...
读数据流: 
  ...
  $  000.输出电压             $    $  V      $    $  ANS000.BYTE004  $  y = SPRINTF([%.2f], (x1*256+x2)*0.1);
  $  001.输出电流             $    $  A      $    $  ANS001.BYTE004  $  y = SPRINTF([%.2f], (x1*256+x2)*0.01);
  $  002.温度                 $    $  ℃     $    $  ANS002.BYTE004  $  y = SPRINTF([%d], x1-40);
  $  003.充电机当前状态       $    $         $    $  ANS003.BYTE004  $  if(x1==0) y=@0005;else if(x1==1) y=@0006;else if(x1==2) y=@0007;else if(x1==3) y=@0008;else y=@0004;
  $  004.输入电压             $    $  V      $    $  ANS004.BYTE004  $  y = SPRINTF([%.2f], (x1*256+x2)*0.1);
  $  005.输入电流             $    $  A      $    $  ANS005.BYTE004  $  y = SPRINTF([%.2f], (x1*256+x2)*0.01);
