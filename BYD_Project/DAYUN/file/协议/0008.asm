...
版本信息:
  ...
  $%  REQ007:722 03 22 F1 8C 00 00 00 00       $%  ANS007:7A2 03 22 F1 8C 00 00 00 00
  $%  REQ008:722 03 22 F1 98 00 00 00 00       $%  ANS008:7A2 03 22 F1 98 00 00 00 00
  $%  REQ009:722 03 22 F1 0A 00 00 00 00       $%  ANS009:7A2 03 22 F1 0A 00 00 00 00
  ...
  $%  009:车辆配置代码:                   $%    $%  ANS009.BYTE004  $%  HEX(x1,x2,x3,x4,x5,x6,x7,x8);
