...
版本信息:
  ...
  $%  REQ009:722 03 22 F1 98 00 00 00 00       $%  ANS009:7A2 03 22 F1 98 00 00 00 00
  $%  REQ010:722 03 22 38 00 00 00 00 00       $%  ANS010:7A2 03 22 38 00 00 00 00 00
  $%  REQ011:722 03 22 F1 0A 00 00 00 00       $%  ANS011:7A2 03 22 F1 0A 00 00 00 00
  ...
  $%  010:ECU维修日期:                    $%    $%  ANS010.BYTE004  $%  HEX(x1,x2,x3,x4);
  $%  011:车辆配置代码:                   $%    $%  ANS011.BYTE004  $%  HEX(x1,x2,x3,x4,x5,x6,x7,x8);
