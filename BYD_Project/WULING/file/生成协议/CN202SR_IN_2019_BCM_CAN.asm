...
数据流
 ...
 $ 00.Car lighting system data
  ...
  $  000.Interior lamp brightness                 $    $  %     $    $  ANS000.BYTE003  $  X
  ...
  $  028.Door lock status lamp                    $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x1)y=@0009;else y=@0008;
  $  029.Rearview mirror Logo lamp                $    $  -     $    $  ANS002.BYTE005  $  if(X1&0x20)y=@0009;else y=@0008;
  $  030.Daytime Running Lamps                    $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  031.Front Turn Lamp Open                     $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0268;else y=@0267;
  $  032.Rear Turn Lamp Open                      $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x40)y=@0268;else y=@0267;
 ...
 $ 02.Touch with door lock state data
  ...
  $  005.PLG switch(PLG only)                   $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x4)y=@0009;else y=@0008;
 ...
 $ 04.IMMO data(non-peps model support)
  ...
  $  000.Key number               $    $  -     $    $  ANS000.BYTE003  $  00:0		01:1		02:2		03:3		04:4		其他:-
 ...
 $ 05.other
	...
	$	REQ007:740 03 22 A0 0D 00 00 00 00          $
	$	REQ008:740 03 22 A0 0E 00 00 00 00          $
	$	REQ009:740 03 22 A0 10 00 00 00 00          $
	$	REQ010:740 03 22 A0 12 00 00 00 00          $
	$	REQ011:740 03 22 A0 15 00 00 00 00          $
	$	REQ012:740 03 22 A0 17 00 00 00 00          $

  $  000.Recent lock source                   $    $  -     $    $  ANS000.BYTE003  $  01:remote control lock		02:mechanical key lock		03:speed lock		04:Automatically locked		05:Central locked		其他:-
  $  001.Last time lock source                $    $  -     $    $  ANS000.BYTE004  $  01:remote control lock		02:mechanical key lock		03:speed lock		04:Automatically locked		05:Central locked		其他:-
  ...
  $  004.Rear Defrost                         $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  005.Remote control output switch         $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0270;else y=@0269;
  $  006.Electric Windows Power switch        $    $  -     $    $  ANS005.BYTE003  $  if(X1&0x80)y=@0270;else y=@0269;
  $  007.Output for brake lamp control        $    $  -     $    $  ANS006.BYTE003  $  if(X1&0x80)y=@0270;else y=@0269;
  $  008.Rearview mirror Folding switch       $    $  -     $    $  ANS007.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  009.Engine hood switch（BSG only）       $    $  -     $    $  ANS008.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  010.Brake switch                         $    $  -     $    $  ANS009.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  011.Mechanical key unlock switch         $    $  -     $    $  ANS010.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  012.Front Turn Lamp Open                 $    $  -     $    $  ANS011.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  013.Rear Turn Lamp Open                  $    $  -     $    $  ANS011.BYTE003  $  if(X1&0x40)y=@0009;else y=@0008;
  $  014.Remote control output switch         $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  015.Electric Windows Power switch        $    $  -     $    $  ANS012.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
