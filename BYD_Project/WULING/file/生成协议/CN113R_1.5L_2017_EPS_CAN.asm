...
数据流
 ...
 $ 00.Real-time Data
  ...
  $  002.ECU Internal Temp                 $    $  deg     $    $  ANS002.BYTE004  $  X*1-40
  $  003.Steering Input Torque             $    $  NM      $    $  ANS003.BYTE004  $  XY*0.0039062-128

 $ 01.Status Data

	$	REQ000:750 03 22 30 05 00 00 00 00          $

  $  000.Vehicle Speed Validity             $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x80)y=@0018;else y=@0017;
  $  001.EPS Calibration Complete           $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x40)y=@0020;else y=@0019;
  $  002.EPS Setup Procedure Complete       $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x20)y=@0020;else y=@0019;
  $  003.EPS Mechanical Center Found        $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x10)y=@0020;else y=@0019;
  $  004.EPS Center Value Stored            $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x8)y=@0020;else y=@0019;
