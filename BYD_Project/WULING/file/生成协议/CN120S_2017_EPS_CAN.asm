...
模块信息
  ...
  $%  003:供应商ECU软件号（耐斯特）       $%    $%  ANS003.BYTE003  $%  20个字节的ASCII显示
  $%  004:供应商ECU软件号（东华）         $%    $%  ANS003.BYTE003  $%  10个字节的ASCII显示
  $%  005:SGMW P/N                        $%    $%  ANS004.BYTE003  $%  X1X2X3X4
  $%  006:供应商标识符                    $%    $%  ANS005.BYTE003  $%  07个字节的ASCII显示
