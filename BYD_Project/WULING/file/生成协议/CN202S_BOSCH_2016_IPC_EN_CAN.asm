...
数据流
 ...
 $ 01.Instrument state display
  ...
  $  018.ABS/ESP fault indicator light                                      $    $  -        $    $  ANS001.BYTE004  $  if(X1&0x1)y=@0009;else y=@0008;
  ...
  $  027.front left door                                                    $    $  -        $    $  ANS001.BYTE006  $  if(X1&0x80)y=@0009;else y=@0008;
  $  028.front right door                                                   $    $  -        $    $  ANS001.BYTE006  $  if(X1&0x40)y=@0009;else y=@0008;
 ...
 $ 02.EPB
  ...
  $  000.EPB worK indication         $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  001.EPB fault  indication       $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x40)y=@0009;else y=@0008;
  $  002.AVH worK indication         $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x20)y=@0009;else y=@0008;
  $  003.AVH fault  indication       $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x10)y=@0009;else y=@0008;
