...
模块信息
	...
	$%	REQ006:740 03 22 F1 88 00 00 00 00          $%
	$%	REQ007:740 03 22 F1 91 00 00 00 00          $%
...
数据流
 ...
 $ 00.车外照明系统数据
  ...
  $  007.后雾灯开关           $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x1)y=@0120;else y=@0119;
  $  008.危险警告灯开关       $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x80)y=@0120;else y=@0119;
  $  009.日间行车灯           $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
 ...
 $ 05.其他
  ...
  $  000.已匹配钥匙（IMMO）       $    $  -     $    $  ANS000.BYTE003  $  00:0		01:1		02:2		03:3		04:4		其他:-
