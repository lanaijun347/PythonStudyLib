...
数据流
  ...
  $  000.加注状态                       $    $  -        $    $  ANS000.BYTE002  $  00:填充未完成		AA:填充完成成功		EE:填充完成不成功		FF:初始状态		其他:-
  $  001.终端检测状态                   $    $  -        $    $  ANS001.BYTE002  $  00:填充未完成		AA:填充完成成功		EE:填充完成不成功		FF:初始状态		其他:-
  $  002.左前轮速度                     $    $  km/h     $    $  ANS002.BYTE002  $  XY*0.0563
  $  003.右前轮速度                     $    $  km/h     $    $  ANS002.BYTE004  $  XY*0.0563
  $  004.左后轮速度                     $    $  km/h     $    $  ANS002.BYTE006  $  XY*0.0563
  $  005.右后轮速度                     $    $  km/h     $    $  ANS002.BYTE008  $  XY*0.0563
  ...
  $  015.气泵马达状态                   $    $  -        $    $  ANS005.BYTE002  $  FF:开 		00:关		其他:-
  $  016.电池电压                       $    $  V        $    $  ANS006.BYTE002  $  X*0.08
