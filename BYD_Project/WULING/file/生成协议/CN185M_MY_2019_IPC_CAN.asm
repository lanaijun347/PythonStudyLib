...
模块信息
  ...
  $%  005:SGMW ECU软件号            $%    $%  ANS005.BYTE003  $%  X1X2X3X4
...
数据流
 ...
 $ 00.仪表模拟量显示
	...
	$	REQ011:760 03 22 60 48 00 00 00 00          $
	$	REQ012:760 03 22 60 5B 00 00 00 00          $
  ...
  $  013.自适应巡航控制指示            $    $  -           $    $  ANS010.BYTE003  $  00:没有指示		01:灰色		02:绿色		03:黄色		其他:-
  $  014.倒车雷达RRS声音警告状态       $    $  -           $    $  ANS011.BYTE003  $  00:无报警		01:自检声音报警		02:单一传感器故障声音报警		03:多个传感器故障声音报警		04:通讯超时声音报警		05:长间歇声音报警		06:短间歇声音报警		07:急促间歇声音报警		08:常规声音报警		其他:-
  $  015.巡航控制系统的目标速度        $    $  Km/h        $    $  ANS012.BYTE003  $  XY*0.015625
 ...
 $ 01.仪表状态量显示
  ...
  $  016.维修指示灯                             $    $  -      $    $  ANS001.BYTE004  $  if(X1&0x4)y=@0120;else y=@0119;
  ...
  $  031.发动机罩指示灯                         $    $  -      $    $  ANS001.BYTE006  $  if(X1&0x4)y=@0120;else y=@0119;
  $  032.启停系统工作指示灯                     $    $  -      $    $  ANS001.BYTE006  $  if(X1&0x2)y=@0120;else y=@0119;
  $  033.启停系统禁止按钮指示灯                 $    $  -      $    $  ANS001.BYTE006  $  if(X1&0x1)y=@0120;else y=@0119;
  $  034.档位模式                               $    $  -      $    $  ANS000.BYTE003  $  if(X1&0x20)y=@0143;else y=@0142;
  $  035.后排安全带报警                         $    $  -      $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  036.主报警灯                               $    $  -      $    $  ANS003.BYTE003  $  if(X1&0x40)y=@0120;else y=@0119;
  $  037.保养提示                               $    $  -      $    $  ANS003.BYTE003  $  if(X1&0x20)y=@0120;else y=@0119;
  $  038.AEB(主动刹车)错误指示灯                $    $  -      $    $  ANS003.BYTE003  $  if(X1&0x10)y=@0120;else y=@0119;
  $  039.汽油机颗粒捕集器再生提醒（国六）       $    $  -      $    $  ANS003.BYTE004  $  if(X1&0x40)y=@0120;else y=@0119;
  $  040.发动机故障指示灯                       $    $  -      $    $  ANS003.BYTE004  $  if(X1&0x20)y=@0120;else y=@0119;
  $  041.机油压力过低指示灯                     $    $  -      $    $  ANS003.BYTE004  $  if(X1&0x10)y=@0120;else y=@0119;
  $  042.近光指示灯                             $    $  -      $    $  ANS003.BYTE004  $  if(X1&0x8)y=@0120;else y=@0119;
