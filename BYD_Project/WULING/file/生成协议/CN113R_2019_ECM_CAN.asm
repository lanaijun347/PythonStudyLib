...
数据流
 ...
 $ 00.Real-time Data
	...
	$	REQ072:7E0 03 22 09 04 00 00 00 00          $
  ...
  $  072.Starter control（E-clutch only）                                            $    $  -          $    $  ANS072.BYTE003  $  00:OFF		01:ON		其他:-

 $ 01.State Data

	$	REQ000:7E0 03 22 09 03 00 00 00 00          $
	$	REQ001:7E0 03 22 09 05 00 00 00 00          $
	$	REQ002:7E0 03 22 02 54 00 00 00 00          $
	$	REQ003:7E0 03 22 03 05 00 00 00 00          $
	$	REQ004:7E0 03 22 03 06 00 00 00 00          $
	$	REQ005:7E0 03 22 02 59 00 00 00 00          $
	$	REQ006:7E0 03 22 03 08 00 00 00 00          $

  $  000.KL50 switch status（E-clutch only）                   $    $  -     $    $  ANS000.BYTE003  $  00:OFF		01:ON		其他:-
  $  001.Starter feedback signal（E-clutch only）              $    $  -     $    $  ANS001.BYTE003  $  00:OFF		01:ON		其他:-
  $  002.Fuel Pump Relay                                       $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x1)y=@0238;else y=@0237;
  $  003.Ignition switch state                                 $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x1)y=@0238;else y=@0237;
  $  004.Starter relay status                                  $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x20)y=@0240;else y=@0239;
  $  005.MIL                                                   $    $  -     $    $  ANS005.BYTE003  $  if(X1&0x1)y=@0009;else y=@0008;
  $  006.Air conditioning requests                             $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0238;else y=@0237;
  $  007.Braking test switch state                             $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x4)y=@0238;else y=@0237;
  $  008.Brake lamp switch state                               $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x2)y=@0238;else y=@0237;
  $  009.Air conditioning compressor clutch relay status       $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x1)y=@0011;else y=@0010;
  $  010.Cooling fan 1 switch state                            $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x2)y=@0009;else y=@0008;
  $  011.Cooling fan 2 switch state                            $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x4)y=@0009;else y=@0008;
  $  012.The main relay status                                 $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x8)y=@0240;else y=@0239;
  $  013.Fuel pump relay                                       $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x10)y=@0240;else y=@0239;
  $  014.Air pressure switch state                             $    $  -     $    $  ANS006.BYTE003  $  if(X1&0x10)y=@0009;else y=@0008;
