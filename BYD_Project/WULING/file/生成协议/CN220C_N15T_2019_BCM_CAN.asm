...
数据流
 ...
 $ 00.车外照明系统数据
  ...
  $  011.远近灯切换开关                 $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x20)y=@0120;else y=@0119;
 ...
 $ 01.刮水器、洗涤器数据
  ...
  $  006.前雨刮雾点动开关         $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x8)y=@0120;else y=@0119;
  $  007.自动雨刮开关             $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x20)y=@0120;else y=@0119;
 ...
 $ 02.门碰与锁状态数据
  ...
  $  000.最新落锁源               $    $  0     $    $  ANS000.BYTE003  $  01:遥控闭锁		02:机械钥匙闭锁		03:车速闭锁		04:自动重上锁		05:中控闭锁		06:远程闭锁		其他:-
  $  001.上次落锁源               $    $  0     $    $  ANS000.BYTE004  $  01:遥控闭锁		02:机械钥匙闭锁		03:车速闭锁		04:自动重上锁		05:中控闭锁		06:远程闭锁		其他:-
  ...
  $  007.电动尾门开关             $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x4)y=@0120;else y=@0119;
  $  008.中控未锁定开关           $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x80)y=@0120;else y=@0119;
  $  009.中控锁定开关             $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x40)y=@0120;else y=@0119;
  $  010.驾驶员锁反馈开关         $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x20)y=@0120;else y=@0119;
  $  011.后备箱解锁开关           $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x10)y=@0120;else y=@0119;
  $  012.副驾驶员锁反馈开关       $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x8)y=@0120;else y=@0119;
  $  013.左后门锁反馈开关         $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x4)y=@0120;else y=@0119;
  $  014.右后门锁反馈开关         $    $  -     $    $  ANS001.BYTE004  $  if(X1&0x2)y=@0120;else y=@0119;
  $  015.行李箱解锁电机           $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x20)y=@0120;else y=@0119;
  $  016.左前门锁电机             $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x10)y=@0120;else y=@0119;
  $  017.左前门解锁电机           $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x8)y=@0120;else y=@0119;
