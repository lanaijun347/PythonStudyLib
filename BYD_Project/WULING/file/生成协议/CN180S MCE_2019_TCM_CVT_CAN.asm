...
模块名:变速器控制系统
供应商:上汽齿柳东
诊断代码:CN180S MCE_2019_TCM_CVT_CAN
...
模块信息
	...
	$%	REQ000:7E1 03 22 F1 8A 00 00 00 00          $%
	$%	REQ001:7E1 03 22 F1 8B 00 00 00 00          $%
	$%	REQ002:7E1 03 22 F1 90 00 00 00 00          $%
	$%	REQ003:7E1 03 22 F1 CB 00 00 00 00          $%
	$%	REQ004:7E1 03 22 F1 93 00 00 00 00          $%
	$%	REQ005:7E1 03 22 F1 95 00 00 00 00          $%
  ...
  $%  004:硬件版本号        $%    $%  ANS004.BYTE003  $%  08个字节的ASCII显示
  $%  005:软件版本号        $%    $%  ANS005.BYTE003  $%  08个字节的HEX显示
