...
模块信息
	...
	$%	REQ002:770 03 22 F1 8C 00 00 00 00          $%
	$%	REQ003:770 03 22 F1 90 00 00 00 00          $%
  ...
  $%  002:ECU序列号                 $%    $%  ANS002.BYTE003  $%  12个字节的ASCII显示
...
数据流
 ...
 $ 01.OBC数据
  ...
  $  001.OBC状态                  $    $  -      $    $  ANS001.BYTE003  $  00:充电准备完成		01:正常工作		02:降功率工作		03:故障		04:待机		FF:NA		其他:-
 ...
 $ 08.电池包状态数据
	...
	$	REQ011:770 03 22 C8 3F 00 00 00 00          $
	$	REQ012:770 03 22 C8 40 00 00 00 00          $
  ...
  $  008.电池包绝缘状态                 $    $  -       $    $  ANS008.BYTE003  $  if(X1&0x1)y=@0067;else y=@0032;
  $  009.电池包内CAN总线故障            $    $  -       $    $  ANS009.BYTE003  $  if(X1&0x1)y=@0064;else y=@0032;
  $  010.电池包温度传感器故障           $    $  -       $    $  ANS010.BYTE003  $  if(X1&0x1)y=@0064;else y=@0032;
  $  011.电池包电流传感器故障           $    $  -       $    $  ANS011.BYTE003  $  if(X1&0x1)y=@0064;else y=@0032;
  $  012.电池包单体电压传感器故障       $    $  -       $    $  ANS012.BYTE003  $  if(X1&0x1)y=@0064;else y=@0032;
