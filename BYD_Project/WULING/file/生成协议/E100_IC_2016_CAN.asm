...
数据流
 ...
 $ 00.所有数据
	...
	$	REQ009:760 03 22 60 01 00 00 00 00          $
	$	REQ010:760 03 22 60 40 00 00 00 00          $
	$	REQ011:760 03 22 60 46 00 00 00 00          $
	$	REQ012:760 03 22 60 4B 00 00 00 00          $
	$	REQ013:760 03 22 60 4C 00 00 00 00          $
  ...
  $  009.主驾驶员安全带未系提醒         $    $  -        $    $  ANS009.BYTE003  $  if(X1&0x1)y=@0041;else y=@0040;
  $  010.主驾驶员安全带未系指示灯       $    $  -        $    $  ANS010.BYTE003  $  if(X1&0x80)y=@0041;else y=@0040;
  $  011.远光指示灯                     $    $  -        $    $  ANS010.BYTE003  $  if(X1&0x20)y=@0041;else y=@0040;
  $  012.左转向指示灯                   $    $  -        $    $  ANS010.BYTE003  $  if(X1&0x10)y=@0041;else y=@0040;
  $  013.右转向指示灯                   $    $  -        $    $  ANS010.BYTE003  $  if(X1&0x8)y=@0041;else y=@0040;
  $  014.前雾指示灯                     $    $  -        $    $  ANS010.BYTE003  $  if(X1&0x4)y=@0041;else y=@0040;
  $  015.后雾指示灯                     $    $  -        $    $  ANS010.BYTE003  $  if(X1&0x2)y=@0041;else y=@0040;
  $  016.安全气囊故障指示灯             $    $  -        $    $  ANS010.BYTE005  $  if(X1&0x80)y=@0041;else y=@0040;
  $  017.ESC警告指示灯                  $    $  -        $    $  ANS010.BYTE005  $  if(X1&0x40)y=@0041;else y=@0040;
  $  018.ESC开关指示灯                  $    $  -        $    $  ANS010.BYTE005  $  if(X1&0x20)y=@0041;else y=@0040;
  $  019.EPS故障指示灯                  $    $  -        $    $  ANS010.BYTE005  $  if(X1&0x10)y=@0041;else y=@0040;
  $  020.EBD故障指示灯                  $    $  -        $    $  ANS010.BYTE005  $  if(X1&0x8)y=@0041;else y=@0040;
  $  021.SDM模块故障指示灯              $    $  -        $    $  ANS010.BYTE005  $  if(X1&0x1)y=@0041;else y=@0040;
  $  022.电子手刹工作指示灯             $    $  -        $    $  ANS011.BYTE003  $  if(X1&0x80)y=@0041;else y=@0040;
  $  023.电子手刹故障指示灯             $    $  -        $    $  ANS011.BYTE003  $  if(X1&0x40)y=@0041;else y=@0040;
  $  024.AUTOHOLD工作指示灯             $    $  -        $    $  ANS011.BYTE003  $  if(X1&0x20)y=@0041;else y=@0040;
  $  025.AUTOHOLD故障指示灯             $    $  -        $    $  ANS011.BYTE003  $  if(X1&0x10)y=@0041;else y=@0040;
  $  026.12V蓄电池充电状态指示灯        $    $  -        $    $  ANS012.BYTE003  $  if(X1&0x80)y=@0041;else y=@0040;
  $  027.手刹指示灯                     $    $  -        $    $  ANS012.BYTE003  $  if(X1&0x40)y=@0041;else y=@0040;
  $  028.电机过热指示灯                 $    $  -        $    $  ANS012.BYTE003  $  if(X1&0x20)y=@0041;else y=@0040;
  $  029.READY指示灯                    $    $  -        $    $  ANS012.BYTE003  $  if(X1&0x10)y=@0041;else y=@0040;
  $  030.车辆充电状态指示灯             $    $  -        $    $  ANS012.BYTE003  $  if(X1&0x8)y=@0041;else y=@0040;
  $  031.充电线连接指示灯               $    $  -        $    $  ANS012.BYTE003  $  if(X1&0x4)y=@0041;else y=@0040;
  $  032.动力电池切断指示               $    $  -        $    $  ANS012.BYTE003  $  if(X1&0x2)y=@0041;else y=@0040;
  $  033.整车绝缘报警指示               $    $  -        $    $  ANS012.BYTE003  $  if(X1&0x1)y=@0041;else y=@0040;
  $  034.动力电池故障指示灯             $    $  -        $    $  ANS012.BYTE004  $  if(X1&0x80)y=@0041;else y=@0040;
  $  035.整车故障指示灯                 $    $  -        $    $  ANS012.BYTE004  $  if(X1&0x40)y=@0041;else y=@0040;
  $  036.动力蓄电池荷电状态指示灯       $    $  -        $    $  ANS012.BYTE004  $  if(X1&0x10)y=@0041;else y=@0040;
  $  037.动力电池温度异常指示灯         $    $  -        $    $  ANS012.BYTE004  $  if(X1&0x4)y=@0041;else y=@0040;
  $  038.车辆低速警示音关闭指示灯       $    $  -        $    $  ANS012.BYTE004  $  if(X1&0x2)y=@0041;else y=@0040;
  $  039.真空泵故障报警指示灯           $    $  -        $    $  ANS012.BYTE004  $  if(X1&0x1)y=@0041;else y=@0040;
  $  040.电机故障指示灯                 $    $  -        $    $  ANS012.BYTE005  $  if(X1&0x80)y=@0041;else y=@0040;
  $  041.驾驶员离开提醒                 $    $  -        $    $  ANS013.BYTE003  $  if(X1&0x80)y=@0041;else y=@0040;
 ...
 $ 03.指示灯输出
  ...
  $  011.SDM模块故障指示灯              $    $  -     $    $  ANS000.BYTE005  $  if(X1&0x1)y=@0041;else y=@0040;
  ...
  $  028.车辆低速警示音关闭指示灯       $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x2)y=@0041;else y=@0040;
  $  029.真空泵故障报警指示灯           $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x1)y=@0041;else y=@0040;
  $  030.电机故障指示灯                 $    $  -     $    $  ANS002.BYTE005  $  if(X1&0x80)y=@0041;else y=@0040;
