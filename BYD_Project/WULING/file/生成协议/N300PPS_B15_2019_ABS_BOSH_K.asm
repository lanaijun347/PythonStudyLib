...
模块名:ABS
供应商:博世
诊断代码:N300PPS_B15_2019_ABS_BOSH_K
ECU地址:28
初始化方式:快速初始化
初始化头字节格式:80
其他服务头字节格式:80
...
数据流
  ...
  $  000.液压块的充填状态               $    $  -        $    $  ANS000.BYTE002  $  00:填充未完成		AA:填充完成,成功		EE:填充完成,不成功		其他:-
  $  001.终端检测状态                   $    $  -        $    $  ANS001.BYTE002  $  00:填充未完成		AA:填充完成,成功		EE:填充完成,不成功		其他:-
