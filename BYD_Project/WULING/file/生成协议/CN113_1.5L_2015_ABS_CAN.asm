...
模块信息
  ...
  $%  004:零件号                $%    $%  ANS004.BYTE003  $%  04个字节的HEX显示
...
数据流
 ...
 $ 00.速度数据
  ...
  $  005.主缸压力                   $    $  bar       $    $  ANS001.BYTE003  $  XY*0.0153
  $  006.方向盘转角                 $    $  °        $    $  ANS001.BYTE005  $  XY*0.1
  $  007.偏航率（横摆角速度）       $    $  rad/s     $    $  ANS001.BYTE007  $  XY*0.00213
  $  008.侧向加速度                 $    $  m/s2      $    $  ANS001.BYTE009  $  XY*0.02712
  $  009.纵向加速度                 $    $  m/s2      $    $  ANS001.BYTE011  $  XY*0.02712
