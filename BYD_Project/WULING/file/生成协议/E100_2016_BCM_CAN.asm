...
数据流
 ...
 $ 06.其他
  ...
  $  000.最新落锁源（仅共享车）       $    $  -     $    $  ANS000.BYTE003  $  01:遥控闭锁		02:机械钥匙闭锁		03:车速闭锁		04:自动重上锁		05:中控闭锁		其他:-
  $  001.上次落锁源（仅共享车）       $    $  -     $    $  ANS000.BYTE004  $  01:遥控闭锁		02:机械钥匙闭锁		03:车速闭锁		04:自动重上锁		05:中控闭锁		其他:-
  $  002.驻车制动开关                 $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  003.Horn蜂鸣器                   $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  004.节电控制                     $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  005.后除霜                       $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
