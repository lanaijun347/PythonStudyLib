...
数据流
   ...
   00.所有数据
	...
	$	REQ002:710 03 22 C1 01 00 00 00 00          $
	$	REQ003:710 03 22 D1 00 00 00 00 00          $

  $  000.电压                      $    $  V     $    $  ANS000.BYTE003  $  XY*0.0276+0.42
  $  001.EEPROM检查                $    $  -     $    $  ANS001.BYTE003  $  X
  $  002.在线配置-变速箱模块       $    $  -     $    $  ANS002.BYTE003  $  01:MT		02:AMT		03:CVT		04:AT		05:DCT		其他:-
  $  003.在线配置-动力             $    $  -     $    $  ANS002.BYTE004  $  01:非混动车（常规动力车）		02:BSG 48V		03:PHEV		其他:-
  $  004.信号输入-on档             $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0086;else y=@0085;
  $  005.信号输入-ACC档            $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x40)y=@0086;else y=@0085;
