...
模块名:电子助力转向
供应商:耐斯特
诊断代码:CN180S MCE_2019_EPS_NAI_CAN
...
模块信息
  ...
  $%  006:SGMW的软件号          $%    $%  ANS006.BYTE003  $%  X1X2X3X4
  $%  007:SGMW的硬件号          $%    $%  ANS007.BYTE003  $%  X1X2X3X4
...
数据流
   ...
   00.EPS数据流
	...
	$	REQ008:750 03 22 30 0F 00 00 00 00          $
  ...
  $  008.方向盘角度传感器           $    $  -          $    $  ANS008.BYTE003  $  00:相对传感器		01:绝对传感器		其他:-
