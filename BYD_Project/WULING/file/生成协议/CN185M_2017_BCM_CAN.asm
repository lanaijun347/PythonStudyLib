...
数据流
 ...
 $ 00.车外照明系统数据
  ...
  $  019.后保左后转向灯       $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x80)y=@0120;else y=@0119;
  $  020.后保右后转向灯       $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x40)y=@0120;else y=@0119;
  $  021.日间行车灯           $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
 ...
 $ 05.RKE相关数据
  ...
  $  000.RKE匹配钥匙数量       $    $  -     $    $  ANS000.BYTE003  $  00:0		01:1		02:2		03:3		04:4		其他:-
