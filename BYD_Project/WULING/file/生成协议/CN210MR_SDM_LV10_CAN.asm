...
数据流
 ...
 $ 00.Airbag value
  ...
  $  008.Airbag side curtain airbag Driver value            $    $  Ohm     $    $  ANS000.BYTE020  $  X*0.256
  $  009.Airbag side curtain airbag Passenger value         $    $  Ohm     $    $  ANS000.BYTE022  $  X*0.256
  $  010.Battery voltage                                    $    $  V       $    $  ANS001.BYTE006  $  X*0.256
  $  011.Energy reserve voltage                             $    $  V       $    $  ANS001.BYTE007  $  X*0.256
  $  012.Ignition Cycle counter                             $    $  -       $    $  ANS001.BYTE008  $  X1X2X3X4
