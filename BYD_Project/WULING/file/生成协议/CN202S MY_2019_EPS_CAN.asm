...
数据流
   ...
   00.EPS数据流
	...
	$	REQ011:750 03 22 40 01 00 00 00 00          $
	$	REQ012:750 03 22 40 03 00 00 00 00          $
	$	REQ013:750 03 22 30 05 00 00 00 00          $
	$	REQ014:750 03 22 40 02 00 00 00 00          $
  ...
  $  011.ABS采集的整车速度        $    $  Km/h       $    $  ANS011.BYTE003  $  X
  $  012.电机输出扭矩             $    $  Nm         $    $  ANS012.BYTE003  $  XY*0.0039062-128
  $  013.EPS标定完成情况          $    $  -          $    $  ANS013.BYTE003  $  if(X1&0x40)y=@0116;else y=@0115;
  $  014.EPS安装完成              $    $  -          $    $  ANS013.BYTE003  $  if(X1&0x20)y=@0116;else y=@0115;
  $  015.EPS找到机械中位          $    $  -          $    $  ANS013.BYTE003  $  if(X1&0x10)y=@0116;else y=@0115;
  $  016.EPS标定值存储            $    $  -          $    $  ANS013.BYTE003  $  if(X1&0x8)y=@0116;else y=@0115;
  $  017.电机运行状态             $    $  -          $    $  ANS014.BYTE003  $  if(X1&0x80)y=@0118;else y=@0117;
  $  018.电机机转速有效性         $    $  -          $    $  ANS014.BYTE003  $  if(X1&0x40)y=@0085;else y=@0086;
