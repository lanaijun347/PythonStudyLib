...
数据流
 ...
 $ 00.Car lighting system data
  ...
  $  000.Output for Interior lamp Control Test       $    $  %     $    $  ANS000.BYTE003  $  X*0.392157
  ...
  $  014.Front left turn lamp                        $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x10)y=@0009;else y=@0008;
  $  015.Front right turn lamp                       $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x8)y=@0009;else y=@0008;
  ...
  $  019.Daytime Running Lamps                       $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
 ...
 $ 01.Wiper and washer data
  ...
  $  000.Input for Wiper and Wash switch Control Test       $    $  -     $    $  ANS000.BYTE007  $  00:Retain		01:delay1		02:delay2		03:delay3		04:delay4		05:delay5		06:delay6		07:delay7		其他:-
  $  001.Front wiper high speed switch                      $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  002.Front wiper high speed switch                      $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x40)y=@0009;else y=@0008;
 ...
 $ 02.Touch with door lock state data
  ...
  $  005.Center control unlock switch       $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x80)y=@0009;else y=@0008;
  $  006.Center control lock switch         $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x40)y=@0009;else y=@0008;
  $  007.Lock feedback switch               $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x20)y=@0009;else y=@0008;
  $  008.Trunk unlock switch                $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x10)y=@0009;else y=@0008;
  $  009.Door Lock motor                    $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  010.Door Unlock motor                  $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x40)y=@0009;else y=@0008;
  $  011.Trunk unlocked motor               $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x20)y=@0009;else y=@0008;
 ...
 $ 03.The key state data
  ...
  $  001.ACC                     $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x40)y=@0011;else y=@0023;
  $  002.ON                      $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x20)y=@0011;else y=@0023;
  $  003.START                   $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x10)y=@0011;else y=@0023;

 $ 04.IMMO data

	$	REQ000:740 03 22 C8 07 00 00 00 00          $

  $  000.Keynum                   $    $  -     $    $  ANS000.BYTE003  $  00:0		01:1		02:2		03:3		04:4		其他:-
 ...
 $ 05.other
	...
	$	REQ003:740 03 22 A0 0F 00 00 00 00          $
	$	REQ004:740 03 22 A0 10 00 00 00 00          $

  $  000.parking brake switch                               $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  001.Horn                                               $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  002.Battery saver output                               $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  003.Output for brake lamp control Test(EPB only)       $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0011;else y=@0023;
  $  004.brake switch input (EPB only)                      $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0011;else y=@0023;
