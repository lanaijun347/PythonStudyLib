...
数据流
 ...
 $ 00.Engine data
  ...
  $  033.boost temperature from sensor                                                      $    $  °C         $    $  ANS033.BYTE003  $  X*0.75-48
  $  034.ambient pressure from sensor                                                       $    $  hPa         $    $  ANS034.BYTE003  $  XY*0.0390625
  $  035.ambient temperature from sensor                                                    $    $  °C         $    $  ANS035.BYTE003  $  X*0.75-48
 ...
 $ 03.Evaporative emission data
	...
	$	REQ009:7E0 03 22 02 44 00 00 00 00          $
	$	REQ010:7E0 03 22 02 0E 00 00 00 00          $
	$	REQ011:7E0 03 22 02 A2 00 00 00 00          $
	$	REQ012:7E0 03 22 02 45 00 00 00 00          $
	$	REQ013:7E0 03 22 02 0F 00 00 00 00          $
	$	REQ014:7E0 03 22 02 0D 00 00 00 00          $
	$	REQ015:7E0 03 22 02 20 00 00 00 00          $
	$	REQ016:7E0 03 22 02 3A 00 00 00 00          $
	$	REQ017:7E0 03 22 02 3B 00 00 00 00          $
  ...
  $  009.Ambient pressure without substitution on sensor error           $    $  hPa      $    $  ANS009.BYTE003  $  XY*0.0390625
  $  010.ambient air temperature                                         $    $  °C      $    $  ANS010.BYTE003  $  X*0.75-48
  $  011.Actual intake manifold pressure sensor voltage                  $    $  hPa      $    $  ANS011.BYTE003  $  XY*0.0390625
  $  012.intake manifold pressure (absolute)                             $    $  hPa      $    $  ANS012.BYTE003  $  XY*0.0390625
  $  013.pressure upstream throttle valve                                $    $  hPa      $    $  ANS013.BYTE003  $  XY*0.078125
  $  014.intake air temperature                                          $    $  °C      $    $  ANS014.BYTE003  $  X*0.75-48
  $  015.Air mass flow                                                   $    $  Kg/h     $    $  ANS015.BYTE003  $  X*4
  $  016.throttle blade position dependent on poti 1                     $    $  %        $    $  ANS016.BYTE003  $  [0000-7FFF]:XY*0.024414063+0		[8000-FFFF]:(XY-65535)*0.024414063+0
  $  017.throttle blade position dependent on poti 2                     $    $  %        $    $  ANS017.BYTE003  $  [0000-7FFF]:XY*0.024414063+0		[8000-FFFF]:(XY-65535)*0.024414063+0
  $  018.throttle angle with respect to lower mechanical stop            $    $  %        $    $  ANS018.BYTE003  $  [0000-7FFF]:XY*0.024414063+0		[8000-FFFF]:(XY-65535)*0.024414063+0
  $  019.sensor voltage from throttle potentiometer 1                    $    $  V        $    $  ANS019.BYTE003  $  XY*0.001220703
  $  020.sensor voltage from throttle potentiometer 2                    $    $  V        $    $  ANS020.BYTE003  $  XY*0.001220703
  $  021.Sum of the PID-components (Throttle actuator Control PWM)       $    $  %        $    $  ANS021.BYTE003  $  XY*0.001525879
  $  022.Voltage PWG potentiometer 1                                     $    $  V        $    $  ANS022.BYTE003  $  XY*0.004882813
  $  023.Voltage PWG potentiometer 2                                     $    $  V        $    $  ANS023.BYTE003  $  XY*0.004882813
  $  024.normalized angle acceleration pedal                             $    $  %        $    $  ANS024.BYTE003  $  XY*0.001525879
  $  025.standardized mass flow from canister purge control              $    $  kg/h     $    $  ANS025.BYTE003  $  XY*0.000390625
  $  026.Cooling fan 1 switch status                                     $    $  -        $    $  ANS026.BYTE003  $  if(X1&0x1)y=@0009;else y=@0008;
  $  027.Cooling fan 2 switch status                                     $    $  -        $    $  ANS027.BYTE003  $  if(X1&0x1)y=@0009;else y=@0008;
 ...
 $ 05.Fuel adjustment data
  ...
  $  019.real ignition angle                                                          $    $  Grad Kw     $    $  ANS019.BYTE003  $  [00-7F]:X*0.75+0		[80-FF]:(X-255)*0.75+0
  $  020.basic ignition angle                                                         $    $  Grad Kw     $    $  ANS020.BYTE003  $  [00-7F]:X*0.75+0		[80-FF]:(X-255)*0.75+0
  $  021.ignition-timing retardation with retardation for dynamics, Cylinder #1       $    $  Grad Kw     $    $  ANS021.BYTE003  $  [00-7F]:X*0.75+0		[80-FF]:(X-255)*0.75+0
  $  022.ignition-timing retardation with retardation for dynamics, Cylinder #2       $    $  Grad Kw     $    $  ANS022.BYTE003  $  [00-7F]:X*0.75+0		[80-FF]:(X-255)*0.75+0
  $  023.ignition-timing retardation with retardation for dynamics, Cylinder #3       $    $  Grad Kw     $    $  ANS023.BYTE003  $  [00-7F]:X*0.75+0		[80-FF]:(X-255)*0.75+0
  $  024.ignition-timing retardation with retardation for dynamics, Cylinder #4       $    $  Grad Kw     $    $  ANS024.BYTE003  $  [00-7F]:X*0.75+0		[80-FF]:(X-255)*0.75+0
  $  025.reference level knock control, 16bit, Cylinder #1                            $    $  V           $    $  ANS025.BYTE003  $  XY*0.00007694
  $  026.reference level knock control, 16bit, Cylinder #2                            $    $  V           $    $  ANS026.BYTE003  $  XY*0.00007694
  $  027.reference level knock control, 16bit, Cylinder #3                            $    $  V           $    $  ANS027.BYTE003  $  XY*0.00007694
  $  028.reference level knock control, 16bit, Cylinder #4                            $    $  V           $    $  ANS028.BYTE003  $  XY*0.00007694
  ...
  $  032.exhaust temperature downstream catalyst (model)                              $    $  °C         $    $  ANS032.BYTE003  $  X*5-50
  $  033.multiplicative correction of the mixture adaptation                          $    $  -           $    $  ANS033.BYTE003  $  XY*0.000030518
  $  034.additive correction of the mixture adaptation                                $    $  -           $    $  ANS034.BYTE003  $  [0000-7FFF]:XY*0.046875+0		[8000-FFFF]:(XY-65535)*0.046875+0
  $  035.injection time                                                               $    $  ms          $    $  ANS035.BYTE003  $  XY*0.00128
  $  036.standardized mass flow from canister purge control                           $    $  kg/h        $    $  ANS036.BYTE003  $  XY*0.000390625
  $  037.Fuel pump relay status                                                       $    $  -           $    $  ANS037.BYTE003  $  if(X1&0x1)y=@0009;else y=@0008;
 ...
 $ 08.Air intake data
	...
	$	REQ028:7E0 03 22 02 2D 00 00 00 00          $
	$	REQ029:7E0 03 22 02 58 00 00 00 00          $
	$	REQ030:7E0 03 22 02 60 00 00 00 00          $
  ...
  $  028.exhaust temperature downstream catalyst (model)                 $    $  °C      $    $  ANS028.BYTE003  $  X*5-50
  $  029.multiplicative correction of the mixture adaptation             $    $  -        $    $  ANS029.BYTE003  $  XY*0.000030518
  $  030.additive correction of the mixture adaptation                   $    $  -        $    $  ANS030.BYTE003  $  [0000-7FFF]:XY*0.046875+0		[8000-FFFF]:(XY-65535)*0.046875+0
