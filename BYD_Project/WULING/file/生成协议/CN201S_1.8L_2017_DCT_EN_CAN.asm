...
模块信息
  ...
  $%  003:Supplier ECU Hardware Version Number       $%    $%  ANS003.BYTE003  $%  10个字节的ASCII显示
  ...
  $%  006:EE_SubROM_Version                          $%    $%  ANS006.BYTE003  $%  04个字节的HEX显示
...
数据流
  ...
  $  010.Clutch temperature sensor value                                  $    $  ℃        $    $  ANS010.BYTE003  $  X*1-40
  $  011.Valvebody temperature sensor value                               $    $  ℃        $    $  ANS011.BYTE003  $  X*1-40
  $  012.Solenoid Oil temperature sensor value                            $    $  ℃        $    $  ANS012.BYTE003  $  X*1-40
  ...
  $  021.State torque clutch 1                                            $    $  -         $    $  ANS021.BYTE003  $  00:Default		01:Stablecontrol		02:Offgoingclutchtorquetransfer		03:Clutchopen		04:Oncomingclutchtoruqetransfer		05:reserved		06:Offgoingclutchspeedcontrol		07:Prefill		08:Oncomingclutchspeedcontrol		09:Offgoingclutchspeedcontrol		0A:Oncomingclutchspeedcontrol		0B:Offgoingclutc		其他:-
  $  022.State torque clutch 2                                            $    $  -         $    $  ANS022.BYTE003  $  00:Default		01:Stablecontrol		02:Offgoingclutchtorquetransfer		03:Clutchopen		04:Oncomingclutchtoruqetransfer		05:reserved		06:Offgoingclutchspeedcontrol		07:Prefill		08:Oncomingclutchspeedcontrol		09:Offgoingclutchspeedcontrol		0A:Oncomingclutchspeedcontrol		0B:Offgoingclutc		其他:-
  ...
  $  035.Electric Park Brake Status                                       $    $  -         $    $  ANS035.BYTE003  $  00:Unknown		01:Released		02:Locked		03:Releasing		04:Locking		05:Unused and Reserved		06:Unused and Reserved		07:Unused and Reserved		其他:-
  ...
  $  039.Shifter position                                                 $    $  -         $    $  ANS039.BYTE003  $  00:error		01:S		02:Unused and Reserved		03:M		05:D		06:N		07:R		08:P		09:upshift of one gear in M-mode		0A:downshift of one gear in M-mode		其他:-
  ...
  $  042.Engine Coolant Temperature                                       $    $  ℃        $    $  ANS042.BYTE003  $  X*1-40
  ...
  $  054.Transmission Engine Speed Request Value                          $    $  rpm       $    $  ANS054.BYTE003  $  XY*0.25
