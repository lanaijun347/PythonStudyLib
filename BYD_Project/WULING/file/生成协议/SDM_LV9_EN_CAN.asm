...
数据流
 ...
 $ 00.Airbag value
  ...
  $  004.Rear Row Left seatbelt Pretensioner value         $    $  Ohm     $    $  ANS000.BYTE012  $  X*0.256
  $  005.Side Curtain Passenger value                      $    $  Ohm     $    $  ANS000.BYTE014  $  X*0.256
  $  006.Belt Retractor Pretensioner Driver value          $    $  Ohm     $    $  ANS000.BYTE016  $  X*0.256
  $  007.Belt Retractor Pretensioner Passenger value       $    $  Ohm     $    $  ANS000.BYTE018  $  X*0.256
  $  008.Side Curtain Driver value                         $    $  Ohm     $    $  ANS000.BYTE020  $  X*0.256
  $  009.Battery voltage                                   $    $  V       $    $  ANS001.BYTE006  $  X*0.256
  $  010.Energy reserve voltage                            $    $  V       $    $  ANS001.BYTE007  $  X*0.256
  $  011.Ignition Cycle counter                            $    $  -       $    $  ANS001.BYTE008  $  X1X2X3X4
