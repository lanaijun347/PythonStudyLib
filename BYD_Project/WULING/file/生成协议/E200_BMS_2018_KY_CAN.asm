...
模块信息
	...
	$%	REQ009:770 03 22 F1 88 00 00 00 00          $%
	$%	REQ010:770 03 22 F1 91 00 00 00 00          $%
  ...
  $%  004:供应商ECU硬件号           $%    $%  ANS004.BYTE003  $%  12个字节的ASCII显示
  $%  005:供应商ECU硬件版本号       $%    $%  ANS005.BYTE003  $%  06个字节的ASCII显示
  $%  006:供应商ECU软件号           $%    $%  ANS006.BYTE003  $%  08个字节的ASCII显示
  $%  007:供应商ECU软件版本号       $%    $%  ANS007.BYTE003  $%  06个字节的ASCII显示
  $%  008:零件号                    $%    $%  ANS008.BYTE003  $%  X1X2X3X4
  $%  009:五菱ECU软件号             $%    $%  ANS009.BYTE003  $%  X1X2X3X4
  $%  010:五菱ECU硬件号             $%    $%  ANS010.BYTE003  $%  X1X2X3X4
