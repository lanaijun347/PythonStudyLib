...
数据流
 ...
 $ 00.Airbag value
  ...
  $  004.The second row on the left side Airbag value       $    $  Ohm     $    $  ANS000.BYTE012  $  X*0.256
  $  005.Front Airbag belt preloaded Driver value           $    $  Ohm     $    $  ANS000.BYTE014  $  X*0.256
  $  006.Front Airbag belt preloaded Passenger value        $    $  Ohm     $    $  ANS000.BYTE016  $  X*0.256
  $  007.Battery voltage                                    $    $  V       $    $  ANS001.BYTE006  $  X*0.256
  $  008.Energy reserve voltage                             $    $  V       $    $  ANS001.BYTE007  $  X*0.256
  $  009.Ignition Cycle counter                             $    $  -       $    $  ANS001.BYTE008  $  X1X2X3X4
