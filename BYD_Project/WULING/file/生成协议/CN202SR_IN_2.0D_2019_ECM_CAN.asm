...
数据流
 ...
 $ 00.Engine data
	...
	$	REQ005:7E0 03 22 12 5D 00 00 00 00          $
	$	REQ006:7E0 03 22 20 04 00 00 00 00          $
	$	REQ007:7E0 03 22 20 06 00 00 00 00          $
	$	REQ008:7E0 03 22 20 05 00 00 00 00          $
	$	REQ009:7E0 03 22 19 34 00 00 00 00          $
	$	REQ010:7E0 03 22 38 07 00 00 00 00          $
	$	REQ011:7E0 03 22 38 35 00 00 00 00          $
	$	REQ012:7E0 03 22 38 08 00 00 00 00          $
	$	REQ013:7E0 03 22 38 09 00 00 00 00          $
	$	REQ014:7E0 03 22 38 0A 00 00 00 00          $
	$	REQ015:7E0 03 22 38 0B 00 00 00 00          $
	$	REQ016:7E0 03 22 18 A5 00 00 00 00          $
	$	REQ017:7E0 03 22 18 A6 00 00 00 00          $
	$	REQ018:7E0 03 22 19 64 00 00 00 00          $
	$	REQ019:7E0 03 22 12 75 00 00 00 00          $
  ...
  $  003.Current gear                                                                                $    $  -       $    $  ANS003.BYTE003  $  00:Gear 0 (Neutral)		01:Gear 1		02:Gear 2		03:Gear 3		04:Gear 4		05:Gear 5		06:Gear 6		07:Gear 7		08: Gear 8		09:Gear 9		其他:-
  $  004.Engine temperature at start                                                                 $    $  °C     $    $  ANS004.BYTE003  $  X*0.75
  $  005.Engine Status                                                                               $    $  -       $    $  ANS005.BYTE003  $  00:Engine not running & Ignition ON		01:Engine cranking  in progress		02:Engine Idling		03:Engine running		04:Engine ready to crank		05:Engine stalled		其他:-
  $  006.Engine overspeed counter                                                                    $    $  -       $    $  ANS006.BYTE003  $  X
  $  007.Total engine overspeed duration                                                             $    $  ms      $    $  ANS007.BYTE003  $  XY*10
  $  008.Maximum engine overspeed                                                                    $    $  rpm     $    $  ANS008.BYTE003  $  X*40
  $  009.ADC Engine coolant temperature                                                              $    $  mV      $    $  ANS009.BYTE003  $  XY*0.1
  $  010.Covered distance since last regeneration                                                    $    $  Km      $    $  ANS010.BYTE003  $  XYZ*0.1
  $  011.Counter of DPF regeneration due to flow resistance                                          $    $  -       $    $  ANS011.BYTE003  $  X
  $  012.Mean temperature value of the last regenerations (forced + automatic)                       $    $  °C     $    $  ANS012.BYTE003  $  XY*0.02-40
  $  013.Mean driven distance of the last regenerations (forced + automatic)                         $    $  Km      $    $  ANS013.BYTE003  $  XY
  $  014.Mean duration of the last regenerations                                                     $    $  s       $    $  ANS014.BYTE003  $  XY
  $  015.Percentage time of regeneration                                                             $    $  %       $    $  ANS015.BYTE003  $  XY*0.0015259
  $  016.RGN interrupted counter OR Number of consecutive interrupted regenerations by key off       $    $  -       $    $  ANS016.BYTE003  $  X
  $  017.Driven distance since DPF lamp ON                                                           $    $  Km      $    $  ANS017.BYTE003  $  XY
  $  018.TVA DC motor required position                                                              $    $  %       $    $  ANS018.BYTE003  $  XY*0.0015259
  $  019.Starter engagement release result-Powerstage high side                                      $    $  -       $    $  ANS019.BYTE003  $  if(X1&0x1)y=@0015;else y=@0318;
  $  020.Starter engagement release result-Powerstage low side                                       $    $  -       $    $  ANS019.BYTE003  $  if(X1&0x2)y=@0015;else y=@0318;
 ...
 $ 05.Fuel adjustment data
	...
	$	REQ004:7E0 03 22 19 02 00 00 00 00          $
  ...
  $  004.Command PTC Fuel Filter heater       $    $  -       $    $  ANS004.BYTE003  $  if(X1&0x1)y=@0323;else y=@0322;

 $ 06.Oxygen sensor data

	$	REQ000:7E0 03 22 02 5B 00 00 00 00          $
	$	REQ001:7E0 03 22 18 00 00 00 00 00          $
  ...
  $  000.Sensor voltage from TVA                                $    $  V        $    $  ANS000.BYTE003  $  XY*0.001220703
 ...
 $ 08.Air intake data
	...
	$	REQ002:7E0 03 22 39 21 00 00 00 00          $
  ...
  $  002.Mean temperature value of the last wobbling events       $    $  °C        $    $  ANS002.BYTE003  $  XY*0.02
 ...
 $ 10.Injector Data
  ...
  $  000.IMA code of injector cylinder 1       $    $  -     $    $  ANS000.BYTE003  $  09个字节的HEX显示
  $  001.IMA code of injector cylinder 2       $    $  -     $    $  ANS001.BYTE003  $  09个字节的HEX显示
  $  002.IMA code of injector cylinder 3       $    $  -     $    $  ANS002.BYTE003  $  09个字节的HEX显示
  $  003.IMA code of injector cylinder 4       $    $  -     $    $  ANS003.BYTE003  $  09个字节的HEX显示
