...
模块名:仪表控制模块
供应商:天有为
诊断代码:CN180S MCE_2019_IC_TYW_CAN
...
模块信息
  ...
  $%  007:供应商代码            $%    $%  ANS007.BYTE003  $%  07个字节的ASCII显示
...
数据流
 ...
 $ 00.仪表模拟量显示
	...
	$	REQ010:760 03 22 C1 01 00 00 00 00          $
  ...
  $  013.在线配置-分体式互联网车机            $    $              $    $  ANS010.BYTE009  $  09:无仪表互联		0A:仪表联CAN		其他:-
  $  014.在线配置-主动刹车AEB                 $    $              $    $  ANS010.BYTE013  $  00:无		01:有		其他:-
  $  015.在线配置-前碰预警功能FCW             $    $              $    $  ANS010.BYTE012  $  00:无		01:有		其他:-
  $  016.在线配置-自适应巡航巡航系统ACC       $    $              $    $  ANS010.BYTE008  $  00:无		01:有		其他:-
  $  017.在线配置-后倒车雷达                  $    $              $    $  ANS010.BYTE010  $  00:无		01:有		其他:-
  $  018.在线配置-胎压测试                    $    $              $    $  ANS010.BYTE012  $  00:无胎压监测		10:有间接式胎压		其他:-
