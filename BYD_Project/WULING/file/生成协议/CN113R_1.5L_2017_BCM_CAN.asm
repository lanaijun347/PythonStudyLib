...
数据流
 ...
 $ 00.Car lighting system data
  ...
  $  019.Daytime running lights         $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;

 $ 01.Wiper and Wash switch data

	$	REQ000:740 03 22 A0 02 00 00 00 00          $
	$	REQ001:740 03 22 A0 06 00 00 00 00          $

  $  000.Input for Wiper and Wash switch       $    $  -     $    $  ANS000.BYTE007  $  00:Reserved		01:Delay1		02:Delay2		03:Delay3		04:Delay4		05:Delay5		06:Delay6		07:Delay7		其他:-
 ...
 $ 02.Door Lock data
  ...
  $  000.Driver door ajar switch            $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  ...
  $  005.Lock feedback switch               $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x20)y=@0009;else y=@0008;
  $  006.Trunk unlock switch                $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x10)y=@0009;else y=@0008;
  $  007.Door Lock motor                    $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  008.Door Unlock motor                  $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x40)y=@0009;else y=@0008;
  $  009.Trunk unlocked motor               $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x20)y=@0009;else y=@0008;

 $ 03.key state data

	$	REQ000:740 03 22 A0 01 00 00 00 00          $

  $  000.Key insert switch              $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x80)y=@0011;else y=@0023;
  $  001.KLR(ACC) switch                $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x40)y=@0011;else y=@0023;
  $  002.KL15(ON) ignition switch       $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x20)y=@0011;else y=@0023;
  $  003.KL50 start switch              $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x10)y=@0011;else y=@0023;

 $ 04.IMMO data

	$	REQ000:740 03 22 C8 07 00 00 00 00          $

  $  000.IMMO Locked or Not       $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x80)y=@0011;else y=@0023;
  $  001.Write PIN or Not         $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x40)y=@0011;else y=@0023;
  $  002.Write SK or Not          $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x20)y=@0011;else y=@0023;
  $  003.Write VIN or Not         $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x10)y=@0011;else y=@0023;

 $ 05.RKE  data

	$	REQ000:740 03 22 C8 16 00 00 00 00          $

  $  000.RKE Number（RKE only）       $    $  -     $    $  ANS000.BYTE007  $  00:0		01:1		02:2		03:3		04:4		其他:-

 $ 06.other

	$	REQ000:740 03 22 C8 07 00 00 00 00          $
	$	REQ001:740 03 22 A0 04 00 00 00 00          $
	$	REQ002:740 03 22 A0 05 00 00 00 00          $
	$	REQ003:740 03 22 A0 08 00 00 00 00          $
	$	REQ004:740 03 22 A0 0A 00 00 00 00          $
	$	REQ005:740 03 22 A0 0B 00 00 00 00          $
	$	REQ006:740 03 22 A0 0C 00 00 00 00          $

  $  000.Keynum                       $    $  -     $    $  ANS000.BYTE003  $  00:0		01:1		02:2		03:3		04:4		05:Reserved		06:Reserved		07:Reserved		其他:-
  $  001.parking brake switch         $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  002.Input for crash signal       $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  003.Horn                         $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  004.Battery saver output         $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  005.Rear Defrost                 $    $  -     $    $  ANS005.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  006.Daytime Running Lamps        $    $  -     $    $  ANS006.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
