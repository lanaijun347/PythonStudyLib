...
模块信息
	...
	$%	REQ005:741 03 22 F1 B2 00 00 00 00          $%
  ...
  $%  005:车辆制造日期        $%    $%  ANS005.BYTE003  $%  04个字节的HEX显示
...
数据流
  ...
  $  009.整车配置信息（变速器型式）       $    $  -        $    $  ANS003.BYTE009  $  00:MT		01:AT		02:AMT		03:		其他:-
