...
数据流
 ...
 $ 00.车外照明系统数据
  ...
  $  018.位置灯改变控制           $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x1)y=@0120;else y=@0119;
  $  019.后挡板左后转向灯         $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x80)y=@0120;else y=@0119;
  $  020.后挡板右后转向灯         $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x40)y=@0120;else y=@0119;
  $  021.D-pillar左后转向灯       $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x20)y=@0120;else y=@0119;
  $  022.D-pillar右后转向灯       $    $  -     $    $  ANS002.BYTE004  $  if(X1&0x10)y=@0120;else y=@0119;
 ...
 $ 03.钥匙状态数据
  ...
  $  000.读钥匙槽数量(仅仅RKE)       $    $  -     $    $  ANS000.BYTE003  $  00:0		01:1		0A:2		0B:3		64:4		其他:-
  $  001.ACC位置                     $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x40)y=@0116;else y=@0115;
  $  002.ON位置                      $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x20)y=@0116;else y=@0115;
  $  003.START位置                   $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x10)y=@0116;else y=@0115;
 ...
 $ 05.其他
	...
	$	REQ005:740 03 22 A0 10 00 00 00 00          $
  ...
  $  004.刹车灯控制输出(仅EPB有)       $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  005.刹车开关状态(仅EPB有)         $    $  -     $    $  ANS005.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
