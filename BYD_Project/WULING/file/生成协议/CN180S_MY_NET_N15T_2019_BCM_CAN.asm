...
模块名:车身控制模块
供应商:联电
诊断代码:CN180S_MY_NET_N15T_2019_BCM_CAN
...
数据流
 ...
 $ 02.门碰与锁状态数据
  ...
  $  006.中控解锁开关             $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x80)y=@0120;else y=@0119;
  $  007.中控闭锁开关             $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x40)y=@0120;else y=@0119;
  $  008.驾驶员锁反馈开关         $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x20)y=@0120;else y=@0119;
  $  009.后备箱解锁开关           $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x10)y=@0120;else y=@0119;
  $  010.副驾驶门锁反馈开关       $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x8)y=@0120;else y=@0119;
  $  011.左后门锁反馈开关         $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x4)y=@0120;else y=@0119;
  $  012.右后门锁反馈开关         $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x2)y=@0120;else y=@0119;
  $  013.门锁电机                 $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  014.门解锁电机               $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x40)y=@0120;else y=@0119;
  $  015.行李箱解锁电机           $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x20)y=@0120;else y=@0119;
  $  016.左前门锁电机             $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x10)y=@0120;else y=@0119;
  $  017.左前门解锁电机           $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x8)y=@0120;else y=@0119;
  $  018.其他三门锁电机           $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x4)y=@0120;else y=@0119;
  $  019.其他三门解锁电机         $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x2)y=@0120;else y=@0119;
 ...
 $ 05.其他
  ...
  $  008.后视镜折叠开关            $    $  -     $    $  ANS007.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  009.前舱盖开关（仅BSG）       $    $  -     $    $  ANS008.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  010.驻车制动开关              $    $  -     $    $  ANS009.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  011.机械钥匙解锁开关          $    $  -     $    $  ANS010.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  012.前转向灯开路反馈          $    $  -     $    $  ANS011.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  013.后转向灯开路反馈          $    $  -     $    $  ANS011.BYTE003  $  if(X1&0x40)y=@0120;else y=@0119;
  $  014.远程控制输出              $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
  $  015.遥控降窗设置状态          $    $  -     $    $  ANS012.BYTE003  $  if(X1&0x80)y=@0120;else y=@0119;
