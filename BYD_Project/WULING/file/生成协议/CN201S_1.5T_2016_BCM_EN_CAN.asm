...
数据流
 ...
 $ 01.Wiper and washer data
  ...
  $  000.The former wiper intermittent control switch       $    $  -     $    $  ANS000.BYTE003  $  00:Retain		01:delay1		02:delay2		03:delay3		04:delay4		05:delay5		06:delay6		07:delay7		其他:-
 ...
 $ 02.Touch with door lock state data
  ...
  $  007.Driver Lock feedback switch        $    $  -     $    $  ANS000.BYTE004  $  if(X1&0x20)y=@0009;else y=@0008;
 ...
 $ 03.The key state data
  ...
  $  000.Key insert switch(Immo only)       $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x80)y=@0022;else y=@0021;
 ...
 $ 04.IMMO data(non-peps model support)
  ...
  $  000.Have matching key        $    $  -     $    $  ANS000.BYTE003  $  00:0		01:1		02:2		03:3		04:4		其他:-
 ...
 $ 05.other
	...
	$	REQ004:740 03 22 A0 0F 00 00 00 00          $
  ...
  $  002.Battery saver control                              $    $  -     $    $  ANS002.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  003.Rear Defrost                                       $    $  -     $    $  ANS003.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
  $  004.Output for brake lamp control Test(EPB only)       $    $  -     $    $  ANS004.BYTE003  $  if(X1&0x80)y=@0009;else y=@0008;
