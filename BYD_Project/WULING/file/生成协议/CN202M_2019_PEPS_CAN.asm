...
模块信息
	...
	$%	REQ003:741 03 22 F1 92 00 00 00 00          $%
	$%	REQ004:741 03 22 F1 93 00 00 00 00          $%
	$%	REQ005:741 03 22 F1 94 00 00 00 00          $%
	$%	REQ006:741 03 22 F1 95 00 00 00 00          $%
	$%	REQ007:741 03 22 F1 CB 00 00 00 00          $%
	$%	REQ008:741 03 22 F1 88 00 00 00 00          $%
	$%	REQ009:741 03 22 F1 91 00 00 00 00          $%

  $%  000:供应商标识信息            $%    $%  ANS000.BYTE003  $%  07个字节的ASCII显示
  $%  001:ECU生产日期               $%    $%  ANS001.BYTE003  $%  04个字节的HEX显示
  $%  002:VIN                       $%    $%  ANS002.BYTE003  $%  17个字节的ASCII显示
  $%  003:供应商ECU硬件号           $%    $%  ANS003.BYTE003  $%  04个字节的HEX显示
  $%  004:供应商ECU硬件版本号       $%    $%  ANS004.BYTE003  $%  06个字节的HEX显示
  $%  005:供应商ECU软件号           $%    $%  ANS005.BYTE003  $%  04个字节的HEX显示
  $%  006:供应商ECU软件版本号       $%    $%  ANS006.BYTE003  $%  06个字节的HEX显示
...
数据流
  ...
  $  009.整车配置信息（变速器型式）         $    $  -        $    $  ANS003.BYTE005  $  01:MT		02:DCT		03:AMT		04:CVT		其他:-
