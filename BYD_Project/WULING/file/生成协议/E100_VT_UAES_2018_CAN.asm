...
数据流
 ...
 $ 01.GPS数据
	...
	$	REQ002:762 03 22 60 04 00 00 00 00          $
  ...
  $  009.GPS定位状态                $    $  -      $    $  ANS002.BYTE003  $  if(X1&0x1)y=@0035;else y=@0034;

 $ 02.GPRS数据

	$	REQ000:762 03 22 60 06 00 00 00 00          $
	$	REQ001:762 03 22 60 08 00 00 00 00          $

  $  000.GPRS模块工作状态       $    $  -     $    $  ANS000.BYTE003  $  if(X1&0x1)y=@0033;else y=@0032;
  $  001.GPRS网络状态           $    $  -     $    $  ANS001.BYTE003  $  if(X1&0x1)y=@0037;else y=@0036;
