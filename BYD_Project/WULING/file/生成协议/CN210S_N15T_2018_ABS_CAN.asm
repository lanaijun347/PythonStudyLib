...
数据流
  ...
  $  014.制动助力真空度（仅EPB+EVP）           $    $  bar       $    $  ANS004.BYTE005  $  [0000-7FFF]:XY*0.0000625+0		[8000-FFFF]:(XY-65535)*0.0000625+0
  $  015.电子手刹指示灯状态（仅EPB）           $    $  -         $    $  ANS005.BYTE003  $  00:关		01:开		其他:-
  $  016.自动电子手刹指示灯状态（仅EPB）       $    $  -         $    $  ANS006.BYTE003  $  00:关		01:开		其他:-
