...
读数据流: 
  ...
  $  REQ000:700 03 22 D9 13 00 00 00 00       $  ANS000:780 03 22 D9 13 00 00 00 00
  $  REQ001:700 03 22 D9 19 00 00 00 00       $  ANS001:780 03 22 D9 19 00 00 00 00
  $  REQ002:700 03 22 D9 A1 00 00 00 00       $  ANS002:780 03 22 D9 A1 00 00 00 00
  $  REQ003:700 03 22 D9 11 00 00 00 00       $  ANS003:780 03 22 D9 11 00 00 00 00
  $  REQ004:700 03 22 C0 00 00 00 00 00       $  ANS004:780 03 22 C0 00 00 00 00 00
  $  REQ005:700 03 22 D9 15 00 00 00 00       $  ANS005:780 03 22 D9 15 00 00 00 00
  $  REQ006:700 03 22 D9 18 00 00 00 00       $  ANS006:780 03 22 D9 18 00 00 00 00
  ...
  $  000.BMS SOC(电池电量)段                 $    $           $    $  ANS000.BYTE004  $  y=x;
  $  001.BMS剩余电量                         $    $  %        $    $  ANS001.BYTE004  $  y=x;
  $  002.氢气                                $    $  %        $    $  ANS002.BYTE004  $  y=(x1*256+x2);
  $  003.H2段                                $    $           $    $  ANS003.BYTE004  $  y=x;
  $  004.SRS启用                             $    $           $    $  ANS004.BYTE004  $  if((x&0x10)==0x10)y=@00f0;else y=@00db;
  $  005.TPMS启用                            $    $           $    $  ANS004.BYTE004  $  if((x&0x08)==0x08)y=@00f0;else y=@00db;
  $  006.超速报警                            $    $           $    $  ANS004.BYTE004  $  if((x&0x06)==0x00) y=@0ba1;else if((x&0x06)==0x02) y=@0ba2;else if((x&0x06)==0x04) y=@0ba3;else y=@0ba4;
  $  007.超速报警                            $    $           $    $  ANS004.BYTE004  $  if((x&0x01)==0x01)y=@00f0;else y=@00db;
  $  008.左前轮胎压力                        $    $  kPa      $    $  ANS005.BYTE004  $  y=x*2.75;
  $  009.左后轮胎压力                        $    $  kPa      $    $  ANS006.BYTE004  $  y=x*2.75;
  $  010.里程表                              $    $  km       $    $  ANS007.BYTE004  $  y=x1*256*256+x2*256+x3;
  $  011.右前轮胎压力                        $    $  kPa      $    $  ANS008.BYTE004  $  y=x*2.75;
  $  012.右后轮胎压力                        $    $  kPa      $    $  ANS009.BYTE004  $  y=x*2.75;
  $  013.速度角度                            $    $           $    $  ANS010.BYTE004  $  y=x;
  $  014.电动踏步警示灯                      $    $           $    $  ANS011.BYTE004  $  if((x&0x80)==0x80)y=@0028;else y=@000f;
  $  015.侧灯                                $    $           $    $  ANS011.BYTE004  $  if((x&0x20)==0x20)y=@0028;else y=@000f;
  $  016.后雾灯                              $    $           $    $  ANS011.BYTE004  $  if((x&0x10)==0x10)y=@0028;else y=@000f;
  $  017.前雾灯                              $    $           $    $  ANS011.BYTE004  $  if((x&0x08)==0x08)y=@0028;else y=@000f;
  $  018.远光灯                              $    $           $    $  ANS011.BYTE004  $  if((x&0x04)==0x04)y=@0028;else y=@000f;
  $  019.右转向灯                            $    $           $    $  ANS011.BYTE004  $  if((x&0x02)==0x02)y=@0028;else y=@000f;
  $  020.左转向灯                            $    $           $    $  ANS011.BYTE004  $  if((x&0x01)==0x01)y=@0028;else y=@000f;
  $  021.胎压监视系统警告灯                  $    $           $    $  ANS011.BYTE005  $  if((x&0x80)==0x80)y=@0028;else y=@000f;
  $  022.EBD警告灯                           $    $           $    $  ANS011.BYTE005  $  if((x&0x40)==0x40)y=@0028;else y=@000f;
  $  023.ABS警告灯                           $    $           $    $  ANS011.BYTE005  $  if((x&0x20)==0x20)y=@0028;else y=@000f;
  $  024.电子驻车故障灯                      $    $           $    $  ANS011.BYTE005  $  if((x&0x10)==0x10)y=@0028;else y=@000f;
  $  025.停车灯                              $    $           $    $  ANS011.BYTE005  $  if((x&0x08)==0x08)y=@0028;else y=@000f;
  $  026.制动系统警告灯                      $    $           $    $  ANS011.BYTE005  $  if((x&0x04)==0x04)y=@0028;else y=@000f;
  $  027.安全带警告灯                        $    $           $    $  ANS011.BYTE005  $  if((x&0x02)==0x02)y=@0028;else y=@000f;
  $  028.安全气囊警告灯                      $    $           $    $  ANS011.BYTE005  $  if((x&0x01)==0x01)y=@0028;else y=@000f;
  $  029.BMS SOCW警示灯                      $    $           $    $  ANS012.BYTE004  $  if((x&0x20)==0x20)y=@0028;else y=@000f;
  $  030.高压电池组切断警告灯                $    $           $    $  ANS012.BYTE004  $  if((x&0x10)==0x10)y=@0028;else y=@000f;
  $  031.动力总成故障开/HVIL警告指示灯       $    $           $    $  ANS012.BYTE004  $  if((x&0x08)==0x08)y=@0028;else y=@000f;
  $  032.电机温度警告灯                      $    $           $    $  ANS012.BYTE004  $  if((x&0x04)==0x04)y=@0028;else y=@000f;
  $  033.电池充电警告灯                      $    $           $    $  ANS012.BYTE004  $  if((x&0x02)==0x02)y=@0028;else y=@000f;
  $  034.电动助力转向故障警告灯              $    $           $    $  ANS012.BYTE004  $  if((x&0x01)==0x01)y=@0028;else y=@000f;
  $  035.燃料电池状态                        $    $           $    $  ANS012.BYTE005  $  if((x&0x80)==0x80)y=@0028;else y=@000f;
  $  036.氢气泄露警告                        $    $           $    $  ANS012.BYTE005  $  if((x&0x40)==0x40)y=@0028;else y=@000f;
  $  037.动力总成燃油汽车                    $    $           $    $  ANS012.BYTE005  $  if((x&0x20)==0x20)y=@0028;else y=@000f;
  $  038.EV动力总成模式                      $    $           $    $  ANS012.BYTE005  $  if((x&0x10)==0x10)y=@0028;else y=@000f;
  $  039.氢化指示                            $    $           $    $  ANS012.BYTE005  $  if((x&0x08)==0x08)y=@0028;else y=@000f;
  $  040.高压隔离警告                        $    $           $    $  ANS012.BYTE005  $  if((x&0x04)==0x04)y=@0028;else y=@000f;
  $  041.电力蓄电池故障状态                  $    $           $    $  ANS012.BYTE005  $  if((x&0x02)==0x02)y=@0028;else y=@000f;
  $  042.电源状态                            $    $           $    $  ANS012.BYTE005  $  if((x&0x01)==0x01)y=@0028;else y=@000f;
  $  043.车辆速度                            $    $  km/h     $    $  ANS013.BYTE004  $  y=(x1*256+x2)*0.01;
