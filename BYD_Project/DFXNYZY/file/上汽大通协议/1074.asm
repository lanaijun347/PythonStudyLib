...
读数据流: 
  ...
  $  004.点火开关状态                         $    $               $    $  ANS000.BYTE013  $  if((x&0x07)==0x00) y=@000f;else if((x&0x07)==0x01) y=@0a27;else if((x&0x07)==0x02) y=@0463;else if((x&0x07)==0x04) y=@009d;else if((x&0x07)==0x07) y=@009e;else y=@01a9;
