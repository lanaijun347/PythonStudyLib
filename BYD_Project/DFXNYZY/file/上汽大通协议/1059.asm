...
读数据流: 
  ...
  $  002.SRS安全气囊配置              $    $           $    $  ANS002.BYTE004  $  if((x&0x10)==0x10)y=@00dc;else y=@00db;
  $  003.TPMS胎压监视系统配置         $    $           $    $  ANS002.BYTE004  $  if((x&0x08)==0x08)y=@00dc;else y=@00db;
  $  004.超速警告的速度配置           $    $           $    $  ANS002.BYTE004  $  if((x&0x06)==0x00) y=@0ba1;else if((x&0x06)==0x02) y=@0ba2;else if((x&0x06)==0x04) y=@0ba3;else y=@0ba4;
  $  005.超速报警功能配置             $    $           $    $  ANS002.BYTE004  $  if((x&0x01)==0x01)y=@00dc;else y=@00db;
  $  006.左前轮胎压力                 $    $  kPa      $    $  ANS003.BYTE004  $  y=x*2.75;
  $  007.左后轮胎压力                 $    $  kPa      $    $  ANS004.BYTE004  $  y=x*2.75;
  $  008.MC动力                       $    $  kW       $    $  ANS005.BYTE004  $  y=(x1*256+x2)*0.01-150.0;
  $  009.MC动力段                     $    $           $    $  ANS006.BYTE004  $  y=x;
  ...
  $  013.速度转速                     $    $           $    $  ANS010.BYTE004  $  y=x;
  $  014.电动侧踏步指示灯             $    $           $    $  ANS011.BYTE004  $  if((x&0x80)==0x80)y=@0028;else y=@000f;
  $  015.位置灯                       $    $           $    $  ANS011.BYTE004  $  if((x&0x20)==0x20)y=@0028;else y=@000f;
  ...
  $  025.电子驻车指示灯               $    $           $    $  ANS011.BYTE005  $  if((x&0x08)==0x08)y=@0028;else y=@000f;
  ...
  $  029.BMS剩余电量警告灯            $    $           $    $  ANS012.BYTE004  $  if((x&0x20)==0x20)y=@0028;else y=@000f;
  $  030.高压电池组切断警告灯         $    $           $    $  ANS012.BYTE004  $  if((x&0x10)==0x10)y=@0028;else y=@000f;
  $  031.动力系统故障警告灯           $    $           $    $  ANS012.BYTE004  $  if((x&0x08)==0x08)y=@0028;else y=@000f;
  $  032.驱动电机温度高警告灯         $    $           $    $  ANS012.BYTE004  $  if((x&0x04)==0x04)y=@0028;else y=@000f;
  $  033.蓄电池未充电警告灯           $    $           $    $  ANS012.BYTE004  $  if((x&0x02)==0x02)y=@0028;else y=@000f;
  $  034.电动助力转向故障警告灯       $    $           $    $  ANS012.BYTE004  $  if((x&0x01)==0x01)y=@0028;else y=@000f;
  $  035.绝缘故障警告灯               $    $           $    $  ANS012.BYTE005  $  if((x&0x04)==0x04)y=@0028;else y=@000f;
  $  036.BMS电池状态                  $    $           $    $  ANS012.BYTE005  $  if((x&0x02)==0x02)y=@0028;else y=@000f;
  $  037.车辆准备就绪指示灯           $    $           $    $  ANS012.BYTE005  $  if((x&0x01)==0x01)y=@0028;else y=@000f;
  $  038.车速                         $    $  km/h     $    $  ANS013.BYTE004  $  y=(x1*256+x2)*0.01;
