...
读数据流: 
  ...
  $  REQ004:721 03 22 FD 87 00 00 00 00       $  ANS004:7A1 03 22 FD 87 00 00 00 00
  $  REQ005:721 03 22 C0 01 00 00 00 00       $  ANS005:7A1 03 22 C0 01 00 00 00 00
  $  REQ006:721 03 22 FD 86 00 00 00 00       $  ANS006:7A1 03 22 FD 86 00 00 00 00
  $  REQ007:721 03 22 FD 81 00 00 00 00       $  ANS007:7A1 03 22 FD 81 00 00 00 00
  ...
  $  004.前压力传感器         $    $  degree C     $    $  ANS004.BYTE004  $  y=x*0.5-30.0;
  $  005.HCM类型              $    $               $    $  ANS005.BYTE004  $  if((x&0x01)==0x01)y=@098b;else y=@098c;
  $  006.后空调开关状态       $    $               $    $  ANS006.BYTE004  $  if((x&0x02)==0x02)y=@0028;else y=@000f;
  $  007.前空调开关状态       $    $               $    $  ANS006.BYTE004  $  if((x&0x01)==0x01)y=@0028;else y=@000f;
  $  008.后压缩机             $    $               $    $  ANS007.BYTE004  $  if((x&0x02)==0x02)y=@0028;else y=@000f;
  $  009.前压缩机             $    $               $    $  ANS007.BYTE004  $  if((x&0x01)==0x01)y=@0028;else y=@000f;
