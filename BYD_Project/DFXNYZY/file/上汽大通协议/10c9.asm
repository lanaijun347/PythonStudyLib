...
版本信息:
  ...
  $%  009:里程读数:                        $%    $%  ANS007.BYTE015  $%  HEX(X1,X2,X3);
...
读数据流: 
  ...
  $  000.LED状态          $    $           $    $  ANS000.BYTE004  $  if(x==0) y=@1124;else if(x==1) y=@1125;else if(x==2) y=@1126;else y=@0035;
  $  001.方向盘角度       $    $           $    $  ANS001.BYTE004  $  y=(x1*256+x2)*0.0625-2048;
  $  002.方向盘扭矩       $    $  Nm       $    $  ANS002.BYTE004  $  y=(x1*256+x2)*0.00097656-32;
  $  003.车速信号         $    $  km/h     $    $  ANS003.BYTE004  $  y=(x1*256+x2);
