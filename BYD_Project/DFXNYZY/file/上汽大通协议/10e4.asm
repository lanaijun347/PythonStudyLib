...
读数据流: 
  ...
  $  REQ000:729 03 22 E4 01 00 00 00 00       $  ANS000:7A9 03 22 E4 01 00 00 00 00
  $  REQ001:729 03 22 E4 08 00 00 00 00       $  ANS001:7A9 03 22 E4 08 00 00 00 00
  $  REQ002:729 03 22 E4 04 00 00 00 00       $  ANS002:7A9 03 22 E4 04 00 00 00 00
  $  REQ003:729 03 22 D0 01 00 00 00 00       $  ANS003:7A9 03 22 D0 01 00 00 00 00
  $  REQ004:729 03 22 E4 00 00 00 00 00       $  ANS004:7A9 03 22 E4 00 00 00 00 00
  $  REQ005:729 03 22 E4 05 00 00 00 00       $  ANS005:7A9 03 22 E4 05 00 00 00 00

  $  000.电池电压                   $    $  V        $    $  ANS000.BYTE004  $  y=(x1*256+x2)*0.001;
  $  001.当前档位                   $    $           $    $  ANS001.BYTE004  $  if(x==1) y=@0187;else if(x==10) y=@0035;else if(x==11) y=@0035;else if(x==12) y=@0035;else if(x==13) y=@0035;else if(x==14) y=@0035;else if(x==15) y=@105e;else if(x==2) y=@0263;else if(x==3) y=@0262;else if(x==4) y=@0261;else if(x==5) y=@0508;else if(x==6) y=@0035;else if(x==7) y=@0035;else if(x==8) y=@0035;else y=@0035;
  $  002.EGSM Park按钮状态          $    $           $    $  ANS002.BYTE004  $  if(x==0) y=@105f;else if(x==1) y=@01db;else if(x==2) y=@0035;else if(x==3) y=@0119;else y=@0035;
  $  003.全局KL50状态               $    $           $    $  ANS003.BYTE004  $  if(((x&0x80)>>7)==0) y=@000f;else if(((x&0x80)>>7)==1) y=@016d;else y=@0035;
  $  004.全局发动机运转状态         $    $           $    $  ANS003.BYTE004  $  if(((x&0x40)>>6)==0) y=@000f;else if(((x&0x40)>>6)==1) y=@016d;else y=@0035;
  $  005.全局KL15状态               $    $           $    $  ANS003.BYTE004  $  if(((x&0x20)>>5)==0) y=@000f;else if(((x&0x20)>>5)==1) y=@016d;else y=@0035;
  $  006.全局ACC/KLR状态            $    $           $    $  ANS003.BYTE004  $  if(((x&0x10)>>4)==0) y=@000f;else if(((x&0x10)>>4)==1) y=@016d;else y=@0035;
  $  007.系统KL50状态               $    $           $    $  ANS003.BYTE004  $  if(((x&0x08)>>3)==0) y=@000f;else if(((x&0x08)>>3)==1) y=@016d;else y=@0035;
  $  008.系统发动机运转状态         $    $           $    $  ANS003.BYTE004  $  if(((x&0x04)>>2)==0) y=@000f;else if(((x&0x04)>>2)==1) y=@016d;else y=@0035;
  $  009.系统KL15状态               $    $           $    $  ANS003.BYTE004  $  if(((x&0x02)>>1)==0) y=@000f;else if(((x&0x02)>>1)==1) y=@016d;else y=@0035;
  $  010.系统ACC/KLR状态            $    $           $    $  ANS003.BYTE004  $  if((x&0x01)==0) y=@000f;else if((x&0x01)==1) y=@016d;else y=@0035;
  $  011.端口15供电状态(KL15)       $    $           $    $  ANS004.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@016d;else y=@0035;
  $  012.车速                       $    $  km/h     $    $  ANS005.BYTE004  $  y=(x1*256+x2)*0.01;
