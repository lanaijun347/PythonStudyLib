...
版本信息:
  ...
  $%  REQ010:730 03 22 FD 10 00 00 00 00       $%  ANS010:738 03 22 FD 10 00 00 00 00
  ...
  $%  004:供应商ECU序列号:           $%    $%  ANS004.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10);
  ...
  $%  010:电池生产日期代码:          $%    $%  ANS010.BYTE004  $%  ASCII(x1,x2,x3);
...
读数据流: 
  ...
  $  002.OBC(车载充电机)输入最大电流         $    $  A            $    $  ANS002.BYTE004  $  y=x1;
  ...
  $  024.电池包告警级别                      $    $               $    $  ANS024.BYTE004  $  switxh(x1&0x03) 0x00: y=@0013;0x01: y=@01dc;0x02: y=@0015;0x03: y=@01dd;default: y=@003f;
  ...
  $  027.电池包温度状态                      $    $               $    $  ANS027.BYTE004  $  switxh(x1&0x03) 0x00: y=@0013;0x01: y=@001a;0x02: y=@001b;0x03: y=@001c;default: y=@003f;
  ...
  $  031.电池包单体电压传感器异常            $    $               $    $  ANS031.BYTE004  $  if(x1&0x01) y=@001d;else y=@0013;
