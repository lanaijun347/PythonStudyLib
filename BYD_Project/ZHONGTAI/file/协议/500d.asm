...
版本信息:
  ...
  $%  REQ008:775 03 22 B0 2F 00 00 00 00       $%  ANS008:715 03 22 B0 2F 00 00 00 00
  ...
  $%  003:序列号:                 $%    $%  ANS003.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,x29);
  ...
  $%  008:车型类型:               $%    $%  ANS008.BYTE004  $%  ASCII(x1,x2);
...
读数据流: 
  ...
  $  REQ005:775 03 22 B0 30 00 00 00 00       $  ANS005:715 03 22 B0 30 00 00 00 00
  $  REQ006:775 03 22 B0 31 00 00 00 00       $  ANS006:715 03 22 B0 31 00 00 00 00
  $  REQ007:775 03 22 B0 32 00 00 00 00       $  ANS007:715 03 22 B0 32 00 00 00 00
  $  REQ008:775 03 22 B0 33 00 00 00 00       $  ANS008:715 03 22 B0 33 00 00 00 00
  $  REQ009:775 03 22 B0 35 00 00 00 00       $  ANS009:715 03 22 B0 35 00 00 00 00
  $  REQ010:775 03 22 B0 36 00 00 00 00       $  ANS010:715 03 22 B0 36 00 00 00 00

  $  000.3G网络类型                             $    $       $    $  ANS000.BYTE004  $  if(x1&0x40) y=@00b3;else y=@00b4;
  $  001.网络状态                               $    $       $    $  ANS000.BYTE004  $  if(x1&0x80) y=@00b5;else y=@00b6;
  $  002.激活状态                               $    $       $    $  ANS001.BYTE004  $  if(x1&0x80) y=@0043;else y=@0044;
  $  003.激活种子                               $    $       $    $  ANS002.BYTE004  $  HEX(x1,x2,x3,x4);
  $  004.国际移动用户识别码                     $    $       $    $  ANS003.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15);
  $  005.PEPS(无匙进入及启动系统)鉴权秘钥       $    $       $    $  ANS004.BYTE004  $  HEX(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
  $  006.TBOX(车联网系统) 型号                  $    $       $    $  ANS005.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10);
  ...
  $  009.TBOX(车联网系统)电话号码               $    $       $    $  ANS008.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15);
  $  010.汽车配置                               $    $       $    $  ANS009.BYTE004  $  HEX(x1,x2,x3);
  $  011.平台秘钥                               $    $       $    $  ANS010.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
