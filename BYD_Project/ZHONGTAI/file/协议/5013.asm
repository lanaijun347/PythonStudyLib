...
版本信息:
  ...
  $%  REQ004:768 03 22 F1 91 00 00 00 00       $%  ANS004:708 03 22 F1 91 00 00 00 00
  $%  REQ005:768 03 22 F1 95 00 00 00 00       $%  ANS005:708 03 22 F1 95 00 00 00 00
  ...
  $%  003:VIN码1:                  $%    $%  ANS003.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
  $%  004:电控单元硬件号:          $%    $%  ANS004.BYTE004  $%  HEX(x1,x2,x3,x4,x5);
