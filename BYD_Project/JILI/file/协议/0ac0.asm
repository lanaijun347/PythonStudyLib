...
读数据流: 
  ...
  $  REQ015:7D2 03 22 32 0D 00 00 00 00       $  ANS015:7DA 03 22 32 0D 00 00 00 00
  ...
  $  015.系统状态                      $    $  /         $    $  ANS015.BYTE004  $  if(x1==0x00)y=@0389;else if(x1==0x01)y=@038a;else if(x1==0x02)y=@038b;else if(x1==0x03)y=@038c;else if(x1==0x04)y=@038d;else if(x1==0x05)y=@038e;else if(x1==0x06)y=@038f;else if(x1>=0x07&&x1<=0xFE)y=@0209;else y=@06e3;
