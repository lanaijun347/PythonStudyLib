...
版本信息:
  ...
  $%  REQ009:745 03 22 F1 97 00 00 00 00       $%  ANS009:74D 03 22 F1 97 00 00 00 00
  $%  REQ010:745 03 22 F1 98 00 00 00 00       $%  ANS010:74D 03 22 F1 98 00 00 00 00
  $%  REQ011:745 03 22 F1 99 00 00 00 00       $%  ANS011:74D 03 22 F1 99 00 00 00 00
  $%  REQ012:745 03 22 F1 9D 00 00 00 00       $%  ANS012:74D 03 22 F1 9D 00 00 00 00
  $%  REQ013:745 03 22 F1 82 00 00 00 00       $%  ANS013:74D 03 22 F1 82 00 00 00 00
...
读数据流: 
  ...
  $  REQ000:745 03 22 DF 00 00 00 00 00       $  ANS000:74D 03 22 DF 00 00 00 00 00
  $  REQ001:745 03 22 DF 01 00 00 00 00       $  ANS001:74D 03 22 DF 01 00 00 00 00
  $  REQ002:745 03 22 69 00 00 00 00 00       $  ANS002:74D 03 22 69 00 00 00 00 00
  $  REQ003:745 03 22 69 01 00 00 00 00       $  ANS003:74D 03 22 69 01 00 00 00 00
  $  REQ004:745 03 22 69 02 00 00 00 00       $  ANS004:74D 03 22 69 02 00 00 00 00

  $  000.供电电压                       $    $  V        $    $  ANS000.BYTE004  $  if(x!=0xff)y=x*0.1;else y=@0008;
  $  001.车速                           $    $  km/h     $    $  ANS001.BYTE004  $  if((x1*0x100+x2)<0x1fff)y=INT((x1*256+x2)*0.05625);else y=@0008;
  $  002.DVR(行车记录仪) 按键状态       $    $  /        $    $  ANS002.BYTE004  $  if(0x00==x)y=@01b2;else if(0x01==x)y=@01b1;
  $  003.DVR(行车记录仪) 系统状态       $    $  /        $    $  ANS003.BYTE004  $  switxh(x)0x00:y=@0318;0x01:y=@0e14;0x02:y=@0e15;0x03:y=@0e16;0x04:y=@0e17;0x05:y=@0e18;0x06:y=@0e19;0x07:y=@0e1a;0x08:y=@0e1b;0x09:y=@0e1c;0x0A:y=@0e1d;0x0B:y=@0e1e;0x0C:y=@0e1f;0x0D:y=@0209;0x0E:y=@0209;0x0F:y=@00be;
  $  004.DVR(行车记录仪) SD卡状态       $    $  /        $    $  ANS004.BYTE004  $  switxh(x)0x00:y=@010f;0x01:y=@0e20;0x02:y=@0e21;0x03:y=@0e22;0x04:y=@0e23;0x05:y=@0e24;0x06:y=@0e25;default:y=@0209;
