...
版本信息:
  ...
  $%  REQ010:7E5 03 22 F1 97 00 00 00 00       $%  ANS010:7ED 03 22 F1 97 00 00 00 00
  $%  REQ011:7E5 03 22 F1 9D 00 00 00 00       $%  ANS011:7ED 03 22 F1 9D 00 00 00 00
  $%  REQ012:7E5 03 22 F1 98 00 00 00 00       $%  ANS012:7ED 03 22 F1 98 00 00 00 00
  ...
  $%  012:诊断仪序列号:                              $%    $%  ANS012.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
...
读数据流: 
  ...
  $  REQ013:7E5 03 22 64 10 00 00 00 00       $  ANS013:7ED 03 22 64 10 00 00 00 00
  $  REQ014:7E5 03 22 64 11 00 00 00 00       $  ANS014:7ED 03 22 64 11 00 00 00 00
  $  REQ015:7E5 03 22 64 12 00 00 00 00       $  ANS015:7ED 03 22 64 12 00 00 00 00
  $  REQ016:7E5 03 22 64 13 00 00 00 00       $  ANS016:7ED 03 22 64 13 00 00 00 00
  $  REQ017:7E5 03 22 64 14 00 00 00 00       $  ANS017:7ED 03 22 64 14 00 00 00 00
  $  REQ018:7E5 03 22 64 15 00 00 00 00       $  ANS018:7ED 03 22 64 15 00 00 00 00
  $  REQ019:7E5 03 22 64 18 00 00 00 00       $  ANS019:7ED 03 22 64 18 00 00 00 00
  $  REQ020:7E5 03 22 64 19 00 00 00 00       $  ANS020:7ED 03 22 64 19 00 00 00 00
  $  REQ021:7E5 03 22 64 1A 00 00 00 00       $  ANS021:7ED 03 22 64 1A 00 00 00 00
  $  REQ022:7E5 03 22 64 1C 00 00 00 00       $  ANS022:7ED 03 22 64 1C 00 00 00 00
  ...
  $  013.乘员安全带锁扣状态                  $    $  /        $    $  ANS013.BYTE004  $  if(((x>>0)&1))y=@0306;else y=@0307;
  $  014.乘员安全带锁扣故障状态              $    $  /        $    $  ANS013.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
  $  015.驾驶员安全带锁扣状态                $    $  /        $    $  ANS014.BYTE004  $  if(((x>>0)&1))y=@0306;else y=@0307;
  $  016.驾驶员安全带锁扣故障状态            $    $  /        $    $  ANS014.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
  $  017.副气囊禁止开关状态                  $    $  /        $    $  ANS015.BYTE004  $  if(((x>>0)&1)) y=@0170;else y=@010e;
  $  018.副气囊禁止开关故障状态              $    $  /        $    $  ANS015.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
  $  019.乘员座椅检测开关状态                $    $  /        $    $  ANS016.BYTE004  $  if(((x>>0)&1)) y=@0170;else y=@010e;
  $  020.乘员座椅检测开关故障状态            $    $  /        $    $  ANS016.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
  $  021.IMU(组合传感器)标定状态             $    $  /        $    $  ANS017.BYTE004  $  if(x==0x00)y=@0312;else if(x==0x01)y=@0c49;else if(x==0x02)y=@0313;else y=@0209;
  $  022.EOL(下线)配置模式                   $    $  /        $    $  ANS018.BYTE004  $  if(x==0x00)y=@030d;else if(x==0x01)y=@036b;else y=@0162;
  $  023.ACU(安全气囊控制单元)点火次数       $    $  /        $    $  ANS019.BYTE004  $  y=x1*256*256*256+x2*256*256+x3*256+x4;
  $  024.ACU(安全气囊控制单元)上电时间       $    $  s        $    $  ANS020.BYTE004  $  y=(x1*0x1000000+x2*0x10000+x3*0x100+x4)*5;
  $  025.第二排左侧安全带锁扣状态            $    $  /        $    $  ANS021.BYTE004  $  if(((x>>0)&1))y=@0307;else y=@0306;
  $  026.第二排左侧安全带锁扣故障状态        $    $  /        $    $  ANS021.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
  $  027.第二排右侧安全带锁扣状态            $    $  /        $    $  ANS022.BYTE004  $  if(((x>>0)&1))y=@0307;else y=@0306;
  $  028.第二排右侧安全带锁扣故障状态        $    $  /        $    $  ANS022.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
