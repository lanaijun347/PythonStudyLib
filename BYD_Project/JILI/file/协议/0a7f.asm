...
读数据流: 
  ...
  $  REQ013:7A0 03 22 68 13 00 00 00 00       $  ANS013:7A8 03 22 68 13 00 00 00 00
  $  REQ014:7A0 03 22 68 14 00 00 00 00       $  ANS014:7A8 03 22 68 14 00 00 00 00
  $  REQ015:7A0 03 22 68 1B 00 00 00 00       $  ANS015:7A8 03 22 68 1B 00 00 00 00
  $  REQ016:7A0 03 22 68 2D 00 00 00 00       $  ANS016:7A8 03 22 68 2D 00 00 00 00
  $  REQ017:7A0 03 22 68 35 00 00 00 00       $  ANS017:7A8 03 22 68 35 00 00 00 00
  ...
  $  013.GNSS定位参数-最后定位时间                  $    $  /     $    $  ANS013.BYTE004  $  SPRINTF([%X%X%X%X%X%X%X],x1,x2,x3,x4,x5,x6,x7);
  $  014.GNSS定位参数-最后定位水平精度因子          $    $  /     $    $  ANS013.BYTE011  $  y=x*0.1;
  $  015.GNSS定位参数-最后定位速度                  $    $  /     $    $  ANS013.BYTE012  $  y=x*1;
  $  016.GNSS定位参数-最后定位方向                  $    $  /     $    $  ANS013.BYTE013  $  y=x*2;
  $  017.GNSS定位参数-最后定位资源卫星数            $    $  /     $    $  ANS013.BYTE014  $  y=x*1;
  $  018.Led背光灯状态                              $    $  /     $    $  ANS014.BYTE004  $  if(0x00==x)y=@0cdd;else if(0x01==x)y=@0cde;else y=@0162;
  $  019.IP地址类型                                 $    $  /     $    $  ANS015.BYTE004  $  switxh(x) 0x00:y=@0539;0x01:y=@053a;default:y=@0009;
  $  020.IP地址                                     $    $  /     $    $  ANS015.BYTE004  $  switxh(((x1>>0)&1))0x00:y=SPRINTF([%d.%d.%d.%d],X2,x3,x4,x5);0x01:y=SPRINTF([%x%x:%x%x:%x%x:%x%x:%x%x:%x%x:%x%x:%x%x],x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
  $  021.访问端口                                   $    $  /     $    $  ANS015.BYTE021  $  y=x1*256+x2;
  $  022.ESK写入状态                                $    $  /     $    $  ANS016.BYTE004  $  switxh(x)0x00:y=@0536;0x01:y=@0f0e;default:y=@0162;
  $  023.GB32960新能源监控功能开关状态              $    $  /     $    $  ANS017.BYTE004  $  if(x==0x00) y=@085c; else if(x==0x01) y=@085d; else y=@0220;
