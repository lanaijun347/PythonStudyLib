...
读数据流: 
  ...
  $  REQ020:7C6 03 22 63 2D 00 00 00 00       $  ANS020:7CE 03 22 63 2D 00 00 00 00
  ...
  $  019.压缩机关闭码                  $    $  /          $    $  ANS019.BYTE004  $  switxh(x1&0xFF)0x00:y=@02a7;0x01:y=@02a8;0x02:y=@02a9;0x03:y=@02aa;0x04:y=@02ab;0x05:y=@02ac;0x06:y=@02ad;0x07:y=@02ae;0x08:y=@02af;0x09:y=@0a0e;0x0A:y=@0a0f;0x0B:y=@0a10;0x0C:y=@0a11;0x0D:y=@02b4;0x0E:y=@02b5;0x0F:y=@0a12;0x10:y=@0a13;default:y=@000b;
  $  020.加热器解锁                    $    $  /          $    $  ANS020.BYTE004  $  switxh(x1&0xff)0x00:y=@01d0;0x01:y=@0124;0x02:y=@0a15;
