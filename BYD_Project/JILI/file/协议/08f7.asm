...
读数据流: 
  ...
  $  REQ000:7D2 03 22 32 0F 00 00 00 00       $  ANS000:7DA 03 22 32 0F 00 00 00 00
  ...
  $  000.启停系统状态                  $    $  /         $    $  ANS000.BYTE004  $  if(x==0x00) y=@0202;else if(x==0x01) y=@0203;else if(x==0x02) y=@0204;else if(x==0x03) y=@0205;else if(x==0x04) y=@0206;else if(x==0x05) y=@0207;else if(x==0x06) y=@0208;else if(x==0xFF) y=@01b0;else y=@0209;
