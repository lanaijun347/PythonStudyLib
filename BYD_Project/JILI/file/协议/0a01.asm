...
读数据流: 
  ...
  $  REQ011:7D2 03 22 32 09 00 00 00 00       $  ANS011:7DA 03 22 32 09 00 00 00 00
  $  REQ012:7D2 03 22 32 0A 00 00 00 00       $  ANS012:7DA 03 22 32 0A 00 00 00 00
  $  REQ013:7D2 03 22 32 0B 00 00 00 00       $  ANS013:7DA 03 22 32 0B 00 00 00 00
  $  REQ014:7D2 03 22 32 0E 00 00 00 00       $  ANS014:7DA 03 22 32 0E 00 00 00 00
  $  REQ015:7D2 03 22 32 0F 00 00 00 00       $  ANS015:7DA 03 22 32 0F 00 00 00 00
  ...
  $  004.扭矩输出比值                  $    $  %         $    $  ANS004.BYTE004  $  y = X1 *(100/255);
  $  005.电机电流                      $    $  A         $    $  ANS005.BYTE004  $  if(x1>=0x80)y = (X1*256+x2-0x10000)*0.5;else y=(X1*256+x2)*0.5;
  ...
  $  008.扭矩传感器供电电压            $    $  V         $    $  ANS008.BYTE004  $  y = X1*0.1;
  $  009.电机输出扭矩                  $    $  Nm        $    $  ANS009.BYTE004  $  if(x1>=0x80)y = (X1*256+x2-0x10000)*0.01;else y=(X1*256+x2)*0.01;
  $  010.发动机状态                    $    $  /         $    $  ANS010.BYTE004  $  if(x1==0x00)y=@0204;else if(x1==0x01)y=@06a3;else if(x1==0x02)y=@0027;else if(x1==0x03)y=@09db;else if(x1==0xff)y=@06dd;else y=@0209;
  $  011.扭矩指令                      $    $  /         $    $  ANS011.BYTE004  $  y = x1* 1-20;
  $  012.电机位置                      $    $  deg       $    $  ANS012.BYTE004  $  y = (X1*256+x2)*(360/4096);
  $  013.电机速度                      $    $  rpm       $    $  ANS013.BYTE004  $  if(x1>=0x80)y=x1*256+x2-0x10000;else y=x1*256+x2;
  $  014.助力模式                      $    $  /         $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0374;else if(x1==0x01)y=@0375;else if(x1==0x02)y=@0376;else if(x1>=0x03&&x1<=0xFF)y=@0209;
  $  015.启停系统状态                  $    $  /         $    $  ANS015.BYTE004  $  if(x1==0x00)y=@06de;else if(x1==0x01)y=@06df;else if(x1==0x02)y=@06e0;else if(x1==0x03)y=@06e1;else if(x1==0x04)y=@06e2;else if(x1==0x05)y=@09dc;else if(x1==0x06)y=@09dd;else if(x1==0xFF)y=@06dd;else y=@0209;
