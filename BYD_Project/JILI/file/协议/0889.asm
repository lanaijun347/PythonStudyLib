...
版本信息:
  ...
  $%  012:标定软件版本号:                            $%    $%  ANS001.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
...
读数据流: 
  ...
  $  REQ018:7E5 03 22 64 18 00 00 00 00       $  ANS018:7ED 03 22 64 18 00 00 00 00
  $  REQ019:7E5 03 22 64 19 00 00 00 00       $  ANS019:7ED 03 22 64 19 00 00 00 00
  $  REQ020:7E5 03 22 64 1A 00 00 00 00       $  ANS020:7ED 03 22 64 1A 00 00 00 00
  $  REQ021:7E5 03 22 64 1C 00 00 00 00       $  ANS021:7ED 03 22 64 1C 00 00 00 00
  ...
  $  019.IMU(组合传感器)标定状态             $    $  /        $    $  ANS016.BYTE004  $  if(x==0x00)y=@0312;else if(x==0x01)y=@0c49;else if(x==0x02)y=@0313;else y=@0209;
  $  020.EOL(下线)配置模式                   $    $  /        $    $  ANS017.BYTE004  $  if(x==0x00)y=@030d;else if(x==0x01)y=@036b;else y=@0162;
  $  021.ACU(安全气囊控制单元)点火次数       $    $  /        $    $  ANS018.BYTE004  $  y=x1*256*256*256+x2*256*256+x3*256+x4;
  $  022.ACU(安全气囊控制单元)上电时间       $    $  s        $    $  ANS019.BYTE004  $  y=(x1*0x1000000+x2*0x10000+x3*0x100+x4)*5;
  $  023.第二排左侧安全带锁扣故障状态        $    $  /        $    $  ANS020.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
  $  024.第二排右侧安全带锁扣故障状态        $    $  /        $    $  ANS021.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
