...
读数据流: 
  ...
  $  REQ001:7A7 03 22 F1 00 00 00 00 00       $  ANS001:7AF 03 22 F1 00 00 00 00 00
  $  REQ002:7A7 03 22 6A 01 00 00 00 00       $  ANS002:7AF 03 22 6A 01 00 00 00 00

  $  000.ECU(电子控制器)供电电压       $    $  V     $    $  ANS000.BYTE004  $  y=x1*0.1;
  $  001.诊断拓扑                      $    $  /     $    $  ANS001.BYTE004  $  HEX(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
  $  002.IG 状态                       $    $  /     $    $  ANS002.BYTE004  $  if(x==0x00) y=@04d9; else if(x==0x01) y=@0f0d; else y=@000b;
