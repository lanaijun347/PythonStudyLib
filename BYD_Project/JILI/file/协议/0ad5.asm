...
读数据流: 
  ...
  $  022.ACU(安全气囊控制单元)点火次数       $    $  /        $    $  ANS018.BYTE004  $  y=x1*256*256*256+x2*256*256+x3*256+x4;
  $  023.ACU(安全气囊控制单元)上电时间       $    $  s        $    $  ANS019.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4)*5;
