...
读数据流: 
  ...
  $  026.点火循环次数                               $    $  /      $    $  ANS018.BYTE004  $  y=x1*256*256+x2*256+x3;
  ...
  $  029.左执行机构状态                             $    $  /      $    $  ANS015.BYTE004  $  switxh(x) 0x00:y=@025c;0x01:y=@025d;0x02:y=@025e;0x03:y=@025f;0x04:y=@0260;0x05:y=@0261;0x06:y=@0262;0x07:y=@0263;0x08:y=@0264;default:y=@0209;
  $  030.右执行机构状态                             $    $  /      $    $  ANS015.BYTE004  $  switxh(x) 0x00:y=@025c;0x01:y=@025d;0x02:y=@025e;0x03:y=@025f;0x04:y=@0260;0x05:y=@0261;0x06:y=@0262;0x07:y=@0263;0x08:y=@0264;0x09:y=@0265;default:y=@0209;
