...
读数据流: 
  ...
  $  REQ013:7E4 03 22 30 0B 00 00 00 00       $  ANS013:7EC 03 22 30 0B 00 00 00 00
  $  REQ014:7E4 03 22 30 0C 00 00 00 00       $  ANS014:7EC 03 22 30 0C 00 00 00 00
  ...
  $  029.左前轮速脉冲                               $    $  /         $    $  ANS013.BYTE004  $  y=(x1*0x100+x2)*1;
  $  030.右前轮速脉冲                               $    $  /         $    $  ANS013.BYTE006  $  y=(x1*0x100+x2)*1;
  $  031.左后轮速脉冲                               $    $  /         $    $  ANS013.BYTE008  $  y=(x1*0x100+x2)*1;
  $  032.右后轮速脉冲                               $    $  /         $    $  ANS013.BYTE010  $  y=(x1*0x100+x2)*1;
  $  033.左前轮速方向                               $    $  /         $    $  ANS014.BYTE004  $  switxh(x)0x00:y=@09d9;0x01:y=@0227;0x02:y=@0228;0x03:y=@001b;default:y=@0209;
  $  034.右前轮速方向                               $    $  /         $    $  ANS014.BYTE005  $  switxh(x)0x00:y=@09d9;0x01:y=@0227;0x02:y=@0228;0x03:y=@001b;default:y=@0209;
  $  035.左后轮速方向                               $    $  /         $    $  ANS014.BYTE006  $  switxh(x)0x00:y=@09d9;0x01:y=@0227;0x02:y=@0228;0x03:y=@001b;default:y=@0209;
  $  036.右后轮速方向                               $    $  /         $    $  ANS014.BYTE007  $  switxh(x)0x00:y=@09d9;0x01:y=@0227;0x02:y=@0228;0x03:y=@001b;default:y=@0209;
  $  037.左刹驱动次数                               $    $  /         $    $  ANS015.BYTE004  $  y=x1*0x1000000+x2*0x10000+x3*0x100+x4;
  $  038.右刹驱动次数                               $    $  /         $    $  ANS016.BYTE004  $  y=x1*0x1000000+x2*0x10000+x3*0x100+x4;
  $  039.左卡钳夹紧力                               $    $  N         $    $  ANS017.BYTE004  $  y=x1*0x100+x2;
  $  040.右卡钳夹紧力                               $    $  N         $    $  ANS018.BYTE004  $  y=x1*0x100+x2;
