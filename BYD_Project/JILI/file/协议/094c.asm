...
读数据流: 
  ...
  $  REQ008:7D1 03 22 71 07 00 00 00 00       $  ANS008:7D9 03 22 71 07 00 00 00 00
  ...
  $  REQ014:7D1 03 22 71 08 00 00 00 00       $  ANS014:7D9 03 22 71 08 00 00 00 00
  $  REQ015:7D1 03 22 71 14 00 00 00 00       $  ANS015:7D9 03 22 71 14 00 00 00 00
  $  REQ016:7D1 03 22 71 15 00 00 00 00       $  ANS016:7D9 03 22 71 15 00 00 00 00
  $  REQ017:7D1 03 22 71 16 00 00 00 00       $  ANS017:7D9 03 22 71 16 00 00 00 00
  $  REQ018:7D1 03 22 71 17 00 00 00 00       $  ANS018:7D9 03 22 71 17 00 00 00 00
  $  REQ019:7D1 03 22 71 18 00 00 00 00       $  ANS019:7D9 03 22 71 18 00 00 00 00
  $  REQ020:7D1 03 22 71 19 00 00 00 00       $  ANS020:7D9 03 22 71 19 00 00 00 00
  $  REQ021:7D1 03 22 71 20 00 00 00 00       $  ANS021:7D9 03 22 71 20 00 00 00 00
  ...
  $  008.ESCL(电子转向柱锁控制单元)转向锁状态         $    $  /        $    $  ANS008.BYTE004  $  switxh(x)0x00:y=@06ed;0x01:y=@06ee;0x02:y=@0027;0xFF:y=@0132;default:y=@0209;
  $  009.ESCL(电子转向柱锁控制单元)系统学习状态       $    $  /        $    $  ANS009.BYTE004  $  switxh(x)0x01:y=@06eb;0x02:y=@0131;0x03:y=@06ec;default:y=@0209;
  $  010.电源模式                                     $    $  /        $    $  ANS010.BYTE004  $  switxh(x)0x00:y=@010e;0x01:y=@015c;0x02:y=@0170;0x03:y=@015f;default:y=@0209;
  $  011.左前(驾驶员)车门开启／关闭状态               $    $  /        $    $  ANS011.BYTE004  $  switxh(x)0x00:y=@06e9;0x01:y=@06ea;default:y=@0209;
  $  012.引擎转速                                     $    $  rpm      $    $  ANS012.BYTE004  $  y=INT((x1*256+x2)*0.25);
  $  013.发动机状态信息                               $    $  /        $    $  ANS013.BYTE004  $  switxh(x)0x00:y=@0390;0x01:y=@0391;0x02:y=@0027;0xFF:y=@00be;default:y=@0209;
  $  014.ESCL(电子转向柱锁控制单元)认证是否成功       $    $  /        $    $  ANS014.BYTE004  $  switxh(x)0x00:y=@01b4;0x01:y=@01b3;default:y=@0209;
  $  015.ESCL(电子转向柱锁控制单元)内部温度           $    $  degC     $    $  ANS015.BYTE004  $  y=x*0.75-48;
  $  016.当前是否在热保护状态                         $    $  /        $    $  ANS016.BYTE004  $  switxh(x)0x00:y=@010e;0x01:y=@0170;default:y=@0209;
  $  017.ESCL(电子转向柱锁)故障状态1                  $    $  /        $    $  ANS017.BYTE004  $  switxh(x)0x00:y=@10c9;0x01:y=@10ca;0x02:y=@10cb;
  $  018.从单片机功能安全状态                         $    $  /        $    $  ANS018.BYTE004  $  switxh(x)0x00:y=@0ed6;0x01:y=@10cc;
  $  019.主单片机功能安全状态                         $    $  /        $    $  ANS019.BYTE004  $  switxh(x)0x00:y=@0ed6;0x01:y=@10cc;
  $  020.解锁反馈电流存在时间                         $    $  ms       $    $  ANS020.BYTE004  $  y=x;
  $  021.解锁最大电流                                 $    $  A        $    $  ANS021.BYTE004  $  y=x;
