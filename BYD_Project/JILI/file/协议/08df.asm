...
版本信息:
  ...
  $%  REQ010:750 03 22 F1 98 00 00 00 00       $%  ANS010:758 03 22 F1 98 00 00 00 00
  $%  REQ011:750 03 22 F1 99 00 00 00 00       $%  ANS011:758 03 22 F1 99 00 00 00 00
  $%  REQ012:750 03 22 F1 82 00 00 00 00       $%  ANS012:758 03 22 F1 82 00 00 00 00
...
读数据流: 
  ...
  $  000.车辆模式       $    $  /     $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0143;else if(x1==0x01)y=@0d44;else if(x1==0x02)y=@0d45;else if(x1==0x03)y=@0d46;else y=@0209;
