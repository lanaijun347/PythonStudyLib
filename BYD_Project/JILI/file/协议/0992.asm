...
读数据流: 
  ...
  $  013.第二排中间位置安全带锁扣状态        $    $  /        $    $  ANS013.BYTE004  $  strcat:if(((x>>0)&1) == 0) y=@0307;if(((x>>0)&1) == 1) y=@0306;if(((x>>1)&1) == 0) y=@01ac;if(((x>>1)&1) == 1) y=@051a;if(((x>>2)&1) == 0) y=@015a;if(((x>>2)&1) == 1) y=@015b;
  ...
  $  020.乘员座椅检测开关状态                $    $  /        $    $  ANS017.BYTE004  $  if(((x>>0)&1)) y=@0170;else y=@010e;
