...
读数据流: 
  ...
  $  REQ001:721 03 22 62 00 00 00 00 00       $  ANS001:729 03 22 62 00 00 00 00 00
  $  REQ002:721 03 22 62 04 00 00 00 00       $  ANS002:729 03 22 62 04 00 00 00 00
  $  REQ003:721 03 22 62 05 00 00 00 00       $  ANS003:729 03 22 62 05 00 00 00 00
  ...
  $  REQ007:721 03 22 62 09 00 00 00 00       $  ANS007:729 03 22 62 09 00 00 00 00
  $  REQ008:721 03 22 DF 05 00 00 00 00       $  ANS008:729 03 22 DF 05 00 00 00 00
  $  REQ009:721 03 22 62 0B 00 00 00 00       $  ANS009:729 03 22 62 0B 00 00 00 00
  $  REQ010:721 03 22 69 80 00 00 00 00       $  ANS010:729 03 22 69 80 00 00 00 00
  $  REQ011:721 03 22 69 81 00 00 00 00       $  ANS011:729 03 22 69 81 00 00 00 00
  $  REQ012:721 03 22 69 82 00 00 00 00       $  ANS012:729 03 22 69 82 00 00 00 00
  $  REQ013:721 03 22 69 83 00 00 00 00       $  ANS013:729 03 22 69 83 00 00 00 00
  $  REQ014:721 03 22 69 84 00 00 00 00       $  ANS014:729 03 22 69 84 00 00 00 00
  $  REQ015:721 03 22 69 85 00 00 00 00       $  ANS015:729 03 22 69 85 00 00 00 00

  $  000.ECU(电子控制器)电压                                       $    $  V        $    $  ANS000.BYTE004  $  if(x==0xff) y=@0008; else y=x*0.1;
  $  001.冷却液温度                                                $    $  degC     $    $  ANS001.BYTE004  $  y=x*0.75-36.8;
  $  002.总里程                                                    $    $  km       $    $  ANS002.BYTE004  $  y=x1*0x10000+x2*0x100+x3;
  $  003.剩余保养里程                                              $    $  km       $    $  ANS003.BYTE004  $  if((x1*0x100+x2)==0xffff)y=@0008;else if((x1*0x100+x2)>=0x2711 && (x1*0x100+x2)<=0xFFFE)y=@0209;else y=x1*256+x2;
  ...
  $  007.第二软件版本号                                            $    $  /        $    $  ANS007.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
  $  008.发动机转速                                                $    $  rpm      $    $  ANS008.BYTE004  $  y=INT((x1*256+x2)*0.25);
  $  009.第二软件版本号                                            $    $  /        $    $  ANS007.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
  $  010.燃油传感器电阻值                                          $    $  ohm      $    $  ANS009.BYTE004  $  y=x1*0x100+x2;
  $  011.抬头显示屏控制器主开关                                    $    $  /        $    $  ANS010.BYTE004  $  if(x==0x00)y=@01cf;else if(x==0x01)y=@04d6;
  $  012.抬头显示屏控制器上调开关                                  $    $  /        $    $  ANS011.BYTE004  $  if(x==0x00)y=@01cf;else if(x==0x01)y=@04d6;
  $  013.抬头显示屏控制器下调开关                                  $    $  /        $    $  ANS012.BYTE004  $  if(x==0x00)y=@01cf;else if(x==0x01)y=@04d6;
  $  014.抬头显示屏控制器软件版本                                  $    $  /        $    $  ANS013.BYTE004  $  HEX(x1,x2,x3);
  $  015.抬头显示屏控制器硬件版本                                  $    $  /        $    $  ANS014.BYTE004  $  HEX(x1,x2);
  $  016.抬头显示屏控制器 EEPROM(电可擦除只读存储器)数据版本       $    $  /        $    $  ANS015.BYTE004  $  HEX(x1,x2,x3);
