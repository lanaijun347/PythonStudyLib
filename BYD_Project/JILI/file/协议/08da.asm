...
读数据流: 
  ...
  $  REQ024:7E5 03 22 64 1D 00 00 00 00       $  ANS024:7ED 03 22 64 1D 00 00 00 00
  $  REQ025:7E5 03 22 64 1E 00 00 00 00       $  ANS025:7ED 03 22 64 1E 00 00 00 00
  ...
  $  028.第二排右侧安全带锁扣状态            $    $  /        $    $  ANS023.BYTE004  $  if(((x>>0)&1))y=@0307;else y=@0306;
  $  029.第二排右侧安全带锁扣故障状态        $    $  /        $    $  ANS023.BYTE004  $  if(((x>>1)&1))y=@051a;else y=@01ac;
  $  030.第三排中间安全带锁扣状态            $    $  /        $    $  ANS024.BYTE004  $  if(((x>>0)&1))y=@0306;else y=@0307;
  $  031.第三排右侧安全带锁扣状态            $    $  /        $    $  ANS025.BYTE004  $  if(((x>>0)&1))y=@0306;else y=@0307;
