...
读数据流: 
  ...
  $  REQ001:7E3 03 22 62 04 00 00 00 00       $  ANS001:7EB 03 22 62 04 00 00 00 00
  $  REQ002:7E3 03 22 62 07 00 00 00 00       $  ANS002:7EB 03 22 62 07 00 00 00 00
  $  REQ003:7E3 03 22 62 08 00 00 00 00       $  ANS003:7EB 03 22 62 08 00 00 00 00
  $  REQ004:7E3 03 22 62 0A 00 00 00 00       $  ANS004:7EB 03 22 62 0A 00 00 00 00

  $  000.ECU(电子控制器)电压       $    $  V      $    $  ANS000.BYTE004  $  if(x==0xff) y=@0008; else y=x*0.1;
  $  001.总里程                    $    $  km     $    $  ANS001.BYTE004  $  y=x1*0x10000+x2*0x100+x3;
  $  002.仪表里程清零次数          $    $  /      $    $  ANS002.BYTE004  $  y=x;
  $  003.备份里程                  $    $  km     $    $  ANS003.BYTE004  $  y=x1*0x10000+x2*0x100+x3;
  $  004.里程备份次数              $    $  /      $    $  ANS004.BYTE004  $  y=x1*0x100+x2;
