...
版本信息:
  ...
  $%  REQ007:7E5 03 22 F1 93 00 00 00 00       $%  ANS007:7ED 03 22 F1 93 00 00 00 00
  $%  REQ008:7E5 03 22 F1 95 00 00 00 00       $%  ANS008:7ED 03 22 F1 95 00 00 00 00
  $%  REQ009:7E5 03 22 F1 98 00 00 00 00       $%  ANS009:7ED 03 22 F1 98 00 00 00 00
  $%  REQ010:7E5 03 22 F1 99 00 00 00 00       $%  ANS010:7ED 03 22 F1 99 00 00 00 00
...
读数据流: 
  ...
  $  REQ015:7E5 03 22 F0 2A 00 00 00 00       $  ANS015:7ED 03 22 F0 2A 00 00 00 00
  $  REQ016:7E5 03 22 F0 2C 00 00 00 00       $  ANS016:7ED 03 22 F0 2C 00 00 00 00
  $  REQ017:7E5 03 22 F0 2D 00 00 00 00       $  ANS017:7ED 03 22 F0 2D 00 00 00 00
  $  REQ018:7E5 03 22 F0 2E 00 00 00 00       $  ANS018:7ED 03 22 F0 2E 00 00 00 00
  $  REQ019:7E5 03 22 F0 44 00 00 00 00       $  ANS019:7ED 03 22 F0 44 00 00 00 00
  $  REQ020:7E5 03 22 F0 31 00 00 00 00       $  ANS020:7ED 03 22 F0 31 00 00 00 00
  $  REQ021:7E5 03 22 F0 34 00 00 00 00       $  ANS021:7ED 03 22 F0 34 00 00 00 00
  $  REQ022:7E5 03 22 F0 35 00 00 00 00       $  ANS022:7ED 03 22 F0 35 00 00 00 00
  $  REQ023:7E5 03 22 F0 41 00 00 00 00       $  ANS023:7ED 03 22 F0 41 00 00 00 00

  $  000.IMU(组合传感器)标定状态                          $    $  /       $    $  ANS000.BYTE004  $  if(x==0x00)y=@0312;else if(x==0x01)y=@0c49;else if(x==0x02)y=@0313;else y=@0209;
  $  001.ECU(电子控制器)客户模式                          $    $  /       $    $  ANS001.BYTE004  $  switxh(x) 0x00: y=@0787; 0xFF: y=@0cda;
  ...
  $  015.乘员安全气囊传感器                               $    $  ohm     $    $  ANS015.BYTE004  $  y=x*2;
  $  016.后排左侧安全带锁扣阻抗                           $    $  ohm     $    $  ANS016.BYTE004  $  y=x*2;
  $  017.后排中间安全带锁扣阻抗                           $    $  ohm     $    $  ANS017.BYTE004  $  y=x*2;
  $  018.后排右侧安全带锁扣阻抗                           $    $  ohm     $    $  ANS018.BYTE004  $  y=x*2;
  $  019.前排乘员检测阻抗                                 $    $  ohm     $    $  ANS019.BYTE004  $  if((x*2)<0xFD)y=x*2;else y=@0c53;
  $  020.前排驾驶员传感器状态                             $    $  /       $    $  ANS020.BYTE004  $  switxh((((x>>1)&1))*2+(((x>>0)&1))) 0x00: y=@0cdb; 0x01: y=@0cdc; 0x10: y=@01b0;
  $  021.前排乘员传感器状态                               $    $  /       $    $  ANS021.BYTE004  $  switxh((((x>>1)&1))*2+(((x>>0)&1))) 0x00: y=@0cdb; 0x01: y=@0cdc; 0x10: y=@01b0;
  $  022.前排乘员安全气囊开关状态                         $    $  /       $    $  ANS022.BYTE004  $  switxh((((x>>1)&1))*2+(((x>>0)&1))) 0x00: y=@0cd3; 0x01: y=@0cd4; 0x10: y=@01b0;
  $  023.前排乘员检测传感器状态                           $    $  /       $    $  ANS023.BYTE004  $  switxh((((x>>1)&1))*2+(((x>>0)&1))) 0x00: y=@0c50; 0x01: y=@0c51; 0x10: y=@01b0;
