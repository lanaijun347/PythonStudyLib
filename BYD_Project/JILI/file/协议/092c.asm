...
读数据流: 
  ...
  $  004.逻辑输出状态                                 $    $  /        $    $  ANS004.BYTE004  $  if(((x1>>0)&1))y=@001c;else y=@001d;
  ...
  $  008.无线充电禁止线输出状态                       $    $  /        $    $  ANS005.BYTE004  $  if(((x>>0)&1))y=@001c;else y=@001d;
  $  009.最大远程发动机运行时间                       $    $  min      $    $  ANS006.BYTE004  $  y=x;
  $  010.最大远程启动时间                             $    $  s        $    $  ANS006.BYTE005  $  y=x;
  $  011.最大远程关窗确认时间                         $    $  s        $    $  ANS006.BYTE006  $  y=x;
  $  012.最大远程闭解锁时间                           $    $  s        $    $  ANS006.BYTE007  $  y=x;
  $  013.最大远程开窗确认时间                         $    $  s        $    $  ANS006.BYTE008  $  y=x;
  $  014.手机蓝牙钥匙序列号                           $    $  /        $    $  ANS007.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8);
  $  015.手机蓝牙钥匙软件版本号                       $    $  /        $    $  ANS008.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8);
  $  016.当前手机蓝牙钥匙数量                         $    $  /        $    $  ANS009.BYTE004  $  y=x;
  $  017.读取脚踢模块零件号信息                       $    $  /        $    $  ANS010.BYTE004  $  HEX(x1,x2,x3,x4,x5,x6,x7,x8);
  $  018.读取脚踢模块硬件版本号                       $    $  /        $    $  ANS011.BYTE004  $  y=HEX(x1,x2);
  $  019.读取脚踢模块软件版本号                       $    $  /        $    $  ANS012.BYTE004  $  y=HEX(x1,x2);
  $  020.读取脚踢模块供应商码                         $    $  /        $    $  ANS013.BYTE004  $  y=HEX(x1,x2,x3);
...
30帧:
  ...
  $FC REQ001:795 30 00 0B 00 00 00 00 00  $FC 
