...
读数据流: 
  ...
  $  REQ015:7E4 03 22 36 04 00 00 00 00       $  ANS015:7EC 03 22 36 04 00 00 00 00
  $  REQ016:7E4 03 22 36 05 00 00 00 00       $  ANS016:7EC 03 22 36 05 00 00 00 00
  ...
  $  029.左后轮速脉冲                               $    $  /         $    $  ANS013.BYTE008  $  y=(x1*0x100+x2)*1;
  $  030.右后轮速脉冲                               $    $  /         $    $  ANS013.BYTE010  $  y=(x1*0x100+x2)*1;
  $  031.左前轮速方向                               $    $  /         $    $  ANS014.BYTE004  $  switxh(x)0x00:y=@09d9;0x01:y=@0227;0x02:y=@0228;0x03:y=@001b;default:y=@0209;
  $  032.右前轮速方向                               $    $  /         $    $  ANS014.BYTE005  $  switxh(x)0x00:y=@09d9;0x01:y=@0227;0x02:y=@0228;0x03:y=@001b;default:y=@0209;
  $  033.左后轮速方向                               $    $  /         $    $  ANS014.BYTE006  $  switxh(x)0x00:y=@09d9;0x01:y=@0227;0x02:y=@0228;0x03:y=@001b;default:y=@0209;
  $  034.右后轮速方向                               $    $  /         $    $  ANS014.BYTE007  $  switxh(x)0x00:y=@09d9;0x01:y=@0227;0x02:y=@0228;0x03:y=@001b;default:y=@0209;
  $  035.左卡钳夹紧力                               $    $  N         $    $  ANS015.BYTE004  $  y=x1*0x100+x2;
  $  036.右卡钳夹紧力                               $    $  N         $    $  ANS016.BYTE004  $  y=x1*0x100+x2;
