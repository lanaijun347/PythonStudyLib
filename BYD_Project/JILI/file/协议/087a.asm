...
版本信息:
  ...
  $%  REQ012:795 03 22 F1 97 00 00 00 00       $%  ANS012:79D 03 22 F1 97 00 00 00 00
...
读数据流: 
  ...
  $  REQ002:795 03 22 65 02 00 00 00 00       $  ANS002:79D 03 22 65 02 00 00 00 00
  ...
  $  002.已学习钥匙数量                $    $  /        $    $  ANS002.BYTE004  $  y=x;
