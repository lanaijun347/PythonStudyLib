...
读数据流: 
  ...
  $  REQ044:7E0 03 22 02 02 00 00 00 00       $  ANS044:7E8 03 22 02 02 00 00 00 00
  $  REQ045:7E0 03 22 01 96 00 00 00 00       $  ANS045:7E8 03 22 01 96 00 00 00 00
  $  REQ046:7E0 03 22 01 97 00 00 00 00       $  ANS046:7E8 03 22 01 97 00 00 00 00
  $  REQ047:7E0 03 22 01 DD 00 00 00 00       $  ANS047:7E8 03 22 01 DD 00 00 00 00
  ...
  $  044.控制器防盗状态                                $    $  /           $    $  ANS044.BYTE004  $  if(x1==0x01)y=@0131;else if(x1==0x02)y=@06db;else y=@0132;
  $  045.发动机运行时间                                $    $  s           $    $  ANS045.BYTE004  $  y=(x1*0x1000000+x2*0x10000+x3*0x100+x4)*1;
  $  046.MIL(故障指示灯)故障后的行驶里程               $    $  km          $    $  ANS046.BYTE004  $  y=(x1*0x100+x2)*1;
  $  047.主继电器状态                                  $    $  /           $    $  ANS047.BYTE004  $  switxh(x) 0x00:y=@0c62;0x01:y=@0c63;
