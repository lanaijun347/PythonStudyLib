...
读数据流: 
  ...
  $  REQ003:7E6 03 22 4C 03 00 00 00 00       $  ANS003:7EE 03 22 4C 03 00 00 00 00
  $  REQ004:7E6 03 22 4C 04 00 00 00 00       $  ANS004:7EE 03 22 4C 04 00 00 00 00
  $  REQ005:7E6 03 22 4C 05 00 00 00 00       $  ANS005:7EE 03 22 4C 05 00 00 00 00
  $  REQ006:7E6 03 22 4C 06 00 00 00 00       $  ANS006:7EE 03 22 4C 06 00 00 00 00
  $  REQ007:7E6 03 22 4C 07 00 00 00 00       $  ANS007:7EE 03 22 4C 07 00 00 00 00
  $  REQ008:7E6 03 22 4C 08 00 00 00 00       $  ANS008:7EE 03 22 4C 08 00 00 00 00
  $  REQ009:7E6 03 22 4C 09 00 00 00 00       $  ANS009:7EE 03 22 4C 09 00 00 00 00
  $  REQ010:7E6 03 22 4C 10 00 00 00 00       $  ANS010:7EE 03 22 4C 10 00 00 00 00
  $  REQ011:7E6 03 22 4C 11 00 00 00 00       $  ANS011:7EE 03 22 4C 11 00 00 00 00
  $  REQ012:7E6 03 22 4C 12 00 00 00 00       $  ANS012:7EE 03 22 4C 12 00 00 00 00
  $  REQ013:7E6 03 22 4C 13 00 00 00 00       $  ANS013:7EE 03 22 4C 13 00 00 00 00
  $  REQ014:7E6 03 22 4C 14 00 00 00 00       $  ANS014:7EE 03 22 4C 14 00 00 00 00
  $  REQ015:7E6 03 22 4C 15 00 00 00 00       $  ANS015:7EE 03 22 4C 15 00 00 00 00
  ...
  $  REQ033:7E6 03 22 4C 34 00 00 00 00       $  ANS033:7EE 03 22 4C 34 00 00 00 00
  $  REQ034:7E6 03 22 4C 35 00 00 00 00       $  ANS034:7EE 03 22 4C 35 00 00 00 00
  $  REQ035:7E6 03 22 4C 36 00 00 00 00       $  ANS035:7EE 03 22 4C 36 00 00 00 00
  $  REQ036:7E6 03 22 4C 37 00 00 00 00       $  ANS036:7EE 03 22 4C 37 00 00 00 00
  $  REQ037:7E6 03 22 4C 38 00 00 00 00       $  ANS037:7EE 03 22 4C 38 00 00 00 00
  $  REQ038:7E6 03 22 4C 39 00 00 00 00       $  ANS038:7EE 03 22 4C 39 00 00 00 00
  $  REQ039:7E6 03 22 4C 40 00 00 00 00       $  ANS039:7EE 03 22 4C 40 00 00 00 00
  $  REQ040:7E6 03 22 4C 41 00 00 00 00       $  ANS040:7EE 03 22 4C 41 00 00 00 00
  $  REQ041:7E6 03 22 4C 42 00 00 00 00       $  ANS041:7EE 03 22 4C 42 00 00 00 00
  $  REQ042:7E6 03 22 4C 43 00 00 00 00       $  ANS042:7EE 03 22 4C 43 00 00 00 00
  $  REQ043:7E6 03 22 4C 44 00 00 00 00       $  ANS043:7EE 03 22 4C 44 00 00 00 00
  $  REQ044:7E6 03 22 4C 4B 00 00 00 00       $  ANS044:7EE 03 22 4C 4B 00 00 00 00
  ...
  $  003.电动系统准备状态                                                 $    $  /        $    $  ANS003.BYTE004  $  switxh(x)0x00:y=@0190;0x01:y=@0191;default:y=@0162;
  $  004.当前挡位状态                                                     $    $  /        $    $  ANS004.BYTE004  $  if(x1==0x0)y=@017b;if(x1==0xC)y=@017a;else if(x1==0xA)y=@0ed4;else if(x1==0xB)y=@0ed5;else if(x1==0xF)y=@0ed6;else y=@0209;
  $  005.主动限速控制设置的速度值                                         $    $  /        $    $  ANS005.BYTE004  $  if(x==0xff)y=@0132;else y=x;
  $  006.车轮端扭矩                                                       $    $  Nm       $    $  ANS006.BYTE004  $  if((x1*0x100+x2)<0x2ee1)y=(x1*256+x2)-6000;else y=@0008;
  $  007.驾驶员需求扭矩                                                   $    $  Nm       $    $  ANS007.BYTE004  $  if((x1*0x100+x2)<0x2ee1)y=(x1*256+x2)-6000;else y=@0008;
  $  008.判断驾驶员通过油门踏板请求的扭矩                                 $    $  /        $    $  ANS008.BYTE004  $  if(x1==0x0)y=@0eb0;else if(x1==0x1)y=@0ed7;else y=@0209;
  $  009.ePT系统启动过程                                                  $    $  /        $    $  ANS009.BYTE004  $  switxh(x)0x0:y=@0eb2;0x1:y=@0eb3;
  $  010.定速巡航控制状态                                                 $    $  /        $    $  ANS010.BYTE004  $  switxh(x)0x0:y=@0eaa;0x1:y=@0eab;0x2:y=@0eac;0x3:y=@0ae1;0x4:y=@02fc;0x5:y=@0ead;0x6:y=@0eae;0x7:y=@0eaf;
  $  011.巡航开关状态                                                     $    $  /        $    $  ANS011.BYTE004  $  switxh(x)0x0:y=@0000;0x1:y=@0001;
  $  012.巡航控制设置的速度值                                             $    $  km/h     $    $  ANS012.BYTE004  $  if(x==0xff)y=@0132;else y=x;
  $  013.ePT最大可用制动能量回收扭矩                                      $    $  Nm       $    $  ANS013.BYTE004  $  if((x1*0x100+x2)<0xfa1)y=(x1*0x100+x2)-4000;else y=@0132;
  $  014.ePT系统实际回收扭矩                                              $    $  Nm       $    $  ANS014.BYTE004  $  if((x1*0x100+x2)<0xfa1)y=(x1*0x100+x2)-4000;else y=@0132;
  $  015.当前油门踩压位置                                                 $    $  %        $    $  ANS015.BYTE004  $  if(x<0xfb)y=x*0.4;else y=@0008;
  ...
  $  033.VCU(整车控制器)净扭矩请求                                        $    $  Nm       $    $  ANS033.BYTE004  $  if((x1*0x100+x2)<0x2ee1)y=(x1*256+x2)-6000;else y=@0008;
  $  034.VLC的VCU(整车控制器)净扭矩请求是否激活                           $    $  /        $    $  ANS034.BYTE004  $  switxh(x)0x0:y=@001d;0x1:y=@001c;
  $  035.左前轮速信号                                                     $    $  km/h     $    $  ANS035.BYTE004  $  if((x1*0x100+x2)<0x1fff)y=INT((x1*0x100+x2)*0.05625);else y=@0132;
  $  036.左前轮轮速值有效状态位                                           $    $  /        $    $  ANS036.BYTE004  $  switxh(x)0x0:y=@0204;0x1:y=@0227;0x2:y=@0228;0x3:y=@0132;
  $  037.右前轮速信号                                                     $    $  km/h     $    $  ANS037.BYTE004  $  if((x1*0x100+x2)<0x1fff)y=INT((x1*0x100+x2)*0.05625);else y=@0132;
  $  038.右前轮轮速值有效状态位                                           $    $  /        $    $  ANS038.BYTE004  $  switxh(x)0x0:y=@0204;0x1:y=@0227;0x2:y=@0228;0x3:y=@0132;
  $  039.主缸压力                                                         $    $  bar      $    $  ANS039.BYTE004  $  if(x==0xff)y=@0132;else y=x;
  $  040.左后轮速信号                                                     $    $  km/h     $    $  ANS040.BYTE004  $  if((x1*0x100+x2)<0x1fff)y=INT((x1*0x100+x2)*0.05625);else y=@0132;
  $  041.左后轮轮速值有效状态位                                           $    $  /        $    $  ANS041.BYTE004  $  switxh(x)0x0:y=@0204;0x1:y=@0227;0x2:y=@0228;0x3:y=@0132;
  $  042.右后轮速信号                                                     $    $  km/h     $    $  ANS042.BYTE004  $  if((x1*0x100+x2)<0x1fff)y=INT((x1*0x100+x2)*0.05625);else y=@0132;
  $  043.右后轮轮速值有效状态位                                           $    $  /        $    $  ANS043.BYTE004  $  switxh(x)0x0:y=@0204;0x1:y=@0227;0x2:y=@0228;0x3:y=@0132;
  $  044.IPU(集成动力控制器)_TDcDcDCDC(DC-DC转换控制器)温度               $    $  degC     $    $  ANS044.BYTE004  $  y=x-40;
