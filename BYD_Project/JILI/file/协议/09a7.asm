...
读数据流: 
  ...
  $  REQ021:7A0 03 22 68 1F 00 00 00 00       $  ANS021:7A8 03 22 68 1F 00 00 00 00
  $  REQ022:7A0 03 22 68 20 00 00 00 00       $  ANS022:7A8 03 22 68 20 00 00 00 00
  $  REQ023:7A0 03 22 68 22 00 00 00 00       $  ANS023:7A8 03 22 68 22 00 00 00 00
  $  REQ024:7A0 03 22 68 2D 00 00 00 00       $  ANS024:7A8 03 22 68 2D 00 00 00 00
  $  REQ025:7A0 03 22 68 2E 00 00 00 00       $  ANS025:7A8 03 22 68 2E 00 00 00 00
  $  REQ026:7A0 03 22 68 31 00 00 00 00       $  ANS026:7A8 03 22 68 31 00 00 00 00
  $  REQ027:7A0 03 22 68 23 00 00 00 00       $  ANS027:7A8 03 22 68 23 00 00 00 00
  $  REQ028:7A0 03 22 68 24 00 00 00 00       $  ANS028:7A8 03 22 68 24 00 00 00 00
  $  REQ029:7A0 03 22 68 25 00 00 00 00       $  ANS029:7A8 03 22 68 25 00 00 00 00
  $  REQ030:7A0 03 22 68 29 00 00 00 00       $  ANS030:7A8 03 22 68 29 00 00 00 00
  $  REQ031:7A0 03 22 68 2A 00 00 00 00       $  ANS031:7A8 03 22 68 2A 00 00 00 00
  ...
  $  006.内部电池状态                                                                $    $  /         $    $  ANS006.BYTE004  $  switxh(x)0x00:y=@101e;0x01:y=@0532;0x02:y=@0533;0x03:y=@0534;default:y=@0162;
  ...
  $  022.开始读取故障信息延时时间(车辆电源IG-ON持续XX秒数后开始故障读取的时间)       $    $  s         $    $  ANS021.BYTE004  $  y=x;
  $  023.故障信息定时上传间隔时间(前一次上传XX分钟数后再次开始故障读取的时间)        $    $  min       $    $  ANS022.BYTE004  $  y=x;
  $  024.远程控制超时时间                                                            $    $  s         $    $  ANS023.BYTE004  $  y=x;
  $  025.ESK写入状态                                                                 $    $  /         $    $  ANS024.BYTE004  $  switxh(x)0x00:y=@0536;0x01:y=@0f0e;default:y=@0162;
  $  026.睡眠时间标定                                                                $    $  s         $    $  ANS025.BYTE004  $  y=x1*256+x2;
  $  027.PKI写入状态                                                                 $    $  /         $    $  ANS026.BYTE004  $  switxh(x)0x00:y=@0901;0x01:y=@09de;default:y=@0162;
  $  028.服务器反馈超时时间                                                          $    $  s         $    $  ANS027.BYTE004  $  y=x;
  $  029.TBOX(远程信息处理控制器)数据上传重试次数                                    $    $  /         $    $  ANS028.BYTE004  $  y=x;
  $  030.TBOX(远程信息处理控制器)数据上传重试间隔时间                                $    $  min       $    $  ANS029.BYTE004  $  y=x;
  $  031.空气质量信息定时上传间隔时间                                                $    $  min       $    $  ANS030.BYTE004  $  y=x;
  $  032.驾驶行为信息定时上传间隔时间                                                $    $  min       $    $  ANS031.BYTE004  $  y=x;
