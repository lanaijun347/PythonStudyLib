...
读数据流: 
  ...
  $  REQ007:794 03 22 10 00 00 00 00 00       $  ANS007:79C 03 22 10 00 00 00 00 00
  ...
  $  004.车速                             $    $  km/h     $    $  ANS004.BYTE004  $  if((x1==0x1f) && (x2==0xff)) y=@0008; else y=INT((x1*256+x2)*0.05625);
  $  005.旋钮软件版本号                   $    $  /        $    $  ANS005.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
  $  006.面板软件版本号                   $    $  /        $    $  ANS006.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
  $  007.EGSM(电子换档器)传感器位置       $    $  /        $    $  ANS007.BYTE004  $  if((x1==0xff) && (x2==0xa4))y=@10c2;else if((x1==0xff) && (x2==0xa8))y=@10c3; else if((x1==0xff) && (x2==0xb0))y=@10c4;else if((x1==0xff) && (x2==0xa2))y=@10c5;else if((x1==0xff) && (x2==0xa1))y=@10c6;else if((x1==0xff) && (x2==0xc4))y=@06cb;else if((x1==0xff) && (x2==0xc8))y=@10c7;else if((x1==0xff) && (x2==0xc2))y=@10c8; else if((x1==0xff) && (x2==0xff))y=@0008;else y=@000b;
