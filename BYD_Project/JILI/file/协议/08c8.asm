...
读数据流: 
  ...
  $  REQ006:7E4 03 22 30 05 00 00 00 00       $  ANS006:7EC 03 22 30 05 00 00 00 00
  $  REQ007:7E4 03 22 30 06 00 00 00 00       $  ANS007:7EC 03 22 30 06 00 00 00 00
  $  REQ008:7E4 03 22 30 07 00 00 00 00       $  ANS008:7EC 03 22 30 07 00 00 00 00
  $  REQ009:7E4 03 22 30 08 00 00 00 00       $  ANS009:7EC 03 22 30 08 00 00 00 00
  $  REQ010:7E4 03 22 30 09 00 00 00 00       $  ANS010:7EC 03 22 30 09 00 00 00 00
  $  REQ011:7E4 03 22 30 0A 00 00 00 00       $  ANS011:7EC 03 22 30 0A 00 00 00 00

  $  000.ECU(电子控制器)供电电压       $    $  V         $    $  ANS000.BYTE004  $  if(x<0xff) y=x*0.1; else y=@0008;
  ...
  $  006.阀继电器状态                  $    $  /         $    $  ANS005.BYTE004  $  switxh(x)0x00:y=@0000;0x01:y=@0001;default:y=@0162;
  $  007.泵马达状态                    $    $  /         $    $  ANS005.BYTE005  $  switxh(x)0x00:y=@0000;0x01:y=@0001;default:y=@0162;
  $  008.左前进气阀状态                $    $  /         $    $  ANS005.BYTE006  $  if(((x>>0)&1))y=@0001;else y=@0000;
  $  009.左前排气阀状态                $    $  /         $    $  ANS005.BYTE006  $  if(((x>>1)&1))y=@0001;else y=@0000;
  $  010.右前进气阀状态                $    $  /         $    $  ANS005.BYTE006  $  if(((x>>2)&1))y=@0001;else y=@0000;
  $  011.右前排气阀状态                $    $  /         $    $  ANS005.BYTE006  $  if(((x>>3)&1))y=@0001;else y=@0000;
  $  012.左后进气阀状态                $    $  /         $    $  ANS005.BYTE006  $  if(((x>>4)&1))y=@0001;else y=@0000;
  $  013.左后排气阀状态                $    $  /         $    $  ANS005.BYTE006  $  if(((x>>5)&1))y=@0001;else y=@0000;
  $  014.右后进气阀状态                $    $  /         $    $  ANS005.BYTE006  $  if(((x>>6)&1))y=@0001;else y=@0000;
  $  015.右后排气阀状态                $    $  /         $    $  ANS005.BYTE006  $  if(((x>>7)&1))y=@0001;else y=@0000;
  $  016.主缸压力                      $    $  bar       $    $  ANS006.BYTE004  $  if((x1*0x100+x2)<0x7FFF)y=(x1*0x100+x2)*0.0153;else if((x1*0x100+x2)>0x7FFF) y=((x1*0x100+x2)-0x10000)*0.0153;else y=@0132;
  $  017.转向角                        $    $  deg       $    $  ANS007.BYTE004  $  if((x1*0x100+x2)<0x7FFF)y=(x1*0x100+x2)*0.1;else if((x1*0x100+x2)>0x7FFF) y=((x1*0x100+x2)-0x10000)*0.1;else y=@0132;
  $  018.横摆角                        $    $  rad/s     $    $  ANS008.BYTE004  $  if((x1*0x100+x2)<0x7FFF)y=(x1*0x100+x2)*0.00213;else if((x1*0x100+x2)>0x7FFF) y=((x1*0x100+x2)-0x10000)*0.00213;else y=@0132;
  $  019.横向加速度                    $    $  m/s^2     $    $  ANS009.BYTE004  $  if((x1*0x100+x2)<0x7FFF)y=(x1*0x100+x2)*0.02712;else if((x1*0x100+x2)>0x7FFF) y=((x1*0x100+x2)-0x10000)*0.02712;else y=@0132;
  $  020.纵向加速度                    $    $  m/s^2     $    $  ANS010.BYTE004  $  if((x1*0x100+x2)<0x7FFF)y=(x1*0x100+x2)*0.02712;else if((x1*0x100+x2)>0x7FFF) y=((x1*0x100+x2)-0x10000)*0.02712;else y=@0132;
  $  021.电子驻车状态                  $    $  /         $    $  ANS011.BYTE004  $  switxh(x)0x00:y=@0018;0x01:y=@0019;0x02:y=@0f0c;default:y=@0209;
