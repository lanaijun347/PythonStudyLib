...
版本信息:
  ...
  $%  REQ004:7A7 03 22 F1 8C 00 00 00 00       $%  ANS004:7AF 03 22 F1 8C 00 00 00 00
  $%  REQ005:7A7 03 22 F1 90 00 00 00 00       $%  ANS005:7AF 03 22 F1 90 00 00 00 00
  $%  REQ006:7A7 03 22 F1 93 00 00 00 00       $%  ANS006:7AF 03 22 F1 93 00 00 00 00
  $%  REQ007:7A7 03 22 F1 95 00 00 00 00       $%  ANS007:7AF 03 22 F1 95 00 00 00 00
  $%  REQ008:7A7 03 22 F1 99 00 00 00 00       $%  ANS008:7AF 03 22 F1 99 00 00 00 00
  $%  REQ009:7A7 03 22 F1 80 00 00 00 00       $%  ANS009:7AF 03 22 F1 80 00 00 00 00
  ...
  $%  009:驱动层软件版本:                   $%    $%  ANS009.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
...
读数据流: 
  ...
  $  REQ002:7A7 03 22 02 00 00 00 00 00       $  ANS002:7AF 03 22 02 00 00 00 00 00
  $  REQ003:7A7 03 22 02 01 00 00 00 00       $  ANS003:7AF 03 22 02 01 00 00 00 00

  $  000.ECU(电子控制器)供电电压           $    $  V     $    $  ANS000.BYTE004  $  y=x1*0.1;
  $  001.IG 状态                           $    $  /     $    $  ANS001.BYTE004  $  if(x==0x00)y=@04d9;else if(x==0x01)y=@0f0d;else y=@0162;
  $  002.ECU(电子控制器)成功刷写次数       $    $  /     $    $  ANS002.BYTE004  $  HEX(x);
  $  003.ECU(电子控制器)尝试刷写次数       $    $  /     $    $  ANS003.BYTE004  $  HEX(x);
