...
版本信息:
  ...
  $%  REQ002:7D1 03 22 F1 89 00 00 00 00       $%  ANS002:7D9 03 22 F1 89 00 00 00 00
  ...
  $%  REQ009:7D1 03 22 F1 97 00 00 00 00       $%  ANS009:7D9 03 22 F1 97 00 00 00 00
  $%  REQ010:7D1 03 22 F1 98 00 00 00 00       $%  ANS010:7D9 03 22 F1 98 00 00 00 00
  $%  REQ011:7D1 03 22 F1 99 00 00 00 00       $%  ANS011:7D9 03 22 F1 99 00 00 00 00
  $%  REQ012:7D1 03 22 F1 9D 00 00 00 00       $%  ANS012:7D9 03 22 F1 9D 00 00 00 00
  $%  REQ013:7D1 03 22 F1 82 00 00 00 00       $%  ANS013:7D9 03 22 F1 82 00 00 00 00
...
读数据流: 
  ...
  $  REQ014:7D1 03 22 71 14 00 00 00 00       $  ANS014:7D9 03 22 71 14 00 00 00 00
  $  REQ015:7D1 03 22 71 15 00 00 00 00       $  ANS015:7D9 03 22 71 15 00 00 00 00

  $  000.系统电压                                     $    $  V        $    $  ANS000.BYTE004  $  y=x*0.1;
  $  001.H桥供应晶体管                                $    $  /        $    $  ANS001.BYTE004  $  if(00==x)y=@001d;else if(01==x)y=@001c;else y=@0162;
  $  002.上电次数                                     $    $  /        $    $  ANS002.BYTE004  $  y=x1*0x100+x2;
  $  003.左前轮速                                     $    $  km/h     $    $  ANS003.BYTE004  $  y=(x1*256+x2)*0.05625;
  $  004.右前轮速                                     $    $  km/h     $    $  ANS004.BYTE004  $  y=(x1*256+x2)*0.05625;
  $  005.左后轮速                                     $    $  km/h     $    $  ANS005.BYTE004  $  y=(x1*256+x2)*0.05625;
  $  006.右后轮速                                     $    $  km/h     $    $  ANS006.BYTE004  $  y=(x1*256+x2)*0.05625;
  $  007.ESCL(电子转向柱锁控制单元)转向锁状态         $    $  /        $    $  ANS007.BYTE004  $  switxh(x)0x00:y=@06ed;0x01:y=@06ee;0x02:y=@0027;0xFF:y=@0132;default:y=@0209;
  $  008.ESCL(电子转向柱锁控制单元)认证是否成功       $    $  /        $    $  ANS008.BYTE004  $  switxh(x)0x00:y=@01b4;0x01:y=@01b3;default:y=@0209;
  ...
  $  014.ESCL(电子转向柱锁控制单元)内部温度           $    $  degC     $    $  ANS014.BYTE004  $  y=x*0.75-48;
  $  015.当前是否在热保护状态                         $    $  /        $    $  ANS015.BYTE004  $  switxh(x)0x00:y=@010e;0x01:y=@0170;default:y=@0209;
