...
读数据流: 
  ...
  $  REQ012:7E4 03 22 36 02 00 00 00 00       $  ANS012:7EC 03 22 36 02 00 00 00 00
  $  REQ013:7E4 03 22 36 03 00 00 00 00       $  ANS013:7EC 03 22 36 03 00 00 00 00
  $  REQ014:7E4 03 22 36 04 00 00 00 00       $  ANS014:7EC 03 22 36 04 00 00 00 00
  $  REQ015:7E4 03 22 36 05 00 00 00 00       $  ANS015:7EC 03 22 36 05 00 00 00 00
  ...
  $  028.左刹驱动次数                  $    $  /         $    $  ANS012.BYTE004  $  y=x1*0x1000000+x2*0x10000+x3*0x100+x4;
  $  029.右刹驱动次数                  $    $  /         $    $  ANS013.BYTE004  $  y=x1*0x1000000+x2*0x10000+x3*0x100+x4;
  $  030.左卡钳夹紧力                  $    $  N         $    $  ANS014.BYTE004  $  y=x1*0x100+x2;
  $  031.右卡钳夹紧力                  $    $  N         $    $  ANS015.BYTE004  $  y=x1*0x100+x2;
