...
版本信息:
  ...
  $%  REQ010:7A5 03 22 F1 9D 00 00 00 00       $%  ANS010:7AD 03 22 F1 9D 00 00 00 00
...
读数据流: 
  ...
  $  002.PDC(泊车距离控制)按键状态       $    $  /        $    $  ANS002.BYTE004  $  if(x==0) y=@0740; else if(x==1) y=@0741; else if(x==2) y=@0742; else y=@0009;
  $  003.SVA(侧方车辆预警)按键状态       $    $  /        $    $  ANS002.BYTE005  $  if(x==0) y=@0740; else if(x==1) y=@0741; else if(x==2) y=@0742; else y=@0009;
  $  004.APA(自动泊车辅助)按键状态       $    $  /        $    $  ANS002.BYTE006  $  if(x==0) y=@0740; else if(x==1) y=@0741; else if(x==2) y=@0742; else y=@0009;
