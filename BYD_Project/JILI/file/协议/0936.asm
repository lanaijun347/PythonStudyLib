...
版本信息:
  ...
  $%  REQ013:7E3 03 22 F1 82 00 00 00 00       $%  ANS013:7EB 03 22 F1 82 00 00 00 00
...
读数据流: 
  ...
  $  REQ001:7E3 03 22 48 0E 00 00 00 00       $  ANS001:7EB 03 22 48 0E 00 00 00 00
  $  REQ002:7E3 03 22 48 0F 00 00 00 00       $  ANS002:7EB 03 22 48 0F 00 00 00 00
  $  REQ003:7E3 03 22 48 10 00 00 00 00       $  ANS003:7EB 03 22 48 10 00 00 00 00
  $  REQ004:7E3 03 22 48 1D 00 00 00 00       $  ANS004:7EB 03 22 48 1D 00 00 00 00
  $  REQ005:7E3 03 22 48 1E 00 00 00 00       $  ANS005:7EB 03 22 48 1E 00 00 00 00
  $  REQ006:7E3 03 22 48 24 00 00 00 00       $  ANS006:7EB 03 22 48 24 00 00 00 00
  $  REQ007:7E3 03 22 48 29 00 00 00 00       $  ANS007:7EB 03 22 48 29 00 00 00 00

  $  000.ECU(电子控制器)供电电压       $    $  V       $    $  ANS000.BYTE004  $  y = X1*0.1;
  $  001.电机模式请求                  $    $  /       $    $  ANS001.BYTE004  $  switxh(x)0x01:y=@06fd;0x03:y=@0f21;0x04:y=@0f22;0x05:y=@0949;0x06:y=@097d;0x07:y=@0f23;0x08:y=@0f24;default:y=@0162;
  $  002.电机模式状态                  $    $  /       $    $  ANS002.BYTE004  $  switxh(x)0x01:y=@0f25;0x02:y=@0f26;0x10:y=@08b7;0x30:y=@0f27;0x31:y=@0f28;0x32:y=@0f29;0x33:y=@0f2a;0x34:y=@0f2b;0x35:y=@0f2c;0x40:y=@0f2d;0x41:y=@0f2e;0x42:y=@0f2f;0x43:y=@0f30;0x44:y=@0f31;0x50:y=@0f32;0x51:y=@0f33;0x52:y=@0f34;0x53:y=@0f35;0x54:y=@0f36;0x55:y=@0f37;0x56:y=@0f38;0x60:y=@0f39;0x61:y=@0f3a;0x62:y=@0f3b;0x63:y=@0f3c;0x64:y=@0f3d;0x65:y=@0f3e;0x70:y=@0f3f;0x71:y=@0f40;0x72:y=@0f41;0x73:y=@0f42;0x74:y=@0f43;0x80:y=@0f44;0x81:y=@0f45;0x82:y=@0f46;0x83:y=@0f47;0x90:y=@0f48;default:y=@0162;
  $  003.扭矩控制中扭矩请求值          $    $  Nm      $    $  ANS003.BYTE004  $  y=x*0.5-44;
  $  004.电机转速                      $    $  rpm     $    $  ANS004.BYTE004  $  y=x1*256+x2-2000;
  $  005.电机48V端电压值               $    $  V       $    $  ANS005.BYTE004  $  y=(x1*256+x2)*0.02;
  $  006.电机48V端电流值               $    $  A       $    $  ANS006.BYTE004  $  y=x1*256+x2-400;
  $  007.电机整体温度率                $    $  %       $    $  ANS007.BYTE004  $  y=x;
