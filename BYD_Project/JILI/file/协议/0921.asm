...
版本信息:
  ...
  $%  010:ECU(电子控制器)软件配置日期                  $%    $%  ANS010.BYTE004  $%  y=SPRINTF([%02X%02X-%02X-%02X],x1,x2,x3,x4);
...
读数据流: 
  ...
  $  REQ023:7C6 03 22 63 1F 00 00 00 00       $  ANS023:7CE 03 22 63 1F 00 00 00 00
  $  REQ024:7C6 03 22 63 20 00 00 00 00       $  ANS024:7CE 03 22 63 20 00 00 00 00
  $  REQ025:7C6 03 22 63 21 00 00 00 00       $  ANS025:7CE 03 22 63 21 00 00 00 00
  $  REQ026:7C6 03 22 63 24 00 00 00 00       $  ANS026:7CE 03 22 63 24 00 00 00 00
  ...
  $  014.双区控制按键                  $    $  /          $    $  ANS014.BYTE004  $  switxh(x1&0xFF)0x00:y=@0158;0x01:y=@0159; default: y=@000b;
  $  015.副驾驶员侧温度风门位置        $    $  %          $    $  ANS015.BYTE004  $  y=x1*100/255;
  $  016.进风风门位置                  $    $  %          $    $  ANS016.BYTE004  $  y=x1*100/255;
  $  017.驾驶侧光照强度                $    $  W/m^2      $    $  ANS017.BYTE004  $  y=x1*256+x2;
  $  018.副驾侧光照强度                $    $  W/m^2      $    $  ANS018.BYTE004  $  y=x1*256+x2;
  ...
  $  023.相对湿度                      $    $  %          $    $  ANS023.BYTE004  $  if(x>=0&&x<=0xCA) y=x*0.5-0.5;else if(x==0xCB) y=@0132; else y=@000b;
  $  024.车窗温度                      $    $  degC       $    $  ANS024.BYTE004  $  if((x1*256+x2)>=0&&(x1*256+x2)<=0x3E8) y=(x1*256+x2)*0.1-39.6;else if((x1*256+x2)==0x3E9) y=@0132;else y=@0008;
  $  025.露点温度                      $    $  degC       $    $  ANS025.BYTE004  $  if((x1*256+x2)>=0&&(x1*256+x2)<=0x3E8) y=(x1*256+x2)*0.1-39.6;else if((x1*256+x2)==0x3E9) y=@0132;else y=@0008;
  $  026.压缩机关闭码                  $    $  /          $    $  ANS026.BYTE004  $  switxh(x1&0xFF)0x00:y=@02a7;0x01:y=@02a8;0x02:y=@02a9;0x03:y=@02aa;0x04:y=@02ab;0x05:y=@02ac;0x06:y=@02ad;0x07:y=@02ae;0x08:y=@02af;0x09:y=@0a0e;0x0A:y=@0a0f;0x0B:y=@0a10;0x0C:y=@0a11;0x0D:y=@02b4;0x0E:y=@02b5;0x0F:y=@0a12;0x10:y=@0a13;default:y=@000b;
