...
读数据流: 
  ...
  $  028.睡眠时间标定                                                                $    $  s         $    $  ANS025.BYTE004  $  y=x1*256+x2;
  $  029.PKI写入状态                                                                 $    $  /         $    $  ANS026.BYTE004  $  switxh(x)0x00:y=@0901;0x01:y=@09de;default:y=@0162;
  $  030.服务器反馈超时时间                                                          $    $  s         $    $  ANS027.BYTE004  $  y=x;
  $  031.TBOX(远程信息处理控制器)数据上传重试次数                                    $    $  /         $    $  ANS028.BYTE004  $  y=x;
  $  032.TBOX(远程信息处理控制器)数据上传重试间隔时间                                $    $  min       $    $  ANS029.BYTE004  $  y=x;
  $  033.空气质量信息定时上传间隔时间                                                $    $  min       $    $  ANS030.BYTE004  $  y=x;
