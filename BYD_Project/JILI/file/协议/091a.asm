...
读数据流: 
  ...
  $  REQ005:7D2 03 22 32 07 00 00 00 00       $  ANS005:7DA 03 22 32 07 00 00 00 00
  $  REQ006:7D2 03 22 32 08 00 00 00 00       $  ANS006:7DA 03 22 32 08 00 00 00 00
  $  REQ007:7D2 03 22 32 0A 00 00 00 00       $  ANS007:7DA 03 22 32 0A 00 00 00 00
  $  REQ008:7D2 03 22 32 0B 00 00 00 00       $  ANS008:7DA 03 22 32 0B 00 00 00 00
  $  REQ009:7D2 03 22 32 0D 00 00 00 00       $  ANS009:7DA 03 22 32 0D 00 00 00 00
  ...
  $  004.方向盘扭矩                    $    $  Nm       $    $  ANS004.BYTE004  $  if(x1>=0x80)y = (X1*256+x2-0x10000)*0.01;else y=(X1*256+x2)*0.01;
  $  005.电机输出扭矩                  $    $  Nm       $    $  ANS005.BYTE004  $  if(x1>=0x80)y = (X1*256+x2-0x10000)*0.01;else y=(X1*256+x2)*0.01;
  $  006.发动机状态                    $    $  /        $    $  ANS006.BYTE004  $  if(x1==0x00)y=@0204;else if(x1==0x01)y=@06a3;else if(x1==0x02)y=@0027;else if(x1==0x03)y=@09db;else if(x1==0xff)y=@06dd;else y=@0209;
  $  007.电机位置                      $    $  deg      $    $  ANS007.BYTE004  $  y = (X1*256+x2)*(360/4096);
  $  008.电机速度                      $    $  rpm      $    $  ANS008.BYTE004  $  if(x1>=0x80)y=x1*256+x2-0x10000;else y=x1*256+x2;
  $  009.系统状态                      $    $  /        $    $  ANS009.BYTE004  $  if(x1==0x00)y=@0389;else if(x1==0x01)y=@038a;else if(x1==0x02)y=@038b;else if(x1==0x03)y=@038c;else if(x1==0x04)y=@038d;else if(x1==0x05)y=@038e;else if(x1==0x06)y=@038f;else if(x1>=0x07&&x1<=0xFE)y=@0209;else y=@06e3;
