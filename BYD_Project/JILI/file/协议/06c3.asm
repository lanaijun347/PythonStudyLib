...
读数据流: 
  ...
  $  000.PCU(P档锁控制单元)位置传感器信号电压值       $    $  V     $    $  ANS000.BYTE004  $  y=x*0.01;
  $  001.PCU(P档锁控制单元)电机电流值                 $    $  A     $    $  ANS000.BYTE004  $  y=x*0.01;
  $  002.PCU(P档锁控制单元)状态                       $    $  /     $    $  ANS001.BYTE004  $  switxh(x) 0x0:y=@0605;0x1:y=@0606;0x2:y=@0607;0x3:y=@0608;0x4:y=@0609;0x5:y=@01b0;default:y=x;
  $  003.PCU(P档锁控制单元) 请求初始化状态            $    $  /     $    $  ANS002.BYTE004  $  if(x) y=@060a;else y=@060b;
