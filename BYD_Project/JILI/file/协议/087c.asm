...
读数据流: 
  ...
  $  REQ005:7C6 03 22 63 0A 00 00 00 00       $  ANS005:7CE 03 22 63 0A 00 00 00 00
  $  REQ006:7C6 03 22 63 0B 00 00 00 00       $  ANS006:7CE 03 22 63 0B 00 00 00 00
  $  REQ007:7C6 03 22 63 0C 00 00 00 00       $  ANS007:7CE 03 22 63 0C 00 00 00 00
  $  REQ008:7C6 03 22 63 0D 00 00 00 00       $  ANS008:7CE 03 22 63 0D 00 00 00 00
  $  REQ009:7C6 03 22 63 0E 00 00 00 00       $  ANS009:7CE 03 22 63 0E 00 00 00 00
  $  REQ010:7C6 03 22 63 0F 00 00 00 00       $  ANS010:7CE 03 22 63 0F 00 00 00 00
  $  REQ011:7C6 03 22 63 15 00 00 00 00       $  ANS011:7CE 03 22 63 15 00 00 00 00
  $  REQ012:7C6 03 22 63 1A 00 00 00 00       $  ANS012:7CE 03 22 63 1A 00 00 00 00
  $  REQ013:7C6 03 22 63 1C 00 00 00 00       $  ANS013:7CE 03 22 63 1C 00 00 00 00
  $  REQ014:7C6 03 22 63 24 00 00 00 00       $  ANS014:7CE 03 22 63 24 00 00 00 00
  ...
  $  005.空调工作状态                  $    $  /         $    $  ANS005.BYTE004  $  switxh(x1&0xFF)0x00:y=@0000;0x01:y=@02bb;0x02:y=@02bc; default:y=@000b;
  $  006.鼓风机档位                    $    $  /         $    $  ANS006.BYTE004  $  switxh(x1&0xFF)0x00:y=@0000;0x01:y=@0118;0x02:y=@0119;0x03:y=@011a;0x04:y=@011b;0x05:y=@011c;0x06:y=@011d;0x07:y=@02bd;0x08:y=@02be; default:y=@000b;
  $  007.吹风模式开关                  $    $  /         $    $  ANS007.BYTE004  $  switxh(x1&0xFF)0x01:y=@03a7;0x02:y=@03a8;0x03:y=@0a1a;0x04:y=@0a1b;0x05:y=@02ba;default:y=@000b;
  $  008.除霜开关                      $    $  /         $    $  ANS008.BYTE004  $  switxh(x1&0xFF)0x00:y=@0000;0x01:y=@0001; default:y=@000b;
  $  009.后除霜开关                    $    $  /         $    $  ANS009.BYTE004  $  switxh(x1&0xFF)0x00:y=@0000;0x01:y=@0001; default:y=@000b;
  $  010.AC(空调)制冷按键              $    $  /         $    $  ANS010.BYTE004  $  switxh(x1&0xFF)0x00:y=@0000;0x01:y=@0001; default:y=@000b;
  $  011.驾驶侧光照强度                $    $  W/m^2     $    $  ANS011.BYTE004  $  y=x1*256+x2;
  $  012.水温                          $    $  degC      $    $  ANS012.BYTE004  $  y =x1*0.75-36.8;
  $  013.指示灯占空比                  $    $  %         $    $  ANS013.BYTE004  $  y=x1;
  $  014.压缩机关闭码                  $    $  /         $    $  ANS014.BYTE004  $  switxh(x1&0xFF)0x00:y=@02a7;0x01:y=@02a8;0x02:y=@02a9;0x03:y=@02aa;0x04:y=@02ab;0x05:y=@02ac;0x06:y=@02ad;0x07:y=@02ae;0x08:y=@02af;0x09:y=@0a0e;0x0A:y=@0a0f;0x0B:y=@0a10;0x0C:y=@0a11;0x0D:y=@02b4;0x0E:y=@02b5;0x0F:y=@0a12;0x10:y=@0a13;default:y=@000b;
