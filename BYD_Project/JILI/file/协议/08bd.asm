...
读数据流: 
  ...
  $  REQ012:720 03 22 60 29 00 00 00 00       $  ANS012:728 03 22 60 29 00 00 00 00
  ...
  $  REQ017:720 03 22 60 22 00 00 00 00       $  ANS017:728 03 22 60 22 00 00 00 00
  $  REQ018:720 03 22 33 00 00 00 00 00       $  ANS018:728 03 22 33 00 00 00 00 00
  $  REQ019:720 03 22 33 01 00 00 00 00       $  ANS019:728 03 22 33 01 00 00 00 00
  $  REQ020:720 03 22 33 02 00 00 00 00       $  ANS020:728 03 22 33 02 00 00 00 00
  $  REQ021:720 03 22 33 03 00 00 00 00       $  ANS021:728 03 22 33 03 00 00 00 00
  $  REQ022:720 03 22 65 02 00 00 00 00       $  ANS022:728 03 22 65 02 00 00 00 00
  $  REQ023:720 03 22 65 03 00 00 00 00       $  ANS023:728 03 22 65 03 00 00 00 00
  ...
  $  029.前雨刮间歇时间档                                     $    $  /        $    $  ANS005.BYTE004  $  switxh(x)0x00:y=@0943;0x01:y=@0791;0x02:y=@0792;0x03:y=@0793;0x04:y=@0944;0x05:y=@0945;0x06:y=@0946;0xFF:y=@00be;
  ...
  $  054.离合器底部开关                                       $    $  /        $    $  ANS015.BYTE004  $  if(((x>>0)&1))y=@0170;else y=@010e;
  $  055.离合器顶部开关                                       $    $  /        $    $  ANS015.BYTE004  $  if(((x>>1)&1))y=@0170;else y=@010e;
  $  056.双闪原因                                             $    $  /        $    $  ANS016.BYTE004  $  switxh(x)0x0:y=@0f04;0x1:y=@00d5;0x2:y=@0d6d;0x3:y=@03d1;0x4:y=@03d2; default:y=@000b;
  $  057.工厂模式                                             $    $  /        $    $  ANS017.BYTE004  $  switxh(x)0x00:y=@03ce;0xFF:y=@03cf; default:y=@000b;
  $  058.左前胎压传感器匹配状态                               $    $  /        $    $  ANS018.BYTE004  $  if(((x>>0)&1)) y=@03cc; else y=@03cd;
  $  059.右前胎压传感器匹配状态                               $    $  /        $    $  ANS018.BYTE004  $  if(((x>>1)&1)) y=@03cc; else y=@03cd;
  $  060.右后胎压传感器匹配状态                               $    $  /        $    $  ANS018.BYTE004  $  if(((x>>2)&1)) y=@03cc; else y=@03cd;
  $  061.左后胎压传感器匹配状态                               $    $  /        $    $  ANS018.BYTE004  $  if(((x>>3)&1)) y=@03cc; else y=@03cd;
  $  062.左前胎压传感器ID                                     $    $  /        $    $  ANS019.BYTE004  $  HEX(x1,x2,x3,x4);
  $  063.右前胎压传感器ID                                     $    $  /        $    $  ANS019.BYTE008  $  HEX(x1,x2,x3,x4);
  $  064.右后胎压传感器ID                                     $    $  /        $    $  ANS019.BYTE012  $  HEX(x1,x2,x3,x4);
  $  065.左后胎压传感器ID                                     $    $  /        $    $  ANS019.BYTE016  $  HEX(x1,x2,x3,x4);
  $  066.左前胎压值                                           $    $  kPa      $    $  ANS020.BYTE004  $  y=x1*1.373;
  $  067.右前胎压值                                           $    $  kPa      $    $  ANS020.BYTE005  $  y=x1*1.373;
  $  068.右后胎压值                                           $    $  kPa      $    $  ANS020.BYTE006  $  y=x1*1.373;
  $  069.左后胎压值                                           $    $  kPa      $    $  ANS020.BYTE007  $  y=x1*1.373;
  $  070.左前轮温度值                                         $    $  degC     $    $  ANS021.BYTE004  $  y=x-50;
  $  071.右前轮温度值                                         $    $  degC     $    $  ANS021.BYTE005  $  y=x-50;
  $  072.右后轮温度值                                         $    $  degC     $    $  ANS021.BYTE006  $  y=x-50;
  $  073.左后轮温度值                                         $    $  degC     $    $  ANS021.BYTE007  $  y=x-50;
  $  074.已学习IMMO(防盗系统)/UID 钥匙数量                    $    $  /        $    $  ANS022.BYTE004  $  if(x==0x00) y=@0d8a; else if(x==0x01) y=@1040;else if(x==0x02) y=@1041;else if(x==0x03) y=@1042;else if(x==0x04) y=@1043;
  $  075.密钥写入状态                                         $    $  /        $    $  ANS023.BYTE004  $  if(((x>>0)&1)) y=@0f0e; else y=@103f;
  $  076.硬线轮速信号                                         $    $  km/h     $    $  ANS024.BYTE004  $  y=x;
  ...
  $)  02.门把手开关输入
  $  02.门把手开关输入
  $  REQ000:720 03 22 65 13 00 00 00 00       $  ANS000:728 03 22 65 13 00 00 00 00
