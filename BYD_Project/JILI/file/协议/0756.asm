...
版本信息:
  ...
  $%  008:ECU(电子控制器)软件版本号:                   $%    $%  ANS008.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21);
...
读数据流: 
  ...
  $  REQ002:7C1 03 22 67 04 00 00 00 00       $  ANS002:7C9 03 22 67 04 00 00 00 00
  $  REQ003:7C1 03 22 67 09 00 00 00 00       $  ANS003:7C9 03 22 67 09 00 00 00 00

  $  000.ECU(电子控制器)供电电压       $    $  V        $    $  ANS000.BYTE004  $  y=x*0.1;
  $  001.车速                          $    $  km/h     $    $  ANS001.BYTE004  $  y=INT((x1*256+x2)*0.05625);
  $  002.蓝牙MAC码                     $    $  /        $    $  ANS002.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
  $  003.上网状态                      $    $  /        $    $  ANS003.BYTE004  $  if(0x00==x)y=@01c3;else if(0x01==x)y=@01c4;else y=@0132;
