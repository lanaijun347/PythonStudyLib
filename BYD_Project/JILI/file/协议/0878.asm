...
版本信息:
  ...
  $%  007:ECU(电子控制器)软件版本号:                   $%    $%  ANS007.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21);
...
读数据流: 
  ...
  $  REQ008:7C1 03 22 67 0A 00 00 00 00       $  ANS008:7C9 03 22 67 0A 00 00 00 00
  $  REQ009:7C1 03 22 67 0B 00 00 00 00       $  ANS009:7C9 03 22 67 0B 00 00 00 00
  $  REQ010:7C1 03 22 67 0C 00 00 00 00       $  ANS010:7C9 03 22 67 0C 00 00 00 00
  $  REQ011:7C1 03 22 67 0D 00 00 00 00       $  ANS011:7C9 03 22 67 0D 00 00 00 00
  $  REQ012:7C1 03 22 67 0E 00 00 00 00       $  ANS012:7C9 03 22 67 0E 00 00 00 00
  $  REQ013:7C1 03 22 67 10 00 00 00 00       $  ANS013:7C9 03 22 67 10 00 00 00 00
  $  REQ014:7C1 03 22 67 00 00 00 00 00       $  ANS014:7C9 03 22 67 00 00 00 00 00
  $  REQ015:7C1 03 22 67 01 00 00 00 00       $  ANS015:7C9 03 22 67 01 00 00 00 00
  ...
  $  008.低音部梯级                         $    $  Step     $    $  ANS008.BYTE004  $  y=x-9;
  $  009.中音部梯级                         $    $  Step     $    $  ANS009.BYTE004  $  y=x-9;
  $  010.高音部梯级                         $    $  Step     $    $  ANS010.BYTE004  $  y=x-9;
  $  011.平衡器梯级                         $    $  Step     $    $  ANS011.BYTE004  $  y=x-9;
  $  012.衰减阶梯                           $    $  Step     $    $  ANS012.BYTE004  $  y=x-9;
  $  013.PKI写入状态                        $    $  /        $    $  ANS013.BYTE004  $  if(0x00==x)y=@0901;else if(0x01==x)y=@09de;else y=@0162;
  $  014.源模式                             $    $  Step     $    $  ANS014.BYTE004  $  switxh(x)0x00:y=@09df;0x01:y=@09e0;0x02:y=@01c6;0x03:y=@09e1;0x04:y=@09e2;0x05:y=@09e3;0x06:y=@09e4;0x07:y=@09e5;0x08:y=@09e6;0x09:y=@09e7;0xff:y=@0600;default:y=@0162;
  $  015.收音机频率                         $    $  KHz      $    $  ANS015.BYTE004  $  y=(x1<<16)+(x2<<8)+x3;
