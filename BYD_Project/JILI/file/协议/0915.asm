...
读数据流: 
  ...
  $  REQ005:721 03 22 62 05 00 00 00 00       $  ANS005:729 03 22 62 05 00 00 00 00
  $  REQ006:721 03 22 62 07 00 00 00 00       $  ANS006:729 03 22 62 07 00 00 00 00
  $  REQ007:721 03 22 62 08 00 00 00 00       $  ANS007:729 03 22 62 08 00 00 00 00
  $  REQ008:721 03 22 62 0A 00 00 00 00       $  ANS008:729 03 22 62 0A 00 00 00 00
  ...
  $  005.剩余保养里程                                              $    $  km       $    $  ANS005.BYTE004  $  if((x1*0x100+x2)==0xffff)y=@0008;else if((x1*0x100+x2)>=0x2711 && (x1*0x100+x2)<=0xFFFE)y=@0209;else y=x1*256+x2;
  $  006.仪表里程清零次数                                          $    $  /        $    $  ANS006.BYTE004  $  y=x;
  $  007.备份里程                                                  $    $  km       $    $  ANS007.BYTE004  $  y=x1*0x10000+x2*0x100+x3;
  $  008.里程备份次数                                              $    $  /        $    $  ANS008.BYTE004  $  y=x1*0x100+x2;
  $  009.燃油传感器电阻值                                          $    $  ohm      $    $  ANS009.BYTE004  $  y=x1*0x100+x2;
  $  010.抬头显示屏控制器主开关                                    $    $  /        $    $  ANS010.BYTE004  $  if(x==0x00)y=@01cf;else if(x==0x01)y=@04d6;
  $  011.抬头显示屏控制器上调开关                                  $    $  /        $    $  ANS011.BYTE004  $  if(x==0x00)y=@01cf;else if(x==0x01)y=@04d6;
  $  012.抬头显示屏控制器下调开关                                  $    $  /        $    $  ANS012.BYTE004  $  if(x==0x00)y=@01cf;else if(x==0x01)y=@04d6;
  $  013.抬头显示屏控制器软件版本                                  $    $  /        $    $  ANS013.BYTE004  $  HEX(x1,x2,x3);
  $  014.抬头显示屏控制器硬件版本                                  $    $  /        $    $  ANS014.BYTE004  $  HEX(x1,x2);
  $  015.抬头显示屏控制器 EEPROM(电可擦除只读存储器)数据版本       $    $  /        $    $  ANS015.BYTE004  $  HEX(x1,x2,x3);
