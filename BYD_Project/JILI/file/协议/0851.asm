...
版本信息:
  ...
  $%  REQ009:7C1 03 22 F1 82 00 00 00 00       $%  ANS009:7C9 03 22 F1 82 00 00 00 00
...
读数据流: 
  ...
  $  REQ010:7C1 03 22 67 01 00 00 00 00       $  ANS010:7C9 03 22 67 01 00 00 00 00
  $  REQ011:7C1 03 22 67 12 00 00 00 00       $  ANS011:7C9 03 22 67 12 00 00 00 00
  ...
  $  010.收音机频率                            $    $  KHz      $    $  ANS010.BYTE004  $  y=(x1<<16)+(x2<<8)+x3;
  $  011.MCU(驱动电机控制单元)软件版本号       $    $  /        $    $  ANS011.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21);
