...
读数据流: 
  ...
  $  REQ000:7A7 03 22 6A 00 00 00 00 00       $  ANS000:7AF 03 22 6A 00 00 00 00 00
  $  REQ001:7A7 03 22 6A 01 00 00 00 00       $  ANS001:7AF 03 22 6A 01 00 00 00 00
  $  REQ002:7A7 03 22 6A 02 00 00 00 00       $  ANS002:7AF 03 22 6A 02 00 00 00 00
  $  REQ003:7A7 03 22 FA 19 00 00 00 00       $  ANS003:7AF 03 22 FA 19 00 00 00 00

  $  000.通道镜像动力CAN信号已经路由到诊断CAN       $    $  /     $    $  ANS000.BYTE004  $  if(((x>>0)&1))y=@001c;else y=@001d;
  $  001.通道镜像混动CAN信号已经路由到诊断CAN       $    $  /     $    $  ANS000.BYTE004  $  if(((x>>1)&1))y=@001c;else y=@001d;
  $  002.通道镜像车身CAN信号已经路由到诊断CAN       $    $  /     $    $  ANS000.BYTE004  $  if(((x>>2)&1))y=@001c;else y=@001d;
  $  003.通道镜像底盘CAN信号已经路由到诊断CAN       $    $  /     $    $  ANS000.BYTE004  $  if(((x>>3)&1))y=@001c;else y=@001d;
  $  004.IG 状态                                    $    $  /     $    $  ANS001.BYTE004  $  if(x==0x00)y=@04d9;else if(x==0x01)y=@0f0d;else y=@0162;
  $  005.节点镜像                                   $    $  /     $    $  ANS002.BYTE004  $  HEX(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12);
  $  006.PCB数据矩阵码                              $    $  /     $    $  ANS003.BYTE004  $  HEX(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,x29,x30,x31,x32);
...
30帧:
  ...
  $FC REQ001:7A7 30 00 0B 00 00 00 00 00  $FC 
