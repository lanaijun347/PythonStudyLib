...
读数据流: 
  ...
  $  REQ007:7E1 03 22 0B 08 00 00 00 00       $  ANS007:7E9 03 22 0B 08 00 00 00 00
  $  REQ008:7E1 03 22 0B 09 00 00 00 00       $  ANS008:7E9 03 22 0B 09 00 00 00 00
  $  REQ009:7E1 03 22 0B 0A 00 00 00 00       $  ANS009:7E9 03 22 0B 0A 00 00 00 00
  $  REQ010:7E1 03 22 0B 0B 00 00 00 00       $  ANS010:7E9 03 22 0B 0B 00 00 00 00
  $  REQ011:7E1 03 22 0B 17 00 00 00 00       $  ANS011:7E9 03 22 0B 17 00 00 00 00
  $  REQ012:7E1 03 22 0B 27 00 00 00 00       $  ANS012:7E9 03 22 0B 27 00 00 00 00
  $  REQ013:7E1 03 22 0B 20 00 00 00 00       $  ANS013:7E9 03 22 0B 20 00 00 00 00
  $  REQ014:7E1 03 22 0B 2D 00 00 00 00       $  ANS014:7E9 03 22 0B 2D 00 00 00 00
  $  REQ015:7E1 03 22 0B 2F 00 00 00 00       $  ANS015:7E9 03 22 0B 2F 00 00 00 00
  $  REQ016:7E1 03 22 0B 0C 00 00 00 00       $  ANS016:7E9 03 22 0B 0C 00 00 00 00
  $  REQ017:7E1 03 22 0B 0D 00 00 00 00       $  ANS017:7E9 03 22 0B 0D 00 00 00 00
  ...
  $  007.齿轮箱油温                            $    $  degC      $    $  ANS007.BYTE004  $  y=x-40;
  $  008.档位状态                              $    $  /         $    $  ANS008.BYTE004  $  switxh(x) 0x01:y=P;0x02:y=R;0x03:y=N;0x04:y=D;0x05:y=M;default:y=@0168;
  $  009.强制换挡状态                          $    $  /         $    $  ANS009.BYTE004  $  switxh(x) 0x00:y=@07dc;0x01:y=@001c;default:y=@0168;
  $  010.目标档位                              $    $  /         $    $  ANS010.BYTE004  $  switxh(x) 0x01:y=1;0x02:y=2;0x03:y=3;0x04:y=4;0x05:y=5;0x06:y=6;0x07:y=R;0x07:y=@0132;default:y=@0168;
  $  011.TCU(自动变速器控制单元)内部温度       $    $  degC      $    $  ANS011.BYTE004  $  if(x1<0x80) y=x1*0x100+x2;else y=x1*0x100+x2-65536;
  $  012.ESP(电控稳定定统)状态                 $    $  /         $    $  ANS012.BYTE004  $  if(((x>>1)&1)) y=@001c;else y=@07dc;
  $  013.MIL(故障指示灯)灯                     $    $  /         $    $  ANS013.BYTE004  $  if(((x>>0)&1)) y=@001c;else y=@07dc;
  $  014.警告灯                                $    $  /         $    $  ANS013.BYTE004  $  if(((x>>1)&1)) y=@001c;else y=@07dc;
  $  015.温度警告灯                            $    $  /         $    $  ANS013.BYTE004  $  if(((x>>2)&1)) y=@001c;else y=@07dc;
  $  016.车辆加速度                            $    $  m/s^2     $    $  ANS014.BYTE004  $  if(x1<0x80) y=(x1*0x100+x2)/1024;else y=(x1*0x100+x2-65536)/1024;
  $  017.TCU(自动变速器控制单元)电压           $    $  V         $    $  ANS015.BYTE004  $  y=(x1*0x100+x2)/512;
  $  018.输入轴1转速                           $    $  rpm       $    $  ANS016.BYTE004  $  y=INT((x1*0x100+x2)*0.50);
  $  019.输入轴2转速                           $    $  rpm       $    $  ANS017.BYTE004  $  y=INT((x1*0x100+x2)*0.5);
