...
读数据流: 
  ...
  $  REQ010:7D2 03 22 F1 11 00 00 00 00       $  ANS010:7DA 03 22 F1 11 00 00 00 00

  $  000.ECU(电子控制器)成功刷写次数         $    $  /        $    $  ANS000.BYTE004  $  y=x1;
  $  001.ECU(电子控制器)尝试刷写次数         $    $  /        $    $  ANS001.BYTE004  $  y=x1;
  ...
  $  010.助力模式                            $    $  /        $    $  ANS010.BYTE004  $  switxh(x1*0x100+x2) 0x0101:y=@000c;0x0102:y=@000d;0x0001:y=@000e;default:y=@0009;
