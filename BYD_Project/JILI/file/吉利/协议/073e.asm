...
版本信息:
  ...
  $%  REQ010:720 03 22 F1 97 00 00 00 00       $%  ANS010:728 03 22 F1 97 00 00 00 00
  $%  REQ011:720 03 22 F1 98 00 00 00 00       $%  ANS011:728 03 22 F1 98 00 00 00 00
  $%  REQ012:720 03 22 F1 99 00 00 00 00       $%  ANS012:728 03 22 F1 99 00 00 00 00
  $%  REQ013:720 03 22 F1 9D 00 00 00 00       $%  ANS013:728 03 22 F1 9D 00 00 00 00
...
读数据流: 
  ...
  $)  00.网络节点配置信息
  $  00.网络节点配置信息
  $  REQ000:720 03 22 F1 10 00 00 00 00       $  ANS000:728 03 22 F1 10 00 00 00 00
  ...
  $)  01.读取防盗学习状态
  $  01.读取防盗学习状态
  $  REQ000:720 03 22 5C 14 00 00 00 00       $  ANS000:728 03 22 5C 14 00 00 00 00

  $  000.读取学习状态       $    $  /     $    $  ANS000.BYTE004  $  if(x<0x0b) y=string(0x06,0x36,0x70,(0x51+x)); else if(x==0x23) y=@074b;

  $)  02.检查学习状态
  $  02.检查学习状态
  $  REQ000:720 03 22 5C B5 00 00 00 00       $  ANS000:728 03 22 5C B5 00 00 00 00
  ...
  $)  03.轮胎胎压传感器标称压力值
  $  03.轮胎胎压传感器标称压力值
  $  REQ000:720 03 22 37 00 00 00 00 00       $  ANS000:728 03 22 37 00 00 00 00 00
  ...
  $)  04.轮胎胎压传感器标示符
  $  04.轮胎胎压传感器标示符
  $  REQ000:720 03 22 37 01 00 00 00 00       $  ANS000:728 03 22 37 01 00 00 00 00
  ...
  $)  05.轮胎胎压压力和温度
  $  05.轮胎胎压压力和温度
  $  REQ000:720 03 22 37 02 00 00 00 00       $  ANS000:728 03 22 37 02 00 00 00 00
  ...
  $)  08.外部进入系统门开开关状态
  $  08.外部进入系统门开开关状态
  $  REQ000:720 03 22 60 04 00 00 00 00       $  ANS000:728 03 22 60 04 00 00 00 00
  ...
  $)  09.门锁系统输入开关状态
  $  09.门锁系统输入开关状态
  $  REQ000:720 03 22 60 05 00 00 00 00       $  ANS000:728 03 22 60 05 00 00 00 00
  ...
  $)  10.雨刮
  $  10.雨刮
  $  REQ000:720 03 22 60 06 00 00 00 00       $  ANS000:728 03 22 60 06 00 00 00 00
  ...
  $)  11.前雨刮自动灵敏度
  $  11.前雨刮自动灵敏度
  $  REQ000:720 03 22 60 07 00 00 00 00       $  ANS000:728 03 22 60 07 00 00 00 00
  ...
  $)  12.点火开关状态(钥匙状态)
  $  12.点火开关状态(钥匙状态)
  $  REQ000:720 03 22 60 08 00 00 00 00       $  ANS000:728 03 22 60 08 00 00 00 00
  ...
  $)  13.后除霜开关
  $  13.后除霜开关
  $  REQ000:720 03 22 60 09 00 00 00 00       $  ANS000:728 03 22 60 09 00 00 00 00

  $  000.后除霜开关       $    $       $    $  ANS000.BYTE004  $  if(((x>>0)&1)) y=@001c;else y=@001d;

  $)  14.后雨刮/清洗输入输出状态
  $  14.后雨刮/清洗输入输出状态
  $  REQ000:720 03 22 60 0A 00 00 00 00       $  ANS000:728 03 22 60 0A 00 00 00 00
  ...
  $)  15.外部温度
  $  15.外部温度
  $  REQ000:720 03 22 60 0B 00 00 00 00       $  ANS000:728 03 22 60 0B 00 00 00 00

  $  000.外部温度       $    $  degC     $    $  ANS000.BYTE004  $  if(x==0xff) y=@0008;else y=x*0.5-40;

  $)  16.玻璃开关
  $  16.玻璃开关
  $  REQ000:720 03 22 60 0C 00 00 00 00       $  ANS000:728 03 22 60 0C 00 00 00 00
