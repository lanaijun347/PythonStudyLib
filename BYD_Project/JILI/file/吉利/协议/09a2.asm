...
读数据流: 
  ...
  $  REQ016:7C6 03 22 63 11 00 00 00 00       $  ANS016:7CE 03 22 63 11 00 00 00 00
  $  REQ017:7C6 03 22 63 12 00 00 00 00       $  ANS017:7CE 03 22 63 12 00 00 00 00
  $  REQ018:7C6 03 22 63 13 00 00 00 00       $  ANS018:7CE 03 22 63 13 00 00 00 00
  $  REQ019:7C6 03 22 63 15 00 00 00 00       $  ANS019:7CE 03 22 63 15 00 00 00 00
  $  REQ020:7C6 03 22 63 16 00 00 00 00       $  ANS020:7CE 03 22 63 16 00 00 00 00
  $  REQ021:7C6 03 22 63 17 00 00 00 00       $  ANS021:7CE 03 22 63 17 00 00 00 00
  $  REQ022:7C6 03 22 63 18 00 00 00 00       $  ANS022:7CE 03 22 63 18 00 00 00 00
  $  REQ023:7C6 03 22 63 1A 00 00 00 00       $  ANS023:7CE 03 22 63 1A 00 00 00 00
  $  REQ024:7C6 03 22 63 1D 00 00 00 00       $  ANS024:7CE 03 22 63 1D 00 00 00 00
  $  REQ025:7C6 03 22 63 25 00 00 00 00       $  ANS025:7CE 03 22 63 25 00 00 00 00
  $  REQ026:7C6 03 22 63 26 00 00 00 00       $  ANS026:7CE 03 22 63 26 00 00 00 00
  $  REQ027:7C6 03 22 63 27 00 00 00 00       $  ANS027:7CE 03 22 63 27 00 00 00 00
  $  REQ028:7C6 03 22 63 28 00 00 00 00       $  ANS028:7CE 03 22 63 28 00 00 00 00
  $  REQ029:7C6 03 22 63 29 00 00 00 00       $  ANS029:7CE 03 22 63 29 00 00 00 00
  $  REQ030:7C6 03 22 63 2A 00 00 00 00       $  ANS030:7CE 03 22 63 2A 00 00 00 00
  $  REQ031:7C6 03 22 63 2B 00 00 00 00       $  ANS031:7CE 03 22 63 2B 00 00 00 00
  $  REQ032:7C6 03 22 63 2C 00 00 00 00       $  ANS032:7CE 03 22 63 2C 00 00 00 00
  $  REQ033:7C6 03 22 63 2D 00 00 00 00       $  ANS033:7CE 03 22 63 2D 00 00 00 00
  $  REQ034:7C6 03 22 63 24 00 00 00 00       $  ANS034:7CE 03 22 63 24 00 00 00 00
  ...
  $  016.双区控制按键                     $    $  /          $    $  ANS016.BYTE004  $  switxh(x1&0xFF)0x00:y=@0158;0x01:y=@0159; default: y=@000b;
  $  017.副驾驶员侧温度风门位置           $    $  %          $    $  ANS017.BYTE004  $  y=x1*100/255;
  $  018.进风风门位置                     $    $  %          $    $  ANS018.BYTE004  $  y=x1*100/255;
  $  019.驾驶侧光照强度                   $    $  W/m^2      $    $  ANS019.BYTE004  $  y=x1*256+x2;
  $  020.副驾侧光照强度                   $    $  W/m^2      $    $  ANS020.BYTE004  $  y=x1*256+x2;
  $  021.车外空气质量状态                 $    $  /          $    $  ANS021.BYTE004  $  switxh(x1&0xFF)0x00:y=@02a1;0x01:y=@02a2;0x02:y=@02a3;0x03:y=@02a4;0x04:y=@02a5;0x05:y=@02a6;0xFF:y=@0132;  default:y=@000b;
  $  022.车外固体颗粒PM2.5                $    $  ug/m^3     $    $  ANS022.BYTE004  $  y=x1*256+x2;
  $  023.水温                             $    $  degC       $    $  ANS023.BYTE004  $  y =x1*0.75-36.8;
  $  024.PM2.5传感器的工作状态            $    $  /          $    $  ANS024.BYTE004  $  switxh(x1&0xFF)0x00:y=@0318;0x01:y=@0a1f;0x02:y=@02de;0x03:y=@00be;0xFF:y=@0132; default:y=@000b;
  $  025.高压电加热器状态                 $    $  /          $    $  ANS025.BYTE004  $  switxh(x1&0xFF)0x00:y=@0000;0x01:y=@02c3;0x02:y=@0a14;0x03:y=@02c5;0x04:y=@02c6; default:y=@000b;
  $  026.高压测量电压                     $    $  mV         $    $  ANS026.BYTE004  $  y=(x1*0x100+x2)*100;
  $  027.高压电流消耗总览                 $    $  mA         $    $  ANS027.BYTE004  $  y=(x1*256+x2)*10;
  $  028.冷却液入口温度                   $    $  degC       $    $  ANS028.BYTE004  $  y=(x1*256+x2)-273;
  $  029.冷却液出口温度                   $    $  degC       $    $  ANS029.BYTE004  $  y=(x1*256+x2)-273;
  $  030.低压电源                         $    $  V          $    $  ANS030.BYTE004  $  y=(x1*256+x2)/1000;
  $  031.加热器核心层温度                 $    $  degC       $    $  ANS031.BYTE004  $  y=(x1*256+x2)-40;
  $  032.瞬时的功率消耗超出高压电网       $    $  W          $    $  ANS032.BYTE004  $  y=x1*256+x2;
  $  033.加热器解锁                       $    $  /          $    $  ANS033.BYTE004  $  switxh(x1&0xff)0x00:y=@01d0;0x01:y=@0124;0x02:y=@0a15;
  $  034.压缩机关闭码                     $    $  /          $    $  ANS034.BYTE004  $  switxh(x1&0xFF)0x00:y=@02a7;0x01:y=@02a8;0x02:y=@02a9;0x03:y=@02aa;0x04:y=@02ab;0x05:y=@02ac;0x06:y=@02ad;0x07:y=@02ae;0x08:y=@02af;0x09:y=@0a0e;0x0A:y=@0a0f;0x0B:y=@0a10;0x0C:y=@0a11;0x0D:y=@02b4;0x0E:y=@02b5;0x0F:y=@0a12;0x10:y=@0a13;default:y=@000b;
