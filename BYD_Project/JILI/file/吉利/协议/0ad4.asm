...
读数据流: 
  ...
  $  REQ014:7C6 03 22 63 13 00 00 00 00       $  ANS014:7CE 03 22 63 13 00 00 00 00
  $  REQ015:7C6 03 22 63 15 00 00 00 00       $  ANS015:7CE 03 22 63 15 00 00 00 00
  $  REQ016:7C6 03 22 63 17 00 00 00 00       $  ANS016:7CE 03 22 63 17 00 00 00 00
  $  REQ017:7C6 03 22 63 18 00 00 00 00       $  ANS017:7CE 03 22 63 18 00 00 00 00
  ...
  $  REQ021:7C6 03 22 63 25 00 00 00 00       $  ANS021:7CE 03 22 63 25 00 00 00 00
  ...
  $  REQ026:7C6 03 22 63 2D 00 00 00 00       $  ANS026:7CE 03 22 63 2D 00 00 00 00
  ...
  $  014.进风风门位置                  $    $  %          $    $  ANS014.BYTE004  $  y=x1*100/255;
  $  015.驾驶侧光照强度                $    $  W/m^2      $    $  ANS015.BYTE004  $  y=x1*256+x2;
  $  016.车外空气质量状态              $    $  /          $    $  ANS016.BYTE004  $  switxh(x1&0xFF)0x00:y=@02a1;0x01:y=@02a2;0x02:y=@02a3;0x03:y=@02a4;0x04:y=@02a5;0x05:y=@02a6;0xFF:y=@0132;  default:y=@000b;
  $  017.车外固体颗粒PM2.5             $    $  ug/m^3     $    $  ANS017.BYTE004  $  y=x1*256+x2;
  $  018.水温                          $    $  degC       $    $  ANS018.BYTE004  $  y =x1*0.75-36.8;
  ...
  $  021.高压电加热器状态              $    $  /          $    $  ANS021.BYTE004  $  switxh(x1&0xFF)0x00:y=@0000;0x01:y=@02c3;0x02:y=@0a14;0x03:y=@02c5;0x04:y=@02c6; default:y=@000b;
  $  022.高压电流消耗总览              $    $  mA         $    $  ANS022.BYTE004  $  y=(x1*256+x2)*10;
  $  023.冷却液入口温度                $    $  degC       $    $  ANS023.BYTE004  $  y=(x1*256+x2)-273;
  $  024.冷却液出口温度                $    $  degC       $    $  ANS024.BYTE004  $  y=(x1*256+x2)-273;
  $  025.低压电源                      $    $  V          $    $  ANS025.BYTE004  $  y=(x1*256+x2)/1000;
  $  026.加热器解锁                    $    $  /          $    $  ANS026.BYTE004  $  switxh(x1&0xff)0x00:y=@01d0;0x01:y=@0124;0x02:y=@0a15;
