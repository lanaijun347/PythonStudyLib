...
读数据流: 
  ...
  $  REQ000:7A1 03 22 70 04 00 00 00 00       $  ANS000:7A9 03 22 70 04 00 00 00 00

  $  000.AVM(全景影像模块)开关状态       $    $  /     $    $  ANS000.BYTE004  $  switxh(x) 0x00:y=@01cf;0x01:y=@04d6;  default:y=@000b;
