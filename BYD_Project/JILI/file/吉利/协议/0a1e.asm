...
读数据流: 
  ...
  $  REQ023:7C6 03 22 63 19 00 00 00 00       $  ANS023:7CE 03 22 63 19 00 00 00 00
  $  REQ024:7C6 03 22 63 1A 00 00 00 00       $  ANS024:7CE 03 22 63 1A 00 00 00 00
  $  REQ025:7C6 03 22 63 1C 00 00 00 00       $  ANS025:7CE 03 22 63 1C 00 00 00 00
  $  REQ026:7C6 03 22 63 1D 00 00 00 00       $  ANS026:7CE 03 22 63 1D 00 00 00 00
  $  REQ027:7C6 03 22 63 24 00 00 00 00       $  ANS027:7CE 03 22 63 24 00 00 00 00
  ...
  $  007.内外循环模式                  $    $  /          $    $  ANS007.BYTE004  $  switxh(x1&0xFF)0x00:y=@02bf;0x01:y=@02c0;0xFF:y=@0132;default:y=@000b;
  ...
  $  023.空气质量传感器电压            $    $  V          $    $  ANS023.BYTE004  $  y=(x1*256+x2)*5/1024;
  $  024.水温                          $    $  degC       $    $  ANS024.BYTE004  $  y =x1*0.75-36.8;
  $  025.指示灯占空比                  $    $  %          $    $  ANS025.BYTE004  $  y=x1;
  $  026.PM2.5传感器的工作状态         $    $  /          $    $  ANS026.BYTE004  $  switxh(x1&0xFF)0x00:y=@0318;0x01:y=@0a1f;0x02:y=@02de;0x03:y=@00be;0xFF:y=@0132; default:y=@000b;
  $  027.压缩机关闭码                  $    $  /          $    $  ANS027.BYTE004  $  switxh(x1&0xFF)0x00:y=@02a7;0x01:y=@02a8;0x02:y=@02a9;0x03:y=@02aa;0x04:y=@02ab;0x05:y=@02ac;0x06:y=@02ad;0x07:y=@02ae;0x08:y=@02af;0x09:y=@0a0e;0x0A:y=@0a0f;0x0B:y=@0a10;0x0C:y=@0a11;0x0D:y=@02b4;0x0E:y=@02b5;0x0F:y=@0a12;0x10:y=@0a13;default:y=@000b;
