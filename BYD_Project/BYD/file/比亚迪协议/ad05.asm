...
版本信息:
  ...
  $%  005:车载诊断系统类型:        $%    $%  ANS005.BYTE006  $%  if(x1==0x01) y=@0013;else if(x1==0x02) y=@0014;else if(x1==0x03) y=@0015;else if(x1==0x04) y=@0016;else if(x1==0x05) y=@0017;else if(x1==0x06) y=@0018;else y=@0019;
...
读数据流: 
  ...
  $  005:发动机转速                              $    $  rpm          $    $  ANS005.BYTE006  $  y=x1*64.0/255;
  ...
  $  014:节气门处于怠速位置                      $    $               $    $  ANS013.BYTE006  $  if(x1&0x01)y=@0000;else y=@0001;
  $  015:空调请求激活                            $    $               $    $  ANS013.BYTE006  $  if(x1&0x10)y=@0000;else y=@0001;
  $  016:空调压缩机状态                          $    $               $    $  ANS013.BYTE006  $  if(x1&0x20)y=@0004;else y=@0005;
  $  017:催化剂保护模式                          $    $               $    $  ANS013.BYTE006  $  if(x1&0x40)y=@0000;else y=@0001;
  $  018:燃油泵开启状态                          $    $               $    $  ANS013.BYTE006  $  if(x1&0x80)y=@0004;else y=@0005;
  $  019:发动机故障(MIL)指示灯状态               $    $               $    $  ANS014.BYTE006  $  if(x1&0x04)y=@0004;else y=@0005;
  $  020:发动机立即维修(SVS)指示灯状态           $    $               $    $  ANS014.BYTE006  $  if(x1&0x08)y=@0004;else y=@0005;
  ...
  $  031:喷油脉宽                                $    $  毫秒         $    $  ANS025.BYTE006  $  y=x1*996.9/255;
