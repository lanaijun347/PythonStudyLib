...
读数据流: 
  ...
  $  061:整车工作模式                                $    $               $    $  ANS043.BYTE004  $  if(x1==0x00) y=@00d2; else if(x1==0x01) y=@03ea; else if(x1==0x02) y=@0492; else if(x1==0x03) y=@0493; else if(x1==0x04) y=@0494;else if(x1==0x05) y=@0495;else if(x1==0x06) y=@03eb;else if(x1==0x07) y=@03ec;else y=@062c;
  $  062:离合器强制脱开                              $    $               $    $  ANS043.BYTE005  $  if(x1&0x01) y=@00eb; else y=@00ea;
  $  063:离合器强制脱开命令有效标识位                $    $               $    $  ANS043.BYTE006  $  if(x1&0x01) y=@00e6; else y=@0048;
  ...
  $  068:电机使能信息                                $    $               $    $  ANS046.BYTE005  $  if(x1==0) y=@0043; else if(x1==1) y=@0044; else y=@062c;
