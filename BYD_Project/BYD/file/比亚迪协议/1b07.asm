...
读数据流: 
  ...
  $  011:驻车制动开关状态                           $    $               $    $  ANS006.BYTE004  $  if(x1==0)y=@0045;else if(x1==1)y=@0046;else if(x1==2)y=@0047;else if(x1==3)y=@0048;else y=@001c;
  $  012:霍尔传感器计数                             $    $  Pulse        $    $  ANS007.BYTE004  $  y=(x2*256+x1);
  $  013:目标拉力                                   $    $  N            $    $  ANS008.BYTE004  $  y=x1*10;
  $  014:EPB(电子驻车)状态                          $    $               $    $  ANS009.BYTE004  $  if(x1==0)y=@0055;else if(x1==1)y=@0056;else if(x1==2)y=@0057;else if(x1==3)y=@0058;else if(x1==4)y=@0059;else y=@001c;
  $  015:EPB(电子驻车)校准检测状态                  $    $               $    $  ANS010.BYTE004  $  if(x1==0)y=@0053;else if(x1==1)y=@0054;else y=@001c;
  $  016:IGN状态                                    $    $               $    $  ANS011.BYTE004  $  if(x1==0)y=@005a;else if(x1==1)y=@005b;else if(x1==2)y=@005c;else if(x1==3)y=@005d;else y=@001c;
  ...
  $  019:维修模式                                   $    $               $    $  ANS014.BYTE004  $  if(x1==0)y=@004b;else if(x1==1)y=@004c;else if(x1==2)y=@004d;else y=@001c;
  $  020:EPB(电子驻车)电机操作有效                  $    $               $    $  ANS015.BYTE004  $  if(x1==0)y=@0049;else if(x1==1)y=@004a;else y=@001c;
  $  021:动态拉起状态                               $    $               $    $  ANS016.BYTE004  $  if(x1==0)y=@0047;else if(x1==1)y=@0050;else if(x1==2)y=@0051;else if(x1==3)y=@0052;else y=@001c;
  $  022:EPB(电子驻车)操作模式                      $    $               $    $  ANS017.BYTE004  $  if(x1==0)y=@004e;else if(x1==1)y=@004f;else y=@001c;
