...
读数据流: 
  ...
  $  001:风速                   $    $               $    $  ANS001.BYTE004  $  if(x1<0x08) y=@002d; else y=@0097;
  ...
  $  005:车内温度               $    $  degree C     $    $  ANS005.BYTE004  $  if((x1>0x7F) && (x1<0xB3)) y=x1-128; else y=@0097;
  $  006:蒸发器温度             $    $  degree C     $    $  ANS006.BYTE004  $  if(x1>0x19) y=x1; else y=@0097;
  $  007:读AC请求状态           $    $               $    $  ANS007.BYTE004  $  if(x1==0x00) y=@014a; else if(x1==0x01) y=@014b; else y=@0097;
  $  008:鼓风机继电器控制       $    $               $    $  ANS008.BYTE004  $  if(x1==0x00) y=@002e; else y=@002f;
