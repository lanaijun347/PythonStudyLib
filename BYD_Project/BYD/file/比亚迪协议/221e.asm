...
读数据流: 
  ...
  $  018:主动泄放状态                       $    $               $    $  ANS018.BYTE004  $  if((x1==0)) y=@01b8;else if((x1==1)) y=@01cf;else if((x1==2)) y=@03de;else if((x1==3)) y=@01d1;else y=@03df;
  $  019:前驱动电机零位值                   $    $               $    $  ANS019.BYTE004  $  y=SPRINTF([%0X %0X],x2,x1);
  $  020:前驱动电机零位标定状态             $    $               $    $  ANS020.BYTE004  $  if((x1==0)) y=@000f;else if((x1==1)) y=@03d8;else if((x1==2)) y=@03d9;else y=@00d6;
  $  021:电机零位检验状态                   $    $               $    $  ANS021.BYTE004  $  if((x1==0)) y=@03da;else if((x1==1)) y=@03db;else if((x1==2)) y=@03dc;else if((x1==3)) y=@003c;else y=@00d6;
