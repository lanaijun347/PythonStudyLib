...
读数据流: 
  ...
  $  065:发动机启动命令                              $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x07)0x02:y=@00d1; 0x03: y=@00d1;0x04:y=@01f3; 0x05: y=@01f3;default:y=@0048;
  $  066:低压启动电池状态                            $    $               $    $  ANS000.BYTE018  $  if((x1&0x1F)<0x08)y=@002e;else if((x1&0x1F)<0x10)y=@002f;else if((x1&0x1F)<0x18)y=@002e;else y=@0048;
  $  067:发动机启动超时次数                          $    $               $    $  ANS000.BYTE018  $  if((x1&0x7F)<0x20)y=@0022;else if((x1&0x7F)<0x40)y=@0251;else if((x1&0x7F)<0x60)y=@0252;else y=@0048;
  $  068:真空泵控制回路#1                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x07)0x00:y=@01ef; 0x01: y=@01ef;0x02:y=@0119; 0x03: y=@0119;0x04:y=@0022; 0x05: y=@0022;default:y=@0048;
  $  069:真空泵控制回路#2                            $    $               $    $  ANS000.BYTE020  $  if((x1&0x1F)<0x08)y=@01ef;else if((x1&0x1F)<0x10)y=@0119;else if((x1&0x1F)<0x18)y=@0022;else y=@0048;
  $  070:真空泵泄露状态                              $    $               $    $  ANS000.BYTE020  $  if((x1&0x7F)<0x20)y=@01ef;else if((x1&0x7F)<0x40)y=@01f2;else if((x1&0x7F)<0x60)y=@019e;else y=@0022;
  $  071:低速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x01)y=@0000;else y=@0001;
  $  072:高速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x02)y=@0000;else y=@0001;
  $  073:风扇类型                                    $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@01d2;else if((x1&0x0F)<0x08)y=@01d3;else y=@009e;
