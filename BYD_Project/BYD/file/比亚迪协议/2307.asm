...
版本信息:
  ...
  $%  002:软件最后更新日期:        $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  $%  003:生产日期:                $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  $%  004:车型:                    $%    $%  ANS002.BYTE004  $%  switxh(x1)0x81: y=@0194;0x82: y=@008d;0x83: y=@0084;0x84: y=@0195;0x85: y=@0196;default: y=@0019;
  $%  005:MCU:                     $%    $%  ANS003.BYTE004  $%  switxh(x1)0x81: y=@0197;default: y=@0019;
  $%  006:压缩机产品序列号:        $%    $%  ANS004.BYTE004  $%  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $%  007:生产日期_1:              $%    $%  ANS004.BYTE007  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
