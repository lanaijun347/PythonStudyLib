...
读数据流: 
  ...
  $  000:内部供电状况             $    $       $    $  ANS000.BYTE004  $  if(x1==0) y=@026c;else if(x1==0xff) y=@026d;else y=@0076;
  $  001:读卡器是否失去通信       $    $       $    $  ANS000.BYTE005  $  if(x1==0) y=@026a;else if(x1==0xff) y=@026b;else y=@0076;
  $  002:读卡器内部天线故障       $    $       $    $  ANS000.BYTE006  $  if(x1==0) y=@0022;else if(x1==0xff) y=@003a;else y=@0076;
  $  003:钥匙状态                 $    $       $    $  ANS000.BYTE007  $  if(x1==0x03) y=@0261;else if(x1==0x04) y=@0262;else y=@0264;
