...
读数据流: 
  ...
  $  011:电流采样电路状态                       $    $               $    $  ANS011.BYTE004  $  if((x1&0x03)==0x00) y=@0022;else if((x1&0x03)==0x01) y=@03c1;else if((x1&0x03)==0x02) y=@03c2;else if((x1&0x03)==0x03) y=@03c3;
  $  012:三相电流状态                           $    $               $    $  ANS011.BYTE004  $  if((x1&0x0C)==0x00) y=@0022;else if((x1&0x0C)==0x04) y=@03c1;else if((x1&0x0C)==0x08) y=@03c2;else if((x1&0x0C)==0x0C) y=@03c3;
  $  013:IPM/IGBT(绝缘栅双极型晶体管)状态       $    $               $    $  ANS011.BYTE004  $  if(x1&0x10) y=@074a;else y=@0022;
  $  014:内部温度传感器状态                     $    $               $    $  ANS011.BYTE004  $  if(x1&0x20) y=@003a;else y=@0022;
  $  015:内部电流状态                           $    $               $    $  ANS011.BYTE004  $  if((x1&0xC0)==0x00) y=@0022;else if((x1&0xC0)==0x40) y=@03c9;else if((x1&0xC0)==0x80) y=@03ca;else if((x1&0xC0)==0xC0) y=@03cb;
  $  016:启动状态                               $    $               $    $  ANS011.BYTE005  $  if(x1&0x01) y=@04b2;else y=@0022;
  $  017:内部温度状态                           $    $               $    $  ANS011.BYTE005  $  switxh(x1&0x07)0x00: y=@0022; 0x01: y=@0022;0x02: y=@03c4; 0x03: y=@03c4;0x04:y=@04b1;0x05:y=@04b1;0x06: y=@009e;0x07: y=@009e;default:y=@0076;
  $  018:转速状态                               $    $               $    $  ANS011.BYTE005  $  if(x1&0x08) y=@003a;else y=@0022;
  $  019:压缩机负载状态                         $    $               $    $  ANS011.BYTE005  $  if((x1&0x30)==0x10) y=@03c7;else if((x1&0x30)==0x20) y=@074b;else if((x1&0x30)==0x30) y=@009e;else y=@0022;
  $  020:母线电压状态                           $    $               $    $  ANS011.BYTE005  $  if((x1&0xC0)==0x00) y=@0022;else if((x1&0xC0)==0x40) y=@03c5;else if((x1&0xC0)==0x80) y=@03c6;else if((x1&0xC0)==0xC0) y=@009e;
  $  021:内部低压电状态                         $    $               $    $  ANS011.BYTE006  $  if((x1&0x03)==0x00) y=@0022;else if((x1&0x03)==0x01) y=@03cd;else if((x1&0x03)==0x02) y=@03ce;else if((x1&0x03)==0x03) y=@009e;
  $  022:相电压状态                             $    $               $    $  ANS011.BYTE006  $  if(x1&0x04) y=@03cc;else y=@0022;
