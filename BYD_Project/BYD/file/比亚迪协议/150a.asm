...
清除故障码:
  ...
  $$  REQ000:7C6 03 14 00 FF 00 00 00 00       $$  ANS000:7CE 03 14 00 FF 00 00 00 00

;******************************************************************************************************************************************************

版本信息:

  $%  REQ000:7C6 03 22 F1 94 00 00 00 00       $%  ANS000:7CE 03 22 F1 94 00 00 00 00
  $%  REQ001:7C6 03 22 F1 95 00 00 00 00       $%  ANS001:7CE 03 22 F1 95 00 00 00 00
  $%  REQ002:7C6 03 22 F1 93 00 00 00 00       $%  ANS002:7CE 03 22 F1 93 00 00 00 00
  ...
  $%  002:软件日期:        $%    $%  ANS001.BYTE006  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
