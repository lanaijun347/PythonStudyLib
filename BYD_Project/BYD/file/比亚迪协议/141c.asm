...
版本信息:
  ...
  $%  000:ECU车型系列:        $%    $%  ANS000.BYTE004  $%  y=@0797;
  ...
  $%  004:生产日期:           $%    $%  ANS000.BYTE009  $%  y=SPRINTF([20%02X%s%02X%s%02X%s],x1,@001d,x2,@001e,x3,@001f);
  $%  005:车速信息:           $%    $%  ANS001.BYTE027  $%  y=x1;
  $%  006:ECU加密信息:        $%    $%  ANS002.BYTE004  $%  if(x1==0x00)y=@0077;else if(x1==0x01)y=@0078;else y=@0076;
