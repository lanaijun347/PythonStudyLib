...
读数据流: 
  ...
  $  005:后驱电动机控制器启动允许命令       $    $               $    $  ANS005.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@03d6;0x01: y=@03e3;default: y=@03e4;
  $  006:整车控制器防盗解除状态             $    $               $    $  ANS006.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0501;0x01: y=@0502;0x02: y=@03e5;default: y=@03e4;
  $  007:整车档位                           $    $               $    $  ANS007.BYTE004  $  switxh((x2<<8)+x1)0x01: y=@0132;0x02: y=@00c7;0x03: y=@00c8;0x04: y=@0133;default: y=@03e4;
  $  008:整车工作模式                       $    $               $    $  ANS008.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0503;0x01: y=@0504;0x02: y=@0505;0x03: y=@0506;default: y=@03e4;
  $  009:整车运行模式                       $    $               $    $  ANS009.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0140;0x01: y=@0141;default: y=@03e4;
  $  010:动力系统状态                       $    $               $    $  ANS010.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0022;0x01: y=@03ee;0x02: y=@03ef;0x03: y=@03f0;default: y=@03e4;
  $  011:水泵状态                           $    $               $    $  ANS011.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@003b;0x01: y=@0005;default: y=@03e4;
  $  012:巡航状态                           $    $               $    $  ANS012.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@01af;0x01: y=@01b0;default: y=@03e4;
  ...
  $  021:OK灯信息                           $    $               $    $  ANS021.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@00a2;0x01: y=@00a1;0x02: y=@050e;default: y=@03e4;
  $  022:电里程                             $    $  km           $    $  ANS022.BYTE004  $  y=(x3<<16)+(x2<<8)+x1;
  $  023:总里程                             $    $  km           $    $  ANS023.BYTE004  $  y=(x3<<16)+(x2<<8)+x1;
  $  024:整车驱动电机系统配置类型           $    $               $    $  ANS024.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0507;0x01: y=@0508;0x02: y=@000f;default: y=@03e4;
  $  025:倾角标定工作信息/是否校准          $    $               $    $  ANS025.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@01b4;0x01: y=@01b5;default: y=@03e4;
  $  026:前电机目标档位                     $    $               $    $  ANS026.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0509;0x01: y=@050a;0x02: y=@050b;0x03: y=@050c;0x04: y=@050d;default: y=@03e4;
