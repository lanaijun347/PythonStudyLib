...
读数据流: 
  ...
  $  001:后背门动作状态                    $    $        $    $  ANS001.BYTE004  $  switxh(x1&0x03)0x00: y=@0004;0x01: y=@0005;0x02: y=@00d2;default: y=@001c;
  $  002:电源档位状态                      $    $        $    $  ANS002.BYTE004  $  switxh(x1&0x03)0x00: y=@0048;0x01: y=@00d4;0x02: y=@025c;0x03: y=@00d3;default: y=@001c;
  $  003:遥控钥匙上后背门开关信号          $    $        $    $  ANS003.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  004:电动后背门内开关信号              $    $        $    $  ANS004.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  005:电动后背门外开关信号              $    $        $    $  ANS005.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  006:车内开关信号                      $    $        $    $  ANS006.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  007:后背门锁全锁信号                  $    $        $    $  ANS007.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  008:后背门锁半锁信号                  $    $        $    $  ANS008.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  009:后背门锁解锁信号                  $    $        $    $  ANS009.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  010:左侧防夹条传感器信号              $    $        $    $  ANS010.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  011:右侧防夹条传感器信号              $    $        $    $  ANS011.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  012:吸合执行器动作信号                $    $        $    $  ANS012.BYTE004  $  switxh(x1&0x03)0x00: y=@0138;0x01: y=@0139;0x02: y=@00d2;default: y=@001c;
  $  013:左侧spindle(轴)撑杆动作信号       $    $        $    $  ANS013.BYTE004  $  switxh(x1&0x03)0x00: y=@0138;0x01: y=@0139;0x02: y=@00d2;default: y=@001c;
  $  014:右侧spindle(轴)撑杆动作信号       $    $        $    $  ANS014.BYTE004  $  switxh(x1&0x03)0x00: y=@0138;0x01: y=@0139;0x02: y=@00d2;default: y=@001c;
  $  015:电源电压                          $    $  V     $    $  ANS015.BYTE004  $  y=x1*0.078;
  $  016:后背门当前位置                    $    $        $    $  ANS016.BYTE004  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=3000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==4095)) y=@00be;else y=@001c;
  $  017:后背门行程                        $    $        $    $  ANS017.BYTE004  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=3000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==4095)) y=@00be;else y=@001c;
  $  018:左侧撑杆当前位置                  $    $        $    $  ANS018.BYTE004  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=3000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==4095)) y=@00be;else y=@001c;
  $  019:左侧撑杆行程                      $    $        $    $  ANS019.BYTE004  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=3000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==4095)) y=@00be;else y=@001c;
  $  020:右侧撑杆当前位置                  $    $        $    $  ANS020.BYTE004  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=3000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==4095)) y=@00be;else y=@001c;
  $  021:右侧撑杆行程                      $    $        $    $  ANS021.BYTE004  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=3000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==4095)) y=@00be;else y=@001c;
