...
读数据流: 
  ...
  $  003:管柱调节开关缩回信号               $    $        $    $  ANS000.BYTE004  $  if(x1&0x08)y=@0004;else y=@0005;
  $  004:电动管柱系统状态                   $    $        $    $  ANS000.BYTE004  $  if(x1&0x10)y=@003a;else y=@0022;
  $  005:电动管柱工作状态                   $    $        $    $  ANS000.BYTE004  $  if(x1&0x20)y=@0259;else if(x1&0x40) y=@06ed;else if(x1&0x80) y=@06ee;else y=@0076;
  $  006:电源档位状态                       $    $        $    $  ANS000.BYTE005  $  if(x1==0x00)y=@0004;else if(x1==0x01) y=@025c;else if(x1==0x02) y=@0005;else y=@0076;
