...
读数据流: 
  ...
  $  011:左侧驻车状态                        $    $               $    $  ANS011.BYTE004  $  switxh(x1)0x00: y=@009a;0x01: y=@03b1;0x02: y=@03b2;0x03: y=@03b3;0x04: y=@00de;0x05: y=@03b4;0x06: y=@03b5;default: y=@001c;
  $  012:右侧驻车状态                        $    $               $    $  ANS012.BYTE004  $  switxh(x1)0x00: y=@009a;0x01: y=@03b1;0x02: y=@03b2;0x03: y=@03b3;0x04: y=@00de;0x05: y=@03b4;0x06: y=@03b5;default: y=@001c;
  $  013:EPB(电子驻车)开关状态               $    $               $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@03af;0x01: y=@03b0;default: y=@001c;
  $  014:车速                                $    $  km/h         $    $  ANS014.BYTE004  $  y=((x1<<8)+x2)*1.0/10;
  $  015:点火开关状态                        $    $               $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@0005;0x01: y=@0004;default: y=@001c;
  ...
  $  021:诊断会话模式                        $    $               $    $  ANS021.BYTE004  $  switxh(x1)0x01: y=@00f6;0x02: y=@0020;0x03: y=@0497;default: y=@001c;
