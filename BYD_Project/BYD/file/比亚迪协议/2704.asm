...
读数据流: 
  ...
  $  000:ECU加密信息       $    $       $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0077;0x01: y=@0078;default: y=@001c;
  $  001:ECU加密方式       $    $       $    $  ANS000.BYTE005  $  switxh(x1)0x00: y=@0077;0x01: y=@0385;0x02: y=@008f;0x03: y=@0386;default: y=@001c;
