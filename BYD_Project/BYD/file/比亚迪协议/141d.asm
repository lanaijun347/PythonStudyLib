...
读数据流: 
  ...
  $  005:蓝牙电话开       $    $       $    $  ANS000.BYTE004  $  if(x1&0x20)y=@002e;else y=@003e;
  ...
  $  009:语音输入         $    $       $    $  ANS000.BYTE005  $  if(x1&0x02)y=@002e;else y=@003e;
  ...
  $  015:蓝牙电话关       $    $       $    $  ANS000.BYTE005  $  if(x1&0x80) y=@002e;else y=@003e;
  $  016:仪表返回         $    $       $    $  ANS001.BYTE004  $  if(x1&0x08)y=@002e;else y=@003e;
