...
读数据流: 
  ...
  $  000:前舱盖开关状态             $    $       $    $  ANS000.BYTE004  $  y=@001c;
  $  001:报警器继电器状态           $    $       $    $  ANS000.BYTE004  $  y=@001c;
  $  002:前洗涤继电器状态           $    $       $    $  ANS000.BYTE004  $  y=@001c;
  $  003:刮水器开关状态             $    $       $    $  ANS000.BYTE004  $  y=@001c;
  $  004:前雨刮调速继电器状态       $    $       $    $  ANS000.BYTE004  $  y=@001c;
  $  005:前雨刮复位信号             $    $       $    $  ANS000.BYTE004  $  y=@001c;
  $  006:近光灯继电器状态           $    $       $    $  ANS000.BYTE005  $  y=@001c;
  $  007:远光灯继电器状态           $    $       $    $  ANS000.BYTE005  $  y=@001c;
  $  008:前雾灯继电器状态           $    $       $    $  ANS000.BYTE005  $  y=@001c;
  $  009:昼行灯状态                 $    $       $    $  ANS000.BYTE005  $  y=@001c;
  $  010:小灯继电器状态             $    $       $    $  ANS000.BYTE005  $  y=@001c;
  $  011:喇叭状态                   $    $       $    $  ANS000.BYTE005  $  y=@001c;
  $  012:后除霜继电器状态           $    $       $    $  ANS000.BYTE005  $  y=@001c;
