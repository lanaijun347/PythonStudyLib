...
版本信息:
  ...
  $%  002:硬件日期:                         $%    $%  ANS001.BYTE005  $%  y=SPRINTF([%d%s%d%s%d%s],x1,@001d,x2,@001e,x3,@001f);
  ...
  $%  005:软件日期:                         $%    $%  ANS003.BYTE006  $%  y=SPRINTF([%d%s%d%s%d%s],x1,@001d,x2,@001e,x3,@001f);
...
读数据流: 
  ...
  $  007:制动踏板状态            $    $           $    $  ANS002.BYTE004  $  if(x1&0x01)y=@036e;else y=@00aa;
  ...
  $  018:加注状态                $    $           $    $  ANS003.BYTE004  $  if(x1==0xAA)y=@000d;else if(x1==0xEE)y=@000e;else if(x1==0x00)y=@000c;else y=@000f;
  $  019:下线检测状态            $    $           $    $  ANS004.BYTE004  $  if(x1==0xAA)y=@0011;else if(x1==0xEE)y=@0012;else if(x1==0x00)y=@0010;else y=@000f;
