...
读数据流: 
  ...
  $  001:电机目标转速       $    $  rpm          $    $  ANS001.BYTE004  $  if(x2<0x1B) y=x1+x2*256;else if((x2==0x1B) && (x1<0x59)) y=x1+x2*256; else y=@00d6;
  $  002:电机实际转速       $    $  rpm          $    $  ANS002.BYTE004  $  if(x2<0x1B) y=x1+x2*256;else if((x2==0x1B) && (x1<0x59)) y=x1+x2*256; else y=@00d6;
  $  003:直流母线电压       $    $  V            $    $  ANS003.BYTE004  $  if(x1<0x33) y=x1;else y=@00d6;
  $  004:交流侧电流         $    $  A            $    $  ANS004.BYTE004  $  if(x1<0xC9) y=x1;else y=@00d6;
  $  005:散热器温度         $    $  degree C     $    $  ANS005.BYTE004  $  if(x1<0xC9) y=x1;else y=@00d6;
