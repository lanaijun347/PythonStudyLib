...
读数据流: 
  ...
  $  080:发动机冷却系统-风扇类型                     $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@01d2;else if((x1&0x0F)<0x08)y=@0249;else y=@001c;
  ...
  $  088:发动机动态工况-是否D档(前进挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x20)y=@0000;else y=@0001;
  $  089:发动机动态工况-是否R档(后退挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x40)y=@0000;else y=@0001;
  $  090:发动机动态工况-是否N档(空挡)                $    $               $    $  ANS000.BYTE025  $  if(x1&0x80)y=@0000;else y=@0001;
  ...
  $  098:发动机怠速-后车窗/前挡风玻璃加热            $    $               $    $  ANS000.BYTE028  $  if(x1&0x08)y=@0004;else y=@0005;
