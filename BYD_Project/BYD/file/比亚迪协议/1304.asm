...
读数据流: 
  ...
  $  000:电源电压                                  $    $  V             $    $  ANS000.BYTE004  $  y=x1*1.0/10;
  ...
  $  011:左侧驻车状态                              $    $                $    $  ANS011.BYTE004  $  if(x1 == 0x00) y=@009a;else if(x1 == 0x01) y=@03b1;else if(x1 == 0x02) y=@03b2;else if(x1 == 0x03) y=@03b3;else if(x1 == 0x04) y=@00de;else if(x1 == 0x05) y=@03b4;else if(x1 == 0x06) y=@03b5;else y=@0440;
  $  012:右侧驻车状态                              $    $                $    $  ANS012.BYTE004  $  if(x1 == 0x00) y=@009a;else if(x1 == 0x01) y=@03b1;else if(x1 == 0x02) y=@03b2;else if(x1 == 0x03) y=@03b3;else if(x1 == 0x04) y=@00de;else if(x1 == 0x05) y=@03b4;else if(x1 == 0x06) y=@03b5;else y=@0440;
  $  013:EPB(电子驻车)开关状态                     $    $                $    $  ANS013.BYTE004  $  if(x1 == 0x00) y=@03af;else if(x1 == 0x01) y=@03b0;else if(x1 == 0x02) y=@0580;else y=@0440;
  $  014:车速                                      $    $  km/h          $    $  ANS014.BYTE004  $  y=x1*25.6+x2*26.0/255;
  $  015:点火开关状态                              $    $                $    $  ANS015.BYTE004  $  if(x1 == 0x00) y=@0005;else if(x1 == 0x01) y=@0004;else y=@0440;
  $  016:ECU唤醒计数                               $    $                $    $  ANS016.BYTE004  $  y=UINT(x1*0x1000000+x2*0x10000+x3*0x100+x4);
  $  017:ESP(电子车身稳定系统)加速度传感器值       $    $  米/平方秒     $    $  ANS017.BYTE004  $  y=(x1*256+x2)*0.1-20;
  $  018:ESP(电子车身稳定系统)加速度传感偏差       $    $  米/平方秒     $    $  ANS018.BYTE004  $  y=(x1*256+x2)*0.1-20;
