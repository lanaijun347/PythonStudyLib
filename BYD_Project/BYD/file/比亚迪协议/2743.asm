...
读数据流: 
  ...
  $  001:车型颜色                 $    $         $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0048;0x01: y=@040c;0x02: y=@040d;0x03: y=@040e;0x04: y=@040f;0x05: y=@0410;0x06: y=@0411;0x07: y=@0412;0x08: y=@0413;0x09: y=@0414;0x0A: y=@0415;0x0B: y=@0416;0x0C: y=@0417;0x0D: y=@0418;0x0E: y=@0419;0x0F: y=@041a;0x10: y=@041b;0x11: y=@041c;0x12: y=@041d;0x13: y=@041e;0x14: y=@041f;0x15: y=@0420;default: y=@001c;
  $  002:车顶行李架配置           $    $         $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0048;0x01: y=@040a;0x02: y=@040b;0x03: y=@009e;default: y=@001c;
  $  003:外置天线配置             $    $         $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0048;0x01: y=@040a;0x02: y=@040b;0x03: y=@009e;default: y=@001c;
  $  004:天窗配置                 $    $         $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@0048;0x01: y=@040a;0x02: y=@0421;0x03: y=@0422;default: y=@001c;
  $  005:已匹配钥匙数             $    $  把     $    $  ANS005.BYTE004  $  y=x1;
  $  006:内部供电状况             $    $         $    $  ANS006.BYTE004  $  switxh(x1)0x00: y=@026c;0xFF: y=@026d;default: y=@001c;
  $  007:读卡器是否失去通信       $    $         $    $  ANS006.BYTE005  $  switxh(x1)0x00: y=@026a;0xFF: y=@026b;default: y=@001c;
  $  008:内部天线状态             $    $         $    $  ANS006.BYTE006  $  switxh(x1)0x00: y=@0022;0xFF: y=@003a;default: y=@001c;
  $  009:钥匙状态                 $    $         $    $  ANS006.BYTE007  $  switxh(x1)0x02: y=@0264;0x03: y=@0261;0x04: y=@0262;0x06: y=@0263;default: y=@001c;
