...
读数据流: 
  ...
  $  025:水平调节电机循环次数       $    $           $    $  ANS001.BYTE021  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=30000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==65535)) y=@0472;else y=@001c;
  $  026:靠背调节电机循环次数       $    $           $    $  ANS001.BYTE023  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=10000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==65535)) y=@0472;else y=@001c;
  $  027:高度调节电机循环次数       $    $           $    $  ANS001.BYTE025  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=10000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==65535)) y=@0472;else y=@001c;
  $  028:坐盆调节电机循环次数       $    $           $    $  ANS001.BYTE027  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=10000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==65535)) y=@0472;else y=@001c;
  $  029:座椅加热时间               $    $  小时     $    $  ANS001.BYTE029  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=3000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==4095)) y=@0472;else y=@001c;
  $  030:座椅通风时间               $    $  小时     $    $  ANS001.BYTE031  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=3000)) y=((x1<<8)+x2);else if((((x1<<8)+x2)==4095)) y=@0472;else y=@001c;
