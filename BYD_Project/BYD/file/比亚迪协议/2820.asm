...
读数据流: 
  ...
  $  008:系统状态                 $    $               $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@0005;0x01: y=@0006;0x02: y=@049b;0x03: y=@049c;default: y=@049d;
  $  009:主副雷达下线标定值       $    $               $    $  ANS009.BYTE004  $  if((x1==0)) y=@004b;else if((x1==1)) y=@048d;else if((x1==2)) y=@048f;else if((x1==3)) y=@008d;else if((x1==4)) y=@0079;else if((x1==5)) y=@0499;else if((x1==6)) y=@00d6;else if((x1>=7)&&(x1<=255)) y=@049a;else y=@001c;
