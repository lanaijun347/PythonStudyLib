...
读数据流: 
  ...
  $  009:驻车制动开关状态                $    $               $    $  ANS004.BYTE004  $  if(x1==0)y=@0045;else if(x1==1)y=@0046;else if(x1==2)y=@0047;else if(x1==3)y=@0048;else y=@0076;
  $  010:目标拉力                        $    $  N            $    $  ANS005.BYTE004  $  y=x1*10;
  $  011:EPB(电子驻车)状态               $    $               $    $  ANS006.BYTE004  $  if(x1==0)y=@0055;else if(x1==1)y=@0056;else if(x1==2)y=@0057;else if(x1==3)y=@0058;else if(x1==4)y=@0059;else y=@0076;
  $  012:EPB(电子驻车)校准检测状态       $    $               $    $  ANS007.BYTE004  $  if(x1==0)y=@0053;else if(x1==1)y=@0054;else y=@0076;
  $  013:IGN状态                         $    $               $    $  ANS008.BYTE004  $  if(x1==0)y=@005a;else if(x1==1)y=@005b;else if(x1==2)y=@005c;else if(x1==3)y=@005d;else y=@0076;
  $  014:维修模式                        $    $               $    $  ANS009.BYTE004  $  if(x1==0)y=@004b;else if(x1==1)y=@06d7;else if(x1==2)y=@004d;else y=@0076;
  $  015:EPB(电子驻车)电机操作有效       $    $               $    $  ANS010.BYTE004  $  if(x1==0)y=@0049;else if(x1==1)y=@004a;else y=@0076;
  $  016:动态拉起状态                    $    $               $    $  ANS011.BYTE004  $  if(x1==0)y=@0047;else if(x1==1)y=@0050;else if(x1==2)y=@0051;else if(x1==3)y=@0052;else y=@0076;
  $  017:EPB(电子驻车)操作模式           $    $               $    $  ANS012.BYTE004  $  if(x1==0)y=@004e;else if(x1==1)y=@004f;else y=@0076;
