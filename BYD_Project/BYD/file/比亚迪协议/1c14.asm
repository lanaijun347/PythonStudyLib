...
读数据流: 
  ...
  $  013:CAN车速状态                                 $    $               $    $  ANS008.BYTE006  $  if(x1==0) y=@0022; else if(x1==1) y=@00be; else y=@001c;
  ...
  $  024:CAN发动机转速状态                           $    $               $    $  ANS014.BYTE006  $  if(x1==0) y=@0022; else if(x1==1) y=@00be; else y=@001c;
  ...
  $  043:油泵使能信息                                $    $               $    $  ANS025.BYTE005  $  if(x1==0) y=@00d1; else if(x1==1) y=@00d2; else y=@001c;
  $  044:油泵转速                                    $    $  rpm          $    $  ANS025.BYTE006  $  y=x1*256+x2;
  $  045:离合器强制脱开命令有效标志                  $    $               $    $  ANS026.BYTE004  $  if(x1==0) y=@0048; else if(x1==1) y=@00e6; else y=@001c;
  $  046:离合器强制脱开                              $    $               $    $  ANS026.BYTE005  $  if(x1==0) y=@00ea; else if(x1==1) y=@00eb; else y=@001c;
  $  047:整车实际工作模式                            $    $               $    $  ANS026.BYTE006  $  if(x1==0) y=@00d2; else if(x1==1) y=@00e7; else if(x1==2) y=@0505;else if(x1==3) y=@00e9;else y=@001c;
