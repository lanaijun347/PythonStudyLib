...
读数据流: 
  ...
  $  002:板换出口侧冷却液温度                  $    $          $    $  ANS002.BYTE004  $  if(((x2*256+x1)*0.1) <= 100) y=(x2*256+x1)*0.1;else if(((x2*25.6+x1*0.1)-6553.6) >= 0-40) y=(x2*25.6+x1*0.1)-6553.6;else y=@001c;
  $  003:板式换热器出口冷媒压力                $    $  Mpa     $    $  ANS003.BYTE004  $  if((x1*0.001+x2*0.256) <= 10) y=(x1*0.001+x2*0.256);else y=@001c;
  $  004:板式换热器出口冷媒温度                $    $          $    $  ANS004.BYTE004  $  if(((x2*256+x1)*0.1) <= 100) y=(x2*256+x1)*0.1;else if(((x2*25.6+x1*0.1)-6553.6) >= 0-10) y=(x2*25.6+x1*0.1)-6553.6;else y=@001c;
