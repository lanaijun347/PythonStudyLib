...
读数据流: 
  ...
  $  000:电机状态                 $    $               $    $  ANS000.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@03d4;0x01: y=@03d5;0x02: y=@0005;default: y=@0440;
  $  001:发动机状态               $    $               $    $  ANS001.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@00d1;0x01: y=@0005;default: y=@0440;
  $  002:离合器强制脱开状态       $    $               $    $  ANS002.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@04f7;0x01: y=@04f8;default: y=@0440;
  $  003:启动允许                 $    $               $    $  ANS003.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@03d6;0x01: y=@0523;default: y=@0440;
  $  004:防盗解除状态             $    $               $    $  ANS004.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0501;0x01: y=@0502;0x02: y=@03e5;default: y=@0440;
  $  005:主动泄放状态             $    $               $    $  ANS005.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@01b8;0x01: y=@01cf;0x02: y=@03de;0x03: y=@01d1;default: y=@0440;
  $  006:盖子状态                 $    $               $    $  ANS006.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0004;0x01: y=@0005;default: y=@0440;
  $  007:整车档位                 $    $               $    $  ANS007.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0132;0x01: y=@00c7;0x02: y=@0133;0x03: y=@00c8;0x04: y=@00be;default: y=@0440;
  $  008:整车工作模式             $    $               $    $  ANS008.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0503;0x01: y=@0504;0x02: y=@0505;0x03: y=@0506;default: y=@0440;
  $  009:整车运行模式             $    $               $    $  ANS009.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0140;0x01: y=@0141;default: y=@0440;
  $  010:动力系统状态             $    $               $    $  ANS010.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0022;0x01: y=@0059;default: y=@0440;
  $  011:水泵状态                 $    $               $    $  ANS011.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0004;0x01: y=@0005;default: y=@0440;
  $  012:巡航状态                 $    $               $    $  ANS012.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0524;0x01: y=@0525;default: y=@0440;
  ...
  $  031:EPB(电子驻车)状态        $    $               $    $  ANS031.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@00de;0x01: y=@00aa;0x02: y=@0526;0x03: y=@0024;0x04: y=@0059;default: y=@0440;
  $  032:驱动电机旋变状态         $    $               $    $  ANS032.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0022;0x01: y=@0059;default: y=@0440;
  $  033:驱动电机过流状态         $    $               $    $  ANS033.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0022;0x01: y=@0059;default: y=@0440;
  $  034:电机目标档位             $    $               $    $  ANS034.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@054b;0x01: y=@050a;0x02: y=@050b;0x03: y=@050c;0x04: y=@050d;default: y=@0440;
  $  035:校准状态                 $    $               $    $  ANS035.BYTE004  $  switxh(x1)0x00: y=@01b4;0x01: y=@01b5;default: y=@0440;
  $  036:错误状态                 $    $               $    $  ANS035.BYTE005  $  switxh(x1)0x00: y=@054c;0x01: y=@0099;default: y=@0440;
  $  037:坡道坡度                 $    $               $    $  ANS035.BYTE006  $  if((((x2<<8)+x1)>=0)&&(((x2<<8)+x1)<=300))y=(((x2<<8)+x1))*1.0/10;else if((((x2<<8)+x1)>=65236)&&(((x2<<8)+x1)<=65535))y=((((x2<<8)+x1))-65536)*1.0/10;else if((((x2<<8)+x1)==32767)) y=@0401;else y=@001c;
