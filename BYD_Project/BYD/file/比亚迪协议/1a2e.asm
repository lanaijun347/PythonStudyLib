...
读数据流: 
  ...
  $  001:冷凝风扇工作状态                    $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@01ca;else if(x1==0x02)y=@019a;else if(x1==0x03)y=@0749;else  y=@001c;
  $  002:冷却风扇工作状态                    $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@01ca;else if(x1==0x02)y=@019a;else if(x1==0x03)y=@0749;else  y=@001c;
  $  003:电源电压                            $    $  V            $    $  ANS003.BYTE004  $  if(x1<=0xFA) y=x1*0.125;else if(x1 == 0xFF) y=@0775;else y=@001c;
  $  004:冷凝风扇实际工作的占空比            $    $  %            $    $  ANS004.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@0775;else y=@001c;
  $  005:冷却风扇实际工作的占空比            $    $  %            $    $  ANS005.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@0775;else y=@001c;
  $  006:冷凝/冷却风扇预置工作的占空比       $    $  %            $    $  ANS006.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@0775;else y=@001c;
  $  007:模块温度                            $    $  degree C     $    $  ANS007.BYTE004  $  if(x1<=0xD2) y=x1-40;else if(x1 == 0xFF) y=@0775;else y=@001c;
  $  008:电源档位                            $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@009e;else if(x1==0x01)y=@00d4;else if(x1==0x02)y=@025c;else if(x1==0x03)y=@00d3;else  y=@001c;
