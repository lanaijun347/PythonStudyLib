...
版本信息:
  ...
  $%  007:硬件日期_1:        $%    $%  ANS003.BYTE005  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
...
读数据流: 
  ...
  $  001:已匹配钥匙数             $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@060b;0x01: y=@0266;0x02: y=@0267;0x03: y=@0268;0x04: y=@0269;default: y=@001c;
