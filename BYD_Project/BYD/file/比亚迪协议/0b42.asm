...
读数据流: 
  ...
  $  009:座椅系统工作状态           $    $        $    $  ANS000.BYTE005  $  if((x1&0x0F)<2)y=@0259;else if((x1&0x0F)<4)y=@025a;else if((x1&0x0F)<6)y=@025b;else if((x1&0x0F)<8)y=@025f;else y=@0076;
  $  010:电源档位状态               $    $        $    $  ANS000.BYTE005  $  if(x1<0x10)y=@0004;else if(x1==0x10) y=@025c;else if(x1==0x20) y=@0005;else y=@0076;
