...
读数据流: 
  ...
  $  000:发电机状态           $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@0059;else if(x1==0x02)y=@01a4;else y=@001c;
  $  001:发动机状态           $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@011a;else if(x1==0x01)y=@00d2;else if(x1==0x02)y=@00d1;else if(x1==0x03)y=@0059;else if(x1==0x04)y=@01a4;else y=@001c;
  $  002:放电是否允许         $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@002c;else if(x1==0x01)y=@002d;else if(x1==0x02)y=@06ca;else if(x1==0x03)y=@0692;else y=@001c;
  $  003:DC系统故障状态       $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@0059;else y=@001c;
  $  004:DC工作模式           $    $               $    $  ANS004.BYTE004  $  if(x1==0x00)y=@014c;else if(x1==0x01)y=@0435;else if(x1==0x02)y=@0436;else y=@001c;
