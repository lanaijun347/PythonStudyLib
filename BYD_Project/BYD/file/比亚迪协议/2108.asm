...
读数据流: 
  ...
  $  020:OK灯信息                           $    $               $    $  ANS020.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@00a2;else if((x1==0x01)&&(x2==0x00)) y=@00a1;else if((x1==0x02)&&(x2==0x00)) y=@050e;else y=@03e4;
  $  021:电里程                             $    $  km           $    $  ANS021.BYTE004  $  y=(x3<<16)+(x2<<8)+x1;
  $  022:总里程                             $    $  km           $    $  ANS022.BYTE004  $  y=(x3<<16)+(x2<<8)+x1;
  $  023:整车驱动电机系统配置类型           $    $               $    $  ANS023.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@0507;else if((x1==0x01)&&(x2==0x00)) y=@0508;else if((x1==0x02)&&(x2==0x00)) y=@000f;else y=@03e4;
  $  024:倾角标定工作信息/是否校准          $    $               $    $  ANS024.BYTE004  $  switxh(x1)0x00: y=@01b4;0x01: y=@01b5;default: y=@03e4;
  $  025:错误信息                           $    $               $    $  ANS024.BYTE005  $  switxh(x1)0x00: y=@054c;0x01: y=@0099;default: y=@03e4;
  $  026:坡道坡度                           $    $  °           $    $  ANS024.BYTE006  $  if((((x2<<8)+x1)>=0)&&(((x2<<8)+x1)<=300))y=(((x2<<8)+x1))*0.1;else if((((x2<<8)+x1)>=65236)&&(((x2<<8)+x1)<=65535))y=((((x2<<8)+x1))-65536)*0.1;else if((((x2<<8)+x1)==32767)) y=@0401;else y=@03e4;
  $  027:前电机目标档位                     $    $               $    $  ANS025.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@0509;else if((x1==0x01)&&(x2==0x00)) y=@050a;else if((x1==0x02)&&(x2==0x00)) y=@050b;else if((x1==0x03)&&(x2==0x00)) y=@050c;else if((x1==0x04)&&(x2==0x00)) y=@050d;else y=@03e4;
  ...
  $  031:电池配置                           $    $               $    $  ANS029.BYTE004  $  if((((x2<<8)+x1)==0)) y=@0076;else if((((x2<<8)+x1)==1)) y=@0076;else if((((x2<<8)+x1)==2)) y=@0076;else y=@03e4;
