...
读数据流: 
  ...
  $  067:车辆禁止停止                              $    $               $    $  ANS040.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@060e;0x01: y=@060f;0x02: y=@0610;0x03: y=@0611;0x04: y=@0612;0x05: y=@0613;0x06: y=@0614;0x07: y=@0615;0x08: y=@0616;0x09: y=@0617;0x0A: y=@009e;0x0B: y=@009e;0x0C: y=@0618;0x0D: y=@009e;0x0E: y=@0619;default: y=@001c;
  $  068:车辆禁止停止_1                            $    $               $    $  ANS040.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@060e;0x01: y=@060f;0x02: y=@0610;0x03: y=@0611;0x04: y=@0612;0x05: y=@0613;0x06: y=@0614;0x07: y=@0615;0x08: y=@0616;0x09: y=@0617;0x0A: y=@009e;0x0B: y=@009e;0x0C: y=@0618;0x0D: y=@009e;0x0E: y=@0619;default: y=@001c;
  $  069:发动机禁止停止                            $    $               $    $  ANS041.BYTE004  $  switxh((x2<<8)+x1)0x06: y=@060d;default: y=@001c;
  $  070:发动机故障禁止停止                        $    $               $    $  ANS042.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@061d;0x01: y=@061e;0x04: y=@061f;0x08: y=@0620;default: y=@001c;
