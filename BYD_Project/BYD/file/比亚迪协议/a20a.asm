...
读数据流: 
  ...
  $  002:位置状态               $    $        $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0048;else if(x1==0x01)y=@02df;else if(x1==0x02)y=@02e0;else y=@00d6;
  ...
  $  006:手动上升开关信号       $    $        $    $  ANS006.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@00d6;
  $  007:玻璃位置百分比         $    $  %     $    $  ANS007.BYTE004  $  if(x1<0xc9) y=x1/2;else y=@00d6;
