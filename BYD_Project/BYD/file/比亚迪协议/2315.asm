...
读数据流: 
  ...
  $  001:巡航按键故障标志位       $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x01: y=@0122;0x02: y=@0123;default: y=@001c;
  $  002:故障检测标志位           $    $       $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@009e;0x01: y=@0446;0x02: y=@0447;0x03: y=@0448;0x04: y=@0449;0x05: y=@012e;0x06: y=@012f;default: y=@001c;
  $  003:故障监测持续判断         $    $       $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@009e;0x01: y=@0126;0x02: y=@0127;0x03: y=@0128;0x04: y=@0129;default: y=@001c;
  $  004:自身识别档位信号         $    $       $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@0130;0x01: y=@0132;0x02: y=@00c7;0x03: y=@00c8;0x04: y=@0133;default: y=@001c;
