...
读数据流: 
  ...
  $  024:速度限制监视器         $    $                $    $  ANS005.BYTE004  $  if(x1==0x00)y=@03a7;else if(x1==0x01)y=@03a8;else y=@001c;
  $  025:主动诊断               $    $                $    $  ANS006.BYTE004  $  if(x1 == 0x01) y=@00f9;else if(x1 == 0x03) y=@00a5;else y=@00fa;
