...
读数据流: 
  ...
  $  005:后驱动电机控制器启动允许命令       $    $               $    $  ANS005.BYTE004  $  if((x1==0x00)&&(x2==0x00))y=@03d6;else if((x1==0x01)&&(x2==0x00))y=@03e3;else y=@03e4;
  $  006:整车控制器防盗解除状态             $    $               $    $  ANS006.BYTE004  $  if((x1==0x00)&&(x2==0x00))y=@0501;else if((x1==0x01)&&(x2==0x00))y=@0502;else if((x1==0x02)&&(x2==0x00))y=@0726;else y=@03e4;
  ...
  $  025:倾角标定工作信息/是否校准          $    $               $    $  ANS025.BYTE004  $  if((x1==0x00))y=@01b4;else if((x1==0x01))y=@01b5;else y=@03e4;
  $  026:错误信息                           $    $               $    $  ANS025.BYTE005  $  if((x1==0x00))y=@054c;else if((x1==0x01))y=@0099;else y=@03e4;
  $  027:坡道坡度                           $    $  °           $    $  ANS025.BYTE006  $  if(((x1+x2*256)*0.1)<31) y=(x1+x2*256)*0.1;else if(((x1+(x2-256)*256)*0.1)>(0-31)) y=(x1+(x2-256)*256)*0.1;else y=@03e4;
  $  028:前电机目标档位                     $    $               $    $  ANS026.BYTE004  $  if((x1==0x00)&&(x2==0x00))y=@07a5;else if((x1==0x01)&&(x2==0x00))y=@050a;else if((x1==0x02)&&(x2==0x00))y=@050b;else if((x1==0x03)&&(x2==0x00))y=@050c;else if((x1==0x04)&&(x2==0x00))y=@050d;else y=@03e4;
  $  029:售后软件版本号                     $    $               $    $  ANS027.BYTE004  $  if(((x1+x2*256)*0.1)<31) y=(x1+x2*256)*0.1;else if(((x1+(x2-256)*256)*0.1)>(0-31)) y=(x1+(x2-256)*256)*0.1;else y=@03e4;
