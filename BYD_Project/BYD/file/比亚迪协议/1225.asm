...
读数据流: 
  ...
  $  004:座椅水平向前调节按键开关次数       $    $       $    $  ANS001.BYTE004  $  if((x1+x2*256)<50001) y=x1+x2*256;else y=@0472;
  $  005:座椅水平向后调节按键开关次数       $    $       $    $  ANS001.BYTE006  $  if((x1+x2*256)<50001) y=x1+x2*256;else y=@0472;
  $  006:靠背前倾调节按键开关次数           $    $       $    $  ANS002.BYTE004  $  if((x1+x2*256)<50001) y=x1+x2*256;else y=@0472;
  $  007:靠背后倾调节按键开关次数           $    $       $    $  ANS002.BYTE006  $  if((x1+x2*256)<50001) y=x1+x2*256;else y=@0472;
