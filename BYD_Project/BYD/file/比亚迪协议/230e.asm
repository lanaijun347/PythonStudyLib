...
读数据流: 
  ...
  $  000:DC_2工作状态       $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x01: y=@0105;0x02: y=@0475;default: y=@001c;
  $  001:DC_2故障状态       $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x01: y=@0022;0x02: y=@0059;default: y=@001c;
  $  002:输出断路故障       $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@009e;0x01: y=@0022;0x02: y=@0663;default: y=@001c;
