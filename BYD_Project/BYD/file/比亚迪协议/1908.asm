...
读数据流: 
  ...
  $  001:巡航按键故障标志位       $    $       $    $  ANS001.BYTE004  $  if(x1==0x01)y=@0122;else if(x1==0x02)y=@0123;else y=@001c;
  $  002:故障检测标志位           $    $       $    $  ANS002.BYTE004  $  if(x1==0x00)y=@009e;else if(x1==0x01)y=@0446;else if(x1==0x02)y=@0447;else if(x1==0x03)y=@0448;else if(x1==0x04)y=@0449;else if(x1==0x05)y=@012e;else if(x1==0x06)y=@012f;else y=@001c;
  $  003:故障监测持续判断         $    $       $    $  ANS003.BYTE004  $  if(x==0x01) y=@0126; else if(x==0x02) y=@0127; else if(x==0x03)  y=@0128; else if(x==0x04)  y=@0129; else y=@001c;
  $  004:自身识别档位信号         $    $       $    $  ANS004.BYTE004  $  if(x==0x00) y=@0130; else if(x==0x01) y=@0132; else if(x==0x02) y=@00c7; else if(x==0x03) y=@00c8; else if(x==0x04) y=@0133; else y=@001c;
