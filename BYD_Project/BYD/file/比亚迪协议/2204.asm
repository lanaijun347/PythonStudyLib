...
读数据流: 
  ...
  $  000:MCU                                    $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x33: y=@0197;default: y=@0042;
  $  001:压缩机控制状态                         $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@00d2;0x01: y=@011a;default: y=@001c;
  $  002:压缩机实际状态                         $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@00d2;0x01: y=@011a;default: y=@001c;
  ...
  $  008:IPM/IGBT(绝缘栅双极型晶体管)温度       $    $  degree C     $    $  ANS008.BYTE004  $  y=x1-100;
