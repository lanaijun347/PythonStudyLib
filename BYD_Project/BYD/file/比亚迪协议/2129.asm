...
读数据流: 
  ...
  $  045:节气门处于怠速位置                          $    $               $    $  ANS044.BYTE004  $  if(x1&0x01)y=@0000;else y=@0001;
  $  046:空调请求激活                                $    $               $    $  ANS044.BYTE004  $  if(x1&0x10)y=@0000;else y=@0001;
  $  047:空调压缩机状态                              $    $               $    $  ANS044.BYTE004  $  if(x1&0x20)y=@0004;else y=@0005;
  $  048:催化剂保护模式                              $    $               $    $  ANS044.BYTE004  $  if(x1&0x40)y=@0000;else y=@0001;
  $  049:燃油泵开启命令                              $    $               $    $  ANS044.BYTE004  $  if(x1&0x80)y=@0000;else y=@0001;
  $  050:低速风扇状态                                $    $               $    $  ANS045.BYTE004  $  if(x1&0x01)y=@0004;else y=@0005;
  $  051:高速风扇状态                                $    $               $    $  ANS045.BYTE004  $  if(x1&0x02)y=@0004;else y=@0005;
