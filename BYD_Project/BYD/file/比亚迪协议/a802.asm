...
版本信息:
  ...
  $%  001:软件版本:           $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%X.%X],x1/16,x1%16);
  $%  002:硬件版本:           $%    $%  ANS000.BYTE008  $%  y=SPRINTF([%X.%X],x1/16,x1%16);
  $%  003:生产日期:           $%    $%  ANS000.BYTE009  $%  HEX(x1,x2,x3);
  $%  004:驱动数:             $%    $%  ANS000.BYTE005  $%  y=x1;
  $%  005:出厂日期:           $%    $%  ANS001.BYTE004  $%  HEX(x1,x2,x3);
  $%  006:维修日期:           $%    $%  ANS001.BYTE007  $%  HEX(x1,x2,x3);
...
读数据流: 
  ...
  $  002:车速           $    $  km/h     $    $  ANS002.BYTE027  $  y=x1;
