...
读数据流: 
  ...
  $  002:放电是否允许         $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@002c;else if(x1==0x01)y=@002d;else if(x1==0x02)y=@06ca;else if(x1==0x03)y=@01a5;else y=@001c;
  $  003:DC系统故障状态       $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@0059;else y=@04ef;
