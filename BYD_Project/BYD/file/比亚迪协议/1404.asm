...
读数据流: 
  ...
  $  024:速度限制监视器              $    $                $    $  ANS005.BYTE004  $  if(x1==0xBB)y=@06d6;else if(x1==0xDD)y=@059c;else y=@001c;
  $  025:EPB(电子驻车)变量配置       $    $                $    $  ANS006.BYTE004  $  if(x1==0xBB)y=@06d6;else if(x1==0xDD)y=@059c;else y=@001c;
