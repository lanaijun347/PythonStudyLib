...
读数据流: 
  ...
  $  009:左前进气阀                  $    $            $    $  ANS002.BYTE005  $  if(x1&0x01) y=@0006;else y=@0007;
  $  010:左前出气阀                  $    $            $    $  ANS002.BYTE005  $  if(x1&0x02) y=@0006;else y=@0007;
  $  011:右前进气阀                  $    $            $    $  ANS002.BYTE005  $  if(x1&0x04) y=@0006;else y=@0007;
  $  012:右前出气阀                  $    $            $    $  ANS002.BYTE005  $  if(x1&0x08) y=@0006;else y=@0007;
  $  013:左后进气阀                  $    $            $    $  ANS002.BYTE005  $  if(x1&0x10) y=@0006;else y=@0007;
  $  014:左后出气阀                  $    $            $    $  ANS002.BYTE005  $  if(x1&0x20) y=@0006;else y=@0007;
  $  015:右后进气阀                  $    $            $    $  ANS002.BYTE005  $  if(x1&0x40) y=@0006;else y=@0007;
  $  016:右后出气阀                  $    $            $    $  ANS002.BYTE005  $  if(x1&0x80) y=@0006;else y=@0007;
  ...
  $  022:加注状态                    $    $            $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@000c;0xAA: y=@03ab;0xEE: y=@03ac;default: y=@000f;
  $  023:下线检测状态                $    $            $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@0010;0xAA: y=@03a9;0xEE: y=@03aa;default: y=@000f;
  $  024:速度限制监视器              $    $            $    $  ANS005.BYTE004  $  switxh(x1)0x00: y=@03a7;0x01: y=@03a8;default: y=@001c;
  $  025:EPB(电子驻车)变量配置       $    $            $    $  ANS006.BYTE004  $  switxh(x1)0xDD: y=@059c;0xBB: y=@059d;default: y=@001c;
