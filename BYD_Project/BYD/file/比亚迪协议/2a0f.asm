...
读数据流: 
  ...
  $  011:电流采样电路状态                       $    $  A            $    $  ANS011.BYTE004  $  switxh(x1&0x03)0x00: y=@0022;0x01: y=@03c1;0x02: y=@03c2;0x03: y=@03c3;default: y=@001c;
  $  012:三相电流状态                           $    $  A            $    $  ANS011.BYTE004  $  switxh(x1&0x0C)0x00: y=@0022;0x04: y=@03c1;0x08: y=@03c2;0x0C: y=@03c3;default: y=@001c;
  $  013:IPM/IGBT(绝缘栅双极型晶体管)状态       $    $               $    $  ANS011.BYTE004  $  if(x1&0x10) y=@003a;else y=@0022;
  $  014:内部温度传感器状态                     $    $               $    $  ANS011.BYTE004  $  if(x1&0x20) y=@003a;else y=@0022;
  $  015:内部电流状态                           $    $               $    $  ANS011.BYTE004  $  switxh(x1&0xC0)0x00: y=@0022;0x40: y=@03c9;0x80: y=@03ca;0xC0: y=@03cb;default: y=@001c;
  $  016:启动状态                               $    $               $    $  ANS011.BYTE005  $  if(x1&0x01) y=@04b2;else y=@0022;
  $  017:内部温度状态                           $    $               $    $  ANS011.BYTE005  $  switxh(x1&0x06)0x00: y=@0022;0x02: y=@03c4;0x04: y=@04b1;default: y=@001c;
  $  018:转速状态                               $    $               $    $  ANS011.BYTE005  $  if(x1&0x08) y=@003a;else y=@0022;
  $  019:压缩机负载状态                         $    $               $    $  ANS011.BYTE005  $  switxh(x1&0x30)0x00: y=@0022;0x10: y=@03c7;0x20: y=@03c8;default: y=@001c;
  $  020:母线电压状态                           $    $               $    $  ANS011.BYTE005  $  switxh(x1&0xC0)0x00: y=@0022;0x40: y=@03c5;0x80: y=@03c6;default: y=@001c;
  $  021:内部低压电状态                         $    $               $    $  ANS011.BYTE006  $  switxh(x1&0x03)0x00: y=@0022;0x01: y=@03cd;0x02: y=@03ce;default: y=@001c;
