...
读数据流: 
  ...
  $  000:车速采集功能       $    $       $    $  ANS000.BYTE004  $  if(x1==0x00) y=@002b; else if(x1==0x01) y=@002a; else y=@009a;
  $  001:IG1电平            $    $       $    $  ANS001.BYTE004  $  if(x1==0x00) y=@02f3; else if(x1==0x02) y=@02f4; else y=@009a;
