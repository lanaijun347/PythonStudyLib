...
版本信息:
  ...
  $%  007:软件日期:                  $%    $%  ANS003.BYTE006  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  $%  008:修改次数:                  $%    $%  ANS003.BYTE009  $%  y=x1;
  $%  009:行车记录仪硬件版本:        $%    $%  ANS004.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1/100,(x1/10)%10,x1%10);
  $%  010:硬件日期:                  $%    $%  ANS004.BYTE005  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
