...
读数据流: 
  ...
  $  065:真空泵控制回路#1                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x07)0x00: y=@01ef;0x01: y=@01ef;0x02: y=@0119;0x03: y=@0119;0x04: y=@0022;0x05: y=@0022;default:y=@0048;
  $  066:真空泵控制回路#2                            $    $               $    $  ANS000.BYTE020  $  if((x1&0x1F)<0x08)y=@01ef;else if((x1&0x1F)<0x10)y=@0119;else if((x1&0x1F)<0x18)y=@0022;else y=@0048;
  $  067:真空泵泄露状态                              $    $               $    $  ANS000.BYTE020  $  if((x1&0x7F)<0x20)y=@01ef;else if((x1&0x7F)<0x40)y=@01f2;else if((x1&0x7F)<0x60)y=@019e;else y=@0022;
  $  068:低速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x01)y=@0000;else y=@0001;
  $  069:高速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x02)y=@0000;else y=@0001;
  $  070:风扇类型                                    $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@01d2;else if((x1&0x0F)<0x08)y=@01d3;else y=@009e;
  ...
  $  073:发动机稳态工况-燃油泵状态                   $    $               $    $  ANS000.BYTE024  $  if(x1&0x04) y=@0004;else y=@0005;
  $  074:发动机动态工况-节气门处于怠速位置           $    $               $    $  ANS000.BYTE025  $  if(x1&0x01)y=@0000;else y=@0001;
  $  075:发动机动态工况-节气门处于部分打开位置       $    $               $    $  ANS000.BYTE025  $  if(x1&0x02)y=@0000;else y=@0001;
  $  076:发动机动态工况-节气门处于全开位置           $    $               $    $  ANS000.BYTE025  $  if(x1&0x04)y=@0000;else y=@0001;
  $  077:发动机动态工况-激活减速断油                 $    $               $    $  ANS000.BYTE025  $  if(x1&0x08)y=@0006;else y=@0007;
  $  078:发动机动态工况-激活加速加浓                 $    $               $    $  ANS000.BYTE025  $  if(x1&0x10)y=@0006;else y=@0007;
  $  079:发动机动态工况-D档                          $    $               $    $  ANS000.BYTE025  $  if(x1&0x20)y=@0000;else y=@0001;
  $  080:发动机动态工况-R档                          $    $               $    $  ANS000.BYTE025  $  if(x1&0x40)y=@0000;else y=@0001;
  $  081:发动机动态工况-N档                          $    $               $    $  ANS000.BYTE025  $  if(x1&0x80)y=@0000;else y=@0001;
  $  082:氧传感器1信号                               $    $               $    $  ANS000.BYTE027  $  if(x1&0x01)y=@0009;else y=@0008;
  $  083:氧传感器2信号                               $    $               $    $  ANS000.BYTE027  $  if(x1&0x02)y=@0009;else y=@0008;
  $  084:氧传感器1加热                               $    $               $    $  ANS000.BYTE027  $  if(x1&0x10)y=@000a;else y=@000b;
  $  085:氧传感器2加热                               $    $               $    $  ANS000.BYTE027  $  if(x1&0x20)y=@000a;else y=@000b;
  $  086:发动机怠速-制动踏板状态                     $    $               $    $  ANS000.BYTE028  $  if(x1&0x02)y=@0062;else y=@0063;
  $  087:MIL(故障指示灯)激活                         $    $               $    $  ANS000.BYTE029  $  if(x1&0x01)y=@0006;else y=@0007;
  $  088:MIL(故障指示灯)闪烁                         $    $               $    $  ANS000.BYTE029  $  if(x1&0x02)y=@0000;else y=@0001;
  $  089:SVS(系统维修指示灯)激活                     $    $               $    $  ANS000.BYTE029  $  if(x1&0x10)y=@0006;else y=@0007;
  $  090:SVS(系统维修指示灯)闪烁                     $    $               $    $  ANS000.BYTE029  $  if(x1&0x20)y=@0000;else y=@0001;
  $  091:AT/扭矩请求-AT转换离合器激活                $    $               $    $  ANS000.BYTE032  $  if(x1&0x08)y=@0006;else y=@0007;
  $  092:发动机状态-刹车开关激活                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x01)y=@0006;else y=@0007;
  $  093:发动机状态-刹车灯激活                       $    $               $    $  ANS000.BYTE034  $  if(x1&0x02)y=@0006;else y=@0007;
  $  094:发动机状态-水泵继电器状态                   $    $               $    $  ANS000.BYTE034  $  if(x1&0x08) y=@0004;else y=@0005;
  $  095:发动机状态-涡轮增压旁通阀                   $    $               $    $  ANS000.BYTE034  $  if(x1&0x10)y=@0004;else y=@0005;
  $  096:发动机状态-防盗锁定状态                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x20)y=@0064;else y=@0065;
