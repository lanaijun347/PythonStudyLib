...
读数据流: 
  ...
  $  061:充电S2开关吸合标志                        $    $               $    $  ANS061.BYTE004  $  if(x1==0x00)y=@002e;else if(x1==0x01)y=@002f;else y=@001c;
  $  062:发送CP标志位                              $    $               $    $  ANS062.BYTE004  $  if(x1==0x00)y=@04c3;else if(x1==0x01)y=@04c4;else y=@001c;
  $  063:驱动电机系统配置类型                      $    $               $    $  ANS063.BYTE004  $  if(x1==0x00)y=@01ba;else if(x1==0x01)y=@01bb;else y=@001c;
  $  064:倾角传感器是否校准                        $    $               $    $  ANS064.BYTE004  $  if(x1==0x00)y=@01b5;else if(x1==0x01)y=@04c5;else y=@001c;
  $  065:倾角传感器信息状态                        $    $               $    $  ANS065.BYTE004  $  if(x1==0x00)y=@0059;else if(x1==0x01)y=@0022;else y=@001c;
  ...
  $  070:降压模块状态                              $    $               $    $  ANS070.BYTE004  $  if(x1==0x00)y=@0441;else if(x1==0x01)y=@04be;else if(x1==0x02)y=@04bf;else if(x1==0x03)y=@04c0;else y=@001c;
  $  071:升降压DC模块故障                          $    $               $    $  ANS071.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@0059;else y=@001c;
