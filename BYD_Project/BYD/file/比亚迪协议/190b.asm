...
读数据流: 
  ...
  $  000:P档电机状态                                              $    $        $    $  ANS000.BYTE004  $  if(x1 == 0x00) y=@011f;else if(x1 == 0x01) y=@00da;else if(x1 == 0x02) y=@00db;else if(x1 == 0x03) y=@00dc;else y=@001c;
  ...
  $  003:位置霍尔状态                                             $    $        $    $  ANS003.BYTE004  $  if(x1 == 0x00) y=@0022;else if(x1 == 0x01) y=@0653;else if(x1 == 0x02) y=@0121;else y=@001c;
  $  004:电机缺相                                                 $    $        $    $  ANS004.BYTE004  $  if(x1 == 0x00) y=@0022;else if(x1 == 0x01) y=@0224;else if(x1 == 0x02) y=@0225;else if(x1 == 0x03) y=@0226;else if(x1 == 0x04) y=@0227;else if(x1 == 0x05) y=@0228;else if(x1 == 0x06) y=@0229;else if(x1 == 0x07) y=@022a;else y=@001c;
  $  005:与ABS/ESP(防抱死刹车系统/电子车身稳定系统)通讯状态       $    $        $    $  ANS005.BYTE004  $  if(x1 == 0x00) y=@0022;else if(x1 == 0x01) y=@003a;else y=@001c;
  ...
  $  010:控制状态                                                 $    $        $    $  ANS010.BYTE004  $  if(x1 == 0x00) y=@0022;else if(x1 == 0x01) y=@01a6;else if(x1 == 0x02) y=@01a7;else y=@001c;
