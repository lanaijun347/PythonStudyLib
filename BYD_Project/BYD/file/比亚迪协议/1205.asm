...
读数据流: 
  ...
  $  000:放电是否允许         $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@002c;else if(x1==0x01)y=@002d;else if(x1==0x02)y=@009e;else y=@001c;
  $  001:DC系统故障状态       $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@0059;else y=@04ef;
