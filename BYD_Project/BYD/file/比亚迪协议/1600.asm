...
读数据流: 
  ...
  $  011:左侧驻车状态                                $    $                $    $  ANS011.BYTE004  $  if(x1 == 0x00) y=@009a;else if(x1 == 0x01) y=@03b1;else if(x1 == 0x02) y=@03b2;else if(x1 == 0x03) y=@03b3;else if(x1 == 0x04) y=@00de;else if(x1 == 0x05) y=@03b4;else if(x1 == 0x06) y=@03b5;else y=@001c;
  $  012:右侧驻车状态                                $    $                $    $  ANS012.BYTE004  $  if(x1 == 0x00) y=@009a;else if(x1 == 0x01) y=@03b1;else if(x1 == 0x02) y=@03b2;else if(x1 == 0x03) y=@03b3;else if(x1 == 0x04) y=@00de;else if(x1 == 0x05) y=@03b4;else if(x1 == 0x06) y=@03b5;else y=@001c;
  $  013:EPB(电子驻车)开关状态                       $    $                $    $  ANS013.BYTE004  $  if(x1 == 0x00) y=@03af;else if(x1 == 0x01) y=@03b0;else y=@001c;
  $  014:车速                                        $    $  km/h          $    $  ANS014.BYTE004  $  y=(x1*256+x2)*0.1;
  $  015:点火开关状态                                $    $                $    $  ANS015.BYTE004  $  if(x1 == 0x00) y=@0005;else if(x1 == 0x01) y=@0004;else y=@001c;
