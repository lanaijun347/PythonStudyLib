...
版本信息:
  ...
  $%  007:生产日期:              $%    $%  ANS003.BYTE007  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
...
读数据流: 
  ...
  $  000:前摄像头配置信息             $    $       $    $  ANS000.BYTE004  $  if((x1==0)) y=@003c;else if((x1==1)) y=@003d;else if((x1>=2)&&(x1<=255)) y=x1;else y=@001c;
  $  001:后摄像头配置信息             $    $       $    $  ANS000.BYTE005  $  if((x1==0)) y=@003c;else if((x1==1)) y=@003d;else if((x1>=2)&&(x1<=255)) y=x1;else y=@001c;
  $  002:左摄像头配置信息             $    $       $    $  ANS000.BYTE006  $  if((x1==0)) y=@003c;else if((x1==1)) y=@003d;else if((x1>=2)&&(x1<=255)) y=x1;else y=@001c;
  $  003:右摄像头配置信息             $    $       $    $  ANS000.BYTE007  $  if((x1==0)) y=@003c;else if((x1==1)) y=@003d;else if((x1>=2)&&(x1<=255)) y=x1;else y=@001c;
  $  004:倒车雷达使能状态(预留)       $    $       $    $  ANS000.BYTE008  $  switxh(x1)0x00: y=@0043;0x01: y=@0044;default: y=@001c;
  $  005:全景匹配状态                 $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@001a;0x01: y=@001b;default: y=@001c;
