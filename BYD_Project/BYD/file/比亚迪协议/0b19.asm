...
读数据流: 
  ...
  $  009:主驾驶PTC状态                                   $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@0298;else if(x1==0x01)y=@011a;else y=@001c;
  ...
  $  014:BMS(电池管理系统)是否允许空调高压模块功能       $    $               $    $  ANS011.BYTE004  $  if(x1==0x00)y=@0097;else if(x1==0x01)y=@002d;else if(x1==0x01)y=@002c;else y=@001c;
  $  015:主驾吹面通道温度                                $    $  degree C     $    $  ANS012.BYTE004  $  y=x1-40;
  $  016:主驾吹脚通道温度                                $    $  degree C     $    $  ANS013.BYTE004  $  y=x1-40;
  $  017:水泵继电器状态                                  $    $               $    $  ANS014.BYTE004  $  if(x1==0x00)y=@002e;else if(x1==0x01)y=@002f;else y=@001c;
  $  018:空调高压模块状态                                $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@06e8;else if(x1==0x02)y=@06e9;else if(x1==0x03)y=@011e;else y=@001c;
  ...
  $  026:CAN请求电除霜                                   $    $               $    $  ANS023.BYTE004  $  if(x1==0x00)y=@014b;else if(x1==0x01)y=@014a;else y=@001c;
