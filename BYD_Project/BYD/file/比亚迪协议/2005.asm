...
读数据流: 
  ...
  $  021:维修模式                                   $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@004c;else if(x1==0x02)y=@004d;else y=@001c;
  $  022:EPB(电子驻车)电机操作有效                  $    $               $    $  ANS016.BYTE004  $  if(x1==0x00)y=@0049;else if(x1==0x01)y=@004a;else y=@001c;
  $  023:动态拉起状态                               $    $               $    $  ANS017.BYTE004  $  if(x1==0x00)y=@0047;else if(x1==0x01)y=@0050;else if(x1==0x02)y=@0051;else if(x1==0x03)y=@0052;else y=@001c;
  $  024:EPB(电子驻车)操作模式                      $    $               $    $  ANS018.BYTE004  $  if(x1==0x00)y=@004e;else if(x1==0x01)y=@004f;else y=@001c;
  $  025:装配位置校准完成                           $    $               $    $  ANS019.BYTE004  $  if(x1&0x01)y=@005e;else y=@005f;
  $  026:拉力校准完成                               $    $               $    $  ANS019.BYTE004  $  if(x1&0x02)y=@005e;else y=@005f;
  $  027:Run-ln完成                                 $    $               $    $  ANS019.BYTE004  $  if(x1&0x04)y=@005e;else y=@005f;
