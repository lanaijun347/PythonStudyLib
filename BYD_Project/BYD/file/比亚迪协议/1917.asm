...
读数据流: 
  ...
  $  009:电流采样电路状态                       $    $               $    $  ANS009.BYTE004  $  if((x1&0x03)==0x00) y=@0022;else if((x1&0x03)==0x01) y=@03c1;else if((x1&0x03)==0x02) y=@03c2;else if((x1&0x03)==0x03) y=@03c3;
  $  010:三相电流状态                           $    $               $    $  ANS009.BYTE004  $  if((x1&0x0C)==0x00) y=@0022;else if((x1&0x0C)==0x04) y=@03c1;else if((x1&0x0C)==0x08) y=@03c2;else if((x1&0x0C)==0x0C) y=@03c3;
  $  011:IPM/IGBT(绝缘栅双极型晶体管)状态       $    $               $    $  ANS009.BYTE004  $  if(x1&0x10) y=@003a;else y=@0022;
  $  012:内部温度传感器状态                     $    $               $    $  ANS009.BYTE004  $  if(x1&0x20) y=@003a;else y=@0022;
  $  013:内部电流状态                           $    $               $    $  ANS009.BYTE004  $  if((x1&0xC0)==0x00) y=@0022;else if((x1&0xC0)==0x40) y=@03c9;else if((x1&0xC0)==0x80) y=@03ca;else if((x1&0xC0)==0xC0) y=@03cb;
  $  014:启动状态                               $    $               $    $  ANS009.BYTE005  $  if(x1&0x01) y=@003a;else y=@0022;
  $  015:内部温度状态                           $    $               $    $  ANS009.BYTE005  $  if((x1&0x07)==0x02) y=@03c4;else if((x1&0x07)==0x04) y=@04b1;else if((x1&0x07)==0x06) y=@009e;else y=@0022;
  $  016:转速状态                               $    $               $    $  ANS009.BYTE005  $  if(x1&0x08) y=@003a;else y=@0022;
  $  017:压缩机负载状态                         $    $               $    $  ANS009.BYTE005  $  if((x1&0x30)==0x10) y=@03c4;else if((x1&0x30)==0x20) y=@04b1;else if((x1&0x30)==0x30) y=@009e;else y=@0022;
