...
读数据流: 
  ...
  $  000:DC1工作状态        $    $               $    $  ANS000.BYTE004  $  if(x1==0x01) y=@014c;else if(x1==0x02) y=@014d;else y=@009e;
  $  001:DC1故障状态        $    $               $    $  ANS001.BYTE004  $  if(x1==0x01) y=@0022;else if(x1==0x02) y=@0059;else y=@009e;
  $  002:输出断路故障       $    $               $    $  ANS002.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@014e;else if(x1==0x02) y=@014f;else if(x1==0x03) y=@0150;else y=@009e;
  $  003:DC1输出电流        $    $  A            $    $  ANS003.BYTE004  $  if((x1<0x65)&&(x2==0)) y=x1;else y=@0097;
  $  004:DC1输入电压        $    $  V            $    $  ANS004.BYTE004  $  if((x1+x2*256)>1000) y=@0097;else y=x1+x2*256;
  $  005:DC1输出电压        $    $  V            $    $  ANS005.BYTE004  $  y=x1*0.1;
  $  006:DC1温度            $    $  degree C     $    $  ANS006.BYTE004  $  if(x1<0xC9) y=x1-40;else y=@0097;
