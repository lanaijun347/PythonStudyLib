...
读数据流: 
  ...
  $  000:BSG启动允许状态               $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@002c;0x01: y=@002d;default: y=@001c;
  $  001:BSG工作状态                   $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0005;0x01: y=@003b;default: y=@001c;
  ...
  $  009:BSG稳压状态                   $    $               $    $  ANS009.BYTE004  $  switxh(x1)0x00: y=@0005;0x01: y=@003b;default: y=@001c;
  $  010:IPM温度                       $    $  degree C     $    $  ANS010.BYTE004  $  y=x1-40;
  $  011:电源电压                      $    $  V            $    $  ANS011.BYTE004  $  y=x1*0.1;
  $  012:三相继电器总状态              $    $               $    $  ANS012.BYTE004  $  switxh(x1)0x00: y=@002f;0x01: y=@002e;default: y=@001c;
