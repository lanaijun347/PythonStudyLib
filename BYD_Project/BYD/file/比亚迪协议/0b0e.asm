...
读数据流: 
  ...
  $  012:与ESP(电子车身稳定系统)通讯状态           $    $               $    $  ANS012.BYTE004  $  if(x1==0x00)y=@02e8;else if(x1==0x01)y=@0371;else y=@001c;
  $  013:与ABS(防抱死刹车系统)通讯状态             $    $               $    $  ANS013.BYTE004  $  if(x1==0x00)y=@02e8;else if(x1==0x02)y=@0371;else y=@001c;
  $  014:与电池管理器通讯状态                      $    $               $    $  ANS014.BYTE004  $  if(x1==0x00)y=@02e8;else if(x1==0x01)y=@0371;else y=@001c;
  $  015:与主控通讯状态                            $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@02e8;else if(x1==0x01)y=@0371;else y=@001c;
  ...
  $  072:升降压DC模块故障                          $    $               $    $  ANS072.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@0059;else y=@001c;
  ...
  $  000:充放电状态             $    $         $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0176;else if(x1==0x01)y=@0177;else if(x1==0x02)y=@06d3;else if(x1==0x03)y=@0179;else if(x1==0x04)y=@017a;else if(x1==0x05)y=@017b;else y=@001c;
  $  001:当前电制频率           $    $  Hz     $    $  ANS001.BYTE004  $  if(x1==0x00) y=@0181;else if(x1==0x01) y=@0182;else y=@001c;
  $  002:当前电制三相电压       $    $  V      $    $  ANS002.BYTE004  $  if(x1==0x00) y=@017c;else if(x1==0x01) y=@016e;else if(x1==0x02) y=@017d;else if(x1==0x03) y=@017e;else if(x1==0x04) y=@017f;else if(x1 ==0x05) y=@0180;else y=@001c;
  $  003:当前电制单相电压       $    $  V      $    $  ANS003.BYTE004  $  if(x1==0x00) y=@016d;else if(x1==0x01) y=@016e;else if(x1==0x02) y=@016f;else if(x1==0x03) y=@0170;else if(x1==0x04) y=@0171;else y=@001c;
