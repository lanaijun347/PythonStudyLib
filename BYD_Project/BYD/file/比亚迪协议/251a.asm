...
版本信息:
  ...
  $%  002:硬件日期:           $%    $%  ANS001.BYTE005  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  ...
  $%  005:软件日期:           $%    $%  ANS003.BYTE006  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
...
读数据流: 
  ...
  $  049:计算节气门位置                              $    $  %            $    $  ANS000.BYTE057  $  y=x1*100*1.0/255;
  $  050:节气门电机PWM(脉宽调制)                     $    $  %            $    $  ANS000.BYTE058  $  y=x1*100*1.0/255;
  $  051:碳罐阀占空比                                $    $  %            $    $  ANS000.BYTE062  $  y=x1*100*1.0/255;
  $  052:冷却液温度传感器                            $    $  V            $    $  ANS000.BYTE041  $  y=x1*1.0/51;
  $  053:进气温度传感器                              $    $  V            $    $  ANS000.BYTE043  $  y=x1*1.0/51;
  $  054:进气压力传感器                              $    $  V            $    $  ANS000.BYTE045  $  y=x1*1.0/51;
  $  055:节气门位置传感器1                           $    $  V            $    $  ANS000.BYTE051  $  y=((x1<<8)+x2)*1.0/13107;
  $  056:节气门位置传感器2                           $    $  V            $    $  ANS000.BYTE053  $  y=((x1<<8)+x2)*1.0/13107;
  $  057:增压压力传感器                              $    $  V            $    $  ANS000.BYTE114  $  y=x1*1.0/51;
  $  058:增压气体温度传感器                          $    $  V            $    $  ANS000.BYTE116  $  y=x1*1.0/51;
  $  059:散热器出口冷却液温度传感器                  $    $  V            $    $  ANS000.BYTE118  $  y=x1*1.0/51;
  $  060:油压传感器                                  $    $  V            $    $  ANS000.BYTE109  $  y=x1*1.0/51;
  $  061:发动机启动禁止状态                          $    $               $    $  ANS000.BYTE018  $  if(x1&0x01) y=@01b1;else y=@002d;
  $  062:发动机启动命令                              $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x06)0x00: y=@0048;0x02: y=@00d1;0x04: y=@01f3;0x06: y=@0048;default: y=@001c;
  $  063:低压启动电池状态                            $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x18)0x00: y=@002e;0x08: y=@002f;0x10: y=@002e;0x18: y=@0048;default: y=@001c;
  $  064:发动机启动超时次数                          $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x60)0x00: y=@0022;0x20: y=@0251;0x40: y=@0252;0x60: y=@0048;default: y=@001c;
  $  065:真空泵控制回路#1                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x06)0x00: y=@01ef;0x02: y=@0119;0x04: y=@0022;0x06: y=@0048;default: y=@001c;
  $  066:真空泵控制回路#2                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x18)0x00: y=@01ef;0x08: y=@0119;0x10: y=@0022;0x18: y=@0048;default: y=@001c;
  $  067:真空泵泄露状态                              $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x60)0x00: y=@01ef;0x20: y=@01f2;0x40: y=@019e;0x60: y=@0022;default: y=@001c;
  $  068:低速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x01) y=@0000;else y=@0001;
  $  069:高速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x02) y=@0000;else y=@0001;
  $  070:风扇类型                                    $    $               $    $  ANS000.BYTE023  $  switxh(x1&0x0C)0x00: y=@01d2;0x04: y=@0249;default: y=@009e;
  ...
  $  097:真空泵工作时间                              $    $  小时         $    $  ANS001.BYTE004  $  y=(x1<<8)+x2;
