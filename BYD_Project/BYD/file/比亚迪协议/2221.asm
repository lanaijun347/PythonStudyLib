...
版本信息:
  ...
  $%  001:软件日期:          $%    $%  ANS000.BYTE005  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  $%  002:软件编号:          $%    $%  ANS001.BYTE004  $%  HEX(x1,x2,x3,x4,x5,x6,x7,x8,x9);
  $%  003:软件版本:          $%    $%  ANS002.BYTE004  $%  y=SPRINTF([%d.%.2d.%.2d],(x1*256+x2)/10000,((x1*256+x2)%10000)/100,(x1*256+x2)%100);
  $%  004:软件日期_1:        $%    $%  ANS002.BYTE006  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
...
读数据流: 
  ...
  $  000:充电是否允许              $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@002d;0x01: y=@002c;default: y=@001c;
  $  001:放电是否允许              $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@002d;0x01: y=@002c;default: y=@001c;
  $  002:铁电池故障报警            $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@03d1;0x01: y=@03d2;default: y=@001c;
  $  003:SOC过低请求充电命令       $    $               $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@01ce;default: y=@001c;
  $  004:充放电状态                $    $               $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@03cf;0x01: y=@03d0;default: y=@001c;
