...
进入命令:
  ...
  $~  REQ001:774 03 22 F1 80 00 00 00 00       $~  ANS001:77C 03 22 F1 80 00 00 00 00
...
版本信息:
  ...
  $%  004:硬件版本1:        $%    $%  ANS002.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1/100,(x1/10)%10,x1%10);
  $%  005:硬件日期1:        $%    $%  ANS002.BYTE005  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  $%  006:硬件版本2:        $%    $%  ANS003.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1/100,(x1/10)%10,x1%10);
  $%  007:硬件日期2:        $%    $%  ANS003.BYTE005  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
