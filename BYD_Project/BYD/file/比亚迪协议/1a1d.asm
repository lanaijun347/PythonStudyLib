...
读数据流: 
  ...
  $  013:左侧纺锤形撑杆动作信号         $    $        $    $  ANS013.BYTE004  $  if((x1&0x03) == 0x00) y=@0138;else if((x1&0x03) == 0x01) y=@0139;else if((x1&0x03) == 0x02) y=@00d2;else if((x1&0x03) == 0x03) y=@001c;
  $  014:右侧纺锤形撑杆动作信号         $    $        $    $  ANS014.BYTE004  $  if((x1&0x03) == 0x00) y=@0138;else if((x1&0x03) == 0x01) y=@0139;else if((x1&0x03) == 0x02) y=@00d2;else if((x1&0x03) == 0x03) y=@001c;
