...
读数据流: 
  ...
  $  000:发送巡航键按键消息       $    $       $    $  ANS000.BYTE004  $  if(x1==0x56) y=@0124; else if(x1==0x59) y=@0125;else y=@009e;
  $  001:巡航键故障标志位         $    $       $    $  ANS001.BYTE004  $  if(x1==0x01) y=@0122;else if(x1==0x02) y=@0123;else y=@00d6;
  $  002:故障检测标志位           $    $       $    $  ANS002.BYTE004  $  if(x1==0x01) y=@012a;else if(x1==0x02) y=@012b;else if(x1==0x03) y=@012c;else if(x1==0x04) y=@012d;else if(x1==0x05) y=@012e;else if(x1==0x06) y=@012f;else y=@00d6;
  $  003:故障检测持续判断         $    $       $    $  ANS003.BYTE004  $  if(x1==0x01) y=@0126;else if(x1==0x02) y=@0127;else if(x1==0x03) y=@0128;else if(x1==0x04) y=@0129;else y=@00d6;
  $  004:自身识别档位消息         $    $       $    $  ANS004.BYTE004  $  if(x1==0x00) y=@0130;else if(x1==0x01) y=@00c9;else if(x1==0x02) y=@00ca;else if(x1==0x03) y=@00cb;else if(x1==0x04) y=@00cc;else y=@00d6;
