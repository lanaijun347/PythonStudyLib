...
读数据流: 
  ...
  $  000:DC_2工作状态       $    $               $    $  ANS000.BYTE004  $  if(x1==0x01) y=@0105;else if(x1==0x02) y=@0475;else y=@001c;
  $  001:DC_2故障状态       $    $               $    $  ANS001.BYTE004  $  if(x1 == 0x01) y=@0022;else if(x1 == 0x02) y=@0059;else y=@001c;
  $  002:输出断路故障       $    $               $    $  ANS002.BYTE004  $  if(x1==0x00) y=@009e;else if(x1==0x01) y=@0022;else if(x1==0x02) y=@0663;else y=@001c;
