...
读数据流: 
  ...
  $  021:车辆前行方向                                $    $               $    $  ANS012.BYTE006  $  switxh(x1)0x00: y=@0491;0x01: y=@00d8;default: y=@001c;
  $  022:换挡手柄                                    $    $               $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@00bf;0x01: y=@00c9;0x02: y=@00ca;0x03: y=@00cb;0x04: y=@00cc;0x05: y=@00cd;0x06: y=@00ce;0x07: y=@00cf;0x08: y=@00d0;default: y=@001c;
  $  023:换杆档状态                                  $    $               $    $  ANS013.BYTE005  $  switxh(x1)0x00: y=@0022;0x01: y=@00be;default: y=@001c;
  ...
  $  033:EPB(电子驻车)板状态                         $    $               $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@00de;0x01: y=@0046;0x02: y=@00df;0x03: y=@00df;0x04: y=@0059;default: y=@001c;
  ...
  $  040:读取遥控驾驶状态                            $    $               $    $  ANS022.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@00dd;default: y=@001c;
  $  041:促动阀1位置传感器                           $    $  mm           $    $  ANS023.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  $  042:促动阀3位置传感器                           $    $  mm           $    $  ANS024.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  $  043:促动器阀1开关状态                           $    $               $    $  ANS025.BYTE004  $  switxh(x1)0x00: y=@00a0;0x01: y=@009f;default: y=@001c;
  $  044:促动器阀2开关状态                           $    $               $    $  ANS026.BYTE004  $  switxh(x1)0x00: y=@00a0;0x01: y=@009f;default: y=@001c;
  $  045:促动器1中位位置                             $    $               $    $  ANS027.BYTE004  $  y=(x1<<8)+x2;
  $  046:促动器3中位位置                             $    $               $    $  ANS028.BYTE004  $  y=(x1<<8)+x2;
  $  047:多路阀开关状态                              $    $               $    $  ANS029.BYTE004  $  switxh((x1<<8)+x2)0x00: y=@00a0;0x01: y=@009f;default: y=@001c;
  $  048:促动器2位置传感器                           $    $  mm           $    $  ANS030.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  $  049:促动器4位置传感器                           $    $  mm           $    $  ANS031.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  $  050:促动器阀3开关状态                           $    $               $    $  ANS032.BYTE004  $  switxh(x1)0x00: y=@00a0;0x01: y=@009f;default: y=@001c;
  $  051:促动器阀4开关状态                           $    $               $    $  ANS033.BYTE004  $  switxh(x1)0x00: y=@00a0;0x01: y=@009f;default: y=@001c;
  ...
  $  063:P档系统状态                                 $    $               $    $  ANS042.BYTE005  $  switxh(x1)0x00: y=@0022;0x01: y=@0059;default: y=@001c;
  ...
  $  075:整车工作模式                                $    $               $    $  ANS050.BYTE004  $  switxh(x1)0x00: y=@00d2;0x01: y=@03ea;0x02: y=@0492;0x03: y=@0493;0x04: y=@0494;0x05: y=@0495;0x06: y=@03eb;0x07: y=@03ec;default: y=@001c;
  $  076:离合器强制脱开                              $    $               $    $  ANS050.BYTE005  $  switxh(x1)0x00: y=@00ea;0x01: y=@00eb;default: y=@001c;
  $  077:离合器强制脱开命令有效标识位                $    $               $    $  ANS050.BYTE006  $  switxh(x1)0x00: y=@0048;0x01: y=@00e6;default: y=@001c;
