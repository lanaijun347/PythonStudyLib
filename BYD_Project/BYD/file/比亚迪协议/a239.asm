...
版本信息:
  ...
  $%  005:已匹配钥匙数:        $%    $%  ANS003.BYTE004  $%  if(x1==0x00) y=@0265;else if(x1==0x01)y=@0266;else if(x1==0x02)y=@0267;else if(x1==0x03)y=@0268;else if(x1==0x04)y=@0269;else y=@0076;
...
读数据流: 
  ...
  $  003:钥匙状态                 $    $       $    $  ANS000.BYTE007  $  if(x1==0x03) y=@0261; else if(x1==0x04) y=@0262; else if(x1==0x06) y=@0263; else y=@0264;
  $  004:钥匙ID                   $    $       $    $  ANS000.BYTE007  $  if(x1==0x04) y=@0262; else if(x1==0x06) y=@0263; else y=(x2<<24)+(x3<<16)+(x4<<8)+x5;
  $  005:钥匙序号                 $    $       $    $  ANS000.BYTE007  $  if(x1==0x03) y=@0261;else if(x1==0x04) y=@0262; else if(x1==0x06) y=@0263; else y=x;
