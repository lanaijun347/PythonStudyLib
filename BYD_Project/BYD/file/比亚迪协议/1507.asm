...
读数据流: 
  ...
  $  025:EPB(电子驻车)状态                           $    $               $    $  ANS014.BYTE004  $  if(x1==0) y=@00de; else if(x1==1) y=@0046; else if(x1==2) y=@00df;else if(x1==3) y=@00e0;else if(x1==4) y=@0059;else y=@001c;
  $  026:遥控驾驶状态                                $    $               $    $  ANS015.BYTE004  $  if(x1==0) y=@0022; else if(x1==1)y=@00dd; else y=@001c;
  $  027:促动器1位置传感器                           $    $  mm           $    $  ANS016.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  028:促动阀3位置传感器                           $    $  mm           $    $  ANS017.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  029:促动器阀1开关状态                           $    $               $    $  ANS018.BYTE004  $  if(x1==0) y=@0005; else if(x1==1) y=@0004; else y=@001c;
  $  030:促动器阀2开关状态                           $    $               $    $  ANS019.BYTE004  $  if(x1==0) y=@0005; else if(x1==1) y=@0004; else y=@001c;
  $  031:促动器1中位置                               $    $               $    $  ANS020.BYTE004  $  y=x1*256+x2;
  $  032:促动器3中位置                               $    $               $    $  ANS021.BYTE004  $  y=x1*256+x2;
  $  033:多路阀开关状态                              $    $               $    $  ANS022.BYTE004  $  if(x1==0) y=@0005; else if(x1==1) y=@0004; else y=@001c;
  $  034:促动器2位置传感器                           $    $  mm           $    $  ANS023.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  035:促动器4位置传感器                           $    $  mm           $    $  ANS024.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  036:促动器阀3开关状态                           $    $               $    $  ANS025.BYTE004  $  if(x1==0) y=@0005; else if(x1==1) y=@0004; else y=@001c;
  $  037:促动器阀4开关状态                           $    $               $    $  ANS026.BYTE004  $  if(x1==0) y=@0005; else if(x1==1) y=@0004; else y=@001c;
  ...
  $  046:P档锁定状态                                 $    $               $    $  ANS034.BYTE004  $  if(x1==0) y=@00bf; else if(x1==1)y=@011f;else if(x1==2)y=@00da;else if(x1==3)y=@00db;else if(x1==4)y=@00dc;else y=@001c;
  $  047:P档系统状态                                 $    $               $    $  ANS034.BYTE005  $  if(x1==0) y=@0022; else if(x1==1)y=@0627;else y=@0048;
  $  048:加速度传感器状态                            $    $               $    $  ANS035.BYTE004  $  if(x1==0) y=@0022; else if(x1==1) y=@00be; else y=@001c;
