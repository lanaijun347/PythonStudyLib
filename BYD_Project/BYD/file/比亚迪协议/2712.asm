...
读数据流: 
  ...
  $  000:管柱调节开关上倾信号               $    $        $    $  ANS000.BYTE004  $  if(x1&0x01) y=@00d3;else y=@00d4;
  $  001:管柱调节信号下倾信号               $    $        $    $  ANS000.BYTE004  $  if(x1&0x02) y=@00d3;else y=@00d4;
  $  002:管柱调节开关伸出信号               $    $        $    $  ANS000.BYTE004  $  if(x1&0x04) y=@00d3;else y=@00d4;
  $  003:管柱调节开关缩回信号               $    $        $    $  ANS000.BYTE004  $  if(x1&0x08) y=@00d3;else y=@00d4;
  $  004:电动管柱系统状态                   $    $        $    $  ANS000.BYTE004  $  if(x1&0x10) y=@003a;else y=@0022;
  $  005:电动管柱工作状态                   $    $        $    $  ANS000.BYTE004  $  switxh(x1&0xE0)0x20: y=@0259;0x40: y=@025a;0x60: y=@025b;0x80: y=@025f;0xA0: y=@0260;default: y=@001c;
  $  006:电源档位状态                       $    $        $    $  ANS000.BYTE005  $  switxh(x1&0x03)0x00: y=@00d3;0x01: y=@025c;0x02: y=@00d4;default: y=@001c;
