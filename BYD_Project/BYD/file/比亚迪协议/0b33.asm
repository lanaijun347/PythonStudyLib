...
读数据流: 
  ...
  $  000:充电是否允许              $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@002d;else if(x1==0x01)y=@002c;else y=@0076;
  $  001:放电是否允许              $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@002d;else if(x1==0x01)y=@002c;else y=@0076;
  $  002:铁电池故障报警            $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@03d1;else if(x1==0x01)y=@03d2;else y=@0076;
  $  003:SOC过低请求充电命令       $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@06c9;else y=@0076;
  $  004:充放电状态                $    $               $    $  ANS004.BYTE004  $  if(x1==0x00)y=@03cf;else if(x1==0x01)y=@03d0;else y=@0076;
