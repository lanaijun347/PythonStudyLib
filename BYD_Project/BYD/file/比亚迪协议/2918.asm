...
读数据流: 
  ...
  $  000:车道系统开关状态-0       $    $       $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0005;0x01: y=@0004;default: y=@001c;
  $  001:车道故障状态-0           $    $       $    $  ANS000.BYTE005  $  switxh(x1)0x00: y=@0059;0x01: y=@0022;default: y=@001c;
  $  002:当前车速-0               $    $       $    $  ANS000.BYTE006  $  switxh(x1)0x00: y=@0059;0x01: y=@0022;default: y=@001c;
  $  003:车速阀值-0               $    $       $    $  ANS000.BYTE007  $  switxh(x1)0x00: y=@0059;0x01: y=@0022;default: y=@001c;
  $  004:当前报警状态-0           $    $       $    $  ANS000.BYTE008  $  switxh(x1)0x00: y=@0407;0x01: y=@0408;0x02: y=@0409;default: y=@001c;
  $  005:Flash状态-0              $    $       $    $  ANS000.BYTE009  $  switxh(x1)0x00: y=@0059;0x01: y=@0022;default: y=@001c;
  ...
  $  011:车道系统开关状态         $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0005;0x01: y=@0004;default: y=@001c;
  $  012:车道故障状态             $    $       $    $  ANS001.BYTE005  $  switxh(x1)0x00: y=@0059;0x01: y=@0022;default: y=@001c;
  $  013:当前车速                 $    $       $    $  ANS001.BYTE006  $  switxh(x1)0x00: y=@0059;0x01: y=@0022;default: y=@001c;
  $  014:车速阀值                 $    $       $    $  ANS001.BYTE007  $  switxh(x1)0x00: y=@0059;0x01: y=@0022;default: y=@001c;
  $  015:当前报警状态             $    $       $    $  ANS001.BYTE008  $  switxh(x1)0x00: y=@0407;0x01: y=@0408;0x02: y=@0409;default: y=@001c;
  $  016:Flash状态                $    $       $    $  ANS001.BYTE009  $  switxh(x1)0x00: y=@0059;0x01: y=@0022;default: y=@001c;
  $  017:温度高字节               $    $       $    $  ANS001.BYTE010  $  y=(x1<<8)+x2;
  $  018:匹配失败原因             $    $       $    $  ANS002.BYTE004  $  switxh(x1)0x03: y=@0404;0x04: y=@0405;0x05: y=@0406;default: y=@0022;
  $  019:左侧识别阈值             $    $       $    $  ANS002.BYTE005  $  y=(x1<<8)+x2;
  $  020:右侧识别阈值             $    $       $    $  ANS002.BYTE007  $  y=(x1<<8)+x2;
  $  021:天空值                   $    $       $    $  ANS002.BYTE009  $  y=(x1<<8)+x2;
  $  022:左转向灯状态             $    $       $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0402;0x01: y=@0403;default: y=@001c;
  $  023:右转向灯状态             $    $       $    $  ANS003.BYTE005  $  switxh(x1)0x00: y=@0402;0x01: y=@0403;default: y=@001c;
