...
版本信息:
  ...
  $%  004:维修日期:                $%    $%  ANS002.BYTE004  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  $%  005:维修次数:                $%    $%  ANS002.BYTE007  $%  y=x1;
  $%  006:PTC产品序列号:           $%    $%  ANS003.BYTE004  $%  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $%  007:生产日期:                $%    $%  ANS003.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
...
读数据流: 
  ...
  $  000:左侧散热片温度        $    $  degree C     $    $  ANS000.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@0193;else if(x1 == 0xD8)y=@03a0;else y=@001c;
  $  001:PTC预置档位           $    $               $    $  ANS001.BYTE004  $  y=x1;
  $  002:PTC实际档位           $    $               $    $  ANS002.BYTE004  $  y=x1;
  $  003:右侧散热片温度        $    $               $    $  ANS003.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@0193;else if(x1 == 0xD8)y=@03a0;else y=@001c;
  $  004:冷却液温度            $    $  degree C     $    $  ANS004.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@0193;else if(x1 == 0xD8)y=@03a0;else y=@001c;
  $  005:IG2低压电源电压       $    $  V            $    $  ANS005.BYTE004  $  y=(x1*256+x2)*0.1;
