...
读数据流: 
  ...
  $  035:左外后视镜折叠电机                 $    $        $    $  ANS001.BYTE072  $  if((x1*256+x2) < 25001) y=x1*256+x2;else y=@001c;
  $  036:左外后视镜换向器水平位置电机       $    $        $    $  ANS001.BYTE074  $  if((x1*256+x2) < 20001) y=x1*256+x2;else y=@001c;
  $  037:左外后视镜换向器垂直位置电机       $    $        $    $  ANS001.BYTE076  $  if((x1*256+x2) < 20001) y=x1*256+x2;else y=@001c;
  $  038:左外后视镜照脚灯点亮时间           $    $  H     $    $  ANS001.BYTE078  $  if((x1*256+x2) < 1001) y=x1*256+x2;else y=@001c;
  $  039:左外后视镜加热时间                 $    $  H     $    $  ANS001.BYTE080  $  if((x1*256+x2) < 501) y=x1*256+x2;else y=@001c;
