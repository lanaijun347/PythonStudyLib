...
读数据流: 
  ...
  $  018:运行时间                               $    $  小时:分      $    $  ANS000.BYTE096  $  if(x1<0x80)y=SPRINTF([%d%s%d],((x1*16777216+x2*65536+x3*256+x4)/60),@01d5,((x1*16777216+x2*65536+x3*256+x4)%60));else y=0;
  ...
  $  041:倾角信息                               $    $  度           $    $  ANS000.BYTE133  $  if(x1<0xF1) y=x1*0.5-60;else y=@009a;
  ...
  $  005:ETC(电子节气门)处于全开位置               $    $       $    $  ANS000.BYTE025  $  if(x1&0x04) y=@0000; else y=@0001;
  $  006:激活减速断油                              $    $       $    $  ANS000.BYTE025  $  if(x1&0x08) y=@0006; else y=@0007;
  $  007:激活加速加浓                              $    $       $    $  ANS000.BYTE025  $  if(x1&0x10) y=@0006; else y=@0007;
  $  008:档位状态                                  $    $       $    $  ANS000.BYTE025  $  if((x1<0x40)&&(x1>0x1F)) y=@00cc;else if((x1<0x60)&&(x1>0x3F)) y=@00ca;else if((x1<0xA0)&&(x1>0x7F)) y=@00cb;else y=@00d6;
  $  009:MIL(故障指示灯)激活                       $    $       $    $  ANS000.BYTE029  $  if(x1&0x01) y=@0006; else y=@0007;
  $  010:MIL(故障指示灯)闪烁                       $    $       $    $  ANS000.BYTE029  $  if(x1&0x02) y=@0000; else y=@0001;
  $  011:SVS(系统维修指示灯)激活                   $    $       $    $  ANS000.BYTE029  $  if(x1&0x10) y=@0006; else y=@0007;
  $  012:SVS(系统维修指示灯)闪烁                   $    $       $    $  ANS000.BYTE029  $  if(x1&0x20) y=@0000; else y=@0001;
  $  013:氧传感器1信号                             $    $       $    $  ANS000.BYTE027  $  if(x1&0x01) y=@0008; else y=@0009;
  $  014:氧传感器2信号                             $    $       $    $  ANS000.BYTE027  $  if(x1&0x02) y=@0008; else y=@0009;
  $  015:氧传感器1加热                             $    $       $    $  ANS000.BYTE027  $  if(x1&0x10) y=@000a; else y=@000b;
  $  016:氧传感器2加热                             $    $       $    $  ANS000.BYTE027  $  if(x1&0x20) y=@000a; else y=@000b;
  $  017:燃油反馈状态                              $    $       $    $  ANS000.BYTE034  $  if(x1&0x40) y=@006c; else y=@006d;
  $  018:加速踏板处于怠速位置                      $    $       $    $  ANS000.BYTE028  $  if(x1&0x01) y=@0000; else y=@0001;
  $  019:制动踏板状态                              $    $       $    $  ANS000.BYTE028  $  if(x1&0x02) y=@0062; else y=@0063;
  $  020:是否有空调请求                            $    $       $    $  ANS000.BYTE028  $  if(x1&0x04) y=@0000; else y=@0001;
  $  021:动力转向开关                              $    $       $    $  ANS000.BYTE028  $  if(x1&0x08) y=@0004; else y=@0005;
  ...
  $  025:可变气门升程阀状态                        $    $       $    $  ANS000.BYTE034  $  if(x1&0x80) y=@0004; else y=@0005;
  $  026:空调请求激活                              $    $       $    $  ANS000.BYTE031  $  if(x1&0x02) y=@0006; else y=@0007;
  $  027:空调压缩机开                              $    $       $    $  ANS000.BYTE031  $  if(x1&0x04) y=@0000; else y=@0001;
  $  028:怠速转速因空调而增加                      $    $       $    $  ANS000.BYTE031  $  if(x1&0x20) y=@0000; else y=@0001;
  $  029:全负荷是关闭空调压缩机                    $    $       $    $  ANS000.BYTE031  $  if(x1&0x40) y=@0000; else y=@0001;
  $  030:空调中压开关                              $    $       $    $  ANS000.BYTE031  $  if(x1&0x20) y=@0000; else y=@0001;
  $  031:ECU发送码验证结果                         $    $       $    $  ANS000.BYTE022  $  if(x1&0x01) y=@001b; else y=@001a;
  $  032:IKEY发送码验证结果                        $    $       $    $  ANS000.BYTE022  $  if(x1&0x02) y=@001b; else y=@001a;
  $  033:节气门位置传感器线路A对地短路或开路       $    $       $    $  ANS000.BYTE022  $  if(x1&0x04) y=@0060; else y=@0061;
  $  034:节气门位置传感器线路A对电源短路           $    $       $    $  ANS000.BYTE023  $  if(x1&0x01) y=@0000; else y=@0001;
  $  035:高速风扇开启                              $    $       $    $  ANS000.BYTE023  $  if(x1&0x02) y=@0000; else y=@0001;
