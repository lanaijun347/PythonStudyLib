...
读数据流: 
  ...
  $  000:母线电压                                     $    $  V            $    $  ANS000.BYTE004  $  if((x1+x2*256)<1001) y=x1+x2*256;else y=@001c;
  ...
  $  009:IGBT(绝缘栅双极型晶体管)驱动状态             $    $               $    $  ANS009.BYTE004  $  if(x1 == 0x01) y=@0005;else if(x1 == 0x02) y=@003b;else y=@001c;
  $  010:电池加热器卸载状态                           $    $               $    $  ANS010.BYTE004  $  if(x1 == 0x00) y=@0048;else if(x1 == 0x01) y=@075e;else if(x1 == 0x02) y=@075f;else y=@001c;
  $  011:电池加热器故障状态                           $    $               $    $  ANS011.BYTE004  $  if(x1 == 0x01) y=@0022;else if(x1 == 0x02) y=@0059;else y=@001c;
  $  012:电池加热器加热组件状态                       $    $               $    $  ANS012.BYTE004  $  if(x1 == 0x01) y=@0022;else if(x1 == 0x02) y=@0059;else y=@001c;
  $  013:电池加热器驱动组件状态                       $    $               $    $  ANS013.BYTE004  $  if(x1 == 0x01) y=@0760;else if(x1 == 0x02) y=@0761;else if(x1 == 0x03) y=@0762;else y=@001c;
  ...
  $  017:IGBT(绝缘栅双极型晶体管)短路状态             $    $               $    $  ANS017.BYTE004  $  if(x1 == 0x01) y=@0022;else if(x1 == 0x02) y=@038c;else y=@001c;
  $  018:IGBT(绝缘栅双极型晶体管)温度传感器状态       $    $               $    $  ANS018.BYTE004  $  if(x1 == 0x01) y=@075d;else if(x1 == 0x02) y=@0193;else if(x1 == 0x03) y=@03a0;else y=@001c;
  $  019:主板温度传感器状态                           $    $               $    $  ANS019.BYTE004  $  if(x1 == 0x01) y=@0760;else if(x1 == 0x02) y=@0761;else if(x1 == 0x03) y=@0762;else y=@001c;
  $  020:与BMS(电池管理系统)通讯状态                  $    $               $    $  ANS020.BYTE004  $  if(x1 == 0x01) y=@02e8;else if(x1 == 0x02) y=@0750;else y=@001c;
