...
读数据流: 
  ...
  $  000:发电机状态           $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0059;0x02: y=@04f0;default: y=@001c;
  $  001:发动机状态           $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@011a;0x01: y=@04f1;default: y=@001c;
  $  002:放电是否允许         $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@002c;0x01: y=@002d;0x02: y=@009e;default: y=@001c;
  $  003:DC系统故障状态       $    $               $    $  ANS003.BYTE004  $  switxh(x1)0x01: y=@0022;0x02: y=@0059;default: y=@04ef;
  $  004:DC工作模式           $    $               $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@014c;0x01: y=@0435;0x02: y=@0436;default: y=@001c;
