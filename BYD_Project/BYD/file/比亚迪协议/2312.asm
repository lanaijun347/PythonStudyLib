...
读数据流: 
  ...
  $  000:真空泵状态                 $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0105;0x01: y=@0475;default: y=@001c;
  $  001:高速冷却风扇工作状态       $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0105;0x01: y=@0475;default: y=@001c;
  $  002:低速冷却风扇工作状态       $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0105;0x01: y=@0475;default: y=@001c;
  ...
  $  007:碰撞信号                   $    $               $    $  ANS007.BYTE004  $  switxh(x1)0x00: y=@0106;0x01: y=@0107;default: y=@001c;
  $  008:水温报警                   $    $               $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@03f3;0x01: y=@03f4;default: y=@001c;
  $  009:真空压力报警               $    $               $    $  ANS009.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@03f1;0x02: y=@03f2;default: y=@001c;
