...
读数据流: 
  ...
  $  026:油泵激活请求                              $    $               $    $  ANS026.BYTE004  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@0004;else y=@001c;
  $  027:风扇1开启标志位                           $    $               $    $  ANS027.BYTE004  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@0004;else y=@001c;
  $  028:风扇2开启标志位                           $    $               $    $  ANS028.BYTE004  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@0004;else y=@001c;
  $  029:进气歧管进气状态                          $    $               $    $  ANS029.BYTE004  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@0004;else y=@001c;
  $  030:VIN是否已编程                             $    $               $    $  ANS030.BYTE004  $  if(x1&0x08)y=@0000;else y=@0001;
  $  031:点火开关15端                              $    $               $    $  ANS031.BYTE004  $  if(x1&0x01)y=@0004;else y=@0005;
  ...
  $  067:车辆禁止停止                              $    $               $    $  ANS040.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@060e;else if((x1==0x01)&&(x2==0x00)) y=@060f;else if((x1==0x02)&&(x2==0x00)) y=@0610;else if((x1==0x03)&&(x2==0x00)) y=@0611;else if((x1==0x04)&&(x2==0x00)) y=@0612;else if((x1==0x05)&&(x2==0x00)) y=@0613;else if((x1==0x06)&&(x2==0x00)) y=@064a;else if((x1==0x07)&&(x2==0x00)) y=@0615;else if((x1==0x08)&&(x2==0x00)) y=@0616;else if((x1==0x09)&&(x2==0x00)) y=@0617;else if(((x1==0x0A)||(x1==0x0B)||(x1==0x0D))&&(x2==0x00)) y=@009e;else if((x1==0x0C)&&(x2==0x00)) y=@0618;else if((x1==0x0E)&&(x2==0x00)) y=@0619;else y=@001c;
  $  068:发动机禁止停止                            $    $               $    $  ANS041.BYTE004  $  if((x1==0x06)&&(x2==0x00)) y=@060d;else y=@001c;
  $  069:发动机故障禁止停止                        $    $               $    $  ANS042.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@061d;else if((x1==0x01)&&(x2==0x00)) y=@061e;else if((x1==0x04)&&(x2==0x00)) y=@061f;else if((x1==0x08)&&(x2==0x00)) y=@0620;else y=@001c;
  $  070:电池启动状态1                             $    $  V            $    $  ANS043.BYTE004  $  y=x1*15.94/255;
  $  071:SOFV1的精度                               $    $               $    $  ANS044.BYTE004  $  if(x1==0x00)y=@0624;else if((x1==0x01)||(x1==0x02))y=@0625;else y=@001c;
  $  072:电池启动状态2                             $    $  V            $    $  ANS045.BYTE004  $  y=x1*15.94/255;
  $  073:SOFV2的精度                               $    $               $    $  ANS046.BYTE004  $  if(x1==0x00)y=@0624;else if((x1==0x01)||(x1==0x02))y=@0625;else y=@001c;
  $  074:SOC电量精度                               $    $               $    $  ANS047.BYTE004  $  if(x1==0x00)y=@0621;else if(x1==0x01)y=@0622;else if(x1==0x02)y=@0623;else y=@001c;
  $  075:真空度                                    $    $               $    $  ANS048.BYTE004  $  y=x1*10+x2*9.96/255;
  $  076:电机启动次数                              $    $               $    $  ANS049.BYTE004  $  y=UINT(x1*0x1000000+x2*0x10000+x3*0x100+x4);
  $  077:起停状态字节                              $    $               $    $  ANS050.BYTE004  $  if(x1==0x00)y=@064b;else if(x1==0x01)y=@061b;else if(x1==0x02)y=@061c;else y=@001c;
  $  078:EGR(废气再循环)阀位置反馈电压信号         $    $  V            $    $  ANS051.BYTE004  $  y=(x1*31.88+x2*0.12)/255;
  $  079:废气循环利用率                            $    $               $    $  ANS051.BYTE006  $  y=(x1*99.61+x2*0.39)/255;
  $  080:EGR(废气再循环)激活条件状态               $    $               $    $  ANS051.BYTE008  $  if(x1&0x04)y=@009f;else y=@00a0;
  ...
  $  089:EGR(废气再循环)阀升高条件                 $    $               $    $  ANS051.BYTE022  $  if(x1&0x80)y=@009f;else y=@00a0;
  $  090:发动机温度阀值                            $    $               $    $  ANS051.BYTE022  $  if(x1&0x08)y=@064c;else y=@064d;
  $  091:档位触发VVL(可变气门升程阀)转换           $    $               $    $  ANS051.BYTE023  $  if(x1&0x08)y=@00ff;else y=@00fe;
