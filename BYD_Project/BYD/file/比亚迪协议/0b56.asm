...
版本信息:
  ...
  $%  004:Boot版本号:          $%    $%  ANS002.BYTE004  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  $%  005:Boot版本信息:        $%    $%  ANS002.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
  $%  006:发布日期:            $%    $%  ANS002.BYTE010  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@001d,x2,@001e,x3,@001f);
