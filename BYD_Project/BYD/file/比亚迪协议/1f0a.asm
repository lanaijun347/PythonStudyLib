...
读数据流: 
  ...
  $  041:左外后视镜折叠电机                  $    $           $    $  ANS001.BYTE072  $  if((x1*256+x2) < 25001) y=x1*256+x2;else if((x1*256+x2)==65535)y=@0472;else y=@001c;
  $  042:左外后视镜换向器水平位置电机        $    $           $    $  ANS001.BYTE074  $  if((x1*256+x2) < 20001) y=x1*256+x2;else if((x1*256+x2)==65535)y=@0472;else y=@001c;
  $  043:左外后视镜换向器垂直位置电机        $    $           $    $  ANS001.BYTE076  $  if((x1*256+x2) < 20001) y=x1*256+x2;else if((x1*256+x2)==65535)y=@0472;else y=@001c;
  $  044:左外后视镜照脚灯点亮时间            $    $  小时     $    $  ANS001.BYTE078  $  if((x1*256+x2) < 1001) y=x1*256+x2;else y=@001c;
  $  045:左外后视镜加热时间                  $    $  小时     $    $  ANS001.BYTE080  $  if((x1*256+x2) < 501) y=x1*256+x2;else y=@001c;
