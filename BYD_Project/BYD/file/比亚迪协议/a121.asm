...
读数据流: 
  ...
  $  005:平均温度                  $    $  degree C     $    $  ANS005.BYTE004  $  if(x1<0xDD) y=x1-60;else y=@019f;
  $  006:极柱温度                  $    $  degree C     $    $  ANS006.BYTE004  $  if(x1<0xDD) y=x1-60;else y=@019f;
  $  007:MOS温度                   $    $  degree C     $    $  ANS007.BYTE004  $  if(x1<0xDD) y=x1-60;else y=@019f;
  $  008:充电允许                  $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@002d;else if(x1==0x01)y=@002c;else y=@00d6;
  $  009:放电允许                  $    $               $    $  ANS009.BYTE004  $  if(x1==0x00)y=@002d;else if(x1==0x01)y=@002c;else y=@00d6;
  $  010:铁电池故障                $    $               $    $  ANS010.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@0108;else y=@00d6;
  $  011:SOC请求充电               $    $               $    $  ANS011.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@01ce;else y=@00d6;
  $  012:充电接触器请求            $    $               $    $  ANS012.BYTE004  $  if(x1==0x00)y=@0048;else if(x1==0x01)y=@015d;else y=@00d6;
  $  013:起停限制                  $    $               $    $  ANS013.BYTE004  $  if(x1==0x00)y=@0048;else if(x1==0x01)y=@01cd;else y=@00d6;
  $  014:充放电状态                $    $               $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0177;else if(x1==0x01)y=@01cc;else y=@00d6;
  $  015:1号电池均衡电路状态       $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@003a;else y=@00d6;
  $  016:2号电池均衡电路状态       $    $               $    $  ANS016.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@003a;else y=@00d6;
  $  017:3号电池均衡电路状态       $    $               $    $  ANS017.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@003a;else y=@00d6;
  $  018:4号电池均衡电路状态       $    $               $    $  ANS018.BYTE004  $  if(x1==0x00)y=@0022;else if(x1==0x01)y=@003a;else y=@00d6;
  $  019:1号电池均衡状态           $    $               $    $  ANS019.BYTE004  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@003b;else y=@00d6;
  $  020:2号电池均衡状态           $    $               $    $  ANS020.BYTE004  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@003b;else y=@00d6;
  $  021:3号电池均衡状态           $    $               $    $  ANS021.BYTE004  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@003b;else y=@00d6;
  $  022:4号电池均衡状态           $    $               $    $  ANS022.BYTE004  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@003b;else y=@00d6;
