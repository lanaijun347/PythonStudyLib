...
读数据流: 
  ...
  $  002:风扇状态                           $    $             $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0059;0x02: y=@009e;0x03: y=@009e;default: y=@0440;
  $  003:接地状态                           $    $             $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0059;0x02: y=@009e;0x03: y=@009e;default: y=@0440;
  ...
  $  012:车内插座放电状态                   $    $             $    $  ANS012.BYTE004  $  switxh(x1)0x00: y=@015c;0x01: y=@04d0;0x02: y=@04d1;0x03: y=@04d2;0x04: y=@04d3;0x05: y=@009e;0x06: y=@009e;0x07: y=@009e;default: y=@0440;
  $  013:VTOL(车辆对用电设备)放电状态       $    $             $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@015c;0x01: y=@04d0;0x02: y=@04d1;0x03: y=@04d2;0x04: y=@04d3;0x05: y=@009e;0x06: y=@009e;0x07: y=@009e;default: y=@0440;
  $  014:车载充电功率状态                   $    $             $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@054f;0x01: y=@0550;0x02: y=@0551;0x03: y=@009e;default: y=@0440;
  $  015:交流外充设备故障状态               $    $             $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0059;default: y=@0440;
  $  016:交流外充接地状态                   $    $             $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0059;0x02: y=@009e;0x03: y=@009e;default: y=@0440;
  $  017:充电枪连接状态                     $    $             $    $  ANS017.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0059;0x02: y=@002e;default: y=@0440;
  $  018:限功率放电状态                     $    $             $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0554;default: y=@0440;
  $  019:应急充电是否允许                   $    $             $    $  ANS019.BYTE004  $  switxh(x1)0x00: y=@002d;0x01: y=@002c;default: y=@0440;
  $  020:交流互锁故障                       $    $             $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0059;default: y=@0440;
