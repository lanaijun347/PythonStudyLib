...
读数据流: 
  ...
  $  009:天窗当前动作状态               $    $        $    $  ANS009.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@00d2;else if(x1==0x02)y=@0004;else if(x1==0x03)y=@0005;else y=@001c;
  $  010:天窗位置状态                   $    $        $    $  ANS010.BYTE004  $  if(x1==0x00)y=@0048;else if(x1==0x01)y=@02df;else if(x1==0x02)y=@0311;else y=@001c;
  $  011:天窗电机热保护状态             $    $        $    $  ANS011.BYTE004  $  if(x1==0x00)y=@0399;else if(x1==0x01)y=@039a;else y=@001c;
  $  012:天窗上倾开关信号               $    $        $    $  ANS012.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  013:天窗打开开关信号               $    $        $    $  ANS013.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  014:天窗关闭开关信号               $    $        $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  015:天窗玻璃位置百分比             $    $  %     $    $  ANS015.BYTE004  $  if(x1 < 101) y=x1;else if(x1 == 0xFF) y=@0398;else y=@001c;
  $  016:遮阳帘当前动作状态             $    $        $    $  ANS016.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@00d2;else if(x1==0x02)y=@0004;else if(x1==0x03)y=@0005;else y=@001c;
  $  017:遮阳帘位置状态                 $    $        $    $  ANS017.BYTE004  $  if(x1==0x00)y=@0048;else if(x1==0x01)y=@02df;else if(x1==0x02)y=@0311;else y=@001c;
  $  018:遮阳帘电机热保护状态           $    $        $    $  ANS018.BYTE004  $  if(x1==0x00)y=@0399;else if(x1==0x01)y=@039a;else y=@001c;
  $  019:遮阳帘打开开关信号             $    $        $    $  ANS019.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  020:遮阳帘关闭开关信号             $    $        $    $  ANS020.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  021:遮阳帘位置百分比               $    $  %     $    $  ANS021.BYTE004  $  if(x1 < 101) y=x1;else if(x1 == 0xFF) y=@0398;else y=@001c;
  $  022:右前车窗当前动作状态           $    $        $    $  ANS022.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@00d2;else if(x1==0x02)y=@0004;else if(x1==0x03)y=@0005;else y=@001c;
  $  023:右前车窗位置                   $    $        $    $  ANS023.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@0470;else if(x1==0x02)y=@0471;else if(x1==0x03)y=@009a;else y=@001c;
  $  024:右前车窗位置状态               $    $        $    $  ANS024.BYTE004  $  if(x1==0x00)y=@0048;else if(x1==0x01)y=@02df;else if(x1==0x02)y=@0311;else y=@001c;
  $  025:右前车窗自动上升开关信号       $    $        $    $  ANS025.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  026:右前车窗自动下降开关信号       $    $        $    $  ANS026.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  027:右前车窗手动上升开关信号       $    $        $    $  ANS027.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  028:右前车窗手动下降开关信号       $    $        $    $  ANS028.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  029:右前车窗玻璃位置百分比         $    $  %     $    $  ANS029.BYTE004  $  if(x1 < 101) y=x1;else if(x1 == 0xFF) y=@0398;else y=@001c;
  $  030:左后车窗当前动作状态           $    $        $    $  ANS030.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@00d2;else if(x1==0x02)y=@0004;else if(x1==0x03)y=@0005;else y=@001c;
  $  031:左后车窗位置                   $    $        $    $  ANS031.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@0470;else if(x1==0x02)y=@0471;else if(x1==0x03)y=@009a;else y=@001c;
  $  032:左后车窗位置状态               $    $        $    $  ANS032.BYTE004  $  if(x1==0x00)y=@0048;else if(x1==0x01)y=@02df;else if(x1==0x02)y=@0311;else y=@001c;
  $  033:左后车窗自动上升开关信号       $    $        $    $  ANS033.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  034:左后车窗自动下降开关信号       $    $        $    $  ANS034.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  035:左后车窗手动上升开关信号       $    $        $    $  ANS035.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  036:左后车窗手动下降开关信号       $    $        $    $  ANS036.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  037:左后车窗玻璃位置百分比         $    $  %     $    $  ANS037.BYTE004  $  if(x1 < 101) y=x1;else if(x1 == 0xFF) y=@0398;else y=@001c;
  $  038:右后车窗当前动作状态           $    $        $    $  ANS038.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@00d2;else if(x1==0x02)y=@0004;else if(x1==0x03)y=@0005;else y=@001c;
  $  039:右后车窗位置                   $    $        $    $  ANS039.BYTE004  $  if(x1==0x00)y=@004b;else if(x1==0x01)y=@0470;else if(x1==0x02)y=@0471;else if(x1==0x03)y=@009a;else y=@001c;
  $  040:右后车窗位置状态               $    $        $    $  ANS040.BYTE004  $  if(x1==0x00)y=@0048;else if(x1==0x01)y=@02df;else if(x1==0x02)y=@0311;else y=@001c;
  $  041:右后车窗自动上升开关信号       $    $        $    $  ANS041.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  042:右后车窗自动下降开关信号       $    $        $    $  ANS042.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  043:右后车窗手动上升开关信号       $    $        $    $  ANS043.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  044:右后车窗手动下降开关信号       $    $        $    $  ANS044.BYTE004  $  if(x1==0x00)y=@0004;else if(x1==0x01)y=@0005;else y=@001c;
  $  045:右后车窗玻璃位置百分比         $    $  %     $    $  ANS045.BYTE004  $  if(x1 < 101) y=x1;else if(x1 == 0xFF) y=@0398;else y=@001c;
