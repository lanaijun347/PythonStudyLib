...
读数据流: 
  ...
  $  001:是否加密       $    $       $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0077;else if(x1==0x01)y=@0078;else y=@074c;
  $  002:加密方式       $    $       $    $  ANS001.BYTE005  $  if(x1==0x00)y=@0077;else if(x1==0x01)y=@0385;else if(x1==0x02)y=@008f;else if(x1==0x03)y=@0386;else y=@074c;
