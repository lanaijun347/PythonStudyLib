...
读数据流: 
  ...
  $  056:燃油闭环                                    $    $                    $    $  ANS000.BYTE058  $  if(x&0x01) y=@0006; else y=@0007;
  $  057:前氧传感器稀浓状态                          $    $                    $    $  ANS000.BYTE058  $  if(x&0x02) y=@0008; else y=@0009;
  $  058:BLM自学习状态                               $    $                    $    $  ANS000.BYTE058  $  if(x&0x04) y=@0006; else y=@0007;
  $  059:溢油清除模式状态                            $    $                    $    $  ANS000.BYTE058  $  if(x&0x08) y=@0006; else y=@0007;
  $  060:功率增强模式状态                            $    $                    $    $  ANS000.BYTE058  $  if(x&0x10) y=@0006; else y=@0007;
  $  061:DFCO模式状态                                $    $                    $    $  ANS000.BYTE058  $  if(x&0x20) y=@0006; else y=@0007;
  $  062:MAPCID第一第二次相同                        $    $                    $    $  ANS000.BYTE058  $  if(x&0x40) y=@0001; else y=@0000;
  $  063:暖机过程                                    $    $                    $    $  ANS000.BYTE058  $  if(x&0x80) y=@0000; else y=@0001;
  $  064:扭矩控制模式状态                            $    $                    $    $  ANS000.BYTE059  $  if(x&0x01) y=@0006; else y=@0007;
  $  065:线性EGR(废气再循环)阀测试完成               $    $                    $    $  ANS000.BYTE059  $  if(x&0x02) y=@0001; else y=@0000;
  $  066:变速器档位                                  $    $                    $    $  ANS000.BYTE059  $  if(x&0x04) y=@024a; else y=@024b;
  $  067:油泵继电器状态                              $    $                    $    $  ANS000.BYTE059  $  if(x&0x08) y=@0004; else y=@0005;
  $  068:非易失性存储器是否正常                      $    $                    $    $  ANS000.BYTE059  $  if(x&0x10) y=@0001; else y=@0000;
  $  069:ICA闭环模式状态                             $    $                    $    $  ANS000.BYTE059  $  if(x&0x40) y=@0006; else y=@0007;
  $  070:ICA调节状态                                 $    $                    $    $  ANS000.BYTE059  $  if(x&0x80) y=@0006; else y=@0007;
  $  071:AC WOT禁止模式状态                          $    $                    $    $  ANS000.BYTE060  $  if(x&0x01) y=@0006; else y=@0007;
  $  072:AC大负荷禁止模式状态                        $    $                    $    $  ANS000.BYTE060  $  if(x&0x02) y=@0006; else y=@0007;
  $  073:后环螺线管关断状态                          $    $                    $    $  ANS000.BYTE060  $  if(x&0x04) y=@0006; else y=@0007;
  $  074:IAC位置正常                                 $    $                    $    $  ANS000.BYTE060  $  if(x&0x08) y=@0001; else y=@0000;
  $  075:有AC请求                                    $    $                    $    $  ANS000.BYTE060  $  if(x&0x10) y=@0001; else y=@0000;
  $  076:AC压力                                      $    $                    $    $  ANS000.BYTE060  $  if(x&0x20) y=@0070; else y=@0071;
  $  077:AC继电器状态                                $    $                    $    $  ANS000.BYTE060  $  if(x&0x40) y=@0004; else y=@0005;
  $  078:AC是否使用                                  $    $                    $    $  ANS000.BYTE060  $  if(x&0x80) y=@0000; else y=@0001;
  $  079:冷却风扇1状态                               $    $                    $    $  ANS000.BYTE061  $  if(x&0x01) y=@0004; else y=@0005;
  $  080:冷却风扇2状态                               $    $                    $    $  ANS000.BYTE061  $  if(x&0x02) y=@0004; else y=@0005;
  $  081:氧传感器加热器A                             $    $                    $    $  ANS000.BYTE061  $  if(x&0x08) y=@0004; else y=@0005;
  $  082:点火开关                                    $    $                    $    $  ANS000.BYTE061  $  if(x&0x10) y=@0004; else y=@0005;
  $  083:发动机检测灯                                $    $                    $    $  ANS000.BYTE061  $  if(x&0x20) y=@0004; else y=@0005;
  $  084:变速器状态                                  $    $                    $    $  ANS000.BYTE061  $  if(x&0x40) y=@024c; else y=@024d;
  $  085:ESC状态                                     $    $                    $    $  ANS000.BYTE061  $  if(x&0x80) y=@0006; else y=@0007;
  $  086:喷油器A电压状态                             $    $                    $    $  ANS000.BYTE065  $  switxh(x&0x03)0: y=@0022;1:y=@0071;2:y=@0070;3:y=@001c;default:y=@0076;
  $  087:喷油器B电压状态                             $    $                    $    $  ANS000.BYTE065  $  switxh(x&0x0C)0: y=@0022;4:y=@0071;8:y=@0070;0x0C:y=@001c;default:y=@0076;
  $  088:喷油器C电压状态                             $    $                    $    $  ANS000.BYTE065  $  switxh(x&0x30)0x00: y=@0022;0x10:y=@0071;0x20:y=@0070;0x30:y=@001c;default:y=@0076;
  $  089:喷油器D电压状态                             $    $                    $    $  ANS000.BYTE065  $  switxh(x&0xC0)0x00: y=@0022;0x40:y=@0071;0x80:y=@0070;0xC0:y=@001c;default:y=@0076;
  $  090:是否达到怠速条件                            $    $                    $    $  ANS000.BYTE066  $  switxh(x&0x03)0: y=@0001;1:y=@0000;default:y=@001c;
  $  091:怠速是否使能                                $    $                    $    $  ANS000.BYTE066  $  switxh(x&0x07)0: y=@0001;1: y=@0001;2:y=@0000;3:y=@0000;default:y=@001c;
  $  092:ELOAD1状态                                  $    $                    $    $  ANS000.BYTE066  $  if(x&0x04) y=@0006; else y=@0007;
  $  093:ELOAD2状态                                  $    $                    $    $  ANS000.BYTE066  $  if(x&0x08) y=@0006; else y=@0007;
  $  094:前蒸汽阀传感器是否启用                      $    $                    $    $  ANS000.BYTE066  $  if(x&0x10) y=@0000; else y=@0001;
  $  095:后蒸汽阀传感器是否启用                      $    $                    $    $  ANS000.BYTE066  $  if(x&0x20) y=@0000; else y=@0001;
  $  096:后环切割线圈是否启用                        $    $                    $    $  ANS000.BYTE066  $  if(x&0x40) y=@0000; else y=@0001;
  $  097:AC传感器是否启用                            $    $                    $    $  ANS000.BYTE066  $  if(x&0x80) y=@0000; else y=@0001;
