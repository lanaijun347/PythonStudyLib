...
读数据流: 
  ...
  $  010:末端保护使能                    $    $               $    $  ANS010.BYTE004  $  switxh(x1)0x00: y=@03ae;0x01: y=@0044;default: y=@001c;
  ...
  $  013:PDC使能状态                     $    $               $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@03ae;0x01: y=@0044;default: y=@001c;
  $  014:PDC初始力矩值                   $    $  牛顿米       $    $  ANS014.BYTE004  $  if(x1<0x80)y=((x1<<24)+(x2<<16)+(x3<<8)+x4)*1.0/2097152;else y=(((x1-256)<<24)+(x2<<16)+(x3<<8)+x4)*1.0/2097152;
  $  015:CCP使能状态                     $    $               $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@03ae;0x01: y=@0044;default: y=@001c;
