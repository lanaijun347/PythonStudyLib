...
读数据流: 
  ...
  $  007:DC预充状态                         $    $               $    $  ANS007.BYTE004  $  if(x1==0x00) y=@0112;else if(x1==0x01) y=@0113; else if(x1==0x02) y=@0114; else if(x1==0x03) y=@0115; else y=@00d6;
  $  008:放电主接触器状态                   $    $               $    $  ANS008.BYTE004  $  if(x1==0x00) y=@002e;else if(x1==0x01) y=@002f;else y=@00d6;
  $  009:预充接触器状态                     $    $               $    $  ANS009.BYTE004  $  if(x1==0x00) y=@002e;else if(x1==0x01) y=@002f;else y=@00d6;
  $  010:充电接触器状态                     $    $               $    $  ANS010.BYTE004  $  if(x1==0x00) y=@002e;else if(x1==0x01) y=@002f;else y=@00d6;
  $  011:DC预充接触器状态                   $    $               $    $  ANS011.BYTE004  $  if(x1==0x00) y=@002e;else if(x1==0x01) y=@002f;else y=@00d6;
  $  012:DC接触器状态                       $    $               $    $  ANS012.BYTE004  $  if(x1==0x00) y=@002e;else if(x1==0x01) y=@002f;else y=@00d6;
  $  013:放电是否允许                       $    $               $    $  ANS013.BYTE004  $  if(x1==0x00) y=@002c;else if(x1==0x01) y=@002d; else y=@00d6;
  $  014:最低电压电池号                     $    $               $    $  ANS014.BYTE004  $  if(x1<0x65) y=x1;else y=@00d6;
  $  015:最低单节电池电压                   $    $  V            $    $  ANS015.BYTE004  $  if((x2==0x00) && (x1<0x64)) y=@00fe;else if((x2==0x00) && (x1>=0x64) && (x1<0xC8)) y=@00ff; else if((x2==0x00) && (x1>=0xC8)) y=@0100;  else if((x2==0x01) && (x1<0x2C)) y=@0100; else if((x2==0x01) && (x1>=0x2C) && (x1<0x90)) y=@0116; else if((x2==0x01) && (x1>=0x90) && (x1<0xF4)) y=@0117; else y=@00d6;
  $  016:最高电压电池号                     $    $               $    $  ANS016.BYTE004  $  if(x1<0x65) y=x1;else y=@00d6;
  $  017:最高单节电池电压                   $    $  V            $    $  ANS017.BYTE004  $  if((x2==0x00) && (x1<0x64)) y=@00fe;else if((x2==0x00) && (x1>=0x64) && (x1<0xC8)) y=@00ff; else if((x2==0x00) && (x1>=0xC8)) y=@0100;  else if((x2==0x01) && (x1<0x2C)) y=@0100; else if((x2==0x01) && (x1>=0x2C) && (x1<0x90)) y=@0116; else if((x2==0x01) && (x1>=0x90) && (x1<0xF4)) y=@0117; else y=@00d6;
  $  018:最低温度电池号                     $    $               $    $  ANS018.BYTE004  $  if(x1<0x65) y=x1;else y=@00d6;
  $  019:最低单节电池温度                   $    $  degree C     $    $  ANS019.BYTE004  $  if(x1<0xC9) y=x1-40;else y=@00d6;
  $  020:最高温度电池号                     $    $               $    $  ANS020.BYTE004  $  if(x1<0x65) y=x1;else y=@00d6;
  $  021:最高单节电池温度                   $    $  degree C     $    $  ANS021.BYTE004  $  if(x1<0xC9) y=x1-40;else y=@00d6;
  $  022:电池组充电状态                     $    $               $    $  ANS022.BYTE004  $  if((x1&0x03)==0x00) y=@0022;else if((x1&0x03)==0x01) y=@010d;else if((x1&0x03)==0x02) y=@010e;  else y=@00d6;
  $  023:电池组温度状态                     $    $               $    $  ANS023.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@010b;else if(x1==0x02) y=@010c; else y=@00d6;
  $  024:电池组漏电状态                     $    $               $    $  ANS024.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@0110;else if(x1==0x02) y=@0111; else y=@00d6;
  $  025:电池组电量状态                     $    $               $    $  ANS025.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@010f;else y=@00d6;
  $  026:湿度状态                           $    $               $    $  ANS026.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@010a;else y=@00d6;
  $  027:过流状态                           $    $               $    $  ANS027.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@0118;else y=@00d6;
  $  028:电压过低报警                       $    $               $    $  ANS028.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@010d;else if(x1==0x02) y=@010e; else y=@00d6;
  $  029:电压过高报警                       $    $               $    $  ANS029.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@010d;else if(x1==0x02) y=@010e; else y=@00d6;
  $  030:BMS(电池管理系统)12V电源电压       $    $               $    $  ANS030.BYTE004  $  if(x1<0xD2) y=x1/10;else y=@0097;
  $  031:系统均衡状态                       $    $               $    $  ANS031.BYTE004  $  if(x1==0x00) y=@0005;else if(x1==0x01) y=@0004;else y=@0097;
  ...
  $  125:1-8节电池电压采样异常              $    $               $    $  ANS125.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  126:9-16节电池电压采样异常             $    $               $    $  ANS126.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  127:17-24节电池电压采样异常            $    $               $    $  ANS127.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  128:25-32节电池电压采样异常            $    $               $    $  ANS128.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  129:33-40节电池电压采样异常            $    $               $    $  ANS129.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  130:41-48节电池电压采样异常            $    $               $    $  ANS130.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  131:49-56节电池电压采样异常            $    $               $    $  ANS131.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  132:57-64节电池电压采样异常            $    $               $    $  ANS132.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  133:65-72节电池电压采样异常            $    $               $    $  ANS133.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  134:73-80节电池电压采样异常            $    $               $    $  ANS134.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  135:81-88节电池电压采样异常            $    $               $    $  ANS135.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  136:89-93节电池电压采样异常            $    $               $    $  ANS136.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@018b;else if(x1&0x40) y=@018c;else if(x1&0x20) y=@018d;else if(x1&0x10) y=@018e;else if(x1&0x08) y=@018f;else if(x1&0x04) y=@0190;else if(x1&0x02) y=@0191;else if(x1&0x01) y=@0192;else y=@003a;
  $  137:1电池包温度采样线异常              $    $               $    $  ANS137.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  138:2电池包温度采样线异常              $    $               $    $  ANS138.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  139:3电池包温度采样线异常              $    $               $    $  ANS139.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  140:4电池包温度采样线异常              $    $               $    $  ANS140.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  141:5电池包温度采样线异常              $    $               $    $  ANS141.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  142:6电池包温度采样线异常              $    $               $    $  ANS142.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  143:7电池包温度采样线异常              $    $               $    $  ANS143.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  144:8电池包温度采样线异常              $    $               $    $  ANS144.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  145:9电池包温度采样线异常              $    $               $    $  ANS145.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
  $  146:10电池包温度采样线异常             $    $               $    $  ANS146.BYTE004  $  if(x1==0) y=@0022;else if(x1&0x80) y=@0183;else if(x1&0x40) y=@0184;else if(x1&0x20) y=@0185;else if(x1&0x10) y=@0186;else if(x1&0x08) y=@0187;else if(x1&0x04) y=@0188;else if(x1&0x02) y=@0189;else if(x1&0x01) y=@018a;else y=@003a;
