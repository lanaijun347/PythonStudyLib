...
读数据流: 
  ...
  $  013:回家照明功能时间         $    $       $    $  ANS002.BYTE004  $  if((x1&0x07)==0x00)y=@0642;else if((x1&0x07)==0x01)y=@0463;else if((x1&0x07)==0x02)y=@0464;else if((x1&0x07)==0x03)y=@0465;else if((x1&0x07)==0x04)y=@0466;else if((x1&0x07)==0x05)y=@0467;else if((x1&0x07)==0x06)y=@0468;else y=@001c;
  $  014:离家照明功能时间         $    $       $    $  ANS002.BYTE004  $  if((x1&0x38)==0x00)y=@0641;else if((x1&0x38)==0x08)y=@0457;else if((x1&0x38)==0x10)y=@0458;else if((x1&0x38)==0x18)y=@0459;else if((x1&0x38)==0x20)y=@045a;else if((x1&0x38)==0x28)y=@045b;else if((x1&0x38)==0x30)y=@045c;else y=@001c;
