...
版本信息:
  ...
  $%  000:ECU车型系列:        $%    $%  ANS000.BYTE004  $%  y=@0083;
...
读数据流: 
  ...
  $  002:ECU加密信息       $    $           $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0077;else if(x1==0x01)y=@0078;else y=@001c;
  $  003:ECU加密方式       $    $           $    $  ANS002.BYTE005  $  if(x1==0x00)y=@0077;else if(x1==0x01)y=@0385;else if(x1==0x02)y=@008f;else if(x1==0x03)y=@0386;else y=@001c;
