...
读数据流: 
  ...
  $  013:回家照明功能时间         $    $       $    $  ANS002.BYTE004  $  if((x1&0x07)==0x00)y=@07ad;else if((x1&0x07)==0x01)y=@06e3;else if((x1&0x07)==0x02)y=@06e4;else if((x1&0x07)==0x03)y=@06e5;else if((x1&0x07)==0x04)y=@06e6;else if((x1&0x07)==0x05)y=@06e7;else if((x1&0x07)==0x06)y=@0468;else y=@001c;
  $  014:离家照明功能时间         $    $       $    $  ANS002.BYTE004  $  if((x1&0x38)==0x00)y=@07ae;else if((x1&0x38)==0x08)y=@06de;else if((x1&0x38)==0x10)y=@06df;else if((x1&0x38)==0x18)y=@06e0;else if((x1&0x38)==0x20)y=@06e1;else if((x1&0x38)==0x28)y=@06e2;else if((x1&0x38)==0x30)y=@045c;else y=@001c;
