...
读数据流: 
  ...
  $  006:缺相err0(速度判断)                 $    $          $    $  ANS006.BYTE004  $  if(x1==0x00) y=@0022; else if(x1==0x01) y=@0059; else y=@00d6;
  $  007:缺相err1(速度判断)                 $    $          $    $  ANS007.BYTE004  $  if(x1==0x00) y=@0022; else if(x1==0x01) y=@0059; else y=@00d6;
  $  008:参数设定err                        $    $          $    $  ANS008.BYTE004  $  if(x1==0x00) y=@0022; else if(x1==0x01) y=@0059; else y=@00d6;
