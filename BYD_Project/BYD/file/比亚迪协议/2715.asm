...
读数据流: 
  ...
  $  001:冷凝风扇工作状态                    $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@00d2;0x01: y=@0475;default: y=@001c;
  $  002:冷却风扇工作状态                    $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@00d2;0x01: y=@0475;default: y=@001c;
  $  003:电机散热风扇工作状态                $    $               $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@00d2;0x01: y=@0475;default: y=@001c;
  $  004:电源电压                            $    $  V            $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=250))y=x1*0.125;else if((x1==255)) y=@00be;else y=@001c;
  $  005:冷凝风扇实际工作的占空比            $    $  %            $    $  ANS005.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@0097;else if((x1==255)) y=@00be;else y=@001c;
  $  006:冷却风扇实际工作的占空比            $    $  %            $    $  ANS006.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@0097;else if((x1==255)) y=@00be;else y=@001c;
  $  007:冷凝/冷却风扇预置工作的占空比       $    $  %            $    $  ANS007.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@0097;else if((x1==255)) y=@00be;else y=@001c;
  $  008:电机散热风扇预置工作的占空比        $    $  %            $    $  ANS008.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@0097;else if((x1==255)) y=@00be;else y=@001c;
  $  009:模块温度                            $    $  degree C     $    $  ANS009.BYTE004  $  if((x1>=0)&&(x1<=210))y=x1-40;else if((x1==255)) y=@00be;else y=@001c;
  $  010:电源档位                            $    $  degree C     $    $  ANS010.BYTE004  $  if(x1&0x01) y=@02f9;else y=@009e;
