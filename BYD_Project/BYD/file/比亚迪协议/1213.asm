...
读数据流: 
  ...
  $  004:压力状态                             $    $               $    $  ANS004.BYTE004  $  if(x1==0x00) y=@0022;else if(x1==0x01) y=@0059;else y=@001c;
  ...
  $  008:后除霜继电器控制                     $    $               $    $  ANS007.BYTE004  $  if(x1==0x00)y=@002e;else if(x1==0x01)y=@002f;else y=@001c;
  $  009:主驾PTC状态                          $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@0298;else if(x1==0x01)y=@011a;else y=@001c;
  $  010:IG2电压                              $    $  V            $    $  ANS009.BYTE004  $  if(((x1*0.1) > 10) && ((x1*0.1) <=15.9)) y=x1*0.1;else y=@001c;
  $  011:电动压缩机状态                       $    $               $    $  ANS010.BYTE004  $  if(x1==0x00)y=@014a;else if(x1==0x01)y=@014b;else y=@001c;
  $  012:整车允许开启电动压缩机状态           $    $               $    $  ANS011.BYTE004  $  if(x1==0x00)y=@0097;else if(x1==0x01)y=@002d;else if(x1==0x02)y=@002c;else y=@001c;
  $  013:主驾吹面通道温度                     $    $  degree C     $    $  ANS012.BYTE004  $  if(((x1-40) > (0-41)) && ((x1-40) <101)) y=x1-40;else if(x1==0xD0) y=@019d;else if(x1==0xD8) y=@038c;else if(x1==0xFF) y=@0048;else y=@001c;
  $  014:水泵继电器控制                       $    $               $    $  ANS013.BYTE004  $  if(x1==0x00)y=@002e;else if(x1==0x01)y=@002f;else y=@001c;
  $  015:净化继电器控制                       $    $               $    $  ANS014.BYTE004  $  if(x1==0x00)y=@002e;else if(x1==0x01)y=@002f;else y=@001c;
  $  016:空调高压模块状态                     $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@0388;else if(x1==0x01)y=@0389;else if(x1==0x02)y=@07a8;else if(x1==0x03)y=@038b;else y=@001c;
  ...
  $  022:蒸发器出口冷媒温度                   $    $  degree C     $    $  ANS021.BYTE004  $  if(((x1*0.1+x2*25.6)<81) &&((x1*0.1+x2*25.6)>=0)) y=x1*0.1+x2*25.6;else if((x1*0.1+(x2-256)*25.6)<0 &&(x1*0.1+(x2-256)*25.6)>=(0-40)) y=x1*0.1+(x2-256)*25.6;else y=@001c;
