...
读数据流: 
  ...
  $  003:座椅通风总档位数               $    $       $    $  ANS001.BYTE004  $  if(x1==0x00)y=@05cd;else if(x1==0x01)y=@009e;else y=@001c;
  $  004:座椅通风当前档位               $    $       $    $  ANS001.BYTE005  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@0295;else if(x1==0x02)y=@009e;else if(x1==0x03)y=@0294;else y=@001c;
  $  005:座椅加热总档位数               $    $       $    $  ANS002.BYTE004  $  if(x1==0x00)y=@05cd;else if(x1==0x01)y=@009e;else y=@001c;
  $  006:座椅加热当前档位               $    $       $    $  ANS002.BYTE005  $  if(x1==0x00)y=@0005;else if(x1==0x01)y=@0295;else if(x1==0x02)y=@009e;else if(x1==0x03)y=@0294;else y=@001c;
