...
读数据流: 
  ...
  $  000:后驱动电机状态                     $    $               $    $  ANS000.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y=@03d4;else if((x1 == 0x01)&&(x2==0x00)) y=@03d5;else if((x1 == 0x02)&&(x2==0x00)) y=@0005;else y=@001c;
  $  001:启动允许                           $    $               $    $  ANS001.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y=@03d6;else if((x1 == 0x01)&&(x2==0x00)) y=@0727;else y=@001c;
  $  002:防盗解除状态                       $    $               $    $  ANS002.BYTE004  $  if(x1 == 0x00)y=@0501;else if(x1 == 0x01)y=@0502;else if(x1 == 0x02)y=@0726;else y=@001c;
  $  003:主动泄放状态                       $    $               $    $  ANS003.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y=@01b8;else if((x1 == 0x01)&&(x2==0x00)) y=@05e2;else if((x1 == 0x02)&&(x2==0x00)) y=@03de;else if((x1 == 0x03)&&(x2==0x00)) y=@01d1;else y=@001c;
  $  004:盖子状态                           $    $               $    $  ANS004.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y=@0004;else if((x1 == 0x01)&&(x2==0x00)) y=@0005;else y=@001c;
  $  005:动力系统状态                       $    $               $    $  ANS005.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y=@0022;else if((x1 == 0x01)&&(x2==0x00)) y=@0059;else y=@001c;
  ...
  $  018:旋变状态                           $    $               $    $  ANS018.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y=@0022;else if((x1 == 0x01)&&(x2==0x00)) y=@0059;else y=@001c;
  $  019:过流状态                           $    $               $    $  ANS019.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y=@0022;else if((x1 == 0x01)&&(x2==0x00)) y=@0059;else y=@001c;
  $  020:IPM状态                            $    $               $    $  ANS020.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y=@0022;else if((x1 == 0x01)&&(x2==0x00)) y=@0059;else y=@001c;
