...
版本信息:
  ...
  $%  004:车型:                    $%    $%  ANS002.BYTE004  $%  switxh(x1) 0x51:y=@06d8;0x52:y=@008d;0x53:y=@0084;0x54:y=@0195;0x55:y=@0196;default: y=@0042;
...
读数据流: 
  ...
  $  000:压缩机控制状态                         $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@00d2;else if(x1==0x01)y=@011a;else y=@0076;
  $  001:压缩机实际状态                         $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@00d2;else if(x1==0x01)y=@011a;else y=@0076;
  ...
  $  006:IPM/IGBT(绝缘栅双极型晶体管)温度       $    $  W            $    $  ANS006.BYTE004  $  y=x1*256+x2;
