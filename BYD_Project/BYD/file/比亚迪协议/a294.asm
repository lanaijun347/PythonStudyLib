...
读数据流: 
  ...
  $  002:模式                 $    $               $    $  ANS002.BYTE004  $  if(x1==0x01) y=@0147; else if(x1==0x02) y=@0146; else if(x1==0x03) y=@0145; else if(x1==0x04) y=@0144; else if(x1==0x05) y=@0148; else y=@0097;
  $  003:AC状态               $    $               $    $  ANS003.BYTE004  $  if(x1==0x00) y=@0340; else if(x1==0x01) y=@0341; else if(x1==0x02) y=@0342;else y=@0097;
  $  004:车外温度             $    $  degree C     $    $  ANS004.BYTE004  $  if(x1>0xEA) y=x1-255; else if(x1<0x27)y=x1;else y=@0097;
  $  005:车内温度             $    $  degree C     $    $  ANS005.BYTE004  $  if(x1>0xEA) y=x1-255; else if(x1<0x27)y=x1;else y=@0097;
  $  006:蒸发器温度           $    $  degree C     $    $  ANS006.BYTE004  $  if(x1>0xEA) y=x1-255; else if(x1<0x27)y=x1;else y=@0097;
