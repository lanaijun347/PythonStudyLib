...
读数据流: 
  ...
  $  000:点火开关开                   $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0000;else y=@0001;
  $  001:主继电器上电                 $    $       $    $  ANS000.BYTE004  $  if(x1&0x02) y=@0000;else y=@0001;
  $  002:油泵继电器上电               $    $       $    $  ANS000.BYTE004  $  if(x1&0x04) y=@0000;else y=@0001;
  $  003:发动机转动                   $    $       $    $  ANS000.BYTE004  $  if(x1&0x08) y=@0000;else y=@0001;
  $  004:发动机达到怠速转速           $    $       $    $  ANS000.BYTE004  $  if(x1&0x10) y=@0000;else y=@0001;
  $  005:达到发动机正常运行水温       $    $       $    $  ANS000.BYTE004  $  if(x1&0x40) y=@0000;else y=@0001;
  $  006:行车状态                     $    $       $    $  ANS000.BYTE004  $  if(x1&0x80) y=@0000;else y=@0001;

  $)  02.发动机动态工况
  $  02.发动机动态工况
  $  REQ000:7E0 03 22 01 E9 00 00 00 00       $  ANS000:7E8 03 22 01 E9 00 00 00 00

  $  000:节气门阀片在怠速位置       $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0000;else y=@0001;
  $  001:节气门全开                 $    $       $    $  ANS000.BYTE004  $  if(x1&0x02) y=@0000;else y=@0001;
  $  002:减速断油状态               $    $       $    $  ANS000.BYTE004  $  if(x1&0x08) y=@0000;else y=@0001;
  $  003:加速加浓状态               $    $       $    $  ANS000.BYTE004  $  if(x1&0x10) y=@0000;else y=@0001;

  $)  03.排放控制
  $  03.排放控制
  $  REQ000:7E0 03 22 01 EA 00 00 00 00       $  ANS000:7E8 03 22 01 EA 00 00 00 00

  $  000:空燃比控制作用           $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0000;else y=@0001;
  $  001:碳罐控制阀控制作用       $    $       $    $  ANS000.BYTE004  $  if(x1&0x04) y=@0000;else y=@0001;
  $  002:减速断油作用             $    $       $    $  ANS000.BYTE004  $  if(x1&0x08) y=@0000;else y=@0001;
  $  003:加速加浓作用             $    $       $    $  ANS000.BYTE004  $  if(x1&0x10) y=@0000;else y=@0001;
  $  004:混合气自学习作用         $    $       $    $  ANS000.BYTE004  $  if(x1&0x20) y=@0000;else y=@0001;

  $)  04.氧传感器
  $  04.氧传感器
  $  REQ000:7E0 03 22 01 EB 00 00 00 00       $  ANS000:7E8 03 22 01 EB 00 00 00 00

  $  000:前氧信号浓状态       $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0000;else y=@0001;
  $  001:前氧信号稀状态       $    $       $    $  ANS000.BYTE004  $  if(x1&0x02) y=@0000;else y=@0001;
  $  002:前氧加热起作用       $    $       $    $  ANS000.BYTE004  $  if(x1&0x10) y=@0000;else y=@0001;
  $  003:后氧加热起作用       $    $       $    $  ANS000.BYTE004  $  if(x1&0x20) y=@0000;else y=@0001;

  $)  05.怠速控制
  $  05.怠速控制
  $  REQ000:7E0 03 22 01 EC 00 00 00 00       $  ANS000:7E8 03 22 01 EC 00 00 00 00

  $  000:怠速状态                  $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0000;else y=@0001;
  $  001:电子负载1(转向助力)       $    $       $    $  ANS000.BYTE004  $  if(x1&0x02) y=@0000;else y=@0001;
  $  002:电子负载2(鼓风机)         $    $       $    $  ANS000.BYTE004  $  if(x1&0x04) y=@0000;else y=@0001;

  $)  06.SVS/MIL灯
  $  06.SVS/MIL灯
  $  REQ000:7E0 03 22 01 ED 00 00 00 00       $  ANS000:7E8 03 22 01 ED 00 00 00 00

  $  000:MIL(故障指示灯)常亮           $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0000;else y=@0001;
  $  001:MIL(故障指示灯)闪亮           $    $       $    $  ANS000.BYTE004  $  if(x1&0x02) y=@0000;else y=@0001;
  $  002:SVS(系统维修指示灯)亮         $    $       $    $  ANS000.BYTE004  $  if(x1&0x10) y=@0000;else y=@0001;
  $  003:SVS(系统维修指示灯)闪亮       $    $       $    $  ANS000.BYTE004  $  if(x1&0x20) y=@0000;else y=@0001;
  $  004:SVS(系统维修指示灯)故障       $    $       $    $  ANS000.BYTE004  $  if(x1&0x40) y=@0000;else y=@0001;

  $)  07.发动机紧急状态
  $  07.发动机紧急状态
  $  REQ000:7E0 03 22 01 EE 00 00 00 00       $  ANS000:7E8 03 22 01 EE 00 00 00 00

  $  000:节气门体位置错误或未知       $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0000;else y=@0001;

  $)  08.空调状态
  $  08.空调状态
  $  REQ000:7E0 03 22 01 EF 00 00 00 00       $  ANS000:7E8 03 22 01 EF 00 00 00 00

  $  000:压缩机工作                   $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0000;else y=@0001;
  $  001:压缩机工作请求               $    $       $    $  ANS000.BYTE004  $  if(x1&0x02) y=@0000;else y=@0001;
  $  002:压缩机提升怠速转速请求       $    $       $    $  ANS000.BYTE004  $  if(x1&0x20) y=@0000;else y=@0001;
  $  003:大负荷时压缩机关闭           $    $       $    $  ANS000.BYTE004  $  if(x1&0x40) y=@0000;else y=@0001;
  $  004:压缩机压力开关状态           $    $       $    $  ANS000.BYTE004  $  if(x1&0x80) y=@0000;else y=@0001;
  ...
  $  000:自动变速器离合器结合       $    $       $    $  ANS000.BYTE004  $  if(x1&0x08) y=@0000;else y=@0001;
  $  001:油泵激活请求               $    $       $    $  ANS001.BYTE004  $  if(x1==0) y=@0005;else if(x1==1) y=@0004;else y=@0076;
  $  002:风扇1                      $    $       $    $  ANS002.BYTE004  $  if(x1==0) y=@0005;else if(x1==1) y=@0004;else y=@0076;
  $  003:风扇2                      $    $       $    $  ANS003.BYTE004  $  if(x1==0) y=@0005;else if(x1==1) y=@0004;else y=@0076;
