...
读数据流: 
  ...
  $  000:电机运行状态       $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@00d3;0x01: y=@00d4;default: y=@001c;
  ...
  $  006:控制器电压         $    $  V            $    $  ANS006.BYTE004  $  if((x1>=0)&&(x1<=50)) y=x1;else y=@001c;
  ...
  $  015:OK灯信号           $    $               $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@00d3;0x01: y=@00d4;default: y=@001c;
