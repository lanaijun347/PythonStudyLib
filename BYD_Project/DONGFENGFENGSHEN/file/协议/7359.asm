...
版本信息:
  ...
  $%  REQ000:761 03 22 F1 90 00 00 00 00       $%  ANS000:769 03 22 F1 90 00 00 00 00
  $%  REQ001:761 03 22 F1 97 00 00 00 00       $%  ANS001:769 03 22 F1 97 00 00 00 00
  $%  REQ002:761 03 22 F1 89 00 00 00 00       $%  ANS002:769 03 22 F1 89 00 00 00 00
  $%  REQ003:761 03 22 F1 79 00 00 00 00       $%  ANS003:769 03 22 F1 79 00 00 00 00
  $%  REQ004:761 03 22 F1 8A 00 00 00 00       $%  ANS004:769 03 22 F1 8A 00 00 00 00
  $%  REQ005:761 03 22 F1 93 00 00 00 00       $%  ANS005:769 03 22 F1 93 00 00 00 00
  $%  REQ006:761 03 22 F1 95 00 00 00 00       $%  ANS006:769 03 22 F1 95 00 00 00 00
  $%  REQ007:761 03 22 F1 87 00 00 00 00       $%  ANS007:769 03 22 F1 87 00 00 00 00
  $%  REQ008:761 03 22 F1 8C 00 00 00 00       $%  ANS008:769 03 22 F1 8C 00 00 00 00
  $%  REQ009:761 03 22 F1 99 00 00 00 00       $%  ANS009:769 03 22 F1 99 00 00 00 00
  ...
  $%  005:ECU硬件版本号(SYS):       $%    $%  ANS005.BYTE004  $%  y=SPRINTF([V%X.%X.%02X],x1,x2,x3);
  $%  006:ECU软件版本号(SYS):       $%    $%  ANS006.BYTE004  $%  y=SPRINTF([V%X.%X.%02X],x1,x2,x3);
  $%  007:零件号(OEM):              $%    $%  ANS007.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14);
  $%  008:生产序列号:               $%    $%  ANS008.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
...
读数据流: 
  ...
  $  004.车型                         $    $       $    $  ANS000.BYTE005  $  if((x&0x1F)==0x00)y=@00c9;else if((x&0x1F)==0x01)y=@00ca;else if((x&0x1F)==0x02)y=@00cb;else if((x&0x1F)==0x03)y=@00f2;else if((x&0x1F)==0x04)y=@00cd;else if((x&0x1F)==0x05)y=@00ce;else if((x&0x1F)==0x06)y=@00f3;else y=@000a;
  ...
  $  018.FCW前向碰撞预警软开关        $    $       $    $  ANS000.BYTE008  $  if(((x>>0)&1))y=@00c2;else y=@00c3;
  ...
  $  022.座椅记忆                     $    $       $    $  ANS000.BYTE010  $  if(((x>>7)&1))y=@00c2;else y=@00c3;
  $  023.座椅加热(界面控制)           $    $       $    $  ANS000.BYTE010  $  if(((x>>6)&1))y=@00c2;else y=@00c3;
  $  024.座椅通风                     $    $       $    $  ANS000.BYTE010  $  if((x&0x30)==0x00)y=@00c3;else if((x&0x30)==0x10)y=@00f5;else y=@000a;
  $  025.座椅迎宾                     $    $       $    $  ANS000.BYTE010  $  if(((x>>1)&1))y=@00c2;else y=@00c3;
