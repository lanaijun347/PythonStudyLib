...
读数据流: 
  ...
  $  REQ002:760 03 22 FD 8D 00 00 00 00       $  ANS002:768 03 22 FD 8D 00 00 00 00
  $  REQ003:760 03 22 F0 12 00 00 00 00       $  ANS003:768 03 22 F0 12 00 00 00 00

  $  000.电池SOC(充电状态)       $    $  %        $    $  ANS000.BYTE004  $  y=x;
  $  001.车速                    $    $  km/h     $    $  ANS001.BYTE004  $  y=(256*x1+x2)*0.01;
  $  002.续航里程                $    $  Km       $    $  ANS002.BYTE004  $  y=(256*x1+x2)*0.1;
  $  003.蓄电池电压              $    $  V        $    $  ANS003.BYTE004  $  y=x1*0.1;
