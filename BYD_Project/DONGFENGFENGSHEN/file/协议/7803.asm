...
版本信息:
  ...
  $%  000:诊断会话类型:          $%    $%  ANS000.BYTE004  $%  if(x==0x01)y=@0107;else if(x==0x03)y=@0108;else y=@004e;
  $%  001:ECU硬件号:             $%    $%  ANS001.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14);
  $%  002:VIN(车辆识别码):       $%    $%  ANS002.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
  $%  003:软件版本编号:          $%    $%  ANS003.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8);
...
读数据流: 
  ...
  $  001.制动灯开关       $    $        $    $  ANS000.BYTE005  $  if(x==0x00)y=@0105;else if(x==0x01) y=@0106;else y=@004e;

  $)  02.激活状态
  $  02.激活状态
  $  REQ000:7C2 03 22 FD 02 00 00 00 00       $  ANS000:7CA 03 22 FD 02 00 00 00 00

  $  000.阀门继电器状态                                            $    $       $    $  ANS000.BYTE004  $  if(x==0x00)y=@0105;else if(x==0x01) y=@0106;else y=@004e;
  $  001.泵马达状态                                                $    $       $    $  ANS000.BYTE005  $  if(x==0x00)y=@0105;else if(x==0x01) y=@0106;else y=@004e;
