...
读数据流: 
  ...
  $  013.阀门HSV2(仅ESP)                $    $            $    $  ANS002.BYTE007  $  if((x&0x08)==0x08)y=@00b2;else y=@00b1;
  $  014.阀门HSV1(仅ESP)                $    $            $    $  ANS002.BYTE007  $  if((x&0x04)==0x04)y=@00b2;else y=@00b1;
  $  015.阀门USV2(仅ESP)                $    $            $    $  ANS002.BYTE007  $  if((x&0x02)==0x02)y=@00b2;else y=@00b1;
  $  016.阀门USV1(仅ESP)                $    $            $    $  ANS002.BYTE007  $  if((x&0x01)==0x01)y=@00b2;else y=@00b1;
  $  017.下线状态                       $    $            $    $  ANS003.BYTE004  $  if(x==0x00)y=@047e;else if(x==0xAA)y=@047f;else if(x==0xEE)y=@0480;else y=@0035;
  ...
  $  029.变量数据(用于柴油发动机)       $    $            $    $  ANS000.BYTE004  $  if(x==0x01)y=@003a;else if(x==0x02)y=@003b;else y=@01a9;
  $  030.变量数据(用于汽油发动机)       $    $            $    $  ANS007.BYTE004  $  if(x==0x01)y=@047c;else if(x==0x02)y=@047d;else y=@01a9;
