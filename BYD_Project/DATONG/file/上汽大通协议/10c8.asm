...
版本信息:
  ...
  $%  011:供应商电控单元产线号:            $%    $%  ANS008.BYTE009  $%  ASCII(X1,X2);
  ...
  $%  015:系统供应商识别号:                $%    $%  ANS010.BYTE004  $%  y=SPRINTF([%c%02X%02X%02X%02X%02X],X1,X2,X3,X4,X5,X6);
...
读数据流: 
  ...
  $  000.LED状态          $    $           $    $  ANS000.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@1079;else if(x==2) y=@107a;else y=@0004;
  $  001.方向盘角度       $    $           $    $  ANS001.BYTE004  $  y=(x1*256+x2)*0.0625-2048;
  $  002.方向盘扭矩       $    $  Nm       $    $  ANS002.BYTE004  $  y=(x1*256+x2)*0.00097-32;
