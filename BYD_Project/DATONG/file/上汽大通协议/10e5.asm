...
读数据流: 
  ...
  $  REQ007:729 03 22 58 20 00 00 00 00       $  ANS007:7A9 03 22 58 20 00 00 00 00
  $  REQ008:729 03 22 58 12 00 00 00 00       $  ANS008:7A9 03 22 58 12 00 00 00 00
  $  REQ009:729 03 22 C0 01 00 00 00 00       $  ANS009:7A9 03 22 C0 01 00 00 00 00
  $  REQ010:729 03 22 C0 04 00 00 00 00       $  ANS010:7A9 03 22 C0 04 00 00 00 00
  $  REQ011:729 03 22 58 10 00 00 00 00       $  ANS011:7A9 03 22 58 10 00 00 00 00
  $  REQ012:729 03 22 58 13 00 00 00 00       $  ANS012:7A9 03 22 58 13 00 00 00 00
  $  REQ013:729 03 22 58 14 00 00 00 00       $  ANS013:7A9 03 22 58 14 00 00 00 00

  $  000.电池电压              $    $  V     $    $  ANS000.BYTE004  $  y=(x1*256+x2);
  $  001.D挡指示器状态         $    $        $    $  ANS001.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@0028;else y=@0035;
  $  002.M-挡指示器状态        $    $        $    $  ANS002.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@0028;else y=@0035;
  $  003.M+挡指示器状态        $    $        $    $  ANS003.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@0028;else y=@0035;
  $  004.电机状态              $    $        $    $  ANS004.BYTE004  $  if(x==0) y=@104e;else if(x==1) y=@104f;else if(x==2) y=@105b;else y=@0035;
  $  005.N挡指示器状态         $    $        $    $  ANS005.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@0028;else y=@0035;
  $  006.P挡指示器状态         $    $        $    $  ANS006.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@0028;else y=@0035;
  $  007.方向盘拨片配置        $    $        $    $  ANS007.BYTE004  $  if(x==255) y=@105c;else if(x==85) y=@105d;else y=@0035;
  $  008.停车按钮状态          $    $        $    $  ANS008.BYTE004  $  if(x==0) y=@0119;else if(x==1) y=@1050;else if(x==2) y=@01db;else y=@0035;
  $  009.R挡指示器状态         $    $        $    $  ANS009.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@0028;else y=@0035;
  $  010.S/M挡指示器状态       $    $        $    $  ANS010.BYTE004  $  if(x==0) y=@000f;else if(x==1) y=@0028;else y=@0035;
  $  011.挡把位置              $    $        $    $  ANS011.BYTE004  $  if(x==0) y=@1051;else if(x==1) y=@1052;else if(x==2) y=@1053;else if(x==3) y=@1054;else if(x==4) y=@1055;else if(x==5) y=@1056;else if(x==6) y=@1057;else if(x==7) y=@1058;else if(x==8) y=@0119;else y=@0035;
  $  012.解锁按钮状态          $    $        $    $  ANS012.BYTE004  $  if(x==0) y=@0119;else if(x==1) y=@1050;else if(x==2) y=@01db;else y=@0035;
  $  013.报警状态              $    $        $    $  ANS013.BYTE004  $  if(x==0) y=@1059;else if(x==1) y=@105a;else y=@0035;
