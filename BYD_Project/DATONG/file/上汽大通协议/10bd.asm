...
读数据流: 
  ...
  $  004.DCDC故障标志                 $    $        $    $  ANS001.BYTE009  $  if(x==0) y=@02ac;else if(x==1) y=@0601;else if(x==2) y=@0602;else if(x==3) y=@0603;else y=@0103;
  $  005.发动机状态                   $    $        $    $  ANS002.BYTE004  $  if(x==0) y=@0036;else if(x==1) y=@016e;else if(x==2) y=@0011;else y=@0103;
  $  006.发动机状态有效性             $    $        $    $  ANS002.BYTE005  $  if(x==0) y=@00bb;else if(x==1) y=@01df;else y=@0103;
  $  007.启动停止发动机状态           $    $        $    $  ANS002.BYTE006  $  if(x==0) y=@0019;else if(x==1) y=@088c;else if(x==2) y=@088d;else if(x==3) y=@0ac5;else if(x==4) y=@0e4e;else if(x==5) y=@007a;else if(x==6) y=@0035;else if(x==7) y=@042f;else y=@0103;
  $  008.启动停止引擎状态有效性       $    $        $    $  ANS002.BYTE007  $  if(x==0) y=@00bb;else if(x==1) y=@01df;else y=@0103;
  $  009.系统电源模式                 $    $        $    $  ANS002.BYTE008  $  if(x==0) y=@000f;else if(x==1) y=@0010;else if(x==2) y=@0011;else if(x==3) y=@0e4f;else y=@0103;
  $  010.系统电源模式有效性           $    $        $    $  ANS002.BYTE009  $  if(x==0) y=@01df;else if(x==1) y=@088e;else if(x==2) y=@088f;else y=@0103;
