...
版本信息:
  ...
  $%  REQ012:786 03 22 F1 A2 FF FF FF FF       $%  ANS012:796 03 22 F1 A2 FF FF FF FF
  $%  REQ013:786 03 22 F1 9D FF FF FF FF       $%  ANS013:796 03 22 F1 9D FF FF FF FF
  $%  REQ014:786 03 22 F1 BF FF FF FF FF       $%  ANS014:796 03 22 F1 BF FF FF FF FF
  $%  REQ015:786 03 22 F1 C0 FF FF FF FF       $%  ANS015:796 03 22 F1 C0 FF FF FF FF
  ...
  $%  012:ECU标定软件号:                     $%    $%  ANS012.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5,x6,x7,x8);
