...
版本信息:
  ...
  $%  005:ECU装配日期:           $%    $%  ANS005.BYTE004  $%  y=HEX(x1,x2,x3,x4);
...
;  $  000.制动开关状态/常闭       $    $       $    $  ANS000.BYTE004  $  switxh(x&0x40) 0x40:y=@0151;default: y=@0007;
;  $  001.制动开关状态/常开       $    $       $    $  ANS000.BYTE004  $  switxh(x&0x80) 0x80:y=@0151;default: y=@0007;
