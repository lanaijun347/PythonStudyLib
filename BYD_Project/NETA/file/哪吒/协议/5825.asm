...
版本信息:
  ...
  $%  015:电机编码:                          $%    $%  ANS015.BYTE004  $%  y=ASCII(x1);
...
读数据流: 
  ...
  $  003.档位信号               $    $               $    $  ANS003.BYTE004  $  switxh(x) 0x00:y=@0201;0x01:y=@0202;0x02:y=@0203;default: y=@0007;
  ...
  $  006.实际工作模式           $    $               $    $  ANS006.BYTE004  $  switxh(x) 0x00:y=@0113;0x01:y=@0042;0x02:y=@0114;0x03:y=@0115;default: y=@0007;
