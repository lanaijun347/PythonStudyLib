...
版本信息:
  ...
  $%  002:零部件号:                                                    $%    $%  ANS002.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13);
  ...
  $%  009:硬件版本号（内部升级版本）:                                  $%    $%  ANS009.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5);
  $%  010:硬件件版本号（固定版本）:                                    $%    $%  ANS010.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5);
  $%  011:Supplier ECU Hardware Number（供应商内部自定义使用）:        $%    $%  ANS011.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5);
  $%  012:Supplier ECU Software Number（供应商内部自定义使用）:        $%    $%  ANS012.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16);
  $%  013:TesterSerialNumberDataIdentifier:                            $%    $%  ANS013.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10);
  $%  014:刷新日期:                                                    $%    $%  ANS014.BYTE004  $%  y=HEX(x1,x2,x3,x4);
  $%  015:ECU装配日期:                                                 $%    $%  ANS015.BYTE004  $%  y=HEX(x1,x2,x3,x4);
  $%  016:BatteryPackIndentifier（24位国标码）:                        $%    $%  ANS016.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24);
  $%  017:软件总成版本:                                                $%    $%  ANS017.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5,x6,x7,x8);
  $%  018:软件零件总成号:                                              $%    $%  ANS018.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13);
...
读数据流: 
  ...
  $  016.电池组电池单体最高电压                                                                                   $    $  mV           $    $  ANS016.BYTE004  $  y=x;
  $  017.电池组电池单体最低电压                                                                                   $    $  mV           $    $  ANS017.BYTE004  $  y=x;
  ...
  $  040.电池温升过快故障                                                                                         $    $               $    $  ANS040.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  041.电池高温报警                                                                                             $    $               $    $  ANS041.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  042.电池低温报警                                                                                             $    $               $    $  ANS042.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  043.单体电池过压报警                                                                                         $    $               $    $  ANS043.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  044.单体电池欠压报警                                                                                         $    $               $    $  ANS044.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  045.电池总电压过高报警                                                                                       $    $               $    $  ANS045.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  046.总电压低压报警                                                                                           $    $               $    $  ANS046.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  047.SOC低报警                                                                                                $    $               $    $  ANS047.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  048.总电流过流报警                                                                                           $    $               $    $  ANS048.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  049.绝缘故障                                                                                                 $    $               $    $  ANS049.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  050.温度差异报警                                                                                             $    $               $    $  ANS050.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  051.动力电池系统故障                                                                                         $    $               $    $  ANS051.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  052.单体一致性差报警                                                                                         $    $               $    $  ANS052.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault(10mv);0x02:y=Level 2 Fault(30mv);0x03:y=Level 3 Fault(50mv);default: y=@0007;
  $  053.热扩散报警                                                                                               $    $               $    $  ANS053.BYTE004  $  switxh(x) 0x00:y=No Fault;0x01:y=Level 1 Fault;0x02:y=Level 2 Fault;0x03:y=Level 3 Fault;default: y=@0007;
  $  054.慢充CP信号（0-100）                                                                                      $    $  %            $    $  ANS054.BYTE004  $  y=x;
  $  055.CP 连接信号                                                                                              $    $               $    $  ANS055.BYTE004  $  switxh(x&0x01) 0x01:y=CPSig Connect;default: y=CPSig Not Connect;
  $  056.电池充电状态                                                                                             $    $               $    $  ANS056.BYTE004  $  switxh(x) 0x00:y=Normal;0x01:y=Slow Charging;0x02:y=Fast Charging;0x03:y=Charge Achieved;0x04:y=Chager Fault;0x05:y=Heating;0x06:y=Charging While Heating;0x07:y=Not Ready;default: y=@0007;
  $  057.慢速充电最大允许交流电流                                                                                 $    $  A            $    $  ANS057.BYTE004  $  y=(x1*256+x2)*0.05-1600;
  $  058.动力电池总成单体总数                                                                                     $    $               $    $  ANS058.BYTE004  $  y=x;
  $  059.动力电池温度传感器总数                                                                                   $    $               $    $  ANS059.BYTE004  $  y=x;
  $  060.交流充电完成剩余时间                                                                                     $    $  min          $    $  ANS060.BYTE004  $  y=x1*256+x2;
  $  061.快充桩输出电压                                                                                           $    $  V            $    $  ANS061.BYTE004  $  y=(x1*256+x2)*0.05;
  $  062.快充桩输出电流                                                                                           $    $  A            $    $  ANS062.BYTE004  $  y=(x1*256+x2)*0.05-1600;
  $  063.快充CC                                                                                                   $    $               $    $  ANS063.BYTE004  $  switxh(x&0x01) 0x01:y=connect;default: y=Disconnect;
  $  064.直流充电完成剩余时间                                                                                     $    $  min          $    $  ANS064.BYTE004  $  y=x1*256+x2;
  $  065.禁止输出                                                                                                 $    $               $    $  ANS065.BYTE004  $  y=(x1*256+x2)*0.05;
  $  066.BMS请求的电压                                                                                            $    $  V            $    $  ANS066.BYTE004  $  y=(x1*256+x2)*0.05;
  $  067.BMS充电完成时间(BMS充电完成时间,VIT收到此信息后通过远程服务器将充电完成时间传送回手机，提醒驾驶员)       $    $  min          $    $  ANS067.BYTE004  $  y=x1*256+x2;
  $  068.充电机状态                                                                                               $    $               $    $  ANS068.BYTE004  $  switxh(x&0x07) 0x00:y=start up;0x01:y=Ready;0x02:y=Charging;0x03:y=ChargeAchieve;0x04:y=ChagerFault;0x05:y=Heating;0x06:y=Inverting;0x07:y=Sleeping;default: y=@0007;
  $  069.充电机输出电流                                                                                           $    $  A            $    $  ANS069.BYTE004  $  y=(x1*256+x2)*0.05;
  $  070.充电机输出电压                                                                                           $    $  V            $    $  ANS070.BYTE004  $  y=(x1*256+x2)*0.05;
  $  071.充电机当前可输出的最大功率                                                                               $    $  KW           $    $  ANS071.BYTE004  $  y=(x1*256+x2)*0.005;
  $  072.OBC反馈交流电网电压                                                                                      $    $  V            $    $  ANS072.BYTE004  $  y=(x1*256+x2)*0.01;
  $  073.OBC反馈交流电网电流                                                                                      $    $  A            $    $  ANS073.BYTE004  $  y=(x1*256+x2)*0.1;
  $  074.OBC降功率状态                                                                                            $    $               $    $  ANS074.BYTE004  $  switxh(x) 0x00:y=Inactive;0x01:y=Active;default: y=@0007;
  $  075.V2L使能                                                                                                  $    $               $    $  ANS075.BYTE004  $  y=x;
  $  076.V2L功率限制                                                                                              $    $  W            $    $  ANS076.BYTE004  $  y=(x1*256+x2)*5;
  $  077.远程充电控制                                                                                             $    $               $    $  ANS077.BYTE004  $  switxh(x) 0x00:y=No request;0x01:y=Stop;0x02:y=Start;default: y=@0007;
  $  078.预约充电使能                                                                                             $    $               $    $  ANS078.BYTE004  $  switxh(x) 0x00:y=Disable;0x01:y=Enable;default: y=@0007;
  $  079.预约充电时间设置                                                                                         $    $               $    $  ANS079.BYTE004  $  y=x*10;
  $  080.车速                                                                                                     $    $  km/h         $    $  ANS080.BYTE004  $  y=(x1*256+x2)*0.03125;
  $  081.车速有效                                                                                                 $    $               $    $  ANS081.BYTE004  $  switxh(x) 0x00:y=Invalid;0x01:y=Valid;default: y=@0007;
  $  082.绝缘电阻值                                                                                               $    $  ΚΩ         $    $  ANS082.BYTE004  $  y=x1*256+x2;
  $  083.快充口负端温度                                                                                           $    $  degree C     $    $  ANS083.BYTE004  $  y=x1*256+x2-40;
  $  084.快充口正端温度                                                                                           $    $  degree C     $    $  ANS084.BYTE004  $  y=x1*256+x2-40;
  $  085.交流慢充口负端温度                                                                                       $    $  degree C     $    $  ANS085.BYTE004  $  y=x1*256+x2-40;
  $  086.交流慢充口正端温度                                                                                       $    $  degree C     $    $  ANS086.BYTE004  $  y=x1*256+x2-40;
  $  087.低压蓄电池电压值                                                                                         $    $  V            $    $  ANS087.BYTE004  $  y=(x1*256+x2)*0.05;
  $  088.V2L功率请求                                                                                              $    $  W            $    $  ANS088.BYTE004  $  y=(x1*256+x2)*5;
  $  089.慢充停止原因                                                                                             $    $               $    $  ANS089.BYTE004  $  y=x;
  $  090.快充停止原因                                                                                             $    $               $    $  ANS090.BYTE004  $  y=x;
  $  091.无法上高压原因                                                                                           $    $               $    $  ANS091.BYTE004  $  y=(x1*256+x2)*65536+x3*256+x4;
  $  092.BMS内部最严重故障号                                                                                      $    $               $    $  ANS092.BYTE004  $  y=x1*256+x2;
  $  093.仪表显示总计里程                                                                                         $    $  km           $    $  ANS093.BYTE004  $  y=x*6553.6+(x2*256+x3)*0.1;
  $  094.脉冲功率                                                                                                 $    $  W            $    $  ANS094.BYTE004  $  y=(x1*256+x2)*5;
  $  095.真实SOC                                                                                                  $    $  %            $    $  ANS095.BYTE004  $  y=(x1*256+x2)*0.01;
  $  096.累计充电总容量                                                                                           $    $  Ah           $    $  ANS096.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  097.累计充电总能量                                                                                           $    $  kwh          $    $  ANS097.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  098.累计放电总容量                                                                                           $    $  Ah           $    $  ANS098.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  099.累计放电总能量                                                                                           $    $  kwh          $    $  ANS099.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  100.累计回充总容量                                                                                           $    $  Ah           $    $  ANS100.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  101.累计回充总能量                                                                                           $    $  kwh          $    $  ANS101.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  102.动力电池总容量                                                                                           $    $  Ah           $    $  ANS102.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  103.动力电池剩余可用容量                                                                                     $    $  Ah           $    $  ANS103.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  104.动力电池可用容量                                                                                         $    $  Ah           $    $  ANS104.BYTE004  $  y=(x1*256+x2)*655.36+(x3*256+x4)*0.01;
  $  105.快充桩最高输出电压                                                                                       $    $  V            $    $  ANS105.BYTE004  $  y=x1*256+x2;
  $  106.快充桩最低输出电压                                                                                       $    $  V            $    $  ANS106.BYTE004  $  y=x1*256+x2;
  $  107.快充桩最大输出电流                                                                                       $    $  A            $    $  ANS107.BYTE004  $  y=x1*256+x2-400;
  $  108.快充桩最小输出电流                                                                                       $    $  A            $    $  ANS108.BYTE004  $  y=x1*256+x2-400;
  $  109.快充电压需求                                                                                             $    $  V            $    $  ANS109.BYTE004  $  y=x1*256+x2;
  $  110.快充充电模式                                                                                             $    $               $    $  ANS110.BYTE004  $  switxh(x) 0x00:y=ConstantVoltage;0x01:y=ConstantCurrent;default: y=@0007;
  $  111.快充电流需求                                                                                             $    $  A            $    $  ANS111.BYTE004  $  y=x1*256+x2-400;
