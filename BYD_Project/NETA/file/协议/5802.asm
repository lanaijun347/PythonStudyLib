...
读数据流: 
  ...
  $  001.主驾驶安全气囊             $    $          $    $  ANS001.BYTE006  $  switxh(x&0x01) 0x00:y=@0278;default: y=@0151;
  $  002.主驾驶座椅侧安全气囊       $    $          $    $  ANS001.BYTE006  $  switxh(x&0x02) 0x00:y=@0278;default: y=@0151;
  $  003.左侧帘式安全气囊           $    $          $    $  ANS001.BYTE006  $  switxh(x&0x04) 0x00:y=@0278;default: y=@0151;
  $  004.副驾驶安全气囊             $    $          $    $  ANS001.BYTE006  $  switxh(x&0x08) 0x00:y=@0278;default: y=@0151;
  $  005.副驾驶座椅侧安全气囊       $    $          $    $  ANS001.BYTE006  $  switxh(x&0x10) 0x00:y=@0278;default: y=@0151;
  $  006.右侧帘式安全气囊           $    $          $    $  ANS001.BYTE006  $  switxh(x&0x20) 0x00:y=@0278;default: y=@0151;
  $  007.电源电压                   $    $  V       $    $  ANS002.BYTE006  $  y=x*25/255+0.7;
  $  008.储能电压                   $    $  V       $    $  ANS002.BYTE007  $  y=x*25/255;
  $  009.点火具数目                 $    $          $    $  ANS002.BYTE008  $  y=x;
  $  010.点火具1电阻值              $    $  ohm     $    $  ANS002.BYTE009  $  y=x/10;
  $  011.点火具2电阻值              $    $  ohm     $    $  ANS002.BYTE010  $  y=x/10;
  $  012.点火具3电阻值              $    $  ohm     $    $  ANS002.BYTE011  $  y=x/10;
  $  013.点火具4电阻值              $    $  ohm     $    $  ANS002.BYTE012  $  y=x/10;
  $  014.点火具5电阻值              $    $  ohm     $    $  ANS002.BYTE013  $  y=x/10;
  $  015.点火具6电阻值              $    $  ohm     $    $  ANS002.BYTE014  $  y=x/10;
  $  016.点火具7电阻值              $    $  ohm     $    $  ANS002.BYTE015  $  y=x/10;
