...
版本信息:
  ...
  $%  REQ013:7E2 03 22 F1 70 FF FF FF FF       $%  ANS013:7EA 03 22 F1 70 FF FF FF FF
  $%  REQ014:7E2 03 22 F1 C0 FF FF FF FF       $%  ANS014:7EA 03 22 F1 C0 FF FF FF FF
  $%  REQ015:7E2 03 22 F1 BF FF FF FF FF       $%  ANS015:7EA 03 22 F1 BF FF FF FF FF
  $%  REQ016:7E2 03 22 F1 7F FF FF FF FF       $%  ANS016:7EA 03 22 F1 7F FF FF FF FF
  ...
  $%  015:硬件版本号:                        $%    $%  ANS015.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5);
  $%  016:软件总成版本:                      $%    $%  ANS014.BYTE004  $%  y=ASCII(x1,x2,x3,x4,x5,x6,x7,x8);
  $%  017:转毂模式:                          $%    $%  ANS016.BYTE004  $%  switxh(x) 0x00:y=@0182;0x01:y=@0404;default: y=@0007;
...
读数据流: 
  ...
  $  010.VCU环路互锁信号故障等级                                 $    $           $    $  ANS004.BYTE004  $  switxh(x&0xC0) 0x00:y=@0000;0x40:y=@0233;0x80:y=@0395;0xC0:y=@0234;default: y=;
  ...
  $  026.充电唤醒信号                                            $    $           $    $  ANS011.BYTE004  $  switxh(x&0x10) 0x00:y=@0330;default: y=@0426;
  ...
  $  048.续航里程                                                $    $  km       $    $  ANS018.BYTE004  $  y=(x1*256+x2)*0.1;
