...
读数据流: 
  ...
  $  000.车道系统开关状态-0       $    $       $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@001e;0x01: y=@001d;default: y=@0001;
  $  001.车道故障状态-0           $    $       $    $  ANS000.BYTE005  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  $  002.当前车速-0               $    $       $    $  ANS000.BYTE006  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  $  003.车速阀值-0               $    $       $    $  ANS000.BYTE007  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  $  004.当前报警状态-0           $    $       $    $  ANS000.BYTE008  $  switxh(x1)0x00: y=@0981;0x01: y=@0982;0x02: y=@0983;default: y=@0001;
  $  005.Flash状态-0              $    $       $    $  ANS000.BYTE009  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  ...
  $  011.车道系统开关状态         $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@001e;0x01: y=@001d;default: y=@0001;
  $  012.车道故障状态             $    $       $    $  ANS001.BYTE005  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  $  013.当前车速                 $    $       $    $  ANS001.BYTE006  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  $  014.车速阀值                 $    $       $    $  ANS001.BYTE007  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  $  015.当前报警状态             $    $       $    $  ANS001.BYTE008  $  switxh(x1)0x00: y=@0981;0x01: y=@0982;0x02: y=@0983;default: y=@0001;
  $  016.Flash状态                $    $       $    $  ANS001.BYTE009  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  $  017.温度高字节               $    $       $    $  ANS001.BYTE010  $  y=(x1<<8)+x2;
  $  018.匹配失败原因             $    $       $    $  ANS002.BYTE004  $  switxh(x1)0x03: y=@097e;0x04: y=@097f;0x05: y=@0980;default: y=@0078;
  $  019.左侧识别阈值             $    $       $    $  ANS002.BYTE005  $  y=(x1<<8)+x2;
  $  020.右侧识别阈值             $    $       $    $  ANS002.BYTE007  $  y=(x1<<8)+x2;
  $  021.天空值                   $    $       $    $  ANS002.BYTE009  $  y=(x1<<8)+x2;
  $  022.左转向灯状态             $    $       $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0984;0x01: y=@0985;default: y=@0001;
  $  023.右转向灯状态             $    $       $    $  ANS003.BYTE005  $  switxh(x1)0x00: y=@0984;0x01: y=@0985;default: y=@0001;
