...
读数据流: 
  ...
  $  010.车内插座放电状态                   $    $          $    $  ANS010.BYTE004  $  if(x1==0x00)y=@01c7;else if(x1==0x01)y=@0265;else if(x1==0x02)y=@0266;else if(x1==0x03)y=@0267;else if(x1==0x04)y=@0268;else if(x1==0x05)y=@007b;else if(x1==0x06)y=@007b;else if(x1==0x07)y=@007b;else y=@01c6;
  $  011.VTOL(车辆对用电设备)放电状态       $    $          $    $  ANS011.BYTE004  $  if(x1==0x00)y=@01c7;else if(x1==0x01)y=@0265;else if(x1==0x02)y=@0266;else if(x1==0x03)y=@0267;else if(x1==0x04)y=@0268;else if(x1==0x05)y=@007b;else if(x1==0x06)y=@007b;else if(x1==0x07)y=@007b;else y=@01c6;
  $  012.车载充电功率状态                   $    $          $    $  ANS012.BYTE004  $  if(x1==0x00)y=@03ce;else if(x1==0x01)y=@01d2;else if(x1==0x02)y=@01d1;else if(x1==0x03)y=@007b;else y=@01c6;
  $  013.交流外充设备故障状态               $    $          $    $  ANS013.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@01c6;
  $  014.交流外充接地状态                   $    $          $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else if(x1==0x02)y=@007b;else if(x1==0x03)y=@007b;else y=@01c6;
  ...
  $  018.交流互锁故障                       $    $          $    $  ANS018.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@01c6;
