...
读数据流: 
  ...
  $  010.左侧防夹条传感器信号           $    $        $    $  ANS010.BYTE004  $  if(x1&0x01) y=@001d;else y=@001e;
  $  011.右侧防夹条传感器信号           $    $        $    $  ANS011.BYTE004  $  if(x1&0x01) y=@001d;else y=@001e;
  $  012.吸合执行器动作信号             $    $        $    $  ANS012.BYTE004  $  switxh(x1&0x03)0x00: y=@0025;0x01: y=@0026;0x02: y=@001c;default: y=@0001;
  $  013.左侧主轴撑杆动作信号           $    $        $    $  ANS013.BYTE004  $  switxh(x1&0x03)0x00: y=@0025;0x01: y=@0026;0x02: y=@001c;default: y=@0001;
  $  014.右侧主轴撑杆动作信号           $    $        $    $  ANS014.BYTE004  $  switxh(x1&0x03)0x00: y=@0025;0x01: y=@0026;0x02: y=@001c;default: y=@0001;
  ...
  $  022.脚踢感应开关信号               $    $        $    $  ANS022.BYTE004  $  if(x1&0x01) y=@001d;else y=@001e;
