...
读数据流: 
  ...
  $  005.系统状态                            $    $           $    $  ANS005.BYTE004  $  switxh(x1)0x00: y=@024c;0x01: y=@024d;0x02: y=@024e;0x03: y=@024f;0x04: y=@0250;0x05: y=@0251;0x06: y=@0252;0x07: y=@0253;default: y=@0001;
  $  006.EPS(电动助力转向系统)报警           $    $           $    $  ANS006.BYTE004  $  switxh((x1*256+x2))0x00: y=@0248;0x01: y=@0249;0x02: y=@024a;0x03: y=@024b;default: y=@0001;
