...
读数据流: 
  ...
  $  001.后背门动作状态                    $    $        $    $  ANS001.BYTE004  $  if((x1&0x03) == 0x00) y = @001d;else if((x1&0x03) == 0x01) y = @001e;else if((x1&0x03) == 0x02) y = @001c;else if((x1&0x03) == 0x03) y = @0001;
  $  002.电源档位状态                      $    $        $    $  ANS002.BYTE004  $  if((x1&0x03) == 0x00) y = @0003;else if((x1&0x03) == 0x01) y = @0012;else if((x1&0x03) == 0x02) y = @0011;else if((x1&0x03) == 0x03) y = @0010;
  ...
  $  012.吸合执行器动作信号                $    $        $    $  ANS012.BYTE004  $  if((x1&0x03) == 0x00) y = @0025;else if((x1&0x03) == 0x01) y = @0026;else if((x1&0x03) == 0x02) y = @001c;else if((x1&0x03) == 0x03) y = @0001;
  $  013.左侧spindle(轴)撑杆动作信号       $    $        $    $  ANS013.BYTE004  $  if((x1&0x03) == 0x00) y = @0025;else if((x1&0x03) == 0x01) y = @0026;else if((x1&0x03) == 0x02) y = @001c;else if((x1&0x03) == 0x03) y = @0001;
  $  014.右侧spindle(轴)撑杆动作信号       $    $        $    $  ANS014.BYTE004  $  if((x1&0x03) == 0x00) y = @0025;else if((x1&0x03) == 0x01) y = @0026;else if((x1&0x03) == 0x02) y = @001c;else if((x1&0x03) == 0x03) y = @0001;
  $  015.电源电压                          $    $  V     $    $  ANS015.BYTE004  $  y = x1*19.9/255;
  $  016.后背门当前位置                    $    $        $    $  ANS016.BYTE004  $  if((x1*256+x2) < 3001) y=x1*256+x2;else y=@0001;
  $  017.后背门行程                        $    $        $    $  ANS017.BYTE004  $  if((x1*256+x2) < 3001) y=x1*256+x2;else y=@0001;
  $  018.左侧撑杆当前位置                  $    $        $    $  ANS018.BYTE004  $  if((x1*256+x2) < 3001) y=x1*256+x2;else y=@0001;
  $  019.左侧撑杆行程                      $    $        $    $  ANS019.BYTE004  $  if((x1*256+x2) < 3001) y=x1*256+x2;else y=@0001;
  $  020.右侧撑杆当前位置                  $    $        $    $  ANS020.BYTE004  $  if((x1*256+x2) < 3001) y=x1*256+x2;else y=@0001;
  $  021.右侧撑杆行程                      $    $        $    $  ANS021.BYTE004  $  if((x1*256+x2) < 3001) y=x1*256+x2;else y=@0001;
