...
读数据流: 
  ...
  $  005.蓝牙电话开开关状态             $    $       $    $  ANS000.BYTE004  $  if(x1&0x20) y=@002a;else y=@00e4;
  ...
  $  015.蓝牙电话开关状态               $    $       $    $  ANS000.BYTE005  $  if(x1&0x80) y=@002a;else y=@00e4;
  $  016.振动马达                       $    $       $    $  ANS001.BYTE004  $  if(x1==0) y=@0010;else if(x1==1) y=@0012;else y=@0001;
  $  017.静音                           $    $       $    $  ANS001.BYTE004  $  if(x1==0) y=@00e4;else if(x1==1) y=@002a;else y=@0001;
  $  018.定制键（预留）                 $    $       $    $  ANS001.BYTE004  $  if(x1==0) y=@00e4;else if(x1==1) y=@002a;else y=@0001;
  $  019.仪表返回                       $    $       $    $  ANS001.BYTE004  $  if(x1==0) y=@00e4;else if(x1==1) y=@002a;else y=@0001;
  $  020.挂电话/仪表返回/（预留）       $    $       $    $  ANS001.BYTE004  $  if(x1==0) y=@00e4;else if(x1==1) y=@002a;else y=@0001;
