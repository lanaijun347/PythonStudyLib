...
版本信息:
  ...
  $%  000:软件号:                  $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1,x2,x3);
  $%  001:软件号(年/月/日):        $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%d.%d.%d],x1,x2,x3);
  $%  002:硬件号:                  $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1,x2,x3);
  $%  003:硬件号(年/月/日):        $%    $%  ANS001.BYTE007  $%  y=SPRINTF([%d.%d.%d],x1,x2,x3);
...
读数据流: 
  ...
  $  005.钥匙序列                 $    $       $    $  ANS000.BYTE012  $  HEX(x1);
