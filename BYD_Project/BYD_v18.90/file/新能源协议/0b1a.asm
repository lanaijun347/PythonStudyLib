...
版本信息:
  ...
  $%  003:生产日期:                $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%d%s%d%s%d%s],x1,@0197,x2,@0198,x3,@0199);
  $%  004:车型:                    $%    $%  ANS002.BYTE004  $%  switxh(x1) 0x51:y=@0a97;0x52:y=@0358;0x53:y=@0607;0x54:y=@08da;0x55:y=@035b;default: y=@020c;
  $%  005:MCU:                     $%    $%  ANS003.BYTE004  $%  switxh(x1) 0x51:y=@0227;default: y=@020c;
  $%  006:压缩机产品序列号:        $%    $%  ANS004.BYTE004  $%  HEX(x1,x2,x3);
...
读数据流: 
  ...
  $  000.压缩机控制状态                                       $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@001c;else if(x1==0x01)y=@004e;else y=@0525;
  $  001.压缩机实际状态                                       $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@001c;else if(x1==0x01)y=@004e;else y=@0525;
  ...
  $  006.IPM(智能功率模块)/IGBT(绝缘栅双极型晶体管)温度       $    $  W            $    $  ANS006.BYTE004  $  y=x1*256+x2;
  $  007.压缩机壳体温度                                       $    $  degree C     $    $  ANS007.BYTE004  $  y=x1-100;
