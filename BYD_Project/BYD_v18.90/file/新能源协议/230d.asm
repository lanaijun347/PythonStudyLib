...
读数据流: 
  ...
  $  000.电机运行状态       $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0010;0x01: y=@0012;default: y=@0001;
  $  001.电机目标转速       $    $  rpm          $    $  ANS001.BYTE004  $  y=(x2<<8)+x1;
  $  002.电机实际转速       $    $  rpm          $    $  ANS002.BYTE004  $  y=(x2<<8)+x1;
  $  003.直流母线电压       $    $  V            $    $  ANS003.BYTE004  $  y=x1;
  $  004.交流侧电流         $    $  A            $    $  ANS004.BYTE004  $  y=x1;
  $  005.散热器温度         $    $  degree C     $    $  ANS005.BYTE004  $  y=x1;
  $  006.控制器电压         $    $  V            $    $  ANS006.BYTE004  $  if((x1>=0)&&(x1<=50)) y=x1;else y=@0001;
  $  007.A相最大电流        $    $  A            $    $  ANS007.BYTE004  $  y=(x2<<8)+x1;
  $  008.B相最大电流        $    $  A            $    $  ANS008.BYTE004  $  y=(x2<<8)+x1;
  $  009.故障信息           $    $               $    $  ANS009.BYTE004  $  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $  010.A相零漂            $    $               $    $  ANS010.BYTE004  $  y=(x2<<8)+x1;
  $  011.B相零漂            $    $               $    $  ANS011.BYTE004  $  y=(x2<<8)+x1;
  $  012.方向盘转速         $    $  °/s         $    $  ANS012.BYTE004  $  y=(x2<<8)+x1;
  $  013.方向盘转角         $    $  °           $    $  ANS013.BYTE004  $  y=((x2<<8)+x1)-800;
  $  014.车速               $    $  km/h         $    $  ANS014.BYTE004  $  y=x1;
  $  015.OK灯信号           $    $               $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@0010;0x01: y=@0012;default: y=@0001;
