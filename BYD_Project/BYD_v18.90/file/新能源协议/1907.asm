...
读数据流: 
  ...
  $  000.DC_2工作状态       $    $               $    $  ANS000.BYTE004  $  if(x1==0x01) y = @047f;else if(x1==0x02) y = @05fd;else y = @0001;
  $  001.DC_2故障状态       $    $               $    $  ANS001.BYTE004  $  if(x1 == 0x01) y = @0078;else if(x1 == 0x02) y = @0167;else y = @0001;
  $  002.输出断路故障       $    $               $    $  ANS002.BYTE004  $  if(x1==0x00) y = @007b;else if(x1==0x01) y = @0078;else if(x1==0x02) y = @05fc;else y = @0001;
