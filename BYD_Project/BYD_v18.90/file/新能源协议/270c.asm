...
进入命令:
  ...
  $~  REQ001:770 02 10 01 00 00 00 00 00       $~  ANS001:778 02 10 01 00 00 00 00 00
...
读数据流: 
  ...
  $  REQ004:770 03 22 00 05 00 00 00 00       $  ANS004:778 03 22 00 05 00 00 00 00
  $  REQ005:770 03 22 00 06 00 00 00 00       $  ANS005:778 03 22 00 06 00 00 00 00
  $  REQ006:770 03 22 00 07 00 00 00 00       $  ANS006:778 03 22 00 07 00 00 00 00

  $  000.左近光灯工作时长       $    $  小时     $    $  ANS000.BYTE004  $  y=(x2<<8)+x1;
  $  001.左远光灯工作时长       $    $  小时     $    $  ANS001.BYTE004  $  y=(x2<<8)+x1;
  $  002.左位置灯工作时长       $    $  小时     $    $  ANS002.BYTE004  $  y=(x2<<8)+x1;
  $  003.左昼行灯工作时长       $    $  小时     $    $  ANS003.BYTE004  $  y=(x2<<8)+x1;
  $  004.左角灯工作时长         $    $  小时     $    $  ANS004.BYTE004  $  y=(x2<<8)+x1;
  $  005.左前雾灯工作时长       $    $  小时     $    $  ANS005.BYTE004  $  y=(x2<<8)+x1;
  $  006.左转向灯工作时长       $    $  小时     $    $  ANS006.BYTE004  $  y=(x2<<8)+x1;

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:770 30 01 00 00 00 00 00 00  $FC 
