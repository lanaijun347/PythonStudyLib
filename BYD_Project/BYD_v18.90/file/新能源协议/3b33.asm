...
读数据流: 
  ...
  $  000.DC_1工作状态       $    $         $    $  ANS000.BYTE004  $  switxh(x1)0x01: y=@047f;0x02: y=@05fd;default: y=@0001;
  $  001.DC_1故障状态       $    $         $    $  ANS001.BYTE004  $  switxh(x1)0x01: y=@0078;0x02: y=@0167;default: y=@0001;
  $  002.输出断路故障       $    $         $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0602;0x02: y=@04bd;0x03: y=@04be;default: y=@0001;
  $  003.DC_1输出电流       $    $  A      $    $  ANS003.BYTE004  $  y=(x2*256+x1);
  $  004.DC_1输入电压       $    $  V      $    $  ANS004.BYTE004  $  y=(x2*256+x1);
  $  005.DC_1输出电压       $    $  V      $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],x1/10);
  $  006.DC_1温度           $    $  ℃     $    $  ANS006.BYTE004  $  y=SPRINTF([%d],x1-40);
