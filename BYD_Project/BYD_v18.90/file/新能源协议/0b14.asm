...
版本信息:
  ...
  $%  010:客户零部件编号:                   $%    $%  ANS007.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8);
...
读数据流: 
  ...
  $  024.EPB(电子驻车)变量配置       $    $           $    $  ANS005.BYTE004  $  if(x1==0xBB)y=@09e9;else if(x1==0xAA)y=@080e;else y=@0001;
  ...
  $  029.横向加速度                  $    $  m/s2     $    $  ANS007.BYTE010  $  y=x1*888.67/128+x2*6.92/255;
  $  030.纵向加速度                  $    $  m/s2     $    $  ANS007.BYTE012  $  if(x1>127)y=(x1-256)*888.67/128+x2*6.92/255;else y=x1*888.67/128+x2*6.92/255;
