...
读数据流: 
  ...
  $  020.前驱动电机零位标定状态                      $    $           $    $  ANS020.BYTE004  $  if(x1==0) y=@0157;else if(x1==1) y=@0221;else if(x1==2) y=@0222;else y=@0001;
  $  021.前驱动电机零位检验状态                      $    $           $    $  ANS021.BYTE004  $  if(x1==0) y=@021e;else if(x1==1) y=@021f;else if(x1==2) y=@0220;else if(x1==3) y=@0015;else y=@0001;
  $  022.电机编号                                    $    $           $    $  ANS022.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10);
  $  023.电机温度传感器故障                          $    $           $    $  ANS023.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@021c;else if(x1==2) y=@021d;else y=@0001;
  $  024.前驱A相结温温度                             $    $  ℃       $    $  ANS024.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  025.前驱B相结温温度                             $    $  ℃       $    $  ANS024.BYTE006  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  026.前驱C相结温温度                             $    $  ℃       $    $  ANS024.BYTE008  $  y=SPRINTF([%d],(x2*256+x1)-40);
