...
读数据流: 
  ...
  $  000.工作状态                           $    $          $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@01d9;0x01: y=@01da;0x02: y=@01db;0x03: y=@01dc;0x04: y=@007b;0x05: y=@050d;default: y=@01c6;
  $  001.故障状态                           $    $          $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@01d7;0x02: y=@01d8;default: y=@01c6;
  $  002.接地状态                           $    $          $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
  $  003.交流侧电压(LSB/MSB)                $    $  V       $    $  ANS003.BYTE004  $  y=(x2*256+x1);
  $  004.直流侧电压(LSB/MSB)                $    $  V       $    $  ANS004.BYTE004  $  y=(x2*256+x1);
  $  005.直流侧电流                         $    $  A       $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],x1*0.3-30);
  $  006.交流侧频率                         $    $  Hz      $    $  ANS006.BYTE004  $  y=x1;
  $  007.PWM(脉宽调制)波占空比              $    $  %       $    $  ANS007.BYTE004  $  y=x1;
  $  008.12V输出电流                        $    $  A       $    $  ANS008.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  009.12V输出电压                        $    $  V       $    $  ANS009.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  010.车内插座放电状态                   $    $          $    $  ANS010.BYTE004  $  switxh(x1)0x00: y=@01c7;0x01: y=@0265;0x02: y=@0266;0x03: y=@0267;0x04: y=@0268;default: y=@01c6;
  $  011.VTOL(车辆对用电设备)对电状态       $    $          $    $  ANS011.BYTE004  $  switxh(x1)0x00: y=@01c7;0x01: y=@0265;0x02: y=@0266;0x03: y=@0267;0x04: y=@0268;default: y=@01c6;
  $  012.车载充电功率状态                   $    $          $    $  ANS012.BYTE004  $  switxh(x1)0x00: y=@03ce;0x01: y=@01d2;0x02: y=@01d1;default: y=@01c6;
  $  013.交流外充设备故障状态               $    $          $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
  $  014.交流外充接地状态                   $    $          $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
  $  015.充电枪连接状态                     $    $          $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;0x02: y=@002a;default: y=@01c6;
  $  016.限功率放电状态                     $    $          $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@03cd;default: y=@01c6;
  $  017.应急充电是否允许                   $    $          $    $  ANS017.BYTE004  $  switxh(x1)0x00: y=@0196;0x01: y=@0195;default: y=@01c6;
  $  018.交流互锁故障                       $    $          $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@0001;
  $  019.本次累积充电量                     $    $  KWH     $    $  ANS019.BYTE004  $  y=SPRINTF([%.2f],(x2*256+x1)/500);
  $  020.交流侧功率                         $    $  W       $    $  ANS020.BYTE004  $  y=SPRINTF([%.1f],(x2*256+x1)/5);
