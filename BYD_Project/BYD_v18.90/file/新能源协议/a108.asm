...
读数据流: 
  ...
  $  001.送风模式                             $    $               $    $  ANS001.BYTE004  $  if(x1==0x01) y=@006e;else if(x1==0x02) y=@0455;else if(x1==0x03) y=@0070;else if(x1==0x04) y=@0456; else if(x1==0x05) y=@0072;else y=@006d;
  $  002.车外温度                             $    $  degree C     $    $  ANS002.BYTE004  $  if((x1<0xB2) && (x1>0x57)) y=x1-128;else y=@006d;
  $  003.车内温度                             $    $  degree C     $    $  ANS003.BYTE004  $  if(x1<0x5B) y=x1-40;else y=@006d;
  $  004.蒸发器温度                           $    $  degree C     $    $  ANS004.BYTE004  $  if(x1<0x28) y=x;else y=@006d;
  $  005.AC(空调控制器)请求状态               $    $               $    $  ANS005.BYTE004  $  if(x1==0x00) y=@003f;else if(x1==0x01) y=@0044;else y=@006d;
  $  006.AC(空调控制器)电机低压启动状态       $    $               $    $  ANS006.BYTE004  $  if(x1%0x10==0x00) y=@0454;else if(x1%0x10==0x01) y=@011a;else y=@006d;
  $  007.压缩机控制档位                       $    $               $    $  ANS007.BYTE004  $  if(x1<0x27) y=x1;else y=@006d;
  $  008.PTC(辅助加热)请求状态                $    $               $    $  ANS008.BYTE004  $  if(x1==0x00) y=@003f;else if(x1==0x01) y=@0044;else y=@006d;
  $  009.PTC(辅助加热)低压启动信号            $    $               $    $  ANS009.BYTE004  $  if(x1==0x00) y=@0454;else if(x1==0x01) y=@011a;else y=@006d;
  $  010.PTC(辅助加热)控制档位                $    $               $    $  ANS010.BYTE004  $  if(x1<0x15) y=x1;else y=@006d;
  $  011.PTC(辅助加热)温度                    $    $  degree C     $    $  ANS011.BYTE004  $  if(x1<0x50) y=x1;else y=@006d;
  $  012.高低压状态                           $    $               $    $  ANS012.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@0167;else y=@006d;
  $  013.中压状态                             $    $               $    $  ANS013.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@0167;else y=@006d;
