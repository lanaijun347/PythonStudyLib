...
读数据流: 
  ...
  $  REQ018:710 03 22 FD 52 00 00 00 00       $  ANS018:718 03 22 FD 52 00 00 00 00
  $  REQ019:710 03 22 F1 5A 00 00 00 00       $  ANS019:718 03 22 F1 5A 00 00 00 00
  $  REQ020:710 03 22 F1 98 00 00 00 00       $  ANS020:718 03 22 F1 98 00 00 00 00
  $  REQ021:710 03 22 F1 86 00 00 00 00       $  ANS021:718 03 22 F1 86 00 00 00 00

  $  000.电源电压                            $    $  V            $    $  ANS000.BYTE004  $  y=x1*0.1;
  $  001.左侧夹紧力                          $    $  牛           $    $  ANS001.BYTE004  $  y=((x1<<8)+x2)*10;
  $  002.右侧夹紧力                          $    $  牛           $    $  ANS002.BYTE004  $  y=((x1<<8)+x2)*10;
  $  003.左侧制动盘温度                      $    $  degree C     $    $  ANS003.BYTE004  $  y=((x1<<8)+x2)-50;
  $  004.右侧制动盘温度                      $    $  degree C     $    $  ANS004.BYTE004  $  y=((x1<<8)+x2)-50;
  ...
  $  013.EPB(电子驻车)开关状态               $    $               $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@00fd;0x01: y=@00fe;default: y=@0001;
  $  014.车速                                $    $  km/h         $    $  ANS014.BYTE004  $  y=((x1<<8)+x2)*1.0/10;
  ...
  $  017.ESP(电子车身稳定系统)加速度值       $    $  m/s^2        $    $  ANS017.BYTE004  $  y=((x1<<8)+x2)*1.0/10-20;
  $  018.距离上次夹紧的里程                  $    $  m            $    $  ANS018.BYTE004  $  y=UINT(x1*0x1000000+x2*0x10000+x3*0x100+x4);
  $  019.写维修店代码用的标识符              $    $               $    $  ANS019.BYTE004  $  ASCII(x10,x9,x8,x7,x6,x5,x4,x3,x2,x1);
  $  020.读维修店代码用的标识符              $    $               $    $  ANS020.BYTE004  $  ASCII(x10,x9,x8,x7,x6,x5,x4,x3,x2,x1);
