...
读数据流: 
  ...
  $  010.前影像开关状态（预留）            $    $       $    $  ANS000.BYTE005  $  if(x1&0x04) y=@002a;else y=@00e4;
  $  011.后影像开关状态（预留）            $    $       $    $  ANS000.BYTE005  $  if(x1&0x08) y=@002a;else y=@00e4;
  $  012.左影像开关状态（预留）            $    $       $    $  ANS000.BYTE005  $  if(x1&0x10) y=@002a;else y=@00e4;
  $  013.右影像开关状态（预留）            $    $       $    $  ANS000.BYTE005  $  if(x1&0x20) y=@002a;else y=@00e4;
  $  014.全景影像开关状态                  $    $       $    $  ANS000.BYTE005  $  if(x1&0x40) y=@002a;else y=@00e4;
  $  015.蓝牙电话关状态开关                $    $       $    $  ANS000.BYTE005  $  if(x1&0x80) y=@002a;else y=@00e4;
  $  016.振动马达工作状态                  $    $       $    $  ANS001.BYTE004  $  if(x1&0x01) y=@001e;else y=@001d;
  $  017.静音开关状态                      $    $       $    $  ANS001.BYTE004  $  if(x1&0x02) y=@002a;else y=@00e4;
  $  018.定制按键                          $    $       $    $  ANS001.BYTE004  $  if(x1&0x04) y=@002a;else y=@00e4;
  $  019.仪表返回按键                      $    $       $    $  ANS001.BYTE004  $  if(x1&0x08) y=@002a;else y=@00e4;
  $  020.挂电话&仪表返回按键（预留）       $    $       $    $  ANS001.BYTE004  $  if(x1&0x10) y=@002a;else y=@00e4;
  $  021.巡航按键                          $    $       $    $  ANS001.BYTE004  $  if(x1&0x20) y=@002a;else y=@00e4;
  $  022.取消按键                          $    $       $    $  ANS001.BYTE004  $  if(x1&0x40) y=@002a;else y=@00e4;
  $  023.速度+按键                         $    $       $    $  ANS001.BYTE004  $  if(x1&0x80) y=@002a;else y=@00e4;
  $  024.速度-按键                         $    $       $    $  ANS001.BYTE005  $  if(x1&0x01) y=@002a;else y=@00e4;
  $  025.设置按键                          $    $       $    $  ANS001.BYTE005  $  if(x1&0x02) y=@002a;else y=@00e4;
  $  026.复位按键                          $    $       $    $  ANS001.BYTE005  $  if(x1&0x04) y=@002a;else y=@00e4;
  $  027.时距按键加                        $    $       $    $  ANS001.BYTE005  $  if(x1&0x08) y=@002a;else y=@00e4;
  $  028.时距按键减                        $    $       $    $  ANS001.BYTE005  $  if(x1&0x10) y=@002a;else y=@00e4;
  $  029.车道偏移按键                      $    $       $    $  ANS001.BYTE005  $  if(x1&0x20) y=@002a;else y=@00e4;
