...
读数据流: 
  ...
  $  000.故障检测标志位                     $    $       $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@007b;0x01: y=@03a7;0x02: y=@03a8;0x03: y=@03a9;default: y=@0001;
  $  001.故障检测持续判断                   $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@007b;0x01: y=@03a3;0x02: y=@03a4;0x03: y=@03a5;0x04: y=@03a6;default: y=@0001;
  $  002.自身识别档位信息                   $    $       $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@03a2;0x01: y=@013a;0x02: y=@010d;0x03: y=@010e;0x04: y=@013b;default: y=@0001;
  ...
  $  004.N切R/D在V≤3时是否需要踩刹车       $    $       $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@0992;0x01: y=@0993;default: y=@0001;
