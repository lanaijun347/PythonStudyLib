...
读数据流: 
  ...
  $  REQ000:7D2 03 22 00 01 00 00 00 00       $  ANS000:7DA 03 22 00 01 00 00 00 00

  $  000.左后座椅通风工作状态       $    $       $    $  ANS000.BYTE004  $  switxh(x1&0x03)0x00: y=@00db;0x01: y=@03d3;0x02: y=@0341;default: y=@0001;
  $  001.左后座椅加热工作状态       $    $       $    $  ANS000.BYTE004  $  switxh(x1&0x0C)0x00: y=@00db;0x04: y=@033d;0x08: y=@033e;default: y=@0001;
  $  002.右后座椅通风工作状态       $    $       $    $  ANS000.BYTE004  $  switxh(x1&0x30)0x00: y=@00db;0x10: y=@03d3;0x20: y=@0341;default: y=@0001;
  $  003.右后座椅加热工作状态       $    $       $    $  ANS000.BYTE004  $  switxh(x1&0xC0)0x00: y=@00db;0x40: y=@033d;0x80: y=@033e;default: y=@0001;
  $  004.左后座椅靠背动作状态       $    $       $    $  ANS000.BYTE005  $  switxh(x1&0x03)0x00: y=@00db;0x01: y=@05ab;0x02: y=@05ac;default: y=@0001;
  $  005.右后座椅靠背动作状态       $    $       $    $  ANS000.BYTE005  $  switxh(x1&0x0C)0x00: y=@00db;0x04: y=@05ab;0x08: y=@05ac;default: y=@0001;

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:7D2 30 01 05 00 00 00 00 00  $FC 
