...
读数据流: 
  ...
  $  003.右侧散热片温度                $    $  ℃     $    $  ANS003.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if(x1==208) y=@0284;else if(x1==216) y=@0285;else y=@0001;
  $  004.冷却液温度                    $    $  ℃     $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=120)) y=x1;else if(x1==208) y=@0284;else if(x1==216) y=@0285;else y=@0001;
  $  005.IG2(点火2)低压电源电压        $    $  V      $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.1);
  ...
  $  009.PTC(辅助加热)控制板温度       $    $  ℃     $    $  ANS009.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if(x1==208) y=@0284;else if(x1==216) y=@0285;else y=@0001;
