...
读数据流: 
  ...
  $  000.通讯监测信号                            $    $          $    $  ANS000.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0214; else y=@00d8;
  $  001.电机零转速故障                          $    $          $    $  ANS001.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0214; else y=@00d8;
  $  002.直流输入过压                            $    $          $    $  ANS002.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  003.直流输入低电压                          $    $          $    $  ANS003.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  004.交流输出过电流                          $    $          $    $  ANS004.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  005.失步检出                                $    $          $    $  ANS005.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  006.缺相err0(速度判断)                      $    $          $    $  ANS006.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  007.缺相err1(速度判断)                      $    $          $    $  ANS007.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  008.参数设定err                             $    $          $    $  ANS008.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  009.逆变器IPM(智能功率模块)故障(边沿)       $    $          $    $  ANS009.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  010.逆变器IPM(智能功率模块)故障(电平)       $    $          $    $  ANS010.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  011.直流电压检出异常                        $    $          $    $  ANS011.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  012.AD OFFset异常检                         $    $          $    $  ANS012.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  013.逆变器PWM(脉宽调制)逻辑设定             $    $          $    $  ANS013.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  014.逆变器PWM(脉宽调制)初始化               $    $          $    $  ANS014.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  015.温度异常                                $    $          $    $  ANS015.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  016.Shunt电阻不平衡                         $    $          $    $  ANS016.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  017.通讯断流                                $    $          $    $  ANS017.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  018.空调电机故障报警                        $    $          $    $  ANS018.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  019.PTC(辅助加热)故障报警                   $    $          $    $  ANS019.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@047a; else if(x1==0x02) y=@047b; else y=@00d8;
  $  020.电机控制状态                            $    $          $    $  ANS020.BYTE004  $  if(x1==0x00) y=@001c; else if(x1==0x01) y=@004e; else y=@00d8;
  $  021.电机真实状态                            $    $          $    $  ANS021.BYTE004  $  if(x1==0x00) y=@001c; else if(x1==0x01) y=@004e; else y=@00d8;
  $  022.PTC(辅助加热)控制状态                   $    $          $    $  ANS022.BYTE004  $  if(x1==0x00) y=@001c; else if(x1==0x01) y=@004e; else y=@00d8;
  $  023.过负载标志                              $    $          $    $  ANS023.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0479; else y=@00d8;
  $  024.空调电机发送转速                        $    $  rpm     $    $  ANS024.BYTE004  $  if(x1<0xFB) y=x1*20; else y=@00d8;
  $  025.压缩机反馈转速                          $    $  rpm     $    $  ANS025.BYTE004  $  if(x1<0xFB) y=x1*20; else y=@00d8;
  $  026.加热器占空比                            $    $  %       $    $  ANS026.BYTE004  $  if(x1<0x65) y=x1; else y=@00d8;
  $  027.直流电压(压缩机)                        $    $  V       $    $  ANS027.BYTE004  $  if(x1<0xFB) y=x1*2; else y=@00d8;
  $  028.交流电压(压缩机)                        $    $  V       $    $  ANS028.BYTE004  $  if(x1<0xC9) y=x1/10.0; else y=@00d8;
  $  029.压缩机消耗功率                          $    $  W       $    $  ANS029.BYTE004  $  if(x1<0x97) y=x1*20; else y=@00d8;
  $  030.BLDC驱动板通讯故障                      $    $          $    $  ANS030.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0167; else y=@00d8;
  $  031.316故障                                 $    $          $    $  ANS031.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0214; else y=@00d8;
  $  032.IGBT(绝缘栅双极型晶体管)故障            $    $          $    $  ANS032.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0214; else y=@00d8;
