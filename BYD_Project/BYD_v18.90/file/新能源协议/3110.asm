...
读数据流: 
  ...
  $  009.电流采样电路状态                                     $    $          $    $  ANS009.BYTE004  $  switxh(x1&0x03)0x00: y=@0078;0x01: y=@0088;0x02: y=@0089;0x03: y=@008a;default: y=@0001;
  $  010.三相电流状态                                         $    $          $    $  ANS009.BYTE004  $  switxh(x1&0x0C)0x00: y=@0078;0x04: y=@0088;0x08: y=@0089;0x0C: y=@008a;default: y=@0001;
  $  011.IPM(智能功率模块)/IGBT(绝缘栅双极型晶体管)状态       $    $          $    $  ANS009.BYTE004  $  if(x1&0x10) y=@0087;else y=@0078;
  $  012.内部温度传感器状态                                   $    $          $    $  ANS009.BYTE004  $  if(x1&0x20) y=@0087;else y=@0078;
  $  013.内部电流状态                                         $    $          $    $  ANS009.BYTE004  $  switxh(x1&0xC0)0x00: y=@0078;0x40: y=@0084;0x80: y=@0085;0xC0: y=@0086;default: y=@0001;
  $  014.启动状态                                             $    $          $    $  ANS009.BYTE005  $  if(x1&0x01) y=@0080;else y=@0078;
  $  015.内部温度状态                                         $    $          $    $  ANS009.BYTE005  $  switxh(x1&0x06)0x00: y=@0078;0x02: y=@007e;0x04: y=@007f;default: y=@0001;
  $  016.转速状态                                             $    $          $    $  ANS009.BYTE005  $  if(x1&0x08) y=@0087;else y=@0078;
  $  017.压缩机负载状态                                       $    $          $    $  ANS009.BYTE005  $  switxh(x1&0x30)0x00: y=@0078;0x10: y=@007c;0x20: y=@007d;default: y=@0001;
  $  018.母线电压状态                                         $    $          $    $  ANS009.BYTE005  $  switxh(x1&0xC0)0x00: y=@0078;0x40: y=@0079;0x80: y=@007a;default: y=@0001;
  $  019.内部低压电状态                                       $    $          $    $  ANS009.BYTE006  $  switxh(x1&0x03)0x00: y=@0078;0x01: y=@0082;0x02: y=@0083;default: y=@0001;
  $  020.相电压状态                                           $    $          $    $  ANS009.BYTE006  $  if(x1&0x04) y=@0081;else y=@0078;
  $  021.日期                                                 $    $          $    $  ANS010.BYTE004  $  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
