...
读数据流: 
  ...
  $  001.车道偏离按键次数                        $    $  次     $    $  ANS000.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  002.空调自动模式次数                        $    $  次     $    $  ANS001.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  003.空调开关按键次数                        $    $  次     $    $  ANS001.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  004.空调前除霜按键次数                      $    $  次     $    $  ANS002.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  005.ECO(经济)按键次数                       $    $  次     $    $  ANS002.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  006.SPORT(运动)按键次数                     $    $  次     $    $  ANS003.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  007.雪地模式按键次数                        $    $  次     $    $  ANS003.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
