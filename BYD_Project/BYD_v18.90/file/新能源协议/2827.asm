...
读数据流: 
  ...
  $  002.驻车开关状态_1                              $    $               $    $  ANS000.BYTE006  $  y=((x1<<8)+x2)*0.153-42.5;
  ...
  $  011.TCU(自动变速箱控制器)计算车速               $    $  KM/H         $    $  ANS006.BYTE004  $  y=SPRINTF([%d],(x1*256+x2)*0.06875);
  $  012.TCU(自动变速箱控制器)计算车速状态           $    $               $    $  ANS006.BYTE006  $  switxh(x1)0x00: y=@0078;0x01: y=@0027;default: y=@0001;
  $  013.CAN车速                                     $    $  km/h         $    $  ANS007.BYTE004  $  y=SPRINTF([%d],(x1*256+x2)*0.06875);
  ...
  $  018.输入轴1转速                                 $    $  rpm          $    $  ANS010.BYTE004  $  if(x1<0x80)y=x1*0.25;else y = (x1-256)*0.25;
