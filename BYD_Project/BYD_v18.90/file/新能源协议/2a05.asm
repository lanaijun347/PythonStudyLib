...
读数据流: 
  ...
  $  004.空调两档风扇档位需求                        $    $               $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@001e;0x01: y=@033b;0x02: y=@033a;default: y=@0001;
  $  005.蒸发器温度                                  $    $  degree C     $    $  ANS005.BYTE004  $  if((x1>=0)&&(x1<=60))y=x1-20;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  006.压力状态                                    $    $               $    $  ANS006.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@0001;
  ...
  $  009.后除霜继电器控制                            $    $               $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@002a;0x01: y=@002b;default: y=@0001;
  $  010.工作电源电压                                $    $  V            $    $  ANS009.BYTE004  $  if((x1>=90)&&(x1<=159))y=x1*1.0/10;else if((x1==160))y=@0001;else if((x1==208))y=@0001;else y=@0001;
  $  011.电动压缩机状态                              $    $               $    $  ANS010.BYTE004  $  switxh(x1)0x00: y=@003f;0x01: y=@0044;default: y=@0001;
  $  012.电机压缩机占空比                            $    $  %            $    $  ANS010.BYTE005  $  y=x1;
  $  013.BMS(电池管理系统)允许空调开启高压模块       $    $               $    $  ANS011.BYTE004  $  switxh(x1)0x00: y=@006d;0x01: y=@0196;0x02: y=@0195;default: y=@0001;
  $  014.主驾吹面通道温度                            $    $  degree C     $    $  ANS012.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else if((x1==255)) y=@0003;else y=@0202;
  $  015.主驾吹脚通道温度                            $    $  degree C     $    $  ANS013.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else if((x1==255)) y=@0003;else y=@0202;
  $  016.空调采暖电动水泵继电器控制                  $    $               $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@002a;0x01: y=@002b;default: y=@0001;
  $  017.PTC(辅助加热)水加热器占空比                 $    $  %            $    $  ANS015.BYTE004  $  y=x1;
  $  018.空调高压模块状态                            $    $               $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@02c9;0x01: y=@02ca;0x02: y=@03fc;0x03: y=@02cc;default: y=@0001;
  ...
  $  024.蒸发器出口冷媒温度                          $    $  degree C     $    $  ANS022.BYTE004  $  if((((x2<<8)+x1)>=0)&&(((x2<<8)+x1)<=800))y=(((x2<<8)+x1))*1.0/10;else if((((x2<<8)+x1)>=65136)&&(((x2<<8)+x1)<=65535))y=((((x2<<8)+x1))-65536)*1.0/10;else if((((x2<<8)+x1)==32764)) y=@01e4;else if((((x2<<8)+x1)==32765)) y=@01e3;else y=@0001;
  ...
  $  027.电池热管理需求                              $    $               $    $  ANS025.BYTE004  $  if((x1==0)) y=@0060;else if((x1==1)) y=@02d0;else if((x1==2)) y=@02d1;else if((x1==3)) y=@02d2;else if((x1==4)) y=@02d3;else if((x1==5)) y=@02d4;else if((x1==6)) y=@02d5;else if((x1==7)) y=@004c;else y=@0001;
  $  028.电池冷却系统开启状态                        $    $               $    $  ANS026.BYTE004  $  if((x1==0)) y=@001e;else if((x1==1)) y=@004a;else if((x1==2)) y=@004b;else if((x1==3)) y=@004c;else y=@0001;
  $  029.板换端电子膨胀阀位置                        $    $  %            $    $  ANS027.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1==255)) y=@0831;else y=@0001;
  $  030.板换出口侧冷却液温度信息                    $    $  degree C     $    $  ANS028.BYTE004  $  if((x1>=0)&&(x1<=90))y=x1-20;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  031.热管理水泵启停命令                          $    $               $    $  ANS029.BYTE004  $  if((x1==0)) y=@004d;else if((x1==1)) y=@004e;else y=@0001;
  $  032.空调发送的电池热管理电动水泵占空比          $    $  %            $    $  ANS030.BYTE004  $  y=x1;
  $  033.电池热管理电动水泵反馈转速                  $    $  rpm          $    $  ANS031.BYTE004  $  y=x1*100;
  $  034.热管理水泵启停命令_1                        $    $               $    $  ANS032.BYTE004  $  if((x1==0)) y=@004d;else if((x1==1)) y=@004e;else y=@0001;
