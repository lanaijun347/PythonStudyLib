...
读数据流: 
  ...
  $  000.DC_1工作状态       $    $               $    $  ANS000.BYTE004  $  if(x1==0x01) y = @047f;else if(x1==0x02) y = @05fd;else y = @0001;
  $  001.DC_1故障状态       $    $               $    $  ANS001.BYTE004  $  if(x1 == 0x01) y = @0078;else if(x1 == 0x02) y = @0167;else y = @0001;
  $  002.输出断路故障       $    $               $    $  ANS002.BYTE004  $  if(x1==0x00) y = @0078;else if(x1==0x01) y = @0a26;else if(x1==0x02) y = @04bd;else if(x1==0x03) y = @04be;else y = @0001;
  $  003.DC_1输出电流       $    $  A            $    $  ANS003.BYTE004  $  y = x1+x2*256;
  $  004.DC_1输入电压       $    $  V            $    $  ANS004.BYTE004  $  y = x1+x2*256;
  $  005.DC_1输出电压       $    $  V            $    $  ANS005.BYTE004  $  y = x1*0.1;
