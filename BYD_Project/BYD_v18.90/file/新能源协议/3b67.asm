...
读数据流: 
  ...
  $  000.散热片温度                    $    $  ℃     $    $  ANS000.BYTE004  $  if((x1>=0)&&(x1<=207)) y=x1;else if(x1==208) y=@0284;else if((x1>=209)&&(x1<=215)) y=x1;else if(x1==216) y=@0621;else if((x1>=217)&&(x1<=255)) y=x1;else y=@0001;
  $  001.PTC(辅助加热)预置档位         $    $         $    $  ANS001.BYTE004  $  y=x1;
  $  002.PTC(辅助加热)实际档位         $    $         $    $  ANS002.BYTE004  $  y=x1;
  $  003.右侧散热片温度                $    $  ℃     $    $  ANS003.BYTE004  $  if((x1>=0)&&(x1<=207)) y=x1;else if(x1==208) y=@0284;else if((x1>=209)&&(x1<=215)) y=x1;else if(x1==216) y=@0621;else if((x1>=217)&&(x1<=255)) y=x1;else y=@0001;
  $  004.水加热器冷却液温度            $    $  ℃     $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=207)) y=x1;else if(x1==208) y=@0284;else if((x1>=209)&&(x1<=215)) y=x1;else if(x1==216) y=@0621;else if((x1>=217)&&(x1<=255)) y=x1;else y=@0001;
  $  005.16V 低压电源值                $    $  V      $    $  ANS005.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=240)) y=SPRINTF([%.1f],(x1*256+x2)*0.1);else y=@0620;
  $  006.负载高压电源                  $    $  V      $    $  ANS006.BYTE004  $  y=(x1*256+x2);
  $  007.负载电流值                    $    $  A      $    $  ANS007.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=500)) y=SPRINTF([%.1f],(x1*256+x2)*0.1);else y=@061f;
  $  008.PTC(辅助加热)消耗功率         $    $  W      $    $  ANS008.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=8000)) y=(x1*256+x2);else y=@0622;
  $  009.PTC(辅助加热)控制板温度       $    $  ℃     $    $  ANS009.BYTE004  $  if((x1>=0)&&(x1<=207)) y=x1;else if(x1==208) y=@0284;else if((x1>=209)&&(x1<=215)) y=x1;else if(x1==216) y=@0621;else if((x1>=217)&&(x1<=255)) y=x1;else y=@0001;
