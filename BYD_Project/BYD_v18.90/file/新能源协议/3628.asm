...
读数据流: 
  ...
  $  REQ000:7C0 03 22 00 04 00 00 00 00       $  ANS000:7C8 03 22 00 04 00 00 00 00
  $  REQ001:7C0 03 22 00 05 00 00 00 00       $  ANS001:7C8 03 22 00 05 00 00 00 00

  $  000.电动后背门内开关信号       $    $       $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0010;else y=@0012;
  $  001.电动后背门外开关信号       $    $       $    $  ANS001.BYTE004  $  if(x1&0x01) y=@0010;else y=@0012;
