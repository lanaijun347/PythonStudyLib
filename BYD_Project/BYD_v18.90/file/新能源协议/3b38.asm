...
版本信息:
  ...
  $%  002:软件最后更新日期:               $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%d.%02d.%02d],x1+2000,x2,x3);
  $%  003:PTC(辅助加热)产品序列号:        $%    $%  ANS001.BYTE004  $%  HEX(x1,x2,x3);
  $%  004:生产日期:                       $%    $%  ANS001.BYTE007  $%  y=SPRINTF([%d.%02d.%02d],x1+2000,x2,x3);
...
读数据流: 
  ...
  $  000.散热片温度                   $    $  ℃     $    $  ANS000.BYTE004  $  y=x1;
  $  001.PTC(辅助加热)预置档位        $    $         $    $  ANS001.BYTE004  $  y=x1;
  $  002.PTC(辅助加热)实际档位        $    $         $    $  ANS002.BYTE004  $  y=x1;
  $  003.IG2(点火2)低压电源电压       $    $  V      $    $  ANS003.BYTE004  $  y=SPRINTF([%d],(x1*256+x2)*0.1);
