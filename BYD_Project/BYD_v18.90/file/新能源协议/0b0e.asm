...
读数据流: 
  ...
  $  012.与ESP(电子车身稳定系统)通讯状态           $    $               $    $  ANS012.BYTE004  $  if(x1==0x00)y=@0526;else if(x1==0x01)y=@0527;else y=@0001;
  $  013.与ABS(防抱死刹车系统)通讯状态             $    $               $    $  ANS013.BYTE004  $  if(x1==0x00)y=@0526;else if(x1==0x02)y=@0527;else y=@0001;
  $  014.与电池管理器通讯状态                      $    $               $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0526;else if(x1==0x01)y=@0527;else y=@0001;
  $  015.与主控通讯状态                            $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@0526;else if(x1==0x01)y=@0527;else y=@0001;
  ...
  $  030.充放电系统故障状态                        $    $               $    $  ANS030.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@05fb;else if(x1==0x02)y=@04c4;else if(x1==0x03)y=@04c5;else if(x1==0x04)y=@01dd;else if(x1==0x05)y=@0a13;else if(x1==0x06)y=@04c8;else if(x1==0x07)y=@04c9;else if(x1==0x08)y=@04ca;else y=@0001;
  ...
  $  048.十五工况标志位                            $    $               $    $  ANS048.BYTE004  $  if(x1==0x00)y=@06a1;else if(x1==0x01)y=@06a2;else y=@0001;
  ...
  $  062.充电S2开关吸合标志                        $    $               $    $  ANS062.BYTE004  $  if(x1==0x00)y=@002a;else if(x1==0x01)y=@002b;else y=@0001;
  $  063.发送CP标志位                              $    $               $    $  ANS063.BYTE004  $  if(x1==0x00)y=@08c0;else if(x1==0x01)y=@08c1;else y=@0001;
  $  064.驱动电机系统配置类型                      $    $               $    $  ANS064.BYTE004  $  if(x1==0x00)y=@08bd;else if(x1==0x01)y=@08be;else y=@0001;
  $  065.倾角传感器是否校准                        $    $               $    $  ANS065.BYTE004  $  if(x1==0x00)y=@015e;else if(x1==0x01)y=@08bf;else y=@0001;
  $  066.倾角传感器信息状态                        $    $               $    $  ANS066.BYTE004  $  if(x1==0x00)y=@0167;else if(x1==0x01)y=@0078;else y=@0001;
  ...
  $  071.降压模块状态                              $    $               $    $  ANS071.BYTE004  $  if(x1==0x00)y=@0415;else if(x1==0x01)y=@042c;else if(x1==0x02)y=@042d;else if(x1==0x03)y=@042e;else y=@0001;
  $  072.升降压DC模块故障                          $    $               $    $  ANS072.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@0001;
  ...
  $  000.充放电状态             $    $         $    $  ANS000.BYTE004  $  if(x1==0x00)y=@04d5;else if(x1==0x01)y=@0495;else if(x1==0x02)y=@0a91;else if(x1==0x03)y=@04d7;else if(x1==0x04)y=@04d8;else if(x1==0x05)y=@04d9;else y=@0001;
  $  001.当前电制频率           $    $  Hz     $    $  ANS001.BYTE004  $  if(x1==0x00) y=@0a24;else if(x1==0x01) y=@0a25;else y=@0001;
  $  002.当前电制三相电压       $    $  V      $    $  ANS002.BYTE004  $  if(x1==0x00) y=@0a1f;else if(x1==0x01) y=@0a1b;else if(x1==0x02) y=@0a20;else if(x1==0x03) y=@0a21;else if(x1==0x04) y=@0a22;else if(x1 ==0x05) y=@0a23;else y=@0001;
  $  003.当前电制单相电压       $    $  V      $    $  ANS003.BYTE004  $  if(x1==0x00) y=@0a1a;else if(x1==0x01) y=@0a1b;else if(x1==0x02) y=@0a1c;else if(x1==0x03) y=@0a1d;else if(x1==0x04) y=@0a1e;else y=@0001;
