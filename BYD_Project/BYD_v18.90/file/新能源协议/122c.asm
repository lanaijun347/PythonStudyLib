...
读数据流: 
  ...
  $  000.母线电压                                     $    $  V            $    $  ANS000.BYTE004  $  if((x1+x2*256)<1001) y=x1+x2*256;else y = @0001;
  ...
  $  009.IGBT(绝缘栅双极型晶体管)驱动状态             $    $               $    $  ANS009.BYTE004  $  if(x1 == 0x01) y = @001e;else if(x1 == 0x02) y = @00d9;else y = @0001;
  $  010.电池加热器卸载状态                           $    $               $    $  ANS010.BYTE004  $  if(x1 == 0x00) y = @0003;else if(x1 == 0x01) y = @09bb;else if(x1 == 0x02) y = @09bc;else y = @0001;
  $  011.电池加热器故障状态                           $    $               $    $  ANS011.BYTE004  $  if(x1 == 0x01) y = @0078;else if(x1 == 0x02) y = @0167;else y = @0001;
  $  012.电池加热器加热组件状态                       $    $               $    $  ANS012.BYTE004  $  if(x1 == 0x01) y = @0078;else if(x1 == 0x02) y = @0167;else y = @0001;
  $  013.电池加热器驱动组件状态                       $    $               $    $  ANS013.BYTE004  $  if(x1 == 0x01) y = @09c1;else if(x1 == 0x02) y = @09c2;else if(x1 == 0x03) y = @09c3;else y = @0001;
  $  014.IG4(点火4)低压电源值                         $    $  V            $    $  ANS014.BYTE004  $  y=x1*0.1;
  $  015.IGBT(绝缘栅双极型晶体管)驱动电压值           $    $  V            $    $  ANS015.BYTE004  $  y=x1*0.1;
  $  016.控制芯片电压值                               $    $  V            $    $  ANS016.BYTE004  $  y=x1*0.1;
  $  017.IGBT(绝缘栅双极型晶体管)短路状态             $    $               $    $  ANS017.BYTE004  $  if(x1 == 0x01) y = @0078;else if(x1 == 0x02) y = @01e3;else y = @0001;
  $  018.IGBT(绝缘栅双极型晶体管)温度传感器状态       $    $               $    $  ANS018.BYTE004  $  if(x1 == 0x01) y = @09c0;else if(x1 == 0x02) y = @0284;else if(x1 == 0x03) y = @0285;else y = @0001;
  $  019.主板温度传感器状态                           $    $               $    $  ANS019.BYTE004  $  if(x1 == 0x01) y = @09c1;else if(x1 == 0x02) y = @09c2;else if(x1 == 0x03) y = @09c3;else y = @0001;
  $  020.与BMS(电池管理系统)通讯状态                  $    $               $    $  ANS020.BYTE004  $  if(x1 == 0x01) y = @0526;else if(x1 == 0x02) y = @09e0;else y = @0001;
