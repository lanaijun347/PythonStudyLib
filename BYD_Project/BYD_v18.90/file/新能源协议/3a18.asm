...
读数据流: 
  ...
  $  REQ022:7C0 03 22 00 16 00 00 00 00       $  ANS022:7C8 03 22 00 16 00 00 00 00
  ...
  $  015.电源电压                          $    $  V     $    $  ANS015.BYTE004  $  y=SPRINTF([%.1f],x1*0.078);
  $  016.后背门当前位置                    $    $        $    $  ANS016.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=3000)) y=(x1*256+x2);else if((x1*256+x2)==4095) y=@0027;else y=@0001;
  $  017.后背门行程                        $    $        $    $  ANS017.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=3000)) y=(x1*256+x2);else if((x1*256+x2)==4095) y=@0027;else y=@0001;
  $  018.左侧撑杆当前位置                  $    $        $    $  ANS018.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=3000)) y=(x1*256+x2);else if((x1*256+x2)==4095) y=@0027;else y=@0001;
  $  019.左侧撑杆行程                      $    $        $    $  ANS019.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=3000)) y=(x1*256+x2);else if((x1*256+x2)==4095) y=@0027;else y=@0001;
  $  020.右侧撑杆当前位置                  $    $        $    $  ANS020.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=3000)) y=(x1*256+x2);else if((x1*256+x2)==4095) y=@0027;else y=@0001;
  $  021.右侧撑杆行程                      $    $        $    $  ANS021.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=3000)) y=(x1*256+x2);else if((x1*256+x2)==4095) y=@0027;else y=@0001;
  $  022.脚踢感应开关信号                  $    $        $    $  ANS022.BYTE004  $  if(x1&0x01) y=@0010;else y=@0012;
