...
读数据流: 
  ...
  $  020.CAN发动机转速状态                             $    $           $    $  ANS012.BYTE006  $  switxh(x1)0x00: y=@0078;0x01: y=@0027;default: y=@0001;
  ...
  $  042.油泵使能信息                                  $    $           $    $  ANS024.BYTE005  $  switxh(x1)0x00: y=@011a;0x01: y=@001c;default: y=@0001;
  ...
  $  047.离合器强制脱开命令有效标志                    $    $           $    $  ANS028.BYTE004  $  switxh(x1)0x00: y=@0003;0x01: y=@0002;default: y=@0001;
  $  048.离合器强制脱开                                $    $           $    $  ANS028.BYTE005  $  switxh(x1)0x00: y=@011e;0x01: y=@011f;default: y=@0001;
  $  049.整车实际工作模式                              $    $           $    $  ANS028.BYTE006  $  switxh(x1)0x00: y=@001c;0x01: y=@011b;0x02: y=@011c;0x03: y=@011d;default: y=@0001;
  $  050.SOC(荷电状态)低于极限阙值次数                 $    $           $    $  ANS029.BYTE004  $  y=(x1*256+x2);
