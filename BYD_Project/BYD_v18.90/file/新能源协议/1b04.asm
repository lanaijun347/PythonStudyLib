...
版本信息:
  ...
  $%  000:硬件版本/日期:        $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1,x2,x3);
  $%  001:软件版本/日期:        $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1,x2,x3);
...
读数据流: 
  ...
  $  012.MOS(金属—绝缘体半导体)温度         $    $  degree C     $    $  ANS012.BYTE004  $  y=x1-60;
