...
读数据流: 
  ...
  $  063.P档系统状态                                 $    $            $    $  ANS042.BYTE005  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@0001;
  ...
  $  075.整车工作模式                                $    $            $    $  ANS050.BYTE004  $  switxh(x1)0x00: y=@001c;0x01: y=@016b;0x02: y=@016c;0x03: y=@016d;0x04: y=@016e;0x05: y=@016f;0x06: y=@0170;0x07: y=@0171;default: y=@0001;
  $  076.离合器强制脱开                              $    $            $    $  ANS050.BYTE005  $  switxh(x1)0x00: y=@011e;0x01: y=@011f;default: y=@0001;
  $  077.离合器强制脱开命令有效标识位                $    $            $    $  ANS050.BYTE006  $  switxh(x1)0x00: y=@0003;0x01: y=@0002;default: y=@0001;
