...
读数据流: 
  ...
  $  003.座椅水平向前调节按键开关次数       $    $       $    $  ANS001.BYTE004  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=50000)) y=(x2*256+x1);else if(((x2*256+x1)>=50001)&&((x2*256+x1)<=65535)) y=@0000;else y=@0001;
  $  004.座椅水平向后调节按键开关次数       $    $       $    $  ANS001.BYTE006  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=50000)) y=(x2*256+x1);else if(((x2*256+x1)>=50001)&&((x2*256+x1)<=65535)) y=@0000;else y=@0001;
  $  005.靠背前倾调节按键开关次数           $    $       $    $  ANS002.BYTE004  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=50000)) y=(x2*256+x1);else if(((x2*256+x1)>=50001)&&((x2*256+x1)<=65535)) y=@0000;else y=@0001;
  $  006.靠背后倾调节按键开关次数           $    $       $    $  ANS002.BYTE006  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=50000)) y=(x2*256+x1);else if(((x2*256+x1)>=50001)&&((x2*256+x1)<=65535)) y=@0000;else y=@0001;
