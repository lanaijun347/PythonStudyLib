...
读数据流: 
  ...
  $  003.DC_2输出电流       $    $  A      $    $  ANS003.BYTE004  $  y=(x2*256+x1);
  $  004.DC_2输入电压       $    $  V      $    $  ANS004.BYTE004  $  y=(x2*256+x1);
  $  005.DC_2输出电压       $    $  V      $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],x1/10);
  $  006.DC_2温度           $    $  ℃     $    $  ANS006.BYTE004  $  y=SPRINTF([%d],x1-40);
