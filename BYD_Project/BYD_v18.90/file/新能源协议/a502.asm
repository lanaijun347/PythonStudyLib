...
版本信息:
  ...
  $%  005:加注状态:            $%    $%  ANS005.BYTE004  $%  if(x1==0) y=@0206;else y=@020c;
  $%  006:下线检测状态:        $%    $%  ANS006.BYTE004  $%  if(x1==0) y=@0a65;else y=@020c;
  $%  007:限速监视状态:        $%    $%  ANS007.BYTE004  $%  if(x1==0) y=@0bd5;else if(x1==1) y=@0bd6; else y=@0bd4;
  $%  008:诊断会话模式:        $%    $%  ANS008.BYTE004  $%  if(x1==1) y=@0bd3;else if(x1==3) y=@0690; else y=@0bd4;
...
读数据流: 
  ...
  $  007.刹车灯状态             $    $           $    $  ANS002.BYTE004  $  if(x1&0x01) y=@0028;else y=@0029;
  $  008.电磁阀继电器状态       $    $           $    $  ANS002.BYTE004  $  if(x1&0x20) y=@0a63;else y=@002a;
  $  009.泵继电器               $    $           $    $  ANS002.BYTE006  $  if(x1&0x40) y=@0a63;else y=@002a;
