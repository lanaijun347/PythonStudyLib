...
读数据流: 
  ...
  $  000.P档电机状态                                              $    $        $    $  ANS000.BYTE004  $  if(x1 == 0x00) y = @0174;else if(x1 == 0x01) y = @0175;else if(x1 == 0x02) y = @0176;else if(x1 == 0x03) y = @0177;else y = @0001;
  ...
  $  003.位置霍尔状态                                             $    $        $    $  ANS003.BYTE004  $  if(x1 == 0x00) y = @0078;else if(x1 == 0x01) y = @0879;else if(x1 == 0x02) y = @04ad;else y = @0001;
  $  004.电机缺相                                                 $    $        $    $  ANS004.BYTE004  $  if(x1 == 0x00) y = @0078;else if(x1 == 0x01) y = @0872;else if(x1 == 0x02) y = @0873;else if(x1 == 0x03) y = @0874;else if(x1 == 0x04) y = @0875;else if(x1 == 0x05) y = @0876;else if(x1 == 0x06) y = @0877;else if(x1 == 0x07) y = @0878;else y = @0001;
  $  005.与ABS/ESP(防抱死刹车系统/电子车身稳定系统)通讯状态       $    $        $    $  ANS005.BYTE004  $  if(x1 == 0x00) y = @0078;else if(x1 == 0x01) y = @0087;else y = @0001;
  ...
  $  010.控制状态                                                 $    $        $    $  ANS010.BYTE004  $  if(x1 == 0x00) y = @0078;else if(x1 == 0x01) y = @04a3;else if(x1 == 0x02) y = @04a4;else y = @0001;
