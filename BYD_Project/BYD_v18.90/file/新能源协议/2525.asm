...
读数据流: 
  ...
  $  000.转向角度                            $    $  °       $    $  ANS000.BYTE004  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=2047))y=(((x1<<8)+x2))*1.0/10;else if((((x1<<8)+x2)>=2048)&&(((x1<<8)+x2)<=4095))y=(2048-(((x1<<8)+x2)))*1.0/10;else y=@0001;
  $  001.转向角速度                          $    $  °/s     $    $  ANS001.BYTE004  $  if((((x1<<8)+x2)>=0)&&(((x1<<8)+x2)<=2047))y=(((x1<<8)+x2))*4;else if((((x1<<8)+x2)>=2048)&&(((x1<<8)+x2)<=4095))y=(2048-(((x1<<8)+x2)))*4;else y=@0001;
