...
读数据流: 
  ...
  $  000.真空泵状态             $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@047f;0x01: y=@0014;default: y=@0001;
  $  001.风扇高速状态           $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@047f;0x01: y=@0014;default: y=@0001;
  $  002.风扇低速工作状态       $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@047f;0x01: y=@0014;default: y=@0001;
  $  003.水温                   $    $  degree C     $    $  ANS003.BYTE004  $  y=x1-40;
  $  004.真空压力值             $    $  kPa          $    $  ANS004.BYTE004  $  y=x1;
  $  005.水温报警               $    $               $    $  ANS005.BYTE004  $  switxh(x1)0x00: y=@023f;0x01: y=@0240;default: y=@0001;
  $  006.真空压力报警           $    $               $    $  ANS006.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@023d;0x02: y=@023e;default: y=@0001;
  $  007.真空泵工作时间         $    $  分钟         $    $  ANS007.BYTE004  $  y=UINT(x1*0x1000000+x2*0x10000+x3*0x100+x4);
  $  008.充电口电锁状态         $    $               $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@05fe;0x01: y=@0009;0x02: y=@0167;default: y=@0001;
  $  009.充电口舱门状态         $    $               $    $  ANS009.BYTE004  $  switxh(x1)0x00: y=@001e;0x01: y=@001d;default: y=@0001;
  $  010.无级风扇状态           $    $               $    $  ANS010.BYTE004  $  switxh(x1)0x00: y=@001e;0x01: y=@001d;default: y=@0001;
