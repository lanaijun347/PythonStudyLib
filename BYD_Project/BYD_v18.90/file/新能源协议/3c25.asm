...
读数据流: 
  ...
  $  000.变道盲区按键次数                        $    $  次     $    $  ANS000.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  001.车道偏离按键次数                        $    $         $    $  ANS000.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  002.空调自动模式次数                        $    $  次     $    $  ANS001.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  003.空调开关按键次数                        $    $         $    $  ANS001.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  004.空调前除霜按键次数                      $    $  次     $    $  ANS002.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  005.ECO(经济)按键次数                       $    $         $    $  ANS002.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  006.SPORT(运动)按键次数                     $    $  次     $    $  ANS003.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  007.雪地模式按键次数                        $    $         $    $  ANS003.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  008.ESP(电子车身稳定系统)开关按键次数       $    $  次     $    $  ANS004.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  009.倒车雷达开关按键次数                    $    $         $    $  ANS004.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:7A7 30 08 05 00 00 00 00 00  $FC 
