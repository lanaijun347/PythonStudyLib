...
读数据流: 
  ...
  $  016.与BMS(电池管理器)通讯状态       $    $          $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;0x02: y=@007b;0x03: y=@007b;default: y=@01c6;
  ...
  $  023.DC工作模式                      $    $          $    $  ANS023.BYTE004  $  switxh(x1)0x00: y=@01d4;0x01: y=@01d6;0x02: y=@01d5;0x03: y=@00d8;default: y=@0001;
  ...
  $  028.交流侧绝缘阻值                  $    $  KΩ     $    $  ANS028.BYTE004  $  if((x1>=0)&&(x1<=254)) y=x1;else if(x1==255) y=@030d;else y=@0001;
