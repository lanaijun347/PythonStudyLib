...
进入命令:
  ...
  $~  REQ001:7A1 02 10 01 00 00 00 00 00       $~  ANS001:7A9 02 10 01 00 00 00 00 00
...
版本信息:
  ...
  $%  004:车型:                    $%    $%  ANS002.BYTE004  $%  switxh(x1)0x81:y=@08d9;0x82:y=@0358;0x83:y=@0607;0x84:y=@08da;0x85:y=@035b;default: y=@020c;
  $%  005:MCU:                     $%    $%  ANS003.BYTE004  $%  switxh(x1)0x81:y=@0227;default: y=@020c;
