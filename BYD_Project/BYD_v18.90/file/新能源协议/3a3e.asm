...
读数据流: 
  ...
  $  006.语音输入开关状态          $    $       $    $  ANS000.BYTE005  $  if(x1&0x02) y=@002a;else y=@00e4;
  $  007.全景影像开关状态          $    $       $    $  ANS000.BYTE005  $  if(x1&0x40) y=@002a;else y=@00e4;
  $  008.振动马达工作状态          $    $       $    $  ANS001.BYTE004  $  if(x1&0x01) y=@0012;else y=@0010;
  $  009.静音开关状态              $    $       $    $  ANS001.BYTE004  $  if(x1&0x02) y=@002a;else y=@00e4;
  $  010.仪表返回开关状态          $    $       $    $  ANS001.BYTE004  $  if(x1&0x04) y=@002a;else y=@00e4;
  $  011.巡航开关状态              $    $       $    $  ANS001.BYTE004  $  if(x1&0x10) y=@002a;else y=@00e4;
  $  012.取消开关状态              $    $       $    $  ANS001.BYTE004  $  if(x1&0x20) y=@002a;else y=@00e4;
  $  013.速度增开关状态            $    $       $    $  ANS001.BYTE004  $  if(x1&0x40) y=@002a;else y=@00e4;
  $  014.速度减开关状态            $    $       $    $  ANS001.BYTE004  $  if(x1&0x80) y=@002a;else y=@00e4;
  $  015.设置开关状态              $    $       $    $  ANS001.BYTE005  $  if(x1&0x01) y=@002a;else y=@00e4;
  $  016.复位开关状态              $    $       $    $  ANS001.BYTE005  $  if(x1&0x02) y=@002a;else y=@00e4;
  $  017.时距/时距减开关状态       $    $       $    $  ANS001.BYTE005  $  if(x1&0x04) y=@002a;else y=@00e4;
  $  018.时距增开关状态            $    $       $    $  ANS001.BYTE005  $  if(x1&0x08) y=@002a;else y=@00e4;
