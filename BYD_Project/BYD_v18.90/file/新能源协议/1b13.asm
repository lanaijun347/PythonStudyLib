...
版本信息:
  ...
  $%  002:软件最后更新日期:             $%    $%  ANS000.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
  $%  003:生产日期:                     $%    $%  ANS001.BYTE004  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
  $%  004:车型:                         $%    $%  ANS002.BYTE004  $%  switxh(x1)0x51:y=@08d9;0x52:y=@0358;0x53:y=@0607;0x54:y=@08da;0x55:y=@035b;default: y=@020c;
  $%  005:MCU:                          $%    $%  ANS003.BYTE004  $%  switxh(x1)0x51:y=@0227;default: y=@020c;
  $%  006:压缩机产品序列号:             $%    $%  ANS004.BYTE004  $%  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $%  007:PTC(辅助加热)生产日期:        $%    $%  ANS004.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
