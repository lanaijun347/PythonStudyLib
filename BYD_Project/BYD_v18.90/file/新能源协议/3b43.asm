...
版本信息:
  ...
  $%  011:内部供电状况:                       $%    $%  ANS006.BYTE004  $%  switxh(x1)0x00: y=@00cb;0xFF: y=@00cc;default: y=@0001;
  $%  012:读卡器是否失去通信:                 $%    $%  ANS006.BYTE005  $%  switxh(x1)0x00: y=@00c9;0xFF: y=@00ca;default: y=@0001;
  $%  013:内部天线状态:                       $%    $%  ANS006.BYTE006  $%  switxh(x1)0x00: y=@0078;0xFF: y=@0087;default: y=@0001;
  $%  014:钥匙状态:                           $%    $%  ANS006.BYTE007  $%  switxh(x1)0x02: y=@00cd;0x03: y=@00ce;0x04: y=@00cf;0x06: y=@00d0;default: y=@0001;
