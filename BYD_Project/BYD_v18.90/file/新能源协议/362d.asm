...
读数据流: 
  ...
  $  008.右前车窗当前动作状态           $    $        $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@0018;0x01: y=@001c;0x02: y=@032d;0x03: y=@001d;0x04: y=@001e;default: y=@0001;
  ...
  $  016.左后车窗当前动作状态           $    $        $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0018;0x01: y=@001c;0x02: y=@032d;0x03: y=@001d;0x04: y=@001e;default: y=@0001;
  ...
  $  024.右后车窗当前动作状态           $    $        $    $  ANS024.BYTE004  $  switxh(x1)0x00: y=@0018;0x01: y=@001c;0x02: y=@032d;0x03: y=@001d;0x04: y=@001e;default: y=@0001;
  ...
  $  032.天窗当前动作状态               $    $        $    $  ANS032.BYTE004  $  switxh(x1)0x00: y=@0018;0x01: y=@001c;0x02: y=@032d;0x03: y=@001d;0x04: y=@001e;default: y=@0001;
  ...
  $  039.遮阳帘当前动作状态             $    $        $    $  ANS039.BYTE004  $  switxh(x1)0x00: y=@0018;0x01: y=@001c;0x02: y=@032d;0x03: y=@001d;0x04: y=@001e;default: y=@0001;
