...
读数据流: 
  ...
  $  026.错误信息                           $    $               $    $  ANS025.BYTE005  $  switxh(x1)0x00: y=@015b;0x01: y=@015c;default: y=@0120;
  $  027.坡道坡度                           $    $  °           $    $  ANS025.BYTE006  $  if((((x2<<8)+x1)>=0)&&(((x2<<8)+x1)<=300))y=(((x2<<8)+x1))*0.1;else if((((x2<<8)+x1)>=65236)&&(((x2<<8)+x1)<=65535))y=((((x2<<8)+x1))-65536)*0.1;else if((((x2<<8)+x1)==32767)) y=@015a;else y=@0120;
  $  028.前电机目标档位                     $    $               $    $  ANS026.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@015f;else if((x1==0x01)&&(x2==0x00)) y=@0160;else if((x1==0x02)&&(x2==0x00)) y=@0161;else if((x1==0x03)&&(x2==0x00)) y=@0162;else if((x1==0x04)&&(x2==0x00)) y=@0163;else y=@0120;
  $  029.BSG(轻度混合动力)目标扭矩          $    $  牛顿米       $    $  ANS027.BYTE004  $  y=((x2<<8)+x1)*1.0/10-500;
  $  030.BSG(轻度混合动力)目标转速          $    $  rpm          $    $  ANS028.BYTE004  $  y=((x2<<8)+x1)-3000;
  $  031.BSG(轻度混合动力)目标电压          $    $  V            $    $  ANS029.BYTE004  $  y=((x2<<8)+x1)*4;
