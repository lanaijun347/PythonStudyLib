...
版本信息:
  ...
  $%  006:硬件版本:        $%    $%  ANS003.BYTE004  $%  y=SPRINTF([%d.%d.%d],(x1%1000-x1%100)/100,(x1%100-x1%10)/10,x1%10);
  $%  007:硬件日期:        $%    $%  ANS003.BYTE005  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
