...
版本信息:
  ...
  $%  REQ001:7B3 03 22 F1 8C 00 00 00 00       $%  ANS001:7BB 03 22 F1 8C 00 00 00 00
  ...
  $%  003:压缩机产品序列号:        $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $%  004:生产日期:                $%    $%  ANS001.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
...
读数据流: 
  ...
  $  005.负载电流                                             $    $  A            $    $  ANS005.BYTE004  $  y=x1*31.88/255;
