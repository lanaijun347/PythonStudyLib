...
读数据流: 
  ...
  $  028.交流充电继电器动作请求命令                $    $               $    $  ANS028.BYTE004  $  if(x1==0x00)y=@01c7;else if(x1==0x01)y=@0498;else y=@0001;
  ...
  $  072.升降压DC模块故障                          $    $               $    $  ANS072.BYTE004  $  if(x1==0x00)y=@0167;else if(x1==0x01)y=@0078;else y=@0001;
