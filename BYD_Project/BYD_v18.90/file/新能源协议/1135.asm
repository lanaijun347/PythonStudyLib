...
读数据流: 
  ...
  $  REQ013:785 03 22 1F F0 00 00 00 00       $  ANS013:78D 03 22 1F F0 00 00 00 00
  ...
  $  004.扭矩                               $    $  N·M         $    $  ANS004.BYTE004  $  y = (x1*26/255)+(x2*25.6)-500;
  $  005.功率                               $    $  kw           $    $  ANS005.BYTE004  $  y = (x1*26/255)+(x2*25.6)-100;
