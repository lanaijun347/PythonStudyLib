...
版本信息:
  ...
  $%  007:编程日期:                       $%    $%  ANS004.BYTE004  $%  y=SPRINTF([%02d/%02d/%02d],x1,x2,x3);
  $%  008:ECU生产日期:                    $%    $%  ANS005.BYTE004  $%  y=SPRINTF([%02d/%02d/%02d],x1,x2,x3);
...
读数据流: 
  ...
  $  048.无级风扇占空比                              $    $  %            $    $  ANS000.BYTE102  $  y = x1*100.0/255;
  ...
  $  064.发动机冷却系统-风扇类型                     $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@0194;else if((x1&0x0F)<0x08)y=@0193;else y=@0001;
  ...
  $  072.发动机动态工况-是否D档(前进挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x20)y=@0185;else y=@0186;
  $  073.发动机动态工况-是否R档(后退挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x40)y=@0185;else y=@0186;
  $  074.发动机动态工况-是否N档(空挡)                $    $               $    $  ANS000.BYTE025  $  if(x1&0x80)y=@0185;else y=@0186;
