...
读数据流: 
  ...
  $  000.发电机状态                          $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else if(x1==0x02)y=@09ba;else y=@0001;
  $  001.发动机状态                          $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@004e;else if(x1==0x01)y=@001c;else if(x1==0x02)y=@011a;else if(x1==0x03)y=@0167;else if(x1==0x04)y=@09ba;else y=@0001;
  $  002.放电是否允许                        $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0195;else if(x1==0x01)y=@0196;else if(x1==0x02)y=@0a0e;else if(x1==0x03)y=@01d3;else y=@0001;
  $  003.DC系统故障状态                      $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@0001;
  $  004.DC工作模式                          $    $               $    $  ANS004.BYTE004  $  if(x1==0x00)y=@01d4;else if(x1==0x01)y=@01d6;else if(x1==0x02)y=@01d5;else y=@0001;
