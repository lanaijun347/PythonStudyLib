...
读数据流: 
  ...
  $  001.制动踏板状态状态                          $    $             $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@08bb;0x01: y=@08bc;default: y=@0001;
  ...
  $  024.IGBT(绝缘栅双极型晶体管)最高温度          $    $  ℃         $    $  ANS024.BYTE004  $  y=SPRINTF([%d],x1-40);
  ...
  $  041.充电方式                                  $    $             $    $  ANS041.BYTE004  $  switxh(x1)0x00: y=@099a;0x02: y=@08c4;default: y=@0001;
  ...
  $  048.十五工况标志位                            $    $             $    $  ANS048.BYTE004  $  switxh(x1)0x00: y=@06a1;0x01: y=@06a2;default: y=@0001;
  $  049.油门采样值1                               $    $             $    $  ANS049.BYTE004  $  y=(x2*256+x1);
  $  050.油门采样值2                               $    $             $    $  ANS050.BYTE004  $  y=(x2*256+x1);
  $  051.IGBT(绝缘栅双极型晶体管)温度采样值U       $    $             $    $  ANS051.BYTE004  $  y=(x2*256+x1);
  $  052.IGBT(绝缘栅双极型晶体管)温度采样值V       $    $             $    $  ANS052.BYTE004  $  y=(x2*256+x1);
  $  053.IGBT(绝缘栅双极型晶体管)温度采样值W       $    $             $    $  ANS053.BYTE004  $  y=(x2*256+x1);
  ...
  $  062.充电S2开关吸合标志                        $    $             $    $  ANS062.BYTE004  $  switxh(x1)0x00: y=@002a;0x01: y=@002b;default: y=@0001;
  $  063.发送CP标志位                              $    $             $    $  ANS063.BYTE004  $  switxh(x1)0x00: y=@08c0;0x01: y=@08c1;default: y=@0001;
  $  064.驱动电机系统配置类型                      $    $             $    $  ANS064.BYTE004  $  switxh(x1)0x00: y=@08bd;0x01: y=@08be;default: y=@0001;
  $  065.倾角传感器是否校准                        $    $             $    $  ANS065.BYTE004  $  switxh(x1)0x00: y=@015e;0x01: y=@08bf;default: y=@0001;
  $  066.倾角传感器信息状态                        $    $             $    $  ANS066.BYTE004  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  ...
  $  071.降压模块状态                              $    $             $    $  ANS071.BYTE004  $  switxh(x1)0x00: y=@0415;0x01: y=@042c;0x02: y=@042d;0x03: y=@042e;default: y=@0001;
  $  072.升降压DC模块故障                          $    $             $    $  ANS072.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@0001;
  ...
  $  001.当前电制频率           $    $  Hz     $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@05f9;0x01: y=@05fa;default: y=@0001;
