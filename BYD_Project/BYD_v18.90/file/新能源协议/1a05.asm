...
读数据流: 
  ...
  $  REQ000:716 03 22 B0 02 00 00 00 00       $  ANS000:71E 03 22 B0 02 00 00 00 00

  $  000.开关模式状态       $    $       $    $  ANS000.BYTE004  $  if((x1==0x00)&&(x2==0x00)&&(x3==0x00))y=@0a14;else if((x1==0x00)&&(x2==0x00)&&(x3==0x01))y=@0a16;else y=@0001;
