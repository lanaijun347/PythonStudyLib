...
读数据流: 
  ...
  $  REQ018:780 03 22 00 22 00 00 00 00       $  ANS018:788 03 22 00 22 00 00 00 00
  $  REQ019:780 03 22 00 24 00 00 00 00       $  ANS019:788 03 22 00 24 00 00 00 00
  $  REQ020:780 03 22 D0 02 00 00 00 00       $  ANS020:788 03 22 D0 02 00 00 00 00
  $  REQ021:780 03 22 D0 03 00 00 00 00       $  ANS021:788 03 22 D0 03 00 00 00 00
  $  REQ022:780 03 22 D0 04 00 00 00 00       $  ANS022:788 03 22 D0 04 00 00 00 00
  $  REQ023:780 03 22 F1 A0 00 00 00 00       $  ANS023:788 03 22 F1 A0 00 00 00 00
  $  REQ024:780 03 22 1F F3 00 00 00 00       $  ANS024:788 03 22 1F F3 00 00 00 00
  $  REQ025:780 03 22 1F F4 00 00 00 00       $  ANS025:788 03 22 1F F4 00 00 00 00
  ...
  $  018.售后软件版本号                              $    $           $    $  ANS018.BYTE004  $  y=SPRINTF([%d.%d.%d],x1,x2,x3);
  $  019.主动泄放状态                                $    $           $    $  ANS019.BYTE004  $  if(x1==0) y=@0215;else if(x1==1) y=@0216;else if(x1==2) y=@0217;else if(x1==3) y=@0218;else y=@0202;
  $  020.前驱动电机零位值                            $    $           $    $  ANS020.BYTE004  $  HEX(x2,x1);
  $  021.前驱动电机零位标定状态                      $    $           $    $  ANS021.BYTE004  $  if(x1==0) y=@0157;else if(x1==1) y=@0221;else if(x1==2) y=@0222;else y=@00d8;
  $  022.电机零位检验状态                            $    $           $    $  ANS022.BYTE004  $  if(x1==0) y=@021e;else if(x1==1) y=@021f;else if(x1==2) y=@0220;else if(x1==3) y=@0015;else y=@00d8;
  $  023.电机编号                                    $    $           $    $  ANS023.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10);
  $  024.电机流水号                                  $    $           $    $  ANS023.BYTE016  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9);
  $  025.前驱A相结温温度                             $    $  ℃       $    $  ANS024.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  026.前驱B相结温温度                             $    $  ℃       $    $  ANS024.BYTE006  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  027.前驱C相结温温度                             $    $  ℃       $    $  ANS024.BYTE008  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  028.电机温度传感器故障                          $    $           $    $  ANS025.BYTE004  $  if((x2*256+x1)==0) y=@0078;else if((x2*256+x1)==1) y=@021c;else if((x2*256+x1)==2) y=@021d;else if((x2*256+x1)==3) y=@007b;else y=@0001;
