...
读数据流: 
  ...
  $  001.车速                     $    $  Km/h      $    $  ANS001.BYTE004  $  y=(x1*256+x2);
  $  002.偏航率                   $    $  Deg/s     $    $  ANS002.BYTE004  $  y=SPRINTF([%.2f],(x1*256+x2)*0.02);
  ...
  $  009.主副雷达下线标定值       $    $            $    $  ANS009.BYTE004  $  y=SPRINTF([%02X%02X%02X%02X%02X%02X%02X%02X],x1,x2,x3,x4,x5,x6,x7,x8);
