...
读数据流: 
  ...
  $  065.真空泵控制回路#1                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x07)0x00: y=@0606;0x01: y=@0606;0x02: y=@0214;0x03: y=@0214;0x04: y=@0078;0x05: y=@0078;default:y=@0003;
  $  066.真空泵控制回路#2                            $    $               $    $  ANS000.BYTE020  $  if((x1&0x1F)<0x08)y=@0606;else if((x1&0x1F)<0x10)y=@0214;else if((x1&0x1F)<0x18)y=@0078;else y=@0003;
  $  067.真空泵泄露状态                              $    $               $    $  ANS000.BYTE020  $  if((x1&0x7F)<0x20)y=@0606;else if((x1&0x7F)<0x40)y=@08a9;else if((x1&0x7F)<0x60)y=@049a;else y=@0078;
  $  068.低速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x01)y=@0185;else y=@0186;
  $  069.高速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x02)y=@0185;else y=@0186;
  $  070.风扇类型                                    $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@0194;else if((x1&0x0F)<0x08)y=@09c4;else y=@007b;
  ...
  $  073.发动机稳态工况-燃油泵状态                   $    $               $    $  ANS000.BYTE024  $  if(x1&0x04) y = @001d;else y = @001e;
  $  074.发动机动态工况-节气门处于怠速位置           $    $               $    $  ANS000.BYTE025  $  if(x1&0x01)y=@0185;else y=@0186;
  $  075.发动机动态工况-节气门处于部分打开位置       $    $               $    $  ANS000.BYTE025  $  if(x1&0x02)y=@0185;else y=@0186;
  $  076.发动机动态工况-节气门处于全开位置           $    $               $    $  ANS000.BYTE025  $  if(x1&0x04)y=@0185;else y=@0186;
  $  077.发动机动态工况-激活减速断油                 $    $               $    $  ANS000.BYTE025  $  if(x1&0x08)y=@00f2;else y=@0181;
  $  078.发动机动态工况-激活加速加浓                 $    $               $    $  ANS000.BYTE025  $  if(x1&0x10)y=@00f2;else y=@0181;
  $  079.发动机动态工况-D档                          $    $               $    $  ANS000.BYTE025  $  if(x1&0x20)y=@0185;else y=@0186;
  $  080.发动机动态工况-R档                          $    $               $    $  ANS000.BYTE025  $  if(x1&0x40)y=@0185;else y=@0186;
  $  081.发动机动态工况-N档                          $    $               $    $  ANS000.BYTE025  $  if(x1&0x80)y=@0185;else y=@0186;
  $  082.氧传感器1信号                               $    $               $    $  ANS000.BYTE027  $  if(x1&0x01)y=@0180;else y=@017f;
  $  083.氧传感器2信号                               $    $               $    $  ANS000.BYTE027  $  if(x1&0x02)y=@0180;else y=@017f;
  $  084.氧传感器1加热                               $    $               $    $  ANS000.BYTE027  $  if(x1&0x10)y=@0183;else y=@0184;
  $  085.氧传感器2加热                               $    $               $    $  ANS000.BYTE027  $  if(x1&0x20)y=@0183;else y=@0184;
  $  086.发动机怠速-制动踏板状态                     $    $               $    $  ANS000.BYTE028  $  if(x1&0x02)y=@0118;else y=@0182;
  $  087.MIL(故障指示灯)激活                         $    $               $    $  ANS000.BYTE029  $  if(x1&0x01)y=@00f2;else y=@0181;
  $  088.MIL(故障指示灯)闪烁                         $    $               $    $  ANS000.BYTE029  $  if(x1&0x02)y=@0185;else y=@0186;
  $  089.SVS(系统维修指示灯)激活                     $    $               $    $  ANS000.BYTE029  $  if(x1&0x10)y=@00f2;else y=@0181;
  $  090.SVS(系统维修指示灯)闪烁                     $    $               $    $  ANS000.BYTE029  $  if(x1&0x20)y=@0185;else y=@0186;
  $  091.AT/扭矩请求-AT转换离合器激活                $    $               $    $  ANS000.BYTE032  $  if(x1&0x08)y=@00f2;else y=@0181;
  $  092.发动机状态-刹车开关激活                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x01)y=@00f2;else y=@0181;
  $  093.发动机状态-刹车灯激活                       $    $               $    $  ANS000.BYTE034  $  if(x1&0x02)y=@00f2;else y=@0181;
  $  094.发动机状态-水泵继电器状态                   $    $               $    $  ANS000.BYTE034  $  if(x1&0x08) y = @001d;else y = @001e;
  $  095.发动机状态-涡轮增压旁通阀                   $    $               $    $  ANS000.BYTE034  $  if(x1&0x10)y=@001d;else y=@001e;
  $  096.发动机状态-防盗锁定状态                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x20)y=@000a;else y=@0459;
