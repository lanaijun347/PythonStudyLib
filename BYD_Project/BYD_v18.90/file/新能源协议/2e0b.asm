...
读数据流: 
  ...
  $  REQ002:7D4 03 22 F1 A1 00 00 00 00       $  ANS002:7DC 03 22 F1 A1 00 00 00 00

  $  000.静态标定状态         $    $       $    $  ANS000.BYTE004  $  switxh(x1)0x01: y=@00fa;0x02: y=@00fb;0x03: y=@00fc;default: y=@0001;
  $  001.静态标定角度值       $    $       $    $  ANS000.BYTE005  $  y=SPRINTF([%.2f],(x1*256+x2)/100);
  $  002.动态标定状态         $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x01: y=@00f6;0x02: y=@00f7;0x03: y=@00f8;0x04: y=@00f9;default: y=@0001;
  $  003.动态标定角度值       $    $       $    $  ANS001.BYTE005  $  y=SPRINTF([%.2f],(x1*256+x2)/100);
  $  004.读取配置成功         $    $       $    $  ANS002.BYTE004  $  HEX(x1,x2,x3,x4,x5,x6,x7,x8);
