...
进入命令:
  ...
  $~  REQ001:7B6 02 10 01 00 00 00 00 00       $~  ANS001:7BE 02 10 01 00 00 00 00 00
...
读数据流: 
  ...
  $  000.AVAS(引擎音模拟器)工作状态       $    $       $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@0001;
  $  001.AVAS(引擎音模拟器)开关状态       $    $       $    $  ANS001.BYTE004  $  if(x1==0x00) y = @00d9;else if(x1==0x01) y = @001e;else y = @0001;
  $  002.音源类型                         $    $       $    $  ANS002.BYTE004  $  if(x1==0x00) y = @00d5;else if(x1==0x01) y = @00d6;else if(x1==0x02) y = @00d7;else if(x1==0x03) y = @00d8;else y = @0001;
  $  003.法规类型                         $    $       $    $  ANS003.BYTE004  $  if(x1==0x00) y = @00d1;else if(x1==0x01) y = @00d2;else if(x1==0x02) y = @00d3;else if(x1==0x03) y = @00d4;else y = @0001;
