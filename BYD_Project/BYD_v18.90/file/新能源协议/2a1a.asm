...
读数据流: 
  ...
  $  026.充放电系统工作状态                        $    $               $    $  ANS026.BYTE004  $  switxh(x1)0x00: y=@025c;0x01: y=@05f7;0x02: y=@01da;0x03: y=@01db;0x04: y=@025e;0x05: y=@025f;0x06: y=@0260;0x07: y=@0261;0x08: y=@0262;0x09: y=@0263;0x0A: y=@05f8;default: y=@0001;
  $  027.充电连接装置连接状态                      $    $               $    $  ANS027.BYTE004  $  switxh(x1)0x00: y=@0254;0x01: y=@04cb;0x02: y=@0257;default: y=@0001;
  $  028.交流充电继电器动作请求命令                $    $               $    $  ANS028.BYTE004  $  switxh(x1)0x00: y=@01c7;0x01: y=@0498;default: y=@0001;
  $  029.SCI通讯状态                               $    $               $    $  ANS029.BYTE004  $  switxh(x1)0x00: y=@014c;0x01: y=@0167;default: y=@0001;
  $  030.充放电系统故障状态                        $    $               $    $  ANS030.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@05fb;0x02: y=@04c4;0x03: y=@04c5;0x04: y=@01dd;0x05: y=@04c7;0x06: y=@04c8;0x07: y=@04c9;0x08: y=@04ca;default: y=@0001;
  ...
  $  041.充电方式                                  $    $               $    $  ANS041.BYTE004  $  switxh(x1)0x00: y=@08c3;0x02: y=@08c4;default: y=@0001;
  $  042.充电设备允许最大电流                      $    $  A            $    $  ANS042.BYTE004  $  y=x1;
  $  043.直流侧充电电流目标值                      $    $  A            $    $  ANS043.BYTE004  $  y=x1;
  $  044.充电口电锁请求                            $    $               $    $  ANS044.BYTE004  $  switxh(x1)0x00: y=@05fe;0x01: y=@000a;default: y=@0001;
  $  045.OBC(车载充电器)充放电请求                 $    $               $    $  ANS045.BYTE004  $  switxh(x1)0x00: y=@01c7;0x01: y=@08c2;0x02: y=@01cc;0x03: y=@01c8;default: y=@0001;
  ...
  $  061.充电S2开关吸合标志                        $    $               $    $  ANS061.BYTE004  $  switxh(x1)0x00: y=@002a;0x01: y=@002b;default: y=@0001;
  $  062.发送CP标志位                              $    $               $    $  ANS062.BYTE004  $  switxh(x1)0x00: y=@08c0;0x01: y=@08c1;default: y=@0001;
  $  063.驱动电机系统配置类型                      $    $               $    $  ANS063.BYTE004  $  switxh(x1)0x00: y=@08bd;0x01: y=@08be;default: y=@0001;
  $  064.倾角传感器是否校准                        $    $               $    $  ANS064.BYTE004  $  switxh(x1)0x00: y=@015e;0x01: y=@08bf;default: y=@0001;
  $  065.倾角传感器信息状态                        $    $               $    $  ANS065.BYTE004  $  switxh(x1)0x00: y=@0167;0x01: y=@0078;default: y=@0001;
  ...
  $  070.降压模块状态                              $    $               $    $  ANS070.BYTE004  $  switxh(x1)0x00: y=@0415;0x01: y=@042c;0x02: y=@042d;0x03: y=@042e;default: y=@0001;
  $  071.升降压DC模块故障                          $    $               $    $  ANS071.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@0001;
