...
进入命令:
  ...
  $~  REQ001:787 02 10 01 00 00 00 00 00       $~  ANS001:78E 02 10 01 00 00 00 00 00
...
读数据流: 
  ...
  $  001.巡航按键故障标志位       $    $       $    $  ANS001.BYTE004  $  if(x1==0x01)y=@04df;else if(x1==0x02)y=@04e0;else y=@0001;
  $  002.故障检测标志位           $    $       $    $  ANS002.BYTE004  $  if(x1==0x00)y=@007b;else if(x1==0x01)y=@03a7;else if(x1==0x02)y=@03a8;else if(x1==0x03)y=@03a9;else if(x1==0x04)y=@03aa;else if(x1==0x05)y=@03ab;else if(x1==0x06)y=@03ac;else y=@0001;
  $  003.故障监测持续判断         $    $       $    $  ANS003.BYTE004  $  if(x==0x01) y=@03a3; else if(x==0x02) y=@03a4; else if(x==0x03)  y=@03a5; else if(x==0x04)  y=@03a6; else y=@0001;
  $  004.自身识别档位信号         $    $       $    $  ANS004.BYTE004  $  if(x==0x00) y=@03a2; else if(x==0x01) y=@013a; else if(x==0x02) y=@010d; else if(x==0x03) y=@010e; else if(x==0x04) y=@013b; else y=@0001;
