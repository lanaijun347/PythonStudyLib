...
读取故障码:
  ...
  $#  REQ000:7E3 04 18 00 00 00 00 00 00       $#  ANS000:7EB 04 18 00 00 00 00 00 00
...
清除故障码:
  ...
  $$  REQ000:7E3 03 14 00 00 00 00 00 00       $$  ANS000:7EB 03 14 00 00 00 00 00 00
...
版本信息:
  ...
  $%  REQ001:7E3 03 22 00 03 00 00 00 00       $%  ANS001:7EB 03 22 00 03 00 00 00 00
