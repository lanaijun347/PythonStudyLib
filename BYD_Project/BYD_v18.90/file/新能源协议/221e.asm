...
读数据流: 
  ...
  $  019.前驱动电机零位值                            $    $               $    $  ANS019.BYTE004  $  y=SPRINTF([%0X %0X],x2,x1);
  ...
  $  024.前驱A相结温温度                             $    $  degree C     $    $  ANS023.BYTE004  $  y=((x2<<8)+x1)-40;
  $  025.前驱B相结温温度                             $    $  degree C     $    $  ANS023.BYTE006  $  y=((x2<<8)+x1)-40;
  $  026.前驱C相结温温度                             $    $  degree C     $    $  ANS023.BYTE008  $  y=((x2<<8)+x1)-40;
