...
版本信息:
  ...
  $%  006:MCU:                          $%    $%  ANS003.BYTE004  $%  switxh(x1)0x51: y=@0227;default: y=@020c;
...
读数据流: 
  ...
  $  000.MCU(驱动电机控制器)                                  $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x51: y=@0227;default: y=@020c;
  $  001.压缩机控制状态                                       $    $               $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@001c;0x01: y=@004e;default: y=@0001;
  $  002.压缩机实际状态                                       $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@001c;0x01: y=@004e;default: y=@0001;
  $  003.压缩机目标转速                                       $    $  rpm          $    $  ANS003.BYTE004  $  y=(x1<<8)+x2;
  $  004.压缩机实际转速                                       $    $  rpm          $    $  ANS004.BYTE004  $  y=(x1<<8)+x2;
  $  005.母线电压                                             $    $  V            $    $  ANS005.BYTE004  $  y=(x1<<8)+x2;
  $  006.母线电流                                             $    $  A            $    $  ANS006.BYTE004  $  y=x1*0.125;
  $  007.压缩机当前功率                                       $    $  W            $    $  ANS007.BYTE004  $  y=(x1<<8)+x2;
  $  008.IPM(智能功率模块)/IGBT(绝缘栅双极型晶体管)温度       $    $  degree C     $    $  ANS008.BYTE004  $  y=x1-100;
