...
读数据流: 
  ...
  $  000.前制动回路气压信号       $    $  Mpa     $    $  ANS000.BYTE004  $  if((x>0x64)||(x==0x00))y=@00d8;else y=0.01*x;
  $  001.前制动回路气压           $    $          $    $  ANS001.BYTE004  $  if(x==0x00)y=@0078;else if(x==0x01)y=@0513;else if(x==0x02)y=@0474;else y=@00d8;
  $  002.后制动回路气压信号       $    $  Mpa     $    $  ANS002.BYTE004  $  if((x>0x64)||(x==0x00))y=@00d8;else y=0.01*x;
  $  003.后制动回路气压           $    $          $    $  ANS003.BYTE004  $  if(x==0x00)y=@0078;else if(x==0x01)y=@0513;else if(x==0x02)y=@0474;else y=@00d8;
  $  004.制动踏板状态             $    $          $    $  ANS004.BYTE004  $  if(x==0x00)y=@0117;else if(x==0x01)y=@0487;else y=@00d8;
  $  005.驻车信号                 $    $          $    $  ANS005.BYTE004  $  if(x==0x00)y=@0117;else if(x==0x01)y=@0168;else y=@00d8;
  $  006.故障检测标志位           $    $          $    $  ANS006.BYTE004  $  if(x==0x01)y=@0514;else if(x==0x02)y=@0515;else if(x==0x03)y=@0516;else y=@00d8;
  $  007.请求档位                 $    $          $    $  ANS007.BYTE004  $  if(x==0x01)y=@013a;else if(x==0x02)y=@010d;else if(x==0x03)y=@010e;else if(x==0x04)y=@013b;else if(x==0x05)y=@0512;else y=@00d8;
