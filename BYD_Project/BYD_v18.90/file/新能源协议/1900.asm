...
读数据流: 
  ...
  $  004.车外温度                     $    $  degree C     $    $  ANS004.BYTE004  $  if(((x1-128) > 0-41) && ((x1-128) <51)) y=x1-128;else y = @0001;
  $  005.车内温度                     $    $  degree C     $    $  ANS005.BYTE004  $  if(((x1-128) > 0-41) && ((x1-128) <80)) y=x1-128;else y = @0001;
