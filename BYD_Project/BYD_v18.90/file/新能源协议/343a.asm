...
读数据流: 
  ...
  $  001.冷凝风扇工作状态                    $    $         $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0345;0x02: y=@0346;0x03: y=@0347;default: y=@0202;
  $  002.冷却风扇工作状态                    $    $         $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0345;0x02: y=@0346;0x03: y=@0347;default: y=@0202;
  $  003.电源电压                            $    $  V      $    $  ANS003.BYTE004  $  if((x1>=0)&&(x1<=250)) y=SPRINTF([%.2f],x1*0.125);else if(x1==255) y=@0344;else y=@0202;
  $  004.冷凝风扇实际工作的占空比            $    $  %      $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@006d;else if(x1==255) y=@0344;else y=@0202;
  $  005.冷却风扇实际工作的占空比            $    $  %      $    $  ANS005.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@006d;else if(x1==255) y=@0344;else y=@0202;
  $  006.冷凝/冷却风扇预置工作的占空比       $    $  %      $    $  ANS006.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@006d;else if(x1==255) y=@0344;else y=@0202;
  $  007.模块温度                            $    $  ℃     $    $  ANS007.BYTE004  $  if((x1>=0)&&(x1<=210)) y=x1-40;else if(x1==255) y=@0344;else y=@0001;
  $  008.电源档位                            $    $  ℃     $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@007b;0x01: y=@0348;0x02: y=@0349;0x03: y=@034a;default: y=@0202;

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:707 30 08 05 00 00 00 00 00  $FC 
