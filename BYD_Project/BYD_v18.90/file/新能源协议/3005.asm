...
读数据流: 
  ...
  $  000.后驱动电机状态                     $    $           $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0179;0x01: y=@017a;0x02: y=@017b;default: y=@0001;
  ...
  $  013.桥臂状态                           $    $           $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@017c;0x02: y=@017d;0x03: y=@017e;default: y=@0001;
