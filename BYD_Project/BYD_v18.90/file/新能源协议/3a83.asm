...
读数据流: 
  ...
  $  001.管柱调节信号下倾信号               $    $        $    $  ANS000.BYTE004  $  if(x1&0x02) y=@001d;else y=@001e;
  ...
  $  006.电源档位状态                       $    $        $    $  ANS000.BYTE005  $  switxh(x1&0x03)0x00: y=@001d;0x01: y=@0011;0x02: y=@001e;default: y=@0001;
