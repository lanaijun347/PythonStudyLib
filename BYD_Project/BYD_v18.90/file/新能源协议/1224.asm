...
读数据流: 
  ...
  $  003.座椅水平向前调节按键开关次数       $    $       $    $  ANS001.BYTE004  $  if((x1+x2*256)<50001) y =x1+x2*256;else y = @0000;
  $  004.座椅水平向后调节按键开关次数       $    $       $    $  ANS001.BYTE006  $  if((x1+x2*256)<50001) y =x1+x2*256;else y = @0000;
  $  005.靠背前倾调节按键开关次数           $    $       $    $  ANS002.BYTE004  $  if((x1+x2*256)<50001) y =x1+x2*256;else y = @0000;
  $  006.靠背后倾调节按键开关次数           $    $       $    $  ANS002.BYTE006  $  if((x1+x2*256)<50001) y =x1+x2*256;else y = @0000;
  $  007.座椅高度上调按键开关次数           $    $       $    $  ANS003.BYTE004  $  if((x1+x2*256)<50001) y =x1+x2*256;else y = @0000;
  $  008.座椅高度下调按键开关次数           $    $       $    $  ANS003.BYTE006  $  if((x1+x2*256)<50001) y =x1+x2*256;else y = @0000;
  $  009.座盆向上调节按键开关次数           $    $       $    $  ANS004.BYTE004  $  if((x1+x2*256)<50001) y =x1+x2*256;else y = @0000;
  $  010.座盆向下调节按键开关次数           $    $       $    $  ANS004.BYTE006  $  if((x1+x2*256)<50001) y =x1+x2*256;else y = @0000;
