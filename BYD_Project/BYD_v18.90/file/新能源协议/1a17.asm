...
读数据流: 
  ...
  $  021.车辆前行方向                                $    $               $    $  ANS012.BYTE006  $  if(x1==0) y=@0169; else if(x1==1) y=@016a; else y = @0001;
  $  022.换挡手柄                                    $    $               $    $  ANS013.BYTE004  $  if(x1==0) y=@0105;else if(x1==1) y=@010f; else if(x1==2) y=@0110;else if(x1==3) y=@0111; else if(x1==4) y=@0112;else if(x1==5) y=@0113;else if(x1==6) y=@0114; else if(x1==7) y=@0115;else if(x1==8) y=@0116; else y=@0001;
  $  023.换杆挡状态                                  $    $               $    $  ANS013.BYTE005  $  if(x1==0) y=@0078; else if(x1==1) y=@0027; else y = @0001;
  $  024.当前档位                                    $    $               $    $  ANS013.BYTE006  $  if(x1==0) y=@0105;else if(x1==1) y=@0106; else if(x1==2) y=@0107;else if(x1==3) y=@0108; else if(x1==4) y=@0109;else if(x1==5) y=@010a;else if(x1==6) y=@010b; else if(x1==7) y=@010c; else if(x1==8) y=@010d;else if(x1==9) y=@010e;else y=@0001;
  ...
  $  033.EPB(电子驻车)状态                           $    $               $    $  ANS018.BYTE004  $  if(x1==0) y=@0102; else if(x1==1) y=@0165; else if(x1==2) y=@0166;else if(x1==3) y=@0166;else if(x1==4) y=@0167;else y=@0001;
  ...
  $  040.读取遥控驾驶状态                            $    $               $    $  ANS022.BYTE004  $  if(x1==0) y=@0078; else if(x1==1)y=@0164; else y=@0001;
  $  041.促动阀1位置传感器                           $    $  mm           $    $  ANS023.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  042.促动阀3位置传感器                           $    $  mm           $    $  ANS024.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  043.促动器阀1开关状态                           $    $               $    $  ANS025.BYTE004  $  if(x1==0) y=@0172; else if(x1==1) y=@0173; else y = @0001;
  $  044.促动器阀2开关状态                           $    $               $    $  ANS026.BYTE004  $  if(x1==0) y=@0172; else if(x1==1) y=@0173; else y = @0001;
  $  045.促动器1中位位置                             $    $               $    $  ANS027.BYTE004  $  y=x1*256+x2;
  $  046.促动器3中位位置                             $    $               $    $  ANS028.BYTE004  $  y=x1*256+x2;
  $  047.多路阀开关状态                              $    $               $    $  ANS029.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@0172; else if((x1==0x00)&&(x2==0x01)) y=@0173; else y = @0001;
  $  048.促动器2位置传感器                           $    $  mm           $    $  ANS030.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  049.促动器4位置传感器                           $    $  mm           $    $  ANS031.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  050.促动器阀3开关状态                           $    $               $    $  ANS032.BYTE004  $  if(x1==0) y=@0172; else if(x1==1) y=@0173; else y = @0001;
  $  051.促动器阀4开关状态                           $    $               $    $  ANS033.BYTE004  $  if(x1==0) y=@0172; else if(x1==1) y=@0173; else y = @0001;
  ...
  $  075.整车工作模式                                $    $               $    $  ANS050.BYTE004  $  if(x1==0x00) y=@001c; else if(x1==0x01) y=@016b; else if(x1==0x02) y=@016c; else if(x1==0x03) y=@016d; else if(x1==0x04) y=@016e;else if(x1==0x05) y=@016f;else if(x1==0x06) y=@0170;else if(x1==0x07) y=@0171;else y = @0001;
  $  076.离合器强制脱开                              $    $               $    $  ANS050.BYTE005  $  if(x1==0) y=@011e; else if(x1==1) y=@011f; else y = @0001;
  $  077.离合器强制脱开命令有效标识位                $    $               $    $  ANS050.BYTE006  $  if(x1==0) y=@0003; else if(x1==1) y=@0002; else y = @0001;
