...
读数据流: 
  ...
  $  011.前刮水器INT(间歇)开关            $    $       $    $  ANS001.BYTE004  $  switxh(x1&0x70)0x00: y=@02a4;0x10: y=@02a5;0x20: y=@02a6;0x30: y=@02a7;0x40: y=@003e;default: y=@0001;
  ...
  $  014.回家照明功能时间                 $    $       $    $  ANS002.BYTE004  $  switxh(x1&0x07)0x00: y=@0973;0x01: y=@0845;0x02: y=@0846;0x03: y=@0847;0x04: y=@0848;0x05: y=@0849;0x06: y=@084a;default: y=@0001;
  $  015.离家照明功能时间                 $    $       $    $  ANS002.BYTE004  $  switxh(x1&0x38)0x00: y=@0974;0x08: y=@084c;0x10: y=@084d;0x18: y=@084e;0x20: y=@084f;0x28: y=@0850;0x30: y=@0851;default: y=@0001;
