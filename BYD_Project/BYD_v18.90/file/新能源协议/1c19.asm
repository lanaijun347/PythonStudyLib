...
版本信息:
  ...
  $%  007:PTC(辅助加热)生产日期:        $%    $%  ANS003.BYTE007  $%  y=SPRINTF([%02d/%02d/%02d],x1,x2,x3);
...
读数据流: 
  ...
  $  000.压缩机控制状态                                       $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@001c;else if(x1==0x01)y=@004e;else y=@0001;
  $  001.压缩机实际状态                                       $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@001c;else if(x1==0x01)y=@004e;else y=@0001;
