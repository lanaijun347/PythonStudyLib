...
读数据流: 
  ...
  $  004.水加热器冷却液温度            $    $  ℃     $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=120)) y=x1;else if(x1==208) y=@0284;else if(x1==216) y=@0285;else y=@0001;
  $  005.12V 低压电源值                $    $  V      $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.1);
  $  006.负载高压电源值                $    $  V      $    $  ANS006.BYTE004  $  y=(x1*256+x2);
  $  007.负载电流值                    $    $  A      $    $  ANS007.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.1);
