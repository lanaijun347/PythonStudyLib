...
读数据流: 
  ...
  $  000.发动机允许信号               $    $               $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0196;0x01: y=@0195;default: y=@0001;
  $  001.风速                         $    $  级           $    $  ANS001.BYTE004  $  y=x1;
  $  002.送风模式                     $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@006d;0x01: y=@006e;0x02: y=@006f;0x03: y=@0070;0x04: y=@0071;0x05: y=@0072;default: y=@0001;
  $  003.AC(空调控制器)状态           $    $               $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0843;0x01: y=@0524;default: y=@0001;
  $  004.车外温度                     $    $  degree C     $    $  ANS004.BYTE004  $  if((x1>=88)&&(x1<=178))y=x1-128;else if((x1==208)) y=@0001;else if((x1==216)) y=@0001;else y=@0001;
  $  005.车内温度                     $    $  degree C     $    $  ANS005.BYTE004  $  if((x1>=88)&&(x1<=207))y=x1-128;else if((x1==208)) y=@0001;else if((x1==216)) y=@0001;else y=@0001;
  $  006.蒸发器温度                   $    $  degree C     $    $  ANS006.BYTE004  $  y=x1;
  $  007.AC(空调控制器)请求状态       $    $               $    $  ANS007.BYTE004  $  switxh(x1)0x00: y=@0044;0x01: y=@003f;default: y=@0001;
  $  008.压力状态                     $    $               $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@0001;
