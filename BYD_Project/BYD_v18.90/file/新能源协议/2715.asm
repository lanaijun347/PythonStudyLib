...
读数据流: 
  ...
  $  004.电源电压                            $    $  V            $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=250))y=x1*0.125;else if((x1==255)) y=@0027;else y=@0001;
  $  005.冷凝风扇实际工作的占空比            $    $  %            $    $  ANS005.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@006d;else if((x1==255)) y=@0027;else y=@0001;
  $  006.冷却风扇实际工作的占空比            $    $  %            $    $  ANS006.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@006d;else if((x1==255)) y=@0027;else y=@0001;
  $  007.冷凝/冷却风扇预置工作的占空比       $    $  %            $    $  ANS007.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@006d;else if((x1==255)) y=@0027;else y=@0001;
  $  008.电机散热风扇预置工作的占空比        $    $  %            $    $  ANS008.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1>=101)&&(x1<=254)) y=@006d;else if((x1==255)) y=@0027;else y=@0001;
  $  009.模块温度                            $    $  degree C     $    $  ANS009.BYTE004  $  if((x1>=0)&&(x1<=210))y=x1-40;else if((x1==255)) y=@0027;else y=@0001;
  $  010.电源档位                            $    $  degree C     $    $  ANS010.BYTE004  $  if(x1&0x01) y=@0348;else y=@007b;
