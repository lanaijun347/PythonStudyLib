...
读数据流: 
  ...
  $  000.左近光灯工作时长       $    $  h     $    $  ANS000.BYTE004  $  y=(x1*256+x2);
  $  001.左远光灯工作时长       $    $  h     $    $  ANS001.BYTE004  $  y=(x1*256+x2);
  $  002.左位置灯工作时长       $    $  h     $    $  ANS002.BYTE004  $  y=(x1*256+x2);
  $  003.左昼行灯工作时长       $    $  h     $    $  ANS003.BYTE004  $  y=(x1*256+x2);
  $  004.左角灯工作时长         $    $  h     $    $  ANS004.BYTE004  $  y=(x1*256+x2);
  $  005.左前雾灯工作时长       $    $  h     $    $  ANS005.BYTE004  $  y=(x1*256+x2);
  $  006.左转向灯工作时长       $    $  h     $    $  ANS006.BYTE004  $  y=(x1*256+x2);

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:770 30 01 05 00 00 00 00 00  $FC 
