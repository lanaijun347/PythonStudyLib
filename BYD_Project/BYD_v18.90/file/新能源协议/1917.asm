...
读数据流: 
  ...
  $  014.启动状态                                             $    $               $    $  ANS009.BYTE005  $  if(x1&0x01) y = @0087;else y = @0078;
  $  015.内部温度状态                                         $    $               $    $  ANS009.BYTE005  $  if((x1&0x07)==0x02) y = @007e;else if((x1&0x07)==0x04) y = @007f;else if((x1&0x07)==0x06) y = @007b;else y = @0078;
  $  016.转速状态                                             $    $               $    $  ANS009.BYTE005  $  if(x1&0x08) y = @0087;else y = @0078;
  $  017.压缩机负载状态                                       $    $               $    $  ANS009.BYTE005  $  if((x1&0x30)==0x10) y = @007e;else if((x1&0x30)==0x20) y = @007f;else if((x1&0x30)==0x30) y = @007b;else y = @0078;
