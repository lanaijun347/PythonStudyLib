...
读数据流: 
  ...
  $  003.右侧散热片温度                $    $  degree C     $    $  ANS003.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if((x1==208)) y=@0284;else if((x1==216)) y=@0285;else y=@0001;
  $  004.冷却液温度                    $    $  degree C     $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if((x1==208)) y=@0284;else if((x1==216)) y=@0285;else y=@0001;
  $  005.低压侧电源                    $    $  V            $    $  ANS005.BYTE004  $  y=((x1<<8)+x2)*0.1;
  $  006.高压侧电源                    $    $  V            $    $  ANS006.BYTE004  $  y=(x1<<8)+x2;
  $  007.负载电流                      $    $  A            $    $  ANS007.BYTE004  $  y=((x1<<8)+x2)*0.1;
  $  008.PTC(辅助加热)消耗功率         $    $  W            $    $  ANS008.BYTE004  $  y=(x1<<8)+x2;
  $  009.PTC(辅助加热)控制板温度       $    $  degree C     $    $  ANS009.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if((x1==208)) y=@0284;else if((x1==216)) y=@0285;else y=@0001;
