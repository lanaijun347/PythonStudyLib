...
读数据流: 
  ...
  $  000.放电是否允许                        $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0195;else if(x1==0x01)y=@0196;else if(x1==0x02)y=@0a0e;else if(x1==0x03)y=@01d3;else y=@0001;
  $  001.DC系统故障状态                      $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@0001;
  $  002.DC工作模式                          $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@01d4;else if(x1==0x01)y=@01d6;else if(x1==0x02)y=@01d5;else y=@0001;
  ...
  $  007.MOS(金属—绝缘体半导体)管温度       $    $  degree C     $    $  ANS007.BYTE004  $  y=x1-40;
