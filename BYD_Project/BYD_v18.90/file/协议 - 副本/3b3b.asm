...
读数据流: 
  ...
  $  000.电机开启状态                           $    $          $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@001e;0x01: y=@00d9;default: y=@0001;
  $  001.制动踏板状态状态                       $    $          $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0117;0x01: y=@05ea;default: y=@0001;
  ...
  $  019.与ABS(防抱死刹车系统)通讯状态          $    $          $    $  ANS019.BYTE004  $  switxh(x1)0x00: y=@00c9;0x01: y=@00d8;0x02: y=@05e7;default: y=@0001;
  ...
  $  026.动力电机母线电压                       $    $  V       $    $  ANS026.BYTE004  $  y=SPRINTF([%d],x1*2);
  $  027.动力电机转速                           $    $  rpm     $    $  ANS027.BYTE004  $  y=SPRINTF([%d],11000-(x2*256+x1));
  $  028.电机扭矩                               $    $  Nm      $    $  ANS028.BYTE004  $  y=SPRINTF([%d],((x2*256+x1)-5000)/10);
  $  029.电机功率                               $    $  Kw      $    $  ANS029.BYTE004  $  y=SPRINTF([%.1f],((x2*256+x1)-2000)/10);
  $  030.动力电机温度                           $    $  ℃      $    $  ANS030.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  031.IGBT(绝缘栅双极型晶体管)最高温度       $    $  ℃      $    $  ANS031.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  032.电感最高温度                           $    $  ℃      $    $  ANS032.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  033.IPM(智能功率模块)散热器温度            $    $  ℃      $    $  ANS033.BYTE004  $  y=SPRINTF([%d],x1-40);
  ...
  $  039.充电母线电压                           $    $  V       $    $  ANS039.BYTE004  $  y=(x2*256+x1);
  $  040.充电直流侧电流                         $    $  A       $    $  ANS040.BYTE004  $  y=x1;
  $  041.控制器充电功率比                       $    $  kW      $    $  ANS041.BYTE004  $  y=SPRINTF([%.1f],(x2*256+x1)*0.1);
  $  042.电网交流频率                           $    $  Hz      $    $  ANS042.BYTE004  $  y=SPRINTF([%.1f],(x2*256+x1)*0.1);
  $  043.交流A相电压                            $    $  V       $    $  ANS043.BYTE004  $  y=(x2*256+x1);
  $  044.交流B相电压                            $    $  V       $    $  ANS044.BYTE004  $  y=(x2*256+x1);
  $  045.交流C相电压                            $    $  V       $    $  ANS045.BYTE004  $  y=(x2*256+x1);
  ...
  $  050.当前电制频率                           $    $  Hz      $    $  ANS050.BYTE004  $  switxh(x1)0x00: y=@05f9;0x01: y=@05fa;default: y=@0001;
  ...
  $  053.线电压                                 $    $  V       $    $  ANS053.BYTE004  $  y=(x2*256+x1);
