...
读数据流: 
  ...
  $  067.车辆禁止停止                              $    $               $    $  ANS040.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0865;0x01: y=@0866;0x02: y=@0867;0x03: y=@0868;0x04: y=@0869;0x05: y=@086a;0x06: y=@0893;0x07: y=@086c;0x08: y=@086d;0x09: y=@086e;0x0A: y=@007b;0x0B: y=@007b;0x0C: y=@086f;0x0D: y=@007b;0x0E: y=@0870;default: y=@0001;
  $  068.车辆禁止停止_1                            $    $               $    $  ANS040.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0865;0x01: y=@0866;0x02: y=@0867;0x03: y=@0868;0x04: y=@0869;0x05: y=@086a;0x06: y=@0893;0x07: y=@086c;0x08: y=@086d;0x09: y=@086e;0x0A: y=@007b;0x0B: y=@007b;0x0C: y=@086f;0x0D: y=@007b;0x0E: y=@0870;default: y=@0001;
  $  069.发动机禁止停止                            $    $               $    $  ANS041.BYTE004  $  switxh((x2<<8)+x1)0x06: y=@0864;default: y=@0001;
  $  070.发动机故障禁止停止                        $    $               $    $  ANS042.BYTE004  $  switxh((x2<<8)+x1)0x00: y=@0860;0x01: y=@0861;0x04: y=@0862;0x08: y=@0863;default: y=@0001;
