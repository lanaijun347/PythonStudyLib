...
读数据流: 
  ...
  $  009.A相IGBT(绝缘栅双极型晶体管)温度       $    $  ℃     $    $  ANS009.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  010.B相IGBT(绝缘栅双极型晶体管)温度       $    $  ℃     $    $  ANS010.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  011.C相IGBT(绝缘栅双极型晶体管)温度       $    $  ℃     $    $  ANS011.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)-40);
