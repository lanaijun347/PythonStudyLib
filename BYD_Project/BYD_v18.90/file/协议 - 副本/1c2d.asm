...
读数据流: 
  ...
  $  004.头枕高度调节                   $    $       $    $  ANS000.BYTE005  $  if((x1&0x03)==0x00) y = @001c;else if((x1&0x03)==0x01) y = @0318;else if((x1&0x03)==0x02) y = @0319;else if((x1&0x03)==0x03) y = @0001;
  $  005.头枕前后调节                   $    $       $    $  ANS000.BYTE005  $  if((x1&0x0C)==0x00) y = @001c;else if((x1&0x0C)==0x04) y = @0338;else if((x1&0x0C)==0x08) y = @0339;else if((x1&0x0C)==0x0C) y = @0001;
