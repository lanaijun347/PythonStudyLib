...
读数据流: 
  ...
  $  REQ000:702 03 22 00 06 00 00 00 00       $  ANS000:70A 03 22 00 06 00 00 00 00
  $  REQ001:702 03 22 00 07 00 00 00 00       $  ANS001:70A 03 22 00 07 00 00 00 00

  $  000.绝缘电阻阻值       $    $  KΩ     $    $  ANS000.BYTE004  $  y=(x2*256+x1);
  $  001.电压检测值         $    $  V       $    $  ANS001.BYTE004  $  y=(x2*256+x1);
