...
读数据流: 
  ...
  $  002.驻车开关状态                                $    $           $    $  ANS000.BYTE006  $  y=SPRINTF([%.3f],(x1*256+x2)*0.153-42.5);
  ...
  $  018.输入轴1转速                                 $    $  rpm      $    $  ANS010.BYTE004  $  if(x1<0x80) y=SPRINTF([%.2f],(x1*256+x2)*0.25);else y=SPRINTF([%.2f],((x1-256)*256+x2)*0.25);
