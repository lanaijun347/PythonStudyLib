...
进入命令:
  ...
  $~  REQ001:782 02 10 03 00 00 00 00 00       $~  ANS001:78A 02 10 03 00 00 00 00 00
...
版本信息:
  ...
  $%  006:系统名称:              $%    $%  ANS003.BYTE004  $%  ASCII(x1,x2,x3);
  $%  007:系统供应商名称:        $%    $%  ANS004.BYTE004  $%  ASCII(x1,x2,x3,x4,x5);
...
读数据流: 
  ...
  $  004.阀继电器电压(URV)       $    $  V        $    $  ANS001.BYTE004  $  y=x1*20.4/255;
  ...
  $  008.阀继电器状态            $    $           $    $  ANS002.BYTE005  $  if(x1&0x04)y=@001d;else y=@001e;
  ...
  $  024.限速失效监测            $    $           $    $  ANS005.BYTE004  $  if(x1==0x00)y=@0a0b;else if(x1==0x01)y=@0a0c;else y=@0001;
  $  025.车速信息                $    $  km/h     $    $  ANS006.BYTE004  $  y=x1*17.6+x2*18.00/255;
