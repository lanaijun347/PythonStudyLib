...
读数据流: 
  ...
  $  000.前驱动电机状态                     $    $               $    $  ANS000.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0179;else if((x1 == 0x01)&&(x2==0x00)) y = @0223;else if((x1 == 0x02)&&(x2==0x00)) y = @001e;else y = @0001;
  $  001.发动机启动命令                     $    $               $    $  ANS001.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @012f;else if((x1 == 0x01)&&(x2==0x00)) y = @0130;else y = @0001;
  $  002.离合器强制脱开命令                 $    $               $    $  ANS002.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0141;else if((x1 == 0x01)&&(x2==0x00)) y = @0142;else y = @0001;
  $  003.启动允许                           $    $               $    $  ANS003.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @013f;else if((x1 == 0x01)&&(x2==0x00)) y = @09b9;else y = @0001;
  $  004.防盗解除状态                       $    $               $    $  ANS004.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @013c;else if((x1 == 0x01)&&(x2==0x00)) y = @013d;else if((x1 == 0x02)&&(x2==0x00)) y = @09df;else y = @0001;
  $  005.主动泄放状态                       $    $               $    $  ANS005.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0215;else if((x1 == 0x01)&&(x2==0x00)) y = @0964;else if((x1 == 0x02)&&(x2==0x00)) y = @0217;else if((x1 == 0x03)&&(x2==0x00)) y = @0218;else y = @0001;
  $  006.盖子状态                           $    $               $    $  ANS006.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @001d;else if((x1 == 0x01)&&(x2==0x00)) y = @001e;else y = @0001;
  $  007.整车档位                           $    $               $    $  ANS007.BYTE004  $  if((x1 == 0x01)&&(x2==0x00)) y = @010f;else if((x1 == 0x02)&&(x2==0x00)) y = @0110;else if((x1 == 0x03)&&(x2==0x00)) y = @0111;else if((x1 == 0x04)&&(x2==0x00)) y = @0112;else y = @0001;
  $  008.整车工作模式                       $    $               $    $  ANS008.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @001c;else if((x1 == 0x01)&&(x2==0x00)) y = @011b;else if((x1 == 0x02)&&(x2==0x00)) y = @04a1;else if((x1 == 0x03)&&(x2==0x00)) y = @011d;else y = @0001;
  $  009.整车运行模式                       $    $               $    $  ANS009.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0a3e;else if((x1 == 0x01)&&(x2==0x00)) y = @0a3f;else y = @0001;
  $  010.动力系统状态                       $    $               $    $  ANS010.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @0167;else y = @0001;
  $  011.水泵状态                           $    $               $    $  ANS011.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @001d;else if((x1 == 0x01)&&(x2==0x00)) y = @001e;else y = @0001;
  $  012.巡航状态                           $    $               $    $  ANS012.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0931;else if((x1 == 0x01)&&(x2==0x00)) y = @0932;else y = @0001;
  ...
  $  018.刹车深度                           $    $  %            $    $  ANS018.BYTE004  $  if((x1 <101)&&(x2==0x00)) y = x1;else if((x1 == 0xFF)&&(x2==0x00)) y = @0a3a;else y = @0001;
  $  019.冷却液温度                         $    $  degree C     $    $  ANS019.BYTE004  $  y = (x2*256+x1)-40;
  $  020.IPM(智能功率模块)散热器温度        $    $  degree C     $    $  ANS020.BYTE004  $  y = (x2*256+x1)-40;
  ...
  $  029.OK灯信息                           $    $               $    $  ANS029.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0029;else if((x1 == 0x01)&&(x2==0x00)) y = @0028;else if((x1 == 0x02)&&(x2==0x00)) y = @0a39;else y = @0001;
  $  030.散热风扇占空比                     $    $  %            $    $  ANS030.BYTE004  $  y = (x2*256+x1);
  $  031.后驱防盗状态                       $    $               $    $  ANS031.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @013c;else if((x1 == 0x01)&&(x2==0x00)) y = @013d;else if((x1 == 0x02)&&(x2==0x00)) y = @09df;else y = @0001;
  $  032.EPB(电子驻车)状态                  $    $               $    $  ANS032.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0102;else if((x1 == 0x01)&&(x2==0x00)) y = @0117;else if((x1 == 0x02)&&(x2==0x00)) y = @0232;else if((x1 == 0x03)&&(x2==0x00)) y = @01ef;else if((x1 == 0x04)&&(x2==0x00)) y = @0167;else y = @0001;
  $  033.旋变状态                           $    $               $    $  ANS033.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @0167;else y = @0001;
  $  034.IPM(智能功率模块)状态              $    $               $    $  ANS034.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @0167;else y = @0001;
  $  035.过流状态                           $    $               $    $  ANS035.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @0167;else y = @0001;
  $  036.电里程                             $    $  km           $    $  ANS036.BYTE004  $  y = (x3*256*256+x2*256+x1);
  $  037.总里程                             $    $  km           $    $  ANS037.BYTE004  $  y = (x3*256*256+x2*256+x1);
  $  038.前驱电机系统配置类型               $    $               $    $  ANS038.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @03a0;else if((x1 == 0x01)&&(x2==0x00)) y = @0a36;else if((x1 == 0x02)&&(x2==0x00)) y = @0157;else y = @0001;
  $  039.发动机启动原因                     $    $               $    $  ANS039.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @05a8;else if((x1 == 0x02)&&(x2==0x00)) y = @0a2e;else if((x1 == 0x03)&&(x2==0x00)) y = @014d;else if((x1 == 0x04)&&(x2==0x00)) y = @0a2f;else if((x1 == 0x05)&&(x2==0x00)) y = @0a30;else if((x1 == 0x06)&&(x2==0x00)) y = @0a31;else if((x1 == 0x07)&&(x2==0x00)) y = @0a32;else if((x1 == 0x08)&&(x2==0x00)) y = @0a33;else if((x1 == 0x09)&&(x2==0x00)) y = @0a34;else if((x1 == 0x0A)&&(x2==0x00)) y = @0a35;else if((x1 == 0x0B)&&(x2==0x00)) y = @072e;else y = @0001;
  $  040.整车车速                           $    $  km/h         $    $  ANS040.BYTE004  $  y = (x2*256+x1)*0.1;
  $  041.前电机目标档位                     $    $               $    $  ANS041.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0a38;else if((x1 == 0x01)&&(x2==0x00)) y = @0160;else if((x1 == 0x02)&&(x2==0x00)) y = @0161;else if((x1 == 0x03)&&(x2==0x00)) y = @0162;else if((x1 == 0x04)&&(x2==0x00)) y = @0163;else y = @0001;
  $  042.前电机实际档位                     $    $               $    $  ANS042.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0a38;else if((x1 == 0x01)&&(x2==0x00)) y = @0160;else if((x1 == 0x02)&&(x2==0x00)) y = @0161;else if((x1 == 0x03)&&(x2==0x00)) y = @0162;else if((x1 == 0x04)&&(x2==0x00)) y = @0163;else y = @0001;
  $  043.是否校准                           $    $               $    $  ANS043.BYTE004  $  if(x1==0x00) y=@015d;else if(x1==0x01) y = @015e;else y = @0a37;
  $  044.信号状态                           $    $               $    $  ANS043.BYTE005  $  if(x1==0x00) y=@015b;else if(x1==0x01) y = @015c;else y = @0a37;
  $  045.坡道坡度                           $    $  °           $    $  ANS043.BYTE006  $  if(((x1+x2*256)*0.1)<31) y=(x1+x2*256)*0.1;else if(((x1+(x2-256)*256)*0.1)>(0-31)) y=(x1+(x2-256)*256)*0.1;else y=@0a37;
  $  046.电池配置                           $    $               $    $  ANS044.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0157;else if((x1 == 0x01)&&(x2==0x00)) y = @0a3b;else if((x1 == 0x02)&&(x2==0x00)) y = @0a3c;else if((x1 == 0x03)&&(x2==0x00)) y = @0a3d;else y = @0001;
  $  047.巡航配置                           $    $               $    $  ANS045.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0157;else if((x1 == 0x01)&&(x2==0x00)) y = @022e;else if((x1 == 0x02)&&(x2==0x00)) y = @022f;else y = @0001;
  $  048.倾角传感器是否校准                 $    $               $    $  ANS046.BYTE004  $  if(x1==0x00) y=@015e;else if(x1==0x01) y = @08bf;else y = @0001;
  $  049.倾角传感器信息状态                 $    $               $    $  ANS047.BYTE004  $  if(x1==0x00) y=@015e;else if(x1==0x01) y = @0078;else y = @0001;
