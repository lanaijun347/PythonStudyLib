...
读数据流: 
  ...
  $  019.CAN发动机转速状态                           $    $               $    $  ANS012.BYTE006  $  if(x1==0) y=@0078; else if(x1==1) y=@0027;else y=@0001;
  $  020.主油路1压力供给                             $    $  MPa          $    $  ANS013.BYTE004  $  y=x1*10.2/255;
  $  021.主油路2压力供给                             $    $  MPa          $    $  ANS013.BYTE005  $  y=x1*10.2/255;
  $  022.油泵供给压力                                $    $  MPa          $    $  ANS013.BYTE006  $  y=x1*637.13/255+x2*2.49/255;
  ...
  $  041.油泵使能信息                                $    $               $    $  ANS024.BYTE005  $  if(x1==0) y=@011a; else if(x1==1) y=@001c;else y=@0001;
