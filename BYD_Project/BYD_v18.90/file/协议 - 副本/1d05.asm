...
读数据流: 
  ...
  $  000.充电是否允许                        $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0196;else if(x1==0x01)y=@0195;else y=@0001;
  $  001.放电是否允许                        $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0196;else if(x1==0x01)y=@0195;else y=@0001;
  $  002.铁电池故障报警                      $    $               $    $  ANS002.BYTE004  $  if(x1 == 0x00) y = @01de;else if(x1 == 0x01) y = @01df;else y = @0001;
  $  003.SOC(荷电状态)过低请求充电命令       $    $               $    $  ANS003.BYTE004  $  if(x1 == 0x00) y = @0078;else if(x1 == 0x01) y = @0145;else y = @0001;
  $  004.充放电状态                          $    $               $    $  ANS004.BYTE004  $  if(x1 == 0x00) y = @01e0;else if(x1 == 0x01) y = @01e1;else y = @0001;
  ...
  $  013.MOS(金属—绝缘体半导体)温度         $    $  degree C     $    $  ANS013.BYTE004  $  y=x1-60;
