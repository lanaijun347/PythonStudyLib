...
读数据流: 
  ...
  $  004.蒸发器温度                       $    $  degree C     $    $  ANS004.BYTE004  $  if( x1<26) y=x1;else if(x1==0xD0) y = @01e4;else if(x1==0xD8) y = @01e3;else y = @0001;
  ...
  $  011.工作电源电压                     $    $  V            $    $  ANS009.BYTE004  $  if(((x1*0.1) >=9) && (x1*0.1) <=15.9) y=x1*0.1;else if(x1==0xA0) y = @01e9;else if(x1==0xD0) y = @01e8;else y = @0001;
  $  012.电动压缩机状态                   $    $               $    $  ANS010.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0044;else y=@0001;
  $  013.电动压缩机占空比                 $    $  %            $    $  ANS010.BYTE005  $  y=x1;
  $  014.主驾吹面通道温度                 $    $  degree C     $    $  ANS011.BYTE004  $  if((x1-40)<101) y=x1-40;else y = @0001;
  $  015.主驾吹脚通道温度                 $    $  degree C     $    $  ANS012.BYTE004  $  if((x1-40)<101) y=x1-40;else y = @0001;
  $  016.主驾冷暖电机位置                 $    $  %            $    $  ANS013.BYTE004  $  y=x1;
  $  017.前置模式电机位置百分比           $    $  %            $    $  ANS014.BYTE004  $  y=x1;
  $  018.新风循环电机位置百分比           $    $  %            $    $  ANS015.BYTE004  $  y=x1;
  $  019.后除霜请求                       $    $               $    $  ANS016.BYTE004  $  if(x1==0x00)y=@0044;else if(x1==0x01)y=@003f;else y=@0001;
