...
清除故障码:
  ...
  $$  REQ000:797 03 14 00 FF 00 00 00 00       $$  ANS000:79F 03 14 00 FF 00 00 00 00
...
读数据流: 
  ...
  $  005.直流侧输出电压                     $    $  V            $    $  ANS005.BYTE004  $  y = (x2*256+x1);
  $  006.直流侧输出电流                     $    $  A            $    $  ANS006.BYTE004  $  y = (x1*0.3)-30;
  ...
  $  018.本次累积充电量                     $    $  KWH          $    $  ANS018.BYTE004  $  y = (x1*0.5+x2*130.6)/255;
  $  019.交流侧功率                         $    $  W            $    $  ANS019.BYTE004  $  y = (x1*0.2+x2*51.2);
