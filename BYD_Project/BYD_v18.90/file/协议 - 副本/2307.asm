...
进入命令:
  ...
  $~  REQ001:7A1 02 10 01 00 00 00 00 00       $~  ANS001:7BB 02 10 01 00 00 00 00 00
...
版本信息:
  ...
  $%  002:软件最后更新日期:        $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
  $%  003:生产日期:                $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
  $%  004:车型:                    $%    $%  ANS002.BYTE004  $%  switxh(x1)0x81: y=@08d9;0x82: y=@0358;0x83: y=@0607;0x84: y=@08da;0x85: y=@035b;default: y=@00da;
  $%  005:MCU:                     $%    $%  ANS003.BYTE004  $%  switxh(x1)0x81: y=@0227;default: y=@00da;
  $%  006:压缩机产品序列号:        $%    $%  ANS004.BYTE004  $%  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $%  007:生产日期_1:              $%    $%  ANS004.BYTE007  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
