...
读数据流: 
  ...
  $  024.速度限制监视器         $    $                $    $  ANS005.BYTE004  $  if(x1==0x00)y=@027d;else if(x1==0x01)y=@020a;else y=@0001;
  $  025.主动诊断               $    $                $    $  ANS006.BYTE004  $  if(x1 == 0x01) y = @0a48;else if(x1 == 0x03) y = @0690;else y = @09fc;
...
30帧:
  ...
  $FC REQ000:782 30 08 00 00 00 00 00 00  $FC 
