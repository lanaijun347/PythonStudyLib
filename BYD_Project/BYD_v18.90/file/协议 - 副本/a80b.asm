...
版本信息:
  ...
  $%  000:ECU车型系列:        $%    $%  ANS000.BYTE004  $%  if(x1==0x00)y=@0356;else if(x1==0x3A)y=@0bdf;else if(x1==0x5A)y=@083e;else if(x1==0x5B)y=@0be0;else if(x1==0x6A)y=@0af4;else if(x1==0x6B)y=@0be1;else if(x1==0xA3)y=@034f;else if(x1==0xB6)y=@0355;else if(x1==0xC3)y=@034e;else if(x1==0xD6)y=@0354;else if(x1==0xDE)y=@0a61;else if(x1==0xE6)y=@0607;else if(x1==0xEA)y=@0a49;else if(x1==0xF0)y=@034b;else if(x1==0xF3)y=@034c;else if(x1==0xF6)y=@0351;else if(x1==0xFB)y=@035c;else if(x1==0xFC)y=@0362;else if(x1==0xFD)y=@0361;else y=@0525;
...
读数据流: 
  ...
  $  001.ECU加密        $    $       $    $  ANS001.BYTE004  $  if(x1==0x00)y=@02f5;else if(x1==0x01)y=@02f6;else y=@0003;
  $  002.加密方式       $    $       $    $  ANS001.BYTE005  $  if(x1==0x00)y=@0bde;else if(x1==0x01)y=@03d1;else y=@0003;
