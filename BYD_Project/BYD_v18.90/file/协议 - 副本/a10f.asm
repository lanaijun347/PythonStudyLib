...
读数据流: 
  ...
  $  000.真空泵状态           $    $               $    $  ANS000.BYTE004  $  if(x1==0x00) y=@047f; else if(x1==0x01) y=@0014; else y=@00d8;
  $  001.风扇高速状态         $    $               $    $  ANS001.BYTE004  $  if(x1==0x00) y=@047f; else if(x1==0x01) y=@0014; else y=@00d8;
  $  002.风扇低速状态         $    $               $    $  ANS002.BYTE004  $  if(x1==0x00) y=@047f; else if(x1==0x01) y=@0014; else y=@00d8;
  $  003.车速                 $    $  km/h         $    $  ANS003.BYTE004  $  if(x2<0x75) y=x2*2.56+x1/100.00; else if((x2==0x75) && (x1<0x31)) y=x2*2.56+x1/100.00; else y=@00d8;
  $  004.总里程               $    $  km           $    $  ANS004.BYTE004  $  y=(x1+x2*256+x3*65536-246)/10;
  $  005.水温值               $    $  degree C     $    $  ANS005.BYTE004  $  if(x1<0xC9) y=x1-40; else y=@00d8;
  $  006.真空压力值           $    $  kpa          $    $  ANS006.BYTE004  $  if(x1<0x65) y=x1; else y=@00d8;
  $  007.碰撞信号             $    $               $    $  ANS007.BYTE004  $  if(x1==0x00) y=@03ec; else if(x1==0x01) y=@047e; else y=@00d8;
  $  008.水温报警             $    $               $    $  ANS008.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@0473; else y=@00d8;
  $  009.真空压力报警         $    $               $    $  ANS009.BYTE004  $  if(x1==0x00) y=@0078; else if(x1==0x01) y=@047c; else if(x1==0x02) y=@047d;else y=@00d8;
