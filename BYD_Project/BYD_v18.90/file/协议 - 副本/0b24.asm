...
版本信息:
  ...
  $%  000:ECU车型系列:        $%    $%  ANS000.BYTE004  $%  y=@08c5;
  $%  001:驱动数:             $%    $%  ANS000.BYTE005  $%  HEX(x1);
  $%  002:软件版本:           $%    $%  ANS000.BYTE007  $%  y=SPRINTF([0%X.0%X],((x1>>4)&0xF),(x1&0x0F));
  $%  003:硬件版本:           $%    $%  ANS000.BYTE008  $%  y=SPRINTF([0%X.0%X],((x1>>4)&0xF),(x1&0x0F));

;******************************************************************************************************************************************************

读数据流: 

  $IN  REQ000:730 02 10 01 00 00 00 00 00       $IN  ANS000:738 02 10 01 00 00 00 00 00
  ...
  $  000.车速信息          $    $  km/h     $    $  ANS000.BYTE027  $  y=x1;
  $  001.ECU加密信息       $    $           $    $  ANS001.BYTE004  $  if(x1==0x00)y=@02f5;else if(x1==0x01)y=@02f6;else y=@0525;
