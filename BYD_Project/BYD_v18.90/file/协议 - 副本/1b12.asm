...
读数据流: 
  ...
  $  008.主驾通道温度                         $    $  degree C     $    $  ANS007.BYTE004  $  if((x1-40)<101) y=x1-40;else y = @0001;
  $  009.电池放电允许信号                     $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@0196;else if(x1==0x01)y=@0195;else y=@0001;
  ...
  $  012.IG2(点火2)电压                       $    $  V            $    $  ANS010.BYTE004  $  if((x1>=0x5A)&&(x1<0xA0)) y=x1*0.1;else y=@0001;
