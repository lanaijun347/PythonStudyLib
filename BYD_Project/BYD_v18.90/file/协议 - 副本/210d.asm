...
版本信息:
  ...
  $%  001:软件日期:        $%    $%  ANS000.BYTE006  $%  y=SPRINTF([20%d%s%d%s%d%s],x1,@0197,x2,@0198,x3,@0199);
  ...
  $%  005:硬件日期:        $%    $%  ANS002.BYTE005  $%  y=SPRINTF([20%d%s%d%s%d%s],x1,@0197,x2,@0198,x3,@0199);
...
读数据流: 
  ...
  $  001.电机温度               $    $  degree C     $    $  ANS001.BYTE004  $  y=x1;
  $  002.扭矩主信号占空比       $    $  %            $    $  ANS002.BYTE004  $  y=((x1<<8)+x2)*1.0/10;
  $  003.扭矩辅信号占空比       $    $  %            $    $  ANS003.BYTE004  $  y=((x1<<8)+x2)*1.0/10;
  $  004.P值                    $    $  %            $    $  ANS004.BYTE004  $  y=((x1<<8)+x2)*1.0/10;
  $  005.S值                    $    $  %            $    $  ANS005.BYTE004  $  y=((x1<<8)+x2)*1.0/10;
  $  006.转角值                 $    $  °           $    $  ANS006.BYTE004  $  y=((x1<<8)+x2)*1.0/10-800;
  $  007.直流母线电压           $    $  V            $    $  ANS007.BYTE004  $  y=((x1<<8)+x2)*1.0/10;
