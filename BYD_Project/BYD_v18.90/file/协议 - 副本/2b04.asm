...
读数据流: 
  ...
  $  005.交流侧电流                        $    $  A       $    $  ANS005.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)*0.2);
  ...
  $  014.与BMS(电池管理器)通讯状态         $    $          $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
  $  015.散热风扇占空比                    $    $  %       $    $  ANS015.BYTE004  $  y=x1;
  $  016.充放电系统工作状态                $    $          $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@025c;0x01: y=@025d;0x02: y=@01da;0x03: y=@01db;0x04: y=@025e;0x05: y=@025f;0x06: y=@0260;0x07: y=@0261;0x08: y=@0262;0x09: y=@0263;0x0A: y=@0264;default: y=@01c6;
  $  017.充放电系统故障状态                $    $          $    $  ANS017.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0258;0x02: y=@0259;0x03: y=@007b;0x04: y=@025a;0x05: y=@025b;0x06: y=@0418;default: y=@01c6;
  ...
  $  021.DC工作模式                        $    $          $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@01d4;0x01: y=@01d6;0x02: y=@01d5;0x03: y=@00d8;default: y=@0001;
  ...
  $  025.电压检测                          $    $  V       $    $  ANS025.BYTE004  $  y=(x2*256+x1);
  $  026.交流侧绝缘阻值                    $    $  Ω      $    $  ANS026.BYTE004  $  y=x1;
  $  027.boot版本号                        $    $          $    $  ANS027.BYTE004  $  y=SPRINTF([%02X%02X%02X],x1,x2,x3);

  $IN_01  REQ000:797 02 10 03 00 00 00 00 00       $IN_01  ANS000:79F 02 10 03 00 00 00 00 00
