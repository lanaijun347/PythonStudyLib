...
读数据流: 
  ...
  $  010.全景影像开关状态       $    $       $    $  ANS000.BYTE005  $  if(x1&0x40) y=@002a;else y=@00e4;
  $  011.蓝牙电话开关状态       $    $       $    $  ANS000.BYTE005  $  if(x1&0x80) y=@002a;else y=@00e4;
  $  012.振动马达状态           $    $       $    $  ANS001.BYTE004  $  if(x1&0x01) y=@00e2;else y=@00e3;
  $  013.静音状态               $    $       $    $  ANS001.BYTE004  $  if(x1&0x02) y=@002a;else y=@00e4;
  $  014.仪表返回开关状态       $    $       $    $  ANS001.BYTE004  $  if(x1&0x08) y=@002a;else y=@00e4;
