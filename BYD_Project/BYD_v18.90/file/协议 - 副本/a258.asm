...
读数据流: 
  ...
  $  001.风速                           $    $               $    $  ANS001.BYTE004  $  if(x1<0x08) y=@0196; else y=@006d;
  ...
  $  005.车内温度                       $    $  degree C     $    $  ANS005.BYTE004  $  if((x1>0x7F) && (x1<0xB3)) y=x1-128; else y=@006d;
  $  006.蒸发器温度                     $    $  degree C     $    $  ANS006.BYTE004  $  if(x1>0x19) y=x1; else y=@006d;
  $  007.读AC(空调控制器)请求状态       $    $               $    $  ANS007.BYTE004  $  if(x1==0x00) y=@003f; else if(x1==0x01) y=@0044; else y=@006d;
  $  008.鼓风机继电器控制               $    $               $    $  ANS008.BYTE004  $  if(x1==0x00) y=@002a; else y=@002b;
