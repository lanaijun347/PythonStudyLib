...
版本信息:
  ...
  $%  002:VIN(车辆识别码):         $%    $%  ANS002.BYTE004  $%  ASCII(x1,x2,x4,x5,x6,x7,x8,x9,x11,x12,x13,x14,x15,x16,x18,x19,x20);
...
读数据流: 
  ...
  $  007.DC预充状态                         $    $               $    $  ANS007.BYTE004  $  if(x1==0x00) y=@01f4;else if(x1==0x01) y=@01f5; else if(x1==0x02) y=@01f6; else if(x1==0x03) y=@01f7; else y=@00d8;
  $  008.放电主接触器状态                   $    $               $    $  ANS008.BYTE004  $  if(x1==0x00) y=@002a;else if(x1==0x01) y=@002b;else y=@00d8;
  $  009.预充接触器状态                     $    $               $    $  ANS009.BYTE004  $  if(x1==0x00) y=@002a;else if(x1==0x01) y=@002b;else y=@00d8;
  $  010.充电接触器状态                     $    $               $    $  ANS010.BYTE004  $  if(x1==0x00) y=@002a;else if(x1==0x01) y=@002b;else y=@00d8;
  $  011.DC预充接触器状态                   $    $               $    $  ANS011.BYTE004  $  if(x1==0x00) y=@002a;else if(x1==0x01) y=@002b;else y=@00d8;
  $  012.DC接触器状态                       $    $               $    $  ANS012.BYTE004  $  if(x1==0x00) y=@002a;else if(x1==0x01) y=@002b;else y=@00d8;
  $  013.放电是否允许                       $    $               $    $  ANS013.BYTE004  $  if(x1==0x00) y=@0195;else if(x1==0x01) y=@0196; else y=@00d8;
  $  014.最低电压电池号                     $    $               $    $  ANS014.BYTE004  $  if(x1<0x65) y=x1;else y=@00d8;
  $  015.最低单节电池电压                   $    $  V            $    $  ANS015.BYTE004  $  if((x2==0x00) && (x1<0x64)) y=@0247;else if((x2==0x00) && (x1>=0x64) && (x1<0xC8)) y=@040f; else if((x2==0x00) && (x1>=0xC8)) y=@0410;  else if((x2==0x01) && (x1<0x2C)) y=@0410; else if((x2==0x01) && (x1>=0x2C) && (x1<0x90)) y=@0411; else if((x2==0x01) && (x1>=0x90) && (x1<0xF4)) y=@0944; else y=@00d8;
  $  016.最高电压电池号                     $    $               $    $  ANS016.BYTE004  $  if(x1<0x65) y=x1;else y=@00d8;
  $  017.最高单节电池电压                   $    $  V            $    $  ANS017.BYTE004  $  if((x2==0x00) && (x1<0x64)) y=@0247;else if((x2==0x00) && (x1>=0x64) && (x1<0xC8)) y=@040f; else if((x2==0x00) && (x1>=0xC8)) y=@0410;  else if((x2==0x01) && (x1<0x2C)) y=@0410; else if((x2==0x01) && (x1>=0x2C) && (x1<0x90)) y=@0411; else if((x2==0x01) && (x1>=0x90) && (x1<0xF4)) y=@0944; else y=@00d8;
  $  018.最低温度电池号                     $    $               $    $  ANS018.BYTE004  $  if(x1<0x65) y=x1;else y=@00d8;
  $  019.最低单节电池温度                   $    $  degree C     $    $  ANS019.BYTE004  $  if(x1<0xC9) y=x1-40;else y=@00d8;
  $  020.最高温度电池号                     $    $               $    $  ANS020.BYTE004  $  if(x1<0x65) y=x1;else y=@00d8;
  $  021.最高单节电池温度                   $    $  degree C     $    $  ANS021.BYTE004  $  if(x1<0xC9) y=x1-40;else y=@00d8;
  $  022.电池组充电状态                     $    $               $    $  ANS022.BYTE004  $  if((x1&0x03)==0x00) y=@0078;else if((x1&0x03)==0x01) y=@0470;else if((x1&0x03)==0x02) y=@0471;  else y=@00d8;
  $  023.电池组温度状态                     $    $               $    $  ANS023.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@0abb;else if(x1==0x02) y=@0abc; else y=@00d8;
  $  024.电池组漏电状态                     $    $               $    $  ANS024.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@04c0;else if(x1==0x02) y=@04c1; else y=@00d8;
  $  025.电池组电量状态                     $    $               $    $  ANS025.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@0474;else y=@00d8;
  $  026.湿度状态                           $    $               $    $  ANS026.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@0473;else y=@00d8;
  $  027.过流状态                           $    $               $    $  ANS027.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@0472;else y=@00d8;
  $  028.电压过低报警                       $    $               $    $  ANS028.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@0470;else if(x1==0x02) y=@0471; else y=@00d8;
  $  029.电压过高报警                       $    $               $    $  ANS029.BYTE004  $  if(x1==0x00) y=@0078;else if(x1==0x01) y=@0470;else if(x1==0x02) y=@0471; else y=@00d8;
  $  030.BMS(电池管理系统)12V电源电压       $    $               $    $  ANS030.BYTE004  $  if(x1<0xD2) y=x1/10;else y=@006d;
  $  031.系统均衡状态                       $    $               $    $  ANS031.BYTE004  $  if(x1==0x00) y=@001e;else if(x1==0x01) y=@001d;else y=@006d;
  ...
  $  125.1-8节电池电压采样异常              $    $               $    $  ANS125.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  126.9-16节电池电压采样异常             $    $               $    $  ANS126.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  127.17-24节电池电压采样异常            $    $               $    $  ANS127.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  128.25-32节电池电压采样异常            $    $               $    $  ANS128.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  129.33-40节电池电压采样异常            $    $               $    $  ANS129.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  130.41-48节电池电压采样异常            $    $               $    $  ANS130.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  131.49-56节电池电压采样异常            $    $               $    $  ANS131.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  132.57-64节电池电压采样异常            $    $               $    $  ANS132.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  133.65-72节电池电压采样异常            $    $               $    $  ANS133.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  134.73-80节电池电压采样异常            $    $               $    $  ANS134.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  135.81-88节电池电压采样异常            $    $               $    $  ANS135.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  136.89-93节电池电压采样异常            $    $               $    $  ANS136.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0ad4;else if(x1&0x40) y=@0ad5;else if(x1&0x20) y=@0ad6;else if(x1&0x10) y=@0ad7;else if(x1&0x08) y=@0ad8;else if(x1&0x04) y=@0ad9;else if(x1&0x02) y=@0ada;else if(x1&0x01) y=@0adb;else y=@0087;
  $  137.1电池包温度采样线异常              $    $               $    $  ANS137.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  138.2电池包温度采样线异常              $    $               $    $  ANS138.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  139.3电池包温度采样线异常              $    $               $    $  ANS139.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  140.4电池包温度采样线异常              $    $               $    $  ANS140.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  141.5电池包温度采样线异常              $    $               $    $  ANS141.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  142.6电池包温度采样线异常              $    $               $    $  ANS142.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  143.7电池包温度采样线异常              $    $               $    $  ANS143.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  144.8电池包温度采样线异常              $    $               $    $  ANS144.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  145.9电池包温度采样线异常              $    $               $    $  ANS145.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
  $  146.10电池包温度采样线异常             $    $               $    $  ANS146.BYTE004  $  if(x1==0) y=@0078;else if(x1&0x80) y=@0acc;else if(x1&0x40) y=@0acd;else if(x1&0x20) y=@0ace;else if(x1&0x10) y=@0acf;else if(x1&0x08) y=@0ad0;else if(x1&0x04) y=@0ad1;else if(x1&0x02) y=@0ad2;else if(x1&0x01) y=@0ad3;else y=@0087;
