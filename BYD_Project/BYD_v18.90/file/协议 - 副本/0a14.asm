...
版本信息:
  ...
  $%  000:软件版本:        $%    $%  ANS000.BYTE004  $%  y=x*0.1;
  $%  001:硬件版本:        $%    $%  ANS000.BYTE005  $%  y=x*0.1;
  $%  002:生产日期:        $%    $%  ANS000.BYTE006  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:735 30 01 04 55 55 55 55 55  $FC 
