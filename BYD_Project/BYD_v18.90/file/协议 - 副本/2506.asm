...
读数据流: 
  ...
  $  040.左外后视镜折叠电机循环              $    $           $    $  ANS002.BYTE004  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
  $  041.左外后视镜换向水平电机循环          $    $           $    $  ANS002.BYTE006  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
  $  042.左外后视镜换向垂直电机循环          $    $           $    $  ANS002.BYTE008  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
  $  043.记忆一档按键次数                    $    $           $    $  ANS003.BYTE004  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
  $  044.记忆二档按键次数                    $    $           $    $  ANS003.BYTE006  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
  $  045.记忆三档按键次数                    $    $           $    $  ANS004.BYTE004  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
  $  046.Set按键工作次数                     $    $           $    $  ANS004.BYTE006  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
  $  047.照脚灯点亮时间                      $    $  小时     $    $  ANS005.BYTE004  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
  $  048.外后视镜加热时间                    $    $  小时     $    $  ANS006.BYTE004  $  if(x1<0x80)y=(x1<<8)+x2;else y = ((x1-256)<<8)+x2;
