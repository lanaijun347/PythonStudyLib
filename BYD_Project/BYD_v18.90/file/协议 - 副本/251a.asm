...
读数据流: 
  ...
  $  062.发动机启动命令                              $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x06)0x00: y=@0003;0x02: y=@011a;0x04: y=@08a8;0x06: y=@0003;default: y=@0001;
  $  063.低压启动电池状态                            $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x18)0x00: y=@002a;0x08: y=@002b;0x10: y=@002a;0x18: y=@0003;default: y=@0001;
  $  064.发动机启动超时次数                          $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x60)0x00: y=@0078;0x20: y=@08a6;0x40: y=@08a7;0x60: y=@0003;default: y=@0001;
  $  065.真空泵控制回路#1                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x06)0x00: y=@0606;0x02: y=@0214;0x04: y=@0078;0x06: y=@0003;default: y=@0001;
  $  066.真空泵控制回路#2                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x18)0x00: y=@0606;0x08: y=@0214;0x10: y=@0078;0x18: y=@0003;default: y=@0001;
  $  067.真空泵泄露状态                              $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x60)0x00: y=@0606;0x20: y=@08a9;0x40: y=@049a;0x60: y=@0078;default: y=@0001;
  $  068.低速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x01) y=@0185;else y=@0186;
  $  069.高速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x02) y=@0185;else y=@0186;
  $  070.风扇类型                                    $    $               $    $  ANS000.BYTE023  $  switxh(x1&0x0C)0x00: y=@0194;0x04: y=@0193;default: y=@007b;
