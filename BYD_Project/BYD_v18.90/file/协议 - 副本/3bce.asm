...
版本信息:
  ...
  $%  005:修改次数:        $%    $%  ANS002.BYTE009  $%  y=SPRINTF([%d%s],x1,@019b);
...
读数据流: 
  ...
  $  REQ003:7A5 03 22 00 07 00 00 00 00       $  ANS003:7AD 03 22 00 07 00 00 00 00
  $  REQ004:7A5 03 22 00 09 00 00 00 00       $  ANS004:7AD 03 22 00 09 00 00 00 00
  $  REQ005:7A5 03 22 00 10 00 00 00 00       $  ANS005:7AD 03 22 00 10 00 00 00 00

  $  000.故障检测标志位                   $    $       $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@007b;0x01: y=@03a7;0x02: y=@03a8;0x03: y=@03a9;0x04: y=@03aa;0x05: y=@03ab;0x06: y=@03ac;default: y=@0001;
  $  001.故障检测持续判断                 $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@007b;0x01: y=@03a3;0x02: y=@03a4;0x03: y=@03a5;0x04: y=@03a6;default: y=@0001;
  $  002.档位信息                         $    $       $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@03a2;0x01: y=@013a;0x02: y=@010d;0x03: y=@010e;0x04: y=@013b;default: y=@0001;
  $  003.换挡球头灯当前状态               $    $       $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@007b;0x01: y=@078f;0x02: y=@04b5;0x03: y=@04b6;0x04: y=@0790;0x05: y=@04b8;0x06: y=@0791;default: y=@0001;
  $  004.N切R/D在V≤3是否需要踩刹车       $    $       $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@03ad;0x01: y=@03ae;default: y=@0001;
  $  005.白天P挡位指示灯占空比            $    $       $    $  ANS005.BYTE005  $  y=SPRINTF([%.3f],(x1*256+x2)/4000);
  $  006.夜间P挡位指示灯占空比            $    $       $    $  ANS005.BYTE007  $  y=SPRINTF([%.3f],(x1*256+x2)/4000);
