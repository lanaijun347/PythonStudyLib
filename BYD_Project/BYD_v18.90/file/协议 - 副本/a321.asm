...
版本信息:
  ...
  $%  000:VIN(车辆识别码):              $%    $%  ANS000.BYTE005  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
...
读数据流: 
  ...
  $  032.1缸ESC(电子车身稳定系统)推迟                                  $    $                    $    $  ANS000.BYTE035  $  y=x1*89.6/255;
  $  033.2缸ESC(电子车身稳定系统)推迟                                  $    $                    $    $  ANS000.BYTE036  $  y=x1*89.6/255;
  $  034.3缸ESC(电子车身稳定系统)推迟                                  $    $                    $    $  ANS000.BYTE037  $  y=x1*89.6/255;
  $  035.4缸ESC(电子车身稳定系统)推迟                                  $    $                    $    $  ANS000.BYTE038  $  y=x1*89.6/255;
  ...
  $  042.电子稳定系统(ESC(电子车身稳定系统))1 模数转换换算(伏特)       $    $  mV                $    $  ANS000.BYTE034  $  y=x1*4980.2/255;
  ...
  $  056.燃油闭环                                                      $    $                    $    $  ANS000.BYTE058  $  if(x&0x01) y=@00f2; else y=@0181;
  $  057.前氧传感器稀浓状态                                            $    $                    $    $  ANS000.BYTE058  $  if(x&0x02) y=@017f; else y=@0180;
  $  058.BLM自学习状态                                                 $    $                    $    $  ANS000.BYTE058  $  if(x&0x04) y=@00f2; else y=@0181;
  $  059.溢油清除模式状态                                              $    $                    $    $  ANS000.BYTE058  $  if(x&0x08) y=@00f2; else y=@0181;
  $  060.功率增强模式状态                                              $    $                    $    $  ANS000.BYTE058  $  if(x&0x10) y=@00f2; else y=@0181;
  $  061.DFCO(燃油切断)模式状态                                        $    $                    $    $  ANS000.BYTE058  $  if(x&0x20) y=@00f2; else y=@0181;
  $  062.MAPCID第一第二次相同                                          $    $                    $    $  ANS000.BYTE058  $  if(x&0x40) y=@0186; else y=@0185;
  $  063.暖机过程                                                      $    $                    $    $  ANS000.BYTE058  $  if(x&0x80) y=@0185; else y=@0186;
  $  064.扭矩控制模式状态                                              $    $                    $    $  ANS000.BYTE059  $  if(x&0x01) y=@00f2; else y=@0181;
  $  065.线性EGR(废气再循环)阀测试完成                                 $    $                    $    $  ANS000.BYTE059  $  if(x&0x02) y=@0186; else y=@0185;
  $  066.变速器档位                                                    $    $                    $    $  ANS000.BYTE059  $  if(x&0x04) y=@0b62; else y=@0b63;
  $  067.油泵继电器状态                                                $    $                    $    $  ANS000.BYTE059  $  if(x&0x08) y=@001d; else y=@001e;
  $  068.非易失性存储器是否正常                                        $    $                    $    $  ANS000.BYTE059  $  if(x&0x10) y=@0186; else y=@0185;
  $  069.ICA闭环模式状态                                               $    $                    $    $  ANS000.BYTE059  $  if(x&0x40) y=@00f2; else y=@0181;
  $  070.ICA调节状态                                                   $    $                    $    $  ANS000.BYTE059  $  if(x&0x80) y=@00f2; else y=@0181;
  $  071.AC WOT禁止模式状态                                            $    $                    $    $  ANS000.BYTE060  $  if(x&0x01) y=@00f2; else y=@0181;
  $  072.AC(空调控制器)大负荷禁止模式状态                              $    $                    $    $  ANS000.BYTE060  $  if(x&0x02) y=@00f2; else y=@0181;
  $  073.后环螺线管关断状态                                            $    $                    $    $  ANS000.BYTE060  $  if(x&0x04) y=@00f2; else y=@0181;
  $  074.IAC(怠速空气控制阀)位置正常                                   $    $                    $    $  ANS000.BYTE060  $  if(x&0x08) y=@0186; else y=@0185;
  $  075.有AC(空调控制器)请求                                          $    $                    $    $  ANS000.BYTE060  $  if(x&0x10) y=@0186; else y=@0185;
  $  076.AC(空调控制器)压力                                            $    $                    $    $  ANS000.BYTE060  $  if(x&0x20) y=@0b65; else y=@0b64;
  $  077.AC(空调控制器)继电器状态                                      $    $                    $    $  ANS000.BYTE060  $  if(x&0x40) y=@001d; else y=@001e;
  $  078.AC(空调控制器)是否使用                                        $    $                    $    $  ANS000.BYTE060  $  if(x&0x80) y=@0185; else y=@0186;
  $  079.冷却风扇1状态                                                 $    $                    $    $  ANS000.BYTE061  $  if(x&0x01) y=@001d; else y=@001e;
  $  080.冷却风扇2状态                                                 $    $                    $    $  ANS000.BYTE061  $  if(x&0x02) y=@001d; else y=@001e;
  $  081.氧传感器加热器A                                               $    $                    $    $  ANS000.BYTE061  $  if(x&0x08) y=@001d; else y=@001e;
  $  082.点火开关                                                      $    $                    $    $  ANS000.BYTE061  $  if(x&0x10) y=@001d; else y=@001e;
  $  083.发动机检测灯                                                  $    $                    $    $  ANS000.BYTE061  $  if(x&0x20) y=@001d; else y=@001e;
  $  084.变速器状态                                                    $    $                    $    $  ANS000.BYTE061  $  if(x&0x40) y=@0b66; else y=@0b67;
  $  085.ESC(电子车身稳定系统)状态                                     $    $                    $    $  ANS000.BYTE061  $  if(x&0x80) y=@00f2; else y=@0181;
  $  086.喷油器A电压状态                                               $    $                    $    $  ANS000.BYTE065  $  switxh(x&0x03)0: y = @0078;1:y = @0b64;2:y = @0b65;3:y = @0001;default:y=@0525;
  $  087.喷油器B电压状态                                               $    $                    $    $  ANS000.BYTE065  $  switxh(x&0x0C)0: y = @0078;4:y = @0b64;8:y = @0b65;0x0C:y = @0001;default:y=@0525;
  $  088.喷油器C电压状态                                               $    $                    $    $  ANS000.BYTE065  $  switxh(x&0x30)0x00: y = @0078;0x10:y = @0b64;0x20:y = @0b65;0x30:y = @0001;default:y=@0525;
  $  089.喷油器D电压状态                                               $    $                    $    $  ANS000.BYTE065  $  switxh(x&0xC0)0x00: y = @0078;0x40:y = @0b64;0x80:y = @0b65;0xC0:y = @0001;default:y=@0525;
  $  090.是否达到怠速条件                                              $    $                    $    $  ANS000.BYTE066  $  switxh(x&0x03)0: y = @0186;1:y = @0185;default:y = @0001;
  $  091.怠速是否使能                                                  $    $                    $    $  ANS000.BYTE066  $  switxh(x&0x07)0: y = @0186;1: y = @0186;2:y = @0185;3:y = @0185;default:y = @0001;
  $  092.ELOAD1状态                                                    $    $                    $    $  ANS000.BYTE066  $  if(x&0x04) y=@00f2; else y=@0181;
  $  093.ELOAD2状态                                                    $    $                    $    $  ANS000.BYTE066  $  if(x&0x08) y=@00f2; else y=@0181;
  $  094.前蒸汽阀传感器是否启用                                        $    $                    $    $  ANS000.BYTE066  $  if(x&0x10) y=@0185; else y=@0186;
  $  095.后蒸汽阀传感器是否启用                                        $    $                    $    $  ANS000.BYTE066  $  if(x&0x20) y=@0185; else y=@0186;
  $  096.后环切割线圈是否启用                                          $    $                    $    $  ANS000.BYTE066  $  if(x&0x40) y=@0185; else y=@0186;
  $  097.AC(空调控制器)传感器是否启用                                  $    $                    $    $  ANS000.BYTE066  $  if(x&0x80) y=@0185; else y=@0186;
