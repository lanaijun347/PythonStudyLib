...
读数据流: 
  ...
  $  000.放电是否允许                        $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0195;else if(x1==0x01)y=@0196;else if(x1==0x02)y=@007b;else y=@0001;
  $  001.DC系统故障状态                      $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@03bc;
