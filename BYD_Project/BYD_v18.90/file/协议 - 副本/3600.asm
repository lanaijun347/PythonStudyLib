...
读数据流: 
  ...
  $  002.软件最后更新日期                                 $    $         $    $  ANS000.BYTE006  $  y=SPRINTF([%d%s%d%s%d%s],x1,@0197,x2,@0198,x3,@0199);
  $  003.母线电压                                         $    $  V      $    $  ANS001.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=1000)) y=(x1*256+x2);else if((x1*256+x2)==65535) y=@0001;else y=@0001;
  $  004.加热器工作电流                                   $    $  A      $    $  ANS002.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=500)) y=(x1*256+x2)/10;else if((x1*256+x2)==65535) y=@0001;else y=@0001;
  $  005.加热器消耗功率                                   $    $  W      $    $  ANS003.BYTE004  $  y=(x1*256+x2);
  $  006.IGBT(绝缘栅双极型晶体管)输出占空比               $    $  %      $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if(x1==255) y=@0001;else y=@0001;
  $  007.IGBT(绝缘栅双极型晶体管)散热片温度               $    $  ℃     $    $  ANS005.BYTE004  $  if((x1>=0)&&(x1<=250)) y=x1-50;else if(x1==255) y=@0001;else y=@0001;
  $  008.冷却液温度                                       $    $  ℃     $    $  ANS006.BYTE004  $  if((x1>=0)&&(x1<=250)) y=x1-50;else if(x1==255) y=@0001;else y=@0001;
  $  009.加热器主板温度                                   $    $  ℃     $    $  ANS007.BYTE004  $  if((x1>=0)&&(x1<=250)) y=x1-50;else if(x1==255) y=@0001;else y=@0001;
  $  010.加热器加热状态                                   $    $         $    $  ANS008.BYTE004  $  if(x1==0) y=@0003;else if(x1==1) y=@001e;else if(x1==2) y=@01ea;else if(x1==3) y=@01eb;else if(x1==4) y=@01ec;else y=@0001;
  $  011.加热器高压状态                                   $    $         $    $  ANS009.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@01e8;else if(x1==2) y=@01e9;else y=@0001;
  $  012.IGBT(绝缘栅双极型晶体管)驱动状态                 $    $         $    $  ANS010.BYTE004  $  if(x1==0) y=@001e;else if(x1==1) y=@01e5;else if(x1==2) y=@01e6;else if(x1==3) y=@01e7;else y=@0001;
  $  013.电池加热器加热组件状态                           $    $         $    $  ANS011.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@0167;else y=@0001;
  $  014.电池加热器驱动组件状态                           $    $         $    $  ANS012.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@0167;else y=@0001;
  $  015.冷却液温度传感器状态                             $    $         $    $  ANS013.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@01e3;else if(x1==2) y=@01e4;else y=@0001;
  $  016.低压电源值                                       $    $  V      $    $  ANS014.BYTE004  $  y=SPRINTF([%.1f],x1/10);
  $  017.IGBT(绝缘栅双极型晶体管)驱动电压值               $    $  V      $    $  ANS015.BYTE004  $  y=SPRINTF([%.1f],x1/10);
  $  018.IGBT(绝缘栅双极型晶体管)短路状态                 $    $         $    $  ANS016.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@01e3;else y=@0001;
  $  019.IGBT(绝缘栅双极型晶体管)温度传感器状态           $    $         $    $  ANS017.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@01e3;else if(x1==2) y=@01e4;else y=@0001;
  $  020.与BMS(电池管理器)通讯状态                        $    $         $    $  ANS018.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@01e2;else y=@0001;
  $  021.右侧IGBT(绝缘栅双极型晶体管)散热片温度           $    $  ℃     $    $  ANS019.BYTE004  $  if((x1>=0)&&(x1<=250)) y=x1-50;else if(x1==255) y=@0001;else y=@0001;
  $  022.右侧IGBT(绝缘栅双极型晶体管)温度传感器状态       $    $         $    $  ANS020.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@01e3;else if(x1==2) y=@01e4;else y=@0001;
