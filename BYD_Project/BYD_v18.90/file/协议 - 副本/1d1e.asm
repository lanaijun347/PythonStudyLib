...
进入命令:
  ...
  $~  REQ001:734 02 10 01 00 00 00 00 00       $~  ANS001:73C 02 10 01 00 00 00 00 00
...
版本信息:
  ...
  $%  REQ001:734 03 22 00 02 00 00 00 00       $%  ANS001:73C 03 22 00 02 00 00 00 00

  $%  000:软件版本:        $%    $%  ANS000.BYTE004  $%  y=x1*0.1;
  $%  001:硬件版本:        $%    $%  ANS000.BYTE005  $%  y=x1*0.1;
  $%  002:编程日期:        $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%02d/%02d/%02d],x1,x2,x3);
