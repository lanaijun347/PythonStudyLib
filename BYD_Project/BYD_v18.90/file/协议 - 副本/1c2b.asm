...
读数据流: 
  ...
  $  001.冷凝风扇工作状态                        $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@001c;else if(x1==0x01)y=@0345;else if(x1==0x02)y=@0346;else if(x1==0x03)y=@0347;else  y=@006d;
  $  002.冷却风扇工作状态                        $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@001c;else if(x1==0x01)y=@0345;else if(x1==0x02)y=@0346;else if(x1==0x03)y=@0347;else  y=@006d;
  ...
  $  008.电源档位                                $    $               $    $  ANS008.BYTE004  $  switxh(x1&0x03)0x00:y=@007b;0x01:y=@0348;0x02:y=@0349;0x03:y=@034a;default:y=@0525;
