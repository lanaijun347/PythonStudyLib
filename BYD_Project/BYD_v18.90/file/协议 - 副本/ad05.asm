...
版本信息:
  ...
  $%  005:车载诊断系统类型:        $%    $%  ANS005.BYTE006  $%  if(x1==0x01) y=@0ba1;else if(x1==0x02) y=@0ba2;else if(x1==0x03) y=@0ba3;else if(x1==0x04) y=@0743;else if(x1==0x05) y=@0ba4;else if(x1==0x06) y=@0ba5;else y =@00da;
...
读数据流: 
  ...
  $  014.节气门处于怠速位置                                  $    $               $    $  ANS013.BYTE006  $  if(x1&0x01)y=@0185;else y=@0186;
  $  015.空调请求激活                                        $    $               $    $  ANS013.BYTE006  $  if(x1&0x10)y=@0185;else y=@0186;
  $  016.空调压缩机状态                                      $    $               $    $  ANS013.BYTE006  $  if(x1&0x20)y=@001d;else y=@001e;
  $  017.催化剂保护模式                                      $    $               $    $  ANS013.BYTE006  $  if(x1&0x40)y=@0185;else y=@0186;
  $  018.燃油泵开启状态                                      $    $               $    $  ANS013.BYTE006  $  if(x1&0x80)y=@001d;else y=@001e;
  $  019.发动机故障(MIL)指示灯状态                           $    $               $    $  ANS014.BYTE006  $  if(x1&0x04)y=@001d;else y=@001e;
  $  020.发动机立即维修(SVS(系统维修指示灯))指示灯状态       $    $               $    $  ANS014.BYTE006  $  if(x1&0x08)y=@001d;else y=@001e;
