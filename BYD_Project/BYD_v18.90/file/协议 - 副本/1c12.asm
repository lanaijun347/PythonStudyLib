...
读数据流: 
  ...
  $  036.错误状态                           $    $               $    $  ANS035.BYTE005  $  if(x1==0x00)y=@015b;else if(x1==0x01)y=@015c;else y=@01c6;
  $  037.坡道坡度                           $    $               $    $  ANS035.BYTE006  $  if(((x1+x2*256)*0.1)<31) y=(x1+x2*256)*0.1;else if(((x1+(x2-256)*256)*0.1)>(0-31)) y=(x1+(x2-256)*256)*0.1;else y=@0001;
