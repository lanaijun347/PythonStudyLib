...
版本信息:
  ...
  $%  REQ002:766 03 22 00 03 00 00 00 00       $%  ANS002:76E 03 22 00 03 00 00 00 00
  $%  REQ003:766 03 22 F1 8C 00 00 00 00       $%  ANS003:76E 03 22 F1 8C 00 00 00 00
  ...
  $%  004:维修日期:                       $%    $%  ANS002.BYTE004  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
  $%  005:维修次数:                       $%    $%  ANS002.BYTE007  $%  y=x1;
  $%  006:PTC(辅助加热)产品序列号:        $%    $%  ANS003.BYTE004  $%  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $%  007:生产日期:                       $%    $%  ANS003.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
...
读数据流: 
  ...
  $  000.左侧散热片温度                $    $  degree C     $    $  ANS000.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@0284;else if(x1 == 0xD8)y=@0285;else y=@0001;
  $  001.PTC(辅助加热)预置档位         $    $               $    $  ANS001.BYTE004  $  y=x1;
  $  002.PTC(辅助加热)实际档位         $    $               $    $  ANS002.BYTE004  $  y=x1;
  $  003.右侧散热片温度                $    $               $    $  ANS003.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@0284;else if(x1 == 0xD8)y=@0285;else y=@0001;
  $  004.冷却液温度                    $    $  degree C     $    $  ANS004.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@0284;else if(x1 == 0xD8)y=@0285;else y=@0001;
  $  005.IG2(点火2)低压电源电压        $    $  V            $    $  ANS005.BYTE004  $  y=(x1*256+x2)*0.1;
  $  006.负载高压电源值                $    $  V            $    $  ANS006.BYTE004  $  y=x1*256+x2;
  $  007.负载电流                      $    $  A            $    $  ANS007.BYTE004  $  y=x1*0.1;
  $  008.PTC(辅助加热)消耗功率         $    $  W            $    $  ANS008.BYTE004  $  y = (x1*256+x2);
  $  009.PTC(辅助加热)控制板温度       $    $  degree C     $    $  ANS009.BYTE004  $  y=x1;
