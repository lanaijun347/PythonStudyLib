...
版本信息:
  ...
  $%  000:防夹电机软件版本:        $%    $%  ANS000.BYTE004  $%  y=x/10;
  $%  001:防夹电机硬件版本:        $%    $%  ANS001.BYTE004  $%  y=x/10;
  $%  002:软件版本:                $%    $%  ANS002.BYTE004  $%  y=x/10;
  $%  003:硬件版本:                $%    $%  ANS002.BYTE005  $%  y=x/10;
  $%  004:生产日期:                $%    $%  ANS002.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
...
读数据流: 
  ...
  $  000.动作状态               $    $       $    $  ANS000.BYTE004  $  if(x==0x00)y=@0049;else if(x==0x01)y=@001c; else if(x==0x02)y=@001d;else if(x==0x03)y=@001e;else y=@00d8;
  $  001.车窗位置               $    $       $    $  ANS001.BYTE004  $  if(x==0x00)y=@0049;else if(x==0x01)y=@0019; else if(x==0x02)y=@001a;else if(x==0x03)y=@001b;else y=@00d8;
  $  002.位置状态               $    $       $    $  ANS002.BYTE004  $  if(x==0x00)y=@0003;else if(x==0x01)y=@00db; else if(x==0x02)y=@050b;else y=@00d8;
  $  003.自动上升开关信号       $    $       $    $  ANS003.BYTE004  $  if(x==0x00)y=@001d;else if(x==0x01)y=@001e;else y=@00d8;
  $  004.自动下降开关信号       $    $       $    $  ANS004.BYTE004  $  if(x==0x00)y=@001d;else if(x==0x01)y=@001e;else y=@00d8;
  $  005.手动上升开关信号       $    $       $    $  ANS005.BYTE004  $  if(x==0x00)y=@001d;else if(x==0x01)y=@001e;else y=@00d8;
  $  006.手动下降开关信号       $    $       $    $  ANS006.BYTE004  $  if(x==0x00)y=@001d;else if(x==0x01)y=@001e;else y=@00d8;
  $  007.玻璃位置百分比         $    $       $    $  ANS007.BYTE004  $  if(x<0xc9)y=x;else y=@00d8;

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:726 30 01 04 55 55 55 55 55  $FC 
