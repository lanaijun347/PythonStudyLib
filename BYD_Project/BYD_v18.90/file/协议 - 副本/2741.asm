...
读数据流: 
  ...
  $  002.风扇状态                           $    $             $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;0x02: y=@007b;0x03: y=@007b;default: y=@01c6;
  $  003.接地状态                           $    $             $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;0x02: y=@007b;0x03: y=@007b;default: y=@01c6;
  ...
  $  008.PFC(功率因数校正)桥温度            $    $  赫兹       $    $  ANS008.BYTE004  $  y=x1-40;
  $  009.PWM(脉宽调制)波占空比              $    $  %          $    $  ANS009.BYTE004  $  y=x1;
  $  010.12V输出电流                        $    $  A          $    $  ANS010.BYTE004  $  y=x1*0.1;
  $  011.12V输出电压                        $    $  V          $    $  ANS011.BYTE004  $  y=x1*0.1;
  $  012.车内插座放电状态                   $    $             $    $  ANS012.BYTE004  $  switxh(x1)0x00: y=@01c7;0x01: y=@0265;0x02: y=@0266;0x03: y=@0267;0x04: y=@0268;0x05: y=@007b;0x06: y=@007b;0x07: y=@007b;default: y=@01c6;
  $  013.VTOL(车辆对用电设备)放电状态       $    $             $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@01c7;0x01: y=@0265;0x02: y=@0266;0x03: y=@0267;0x04: y=@0268;0x05: y=@007b;0x06: y=@007b;0x07: y=@007b;default: y=@01c6;
  $  014.车载充电功率状态                   $    $             $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@03ce;0x01: y=@01d2;0x02: y=@01d1;0x03: y=@007b;default: y=@01c6;
  $  015.交流外充设备故障状态               $    $             $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
  $  016.交流外充接地状态                   $    $             $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;0x02: y=@007b;0x03: y=@007b;default: y=@01c6;
  $  017.充电枪连接状态                     $    $             $    $  ANS017.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;0x02: y=@002a;default: y=@01c6;
  $  018.限功率放电状态                     $    $             $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@03cd;default: y=@01c6;
  $  019.应急充电是否允许                   $    $             $    $  ANS019.BYTE004  $  switxh(x1)0x00: y=@0196;0x01: y=@0195;default: y=@01c6;
  $  020.交流互锁故障                       $    $             $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
