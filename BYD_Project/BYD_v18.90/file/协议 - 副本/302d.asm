...
读数据流: 
  ...
  $  000.前摄像头配置信息       $    $       $    $  ANS000.BYTE004  $  if((x1>=0)&&(x1<=1)) y=@0015;else if((x1>=2)&&(x1<=255)) y=x1;else y=@0001;
  $  001.后摄像头配置信息       $    $       $    $  ANS000.BYTE005  $  if((x1>=0)&&(x1<=1)) y=@0015;else if((x1>=2)&&(x1<=255)) y=x1;else y=@0001;
  $  002.左摄像头配置信息       $    $       $    $  ANS000.BYTE006  $  if((x1>=0)&&(x1<=1)) y=@0015;else if((x1>=2)&&(x1<=255)) y=x1;else y=@0001;
  $  003.右摄像头配置信息       $    $       $    $  ANS000.BYTE007  $  if((x1>=0)&&(x1<=1)) y=@0015;else if((x1>=2)&&(x1<=255)) y=x1;else y=@0001;
  $  004.倒车雷达使能状态       $    $       $    $  ANS000.BYTE008  $  switxh(x1)0x00: y=@0013;0x01: y=@0014;default: y=@0001;
  $  005.全景产品序列号         $    $       $    $  ANS001.BYTE004  $  y=SPRINTF([%02X%02X%02X],x1,x2,x3);
  $  006.生产日期               $    $       $    $  ANS001.BYTE007  $  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
