...
读数据流: 
  ...
  $  000.后驱动电机状态                     $    $               $    $  ANS000.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0179;else if((x1 == 0x01)&&(x2==0x00)) y = @0223;else if((x1 == 0x02)&&(x2==0x00)) y = @001e;else y = @0001;
  $  001.启动允许                           $    $               $    $  ANS001.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @013f;else if((x1 == 0x01)&&(x2==0x00)) y = @09b9;else y = @0001;
  $  002.防盗解除状态                       $    $               $    $  ANS002.BYTE004  $  if(x1 == 0x00)y = @013c;else if(x1 == 0x01)y = @013d;else if(x1 == 0x02)y = @09df;else y=@0001;
  $  003.主动泄放状态                       $    $               $    $  ANS003.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0215;else if((x1 == 0x01)&&(x2==0x00)) y = @0964;else if((x1 == 0x02)&&(x2==0x00)) y = @0217;else if((x1 == 0x03)&&(x2==0x00)) y = @0218;else y = @0001;
  $  004.盖子状态                           $    $               $    $  ANS004.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @001d;else if((x1 == 0x01)&&(x2==0x00)) y = @001e;else y = @0001;
  $  005.动力系统状态                       $    $               $    $  ANS005.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @0167;else y = @0001;
  ...
  $  011.IPM(智能功率模块)散热器温度        $    $  degree C     $    $  ANS011.BYTE004  $  y = (x2*256+x1)-40;
  ...
  $  018.旋变状态                           $    $               $    $  ANS018.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @0167;else y = @0001;
  $  019.过流状态                           $    $               $    $  ANS019.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @0167;else y = @0001;
  $  020.IPM(智能功率模块)状态              $    $               $    $  ANS020.BYTE004  $  if((x1 == 0x00)&&(x2==0x00)) y = @0078;else if((x1 == 0x01)&&(x2==0x00)) y = @0167;else y = @0001;
