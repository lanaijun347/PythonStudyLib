...
读数据流: 
  ...
  $  REQ006:782 03 22 20 43 00 00 00 00       $  ANS006:78A 03 22 20 43 00 00 00 00
  ...
  $  024.EPB(电子驻车系统)变量配置       $    $            $    $  ANS005.BYTE004  $  switxh(x1)0xDD: y=@080e;0xBB: y=@080f;default: y=@0001;
  $  025.速度限制监视器                  $    $            $    $  ANS006.BYTE004  $  switxh(x1)0x00: y=@027d;0x01: y=@020a;default: y=@0001;
