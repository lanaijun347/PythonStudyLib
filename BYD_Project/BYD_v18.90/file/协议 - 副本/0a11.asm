...
读数据流: 
  ...
  $  000.内部供电状况             $    $       $    $  ANS000.BYTE004  $  if(x==00) y=@00cb;else if(x==0xff) y=@00cc;
  $  001.读卡器是否失去通信       $    $       $    $  ANS000.BYTE005  $  if(x==00) y=@00c9;else if(x==0xff) y=@0a78;
  $  002.读卡器内部天线故障       $    $       $    $  ANS000.BYTE006  $  if(x==00) y=@0078;else if(x==0xff) y=@0087;
