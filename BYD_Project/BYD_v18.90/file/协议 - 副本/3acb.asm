...
读数据流: 
  ...
  $  008.系统状态                 $    $         $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@001e;0x01: y=@00f2;0x02: y=@00f3;0x03: y=@00f4;default: y=@00f5;
  $  009.主副雷达下线标定值       $    $         $    $  ANS009.BYTE004  $  if(x1==0) y=@0018;else if(x1==1) y=@03e1;else if(x1==2) y=@037b;else if(x1==3) y=@0358;else if(x1==4) y=@0356;else if(x1==5) y=@035a;else if(x1==6) y=@00d8;else if((x1>=7)&&(x1<=255)) y=@055b;else y=@0001;
