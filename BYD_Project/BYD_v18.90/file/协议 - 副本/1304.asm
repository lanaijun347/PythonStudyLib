...
读数据流: 
  ...
  $  011.左侧驻车状态                              $    $                $    $  ANS011.BYTE004  $  if(x1 == 0x00) y = @001b;else if(x1 == 0x01) y = @00ff;else if(x1 == 0x02) y = @0100;else if(x1 == 0x03) y = @0101;else if(x1 == 0x04) y = @0102;else if(x1 == 0x05) y = @0103;else if(x1 == 0x06) y = @0104;else y = @01c6;
  $  012.右侧驻车状态                              $    $                $    $  ANS012.BYTE004  $  if(x1 == 0x00) y = @001b;else if(x1 == 0x01) y = @00ff;else if(x1 == 0x02) y = @0100;else if(x1 == 0x03) y = @0101;else if(x1 == 0x04) y = @0102;else if(x1 == 0x05) y = @0103;else if(x1 == 0x06) y = @0104;else y = @01c6;
  $  013.EPB(电子驻车)开关状态                     $    $                $    $  ANS013.BYTE004  $  if(x1 == 0x00) y = @00fd;else if(x1 == 0x01) y = @00fe;else if(x1 == 0x02) y = @027c;else y = @01c6;
  $  014.车速                                      $    $  km/h          $    $  ANS014.BYTE004  $  y = x1*25.6+x2*26.0/255;
  $  015.点火开关状态                              $    $                $    $  ANS015.BYTE004  $  if(x1 == 0x00) y = @001e;else if(x1 == 0x01) y = @001d;else y = @01c6;
