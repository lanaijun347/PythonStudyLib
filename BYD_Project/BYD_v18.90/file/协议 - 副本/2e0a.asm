...
读数据流: 
  ...
  $  020.真空泵状态                      $    $  %        $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@0238;0x01: y=@0239;default: y=@0001;
  ...
  $  025.真空压力报警                    $    $           $    $  ANS025.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@023d;else if(x1==2) y=@023e;else y=@0001;
  $  026.真空泵工作时间                  $    $  Min      $    $  ANS026.BYTE004  $  y=(x4*256*256*256+x3*256*256+x2*256+x1);
  $  027.真空泵继电器状态                $    $           $    $  ANS027.BYTE004  $  if(x1==0) y=@0078;else if(x1==1) y=@023a;else if(x1==2) y=@023b;else if(x1==3) y=@023c;else y=@0001;
  $  028.整车车速                        $    $  km/h     $    $  ANS028.BYTE004  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=7530)) y=SPRINTF([%.1f],(x2*256+x1)*0.1);else if((x2*256+x1)==65535) y=@0027;else y=@0001;
  $  029.总里程                          $    $  km       $    $  ANS029.BYTE004  $  y=SPRINTF([%.1f],(x3*256*256+x2*256+x1)/10);
  $  030.倾角标定工作信息/是否校准       $    $           $    $  ANS030.BYTE004  $  if((x2*256+x1)==0) y=@015d;else if((x2*256+x1)==1) y=@015e;else y=@0120;
  ...
  $  037.巡航配置状态                    $    $           $    $  ANS037.BYTE004  $  switxh((x2*256+x1))0x00: y=@0157;0x01: y=@022e;0x02: y=@022f;default: y=@0001;
  $  038.制动开关状态                    $    $           $    $  ANS038.BYTE004  $  if((x2*256+x1)==0) y=@0182;else if((x2*256+x1)==1) y=@0118;else y=@0001;
  $  039.VIN(车辆识别码)是否写入         $    $           $    $  ANS039.BYTE004  $  if((x2*256+x1)==0) y=@0230;else if((x2*256+x1)==1) y=@0231;else y=@0001;
