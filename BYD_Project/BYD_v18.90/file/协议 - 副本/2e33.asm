...
读数据流: 
  ...
  $  000.左侧散热片温度              $    $  ℃     $    $  ANS000.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if(x1==208) y=@099b;else if(x1==216) y=@099c;else y=@0001;
  ...
  $  007.主驾驶侧1#芯体温度          $    $  ℃     $    $  ANS007.BYTE004  $  if((x1>=0)&&(x1<=160)) y=x1;else if(x1==208) y=@099b;else if(x1==216) y=@099c;else y=@0001;
  $  008.主驾驶侧2#芯体温度          $    $  ℃     $    $  ANS008.BYTE004  $  if((x1>=0)&&(x1<=160)) y=x1;else if(x1==208) y=@099b;else if(x1==216) y=@099c;else y=@0001;
