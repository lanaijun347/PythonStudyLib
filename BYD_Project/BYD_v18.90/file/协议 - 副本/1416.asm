...
进入命令:
  ...
  $~  REQ001:735 02 10 01 00 00 00 00 00       $~  ANS001:73D 02 10 01 00 00 00 00 00
...
读数据流: 
  ...
  $  000.驻车辅助配置类型       $    $       $    $  ANS000.BYTE004  $  if(x1==0x00)y=@02d6;else if(x1==0x01)y=@02d7;else if(x1==0x02)y=@02d8;else y=@020c;
