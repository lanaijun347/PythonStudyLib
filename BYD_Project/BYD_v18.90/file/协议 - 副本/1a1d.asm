...
读数据流: 
  ...
  $  013.左侧纺锤形撑杆动作信号         $    $        $    $  ANS013.BYTE004  $  if((x1&0x03) == 0x00) y = @0025;else if((x1&0x03) == 0x01) y = @0026;else if((x1&0x03) == 0x02) y = @001c;else if((x1&0x03) == 0x03) y = @0001;
  $  014.右侧纺锤形撑杆动作信号         $    $        $    $  ANS014.BYTE004  $  if((x1&0x03) == 0x00) y = @0025;else if((x1&0x03) == 0x01) y = @0026;else if((x1&0x03) == 0x02) y = @001c;else if((x1&0x03) == 0x03) y = @0001;
