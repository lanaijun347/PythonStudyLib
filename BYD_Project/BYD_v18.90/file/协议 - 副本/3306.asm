...
读数据流: 
  ...
  $  013.端部保护状态             $    $           $    $  ANS013.BYTE004  $  switxh(x1&0x03)0x00: y=@02f9;0x01: y=@02fa;0x02: y=@02fb;default: y=@0001;
  $  014.系统状态                 $    $           $    $  ANS014.BYTE004  $  switxh((x1*256+x2))0x00: y=@02ff;0x01: y=@0300;0x02: y=@0301;0x03: y=@0302;0x04: y=@0303;0x05: y=@0304;0x06: y=@0305;0xFF: y=@0027;default: y=@0001;
  $  015.助力模式                 $    $           $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@02fc;0x01: y=@02fd;0x02: y=@02fe;default: y=@0001;
