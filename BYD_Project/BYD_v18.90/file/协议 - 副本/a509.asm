...
读数据流: 
  ...
  $  005.左前进油阀状态         $    $           $    $  ANS002.BYTE006  $  if(x1&0x01) y=@0173;else y=@0172;
  $  006.左前出油阀状态         $    $           $    $  ANS002.BYTE006  $  if(x1&0x02) y=@0173;else y=@0172;
  $  007.右前进油阀状态         $    $           $    $  ANS002.BYTE006  $  if(x1&0x04) y=@0173;else y=@0172;
  $  008.右前出油阀状态         $    $           $    $  ANS002.BYTE006  $  if(x1&0x08) y=@0173;else y=@0172;
  $  009.左后进油阀状态         $    $           $    $  ANS002.BYTE006  $  if(x1&0x10) y=@0173;else y=@0172;
  $  010.左后出油阀状态         $    $           $    $  ANS002.BYTE006  $  if(x1&0x20) y=@0173;else y=@0172;
  $  011.右后进油阀状态         $    $           $    $  ANS002.BYTE006  $  if(x1&0x40) y=@0173;else y=@0172;
  $  012.右后出油阀状态         $    $           $    $  ANS002.BYTE006  $  if(x1&0x80) y=@0173;else y=@0172;
  $  013.制动灯状态             $    $           $    $  ANS002.BYTE007  $  if(x1&0x20) y=@0173;else y=@0172;
  $  014.回流泵电机状态         $    $           $    $  ANS002.BYTE007  $  if(x1&0x40) y=@0173;else y=@0172;
  $  015.电磁阀继电器状态       $    $           $    $  ANS002.BYTE007  $  if(x1&0x80) y=@0173;else y=@0172;
  $  016.制动液压模块状态       $    $           $    $  ANS003.BYTE005  $  if(x1==0) y=@0206;else if(x1==0x01) y=@0bcc;else if(x1==0xAA) y=@0bcd;else if(x1==0xEE) y=@0bce;else if(x1==0xFF) y=@0bcc;else y=@0525;
