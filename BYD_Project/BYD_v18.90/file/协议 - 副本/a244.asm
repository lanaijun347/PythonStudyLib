...
读数据流: 
  ...
  $  002.位置状态               $    $        $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0003;else if(x1==0x01)y=@0aea;else if(x1==0x02)y=@08c6;else y=@00d8;
  ...
  $  006.手动下降开关信号       $    $        $    $  ANS006.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@00d8;
  $  007.玻璃位置百分比         $    $  %     $    $  ANS007.BYTE004  $  if(x1<0xc9) y=x1/2.0;else y=@00d8;
  $  008.车窗遥控升降状态       $    $        $    $  ANS008.BYTE004  $  if(x1==0x00)y=@0a8b;else if(x1==0x01)y=@0a8c;else if(x1==0x02)y=@0a8d;else y=@00d8;
