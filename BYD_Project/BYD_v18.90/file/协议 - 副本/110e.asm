...
读数据流: 
  ...
  $  065.发动机启动命令                              $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x07)0x02:y=@011a; 0x03: y=@011a;0x04:y=@08a8; 0x05: y=@08a8;default:y=@0003;
  $  066.低压启动电池状态                            $    $               $    $  ANS000.BYTE018  $  if((x1&0x1F)<0x08)y=@002a;else if((x1&0x1F)<0x10)y=@002b;else if((x1&0x1F)<0x18)y=@002a;else y=@0003;
  $  067.发动机启动超时次数                          $    $               $    $  ANS000.BYTE018  $  if((x1&0x7F)<0x20)y=@0078;else if((x1&0x7F)<0x40)y=@08a6;else if((x1&0x7F)<0x60)y=@08a7;else y=@0003;
  $  068.真空泵控制回路#1                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x07)0x00:y=@0606; 0x01: y=@0606;0x02:y=@0214; 0x03: y=@0214;0x04:y=@0078; 0x05: y=@0078;default:y=@0003;
  $  069.真空泵控制回路#2                            $    $               $    $  ANS000.BYTE020  $  if((x1&0x1F)<0x08)y=@0606;else if((x1&0x1F)<0x10)y=@0214;else if((x1&0x1F)<0x18)y=@0078;else y=@0003;
  $  070.真空泵泄露状态                              $    $               $    $  ANS000.BYTE020  $  if((x1&0x7F)<0x20)y=@0606;else if((x1&0x7F)<0x40)y=@08a9;else if((x1&0x7F)<0x60)y=@049a;else y=@0078;
  $  071.低速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x01)y=@0185;else y=@0186;
  $  072.高速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x02)y=@0185;else y=@0186;
  $  073.风扇类型                                    $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@0194;else if((x1&0x0F)<0x08)y=@09c4;else y=@007b;
