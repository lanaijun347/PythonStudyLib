...
读数据流: 
  ...
  $  002.扭矩主信号占空比       $    $  %            $    $  ANS002.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y = @09eb; else if((x1==0x01)&&(x2==0x10)) y=@09ec;else if((x1*6.2/255+x2*6.25)>100) y=@0001;else y=x1*6.2/255+x2*6.25;
  $  003.扭矩主信号周期         $    $  微秒         $    $  ANS003.BYTE004  $  if(((x1+x2*256)*0.1>0)&&((x1+x2*256)*0.1<=750)) y=(x1+x2*256)*0.1;else if((x1==0xFF) && (x2==0xFF)) y=@09ea;else y = @0001;
  $  004.扭矩辅信号占空比       $    $  %            $    $  ANS004.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y = @09eb; else if((x1==0x01)&&(x2==0x10)) y=@09ec;else if((x1*6.2/255+x2*6.25)>100) y=@0001;else y=x1*6.2/255+x2*6.25;
  $  005.扭矩辅信号周期         $    $  微秒         $    $  ANS005.BYTE004  $  if(((x1+x2*256)*0.1>0)&&((x1+x2*256)*0.1<=750)) y=(x1+x2*256)*0.1;else if((x1==0xFF) && (x2==0xFF)) y=@09ea;else y = @0001;
  $  006.P值占空比              $    $  %            $    $  ANS006.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y = @09eb;else if((x1*6.2/255+x2*6.25)>100) y=@0001;else y=x1*6.2/255+x2*6.25;
  $  007.P值周期                $    $  微秒         $    $  ANS007.BYTE004  $  if(((x1+x2*256)*0.1>0)&&((x1+x2*256)*0.1<=1500)) y=(x1+x2*256)*0.1;else if((x1==0xFF) && (x2==0xFF)) y=@09ea;else y = @0001;
  $  008.S值占空比              $    $  %            $    $  ANS008.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y = @09eb;else if((x1*6.2/255+x2*6.25)>100) y=@0001;else y=x1*6.2/255+x2*6.25;
  $  009.S值周期                $    $  微秒         $    $  ANS009.BYTE004  $  if((x1==0x00) && (x2==0x00)) y = @0001;else if((x1==0xFF) && (x2==0xFF)) y=@09ea;else y=(x1+x2*256)*0.1;
  ...
  $  015.当前助力模式           $    $               $    $  ANS015.BYTE004  $  if((x2==0x00) && (x1==0x00)) y=@09ed;else if((x2==0x00) && (x1==0x01)) y=@0319;else if((x2==0x00) && (x1==0x02)) y=@09ee;else y=@0001;
