...
版本信息:
  ...
  $%  008:MCU软件生产日期:        $%    $%  ANS003.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
  $%  009:MCU硬件版本:            $%    $%  ANS004.BYTE004  $%  y=x1*0.1;
  $%  010:全景硬件平台:           $%    $%  ANS004.BYTE006  $%  y=x1*0.1;
  $%  011:MCU硬件生产日期:        $%    $%  ANS004.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
