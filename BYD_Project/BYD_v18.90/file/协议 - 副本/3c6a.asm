...
读数据流: 
  ...
  $  001.电动门动作状态                    $    $        $    $  ANS001.BYTE004  $  switxh(x1&0x03)0x00: y=@001d;0x01: y=@001e;0x02: y=@001c;default: y=@0001;
  ...
  $  006.车内开关信号                      $    $        $    $  ANS006.BYTE004  $  if((x1&0x03)==0x00) y=@0003;else if((x1&0x03)==0x01) y=@0647;else if((x1&0x03)==0x02) y=@0648;else if((x1&0x03)==0x03) y=@0649;else y=@0001;
