...
读数据流: 
  ...
  $  012.水泵状态                        $    $               $    $  ANS012.BYTE004  $  if((((x2<<8)+x1)==0)) y=@00d9;else if((((x2<<8)+x1)==1)) y=@001e;else y=@00d8;
  ...
  $  017.巡航目标车速                    $    $  km/h         $    $  ANS017.BYTE004  $  if((((x2<<8)+x1)>=0)&&(((x2<<8)+x1)<=3000))y=(((x2<<8)+x1))*1.0/10;else if((((x2<<8)+x1)==65535)) y=@032c;else y=@0001;
  ...
  $  021.EPB(电子驻车)状态               $    $               $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@0102;0x01: y=@0117;0x02: y=@0232;0x03: y=@01ef;0x04: y=@0167;default: y=@0001;
  $  022.坡道坡度                        $    $               $    $  ANS022.BYTE004  $  if((((x2<<8)+x1)>=0)&&(((x2<<8)+x1)<=200))y=(((x2<<8)+x1))-100;else if((((x2<<8)+x1)==32767)) y=@015a;else y=@0120;
  ...
  $  029.整车车速                        $    $  km/h         $    $  ANS029.BYTE004  $  if((x1>=0)&&(x1<=3000)) y=x1;else if((x1==65535)) y=@0027;else y=@0001;
  $  030.总里程                          $    $  km           $    $  ANS030.BYTE004  $  y=((x3<<16)+(x2<<8)+x1)*1.0/10;
  $  031.倾角标定工作信息/是否校准       $    $               $    $  ANS031.BYTE004  $  if((((x2<<8)+x1)==0)) y=@015d;else if((((x2<<8)+x1)==1)) y=@015e;else y=@0120;
  ...
  $  036.巡航配置                        $    $               $    $  ANS036.BYTE004  $  if((((x2<<8)+x1)==0)) y=@0157;else if((((x2<<8)+x1)==1)) y=@022e;else if((((x2<<8)+x1)==2)) y=@022f;else y=@0001;
  $  037.制动开关状态                    $    $               $    $  ANS037.BYTE004  $  if((((x2<<8)+x1)==0)) y=@0182;else if((((x2<<8)+x1)==1)) y=@0118;else y=@0001;
  $  038.VIN(车辆识别码)是否写入         $    $               $    $  ANS038.BYTE004  $  if((((x2<<8)+x1)==0)) y=@0230;else if((((x2<<8)+x1)==1)) y=@0231;else y=@0001;
