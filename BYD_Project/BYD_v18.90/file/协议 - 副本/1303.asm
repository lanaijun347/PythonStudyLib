...
读数据流: 
  ...
  $  073.发动机冷却系统-低速风扇是否开启             $    $               $    $  ANS000.BYTE023  $  if(x1&0x01)y=@0185;else y=@0186;
  $  074.发动机冷却系统-高速风扇是否开启             $    $               $    $  ANS000.BYTE023  $  if(x1&0x02)y=@0185;else y=@0186;
  $  075.发动机冷却系统-风扇类型                     $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@0194;else if((x1&0x0F)<0x08)y=@0193;else y=@0001;
  $  076.发动机稳态工况-点火电源开启                 $    $               $    $  ANS000.BYTE024  $  if(x1&0x01)y=@0185;else y=@0186;
  $  077.发动机稳态工况-主继电器工作                 $    $               $    $  ANS000.BYTE024  $  if(x1&0x02)y=@0185;else y=@0186;
  $  078.发动机动态工况-节气门处于怠速位置           $    $               $    $  ANS000.BYTE025  $  if(x1&0x01)y=@0185;else y=@0186;
  $  079.发动机动态工况-节气门处于部分打开位置       $    $               $    $  ANS000.BYTE025  $  if(x1&0x02)y=@0185;else y=@0186;
  $  080.发动机动态工况-节气门处于全开位置           $    $               $    $  ANS000.BYTE025  $  if(x1&0x04)y=@0185;else y=@0186;
  $  081.发动机动态工况-激活减速断油                 $    $               $    $  ANS000.BYTE025  $  if(x1&0x08)y=@00f2;else y=@0181;
  $  082.发动机动态工况-激活加速加浓                 $    $               $    $  ANS000.BYTE025  $  if(x1&0x10)y=@00f2;else y=@0181;
  $  083.发动机动态工况-是否D档(前进挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x20)y=@0185;else y=@0186;
  $  084.发动机动态工况-是否R档(后退挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x40)y=@0185;else y=@0186;
  $  085.发动机动态工况-是否N档(空挡)                $    $               $    $  ANS000.BYTE025  $  if(x1&0x80)y=@0185;else y=@0186;
  $  086.氧传感器-氧传感器1信号                      $    $               $    $  ANS000.BYTE027  $  if(x1&0x01)y=@017f;else y=@0180;
  $  087.氧传感器-氧传感器2信号                      $    $               $    $  ANS000.BYTE027  $  if(x1&0x02)y=@017f;else y=@0180;
  $  088.氧传感器-氧传感器1加热                      $    $               $    $  ANS000.BYTE027  $  if(x1&0x10)y=@0183;else y=@0184;
  $  089.氧传感器-氧传感器2加热                      $    $               $    $  ANS000.BYTE027  $  if(x1&0x20)y=@0183;else y=@0184;
  $  090.发动机怠速-踏板位置确认怠速                 $    $               $    $  ANS000.BYTE028  $  if(x1&0x01)y=@0185;else y=@0186;
  $  091.发动机怠速-制动器状态                       $    $               $    $  ANS000.BYTE028  $  if(x1&0x02)y=@0118;else y=@0182;
  $  092.发动机怠速-是否有空调请求                   $    $               $    $  ANS000.BYTE028  $  if(x1&0x04)y=@0185;else y=@0186;
  $  093.发动机怠速-后车窗/前挡风玻璃加热            $    $               $    $  ANS000.BYTE028  $  if(x1&0x08)y=@001d;else y=@001e;
  $  094.发动机怠速-动力转向开关                     $    $               $    $  ANS000.BYTE028  $  if(x1&0x10)y=@001d;else y=@001e;
  $  095.发动机怠速-真空泵状态                       $    $               $    $  ANS000.BYTE028  $  if(x1&0x40)y=@001d;else y=@001e;
  $  096.指示灯SVS/MIL-MIL(故障指示灯)激活           $    $               $    $  ANS000.BYTE029  $  if(x1&0x01)y=@00f2;else y=@0181;
  $  097.指示灯SVS/MIL-MIL(故障指示灯)闪烁           $    $               $    $  ANS000.BYTE029  $  if(x1&0x02)y=@0185;else y=@0186;
  $  098.指示灯SVS/充电系统故障灯                    $    $               $    $  ANS000.BYTE029  $  if(x1&0x04)y=@0078;else y=@0167;
  $  099.指示灯SVS/MIL-SVS(系统维修指示灯)激活       $    $               $    $  ANS000.BYTE029  $  if(x1&0x10)y=@00f2;else y=@0181;
  $  100.指示灯SVS/MIL-SVS(系统维修指示灯)闪烁       $    $               $    $  ANS000.BYTE029  $  if(x1&0x20)y=@0185;else y=@0186;
  $  101.空调系统-空调开启                           $    $               $    $  ANS000.BYTE031  $  if(x1&0x01)y=@0185;else y=@0186;
  $  102.空调系统-空调请求激活                       $    $               $    $  ANS000.BYTE031  $  if(x1&0x02)y=@00f2;else y=@0181;
  $  103.空调系统-空调压缩机开                       $    $               $    $  ANS000.BYTE031  $  if(x1&0x04)y=@0185;else y=@0186;
  $  104.空调系统-空调断开或无空调                   $    $               $    $  ANS000.BYTE031  $  if(x1&0x08)y=@0185;else y=@0186;
  $  105.空调系统-空调因温度断开                     $    $               $    $  ANS000.BYTE031  $  if(x1&0x10)y=@0185;else y=@0186;
  $  106.空调系统-怠速转速因空调而增加               $    $               $    $  ANS000.BYTE031  $  if(x1&0x20)y=@0185;else y=@0186;
  $  107.空调系统-全负荷时关闭空调压缩机             $    $               $    $  ANS000.BYTE031  $  if(x1&0x40)y=@0185;else y=@0186;
  $  108.空调系统-空调中压开关开                     $    $               $    $  ANS000.BYTE031  $  if(x1&0x80)y=@0185;else y=@0186;
  $  109.AT/扭矩请求-AT转换离合器激活                $    $               $    $  ANS000.BYTE032  $  if(x1&0x08)y=@00f2;else y=@0181;
  $  110.巡航控制-巡航功能                           $    $               $    $  ANS000.BYTE033  $  if(x1&0x01) y = @001d;else y = @001e;
  $  111.巡航控制-巡航状态                           $    $               $    $  ANS000.BYTE033  $  if(x1&0x02)y=@0002;else y=@0003;
  $  112.巡航控制-按键状态                           $    $               $    $  ANS000.BYTE033  $  if((x1&0x1F)<0x04)y=@018b;else if((x1&0x1F)<0x08)y=@018c;else if((x1&0x1F)<0x0C)y=@018d;else if((x1&0x1F)<0x10)y=@018e;else if((x1&0x1F)<0x14)y=@018f;else if((x1&0x1F)<0x18)y=@0190;else y=@0001;
  $  113.发动机状态-刹车开关激活                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x01)y=@00f2;else y=@0181;
  $  114.发动机状态-刹车灯激活                       $    $               $    $  ANS000.BYTE034  $  if(x1&0x02)y=@00f2;else y=@0181;
  $  115.发动机状态-涡轮增压旁通阀                   $    $               $    $  ANS000.BYTE034  $  if(x1&0x10)y=@001d;else y=@001e;
  $  116.发动机状态-防盗锁定状态                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x20)y=@000a;else y=@0459;
  $  117.发动机状态-燃油反馈状态                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x40)y=@0189;else y=@018a;
  $  118.发动机状态-可变气门升程阀状态(VVL阀)        $    $               $    $  ANS000.BYTE034  $  if(x1&0x80)y=@001d;else y=@001e;
