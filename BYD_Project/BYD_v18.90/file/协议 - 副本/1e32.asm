...
版本信息:
  ...
  $%  007:STK软件日期:         $%    $%  ANS003.BYTE006  $%  y=SPRINTF([%02d/%02d/%02d],x1,x2,x3);
  $%  008:修改次数:            $%    $%  ANS003.BYTE009  $%  y=x1;
  $%  009:STK硬件版本:         $%    $%  ANS004.BYTE004  $%  y=SPRINTF([%d.%d],x1/10,x1%10);
  $%  010:STK硬件日期:         $%    $%  ANS004.BYTE005  $%  y=SPRINTF([%d年%d月%d日],x1,x2,x3);
  $%  011:修改次数:            $%    $%  ANS004.BYTE009  $%  y=x1;
