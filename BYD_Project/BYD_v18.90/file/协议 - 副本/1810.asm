...
读数据流: 
  ...
  $  REQ013:710 03 22 21 0A 00 00 00 00       $  ANS013:718 03 22 21 0A 00 00 00 00
  ...
  $  018.安装模式                        $    $               $    $  ANS013.BYTE004  $  if(x1&0x01)y=@030b;else y=@03dd;
  $  019.拉力校准                        $    $               $    $  ANS013.BYTE004  $  if(x1&0x02)y=@030b;else y=@03dd;
  $  020.Run-ln完成                      $    $               $    $  ANS013.BYTE004  $  if(x1&0x04)y=@030b;else y=@03dd;
