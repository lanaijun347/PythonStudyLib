...
读数据流: 
  ...
  $  009.语音输入开关状态              $    $       $    $  ANS000.BYTE005  $  if(x1&0x02) y=@002a;else y=@00e4;
  ...
  $  015.蓝牙电话关状态                $    $       $    $  ANS000.BYTE005  $  if(x1&0x80) y=@002a;else y=@00e4;
  ...
  $  019.仪表返回按键状态              $    $       $    $  ANS001.BYTE004  $  if(x1&0x08) y=@002a;else y=@00e4;
  $  020.挂电话&仪表返回按键状态       $    $       $    $  ANS001.BYTE004  $  if(x1&0x10) y=@002a;else y=@00e4;
  $  021.巡航按键状态                  $    $       $    $  ANS001.BYTE004  $  if(x1&0x20) y=@002a;else y=@00e4;
  $  022.取消按键状态                  $    $       $    $  ANS001.BYTE004  $  if(x1&0x40) y=@002a;else y=@00e4;
  $  023.速度+按键状态                 $    $       $    $  ANS001.BYTE004  $  if(x1&0x80) y=@002a;else y=@00e4;
  $  024.速度-按键状态                 $    $       $    $  ANS001.BYTE005  $  if(x1&0x01) y=@002a;else y=@00e4;
  $  025.设置按键状态                  $    $       $    $  ANS001.BYTE005  $  if(x1&0x02) y=@002a;else y=@00e4;
  $  026.复位按键状态                  $    $       $    $  ANS001.BYTE005  $  if(x1&0x04) y=@002a;else y=@00e4;
  $  027.时距按键/时距减按键状态       $    $       $    $  ANS001.BYTE005  $  if(x1&0x08) y=@002a;else y=@00e4;
  $  028.时距加按键状态                $    $       $    $  ANS001.BYTE005  $  if(x1&0x10) y=@002a;else y=@00e4;
  $  029.车道偏移按键状态              $    $       $    $  ANS001.BYTE005  $  if(x1&0x20) y=@002a;else y=@00e4;
