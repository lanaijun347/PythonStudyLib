...
读数据流: 
  ...
  $  002.电源档位状态                      $    $        $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0003;0x01: y=@0012;0x02: y=@0011;0x03: y=@0010;default: y=@0001;
  ...
  $  015.电源电压                          $    $  V     $    $  ANS015.BYTE004  $  y=SPRINTF([%.2f],x1*0.078);
  $  016.后背门当前位置                    $    $        $    $  ANS016.BYTE004  $  y=(x2*256+x1);
  $  017.后背门行程                        $    $        $    $  ANS017.BYTE004  $  y=(x2*256+x1);
  $  018.左侧撑杆当前位置                  $    $        $    $  ANS018.BYTE004  $  y=(x2*256+x1);
  $  019.左侧撑杆行程                      $    $        $    $  ANS019.BYTE004  $  y=(x2*256+x1);
  $  020.右侧撑杆当前位置                  $    $        $    $  ANS020.BYTE004  $  y=(x2*256+x1);
  $  021.右侧撑杆行程                      $    $        $    $  ANS021.BYTE004  $  y=(x2*256+x1);
