...
版本信息:
  ...
  $%  004:VIN(车辆识别码):        $%    $%  ANS004.BYTE002  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
...
读数据流: 
  ...
  $  074.车载诊断系统类型                            $    $               $    $  ANS068.BYTE004  $  switxh(x1)0x00: y=@0860;0x01: y=@0861;0x04: y=@0862;0x08: y=@0863;default: y=@0001;
