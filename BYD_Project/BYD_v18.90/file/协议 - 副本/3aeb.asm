...
读数据流: 
  ...
  $  REQ001:716 03 22 B0 03 00 00 00 00       $  ANS001:71E 03 22 B0 03 00 00 00 00

  $  000.当前低压电源电压值       $    $       $    $  ANS000.BYTE004  $  y=SPRINTF([%d],(x1*256+x2)*0.1);
  $  001.车道偏离次数             $    $       $    $  ANS001.BYTE004  $  y=(x1*256*256+x2*256+x3);
  $  002.倒车雷达次数             $    $       $    $  ANS001.BYTE007  $  y=(x1*256*256+x2*256+x3);
