...
读数据流: 
  ...
  $  005.交流侧电流                        $    $  A       $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],x1*0.2);
  $  006.PWM(脉宽调制)波占空比             $    $  %       $    $  ANS006.BYTE004  $  y=x1;
  $  007.车内插座放电状态                  $    $          $    $  ANS007.BYTE004  $  switxh(x1)0x00: y=@01c7;0x01: y=@0265;0x02: y=@0266;0x03: y=@0267;0x04: y=@0268;0x05: y=@007b;0x06: y=@007b;0x07: y=@007b;default: y=@0001;
  $  008.交流外充接地状态                  $    $          $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;0x02: y=@007b;0x03: y=@007b;default: y=@01c6;
  $  009.交流互锁故障                      $    $          $    $  ANS009.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
  ...
  $  013.电感温度                          $    $  ℃      $    $  ANS013.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  014.充电口温度                        $    $  ℃      $    $  ANS014.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  015.车内插座交流侧电压                $    $          $    $  ANS015.BYTE004  $  y=(x2*256+x1);
  $  016.与BMS(电池管理系统)通讯状态       $    $          $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
  ...
  $  019.充放电系统故障状态                $    $          $    $  ANS019.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0258;0x02: y=@0259;0x03: y=@007b;0x04: y=@025a;0x05: y=@025b;0x06: y=@0418;default: y=@01c6;
  $  020.充电连接装置连接状态              $    $          $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@0254;0x01: y=@0255;0x02: y=@0256;0x03: y=@0257;default: y=@01c6;
  $  021.放电是否允许 DC放电是否允许       $    $          $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@0195;0x01: y=@0196;0x02: y=@01d3;default: y=@01c6;
  $  022.DC系统故障状态                    $    $          $    $  ANS022.BYTE004  $  switxh(x1)0x00: y=@00d8;0x01: y=@0078;0x02: y=@0167;0x03: y=@00d8;default: y=@01c6;
  $  023.DC工作模式                        $    $          $    $  ANS023.BYTE004  $  switxh(x1)0x00: y=@01d4;0x01: y=@01d5;0x02: y=@01d6;0x03: y=@00d8;default: y=@0001;
  $  024.低压输出电压                      $    $  V       $    $  ANS024.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  025.低压输出电流                      $    $  A       $    $  ANS025.BYTE004  $  y=SPRINTF([%d],x1*2-250);
  $  026.读取交流侧绝缘阻值                $    $          $    $  ANS026.BYTE004  $  if((x1>=0)&&(x1<=254)) y=x1;else if(x1==255) y=@0001;else y=@0001;
