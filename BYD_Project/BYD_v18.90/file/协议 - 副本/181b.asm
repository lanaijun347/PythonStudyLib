...
版本信息:
  ...
  $%  004:PTC(辅助加热)产品序列号:        $%    $%  ANS002.BYTE004  $%  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $%  005:生产日期:                       $%    $%  ANS002.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
...
读数据流: 
  ...
  $  000.左侧散热片温度               $    $  degree C     $    $  ANS000.BYTE004  $  if(x1<171) y=x1;else y=@0001;
