...
读数据流: 
  ...
  $  016.CAN发动机转速                               $    $  rpm      $    $  ANS009.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.25);
  $  017.CAN发动机转速状态                           $    $           $    $  ANS009.BYTE006  $  switxh(x1)0x00: y=@0078;0x01: y=@0027;default: y=@0001;
  $  018.输入轴1转速                                 $    $  rpm      $    $  ANS010.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.25);
  $  019.输入轴2转速                                 $    $  rpm      $    $  ANS011.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.25);
  $  020.输出轴转速                                  $    $  rpm      $    $  ANS012.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.25);
  ...
  $  042.促动阀3位置传感器                           $    $  mm       $    $  ANS024.BYTE004  $  y=SPRINTF([%.2f],(x1*256+x2)/100-15);
  ...
  $  061.进气温度温度                                $    $  ℃       $    $  ANS041.BYTE005  $  y=SPRINTF([%d],x1-60);
