...
读数据流: 
  ...
  $  000.放电是否允许                        $    $         $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0195;0x01: y=@0196;0x02: y=@0306;0x03: y=@0018;default: y=@0001;
  $  001.DC系统故障状态                      $    $         $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@0001;
  ...
  $  004.高压侧电流                          $    $  A      $    $  ANS004.BYTE004  $  y=SPRINTF([%d],x1-50);
  $  005.低压侧电压                          $    $  V      $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  006.低压侧电流                          $    $  A      $    $  ANS006.BYTE004  $  y=SPRINTF([%d],x1*2-250);
  $  007.MOS(金属—绝缘体半导体)管温度       $    $  ℃     $    $  ANS007.BYTE004  $  y=SPRINTF([%d],x1-40);
