...
读数据流: 
  ...
  $  000.空调前除霜次数            $    $       $    $  ANS000.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  001.Power(电源)按键次数       $    $       $    $  ANS000.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  002.空调自模式次数            $    $       $    $  ANS001.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  003.OFF(关闭)按键次数         $    $       $    $  ANS001.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
