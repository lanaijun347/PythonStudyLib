...
读数据流: 
  ...
  $  016.振动马达               $    $       $    $  ANS001.BYTE004  $  if(((x1&0x01)==0)) y=@0010;else if(((x1&0x01)==1)) y=@0012;else y=@0001;
  $  017.静音                   $    $       $    $  ANS001.BYTE004  $  if(((x1&0x02)==0)) y=@00e4;else if(((x1&0x02)==2)) y=@002a;else y=@0001;
  $  018.仪表返回               $    $       $    $  ANS001.BYTE004  $  if(((x1&0x08)==0)) y=@00e4;else if(((x1&0x08)==8)) y=@002a;else y=@0001;
