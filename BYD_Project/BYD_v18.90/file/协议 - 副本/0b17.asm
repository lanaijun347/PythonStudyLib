...
读数据流: 
  ...
  $  001.已匹配钥匙数             $    $       $    $  ANS001.BYTE004  $  if(x1==1)y=@00e6;else if(x1==2)y=@00e7;else if(x1==3)y=@00e8;else if(x1==4)y=@00e9;else y=@0525;
  $  002.内部供电状况             $    $       $    $  ANS002.BYTE004  $  if(x1==0x00)y=@00cb;else if(x1==0xFF)y=@00cc;else y=@0525;
  $  003.读卡器是否失去通信       $    $       $    $  ANS002.BYTE005  $  if(x1==0x00)y=@0526;else if(x1==0xFF)y=@09b2;else y=@0525;
  $  004.内部天线状态             $    $       $    $  ANS002.BYTE006  $  if(x1==0x00)y=@0078;else if(x1==0xFF)y=@0087;else y=@0525;
  $  005.钥匙状态                 $    $       $    $  ANS002.BYTE007  $  switxh(x1) 2:y=@00cd; 3:y=@00ce; 4:y=@09dd; 6:y=@00d0;default:y=@0525;
