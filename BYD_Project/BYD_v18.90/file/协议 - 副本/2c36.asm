...
版本信息:
  ...
  $%  REQ003:756 03 22 F1 80 00 00 00 00       $%  ANS003:75E 03 22 F1 80 00 00 00 00
  ...
  $%  006:引导程序软件版本号/日期(年):        $%    $%  ANS003.BYTE004  $%  y=SPRINTF([%02d%s%d%s%02d%s],x1+2000,@0197,x2,@019a,x3,@019b);
...
读数据流: 
  ...
  $  REQ000:756 03 22 B0 00 00 00 00 00       $  ANS000:75E 03 22 B0 00 00 00 00 00
  $  REQ001:756 03 22 B0 01 00 00 00 00       $  ANS001:75E 03 22 B0 01 00 00 00 00

  $  000.空调前除霜次数            $    $       $    $  ANS000.BYTE004  $  y=(x1*256*256+x2*256+x3);
  $  001.Power(电源)按键次数       $    $       $    $  ANS000.BYTE008  $  y=(x1*256*256+x2*256+x3);
  $  002.空调自动模式次数          $    $       $    $  ANS001.BYTE004  $  y=(x1*256*256+x2*256+x3);
  $  003.空调OFF(关闭)次数         $    $       $    $  ANS001.BYTE008  $  y=(x1*256*256+x2*256+x3);
