...
读数据流: 
  ...
  $  002.送风模式                 $    $               $    $  ANS002.BYTE004  $  if(x1==0x01) y=@006e;else if(x1==0x02) y=@006f; else if(x1==0x03) y=@0070; else if(x1==0x04) y=@0071; else if(x1==0x05) y=@0072;else y=@006d;
  $  003.AC(空调控制器)状态       $    $               $    $  ANS003.BYTE004  $  if(x1==0x00) y=@0843;else if(x1==0x01) y=@0524; else y=@006d;
  $  004.车外温度                 $    $  degree C     $    $  ANS004.BYTE004  $  if((x1<0xB3) && (x1>0x57)) y=x1-128;else if(x1==0xD0) y=@0346;else y=@006d;
  $  005.车内温度                 $    $  degree C     $    $  ANS005.BYTE004  $  if((x1<0xCF) && (x1>0x80)) y=x1-128;else if(x1==0xD0) y=@0346;else y=@006d;
  $  006.蒸发器温度               $    $  degree C     $    $  ANS006.BYTE004  $  if(x1<0x1A) y=x1;else if(x1==0xD0) y=@01e4;else y=@006d;
