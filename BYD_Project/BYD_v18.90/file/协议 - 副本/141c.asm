...
版本信息:
  ...
  $%  REQ001:730 03 22 00 02 00 00 00 00       $%  ANS001:738 03 22 00 02 00 00 00 00
  ...
  $%  004:生产日期:           $%    $%  ANS000.BYTE009  $%  y=SPRINTF([20%02X%s%02X%s%02X%s],x1,@0197,x2,@0198,x3,@0199);
  $%  005:车速信息:           $%    $%  ANS001.BYTE027  $%  y=x1;
  $%  006:ECU加密信息:        $%    $%  ANS002.BYTE004  $%  if(x1==0x00)y=@02f5;else if(x1==0x01)y=@02f6;else y=@0525;
