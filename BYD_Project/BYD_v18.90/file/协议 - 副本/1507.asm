...
读数据流: 
  ...
  $  025.EPB(电子驻车)状态                           $    $               $    $  ANS014.BYTE004  $  if(x1==0) y=@0102; else if(x1==1) y=@0165; else if(x1==2) y=@0166;else if(x1==3) y=@0457;else if(x1==4) y=@0167;else y=@0001;
  $  026.遥控驾驶状态                                $    $               $    $  ANS015.BYTE004  $  if(x1==0) y=@0078; else if(x1==1)y=@0164; else y=@0001;
  $  027.促动器1位置传感器                           $    $  mm           $    $  ANS016.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  028.促动阀3位置传感器                           $    $  mm           $    $  ANS017.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  029.促动器阀1开关状态                           $    $               $    $  ANS018.BYTE004  $  if(x1==0) y=@001e; else if(x1==1) y=@001d; else y = @0001;
  $  030.促动器阀2开关状态                           $    $               $    $  ANS019.BYTE004  $  if(x1==0) y=@001e; else if(x1==1) y=@001d; else y = @0001;
  $  031.促动器1中位置                               $    $               $    $  ANS020.BYTE004  $  y = x1*256+x2;
  $  032.促动器3中位置                               $    $               $    $  ANS021.BYTE004  $  y = x1*256+x2;
  $  033.多路阀开关状态                              $    $               $    $  ANS022.BYTE004  $  if(x1==0) y=@001e; else if(x1==1) y=@001d; else y = @0001;
  $  034.促动器2位置传感器                           $    $  mm           $    $  ANS023.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  035.促动器4位置传感器                           $    $  mm           $    $  ANS024.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  036.促动器阀3开关状态                           $    $               $    $  ANS025.BYTE004  $  if(x1==0) y=@001e; else if(x1==1) y=@001d; else y = @0001;
  $  037.促动器阀4开关状态                           $    $               $    $  ANS026.BYTE004  $  if(x1==0) y=@001e; else if(x1==1) y=@001d; else y = @0001;
  ...
  $  046.P档锁定状态                                 $    $               $    $  ANS034.BYTE004  $  if(x1==0) y=@0105; else if(x1==1)y=@0174;else if(x1==2)y=@0175;else if(x1==3)y=@0176;else if(x1==4)y=@0177;else y=@0001;
  $  047.P档系统状态                                 $    $               $    $  ANS034.BYTE005  $  if(x1==0) y=@0078; else if(x1==1)y=@0792;else y=@0003;
  $  048.加速度传感器状态                            $    $               $    $  ANS035.BYTE004  $  if(x1==0) y=@0078; else if(x1==1) y=@0027; else y = @0001;
