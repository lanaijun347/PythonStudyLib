...
读数据流: 
  ...
  $  061.整车工作模式                                $    $               $    $  ANS043.BYTE004  $  if(x1==0x00) y=@001c; else if(x1==0x01) y=@016b; else if(x1==0x02) y=@016c; else if(x1==0x03) y=@016d; else if(x1==0x04) y=@016e;else if(x1==0x05) y=@016f;else if(x1==0x06) y=@0170;else if(x1==0x07) y=@0171;else y = @0898;
  $  062.离合器强制脱开                              $    $               $    $  ANS043.BYTE005  $  if(x1&0x01) y=@011f; else y=@011e;
  $  063.离合器强制脱开命令有效标识位                $    $               $    $  ANS043.BYTE006  $  if(x1&0x01) y=@0002; else y=@0003;
  ...
  $  068.电机使能信息                                $    $               $    $  ANS046.BYTE005  $  if(x1==0) y=@0013; else if(x1==1) y=@0014; else y = @0898;
