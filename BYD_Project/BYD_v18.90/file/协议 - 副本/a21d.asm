...
版本信息:
  ...
  $%  000:硬件号:              $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%02X.%02X.%02X %d%s%d%s%d%s],x1,x2,x3,x4,@0197,x5,@0198,x6,@0199);
  $%  001:软件号:              $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%02X.%02X.%02X %d%s%d%s%d%s],x1,x2,x3,x4,@0197,x5,@0198,x6,@0199);
