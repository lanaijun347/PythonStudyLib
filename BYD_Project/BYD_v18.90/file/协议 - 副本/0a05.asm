...
读数据流: 
  ...
  $  001.发动机启动命令                     $    $               $    $  ANS001.BYTE004  $  if(x==0x00)y=@011a;else if(x==0x01)y=@001e;else y=@00d8;
  $  002.离合器强制脱开命令                 $    $               $    $  ANS002.BYTE004  $  if(x==0x00)y=@011e;else if(x==0x01)y=@0a77;else y=@00d8;
  $  003.启动允许                           $    $               $    $  ANS003.BYTE004  $  if(x==0x00)y=@0196;else if(x==0x01)y=@04a0;else y=@00d8;
  $  004.防盗解除状态                       $    $               $    $  ANS004.BYTE004  $  if(x==0x00)y=@0191;else if(x==0x01)y=@0192;else if(x==0x02)y=@049d;else y=@00d8;
  $  005.主动泄放状态                       $    $               $    $  ANS005.BYTE004  $  if(x==0x00)y=@0218;else if(x==0x01)y=@0191;else if(x==0x02)y=@0167;else if(x==0x03)y=@0215;else y=@00d8;
  $  006.盖子状态                           $    $               $    $  ANS006.BYTE004  $  if(x==0x00)y=@001d;else if(x==0x01)y=@001e;else y=@00d8;
  $  007.整车档位                           $    $               $    $  ANS007.BYTE004  $  if(x==0x00)y=@010f;else if(x==0x01)y=@0110;else if(x==0x02)y=@0112;else if(x==0x03)y=@0111;else if(x==0x04)y=@0027;else y=@00d8;
  $  008.整车工作模式                       $    $               $    $  ANS008.BYTE004  $  if(x==0x00)y=@001c;else if(x==0x01)y=@011b;else if(x==0x02)y=@04a1;else if(x==0x03)y=@011d;else y=@00d8;
  $  009.整车运行模式                       $    $               $    $  ANS009.BYTE004  $  if(x==0x00)y=@049f;else if(x==0x01)y=@045e;else y=@00d8;
  $  010.动力系统状态                       $    $               $    $  ANS010.BYTE004  $  if(x==0x00)y=@0078;else if(x==0x01)y=@0167;else y=@00d8;
  $  011.水泵状态                           $    $               $    $  ANS011.BYTE004  $  if(x==0x00)y=@001d;else if(x==0x01)y=@001e;else y=@00d8;
  $  012.巡航状态                           $    $               $    $  ANS012.BYTE004  $  if(x==0x00)y=@012a;else if(x==0x01)y=@012b;else y=@00d8;
  $  013.OK灯信息                           $    $               $    $  ANS013.BYTE004  $  if(x==0x00)y=@0029;else if(x==0x01)y=@0028;else y=@00d8;
  $  014.风扇状态                           $    $               $    $  ANS014.BYTE004  $  if(x==0x00)y=@001c;else if(x==0x01)y=@01ea;else if(x==0x02)y=@01eb;else y=@00d8;
  $  015.防盗状态                           $    $               $    $  ANS015.BYTE004  $  if(x==0x00)y=@0191;else if(x==0x01)y=@0192;else if(x==0x02)y=@049d;else y=@00d8;
  $  016.EPB(电子驻车)状态                  $    $               $    $  ANS016.BYTE004  $  if(x==0x00)y=@0191;else if(x==0x01)y=@0192;else if(x==0x02)y=@049d;else y=@00d8;
  $  017.电机旋变状态                       $    $               $    $  ANS017.BYTE004  $  if(x==0x00)y=@0078;else if(x==0x01)y=@0167;else y=@00d8;
  $  018.IPM(智能功率模块)状态              $    $               $    $  ANS018.BYTE004  $  if(x==0x00)y=@0078;else if(x==0x01)y=@0167;else y=@00d8;
  $  019.过流状态                           $    $               $    $  ANS019.BYTE004  $  if(x==0x00)y=@0078;else if(x==0x01)y=@0167;else y=@00d8;
  $  020.电机母线电压                       $    $  V            $    $  ANS020.BYTE004  $  if((x2>0x03)||((x2==0x03)&&(x1>0xE8)))y=@052b;else y=x2*256+x1;
  $  021.电机转速                           $    $  rpm          $    $  ANS021.BYTE004  $  if((x2>0x75)||((x2==0x75)&&(x1>0x30)))y=@052b;else y=x2*256+x1-15000;
  $  022.电机扭矩                           $    $  NM           $    $  ANS022.BYTE004  $  if((x2>0x27)||((x2==0x27)&&(x1>0x10)))y=@052b;else y=0.1*(x2*256+x1)-500;
  $  023.电机功率                           $    $  KM           $    $  ANS023.BYTE004  $  if((x2>0x0B)||((x2==0x0B)&&(x1>0xC1)))y=@052b;else y=0.1*(x2*256+x1)-100;
  $  024.油门深度                           $    $  %            $    $  ANS024.BYTE004  $  if(x>0x64)y=@052b;else y=x;
  $  025.刹车深度                           $    $  %            $    $  ANS025.BYTE004  $  if(x>0x64)y=@052b;else y=x;
  $  026.冷却液温度                         $    $  degree C     $    $  ANS026.BYTE004  $  if((x>0xC8))y=@052b;else y=x-40;
  $  027.IPM(智能功率模块)散热器温度        $    $  degree C     $    $  ANS027.BYTE004  $  if((x>0xC8))y=@052b;else y=x-40;
  $  028.电机温度                           $    $  degree C     $    $  ANS028.BYTE004  $  if((x>0xC8))y=@052b;else y=x-40;
  $  029.IGBT(绝缘栅双极型晶体管)温度       $    $  degree C     $    $  ANS029.BYTE004  $  if((x>0xC8))y=@052b;else y=x-40;
  $  030.电机A相电流                        $    $  A            $    $  ANS030.BYTE004  $  if((x2>0x03)||((x2==0x03)&&(x1>0xE8)))y=@052b;else y=x2*256+x1;
  $  031.电机B相电流                        $    $  A            $    $  ANS031.BYTE004  $  if((x2>0x03)||((x2==0x03)&&(x1>0xE8)))y=@052b;else y=x2*256+x1;
  $  032.电机C相电流                        $    $  A            $    $  ANS032.BYTE004  $  if((x2>0x03)||((x2==0x03)&&(x1>0xE8)))y=@052b;else y=x2*256+x1;
  $  033.电机过载系数                       $    $  %            $    $  ANS033.BYTE004  $  if(x>0x64)y=@052b;else y=x;
  $  034.电机目标扭矩                       $    $  NM           $    $  ANS034.BYTE004  $  if((x2>0x27)||((x2==0x27)&&(x1>0x10)))y=@052b;else y=0.1*(x2*256+x1)-500;
  $  035.发动机目标扭矩                     $    $  NM           $    $  ANS035.BYTE004  $  if((x2>0x27)||((x2==0x27)&&(x1>0x10)))y=@052b;else y=0.1*(x2*256+x1)-500;
