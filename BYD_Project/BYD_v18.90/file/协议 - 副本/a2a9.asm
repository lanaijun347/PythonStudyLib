...
版本信息:
  ...
  $%  000:软件号:                 $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%02X.%02X.%02X %d年%d月%d日],x1,x2,x3,x4,x5,x6);
  $%  001:硬件号:                 $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%02X.%02X.%02X %d年%d月%d日],x1,x2,x3,x4,x5,x6);
...
读数据流: 
  ...
  $  001.已匹配钥匙数             $    $       $    $  ANS001.BYTE004  $  if(x1==0x00)y=@00e5;else if(x1==0x01)y=@00e6;else if(x1==0x02)y=@00e7;else if(x1==0x03)y=@00e8;else if(x1==0x04)y=@00e9;else y=@0001;
  $  002.内部供电状况             $    $       $    $  ANS002.BYTE004  $  if(x1==0x00)y=@00cb;else if(x1==0xFF)y=@00cc;else y=@0001;
  $  003.读卡器是否失去通信       $    $       $    $  ANS002.BYTE005  $  if(x1==0x00)y=@00c9;else if(x1==0xFF)y=@00ca;else y=@0001;
