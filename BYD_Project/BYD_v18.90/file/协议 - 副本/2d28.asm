...
读数据流: 
  ...
  $  000.管柱上倾                           $    $        $    $  ANS000.BYTE004  $  if(x1&0x01) y=@0010;else y=@0012;
  $  001.管柱下倾                           $    $        $    $  ANS000.BYTE004  $  if(x1&0x02) y=@0010;else y=@0012;
  $  002.管柱伸出                           $    $        $    $  ANS000.BYTE004  $  if(x1&0x04) y=@0010;else y=@0012;
  $  003.管柱缩回                           $    $        $    $  ANS000.BYTE004  $  if(x1&0x08) y=@0010;else y=@0012;
  $  004.电动管柱系统状态                   $    $        $    $  ANS000.BYTE004  $  if(x1&0x30) y=@0087;else y=@0078;
  ...
  $  012.管住轴向电机循环次数               $    $        $    $  ANS001.BYTE013  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=30000)) y=(x1*256+x2);else y=@0001;
  $  013.管柱角度电机循环次数               $    $        $    $  ANS001.BYTE015  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=30000)) y=(x1*256+x2);else y=@0001;
  $  014.方向盘上倾开关调节次数             $    $        $    $  ANS001.BYTE017  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=30000)) y=(x1*256+x2);else y=@0001;
  $  015.方向盘下倾开关调节次数             $    $        $    $  ANS001.BYTE019  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=30000)) y=(x1*256+x2);else y=@0001;
  $  016.方向盘回缩开关调节次数             $    $        $    $  ANS001.BYTE021  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=30000)) y=(x1*256+x2);else y=@0001;
  $  017.方向盘伸出开关调节次数             $    $        $    $  ANS001.BYTE023  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=30000)) y=(x1*256+x2);else y=@0001;
