...
读数据流: 
  ...
  $  000.P档锁定状态                              $    $        $    $  ANS000.BYTE004  $  if(x1==0x00)y=@006d;else if(x1==0x01)y=@0174;else if(x1==0x02)y=@0175;else if(x1==0x03)y=@0176;else if(x1==0x04)y=@0177;else y=@00d8;
  ...
  $  003.位置霍尔信号                             $    $        $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@04ac;else if(x1==0x02)y=@04ad;else y=@00d8;
  $  004.EEPROM(电可擦除只读存储器)存储状态       $    $        $    $  ANS004.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0087;else y=@00d8;
  $  005.缺相故障                                 $    $        $    $  ANS005.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@04a5;else if(x1==0x02)y=@04a6;else if(x1==0x03)y=@04a7;else if(x1==0x04)y=@04a8;else if(x1==0x05)y=@04a9;else if(x1==0x06)y=@04aa;else if(x1==0x07)y=@04ab;else y=@00d8;
  $  006.与ABS(防抱死刹车系统)通讯故障            $    $        $    $  ANS006.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0087;else y=@00d8;
  $  007.控制状态                                 $    $        $    $  ANS007.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@04a3;else if(x1==0x02)y=@04a4;else y=@00d8;
  $  008.与MG通讯故障                             $    $        $    $  ANS008.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0087;else y=@00d8;
  $  009.驱动电压                                 $    $  V     $    $  ANS009.BYTE004  $  if(x1<0x11) y=x1;else y=@007b;
  $  010.控制器电流                               $    $  A     $    $  ANS010.BYTE004  $  if(x1<0xFB) y=x1*0.1;else y=@007b;
  $  011.霍尔脉冲个数                             $    $        $    $  ANS011.BYTE004  $  if(x1<0x5B) y=x1;else y=@007b;
  $  012.反弹霍尔个数                             $    $        $    $  ANS012.BYTE004  $  if(x1<0x5B) y=x1;else y=@007b;
