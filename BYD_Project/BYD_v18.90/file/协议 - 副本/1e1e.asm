...
读数据流: 
  ...
  $  010.遥控升降窗状态                 $    $        $    $  ANS010.BYTE004  $  if(x1==0x00)y=@001c;else if(x1==0x01)y=@0318;else if(x1==0x02)y=@0319;else y=@0001;
  $  011.右前车窗当前动作状态           $    $        $    $  ANS011.BYTE004  $  if(x1==0x00)y=@0018;else if(x1==0x01)y=@001c;else if(x1==0x02)y=@001d;else if(x1==0x03)y=@001e;else y=@0001;
  $  012.右前车窗位置                   $    $        $    $  ANS012.BYTE004  $  if(x1==0x00)y=@0018;else if(x1==0x01)y=@0314;else if(x1==0x02)y=@0315;else if(x1==0x03)y=@001b;else y=@0001;
  $  013.右前车窗位置状态               $    $        $    $  ANS013.BYTE004  $  if(x1==0x00)y=@0003;else if(x1==0x01)y=@00db;else if(x1==0x02)y=@08c6;else y=@0001;
  $  014.右前车窗自动上升开关信号       $    $        $    $  ANS014.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  015.右前车窗自动下降开关信号       $    $        $    $  ANS015.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  016.右前车窗手动上升开关信号       $    $        $    $  ANS016.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  017.右前车窗手动下降开关信号       $    $        $    $  ANS017.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  018.右前车窗玻璃位置百分比         $    $  %     $    $  ANS018.BYTE004  $  if(x1 < 101) y=x1;else if(x1 == 0xFF)y=@0024;else y=@0001;
  $  019.右前车窗防夹电机软件版本       $    $        $    $  ANS019.BYTE004  $  y=x1*0.1;
  $  020.右前车窗防夹电机硬件版本       $    $        $    $  ANS020.BYTE004  $  y=x1*0.1;
  $  021.左后车窗当前动作状态           $    $        $    $  ANS021.BYTE004  $  if(x1==0x00)y=@0018;else if(x1==0x01)y=@001c;else if(x1==0x02)y=@001d;else if(x1==0x03)y=@001e;else y=@0001;
  $  022.左后车窗位置                   $    $        $    $  ANS022.BYTE004  $  if(x1==0x00)y=@0018;else if(x1==0x01)y=@0314;else if(x1==0x02)y=@0315;else if(x1==0x03)y=@001b;else y=@0001;
  $  023.左后车窗位置状态               $    $        $    $  ANS023.BYTE004  $  if(x1==0x00)y=@0003;else if(x1==0x01)y=@00db;else if(x1==0x02)y=@08c6;else y=@0001;
  $  024.左后车窗自动上升开关信号       $    $        $    $  ANS024.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  025.左后车窗自动下降开关信号       $    $        $    $  ANS025.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  026.左后车窗手动上升开关信号       $    $        $    $  ANS026.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  027.左后车窗手动下降开关信号       $    $        $    $  ANS027.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  028.左后车窗玻璃位置百分比         $    $  %     $    $  ANS028.BYTE004  $  if(x1 < 101) y=x1;else if(x1 == 0xFF)y=@0024;else y=@0001;
  $  029.左后车窗防夹电机软件版本       $    $        $    $  ANS029.BYTE004  $  y=x1*0.1;
  $  030.左后车窗防夹电机硬件版本       $    $        $    $  ANS030.BYTE004  $  y=x1*0.1;
  $  031.右后车窗当前动作状态           $    $        $    $  ANS031.BYTE004  $  if(x1==0x00)y=@0018;else if(x1==0x01)y=@001c;else if(x1==0x02)y=@001d;else if(x1==0x03)y=@001e;else y=@0001;
  $  032.右后车窗位置                   $    $        $    $  ANS032.BYTE004  $  if(x1==0x00)y=@0018;else if(x1==0x01)y=@0314;else if(x1==0x02)y=@0315;else if(x1==0x03)y=@001b;else y=@0001;
  $  033.右后车窗位置状态               $    $        $    $  ANS033.BYTE004  $  if(x1==0x00)y=@0003;else if(x1==0x01)y=@00db;else if(x1==0x02)y=@08c6;else y=@0001;
  $  034.右后车窗自动上升开关信号       $    $        $    $  ANS034.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  035.右后车窗自动下降开关信号       $    $        $    $  ANS035.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  036.右后车窗手动上升开关信号       $    $        $    $  ANS036.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  037.右后车窗手动下降开关信号       $    $        $    $  ANS037.BYTE004  $  if(x1==0x00)y=@001d;else if(x1==0x01)y=@001e;else y=@0001;
  $  038.右后车窗玻璃位置百分比         $    $  %     $    $  ANS038.BYTE004  $  if(x1 < 101) y=x1;else if(x1 == 0xFF)y=@0024;else y=@0001;
