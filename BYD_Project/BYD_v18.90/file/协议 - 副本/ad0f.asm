...
版本信息:
  ...
  $%  002:生产日期:                $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%d年%d月%d日],x1,x2,x3);
  $%  003:驻车辅助配置类型:        $%    $%  ANS001.BYTE004  $%  if(x1==0x00)y=@02d6;else if(x1==0x01)y=@02d7;else if(x1==0x02)y=@02d8;else y=@020c;
