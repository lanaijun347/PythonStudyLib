...
读数据流: 
  ...
  $  000.放电是否允许         $    $         $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0195;0x01: y=@0196;0x02: y=@0306;default: y=@0001;
  $  001.DC系统故障状态       $    $         $    $  ANS001.BYTE004  $  switxh(x1)0x01: y=@0078;0x02: y=@0167;default: y=@03bc;
  $  002.DC工作模式           $    $         $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@01d4;0x01: y=@01d5;0x02: y=@01d6;default: y=@03bc;
