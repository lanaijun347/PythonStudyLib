...
读数据流: 
  ...
  $  033.左外后视镜当前水平位置             $    $  V     $    $  ANS001.BYTE068  $  y = (x1*256+x2)*0.01;
  $  034.左外后视镜当前垂直位置             $    $  V     $    $  ANS001.BYTE070  $  y = (x1*256+x2)*0.01;
  $  035.左外后视镜折叠电机                 $    $        $    $  ANS001.BYTE072  $  if((x1*256+x2) < 25001) y=x1*256+x2;else y=@0001;
  $  036.左外后视镜换向器水平位置电机       $    $        $    $  ANS001.BYTE074  $  if((x1*256+x2) < 20001) y=x1*256+x2;else y=@0001;
  $  037.左外后视镜换向器垂直位置电机       $    $        $    $  ANS001.BYTE076  $  if((x1*256+x2) < 20001) y=x1*256+x2;else y=@0001;
  $  038.左外后视镜照脚灯点亮时间           $    $  H     $    $  ANS001.BYTE078  $  if((x1*256+x2) < 1001) y=x1*256+x2;else y=@0001;
  $  039.左外后视镜加热时间                 $    $  H     $    $  ANS001.BYTE080  $  if((x1*256+x2) < 501) y=x1*256+x2;else y=@0001;
