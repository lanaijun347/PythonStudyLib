...
读数据流: 
  ...
  $  009.驻车制动开关状态                $    $               $    $  ANS004.BYTE004  $  if(x1==0)y=@000c;else if(x1==1)y=@0165;else if(x1==2)y=@0440;else if(x1==3)y=@0003;else y=@0001;
  $  010.目标拉力                        $    $  N            $    $  ANS005.BYTE004  $  y=x1*10;
  $  011.EPB(电子驻车)状态               $    $               $    $  ANS006.BYTE004  $  if(x1==0)y=@0888;else if(x1==1)y=@0889;else if(x1==2)y=@043e;else if(x1==3)y=@043f;else if(x1==4)y=@0167;else y=@0001;
  $  012.EPB(电子驻车)校准检测状态       $    $               $    $  ANS007.BYTE004  $  if(x1==0)y=@0886;else if(x1==1)y=@0887;else y=@0001;
  $  013.IGN(点火)状态                   $    $               $    $  ANS008.BYTE004  $  if(x1==0)y=@0438;else if(x1==1)y=@0439;else if(x1==2)y=@0884;else if(x1==3)y=@0885;else y=@0001;
  $  014.维修模式                        $    $               $    $  ANS009.BYTE004  $  if(x1==0)y=@0018;else if(x1==1)y=@044b;else if(x1==2)y=@0883;else y=@0001;
  $  015.EPB(电子驻车)电机操作有效       $    $               $    $  ANS010.BYTE004  $  if(x1==0)y=@0881;else if(x1==1)y=@0882;else y=@0001;
  $  016.动态拉起状态                    $    $               $    $  ANS011.BYTE004  $  if(x1==0)y=@0440;else if(x1==1)y=@087e;else if(x1==2)y=@087f;else if(x1==3)y=@0880;else y=@0001;
  $  017.EPB(电子驻车)操作模式           $    $               $    $  ANS012.BYTE004  $  if(x1==0)y=@0452;else if(x1==1)y=@0453;else y=@0001;
