...
读数据流: 
  ...
  $  002.接地状态                           $    $         $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@01c6;
  ...
  $  010.车内插座放电状态                   $    $         $    $  ANS010.BYTE004  $  if(x1==0x00)y=@01c7;else if(x1==0x01)y=@0265;else if(x1==0x02)y=@0266;else if(x1==0x03)y=@0267;else if(x1==0x04)y=@0268;else y=@01c6;
  ...
  $  012.充电口电锁状态                     $    $         $    $  ANS012.BYTE004  $  if(x1==0x00)y=@096e;else if(x1==0x01)y=@0a8e;else if(x1==0x02)y=@0970;else if(x1==0x03)y=@0a8f;else y=@01c6;
  $  013.车载充电功率状态                   $    $         $    $  ANS013.BYTE004  $  if(x1==0x00)y=@03ce;else if(x1==0x01)y=@01d2;else if(x1==0x02)y=@01d1;else y=@01c6;
  $  014.交流外充设备故障状态               $    $         $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@01c6;
  $  015.交流外充接地状态                   $    $         $    $  ANS015.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@01c6;
  $  016.充电抢连接状态                     $    $         $    $  ANS016.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else if(x1==0x02)y=@002a;else y=@01c6;
  $  017.限功率放电状态                     $    $         $    $  ANS017.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@03cd;else y=@01c6;
  $  018.应急充电是否允许                   $    $         $    $  ANS018.BYTE004  $  if(x1==0x00)y=@0196;else if(x1==0x01)y=@0195;else y=@01c6;
  $  019.交流互锁故障                       $    $         $    $  ANS019.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@01c6;
