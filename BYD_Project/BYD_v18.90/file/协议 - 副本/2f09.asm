...
读数据流: 
  ...
  $  004.左前轮压力值         $    $  kPa     $    $  ANS000.BYTE010  $  y=(x2*256+x1)&0xFFF;
  $  005.右前轮ID             $    $          $    $  ANS001.BYTE004  $  HEX(x1,x2,x3,x4);
  $  006.右前轮信号状态       $    $          $    $  ANS001.BYTE008  $  switxh(x1)0x00: y=@0078;0x01: y=@015c;0x02: y=@00f0;0xFF: y=@0200;default: y=@0001;
  $  007.右前轮漏气状态       $    $          $    $  ANS001.BYTE009  $  switxh(x1&0x03)0x00: y=@0078;0x01: y=@01fe;0x02: y=@01ff;0x03: y=@00f0;default: y=@0001;
  $  008.右前轮压力状态       $    $          $    $  ANS001.BYTE009  $  switxh(x1&0x1C)0x00: y=@0078;0x04: y=@01fc;0x08: y=@01fd;0x0C: y=@00f0;0x10: y=@015c;default: y=@0001;
  $  009.右前轮压力值         $    $  kPa     $    $  ANS001.BYTE010  $  y=(x2*256+x1)&0xFFF;
  $  010.左后轮ID             $    $          $    $  ANS002.BYTE004  $  HEX(x1,x2,x3,x4);
  $  011.左后轮信号状态       $    $          $    $  ANS002.BYTE008  $  switxh(x1)0x00: y=@0078;0x01: y=@015c;0x02: y=@00f0;0xFF: y=@0200;default: y=@0001;
  $  012.左后轮漏气状态       $    $          $    $  ANS002.BYTE009  $  switxh(x1&0x03)0x00: y=@0078;0x01: y=@01fe;0x02: y=@01ff;0x03: y=@00f0;default: y=@0001;
  $  013.左后轮压力状态       $    $          $    $  ANS002.BYTE009  $  switxh(x1&0x1C)0x00: y=@0078;0x04: y=@01fc;0x08: y=@01fd;0x0C: y=@00f0;0x10: y=@015c;default: y=@0001;
  $  014.左后轮压力值         $    $  kPa     $    $  ANS002.BYTE010  $  y=(x2*256+x1)&0xFFF;
  $  015.右后轮ID             $    $          $    $  ANS003.BYTE004  $  HEX(x1,x2,x3,x4);
  $  016.右后轮信号状态       $    $          $    $  ANS003.BYTE008  $  switxh(x1)0x00: y=@0078;0x01: y=@015c;0x02: y=@00f0;0xFF: y=@0200;default: y=@0001;
  $  017.右后轮漏气状态       $    $          $    $  ANS003.BYTE009  $  switxh(x1&0x03)0x00: y=@0078;0x01: y=@01fe;0x02: y=@01ff;0x03: y=@00f0;default: y=@0001;
  $  018.右后轮压力状态       $    $          $    $  ANS003.BYTE009  $  switxh(x1&0x1C)0x00: y=@0078;0x04: y=@01fc;0x08: y=@01fd;0x0C: y=@00f0;0x10: y=@015c;default: y=@0001;
  $  019.右后轮压力值         $    $  kPa     $    $  ANS003.BYTE010  $  y=(x2*256+x1)&0xFFF;
