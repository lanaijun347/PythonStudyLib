...
读数据流: 
  ...
  $  002.直流侧电流                        $    $  A       $    $  ANS002.BYTE004  $  y=SPRINTF([%.1f],x1*0.3-30);
  $  003.交流侧频率                        $    $  Hz      $    $  ANS003.BYTE004  $  y=x1;
  $  004.交流侧电流                        $    $  A       $    $  ANS004.BYTE004  $  y=SPRINTF([%d],x1*0.1);
  ...
  $  015.与BMS(电池管理系统)通讯状态       $    $          $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;0x02: y=@007b;0x03: y=@007b;default: y=@01c6;
  ...
  $  018.充放电系统故障状态                $    $          $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@083a;0x02: y=@0259;0x03: y=@007b;0x04: y=@025a;0x05: y=@025b;default: y=@01c6;
  ...
  $  022.DC工作模式                        $    $          $    $  ANS022.BYTE004  $  switxh(x1)0x00: y=@01d4;0x01: y=@01d6;0x02: y=@01d5;0x03: y=@00d8;default: y=@0001;
