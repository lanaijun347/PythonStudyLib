...
读数据流: 
  ...
  $  REQ019:710 03 22 F1 86 00 00 00 00       $  ANS019:718 03 22 F1 86 00 00 00 00
  ...
  $  018.距离上次夹紧的里程                  $    $  m         $    $  ANS018.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  019.诊断会话模式                        $    $            $    $  ANS019.BYTE004  $  switxh(x1)0x01: y=@0441;0x02: y=@0442;0x03: y=@03e0;default: y=@0001;
