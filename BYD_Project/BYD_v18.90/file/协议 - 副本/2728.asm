...
读数据流: 
  ...
  $  002.BSG(轻度混合动力)电机实际转速               $    $  rpm          $    $  ANS002.BYTE004  $  y=((x1<<8)+x2)-30000;
  $  003.BSG(轻度混合动力)输出扭矩(发电、电动)       $    $  牛顿米       $    $  ANS003.BYTE004  $  y=((x1<<8)+x2)*0.1-500;
  $  004.BSG(轻度混合动力)母线电压                   $    $  V            $    $  ANS004.BYTE004  $  y=(x1<<8)+x2;
  $  005.BSG A相电流                                 $    $  A            $    $  ANS005.BYTE004  $  y=(x1<<8)+x2;
  $  006.BSG B相电流                                 $    $  A            $    $  ANS006.BYTE004  $  y=(x1<<8)+x2;
  $  007.BSG C相电流                                 $    $  A            $    $  ANS007.BYTE004  $  y=(x1<<8)+x2;
  $  008.BSG(轻度混合动力)电机温度                   $    $  degree C     $    $  ANS008.BYTE004  $  y=x1-40;
  $  009.BSG(轻度混合动力)稳压状态                   $    $               $    $  ANS009.BYTE004  $  switxh(x1)0x00: y=@001e;0x01: y=@00d9;default: y=@0001;
  $  010.IPM(智能功率模块)温度                       $    $  degree C     $    $  ANS010.BYTE004  $  y=x1-40;
