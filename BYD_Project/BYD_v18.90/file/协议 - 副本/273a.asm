...
读数据流: 
  ...
  $  000.EV(纯电动)次数          $    $       $    $  ANS000.BYTE004  $  y=(x1<<16)+(x2<<8)+x3;
  $  001.HEV(混合动力)次数       $    $       $    $  ANS000.BYTE007  $  y=(x1<<16)+(x2<<8)+x3;
  $  002.模式旋钮次数            $    $       $    $  ANS001.BYTE004  $  y=(x1<<16)+(x2<<8)+x3;
  $  003.变道盲区次数            $    $       $    $  ANS001.BYTE007  $  y=(x1<<16)+(x2<<8)+x3;
  $  004.车道偏离次数            $    $       $    $  ANS002.BYTE004  $  y=(x1<<16)+(x2<<8)+x3;
  $  005.倒车雷达次数            $    $       $    $  ANS002.BYTE007  $  y=(x1<<16)+(x2<<8)+x3;
  $  006.预约充电次数            $    $       $    $  ANS003.BYTE004  $  y=(x1<<16)+(x2<<8)+x3;
