...
读数据流: 
  ...
  $  REQ009:7B4 03 22 00 0E 00 00 00 00       $  ANS009:7BC 03 22 00 0E 00 00 00 00
  ...
  $  002.板换出口侧冷却液温度                  $    $          $    $  ANS002.BYTE004  $  if(((x2*256+x1)*0.1) < 101) y=(x2*256+x1)*0.1;else if(((x2*25.6+x1*0.1)-6553.6) >= (0-40)) y=(x2*25.6+x1*0.1)-6553.6;else y=@0001;
  $  003.板式换热器出口冷媒压力                $    $  Mpa     $    $  ANS003.BYTE004  $  if((x1*0.001+x2*0.256) < 11) y=(x1*0.001+x2*0.256);else y=@0001;
  ...
  $  009.板式换热器出口冷媒过热度              $    $  %       $    $  ANS009.BYTE004  $  if(((x2*256+x1)*0.1) <101) y=(x2*256+x1)*0.1;else if(((x2*25.6+x1*0.1)-6553.6) > (0-101)) y=(x2*25.6+x1*0.1)-6553.6;else y=@0001;
