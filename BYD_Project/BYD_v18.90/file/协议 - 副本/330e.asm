...
读数据流: 
  ...
  $  001.转向角速度                          $    $  °/s     $    $  ANS001.BYTE004  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=32767)) y=(x1*256+x2)*4;else if(((x1*256+x2)>=32768)&&((x1*256+x2)<=65535)) y=SPRINTF([%.1f],(32768-(x1*256+x2))*4);else y=@0001;
