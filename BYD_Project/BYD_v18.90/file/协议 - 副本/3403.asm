...
版本信息:
  ...
  $%  007:学习到的VIN(车辆识别码):        $%    $%  ANS004.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
...
读数据流: 
  ...
  $  127.电子水泵状态字1-水泵紧急模式状态                   $    $           $    $  ANS000.BYTE177  $  if(x1==0) y=@03b3;else if(x1==1) y=@03b4;else if(x1==2) y=@03b1;else y=@0001;
  $  128.电子水泵状态字1-水泵过温状态                       $    $           $    $  ANS000.BYTE177  $  if(x1==0) y=@0078;else if(x1==1) y=@03b2;else if(x1==2) y=@03b1;else y=@0001;
  $  129.电子水泵状态字1-水泵过流状态                       $    $           $    $  ANS000.BYTE177  $  if(x1==0) y=@0078;else if(x1==1) y=@0345;else if(x1==2) y=@03b1;else y=@0001;
  $  130.电子水泵状态字1-水泵干转状态                       $    $           $    $  ANS000.BYTE177  $  if(x1==0) y=@0078;else if(x1==1) y=@03bb;else if(x1==2) y=@03b1;else y=@0001;
  $  131.电子水泵状态字2-水泵电压状态                       $    $           $    $  ANS000.BYTE178  $  if(x1==0) y=@0078;else if(x1==1) y=@01e8;else if(x1==2) y=@03b1;else y=@0001;
  $  132.电子水泵状态字2-水泵堵转状态                       $    $           $    $  ANS000.BYTE178  $  if(x1==0) y=@0078;else if(x1==1) y=@0347;else if(x1==2) y=@03b1;else y=@0001;
