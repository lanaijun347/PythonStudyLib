...
读数据流: 
  ...
  $  011.鼓风机正端继电器控制         $    $               $    $  ANS010.BYTE004  $  if(x1==0x00)y=@001e;else if(x1==0x01)y=@033b;else if(x1==0x02)y=@033a;else y=@0001;
  $  012.IG2(点火2)电压               $    $  V            $    $  ANS011.BYTE004  $  if((x1>89)&&(x1<160)) y=x1;else y=@0001;
  $  013.净化继电器控制               $    $               $    $  ANS012.BYTE004  $  if(x1==0x00)y=@002a;else if(x1==0x01)y=@002b;else y=@0001;
