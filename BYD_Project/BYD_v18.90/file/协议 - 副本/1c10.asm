...
读数据流: 
  ...
  $  002.放电是否允许                        $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0195;else if(x1==0x01)y=@0196;else if(x1==0x02)y=@0a0e;else if(x1==0x03)y=@0306;else y=@0001;
  $  003.DC系统故障状态                      $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0167;else y=@03bc;
