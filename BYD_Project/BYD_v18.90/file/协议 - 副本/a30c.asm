...
版本信息:
  ...
  $%  001:VIN(车辆识别码):                 $%    $%  ANS001.BYTE006  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
...
读数据流: 
  ...
  $  000.MIL(故障指示灯)状态                     $    $               $    $  ANS000.BYTE006  $  if(x1&0x80) y=@0028;else y=@0029;
  $  001.失火监测                                $    $               $    $  ANS000.BYTE007  $  if(x1&0x01) y=@0755;else y=@0606;
  $  002.燃油系统监测                            $    $               $    $  ANS000.BYTE007  $  if(x1&0x02) y=@0755;else y=@0606;
  $  003.综合部件监测                            $    $               $    $  ANS000.BYTE007  $  if(x1&0x04) y=@0755;else y=@0606;
  $  004.催化剂测试                              $    $               $    $  ANS000.BYTE008  $  if(x1&0x01) y=@0755;else y=@0606;
  $  005.催化剂加热测试                          $    $               $    $  ANS000.BYTE008  $  if(x1&0x02) y=@0755;else y=@0606;
  $  006.加强的蒸发净化系统测试                  $    $               $    $  ANS000.BYTE008  $  if(x1&0x04) y=@0755;else y=@0606;
  $  007.二次空气喷射测试                        $    $               $    $  ANS000.BYTE008  $  if(x1&0x08) y=@0755;else y=@0606;
  $  008.空调系统冷媒测试                        $    $               $    $  ANS000.BYTE008  $  if(x1&0x10) y=@0755;else y=@0606;
  $  009.氧传感器测试                            $    $               $    $  ANS000.BYTE008  $  if(x1&0x20) y=@0755;else y=@0606;
  $  010.氧传感器加热测试                        $    $               $    $  ANS000.BYTE008  $  if(x1&0x40) y=@0755;else y=@0606;
  $  011.废气再循环系统测试                      $    $               $    $  ANS000.BYTE008  $  if(x1&0x80) y=@0755;else y=@0606;
  $  012.燃油系统1状态                           $    $               $    $  ANS001.BYTE006  $  if(x1&0x01) y=@0b8c;else if(x1&0x02) y=@0189;else if(x1&0x04) y=@0b8d;else if(x1&0x08) y=@0b8e;else y=@0525;
  $  013.燃油系统2状态                           $    $               $    $  ANS001.BYTE007  $  if(x1&0x01) y=@0b8c;else if(x1&0x02) y=@0189;else if(x1&0x04) y=@0b8d;else if(x1&0x08) y=@0b8e;else y=@0525;
  ...
  $  024.氧传感器安装位置                        $    $               $    $  ANS012.BYTE006  $  if(x1&0x01) y=@0b84;else if(x1&0x02) y=@0b85;  else if(x1&0x04)  y=@0b86; else if(x1=0x08) y=@0b87;  else if(x1&0x10) y=@0b88; else if(x1&0x20) y=@0b89;  else if(x1&0x40) y=@0b8a;  else if(x1&0x80) y=@0b8b;
  ...
  $  029.OBD(车载诊断系统)系统类型               $    $               $    $  ANS015.BYTE006  $  if(x==0x01) y=@0b7a;else if(x==0x02) y=@0b7b;else if(x==0x03) y=@0b7c;else if(x==0x04) y=@0743;else if(x==0x05) y=@0b7d;else if(x==0x06) y=@0745;else if(x==0x07) y=@0b7e;else if(x==0x08) y=@0b7f;else if(x==0x09) y=@0b80;else if(x==0x0A) y=@0749;else if(x==0x0B) y=@0b81;else if(x==0x0C) y=@0b82;else if(x==0x0D) y=@0b83;else y=@00d8;
  ...
  $  047.节气门怠速                              $    $               $    $  ANS032.BYTE006  $  if(x1&0x01)y=@0185;else y=@0186;
  $  048.助力转向                                $    $               $    $  ANS032.BYTE006  $  if(x1&0x08)y=@0b75;else y=@0186;
  $  049.空调请求                                $    $               $    $  ANS032.BYTE006  $  if(x1&0x10)y=@0185;else y=@0186;
  $  050.空调离合器                              $    $               $    $  ANS032.BYTE006  $  if(x1&0x20)y=@0185;else y=@0186;
  $  051.催化剂保护模式                          $    $               $    $  ANS032.BYTE006  $  if(x1&0x40)y=@0185;else y=@0186;
  $  052.燃油泵命令开                            $    $               $    $  ANS032.BYTE006  $  if(x1&0x80)y=@0185;else y=@0186;
  $  053.MIL(故障指示灯)                         $    $               $    $  ANS033.BYTE006  $  if(x1&0x04)y=@0173;else y=@0172;
  $  054.SVS(系统维修指示灯)                     $    $               $    $  ANS033.BYTE006  $  if(x1&0x08)y=@0173;else y=@0172;
  $  055.低燃油位灯                              $    $               $    $  ANS033.BYTE006  $  if(x1&0x10)y=@0173;else y=@0172;
  $  056.VIM(可变进气歧管)阀                     $    $               $    $  ANS033.BYTE006  $  if(x1&0x20)y=@0173;else y=@0172;
  $  057.断油激活                                $    $               $    $  ANS033.BYTE006  $  if(x1&0x40)y=@0173;else y=@0172;
  $  058.闭环                                    $    $               $    $  ANS034.BYTE006  $  if(x1&0x01)y=@0185;else y=@0186;
  $  059.前氧传感器就绪                          $    $               $    $  ANS034.BYTE006  $  if(x1&0x02)y=@0185;else y=@0186;
  $  060.车辆节气制止                            $    $               $    $  ANS034.BYTE006  $  if(x1&0x04)y=@00f2;else y=@0181;
  $  061.燃油修正学习                            $    $               $    $  ANS034.BYTE006  $  if(x1&0x08)y=@0185;else y=@0186;
  $  062.动力富足                                $    $               $    $  ANS034.BYTE006  $  if(x1&0x10)y=@0185;else y=@0186;
  $  063.爆震存在                                $    $               $    $  ANS034.BYTE006  $  if(x1&0x20)y=@0185;else y=@0186;
  $  064.浓/稀 前氧传感器                        $    $               $    $  ANS034.BYTE006  $  if(x1&0x40)y=@017f;else y=@0180;
  $  065.低速风扇                                $    $               $    $  ANS035.BYTE006  $  if(x1&0x01)y=@0173;else y=@0172;
  $  066.高速风扇                                $    $               $    $  ANS035.BYTE006  $  if(x1&0x02)y=@0173;else y=@0172;
  $  067.P/N档                                   $    $               $    $  ANS035.BYTE006  $  if(x1&0x40)y=@0b77;else y=@0b78;
  $  068.ETC(电子节气门)模式                     $    $               $    $  ANS035.BYTE006  $  if(x1&0x80)y=@0167;else y=@0078;
  $  069.坏路屏蔽失火数据                        $    $               $    $  ANS036.BYTE006  $  if(x1&0x04)y=@0185;else y=@0186;
  $  070.本次钥匙循环凸轮轴信号存在错误          $    $               $    $  ANS036.BYTE006  $  if(x1&0x08)y=@0b79;else y=@0027;
  $  071.EEVAP(燃油蒸发系统)出口阀               $    $               $    $  ANS036.BYTE006  $  if(x1&0x10)y=@0185;else y=@0186;
  $  072.EGR(废气再循环)阀关闭位置错误           $    $               $    $  ANS036.BYTE006  $  if(x1&0x20)y=@0b79;else y=@0027;
  $  073.怠速使能测试                            $    $               $    $  ANS036.BYTE006  $  if(x1&0x40)y=@0b79;else y=@0027;
  $  074.EGR(废气再循环)流量测试允许             $    $               $    $  ANS036.BYTE006  $  if(x1&0x80)y=@0b79;else y=@0027;
  ...
  $  088.前氧传感器主状态                        $    $               $    $  ANS050.BYTE006  $  if(x1&0x03) y=@0b76;else if(x1&0x08) y=@0b74;else y=@001b;
  ...
  $  127.弱缸                                    $    $               $    $  ANS086.BYTE006  $  switxh(x1) 0x00: y=@0b68;0x01: y=@0b69;0x02: y=@0b6a;0x03: y=@0b6b; 0x04: y=@0b6c;0x05: y=@0b6d;0x06: y=@0b6e;0x07: y=@0b6f;0x08: y=@0b70;default: y=@001b;
  ...
  $  162.凸轮相位主要使能打包标志                $    $               $    $  ANS117.BYTE006  $  if(x1&0x01)y=@0185;else y=@0186;
  $  163.凸轮相位指示所有诊断无关使能条件        $    $               $    $  ANS117.BYTE006  $  if(x1&0x02)y=@0185;else y=@0186;
  ...
  $  168.怠速催化剂监测测试状态                  $    $               $    $  ANS122.BYTE006  $  switxh(x1) 0x01: y=@0b71;0x02: y=@0b72;0x04: y=@0b73;0x08: y=@0b74;default: y=@001b;
  ...
  $  175.巡航激活灯                              $    $               $    $  ANS129.BYTE006  $  if(x1&0x01)y=@0173;else y=@0172;
  $  176.巡航使能灯                              $    $               $    $  ANS129.BYTE006  $  if(x1&0x02)y=@0173;else y=@0172;
