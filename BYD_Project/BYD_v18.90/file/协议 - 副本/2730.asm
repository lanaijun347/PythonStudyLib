...
进入命令:
  ...
  $~  REQ001:7E1 02 10 01 00 00 00 00 00       $~  ANS001:7E9 02 10 01 00 00 00 00 00
...
读数据流: 
  ...
  $  002.MC压力值(MSB/LSB)                           $    $               $    $  ANS000.BYTE006  $  y=((x1<<8)+x2)*0.153-42.5;
  ...
  $  018.输入轴1转速                                 $    $  rpm          $    $  ANS010.BYTE004  $  y=x1*0.25;
  ...
  $  026.主压力阀实际电流                            $    $  mA           $    $  ANS014.BYTE006  $  y=x1*0.75;
  $  027.安全阀1设置电流                             $    $  mA           $    $  ANS015.BYTE004  $  y=((x1<<8)+x2)*0.78125;
  $  028.安全阀1实际电流                             $    $  mA           $    $  ANS015.BYTE004  $  y=((x1<<8)+x2)*0.78125;
  $  029.离合器阀1设置电流                           $    $  mA           $    $  ANS016.BYTE004  $  y=((x1<<8)+x2)*0.73;
  $  030.离合器1实际电流                             $    $  mA           $    $  ANS016.BYTE006  $  y=((x1<<8)+x2)*0.75;
  $  031.离合器1实际压力                             $    $               $    $  ANS017.BYTE004  $  y=(x1<<8)+x2;
  ...
  $  037.离合器阀2实际电流                           $    $  mA           $    $  ANS020.BYTE006  $  y=((x1<<8)+x2)*0.73;
  $  038.离合器2实际压力                             $    $               $    $  ANS021.BYTE004  $  y=(x1<<8)+x2;
  $  039.离合器2滑磨点                               $    $               $    $  ANS021.BYTE006  $  y=x1;
  $  040.读取遥控驾驶状态                            $    $               $    $  ANS022.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0164;default: y=@0001;
  $  041.促动阀1位置传感器                           $    $  mm           $    $  ANS023.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  $  042.促动阀3位置传感器                           $    $  mm           $    $  ANS024.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  ...
  $  045.促动器1中位位置                             $    $               $    $  ANS027.BYTE004  $  y=(x1<<8)+x2;
  $  046.促动器3中位位置                             $    $               $    $  ANS028.BYTE004  $  y=(x1<<8)+x2;
  $  047.多路阀开关状态                              $    $               $    $  ANS029.BYTE004  $  switxh((x1<<8)+x2)0x00: y=@0172;0x01: y=@0173;default: y=@0001;
  $  048.促动器2位置传感器                           $    $  mm           $    $  ANS030.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  $  049.促动器4位置传感器                           $    $  mm           $    $  ANS031.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  ...
  $  052.促动器1中位置                               $    $               $    $  ANS034.BYTE004  $  y=(x1<<8)+x2;
  ...
  $  059.传感器电压                                  $    $  V            $    $  ANS040.BYTE004  $  y=((x1<<8)+x2)*0.0024;
  ...
  $  072.档位适配次数                                $    $               $    $  ANS048.BYTE004  $  y=(x1<<8)+x2;
  $  073.离合器1适配次数                             $    $               $    $  ANS049.BYTE004  $  y=(x1<<8)+x2;
  $  074.离合器2适配次数                             $    $               $    $  ANS049.BYTE006  $  y=(x1<<8)+x2;
  ...
  $  078.促动器5位置传感器                           $    $  mm           $    $  ANS051.BYTE004  $  y=((x1<<8)+x2)*0.01-15;
  $  079.促动器5中位位置                             $    $               $    $  ANS051.BYTE006  $  y=(x1<<8)+x2;
  $  080.促动器5设置电流                             $    $  mA           $    $  ANS052.BYTE004  $  y=((x1<<8)+x2)*0.78125;
  $  081.促动器5实际电流                             $    $  mA           $    $  ANS052.BYTE006  $  y=((x1<<8)+x2)*0.78125;
  $  082.主压力阀-1设置电流                          $    $  mA           $    $  ANS053.BYTE004  $  y=((x1<<8)+x2)*0.73;
  $  083.主压力阀-1实际电流                          $    $  mA           $    $  ANS053.BYTE006  $  y=x1*0.75;
  $  084.油泵压力                                    $    $  bar          $    $  ANS054.BYTE004  $  y=(((x1<<8)+x2)*24.42-5676)*1.0/4324;
  $  085.电机运行占空比                              $    $               $    $  ANS055.BYTE004  $  y=x1;
  $  086.电机使能信息                                $    $               $    $  ANS055.BYTE005  $  y=x1;
  $  087.电机转速                                    $    $  n/min        $    $  ANS055.BYTE006  $  y=x1;
  $  088.电子油泵适配次数                            $    $               $    $  ANS056.BYTE004  $  y=(x1<<8)+x2;
