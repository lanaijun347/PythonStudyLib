...
读数据流: 
  ...
  $  002.皮带驱动压缩机继电器状态             $    $               $    $  ANS002.BYTE004  $  if((x1==0)) y=@002a;else if((x1==1)) y=@002b;else y=@0001;
  $  003.车外温度                             $    $  degree C     $    $  ANS003.BYTE004  $  if((x1>=88)&&(x1<=178))y=x1-128;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  004.车内温度                             $    $  degree C     $    $  ANS004.BYTE004  $  if((x1>=88)&&(x1<=207))y=x1-128;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  005.空调请求开启皮带驱动压缩机           $    $               $    $  ANS005.BYTE004  $  switxh(x1)0x00: y=@003f;0x01: y=@0044;default: y=@0001;
  ...
  $  009.鼓风机正端继电器控制                 $    $               $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@002a;0x01: y=@002b;default: y=@0001;
  $  010.后除霜继电器控制                     $    $               $    $  ANS009.BYTE004  $  switxh(x1)0x00: y=@002a;0x01: y=@002b;default: y=@0001;
  $  011.工作电源电压                         $    $  V            $    $  ANS010.BYTE004  $  if((x1>=90)&&(x1<=159))y=x1*1.0/10;else if((x1==160)) y=@01e9;else if((x1==208)) y=@01e8;else y=@0001;
  $  012.主驾吹面通道温度                     $    $  degree C     $    $  ANS011.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  013.主驾吹脚通道温度                     $    $  degree C     $    $  ANS012.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  014.副驾吹面通道温度                     $    $  degree C     $    $  ANS013.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  015.副驾吹脚通道温度                     $    $  degree C     $    $  ANS014.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  ...
  $  021.蒸发器温度                           $    $  degree C     $    $  ANS020.BYTE004  $  if((x1>=0)&&(x1<=60))y=x1-20;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  022.请求后除霜                           $    $               $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@003f;0x01: y=@0044;default: y=@0001;
  $  023.后风速                               $    $  级           $    $  ANS022.BYTE004  $  y=x1;
  $  024.后出风模式                           $    $               $    $  ANS023.BYTE004  $  if((x1==1)) y=@006e;else if((x1==2)) y=@0455;else if((x1==3)) y=@0070;else y=@0001;
  $  025.后车内温度                           $    $  degree C     $    $  ANS024.BYTE004  $  if((x1>=88)&&(x1<=207))y=x1-128;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  026.后吹面通道温度                       $    $  degree C     $    $  ANS025.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  027.后吹脚通道温度                       $    $  %            $    $  ANS026.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@01e4;else if((x1==216)) y=@01e3;else y=@0001;
  $  028.后冷暖电机位置百分比                 $    $  %            $    $  ANS027.BYTE004  $  y=x1;
  $  029.后模式电机位置百分比                 $    $  %            $    $  ANS028.BYTE004  $  y=x1;
  $  030.玻璃温度信号                         $    $  %            $    $  ANS029.BYTE004  $  if((x1>=0)&&(x1<=200))y=x1*1.0/2;else y=@0001;
  $  031.玻璃湿度信号                         $    $  %            $    $  ANS030.BYTE004  $  if((x1>=0)&&(x1<=254))y=x1*1.0/2-40;else y=@0001;
  $  032.右侧阳光值                           $    $  w/m^2        $    $  ANS031.BYTE004  $  if((x1>=0)&&(x1<=254))y=x1*4.01575;else y=@0001;
  $  033.左侧阳光值                           $    $  w/m^2        $    $  ANS032.BYTE004  $  if((x1>=0)&&(x1<=254))y=x1*4.01575;else y=@0001;
