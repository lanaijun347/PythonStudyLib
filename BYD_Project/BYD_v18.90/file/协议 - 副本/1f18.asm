...
读数据流: 
  ...
  $  000.车速           $    $       $    $  ANS000.BYTE027  $  y = x1*256+x2;
  $  001.是否加密       $    $       $    $  ANS001.BYTE004  $  if(x1==0x00)y = @02f5;else if(x1==0x01)y=@02f6;else y = @0a62;
  $  002.加密方式       $    $       $    $  ANS001.BYTE005  $  if(x1==0x00)y = @02f5;else if(x1==0x01)y=@03d0;else if(x1==0x02)y=@03d1;else if(x1==0x03)y=@03d2;else y = @0a62;
