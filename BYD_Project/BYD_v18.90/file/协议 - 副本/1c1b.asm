...
读数据流: 
  ...
  $  000.电池冷却系统开启状态                  $    $          $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0049;else if(x1==0x01)y=@004a;else if(x1==0x02)y=@004b;else if(x1==0x03)y=@004c;else if(x1==0x07)y=@001e;else y=@0001;
  $  001.电池冷却副水箱液位                    $    $          $    $  ANS001.BYTE004  $  if(x1==0x00)y=@03c6;else if(x1==0x01)y=@03c7;else y=@0001;
  $  002.板换出口侧冷却液温度                  $    $          $    $  ANS002.BYTE004  $  if((x2*256+x1) <41) y=(x2*256+x1);else if(((x2*256+x1)-65536) >= 0-10) y=(x2*256+x1)-65536;else y=@0001;
  $  003.板式换热器出口冷媒压力                $    $  Mpa     $    $  ANS003.BYTE004  $  if((x1*0.001+x2*0.256) <= 10) y=(x1*0.001+x2*0.256);else y=@0001;
  $  004.板式换热器出口冷媒温度                $    $          $    $  ANS004.BYTE004  $  if(((x2*256+x1)*0.1) <= 40) y=(x2*256+x1)*0.1;else if(((x2*25.6+x1*0.1)-6553.6) >= 0-10) y=(x2*25.6+x1*0.1)-6553.6;else y=@0001;
  ...
  $  008.电子膨胀阀位置                        $    $  %       $    $  ANS008.BYTE004  $  if(x1 < 101) y=x1;else y=@0001;
  ...
  $  011.皮带驱动压缩机请求信号                $    $          $    $  ANS011.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0044;else y=@0001;
