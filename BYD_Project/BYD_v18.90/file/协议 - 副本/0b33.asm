...
进入命令:
  ...
  $~  REQ001:762 02 10 01 00 00 00 00 00       $~  ANS001:76A 02 10 01 00 00 00 00 00
...
读数据流: 
  ...
  $  REQ010:762 03 22 00 11 00 00 00 00       $  ANS010:76A 03 22 00 11 00 00 00 00
  $  REQ011:762 03 22 00 12 00 00 00 00       $  ANS011:76A 03 22 00 12 00 00 00 00
  $  REQ012:762 03 22 00 13 00 00 00 00       $  ANS012:76A 03 22 00 13 00 00 00 00
  $  REQ013:762 03 22 00 14 00 00 00 00       $  ANS013:76A 03 22 00 14 00 00 00 00

  $  000.充电是否允许                        $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0196;else if(x1==0x01)y=@0195;else y=@0525;
  $  001.放电是否允许                        $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0196;else if(x1==0x01)y=@0195;else y=@0525;
  $  002.铁电池故障报警                      $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@01de;else if(x1==0x01)y=@01df;else y=@0525;
  $  003.SOC(荷电状态)过低请求充电命令       $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0078;else if(x1==0x01)y=@0a90;else y=@0525;
  $  004.充放电状态                          $    $               $    $  ANS004.BYTE004  $  if(x1==0x00)y=@01e0;else if(x1==0x01)y=@01e1;else y=@0525;
  ...
  $  010.电流                                $    $  A            $    $  ANS010.BYTE004  $  y=x1-100;
  $  011.平均温度                            $    $  degree C     $    $  ANS011.BYTE004  $  y=x1-60;
  $  012.负责柱温度                          $    $  degree C     $    $  ANS012.BYTE004  $  y=x1-60;
  $  013.继电器温度                          $    $  degree C     $    $  ANS013.BYTE004  $  y=x1-60;
