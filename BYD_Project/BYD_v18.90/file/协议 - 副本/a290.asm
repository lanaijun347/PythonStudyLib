...
读数据流: 
  ...
  $  006.复位代码         $    $         $    $  ANS001.BYTE004  $  if(x1<0x02)y=@0525;else if(x1>=0x02&&x1<0x04)y=@0b61;else if(x1>=0x04&&x1<0x08)y=@0b42;else if(x1>=0x08&&x1<0x10)y=@0b41;else if(x1>=0x10&&x1<0x40)y=@0b40;else if(x1>=0x40&&x1<0x80)y=@0b3e;else if(x1>=0x80&&x1<=0xff)y=@0b3d;
