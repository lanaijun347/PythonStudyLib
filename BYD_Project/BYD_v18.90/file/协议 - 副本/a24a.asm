...
版本信息:
  ...
  $%  004:VIN(车辆识别码):        $%    $%  ANS003.BYTE004  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
...
读数据流: 
  ...
  $  000.第一把钥匙ID       $    $       $    $  ANS000.BYTE004  $  if(x1==0x01)y=x2*16777216+x3*65536+x4*256+x5;else y=@0525;
  ...
  $  000.门把手探测器状态       $    $       $    $  ANS000.BYTE004  $  if(x1==0x01)y=@0a7d;else y=@0a7e;
