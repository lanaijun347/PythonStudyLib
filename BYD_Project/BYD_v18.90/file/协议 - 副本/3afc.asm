...
读数据流: 
  ...
  $  007.车内插座放电状态                  $    $          $    $  ANS007.BYTE004  $  switxh(x1)0x00: y=@01c7;0x01: y=@0265;0x02: y=@0266;0x03: y=@0267;0x04: y=@0268;0x05: y=@007b;0x06: y=@007b;0x07: y=@007b;default: y=@01c6;
  ...
  $  010.本次累计充电量                    $    $  KwH     $    $  ANS010.BYTE004  $  y=SPRINTF([%.3f],(x2*256+x1)/500);
  ...
  $  015.车内插座交流侧电压                $    $  V       $    $  ANS015.BYTE004  $  y=(x2*256+x1);
  $  016.与BMS(电池管理系统)通讯状态       $    $          $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0167;default: y=@01c6;
  $  017.散热风扇占空比                    $    $  %       $    $  ANS017.BYTE004  $  y=x1;
  $  018.充放电系统工作状态                $    $          $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@025c;0x01: y=@025d;0x02: y=@01da;0x03: y=@01db;0x04: y=@025e;0x05: y=@025f;0x06: y=@0260;0x07: y=@0261;0x08: y=@0262;0x09: y=@0263;0x0A: y=@041f;0x0B: y=@0420;0x0C: y=@0421;0x0D: y=@0422;default: y=@01c6;
  $  019.充放电系统故障状态                $    $          $    $  ANS019.BYTE004  $  switxh(x1)0x00: y=@0078;0x01: y=@0417;0x02: y=@0259;0x03: y=@007b;0x04: y=@025a;0x05: y=@025b;0x06: y=@0614;0x07: y=@0615;default: y=@01c6;
  $  020.充电连接装置连接状态              $    $          $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@0254;0x01: y=@0255;0x02: y=@0256;0x03: y=@0257;default: y=@01c6;
  $  021.DC放电是否允许                    $    $          $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@0195;0x01: y=@0196;0x02: y=@01d3;default: y=@01c6;
  ...
  $  026.交流侧绝缘阻值                    $    $  Ω      $    $  ANS026.BYTE004  $  if((x1>=0)&&(x1<=254)) y=x1;else if(x1==255) y=@030d;else y=@0001;
