...
读数据流: 
  ...
  $  000.当前低压电源电压值       $    $  V     $    $  ANS000.BYTE004  $  y=(x1<<8)+x2;
  $  001.变道盲区次数             $    $        $    $  ANS001.BYTE004  $  y=(x1<<16)+(x2<<8)+x3;
  $  002.道偏移次数               $    $        $    $  ANS001.BYTE007  $  y=(x1<<16)+(x2<<8)+x3;

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:716 30 01 00 00 00 00 00 00  $FC 
