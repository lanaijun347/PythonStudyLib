...
读数据流: 
  ...
  $  021.维修模式                                   $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@0018;else if(x1==0x01)y=@044b;else if(x1==0x02)y=@0883;else y=@0001;
  $  022.EPB(电子驻车)电机操作有效                  $    $               $    $  ANS016.BYTE004  $  if(x1==0x00)y=@0881;else if(x1==0x01)y=@0882;else y=@0001;
  $  023.动态拉起状态                               $    $               $    $  ANS017.BYTE004  $  if(x1==0x00)y=@0440;else if(x1==0x01)y=@087e;else if(x1==0x02)y=@087f;else if(x1==0x03)y=@0880;else y=@0001;
  $  024.EPB(电子驻车)操作模式                      $    $               $    $  ANS018.BYTE004  $  if(x1==0x00)y=@0452;else if(x1==0x01)y=@0453;else y=@0001;
  $  025.装配位置校准完成                           $    $               $    $  ANS019.BYTE004  $  if(x1&0x01)y=@030b;else y=@03dd;
  $  026.拉力校准完成                               $    $               $    $  ANS019.BYTE004  $  if(x1&0x02)y=@030b;else y=@03dd;
  $  027.Run-ln完成                                 $    $               $    $  ANS019.BYTE004  $  if(x1&0x04)y=@030b;else y=@03dd;
  $  028.EPB(电子驻车)执行器PWM(脉宽调制)控制       $    $               $    $  ANS020.BYTE004  $  y = x1*100.00/255;
