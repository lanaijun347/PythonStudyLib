...
读数据流: 
  ...
  $  000.EV(纯电动)按键次数          $    $  次     $    $  ANS000.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  001.HEV(混合动力)按键次数       $    $         $    $  ANS000.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  002.ECO(经济)按键次数           $    $  次     $    $  ANS001.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  003.SPORT(运动)按键次数         $    $         $    $  ANS001.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
