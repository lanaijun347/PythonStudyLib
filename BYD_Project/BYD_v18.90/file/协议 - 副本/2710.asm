...
读数据流: 
  ...
  $  046.记录有效性_1                   $    $       $    $  ANS002.BYTE004  $  switxh(x1)0x21: y=@0091;default: y=@0092;
  ...
  $  051.数据索引_2                     $    $       $    $  ANS002.BYTE006  $  switxh(x1)0x00: y=@0003;0x01: y=@0002;default: y=@0003;
  $  052.儿童锁解锁触发时间标识         $    $       $    $  ANS002.BYTE007  $  switxh(x1)0x00: y=@0003;0x01: y=@0002;default: y=@0001;
  $  053.触发时间_1                     $    $       $    $  ANS002.BYTE008  $  y=SPRINTF([%02d%s%02d%s%02d%s%02d%s],x1,@0198,x2,@0199,x3,@02ab,x4,@0212);
