...
读数据流: 
  ...
  $  050.发动机冷却工况-冷却风扇#1                          $    $                $    $  ANS000.BYTE023  $  if(x1&0x01)y=@001d;else y=@001e;
  $  051.发动机冷却工况-冷却风扇#2                          $    $                $    $  ANS000.BYTE023  $  if(x1&0x02)y=@001d;else y=@001e;
  ...
  $  054.发动机稳态工况-燃油泵继电器工作                    $    $                $    $  ANS000.BYTE024  $  if(x1&0x04)y=@001d;else y=@001e;
  $  055.发动机稳态工况-启动机工作                          $    $                $    $  ANS000.BYTE024  $  if(x1&0x08)y=@0185;else y=@0186;
  $  056.发动机稳态工况-达到怠速转速                        $    $                $    $  ANS000.BYTE024  $  if(x1&0x10)y=@0185;else y=@0186;
  $  057.发动机稳态工况-达到发动机工作温度(大于80°C)       $    $                $    $  ANS000.BYTE024  $  if(x1&0x40)y=@0187;else y=@0188;
  $  058.发动机稳态工况-车辆行驶(收到速度脉冲)              $    $                $    $  ANS000.BYTE024  $  if(x1&0x80)y=@0185;else y=@0186;
  $  059.发动机动态工况-节气门处于怠速位置                  $    $                $    $  ANS000.BYTE025  $  if(x1&0x01)y=@0185;else y=@0186;
  $  060.发动机动态工况-节气门处于全负荷位置                $    $                $    $  ANS000.BYTE025  $  if(x1&0x02)y=@0185;else y=@0186;
  $  061.发动机动态工况-激活减速断油                        $    $                $    $  ANS000.BYTE025  $  if(x1&0x08)y=@00f2;else y=@0181;
  $  062.发动机动态工况-激活加速加浓                        $    $                $    $  ANS000.BYTE025  $  if(x1&0x10)y=@00f2;else y=@0181;
  $  063.排放控制-λ控制激活                                $    $                $    $  ANS000.BYTE026  $  if(x1&0x01)y=@00f2;else y=@0181;
  $  064.排放控制-碳罐控制阀激活                            $    $                $    $  ANS000.BYTE026  $  if(x1&0x04)y=@00f2;else y=@0181;
  $  065.排放控制-减速断油激活                              $    $                $    $  ANS000.BYTE026  $  if(x1&0x08)y=@00f2;else y=@0181;
  $  066.排放控制-催化转换器保护加浓激活                    $    $                $    $  ANS000.BYTE026  $  if(x1&0x10)y=@00f2;else y=@0181;
  $  067.氧传感器-氧传感器1信号 浓                          $    $                $    $  ANS000.BYTE027  $  if(x1&0x01)y=@0180;else y=@017f;
  $  068.排放控制-氧传感器1信号 稀                          $    $                $    $  ANS000.BYTE027  $  if(x1&0x02)y=@0180;else y=@017f;
  ...
  $  071.发动机怠速-踏板位置确认怠速                        $    $                $    $  ANS000.BYTE028  $  if(x1&0x01)y=@0185;else y=@0186;
  $  072.发动机怠速-电气负载1                               $    $                $    $  ANS000.BYTE028  $  if(x1&0x02)y=@0185;else y=@0186;
  $  073.发动机怠速-电气负载2                               $    $                $    $  ANS000.BYTE028  $  if(x1&0x04)y=@0185;else y=@0186;
  $  074.指示灯SVS/MIL-MIL(故障指示灯)激活                  $    $                $    $  ANS000.BYTE029  $  if(x1&0x01)y=@00f2;else y=@0181;
  $  075.指示灯SVS/MIL-MIL(故障指示灯)闪烁                  $    $                $    $  ANS000.BYTE029  $  if(x1&0x02)y=@0185;else y=@0186;
  $  076.指示灯SVS/MIL-SVS(系统维修指示灯)激活              $    $                $    $  ANS000.BYTE029  $  if(x1&0x10)y=@00f2;else y=@0181;
  $  077.指示灯SVS/MIL-SVS(系统维修指示灯)闪烁              $    $                $    $  ANS000.BYTE029  $  if(x1&0x20)y=@0185;else y=@0186;
  $  078.指示灯SVS/MIL-SVS相关故障出现                      $    $                $    $  ANS000.BYTE029  $  if(x1&0x40)y=@0185;else y=@0186;
  $  079.发动机紧急工况-节气门位置或未知错误                $    $                $    $  ANS000.BYTE030  $  if(x1&0x01)y=@0185;else y=@0186;
  $  080.发动机紧急工况-ETC(电子节气门)相关动力故障         $    $                $    $  ANS000.BYTE030  $  if(x1&0x02)y=@0185;else y=@0186;
  $  081.空调系统-空调开启                                  $    $                $    $  ANS000.BYTE031  $  if(x1&0x01)y=@0185;else y=@0186;
  $  082.空调系统-空调请求激活                              $    $                $    $  ANS000.BYTE031  $  if(x1&0x02)y=@00f2;else y=@0181;
  $  083.空调系统-怠速转速因空调而增加                      $    $                $    $  ANS000.BYTE031  $  if(x1&0x20)y=@0185;else y=@0186;
  $  084.空调系统-全负荷时关闭空调压缩机                    $    $                $    $  ANS000.BYTE031  $  if(x1&0x40)y=@0185;else y=@0186;
