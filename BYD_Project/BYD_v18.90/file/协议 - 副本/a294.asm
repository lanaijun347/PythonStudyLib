...
读数据流: 
  ...
  $  002.模式                     $    $               $    $  ANS002.BYTE004  $  if(x1==0x01) y=@0456; else if(x1==0x02) y=@0070; else if(x1==0x03) y=@0455; else if(x1==0x04) y=@006e; else if(x1==0x05) y=@0072; else y=@006d;
  $  003.AC(空调控制器)状态       $    $               $    $  ANS003.BYTE004  $  if(x1==0x00) y=@0b55; else if(x1==0x01) y=@0b56; else if(x1==0x02) y=@0b57;else y=@006d;
  $  004.车外温度                 $    $  degree C     $    $  ANS004.BYTE004  $  if(x1>0xEA) y=x1-255; else if(x1<0x27)y=x1;else y=@006d;
  $  005.车内温度                 $    $  degree C     $    $  ANS005.BYTE004  $  if(x1>0xEA) y=x1-255; else if(x1<0x27)y=x1;else y=@006d;
  $  006.蒸发器温度               $    $  degree C     $    $  ANS006.BYTE004  $  if(x1>0xEA) y=x1-255; else if(x1<0x27)y=x1;else y=@006d;
