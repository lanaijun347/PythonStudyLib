...
版本信息:
  ...
  $%  004:车辆规格:        $%    $%  ANS002.BYTE004  $%  if(x1==0x01)y=@0461;else if(x1==0x02)y=@0462;else if(x1==0x03)y=@0463;else if(x1==0x04)y=@0464;else if(x1==0x05)y=@046e;else if(x1==0x06)y=@046f;else y=@001b;
...
读数据流: 
  ...
  $  000.近光灯状态                   $    $        $    $  ANS000.BYTE004  $  if(x1==0x00)y=@00d9;else if(x1==0x01)y=@001e;else y=@001b;
  $  001.初始化次数                   $    $        $    $  ANS001.BYTE004  $  y=x1;
  $  002.ECU电源电压                  $    $  V     $    $  ANS002.BYTE005  $  if(x1<0x08)y=x1*2.56+0.03;else y=@0003;
  $  003.传感器电源电压               $    $  V     $    $  ANS003.BYTE005  $  if(x1<0x02)y=x1*2.56+0.51;else y=@0003;
  $  004.传感器信号电压               $    $  V     $    $  ANS004.BYTE005  $  if(x1<0x02)y=x1*2.56+0.51;else y=@0003;
  $  005.初始化高度传感器电压值       $    $  V     $    $  ANS005.BYTE005  $  if(x1<0x02)y=x1*2.56+0.51;else y=@0003;
  $  006.高度传感器值标定结果         $    $        $    $  ANS006.BYTE004  $  if(x1==0x00)y=@0002;else if(x1==0x01)y=@0003;else y=@001b;
