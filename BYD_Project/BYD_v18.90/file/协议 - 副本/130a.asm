...
读数据流: 
  ...
  $  000.发动机允许信号                       $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0196;else if(x1==0x01)y=@0195;else y=@09b4;
  $  001.风速                                 $    $               $    $  ANS001.BYTE004  $  y=x1;
  $  002.送风模式                             $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@006d;else if(x1==0x01)y=@006e;else if(x1==0x02)y=@006f;else if(x1==0x03)y=@0070;else if(x1==0x04)y=@0071;else if(x1==0x05)y=@0072;else y=@03e4;
  $  003.皮带驱动压缩机继电器状态             $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0843;else if(x1==0x01)y=@0524;else y=@0001;
  $  004.车外温度                             $    $  degree C     $    $  ANS004.BYTE004  $  if(((x1-128) > (0-41)) && ((x1-128) <51)) y=x1-128;else if(x1==0xD0) y = @01e4;else if(x1==0xD8) y = @01e3;else y = @0001;
  $  005.车内温度                             $    $  degree C     $    $  ANS005.BYTE004  $  if(((x1-128) > (0-41)) && ((x1-128) <80)) y=x1-128;else if(x1==0xD0) y = @01e4;else if(x1==0xD8) y = @01e3;else y = @0001;
  $  006.皮带驱动空调压缩机请求               $    $               $    $  ANS006.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0044;else y=@0001;
  $  007.压力状态                             $    $               $    $  ANS007.BYTE004  $  if(x1==0x00)y=@03c3;else if(x1==0x01)y=@02df;else if(x1==0x02)y=@03c4;else if(x1==0x03)y=@03c5;else y=@0001;
  $  008.压力值                               $    $  MPa          $    $  ANS007.BYTE005  $  y=x1*3.0/255+x2*653.0/255;
  $  009.空调给出的散热风扇占空比(无极)       $    $  %            $    $  ANS008.BYTE004  $  y=x1;
  $  010.鼓风机正端继电器控制状态             $    $               $    $  ANS009.BYTE004  $  if(x1==0x00)y=@002a;else if(x1==0x01)y=@002b;else y=@0958;
  $  011.空调两级风扇档位需求                 $    $               $    $  ANS010.BYTE004  $  if(x1==0x00)y=@001e;else if(x1==0x01)y=@033b;else if(x1==0x02)y=@033a;else y=@0001;
  $  012.工作电源电压                         $    $  V            $    $  ANS011.BYTE004  $  if(((x1*0.1) >8) && (x1*0.1) <=15.9) y=x1*0.1;else y = @0001;
  $  013.主驾吹面通道温度                     $    $  degree C     $    $  ANS012.BYTE004  $  if(((x1-40) > (0-41)) && ((x1-40) <101)) y=x1-40;else y = @0001;
  $  014.主驾吹脚通道温度                     $    $  degree C     $    $  ANS013.BYTE004  $  if(((x1-40) > (0-41)) && ((x1-40) <101)) y=x1-40;else y = @0001;
  ...
  $  021.CAN请求后除霜                        $    $               $    $  ANS020.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0044;else y=@0001;
