...
版本信息:
  ...
  $%  000:ECU车型系列:        $%    $%  ANS000.BYTE004  $%  y=@09ef;
...
读数据流: 
  ...
  $  002.ECU加密信息       $    $           $    $  ANS002.BYTE004  $  if(x1==0x00)y=@02f5;else if(x1==0x01)y=@02f6;else y=@0001;
  $  003.ECU加密方式       $    $           $    $  ANS002.BYTE005  $  if(x1==0x00)y=@02f5;else if(x1==0x01)y=@03d0;else if(x1==0x02)y=@03d1;else if(x1==0x03)y=@03d2;else y=@0001;
