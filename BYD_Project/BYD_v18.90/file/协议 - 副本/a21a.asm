...
版本信息:
  ...
  $%  000:软件版本:               $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%.2d.%.2d.%.2d],x1,x2,x3);
  $%  001:软件日期:               $%    $%  ANS000.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
  $%  002:硬件版本:               $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%.2d.%.2d.%.2d],x1,x2,x3);
  ...
  $%  005:已匹配钥匙数:           $%    $%  ANS003.BYTE004  $%  y=x1;
...
读数据流: 
  ...
  $  000.内部供电状况             $    $       $    $  ANS000.BYTE004  $  if(x1==0) y=@00cb;else if(x1==0xff) y=@00cc;else y=@0525;
  $  001.读卡器是否失去通信       $    $       $    $  ANS000.BYTE005  $  if(x1==0) y=@00c9;else if(x1==0xff) y=@00ca;else y=@0525;
  $  002.读卡器内部天线故障       $    $       $    $  ANS000.BYTE006  $  if(x1==0) y=@0078;else if(x1==0xff) y=@0087;else y=@0525;
  $  003.钥匙状态                 $    $       $    $  ANS000.BYTE007  $  if(x1==0x03) y=@00ce;else if(x1==0x04) y=@00cf;else y=@00cd;
  $  004.钥匙ID                   $    $       $    $  ANS000.BYTE008  $  HEX(x1,x2,x3,x4);
  $  005.钥匙序号                 $    $       $    $  ANS000.BYTE012  $  HEX(x1);
