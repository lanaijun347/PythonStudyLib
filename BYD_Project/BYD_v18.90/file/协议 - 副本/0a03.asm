...
版本信息:
  ...
  $%  002:软件日期:        $%    $%  ANS001.BYTE004  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0197,x2,@0198,x3,@0199);
...
读数据流: 
  ...
  $  000.故障检测标志位         $    $       $    $  ANS000.BYTE004  $  if(x==0x01)y=@04b0;else if(x==0x02)y=@04b1;else if(x==0x03)y=@04b2;else if(x==0x04)y=@04b3;else if(x==0x05)y=@03ab;else if(x==0x06)y=@03ac;else y=@00d8;
  $  001.故障检测持续判断       $    $       $    $  ANS001.BYTE004  $  if(x==0x01)y=@03a3;else if(x==0x02)y=@03a4;else if(x==0x03)y=@03a5;else if(x==0x04)y=@03a6;else y=@00d8;
  $  002.自身识别档位消息       $    $       $    $  ANS002.BYTE004  $  if(x==0x00)y=@03a2;else if(x==0x01)y=@010f;else if(x==0x02)y=@0110;else if(x==0x03)y=@0111;else if(x==0x04)y=@0112;else y=@00d8;
