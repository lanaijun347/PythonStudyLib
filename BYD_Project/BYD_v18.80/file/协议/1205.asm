...
读数据流: 
  ...
  $  000.放电是否允许         $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@004e;else if(x1==0x01)y=@004d;else if(x1==0x02)y=@010e;else y=@0002;
  $  001.DC系统故障状态       $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@01ff;
