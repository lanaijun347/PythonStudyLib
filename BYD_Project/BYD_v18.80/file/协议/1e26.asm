...
版本信息:
  ...
  $%  004:维修日期:                $%    $%  ANS002.BYTE004  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
...
读数据流: 
  ...
  $  000.左侧散热片温度        $    $  degree C     $    $  ANS000.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@01d0;else if(x1 == 0xD8)y=@01d1;else y=@0002;
  $  001.PTC预置档位           $    $               $    $  ANS001.BYTE004  $  y=x1;
  $  002.PTC实际档位           $    $               $    $  ANS002.BYTE004  $  y=x1;
  $  003.右侧散热片温度        $    $               $    $  ANS003.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@01d0;else if(x1 == 0xD8)y=@01d1;else y=@0002;
  $  004.冷却液温度            $    $  degree C     $    $  ANS004.BYTE004  $  if(x1<171) y=x1;else if(x1 == 0xD0)y=@01d0;else if(x1 == 0xD8)y=@01d1;else y=@0002;
