...
读数据流: 
  ...
  $  000.放电是否允许         $    $         $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@004e;0x01: y=@004d;0x02: y=@00ff;default: y=@0002;
  $  001.DC系统故障状态       $    $         $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0108;0x01: y=@0045;0x02: y=@0046;0x03: y=@0108;default: y=@0002;
  $  002.DC工作模式           $    $         $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0100;0x01: y=@0101;0x02: y=@0102;0x03: y=@0108;default: y=@0002;
