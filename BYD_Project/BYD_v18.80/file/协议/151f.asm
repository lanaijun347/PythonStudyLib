...
版本信息:
  ...
  $%  002:DZ60日期:            $%    $%  ANS000.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
  $%  003:STK软件版本:         $%    $%  ANS001.BYTE004  $%  y=x1*0.1;
  $%  004:STK硬件版本:         $%    $%  ANS001.BYTE005  $%  y=x1*0.1;
  $%  005:STK软件日期:         $%    $%  ANS001.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
