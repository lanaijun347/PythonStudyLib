...
读数据流: 
  ...
  $  067.车辆禁止停止                              $    $               $    $  ANS040.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@06f3;else if((x1==0x01)&&(x2==0x00)) y=@06f4;else if((x1==0x02)&&(x2==0x00)) y=@06f5;else if((x1==0x03)&&(x2==0x00)) y=@06f6;else if((x1==0x04)&&(x2==0x00)) y=@06f7;else if((x1==0x05)&&(x2==0x00)) y=@06f8;else if((x1==0x06)&&(x2==0x00)) y=@06f9;else if((x1==0x07)&&(x2==0x00)) y=@06fa;else if((x1==0x08)&&(x2==0x00)) y=@06fb;else if((x1==0x09)&&(x2==0x00)) y=@06fc;else if((x1==0x0A)&&(x2==0x00)) y=@010e;else if((x1==0x0B)&&(x2==0x00)) y=@010e;else if((x1==0x0C)&&(x2==0x00)) y=@06fd;else if((x1==0x0D)&&(x2==0x00)) y=@010e;else if((x1==0x0E)&&(x2==0x00)) y=@06fe;else y=@0002;
  $  068.车辆禁止停止_1                            $    $               $    $  ANS040.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@06f3;else if((x1==0x01)&&(x2==0x00)) y=@06f4;else if((x1==0x02)&&(x2==0x00)) y=@06f5;else if((x1==0x03)&&(x2==0x00)) y=@06f6;else if((x1==0x04)&&(x2==0x00)) y=@06f7;else if((x1==0x05)&&(x2==0x00)) y=@06f8;else if((x1==0x06)&&(x2==0x00)) y=@06f9;else if((x1==0x07)&&(x2==0x00)) y=@06fa;else if((x1==0x08)&&(x2==0x00)) y=@06fb;else if((x1==0x09)&&(x2==0x00)) y=@06fc;else if((x1==0x0A)&&(x2==0x00)) y=@010e;else if((x1==0x0B)&&(x2==0x00)) y=@010e;else if((x1==0x0C)&&(x2==0x00)) y=@06fd;else if((x1==0x0D)&&(x2==0x00)) y=@010e;else if((x1==0x0E)&&(x2==0x00)) y=@06fe;else y=@0002;
  $  069.发动机禁止停止                            $    $               $    $  ANS041.BYTE004  $  if((x1==0x06)&&(x2==0x00)) y=@06f2;else y=@0002;
  $  070.发动机故障禁止停止                        $    $               $    $  ANS042.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@06e6;else if((x1==0x01)&&(x2==0x00)) y=@06e7;else if((x1==0x04)&&(x2==0x00)) y=@06e8;else if((x1==0x08)&&(x2==0x00)) y=@06e9;else y=@0002;
