...
读数据流: 
  ...
  $  004.系统工作状态                        $    $        $    $  ANS000.BYTE004  $  switxh(x1&0x60)0x20: y=@05d3;0x40: y=@05d4;0x60: y=@05d5;default: y=@0002;
  ...
  $  041.左外后视镜折叠电机                  $    $        $    $  ANS001.BYTE072  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=25000)) y=(x1*256+x2);else if((x1*256+x2)==65535) y=@0059;else y=@0002;
  $  042.左外后视镜换向器水平位置电机        $    $        $    $  ANS001.BYTE074  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=20000)) y=(x1*256+x2);else if((x1*256+x2)==65535) y=@0059;else y=@0002;
  $  043.左外后视镜换向器垂直位置电机        $    $        $    $  ANS001.BYTE076  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=20000)) y=(x1*256+x2);else if((x1*256+x2)==65535) y=@0059;else y=@0002;
  $  044.左外后视镜照脚灯点亮时间            $    $  H     $    $  ANS001.BYTE078  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=1000)) y=(x1*256+x2);else if((x1*256+x2)==4095) y=@0059;else y=@0002;
  $  045.左外后视镜加热时间                  $    $  H     $    $  ANS001.BYTE080  $  if(((x1*256+x2)>=0)&&((x1*256+x2)<=500)) y=(x1*256+x2);else if((x1*256+x2)==4095) y=@0059;else y=@0002;
...
$^BUTTON:停止 
$^REQ00:747 05 2F 20 02 03 02 00 00     $^
...
$^BUTTON:停止 
$^REQ00:747 05 2F 20 03 03 02 00 00     $^
...
$^BUTTON:停止 
$^REQ00:747 05 2F 20 04 03 02 00 00     $^
...
$^TYPE0
$^BUTTON:解锁 
$^REQ00:747 05 2F 20 07 03 00 00 00     $^

$^BUTTON:闭锁 
$^REQ00:747 05 2F 20 07 03 01 00 00     $^

$^BUTTON:停止 
$^REQ00:747 05 2F 20 07 03 02 00 00     $^
