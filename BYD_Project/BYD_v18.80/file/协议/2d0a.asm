...
读数据流: 
  ...
  $  000.工作状态                           $    $          $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0118;0x01: y=@0119;0x02: y=@011a;0x03: y=@0206;0x04: y=@010e;0x05: y=@011b;default: y=@00d6;
  $  001.故障状态                           $    $          $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@011c;0x02: y=@011d;default: y=@00d6;
  $  002.接地状态                           $    $          $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;default: y=@00d6;
  ...
  $  007.PWM波占空比                        $    $  %       $    $  ANS007.BYTE004  $  y=x1;
  $  008.12V输出电流                        $    $  A       $    $  ANS008.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  009.12V输出电压                        $    $  V       $    $  ANS009.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  010.车内插座放电状态                   $    $          $    $  ANS010.BYTE004  $  switxh(x1)0x00: y=@0207;0x01: y=@0208;0x02: y=@0209;0x03: y=@020a;0x04: y=@020b;default: y=@00d6;
  $  011.VTOL(车辆对用电设备)对电状态       $    $          $    $  ANS011.BYTE004  $  switxh(x1)0x00: y=@0207;0x01: y=@0208;0x02: y=@0209;0x03: y=@020a;0x04: y=@020b;default: y=@00d6;
  ...
  $  018.交流互锁故障                       $    $          $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;default: y=@0002;
