...
读数据流: 
  ...
  $  000.高压侧电压         $    $  V            $    $  ANS000.BYTE004  $  if((x2*256+x1)<0x03E9) y=x2*256+x1;else y=@0108;
  $  001.低压侧电压         $    $  V            $    $  ANS001.BYTE004  $  if(x1<0xC9) y=x1*0.1;else y=@010e;
  $  002.低压侧电流         $    $  A            $    $  ANS002.BYTE004  $  if(x1<0xFB) y=x1*2-250;else y=@010e;
  $  003.MOS管温度          $    $  degree C     $    $  ANS003.BYTE004  $  if(x1<0xF1) y=x1-40;else y=@010e;
  $  004.发电机状态         $    $               $    $  ANS004.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else if(x1==0x02)y=@00d1;else y=@010e;
  $  005.发动机状态         $    $               $    $  ANS005.BYTE004  $  if(x1==0x00)y=@004a;else if(x1==0x01)y=@003e;else if(x1==0x02)y=@0066;else if(x1==0x03)y=@0046;else if(x1==0x04)y=@00fc;else y=@010e;
  $  006.放电是否允许       $    $               $    $  ANS006.BYTE004  $  if(x1==0x00)y=@004e;else if((x1==0x01)||(x1==0x02))y=@004d;else if(x1==0x03)y=@02fd;else y=@010e;
  $  007.DC故障状态         $    $               $    $  ANS007.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@010e;
  $  008.DC工作模式         $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@022d;else if(x1==0x01)y=@03c9;else if(x1==0x02)y=@03ca;else y=@010e;
