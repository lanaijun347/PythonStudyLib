...
读数据流: 
  ...
  $  000.内部供电状况                   $    $       $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@00ae;0xFF: y=@00af;default: y=@0002;
  $  001.读卡器是否失去通信             $    $       $    $  ANS000.BYTE005  $  switxh(x1)0x00: y=@0364;0xFF: y=@0365;default: y=@0002;
  $  002.卡片状态                       $    $       $    $  ANS000.BYTE006  $  switxh(x1)0x02: y=@04ac;0x03: y=@04ad;0x04: y=@04ae;0x06: y=@04af;default: y=@0002;
  ...
  $  006.已匹配卡片数                   $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@00a7;0x01: y=@00a8;0x02: y=@00a9;0x03: y=@00aa;0x04: y=@00ab;default: y=@0002;
  $  007.模块与整车匹配状态             $    $       $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0487;0x01: y=@04b0;default: y=@0002;
  $  008.模块是否配卡（模块新旧）       $    $       $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0022;0x01: y=@0021;default: y=@0002;
