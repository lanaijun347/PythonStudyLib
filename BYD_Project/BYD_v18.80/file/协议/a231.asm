...
读数据流: 
  ...
  $  001.风速                 $    $               $    $  ANS001.BYTE004  $  if(x1<0x08)y=x1;else y=@002e;
  $  002.模式                 $    $               $    $  ANS002.BYTE004  $  if(x1==0x01)y=@002f;else if(x1==0x02)y=@03c1;else if(x1==0x03)y=@0031;else if(x1==0x04)y=@03c2;else if(x1==0x05)y=@0033;else y=@002e;
  $  003.AC状态               $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@06e3;else if(x1==0x01)y=@00f5;else y=@002e;
  $  004.车外温度             $    $  degree C     $    $  ANS004.BYTE004  $  if((x1>0x57)&&(x1<0xB2))y=x1-128;else y=@002e;
  $  005.车内温度             $    $  degree C     $    $  ANS005.BYTE004  $  if((x1>0x80)&&(x1<0xCF))y=x1-128;else y=@002e;
  $  006.蒸发器温度           $    $  degree C     $    $  ANS006.BYTE004  $  if(x1<0x1A)y=x1;else y=@002e;
  $  007.读AC请求状态         $    $               $    $  ANS007.BYTE004  $  if(x1==0x00)y=@0036;else if(x1==0x01) y=@0037;else y=@002e;
  $  008.压力状态             $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@0045;else y=@0046;
  $  009.压力值               $    $               $    $  ANS008.BYTE006  $  if(x1==0x00)y=@0847;else y=@0848;
  $  010.散热风扇占空比       $    $  %            $    $  ANS009.BYTE004  $  if(x1<0x65)y=x1;else y=@002e;
