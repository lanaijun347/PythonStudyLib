...
读数据流: 
  ...
  $  064.发动机冷却系统-风扇类型                     $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@0023;else if((x1&0x0F)<0x08)y=@0024;else y=@0002;
  ...
  $  072.发动机动态工况-是否D档(前进挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x20)y=@001b;else y=@001c;
  $  073.发动机动态工况-是否R档(后退挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x40)y=@001b;else y=@001c;
  $  074.发动机动态工况-是否N档(空挡)                $    $               $    $  ANS000.BYTE025  $  if(x1&0x80)y=@001b;else y=@001c;
