...
读数据流: 
  ...
  $  000.散热片温度            $    $  ℃     $    $  ANS000.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if(x1==208) y=@01d0;else if(x1==216) y=@01d1;else y=@0002;
  $  001.PTC预置档位           $    $         $    $  ANS001.BYTE004  $  y=x1;
  $  002.PTC实际档位           $    $         $    $  ANS002.BYTE004  $  y=x1;
  $  003.右侧散热片温度        $    $  ℃     $    $  ANS003.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if(x1==208) y=@01d0;else if(x1==216) y=@01d1;else y=@0002;
  $  004.冷却液温度            $    $  ℃     $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=120)) y=x1;else if(x1==208) y=@01d0;else if(x1==216) y=@01d1;else y=@0002;
  $  005.IG2低压电源电压       $    $  V      $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.1);
  ...
  $  009.PTC控制板温度         $    $  ℃     $    $  ANS009.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if(x1==208) y=@01d0;else if(x1==216) y=@01d1;else y=@0002;
