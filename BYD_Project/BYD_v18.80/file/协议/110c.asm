...
读数据流: 
  ...
  $  000.BSG启动允许状态               $    $               $    $  ANS000.BYTE004  $  if(x1 == 0x00) y=@004e;else if(x1 == 0x01) y=@004d;else y=@0002;
  $  001.BSG工作状态                   $    $               $    $  ANS001.BYTE004  $  if(x1 == 0x00) y=@0000;else if(x1 == 0x01) y=@002d;else y=@0002;
  ...
  $  005.BSG稳压状态                   $    $               $    $  ANS005.BYTE004  $  if(x1 == 0x28) y=@0000;else if(x1 == 0x29) y=@002d;else y=@0002;
  $  006.IPM温度                       $    $  degree C     $    $  ANS006.BYTE004  $  y=x1-40;
  $  007.电源电压                      $    $  V            $    $  ANS007.BYTE004  $  y=x1*0.1;
  $  008.三相继电器总状态              $    $               $    $  ANS008.BYTE004  $  if(x1 == 0x00) y=@0048;else if(x1 == 0x01) y=@0047;else y=@0002;
