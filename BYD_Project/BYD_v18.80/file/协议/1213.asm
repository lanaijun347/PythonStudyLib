...
读数据流: 
  ...
  $  004.压力状态                             $    $               $    $  ANS004.BYTE004  $  if(x1==0x00) y=@0045;else if(x1==0x01) y=@0046;else y=@0002;
  ...
  $  008.后除霜继电器控制                     $    $               $    $  ANS007.BYTE004  $  if(x1==0x00)y=@0047;else if(x1==0x01)y=@0048;else y=@0002;
  $  009.主驾PTC状态                          $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@0049;else if(x1==0x01)y=@004a;else y=@0002;
  $  010.IG2电压                              $    $  V            $    $  ANS009.BYTE004  $  if(((x1*0.1) > 10) && ((x1*0.1) <=15.9)) y=x1*0.1;else y=@0002;
  $  011.电动压缩机状态                       $    $               $    $  ANS010.BYTE004  $  if(x1==0x00)y=@0036;else if(x1==0x01)y=@0037;else y=@0002;
  $  012.整车允许开启电动压缩机状态           $    $               $    $  ANS011.BYTE004  $  if(x1==0x00)y=@002e;else if(x1==0x01)y=@004d;else if(x1==0x02)y=@004e;else y=@0002;
  $  013.主驾吹面通道温度                     $    $  degree C     $    $  ANS012.BYTE004  $  if(((x1-40) > (0-41)) && ((x1-40) <101)) y=x1-40;else if(x1==0xD0) y=@0034;else if(x1==0xD8) y=@0035;else if(x1==0xFF) y=@003f;else y=@0002;
  $  014.水泵继电器控制                       $    $               $    $  ANS013.BYTE004  $  if(x1==0x00)y=@0047;else if(x1==0x01)y=@0048;else y=@0002;
  $  015.净化继电器控制                       $    $               $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0047;else if(x1==0x01)y=@0048;else y=@0002;
  $  016.空调高压模块状态                     $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@01e1;else if(x1==0x01)y=@01e2;else if(x1==0x02)y=@01e3;else if(x1==0x03)y=@01e4;else y=@0002;
  ...
  $  022.蒸发器出口冷媒温度                   $    $  degree C     $    $  ANS021.BYTE004  $  if(((x1*0.1+x2*25.6)<81) &&((x1*0.1+x2*25.6)>=0)) y=x1*0.1+x2*25.6;else if((x1*0.1+(x2-256)*25.6)<0 &&(x1*0.1+(x2-256)*25.6)>=(0-40)) y=x1*0.1+(x2-256)*25.6;else y=@0002;
