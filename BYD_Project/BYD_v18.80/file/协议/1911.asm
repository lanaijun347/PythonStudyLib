...
读数据流: 
  ...
  $  000.电机运行状态       $    $               $    $  ANS000.BYTE004  $  if(x1 == 0x00)y=@0001;else if(x1 == 0x01)y=@0000;else y=@0002;
  ...
  $  006.控制器电压         $    $  V            $    $  ANS006.BYTE004  $  if(x1<0x33)y=x1;else y=@0002;
  ...
  $  015.OK灯信息           $    $               $    $  ANS015.BYTE004  $  if(x1 == 0x00)y=@0001;else if(x1 == 0x01)y=@0000;else y=@0002;
