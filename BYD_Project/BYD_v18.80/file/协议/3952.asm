...
读数据流: 
  ...
  $  000.DC工作状态       $    $               $    $  ANS000.BYTE004  $  if((x&0x03)==0x01)y=@0100;else if((x&0x03)==0x02)y=@0679;else y=@002e;
  $  001.DC故障状态       $    $               $    $  ANS001.BYTE004  $  if((x&0x03)==0x01)y=@0045;else if((x&0x03)==0x02)y=@0046;else y=@002e;
  $  002.DC输出电流       $    $  A            $    $  ANS002.BYTE004  $  if((x2>0x03)||((x2==0x03)&&(x1>0xE8)))y=@002e;else y=0.1*(x2*256+x1);
  $  003.DC输入电压       $    $  V            $    $  ANS003.BYTE004  $  if((x2>0x03)||((x2==0x03)&&(x1>0xE8)))y=@002e;else y=x2*256+x1;
  $  004.DC输出电压       $    $  V            $    $  ANS004.BYTE004  $  if(x>0x64)y=@002e;else y=x;
  $  005.DC温度           $    $  degree C     $    $  ANS005.BYTE004  $  if(x>0xA0)y=@002e;else y=x-40;
