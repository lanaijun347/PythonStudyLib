...
读数据流: 
  ...
  $  000.DC_1工作状态       $    $               $    $  ANS000.BYTE004  $  if(x1==0x01) y=@022d;else if(x1==0x02) y=@022e;else y=@0002;
  $  001.DC_1故障状态       $    $               $    $  ANS001.BYTE004  $  if(x1 == 0x01) y=@0045;else if(x1 == 0x02) y=@0046;else y=@0002;
  $  002.输出断路故障       $    $               $    $  ANS002.BYTE004  $  if(x1==0x00) y=@0045;else if(x1==0x01) y=@0375;else if(x1==0x02) y=@0376;else if(x1==0x03) y=@0377;else y=@0002;
