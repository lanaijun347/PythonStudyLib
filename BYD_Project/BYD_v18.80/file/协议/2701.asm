...
版本信息:
  ...
  $%  014:天窗电机软件版本信息:            $%    $%  ANS011.BYTE004  $%  y=x1*0.1;
  $%  015:天窗电机硬件版本信息:            $%    $%  ANS012.BYTE004  $%  y=x1*0.1;
  $%  016:遮阳帘电机软件版本信息:          $%    $%  ANS013.BYTE004  $%  y=x1*0.1;
  $%  017:遮阳帘电机硬件版本信息:          $%    $%  ANS014.BYTE004  $%  y=x1*0.1;
