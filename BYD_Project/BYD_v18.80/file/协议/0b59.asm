...
版本信息:
  ...
  $%  005:硬件日期1:        $%    $%  ANS002.BYTE005  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
  $%  006:硬件版本2:        $%    $%  ANS003.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1/100,(x1/10)%10,x1%10);
  $%  007:硬件日期2:        $%    $%  ANS003.BYTE005  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
