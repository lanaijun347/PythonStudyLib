...
版本信息:
  ...
  $%  003:生产日期:                $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%d%s%d%s%d%s],x1,@0038,x2,@0039,x3,@003a);
  $%  004:车型:                    $%    $%  ANS002.BYTE004  $%  switxh(x1) 0x51:y=@03f9;0x52:y=@00f8;0x53:y=@00f9;0x54:y=@00fa;0x55:y=@00fb;default: y=@0063;
  $%  005:MCU:                     $%    $%  ANS003.BYTE004  $%  switxh(x1) 0x51:y=@00f6;default: y=@0063;
...
读数据流: 
  ...
  $  000.压缩机控制状态                         $    $               $    $  ANS000.BYTE004  $  if(x1==0x00)y=@003e;else if(x1==0x01)y=@004a;else y=@007f;
  $  001.压缩机实际状态                         $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@003e;else if(x1==0x01)y=@004a;else y=@007f;
