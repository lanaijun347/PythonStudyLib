...
读数据流: 
  ...
  $  003.右侧散热片温度       $    $  degree C     $    $  ANS003.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if((x1==208)) y=@01d0;else if((x1==216)) y=@01d1;else y=@0002;
  $  004.冷却液温度           $    $  degree C     $    $  ANS004.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if((x1==208)) y=@01d0;else if((x1==216)) y=@01d1;else y=@0002;
  ...
  $  009.PTC控制板温度        $    $  degree C     $    $  ANS009.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if((x1==208)) y=@01d0;else if((x1==216)) y=@01d1;else y=@0002;
