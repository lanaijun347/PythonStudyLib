...
版本信息:
  ...
  $%  002:硬件日期:           $%    $%  ANS001.BYTE005  $%  y=SPRINTF([%dY%dM%dD],x1,x2,x3);
  ...
  $%  005:软件日期:           $%    $%  ANS003.BYTE006  $%  y=SPRINTF([%dY%dM%dD],x1,x2,x3);
...
读数据流: 
  ...
  $  062.发动机启动前条件-发动机是否禁止启动              $    $               $    $  ANS000.BYTE018  $  if(x1&0x01)y=@001b;else y=@001c;
  $  063.发动机启动前条件-发动机启动命令                  $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x07)0x02:y=@0066;0x03:y=@0066;0x04:y=@0107;0x05:y=@0107;default:y=@010e;
  $  064.发动机启动前条件-低压BMS(电池管理系统)状态       $    $               $    $  ANS000.BYTE018  $  if((x1&0x1F)<0x08)y=@0047;else if((x1&0x1F)<0x10)y=@0048;else if((x1&0x1F)<0x18) y=@0047;else y=@010e;
  $  065.发动机启动前条件-发动机启动超时次数              $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x70)0x00: y=@0045;0x10: y=@0045;0x20: y=@00cc;0x30: y=@00cc;0x40: y=@00cd;0x50: y=@00cd;default:y=@010e;
  $  066.整车信息-真空泵控制回路1#                        $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x07)0x00: y=@00ce;0x01: y=@00ce;0x02:y=@00cf;0x03:y=@00cf;0x04: y=@0045;0x05: y=@0045;default:y=@010e;
  $  067.整车信息-真空泵控制回路2#                        $    $               $    $  ANS000.BYTE020  $  if((x1&0x1F)<0x08)y=@00ce;else if((x1&0x1F)<0x10)y=@00cf;else if((x1&0x1F)<0x18)y=@0045;else y=@010e;
  $  068.整车信息-真空泵泄露状态                          $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x70)0x00: y=@00ce;0x10: y=@00ce;0x20: y=@00d0;0x30: y=@00d0;0x40: y=@00d1;0x50: y=@00d1;default:y=@0045;
  $  069.发动机冷却系统-高速风扇是否开启                  $    $               $    $  ANS000.BYTE023  $  if(x1&0x02)y=@001b;else y=@001c;
  $  070.发动机冷却系统-风扇类型                          $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@0023;else if((x1&0x0F)<0x08)y=@0024;else y=@0002;
  ...
  $  073.发动机动态工况-节气门处于怠速位置                $    $               $    $  ANS000.BYTE025  $  if(x1&0x01)y=@001b;else y=@001c;
  $  074.发动机动态工况-节气门处于部分打开位置            $    $               $    $  ANS000.BYTE025  $  if(x1&0x02)y=@001b;else y=@001c;
  $  075.发动机动态工况-节气门处于全开位置                $    $               $    $  ANS000.BYTE025  $  if(x1&0x04)y=@001b;else y=@001c;
  $  076.发动机动态工况-激活减速断油                      $    $               $    $  ANS000.BYTE025  $  if(x1&0x08)y=@000e;else y=@000f;
  $  077.发动机动态工况-激活加速加浓                      $    $               $    $  ANS000.BYTE025  $  if(x1&0x10)y=@000e;else y=@000f;
  $  078.发动机动态工况-是否D档(前进挡)                   $    $               $    $  ANS000.BYTE025  $  if(x1&0x20)y=@001b;else y=@001c;
  $  079.发动机动态工况-是否R档(后退挡)                   $    $               $    $  ANS000.BYTE025  $  if(x1&0x40)y=@001b;else y=@001c;
  $  080.发动机动态工况-是否N档(空挡)                     $    $               $    $  ANS000.BYTE025  $  if(x1&0x80)y=@001b;else y=@001c;
  $  081.氧传感器-氧传感器1信号                           $    $               $    $  ANS000.BYTE027  $  if(x1&0x01)y=@001d;else y=@001e;
  $  082.氧传感器-氧传感器2信号                           $    $               $    $  ANS000.BYTE027  $  if(x1&0x02)y=@001d;else y=@001e;
  $  083.氧传感器-氧传感器1加热                           $    $               $    $  ANS000.BYTE027  $  if(x1&0x10)y=@00be;else y=@00bf;
  $  084.氧传感器-氧传感器2加热                           $    $               $    $  ANS000.BYTE027  $  if(x1&0x20)y=@00be;else y=@00bf;
  $  085.发动机怠速-制动器踏板状态                        $    $               $    $  ANS000.BYTE028  $  if(x1&0x02)y=@0003;else y=@00c0;
  $  086.指示灯SVS/MIL-MIL(故障指示灯)激活                $    $               $    $  ANS000.BYTE029  $  if(x1&0x01)y=@000e;else y=@000f;
  $  087.指示灯SVS/MIL-MIL(故障指示灯)闪烁                $    $               $    $  ANS000.BYTE029  $  if(x1&0x02)y=@001b;else y=@001c;
  $  088.指示灯SVS/MIL-SVS(系统维修指示灯)激活            $    $               $    $  ANS000.BYTE029  $  if(x1&0x10)y=@000e;else y=@000f;
  $  089.指示灯SVS/MIL-SVS(系统维修指示灯)闪烁            $    $               $    $  ANS000.BYTE029  $  if(x1&0x20)y=@001b;else y=@001c;
  $  090.AT/扭矩请求-AT转换离合器激活                     $    $               $    $  ANS000.BYTE032  $  if(x1&0x08)y=@000e;else y=@000f;
  $  091.发动机状态-刹车开关激活                          $    $               $    $  ANS000.BYTE034  $  if(x1&0x01)y=@000e;else y=@000f;
  $  092.发动机状态-刹车灯激活                            $    $               $    $  ANS000.BYTE034  $  if(x1&0x02)y=@000e;else y=@000f;
  $  093.发动机状态-涡轮增压旁通阀                        $    $               $    $  ANS000.BYTE034  $  if(x1&0x10)y=@0001;else y=@0000;
  $  094.发动机状态-防盗锁定状态                          $    $               $    $  ANS000.BYTE034  $  if(x1&0x20)y=@0067;else y=@00bd;
  $  095.真空泵工作时间                                   $    $  H            $    $  ANS001.BYTE004  $  y=(x1*256+x2);
  $  096.机油液位                                         $    $               $    $  ANS000.BYTE153  $  if(x1==0x00)y=@029e;else if(x1==0x01)y=@029f;else if(x1==0x02)y=@02a0;else if(x1==0x03)y=@02a1;else if(x1==0x04)y=@02a2;else if(x1==0x05)y=@02a3;else if(x1==0x06)y=@02a4;else if(x1==0x07)y=@02a5;else if(x1==0x08)y=@02a6;else if(x1==0x09)y=@02a7;else if(x1==0x0A)y=@02a8;else if(x1==0x0B)y=@02a9;else if(x1==0x0C)y=@02aa;else if(x1==0x0D)y=@00c7;else y=@0002;
