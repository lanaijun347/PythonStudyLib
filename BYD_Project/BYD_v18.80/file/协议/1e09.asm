...
读数据流: 
  ...
  $  002.接地状态                           $    $          $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@00d6;
  ...
  $  010.车内插座放电状态                   $    $          $    $  ANS010.BYTE004  $  if(x1==0x00)y=@0207;else if(x1==0x01)y=@0208;else if(x1==0x02)y=@0209;else if(x1==0x03)y=@020a;else if(x1==0x04)y=@020b;else if(x1==0x05)y=@010e;else if(x1==0x06)y=@010e;else if(x1==0x07)y=@010e;else y=@00d6;
  $  011.VTOL(车辆对用电设备)放电状态       $    $          $    $  ANS011.BYTE004  $  if(x1==0x00)y=@0207;else if(x1==0x01)y=@0208;else if(x1==0x02)y=@0209;else if(x1==0x03)y=@020a;else if(x1==0x04)y=@020b;else if(x1==0x05)y=@010e;else if(x1==0x06)y=@010e;else if(x1==0x07)y=@010e;else y=@00d6;
  $  012.车载充电功率状态                   $    $          $    $  ANS012.BYTE004  $  if(x1==0x00)y=@020c;else if(x1==0x01)y=@020d;else if(x1==0x02)y=@020e;else if(x1==0x03)y=@010e;else y=@00d6;
  $  013.交流外充设备故障状态               $    $          $    $  ANS013.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@00d6;
  $  014.交流外充接地状态                   $    $          $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else if(x1==0x02)y=@010e;else if(x1==0x03)y=@010e;else y=@00d6;
  ...
  $  018.交流互锁故障                       $    $          $    $  ANS018.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@00d6;
