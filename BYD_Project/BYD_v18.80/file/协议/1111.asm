...
读数据流: 
  ...
  $  000.后驱动电机状态                     $    $               $    $  ANS000.BYTE004  $  if((x1 == 0x00)&&(x2 == 0x00)) y=@00dd;else if((x1 == 0x01)&&(x2 == 0x00)) y=@026e;else if((x1 == 0x02)&&(x2 == 0x00)) y=@026f;else y=@0002;
  ...
  $  014.后电机动力系统故障_1               $    $               $    $  ANS014.BYTE004  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  015.后电机动力系统故障_2               $    $               $    $  ANS014.BYTE007  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  016.后电机动力系统故障_3               $    $               $    $  ANS014.BYTE010  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  017.后电机动力系统故障_4               $    $               $    $  ANS014.BYTE013  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  018.后电机动力系统故障_5               $    $               $    $  ANS014.BYTE016  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  019.后电机动力系统故障_6               $    $               $    $  ANS014.BYTE019  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  020.后电机动力系统故障_7               $    $               $    $  ANS014.BYTE022  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  021.后电机动力系统故障_8               $    $               $    $  ANS014.BYTE025  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  022.后电机动力系统故障_9               $    $               $    $  ANS014.BYTE028  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
  $  023.后电机动力系统故障_10              $    $               $    $  ANS014.BYTE031  $  if(x1 == 0x00) y=@00dd;else if(x1 == 0x01) y=@026e;else if(x1 == 0x02) y=@026f;else y=@0002;
