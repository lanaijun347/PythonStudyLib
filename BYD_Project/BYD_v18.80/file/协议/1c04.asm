...
读数据流: 
  ...
  $  001.EV次数                   $    $        $    $  ANS001.BYTE004  $  y=(x1*256*256+x2*256+x3);
  $  002.HEV次数                  $    $        $    $  ANS001.BYTE007  $  y=(x1*256*256+x2*256+x3);
  $  003.ECO次数                  $    $        $    $  ANS002.BYTE004  $  y=(x1*256*256+x2*256+x3);
  $  004.Sport次数                $    $        $    $  ANS002.BYTE007  $  y=(x1*256*256+x2*256+x3);
