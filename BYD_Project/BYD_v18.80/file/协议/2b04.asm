...
读数据流: 
  ...
  $  014.与BMS(电池管理器)通讯状态         $    $          $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;default: y=@00d6;
  $  015.散热风扇占空比                    $    $  %       $    $  ANS015.BYTE004  $  y=x1;
  $  016.充放电系统工作状态                $    $          $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@020f;0x01: y=@04e0;0x02: y=@0119;0x03: y=@011a;0x04: y=@0211;0x05: y=@0212;0x06: y=@0213;0x07: y=@0214;0x08: y=@0215;0x09: y=@0216;0x0A: y=@04e1;default: y=@00d6;
  $  017.充放电系统故障状态                $    $          $    $  ANS017.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@04dc;0x02: y=@04dd;0x03: y=@010e;0x04: y=@04de;0x05: y=@04df;0x06: y=@04fc;default: y=@00d6;
  $  018.充电连接装置连接状态              $    $          $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@021a;0x01: y=@04e2;0x02: y=@04e3;0x03: y=@021c;default: y=@00d6;
  $  019.放电是否允许 DC放电是否允许       $    $          $    $  ANS019.BYTE004  $  switxh(x1)0x00: y=@004e;0x01: y=@004d;0x02: y=@00ff;default: y=@00d6;
  $  020.DC系统故障状态                    $    $          $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@0108;0x01: y=@0045;0x02: y=@0046;0x03: y=@0108;default: y=@00d6;
  $  021.DC工作模式                        $    $          $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@0100;0x01: y=@0101;0x02: y=@0102;0x03: y=@0108;default: y=@0002;
