...
版本信息:
  ...
  $%  004:Boot版本号:          $%    $%  ANS002.BYTE004  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
  $%  005:Boot版本信息:        $%    $%  ANS002.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
  $%  006:发布日期:            $%    $%  ANS002.BYTE010  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
