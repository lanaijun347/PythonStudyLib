...
读数据流: 
  ...
  $  018.加注状态                $    $           $    $  ANS003.BYTE004  $  if(x1==0xAA)y=@0015;else if(x1==0xEE)y=@0016;else if(x1==0x00)y=@0014;else y=@0013;
  $  019.下线检测状态            $    $           $    $  ANS004.BYTE004  $  if(x1==0xAA)y=@0011;else if(x1==0xEE)y=@0012;else if(x1==0x00)y=@0010;else y=@0013;
