...
读数据流: 
  ...
  $  002.前雾灯（或全天候灯）开关       $    $       $    $  ANS000.BYTE004  $  if(x1&0x04) y=@014f;else y=@014d;
  ...
  $  011.前刮水器INT开关                $    $       $    $  ANS001.BYTE004  $  switxh(x1&0x70)0x00: y=@04cb;0x10: y=@04cc;0x20: y=@04cd;0x30: y=@04ce;0x40: y=@0162;default: y=@0002;
