...
读数据流: 
  ...
  $  007.左前车窗玻璃位置百分比         $    $  %     $    $  ANS007.BYTE004  $  if(x1 <= 100) y=x1;else if(x1 == 0xFF) y=@0044;else y=@0002;
  $  008.右前车窗当前动作状态           $    $        $    $  ANS008.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@003e;else if(x1==0x02)y=@0001;else if(x1==0x03)y=@0000;else y=@0002;
  $  009.右前车窗位置                   $    $        $    $  ANS009.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@01cb;else if(x1==0x02)y=@01cc;else if(x1==0x03)y=@0005;else y=@0002;
  $  010.右前车窗位置状态               $    $        $    $  ANS010.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0040;else if(x1==0x02)y=@0041;else y=@0002;
  $  011.右前车窗自动上升开关信号       $    $        $    $  ANS011.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  012.右前车窗自动下降开关信号       $    $        $    $  ANS012.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  013.右前车窗手动上升开关信号       $    $        $    $  ANS013.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  014.右前车窗手动下降开关信号       $    $        $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  015.右前车窗玻璃位置百分比         $    $  %     $    $  ANS015.BYTE004  $  if(x1 <= 100) y=x1;else if(x1 == 0xFF) y=@0044;else y=@0002;
  $  016.左后车窗当前动作状态           $    $        $    $  ANS016.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@003e;else if(x1==0x02)y=@0001;else if(x1==0x03)y=@0000;else y=@0002;
  $  017.左后车窗位置                   $    $        $    $  ANS017.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@01cb;else if(x1==0x02)y=@01cc;else if(x1==0x03)y=@0005;else y=@0002;
  $  018.左后车窗位置状态               $    $        $    $  ANS018.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0040;else if(x1==0x02)y=@0041;else y=@0002;
  $  019.左后车窗自动上升开关信号       $    $        $    $  ANS019.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  020.左后车窗自动下降开关信号       $    $        $    $  ANS020.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  021.左后车窗手动上升开关信号       $    $        $    $  ANS021.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  022.左后车窗手动下降开关信号       $    $        $    $  ANS022.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  023.左后车窗玻璃位置百分比         $    $  %     $    $  ANS023.BYTE004  $  if(x1 <= 100) y=x1;else if(x1 == 0xFF) y=@0044;else y=@0002;
  $  024.右后车窗当前动作状态           $    $        $    $  ANS024.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@003e;else if(x1==0x02)y=@0001;else if(x1==0x03)y=@0000;else y=@0002;
  $  025.右后车窗位置                   $    $        $    $  ANS025.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@01cb;else if(x1==0x02)y=@01cc;else if(x1==0x03)y=@0005;else y=@0002;
  $  026.右后车窗位置状态               $    $        $    $  ANS026.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0040;else if(x1==0x02)y=@0041;else y=@0002;
  $  027.右后车窗自动上升开关信号       $    $        $    $  ANS027.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  028.右后车窗自动下降开关信号       $    $        $    $  ANS028.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  029.右后车窗手动上升开关信号       $    $        $    $  ANS029.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  030.右后车窗手动下降开关信号       $    $        $    $  ANS030.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  031.右后车窗玻璃位置百分比         $    $  %     $    $  ANS031.BYTE004  $  if(x1 <= 100) y=x1;else if(x1 == 0xFF) y=@0044;else y=@0002;
  $  032.天窗当前动作状态               $    $        $    $  ANS032.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@003e;else if(x1==0x02)y=@01cd;else if(x1==0x03)y=@01a6;else y=@0002;
  $  033.天窗位置状态                   $    $        $    $  ANS033.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0040;else if(x1==0x02)y=@0041;else y=@0002;
  $  034.天窗电机热保护状态             $    $        $    $  ANS034.BYTE004  $  if(x1==0x00)y=@0057;else if(x1==0x01)y=@0058;else y=@0002;
  $  035.天窗上倾开关信号               $    $        $    $  ANS035.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  036.天窗打开开关信号               $    $        $    $  ANS036.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  037.天窗关闭开关信号               $    $        $    $  ANS037.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  038.天窗玻璃位置百分比             $    $  %     $    $  ANS038.BYTE004  $  if(x1 <= 100) y=x1;else if(x1 == 0xFF) y=@0044;else y=@0002;
  $  039.遮阳帘当前动作状态             $    $        $    $  ANS039.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@003e;else if(x1==0x02)y=@0001;else if(x1==0x03)y=@0000;else y=@0002;
  $  040.遮阳帘位置状态                 $    $        $    $  ANS040.BYTE004  $  if(x1==0x00)y=@003f;else if(x1==0x01)y=@0040;else if(x1==0x02)y=@0041;else y=@0002;
  $  041.遮阳帘电机热保护状态           $    $        $    $  ANS041.BYTE004  $  if(x1==0x00)y=@0057;else if(x1==0x01)y=@0058;else y=@0002;
  $  042.遮阳帘打开开关信号             $    $        $    $  ANS042.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  043.遮阳帘关闭开关信号             $    $        $    $  ANS043.BYTE004  $  if(x1==0x00)y=@0001;else if(x1==0x01)y=@0000;else y=@0002;
  $  044.遮阳帘玻璃位置百分比           $    $  %     $    $  ANS044.BYTE004  $  if(x1 <= 100) y=x1;else if(x1 == 0xFF) y=@0044;else y=@0002;
