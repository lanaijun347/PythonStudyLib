...
读数据流: 
  ...
  $  024.速度限制监视器                  $    $            $    $  ANS005.BYTE004  $  switxh(x1)0x00: y=@0357;0x01: y=@0358;default: y=@0002;
  $  025.EPB(电子驻车系统)变量配置       $    $            $    $  ANS006.BYTE004  $  switxh(x1)0xDD: y=@00cb;0xBB: y=@06e5;default: y=@0002;
