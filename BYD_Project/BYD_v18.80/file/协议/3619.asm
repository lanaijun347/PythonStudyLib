...
读数据流: 
  ...
  $  000.ECU供电电压              $    $       $    $  ANS000.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  001.车速                     $    $       $    $  ANS001.BYTE004  $  y=SPRINTF([%d],(x1*256+x2));
  $  002.偏航率                   $    $       $    $  ANS002.BYTE004  $  y=SPRINTF([%.2f],(x1*256+x2)*0.02);
  $  003.副雷达ECU供电电压        $    $       $    $  ANS003.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  004.副雷达内部温度           $    $       $    $  ANS004.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  005.主雷达内部温度           $    $       $    $  ANS005.BYTE004  $  y=SPRINTF([%d],x1*0.1);
  $  006.主雷达自动标定角度       $    $       $    $  ANS006.BYTE004  $  if(x1<0x80) y=SPRINTF([%.2f],(x1*256+x2)*0.01);else y=SPRINTF([%.2f],((x1-256)*256+x2)*0.01);
  $  007.副雷达自动标定角度       $    $       $    $  ANS007.BYTE004  $  if(x1<0x80) y=SPRINTF([%.2f],(x1*256+x2)*0.01);else y=SPRINTF([%.2f],((x1-256)*256+x2)*0.01);
  $  008.系统状态                 $    $       $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@007a;0x02: y=@007a;0x04: y=@007a;0x06: y=@007a;0x01: y=@0503;0x03: y=@0503;0x05: y=@0503;0x07: y=@0503;0x08: y=@0504;0x0A: y=@0504;0x0C: y=@0504;0x0E: y=@0504;0x09: y=@0505;0x0B: y=@0505;0x0D: y=@0505;0x0F: y=@0505;default: y=@0002;
