...
读数据流: 
  ...
  $  000.电源电压                            $    $  V            $    $  ANS000.BYTE004  $  if(x1<=0xFA) y=x1*0.125;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  001.冷凝风扇实际工作的占空比            $    $  %            $    $  ANS001.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  002.冷却风扇实际工作的占空比            $    $  %            $    $  ANS002.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  003.冷凝/冷却风扇预置工作的占空比       $    $  %            $    $  ANS003.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  004.模块温度                            $    $  degree C     $    $  ANS004.BYTE004  $  if(x1<=0xD2) y=x1-40;else if(x1 == 0xFF) y=@027c;else y=@0002;
