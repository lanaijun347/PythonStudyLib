...
版本信息:
  ...
  $%  010:倒车雷达使能标记:                   $%    $%  ANS003.BYTE008  $%  if(x==0x00)y=@03b0;else if(x==0x01)y=@005b;else y=@0108;
  $%  011:全景产品序列号:                     $%    $%  ANS004.BYTE004  $%  y=SPRINTF([%d%d%d],x1,x2,x3);
  $%  012:生产日期:                           $%    $%  ANS004.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
