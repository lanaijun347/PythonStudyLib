...
读数据流: 
  ...
  $  011.IPM/IGBT(绝缘栅双极型晶体管)状态       $    $          $    $  ANS009.BYTE004  $  if(x1&0x10) y=@02f0;else y=@0045;
  ...
  $  014.启动状态                               $    $          $    $  ANS009.BYTE005  $  if(x1&0x01) y=@02f6;else y=@0045;
  $  015.内部温度状态                           $    $          $    $  ANS009.BYTE005  $  switxh(x1&0x07)0x00: y=@0045; 0x01: y=@0045;0x02: y=@02f4; 0x03: y=@02f4;0x04:y=@02f5;0x05:y=@02f5;0x06: y=@010e;0x07: y=@010e;default:y=@007f;
  $  016.转速状态                               $    $          $    $  ANS009.BYTE005  $  if(x1&0x08) y=@00b4;else y=@0045;
  $  017.压缩机负载状态                         $    $          $    $  ANS009.BYTE005  $  if((x1&0x30)==0x10) y=@02e6;else if((x1&0x30)==0x20) y=@02e7;else if((x1&0x30)==0x30) y=@010e;else y=@0045;
  $  018.母线电压状态                           $    $          $    $  ANS009.BYTE005  $  if((x1&0xC0)==0x00) y=@0045;else if((x1&0xC0)==0x40) y=@02ea;else if((x1&0xC0)==0x80) y=@02eb;else if((x1&0xC0)==0xC0) y=@010e;
  $  019.内部低压电状态                         $    $          $    $  ANS009.BYTE006  $  if((x1&0x03)==0x00) y=@0045;else if((x1&0x03)==0x01) y=@02e8;else if((x1&0x03)==0x02) y=@02e9;else if((x1&0x03)==0x03) y=@010e;
  $  020.相电压状态                             $    $          $    $  ANS009.BYTE006  $  if(x1&0x04) y=@02ec;else y=@0045;
