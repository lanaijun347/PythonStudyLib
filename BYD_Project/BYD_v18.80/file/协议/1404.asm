...
读数据流: 
  ...
  $  024.速度限制监视器              $    $                $    $  ANS005.BYTE004  $  if(x1==0xBB)y=@00ca;else if(x1==0xDD)y=@00cb;else y=@0002;
  $  025.EPB(电子驻车)变量配置       $    $                $    $  ANS006.BYTE004  $  if(x1==0xBB)y=@00ca;else if(x1==0xDD)y=@00cb;else y=@0002;
