...
读取故障码:
  ...
  $#IN  REQ001:710 02 10 01 00 00 00 00 00       $#IN  ANS001:718 02 10 01 00 00 00 00 00
  $#IN  REQ002:710 02 10 03 00 00 00 00 00       $#IN  ANS002:718 02 10 03 00 00 00 00 00
...
读数据流: 
  ...
  $  011.左侧驻车状态                                $    $                $    $  ANS011.BYTE004  $  if(x1 == 0x00) y=@0005;else if(x1 == 0x01) y=@0006;else if(x1 == 0x02) y=@0007;else if(x1 == 0x03) y=@0008;else if(x1 == 0x04) y=@0009;else if(x1 == 0x05) y=@000a;else if(x1 == 0x06) y=@000b;else y=@0002;
  $  012.右侧驻车状态                                $    $                $    $  ANS012.BYTE004  $  if(x1 == 0x00) y=@0005;else if(x1 == 0x01) y=@0006;else if(x1 == 0x02) y=@0007;else if(x1 == 0x03) y=@0008;else if(x1 == 0x04) y=@0009;else if(x1 == 0x05) y=@000a;else if(x1 == 0x06) y=@000b;else y=@0002;
  $  013.EPB(电子驻车)开关状态                       $    $                $    $  ANS013.BYTE004  $  if(x1 == 0x00) y=@000c;else if(x1 == 0x01) y=@000d;else y=@0002;
  $  014.车速                                        $    $  km/h          $    $  ANS014.BYTE004  $  y=(x1*256+x2)*0.1;
  $  015.点火开关状态                                $    $                $    $  ANS015.BYTE004  $  if(x1 == 0x00) y=@0000;else if(x1 == 0x01) y=@0001;else y=@0002;
...
30帧:
  ...
  $FC REQ001:710 30 00 05 00 00 00 00 00  $FC 
