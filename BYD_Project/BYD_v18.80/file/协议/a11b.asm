...
读数据流: 
  ...
  $  002.送风模式             $    $               $    $  ANS002.BYTE004  $  if(x1==0x01) y=@002f;else if(x1==0x02) y=@0030; else if(x1==0x03) y=@0031; else if(x1==0x04) y=@0032; else if(x1==0x05) y=@0033;else y=@002e;
  $  003.AC状态               $    $               $    $  ANS003.BYTE004  $  if(x1==0x00) y=@00f4;else if(x1==0x01) y=@00f5; else y=@002e;
  $  004.车外温度             $    $  degree C     $    $  ANS004.BYTE004  $  if((x1<0xB3) && (x1>0x57)) y=x1-128;else if(x1==0xD0) y=@02e1;else y=@002e;
  $  005.车内温度             $    $  degree C     $    $  ANS005.BYTE004  $  if((x1<0xCF) && (x1>0x80)) y=x1-128;else if(x1==0xD0) y=@02e1;else y=@002e;
  $  006.蒸发器温度           $    $  degree C     $    $  ANS006.BYTE004  $  if(x1<0x1A) y=x1;else if(x1==0xD0) y=@0034;else y=@002e;
