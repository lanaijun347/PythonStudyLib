...
读数据流: 
  ...
  $  000.发动机允许信号                 $    $               $    $  ANS000.BYTE004  $  if(x1==0x00) y=@004d; else if(x1==0x01) y=@004e; else y=@018d;
  $  001.风速                           $    $               $    $  ANS001.BYTE004  $  y=x1;
  $  002.送风模式                       $    $               $    $  ANS002.BYTE004  $  if(x1==0x00) y=@002e;else if(x1==0x01) y=@002f; else if(x1==0x02) y=@0030; else if(x1==0x03) y=@0031; else if(x1==0x04) y=@0032; else if(x1==0x05) y=@0033; else y=@0156;
  $  003.燃油压缩机状态                 $    $               $    $  ANS003.BYTE004  $  if(x1==0x00) y=@00f4; else if(x1==0x01) y=@00f5; else y=@018e;
  $  004.蒸发器温度                     $    $  degree C     $    $  ANS004.BYTE004  $  if(x1<0x1A) y=x1;else if(x1==0xD0)y=@0034; else if(x1==0xD8)y=@0035; else y=@0002;
  $  005.AC请求状态                     $    $               $    $  ANS005.BYTE004  $  if(x1==0x00) y=@0037; else if(x1==0x01) y=@0036; else y=@018f;
  $  006.压力状态                       $    $               $    $  ANS006.BYTE004  $  if(x1==0x00) y=@0045; else if(x1==0x01) y=@011d; else y=@019f;
  $  007.压力值                         $    $  Mpa          $    $  ANS006.BYTE005  $  y=(x1*3+x2*653)/255;
  $  008.鼓风机正端继电器控制状态       $    $               $    $  ANS007.BYTE004  $  if(x1==0x00) y=@0047; else if(x1==0x01) y=@0048; else y=@015b;
  $  009.后除霜继电器控制状态           $    $               $    $  ANS008.BYTE004  $  if(x1==0x00) y=@0047; else if(x1==0x01) y=@0048; else y=@015b;
