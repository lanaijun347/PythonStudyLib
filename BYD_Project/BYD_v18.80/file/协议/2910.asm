...
版本信息:
  ...
  $%  006:引导版本信息:        $%    $%  ANS003.BYTE004  $%  y=SPRINTF([%02d%s%02d%s],x1,@0038,x2,@0521);
  ...
  $%  009:网络类型信息:        $%    $%  ANS006.BYTE001  $%  y=@0065;
  $%  010:重复编程次数:        $%    $%  ANS007.BYTE004  $%  y=SPRINTF([%s%d %s%d],@081a,x1*256+x2,@081b,x2);
