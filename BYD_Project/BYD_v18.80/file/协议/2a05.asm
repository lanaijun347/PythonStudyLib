...
读数据流: 
  ...
  $  004.空调两档风扇档位需求                        $    $               $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@0000;0x01: y=@004b;0x02: y=@004c;default: y=@0002;
  $  005.蒸发器温度                                  $    $  degree C     $    $  ANS005.BYTE004  $  if((x1>=0)&&(x1<=60))y=x1-20;else if((x1==208)) y=@0034;else if((x1==216)) y=@0035;else y=@0002;
  ...
  $  009.后除霜继电器控制                            $    $               $    $  ANS008.BYTE004  $  switxh(x1)0x00: y=@0047;0x01: y=@0048;default: y=@0002;
  $  010.工作电源电压                                $    $  V            $    $  ANS009.BYTE004  $  if((x1>=90)&&(x1<=159))y=x1*1.0/10;else if((x1==160))y=@0002;else if((x1==208))y=@0002;else y=@0002;
  $  011.电动压缩机状态                              $    $               $    $  ANS010.BYTE004  $  switxh(x1)0x00: y=@0036;0x01: y=@0037;default: y=@0002;
  $  012.电机压缩机占空比                            $    $  %            $    $  ANS010.BYTE005  $  y=x1;
  $  013.BMS(电池管理系统)允许空调开启高压模块       $    $               $    $  ANS011.BYTE004  $  switxh(x1)0x00: y=@002e;0x01: y=@004d;0x02: y=@004e;default: y=@0002;
  $  014.主驾吹面通道温度                            $    $  degree C     $    $  ANS012.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@0034;else if((x1==216)) y=@0035;else if((x1==255)) y=@003f;else y=@04e8;
  $  015.主驾吹脚通道温度                            $    $  degree C     $    $  ANS013.BYTE004  $  if((x1>=0)&&(x1<=140))y=x1-40;else if((x1==208)) y=@0034;else if((x1==216)) y=@0035;else if((x1==255)) y=@003f;else y=@04e8;
  $  016.空调采暖电动水泵继电器控制                  $    $               $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@0047;0x01: y=@0048;default: y=@0002;
  $  017.PTC水加热器占空比                           $    $  %            $    $  ANS015.BYTE004  $  y=x1;
  $  018.空调高压模块状态                            $    $               $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@01e1;0x01: y=@01e2;0x02: y=@04b1;0x03: y=@01e4;default: y=@0002;
  ...
  $  024.蒸发器出口冷媒温度                          $    $  degree C     $    $  ANS022.BYTE004  $  if((((x2<<8)+x1)>=0)&&(((x2<<8)+x1)<=800))y=(((x2<<8)+x1))*1.0/10;else if((((x2<<8)+x1)>=65136)&&(((x2<<8)+x1)<=65535))y=((((x2<<8)+x1))-65536)*1.0/10;else if((((x2<<8)+x1)==32764)) y=@0034;else if((((x2<<8)+x1)==32765)) y=@0035;else y=@0002;
  ...
  $  027.电池热管理需求                              $    $               $    $  ANS025.BYTE004  $  if((x1==0)) y=@0283;else if((x1==1)) y=@0490;else if((x1==2)) y=@0491;else if((x1==3)) y=@049a;else if((x1==4)) y=@049b;else if((x1==5)) y=@049c;else if((x1==6)) y=@0492;else if((x1==7)) y=@01e0;else y=@0002;
  $  028.电池冷却系统开启状态                        $    $               $    $  ANS026.BYTE004  $  if((x1==0)) y=@0000;else if((x1==1)) y=@01de;else if((x1==2)) y=@01df;else if((x1==3)) y=@01e0;else y=@0002;
  $  029.板换端电子膨胀阀位置                        $    $  %            $    $  ANS027.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if((x1==255)) y=@0797;else y=@0002;
  $  030.板换出口侧冷却液温度信息                    $    $  degree C     $    $  ANS028.BYTE004  $  if((x1>=0)&&(x1<=90))y=x1-20;else if((x1==208)) y=@0034;else if((x1==216)) y=@0035;else y=@0002;
  $  031.热管理水泵启停命令                          $    $               $    $  ANS029.BYTE004  $  if((x1==0)) y=@0049;else if((x1==1)) y=@004a;else y=@0002;
  $  032.空调发送的电池热管理电动水泵占空比          $    $  %            $    $  ANS030.BYTE004  $  y=x1;
  $  033.电池热管理电动水泵反馈转速                  $    $  rpm          $    $  ANS031.BYTE004  $  y=x1*100;
  $  034.热管理水泵启停命令_1                        $    $               $    $  ANS032.BYTE004  $  if((x1==0)) y=@0049;else if((x1==1)) y=@004a;else y=@0002;
