...
读取故障码:
  ...
  $#  REQ000:722 04 18 00 00 00 00 00 00       $#  ANS000:72A 04 18 00 00 00 00 00 00
...
清除故障码:
  ...
  $$  REQ000:722 03 14 00 00 00 00 00 00       $$  ANS000:72A 03 14 00 00 00 00 00 00
...
版本信息:
  ...
  $%  REQ001:722 03 22 00 03 00 00 00 00       $%  ANS001:72A 03 22 00 03 00 00 00 00
