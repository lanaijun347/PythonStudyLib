...
读数据流: 
  ...
  $  001.风速                   $    $               $    $  ANS001.BYTE004  $  if(x1<0x08) y=@004d; else y=@002e;
  ...
  $  005.车内温度               $    $  degree C     $    $  ANS005.BYTE004  $  if((x1>0x7F) && (x1<0xB3)) y=x1-128; else y=@002e;
  $  006.蒸发器温度             $    $  degree C     $    $  ANS006.BYTE004  $  if(x1>0x19) y=x1; else y=@002e;
  $  007.读AC请求状态           $    $               $    $  ANS007.BYTE004  $  if(x1==0x00) y=@0036; else if(x1==0x01) y=@0037; else y=@002e;
  $  008.鼓风机继电器控制       $    $               $    $  ANS008.BYTE004  $  if(x1==0x00) y=@0047; else y=@0048;
