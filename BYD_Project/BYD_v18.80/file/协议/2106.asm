...
版本信息:
  ...
  $%  003:软件日期:           $%    $%  ANS002.BYTE006  $%  y=SPRINTF([20%d%s%d%s%d%s],x1,@0038,x2,@0039,x3,@003a);
...
读数据流: 
  ...
  $  065.发动机启动命令                              $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x06)0x00: y=@003f;0x02: y=@0066;0x04: y=@0107;0x06: y=@003f;default: y=@0002;
  $  066.低压启动电池状态                            $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x18)0x00: y=@0047;0x08: y=@0048;0x10: y=@0047;0x18: y=@003f;default: y=@0002;
  $  067.发动机启动超时次数                          $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x60)0x00: y=@0045;0x20: y=@00cc;0x40: y=@00cd;0x60: y=@003f;default: y=@0002;
  $  068.真空泵控制回路#1                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x06)0x00: y=@00ce;0x02: y=@00cf;0x04: y=@0045;0x06: y=@003f;default: y=@0002;
  $  069.真空泵控制回路#2                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x18)0x00: y=@00ce;0x08: y=@00cf;0x10: y=@0045;0x18: y=@003f;default: y=@0002;
  $  070.真空泵泄露状态                              $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x60)0x00: y=@00ce;0x20: y=@00d0;0x40: y=@00d1;0x60: y=@0045;default: y=@0002;
  $  071.低速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x01) y=@001b;else y=@001c;
  $  072.高速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x02) y=@001b;else y=@001c;
  $  073.风扇类型                                    $    $               $    $  ANS000.BYTE023  $  switxh(x1&0x0C)0x00: y=@0023;0x04: y=@0024;default: y=@010e;
