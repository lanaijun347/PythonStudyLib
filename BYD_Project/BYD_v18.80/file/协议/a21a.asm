...
读数据流: 
  ...
  $  000.内部供电状况             $    $       $    $  ANS000.BYTE004  $  if(x1==0) y=@00ae;else if(x1==0xff) y=@00af;else y=@007f;
  $  001.读卡器是否失去通信       $    $       $    $  ANS000.BYTE005  $  if(x1==0) y=@0364;else if(x1==0xff) y=@0365;else y=@007f;
  $  002.读卡器内部天线故障       $    $       $    $  ANS000.BYTE006  $  if(x1==0) y=@0045;else if(x1==0xff) y=@00b4;else y=@007f;
