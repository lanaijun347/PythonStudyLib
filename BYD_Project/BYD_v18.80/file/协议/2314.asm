...
读数据流: 
  ...
  $  009.过载告警                               $    $               $    $  ANS009.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@0046;default: y=@0002;
  $  010.堵转告警                               $    $               $    $  ANS010.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@0046;default: y=@0002;
  $  011.油门错误                               $    $               $    $  ANS011.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@0046;default: y=@0002;
  $  012.碰撞告警                               $    $               $    $  ANS012.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@0046;default: y=@0002;
  $  013.严重告警标志                           $    $               $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@0046;default: y=@0002;
  $  014.一般告警标志                           $    $               $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@0046;default: y=@0002;
  $  015.自检状态                               $    $               $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@037c;0x01: y=@037d;default: y=@0002;
  $  016.缺相保护                               $    $               $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@0046;default: y=@0002;
  $  017.与ACM通讯状态                          $    $               $    $  ANS017.BYTE004  $  switxh(x1)0x00: y=@00ac;0x01: y=@022b;default: y=@0002;
  $  018.与ESP(电子车身稳定系统)通讯状态        $    $               $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@00ac;0x01: y=@022b;default: y=@0002;
  $  019.与ABS(防抱死刹车系统)通讯状态          $    $               $    $  ANS019.BYTE004  $  switxh(x1)0x00: y=@00ac;0x01: y=@022b;default: y=@0002;
  $  020.与电池管理器通讯状态                   $    $               $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@00ac;0x01: y=@022b;default: y=@0002;
  $  021.与P档控制器通讯状态                    $    $               $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@00ac;0x01: y=@022b;default: y=@0002;
  $  022.与主控通讯状态                         $    $               $    $  ANS022.BYTE004  $  switxh(x1)0x00: y=@00ac;0x01: y=@022b;default: y=@0002;
  $  023.主接触器状态                           $    $               $    $  ANS023.BYTE004  $  switxh(x1)0x00: y=@010e;0x01: y=@0045;0x02: y=@022c;default: y=@0002;
  ...
  $  034.充放电系统工作状态                     $    $               $    $  ANS034.BYTE004  $  switxh(x1)0x00: y=@020f;0x01: y=@0210;0x02: y=@0119;0x03: y=@011a;0x04: y=@0211;0x05: y=@0212;0x06: y=@0213;0x07: y=@0214;0x08: y=@0215;0x09: y=@0216;0x0A: y=@0217;default: y=@0002;
  $  035.充电连接装置连接状态                   $    $               $    $  ANS035.BYTE004  $  switxh(x1)0x00: y=@021a;0x01: y=@021b;0x02: y=@021c;default: y=@0002;
  $  036.交流充电继电器动作请求命令             $    $               $    $  ANS036.BYTE004  $  switxh(x1)0x00: y=@0207;0x01: y=@0219;default: y=@0002;
  $  037.SCI通讯状态                            $    $               $    $  ANS037.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@0046;default: y=@0002;
  $  038.充放电系统故障状态                     $    $               $    $  ANS038.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@021d;0x02: y=@021e;0x03: y=@021f;0x04: y=@0220;0x05: y=@0221;0x06: y=@0222;0x07: y=@0223;0x08: y=@0224;default: y=@0002;
  ...
  $  049.充放电状态                             $    $               $    $  ANS049.BYTE004  $  switxh(x1)0x00: y=@0240;0x01: y=@0241;0x02: y=@0242;0x03: y=@0243;0x04: y=@0244;0x05: y=@0245;default: y=@0002;
  $  050.当前电制频率                           $    $  赫兹         $    $  ANS050.BYTE004  $  switxh(x1)0x00: y=@023e;0x01: y=@023f;default: y=@0002;
  $  051.当前电制三相电压                       $    $  V            $    $  ANS051.BYTE004  $  switxh(x1)0x00: y=@024b;0x01: y=@0247;0x02: y=@024c;0x03: y=@024d;0x04: y=@024e;0x05: y=@024f;default: y=@0002;
  $  052.当前电制单相电压                       $    $  V            $    $  ANS052.BYTE004  $  switxh(x1)0x00: y=@0246;0x01: y=@0247;0x02: y=@0248;0x03: y=@0249;0x04: y=@024a;default: y=@0002;
