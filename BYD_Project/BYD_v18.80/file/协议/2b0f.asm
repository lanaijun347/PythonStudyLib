...
读数据流: 
  ...
  $  021.泵电机继电器状态                $    $            $    $  ANS002.BYTE006  $  if(x1&0x40) y=@014d;else y=@014f;
  $  022.加注状态                        $    $            $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0014;0xAA: y=@0801;0xEE: y=@0802;default: y=@0013;
  $  023.下线检测状态                    $    $            $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@0010;0xAA: y=@0803;0xEE: y=@0804;default: y=@0013;
