...
读数据流: 
  ...
  $  011.电流采样电路状态                       $    $               $    $  ANS011.BYTE004  $  switxh(x1&0x03)0x00: y=@0045;0x01: y=@02ed;0x02: y=@02ee;0x03: y=@02ef;default: y=@0002;
  $  012.三相电流状态                           $    $               $    $  ANS011.BYTE004  $  switxh(x1&0x0C)0x00: y=@0045;0x04: y=@02ed;0x08: y=@02ee;0x0C: y=@02ef;default: y=@0002;
  $  013.IPM/IGBT(绝缘栅双极型晶体管)状态       $    $               $    $  ANS011.BYTE004  $  if(x1&0x10) y=@00b4;else y=@0045;
  $  014.内部温度传感器状态                     $    $               $    $  ANS011.BYTE004  $  if(x1&0x20) y=@00b4;else y=@0045;
  $  015.内部电流状态                           $    $               $    $  ANS011.BYTE004  $  switxh(x1&0xC0)0x00: y=@0045;0x40: y=@02f1;0x80: y=@02f2;0xC0: y=@02f3;default: y=@0002;
  $  016.启动状态                               $    $               $    $  ANS011.BYTE005  $  if(x1&0x01) y=@02f6;else y=@0045;
  $  017.内部温度状态                           $    $               $    $  ANS011.BYTE005  $  switxh(x1&0x06)0x00: y=@0045;0x02: y=@02f4;0x04: y=@02f5;default: y=@0002;
  $  018.转速状态                               $    $               $    $  ANS011.BYTE005  $  if(x1&0x08) y=@00b4;else y=@0045;
  $  019.压缩机负载状态                         $    $               $    $  ANS011.BYTE005  $  switxh(x1&0x30)0x00: y=@0045;0x10: y=@02e6;0x20: y=@0530;default: y=@0002;
  $  020.母线电压状态                           $    $               $    $  ANS011.BYTE005  $  switxh(x1&0xC0)0x00: y=@0045;0x40: y=@02ea;0x80: y=@02eb;default: y=@0002;
  $  021.内部低压电状态                         $    $               $    $  ANS011.BYTE006  $  switxh(x1&0x03)0x00: y=@0045;0x01: y=@02e8;0x02: y=@02e9;default: y=@0002;
