...
版本信息:
  ...
  $%  000:硬件版本:        $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%.1f],x1*0.1);
  $%  001:软件版本:        $%    $%  ANS000.BYTE005  $%  y=SPRINTF([%.1f],x1*0.1);
  $%  002:生产日期:        $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%d.%d.%d],2000+x1,x2,x3);

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:725 30 01 01 00 00 00 00 00  $FC 
