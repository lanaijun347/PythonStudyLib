...
读数据流: 
  ...
  $  022.维修模式                                   $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@0133;else if(x1==0x02)y=@0134;else y=@0002;
  $  023.EPB(电子驻车)电机操作有效                  $    $               $    $  ANS016.BYTE004  $  if(x1==0x00)y=@013c;else if(x1==0x01)y=@013d;else y=@0002;
  $  024.动态拉起状态                               $    $               $    $  ANS017.BYTE004  $  if(x1==0x00)y=@012c;else if(x1==0x01)y=@0139;else if(x1==0x02)y=@013a;else if(x1==0x03)y=@013b;else y=@0002;
  $  025.EPB(电子驻车)操作模式                      $    $               $    $  ANS018.BYTE004  $  if(x1==0x00)y=@0140;else if(x1==0x01)y=@0141;else y=@0002;
  $  026.装配位置校准完成                           $    $               $    $  ANS019.BYTE004  $  if(x1&0x01)y=@013e;else y=@013f;
  $  027.拉力校准完成                               $    $               $    $  ANS019.BYTE004  $  if(x1&0x02)y=@013e;else y=@013f;
  $  028.Run-ln完成                                 $    $               $    $  ANS019.BYTE004  $  if(x1&0x04)y=@013e;else y=@013f;
