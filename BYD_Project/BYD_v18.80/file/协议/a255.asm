...
读数据流: 
  ...
  $  000.车速采集功能       $    $       $    $  ANS000.BYTE004  $  if(x1==0x00) y=@0147; else if(x1==0x01) y=@0146; else y=@0005;
  $  001.IG1电平            $    $       $    $  ANS001.BYTE004  $  if(x1==0x00) y=@01ca; else if(x1==0x02) y=@01c9; else y=@0005;
