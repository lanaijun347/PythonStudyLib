...
读数据流: 
  ...
  $  REQ006:7C2 03 22 00 16 00 00 00 00       $  ANS006:7CA 03 22 00 16 00 00 00 00
  $  REQ007:7C2 03 22 F1 A1 00 00 00 00       $  ANS007:7CA 03 22 F1 A1 00 00 00 00

  $  000.供电电压           $    $  V         $    $  ANS000.BYTE004  $  y=SPRINTF([%d],x1*0.1);
  $  001.车速               $    $  Km/h      $    $  ANS001.BYTE004  $  y=(x1*256+x2);
  $  002.偏向角             $    $  Deg/s     $    $  ANS002.BYTE004  $  y=SPRINTF([%d],x1*0.02);
  $  003.电压               $    $  V         $    $  ANS003.BYTE004  $  y=SPRINTF([%d],x1*0.1);
  $  004.温度               $    $  ℃        $    $  ANS004.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  005.温度               $    $  ℃        $    $  ANS005.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  006.系统状态           $    $            $    $  ANS006.BYTE004  $  switxh(x1)0x00: y=@0000;0x01: y=@000e;0x02: y=@057a;0x03: y=@02b1;default: y=@0002;
  $  007.读取配置成功       $    $            $    $  ANS007.BYTE004  $  HEX(x1,x2,x3,x4,x5,x6,x7,x8);

;******************************************************************************************************************************************************

30帧:

  $FC REQ000:7C2 30 01 00 00 00 00 00 00  $FC 
