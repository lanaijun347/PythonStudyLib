...
读数据流: 
  ...
  $  010.车内插座放电状态                   $    $         $    $  ANS010.BYTE004  $  if(x1==0x00)y=@0207;else if(x1==0x01)y=@0208;else if(x1==0x02)y=@0209;else if(x1==0x03)y=@020a;else if(x1==0x04)y=@020b;else y=@00d6;
  ...
  $  012.充电口电锁状态                     $    $         $    $  ANS012.BYTE004  $  if(x1==0x00)y=@03eb;else if(x1==0x01)y=@03ec;else if(x1==0x02)y=@03ed;else if(x1==0x03)y=@03ee;else y=@00d6;
  $  013.车载充电功率状态                   $    $         $    $  ANS013.BYTE004  $  if(x1==0x00)y=@020c;else if(x1==0x01)y=@020d;else if(x1==0x02)y=@020e;else y=@00d6;
  $  014.交流外充设备故障状态               $    $         $    $  ANS014.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@00d6;
  $  015.交流外充接地状态                   $    $         $    $  ANS015.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@00d6;
  $  016.充电抢连接状态                     $    $         $    $  ANS016.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else if(x1==0x02)y=@0047;else y=@00d6;
  $  017.限功率放电状态                     $    $         $    $  ANS017.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0200;else y=@00d6;
  $  018.应急充电是否允许                   $    $         $    $  ANS018.BYTE004  $  if(x1==0x00)y=@004d;else if(x1==0x01)y=@004e;else y=@00d6;
  $  019.交流互锁故障                       $    $         $    $  ANS019.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@00d6;
