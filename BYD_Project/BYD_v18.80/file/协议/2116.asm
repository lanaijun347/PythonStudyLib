...
读数据流: 
  ...
  $  030.发动机冷却系统-低速风扇是否开启          $    $               $    $  ANS000.BYTE023  $  if(x1&0x01) y=@001b;else y=@001c;
  $  031.发动机冷却系统-高速风扇是否开启          $    $               $    $  ANS000.BYTE023  $  if(x1&0x02) y=@001b;else y=@001c;
  $  032.发动机稳态工况-点火电源开启              $    $               $    $  ANS000.BYTE024  $  if(x1&0x01) y=@001b;else y=@001c;
  $  033.发动机稳态工况-主继电器工作              $    $               $    $  ANS000.BYTE024  $  if(x1&0x02) y=@001b;else y=@001c;
  $  034.发动机稳态工况-燃油泵状态                $    $               $    $  ANS000.BYTE024  $  if(x1&0x04) y=@0001;else y=@0000;
  $  035.发动机动态工况-激活减速断油              $    $               $    $  ANS000.BYTE025  $  if(x1&0x08) y=@000e;else y=@000f;
  $  036.发动机动态工况-激活加速加浓              $    $               $    $  ANS000.BYTE025  $  if(x1&0x10) y=@000e;else y=@000f;
  $  037.氧传感器-氧传感器1信号                   $    $               $    $  ANS000.BYTE027  $  if(x1&0x01) y=@001d;else y=@001e;
  $  038.氧传感器-氧传感器2信号                   $    $               $    $  ANS000.BYTE027  $  if(x1&0x02) y=@001d;else y=@001e;
  $  039.氧传感器-氧传感器1加热                   $    $               $    $  ANS000.BYTE027  $  if(x1&0x10) y=@00be;else y=@00bf;
  $  040.氧传感器-氧传感器2加热                   $    $               $    $  ANS000.BYTE027  $  if(x1&0x20) y=@00be;else y=@00bf;
  $  041.发动机怠速-是否有空调请求                $    $               $    $  ANS000.BYTE028  $  if(x1&0x04) y=@001b;else y=@001c;
  $  042.指示灯SVS/MIL-MIL(故障指示灯)激活        $    $               $    $  ANS000.BYTE029  $  if(x1&0x01) y=@000e;else y=@000f;
  $  043.空调系统-空调请求激活                    $    $               $    $  ANS000.BYTE031  $  if(x1&0x02) y=@000e;else y=@000f;
  $  044.空调系统-空调压缩机开                    $    $               $    $  ANS000.BYTE031  $  if(x1&0x04) y=@001b;else y=@001c;
  $  045.空调系统-全负荷时关闭空调压缩机          $    $               $    $  ANS000.BYTE031  $  if(x1&0x40) y=@001b;else y=@001c;
  $  046.发动机状态-防盗锁定状态                  $    $               $    $  ANS000.BYTE034  $  if(x1&0x20) y=@0001;else y=@0000;
  $  047.发动机状态-燃油反馈状态                  $    $               $    $  ANS000.BYTE034  $  if(x1&0x40) y=@00bb;else y=@00bc;
