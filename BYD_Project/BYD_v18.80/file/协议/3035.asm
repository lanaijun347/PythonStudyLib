...
读数据流: 
  ...
  $  005.ECO按键次数                $    $         $    $  ANS002.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  006.SPORT按键次数              $    $  次     $    $  ANS003.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  007.雪地模式按键次数           $    $         $    $  ANS003.BYTE008  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
  $  008.ESP开关按键次数            $    $  次     $    $  ANS004.BYTE004  $  y=(x1*256*256*256+x2*256*256+x3*256+x4);
