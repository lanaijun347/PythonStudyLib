...
读数据流: 
  ...
  $  001.制动踏板状态状态                      $    $             $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@07a9;0x01: y=@07aa;default: y=@0002;
  ...
  $  006.READY指示灯状态                       $    $             $    $  ANS006.BYTE004  $  switxh(x1)0x00: y=@0229;0x01: y=@022a;default: y=@0002;
  ...
  $  019.动力电机母线电压                      $    $  V          $    $  ANS019.BYTE004  $  y=SPRINTF([%d],x1*2);
  $  020.动力电机转速                          $    $  rpm        $    $  ANS020.BYTE004  $  y=SPRINTF([%d],11000-(x2*256+x1));
  $  021.电机扭矩                              $    $  Nm         $    $  ANS021.BYTE004  $  y=SPRINTF([%d],((x2*256+x1)-5000)/10);
  $  022.电机功率                              $    $  Kw         $    $  ANS022.BYTE004  $  y=SPRINTF([%.1f],((x2*256+x1)-2000)/10);
  $  023.动力电机温度                          $    $  ℃         $    $  ANS023.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  024.IGBT最高温度                          $    $  ℃         $    $  ANS024.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  025.电感最高温度                          $    $  ℃         $    $  ANS025.BYTE004  $  y=SPRINTF([%d],x1-40);
  ...
  $  031.充电母线电压                          $    $  V          $    $  ANS031.BYTE004  $  y=(x2*256+x1);
  $  032.充电直流侧电流                        $    $  A          $    $  ANS032.BYTE004  $  y=x1;
  $  033.控制器充电功率比                      $    $  kW         $    $  ANS033.BYTE004  $  y=SPRINTF([%.1f],(x2*256+x1)*0.1);
  $  034.电网交流频率                          $    $  Hz         $    $  ANS034.BYTE004  $  y=SPRINTF([%.1f],(x2*256+x1)*0.1);
  $  035.交流A相电压                           $    $  V          $    $  ANS035.BYTE004  $  y=SPRINTF([%d],x1*2);
  $  036.交流B相电压                           $    $  V          $    $  ANS036.BYTE004  $  y=SPRINTF([%d],x1*2);
  $  037.交流C相电压                           $    $  V          $    $  ANS037.BYTE004  $  y=SPRINTF([%d],x1*2);
  $  038.电网交流A相电流                       $    $  A          $    $  ANS038.BYTE004  $  y=x1;
  $  039.电网交流B相电流                       $    $  A          $    $  ANS039.BYTE004  $  y=x1;
  $  040.电网交流C相电流                       $    $  A          $    $  ANS040.BYTE004  $  y=x1;
  $  041.充电方式                              $    $             $    $  ANS041.BYTE004  $  switxh(x1)0x00: y=@07f0;0x02: y=@07f1;default: y=@0002;
  ...
  $  045.OBC充放电请求                         $    $             $    $  ANS045.BYTE004  $  switxh(x1)0x00: y=@0207;0x01: y=@0252;0x02: y=@0253;0x03: y=@0254;default: y=@0002;
  $  046.充电枪温度                            $    $  ℃         $    $  ANS046.BYTE004  $  y=x1;
  $  047.充电口拔插次数                        $    $             $    $  ANS047.BYTE004  $  y=(x3*256*256+x2*256+x1);
  $  048.十五工况标志位                        $    $             $    $  ANS048.BYTE004  $  switxh(x1)0x00: y=@0250;0x01: y=@0251;default: y=@0002;
  $  049.油门采样值1                           $    $             $    $  ANS049.BYTE004  $  y=(x2*256+x1);
  $  050.油门采样值2                           $    $             $    $  ANS050.BYTE004  $  y=(x2*256+x1);
  $  051.IGBT温度采样值U                       $    $             $    $  ANS051.BYTE004  $  y=(x2*256+x1);
  $  052.IGBT温度采样值V                       $    $             $    $  ANS052.BYTE004  $  y=(x2*256+x1);
  $  053.IGBT温度采样值W                       $    $             $    $  ANS053.BYTE004  $  y=(x2*256+x1);
  $  054.电机温度采样值                        $    $             $    $  ANS054.BYTE004  $  y=(x2*256+x1);
  $  055.电感温度采样值U                       $    $             $    $  ANS055.BYTE004  $  y=(x2*256+x1);
  $  056.电感温度采样值V                       $    $             $    $  ANS056.BYTE004  $  y=(x2*256+x1);
  $  057.电感温度采样值W                       $    $             $    $  ANS057.BYTE004  $  y=(x2*256+x1);
  $  058.充电枪温度采样值1                     $    $             $    $  ANS058.BYTE004  $  y=(x2*256+x1);
  $  059.充电枪温度采样值2                     $    $             $    $  ANS059.BYTE004  $  y=(x2*256+x1);
  $  060.CC采样值                              $    $             $    $  ANS060.BYTE004  $  y=(x2*256+x1);
  $  061.CP占空比                              $    $  %          $    $  ANS061.BYTE004  $  y=x1;
  $  062.充电S2开关吸合标志                    $    $             $    $  ANS062.BYTE004  $  switxh(x1)0x00: y=@0047;0x01: y=@0048;default: y=@0002;
  $  063.发送CP标志位                          $    $             $    $  ANS063.BYTE004  $  switxh(x1)0x00: y=@0257;0x01: y=@0258;default: y=@0002;
  $  064.驱动电机系统配置类型                  $    $             $    $  ANS064.BYTE004  $  switxh(x1)0x00: y=@0255;0x01: y=@0256;default: y=@0002;
  $  065.倾角传感器是否校准                    $    $             $    $  ANS065.BYTE004  $  switxh(x1)0x00: y=@00ed;0x01: y=@0259;default: y=@0002;
  $  066.倾角传感器信息状态                    $    $             $    $  ANS066.BYTE004  $  switxh(x1)0x00: y=@0046;0x01: y=@0045;default: y=@0002;
  $  067.倾角值                                $    $  %(DEG)     $    $  ANS067.BYTE004  $  y=SPRINTF([%d],x1-100);
  $  068.直流充电目标输入电压                  $    $  V          $    $  ANS068.BYTE004  $  y=(x2*256+x1);
  $  069.直流充电实际输入电压                  $    $  V          $    $  ANS069.BYTE004  $  y=(x2*256+x1);
  $  070.直流充电实际输入电流                  $    $  A          $    $  ANS070.BYTE004  $  y=SPRINTF([%.1f],(x2*256+x1)/10-500);
  $  071.降压模块状态                          $    $             $    $  ANS071.BYTE004  $  switxh(x1)0x00: y=@025a;0x01: y=@025b;0x02: y=@025c;0x03: y=@025d;default: y=@0002;
  $  072.升降压DC模块故障                      $    $             $    $  ANS072.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;default: y=@0002;
  ...
  $  000.充放电状态             $    $         $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0240;0x01: y=@0241;0x02: y=@0242;0x03: y=@0243;0x04: y=@07ee;0x05: y=@07ef;default: y=@0002;
  $  001.当前电制频率           $    $  Hz     $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@023e;0x01: y=@023f;default: y=@0002;
  ...
  $  004.线电压                 $    $  V      $    $  ANS004.BYTE004  $  y=(x2*256+x1);
  $  005.电网交流频率           $    $  Hz     $    $  ANS005.BYTE004  $  y=SPRINTF([%.1f],(x2*256+x1)*0.1);
  $  006.交流A相电压            $    $  V      $    $  ANS006.BYTE004  $  y=SPRINTF([%d],x1*2);
  $  007.交流B相电压            $    $  V      $    $  ANS007.BYTE004  $  y=SPRINTF([%d],x1*2);
  $  008.交流C相电压            $    $  V      $    $  ANS008.BYTE004  $  y=SPRINTF([%d],x1*2);
