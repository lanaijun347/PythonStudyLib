...
读数据流: 
  ...
  $  009.电流采样电路状态         $    $          $    $  ANS009.BYTE004  $  switxh(x1&0x03)0x00: y=@0045;0x01: y=@02ed;0x02: y=@02ee;0x03: y=@02ef;default: y=@0002;
  $  010.三相电流状态             $    $          $    $  ANS009.BYTE004  $  switxh(x1&0x0C)0x00: y=@0045;0x04: y=@02ed;0x08: y=@02ee;0x0C: y=@02ef;default: y=@0002;
  $  011.IPM/IGBT状态             $    $          $    $  ANS009.BYTE004  $  if(x1&0x10) y=@00b4;else y=@0045;
  $  012.内部温度传感器状态       $    $          $    $  ANS009.BYTE004  $  if(x1&0x20) y=@00b4;else y=@0045;
  $  013.内部电流状态             $    $          $    $  ANS009.BYTE004  $  switxh(x1&0xC0)0x00: y=@0045;0x40: y=@02f1;0x80: y=@02f2;0xC0: y=@02f3;default: y=@0002;
  $  014.启动状态                 $    $          $    $  ANS009.BYTE005  $  if(x1&0x01) y=@02f6;else y=@0045;
  $  015.内部温度状态             $    $          $    $  ANS009.BYTE005  $  switxh(x1&0x06)0x00: y=@0045;0x02: y=@02f4;0x04: y=@02f5;default: y=@0002;
  $  016.转速状态                 $    $          $    $  ANS009.BYTE005  $  if(x1&0x08) y=@00b4;else y=@0045;
  $  017.压缩机负载状态           $    $          $    $  ANS009.BYTE005  $  switxh(x1&0x30)0x00: y=@0045;0x10: y=@02e6;0x20: y=@0530;default: y=@0002;
  $  018.母线电压状态             $    $          $    $  ANS009.BYTE005  $  switxh(x1&0xC0)0x00: y=@0045;0x40: y=@02ea;0x80: y=@02eb;default: y=@0002;
  $  019.内部低压电状态           $    $          $    $  ANS009.BYTE006  $  switxh(x1&0x03)0x00: y=@0045;0x01: y=@02e8;0x02: y=@02e9;default: y=@0002;
  $  020.相电压状态               $    $          $    $  ANS009.BYTE006  $  if(x1&0x04) y=@02ec;else y=@0045;
  $  021.日期                     $    $          $    $  ANS010.BYTE004  $  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
