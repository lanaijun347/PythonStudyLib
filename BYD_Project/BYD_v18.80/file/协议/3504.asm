...
读数据流: 
  ...
  $  014.VIN码                      $    $            $    $  ANS014.BYTE004  $  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17);
  $  015.硬件版本                   $    $            $    $  ANS015.BYTE004  $  y=SPRINTF([%d.%d.%d],(x1%1000-x1%100)/100,(x1%100-x1%10)/10,x1%10);
  $  016.硬件日期                   $    $            $    $  ANS015.BYTE005  $  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
