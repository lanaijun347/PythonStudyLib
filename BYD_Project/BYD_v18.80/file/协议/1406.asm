...
读数据流: 
  ...
  $  033.EPB(电子驻车)状态                           $    $               $    $  ANS018.BYTE004  $  if(x1==0) y=@0009; else if(x1==1) y=@012b; else if(x1==2) y=@0183;else if(x1==3) y=@0184;else if(x1==4) y=@0046;else y=@0002;
  ...
  $  040.遥控驾驶状态                                $    $               $    $  ANS022.BYTE004  $  if(x1==0) y=@0045; else if(x1==1)y=@017b; else y=@0002;
  $  041.促动器1位置传感器                           $    $  mm           $    $  ANS023.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  042.促动器3位置传感器                           $    $  mm           $    $  ANS024.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  043.促动器阀1开关状态                           $    $               $    $  ANS025.BYTE004  $  if(x1==0) y=@0000; else if(x1==1) y=@0001; else y=@0002;
  $  044.促动器阀2开关状态                           $    $               $    $  ANS026.BYTE004  $  if(x1==0) y=@0000; else if(x1==1) y=@0001; else y=@0002;
  $  045.促动器1中位置                               $    $               $    $  ANS027.BYTE004  $  y=x1*256+x2;
  $  046.促动器3中位置                               $    $               $    $  ANS028.BYTE004  $  y=x1*256+x2;
  $  047.多路阀开关状态                              $    $               $    $  ANS029.BYTE004  $  if(x1==0) y=@0000; else if(x1==1) y=@0001; else y=@0002;
  $  048.促动器2位置传感器                           $    $  mm           $    $  ANS030.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  049.促动器4位置传感器                           $    $  mm           $    $  ANS031.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  050.促动器阀3开关状态                           $    $               $    $  ANS032.BYTE004  $  if(x1==0) y=@0000; else if(x1==1) y=@0001; else y=@0002;
  $  051.促动器阀4开关状态                           $    $               $    $  ANS033.BYTE004  $  if(x1==0) y=@0000; else if(x1==1) y=@0001; else y=@0002;
  ...
  $  062.P档锁定状态                                 $    $               $    $  ANS042.BYTE004  $  if(x1==0) y=@0069; else if(x1==1)y=@017c;else if(x1==2)y=@017d;else if(x1==3)y=@017e;else if(x1==4)y=@017f;else y=@0002;
  $  063.P档系统状态                                 $    $               $    $  ANS042.BYTE005  $  if(x1==0) y=@0045; else if(x1==1)y=@0180;else y=@003f;
  $  064.加速度传感器状态                            $    $               $    $  ANS043.BYTE004  $  if(x1==0) y=@0045; else if(x1==1) y=@00c7; else y=@0002;
...
$^TIP:执行条件要求(为保证安全请将刹车踏板踩到底) (1)整车P档位,拉手刹 (2)发动机启动中 (3)必须踩住刹车踏板 
;----------------------------------------------------------------------------------------------------
