...
读数据流: 
  ...
  $  026.海拔校正                                    $    $  %            $    $  ANS000.BYTE121  $  y=x1*100.00/255;
  ...
  $  073.发动机冷却系统-低速风扇是否开启             $    $               $    $  ANS000.BYTE023  $  if(x1&0x01)y=@001b;else y=@001c;
  $  074.发动机冷却系统-高速风扇是否开启             $    $               $    $  ANS000.BYTE023  $  if(x1&0x02)y=@001b;else y=@001c;
  $  075.发动机冷却系统-风扇类型                     $    $               $    $  ANS000.BYTE023  $  if((x1&0x0F)<0x04)y=@0023;else if((x1&0x0F)<0x08)y=@0024;else y=@0002;
  $  076.发动机稳态工况-点火电源开启                 $    $               $    $  ANS000.BYTE024  $  if(x1&0x01)y=@001b;else y=@001c;
  $  077.发动机稳态工况-主继电器工作                 $    $               $    $  ANS000.BYTE024  $  if(x1&0x02)y=@001b;else y=@001c;
  $  078.发动机动态工况-节气门处于怠速位置           $    $               $    $  ANS000.BYTE025  $  if(x1&0x01)y=@001b;else y=@001c;
  $  079.发动机动态工况-节气门处于部分打开位置       $    $               $    $  ANS000.BYTE025  $  if(x1&0x02)y=@001b;else y=@001c;
  $  080.发动机动态工况-节气门处于全开位置           $    $               $    $  ANS000.BYTE025  $  if(x1&0x04)y=@001b;else y=@001c;
  $  081.发动机动态工况-激活减速断油                 $    $               $    $  ANS000.BYTE025  $  if(x1&0x08)y=@000e;else y=@000f;
  $  082.发动机动态工况-激活加速加浓                 $    $               $    $  ANS000.BYTE025  $  if(x1&0x10)y=@000e;else y=@000f;
  $  083.发动机动态工况-是否D档(前进挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x20)y=@001b;else y=@001c;
  $  084.发动机动态工况-是否R档(后退挡)              $    $               $    $  ANS000.BYTE025  $  if(x1&0x40)y=@001b;else y=@001c;
  $  085.发动机动态工况-是否N档(空挡)                $    $               $    $  ANS000.BYTE025  $  if(x1&0x80)y=@001b;else y=@001c;
  $  086.氧传感器-氧传感器1信号                      $    $               $    $  ANS000.BYTE027  $  if(x1&0x01)y=@001d;else y=@001e;
  $  087.氧传感器-氧传感器2信号                      $    $               $    $  ANS000.BYTE027  $  if(x1&0x02)y=@001d;else y=@001e;
  $  088.氧传感器-氧传感器1加热                      $    $               $    $  ANS000.BYTE027  $  if(x1&0x10)y=@00be;else y=@00bf;
  $  089.氧传感器-氧传感器2加热                      $    $               $    $  ANS000.BYTE027  $  if(x1&0x20)y=@00be;else y=@00bf;
  $  090.发动机怠速-踏板位置确认怠速                 $    $               $    $  ANS000.BYTE028  $  if(x1&0x01)y=@001b;else y=@001c;
  $  091.发动机怠速-制动器状态                       $    $               $    $  ANS000.BYTE028  $  if(x1&0x02)y=@0003;else y=@00c0;
  $  092.发动机怠速-是否有空调请求                   $    $               $    $  ANS000.BYTE028  $  if(x1&0x04)y=@001b;else y=@001c;
  $  093.发动机怠速-后车窗/前挡风玻璃加热            $    $               $    $  ANS000.BYTE028  $  if(x1&0x08)y=@0001;else y=@0000;
  $  094.发动机怠速-动力转向开关                     $    $               $    $  ANS000.BYTE028  $  if(x1&0x10)y=@0001;else y=@0000;
  $  095.发动机怠速-真空泵状态                       $    $               $    $  ANS000.BYTE028  $  if(x1&0x40)y=@0001;else y=@0000;
  $  096.指示灯SVS/MIL-MIL(故障指示灯)激活           $    $               $    $  ANS000.BYTE029  $  if(x1&0x01)y=@000e;else y=@000f;
  $  097.指示灯SVS/MIL-MIL(故障指示灯)闪烁           $    $               $    $  ANS000.BYTE029  $  if(x1&0x02)y=@001b;else y=@001c;
  $  098.指示灯SVS/充电系统故障灯                    $    $               $    $  ANS000.BYTE029  $  if(x1&0x04)y=@0045;else y=@0046;
  $  099.指示灯SVS/MIL-SVS(系统维修指示灯)激活       $    $               $    $  ANS000.BYTE029  $  if(x1&0x10)y=@000e;else y=@000f;
  $  100.指示灯SVS/MIL-SVS(系统维修指示灯)闪烁       $    $               $    $  ANS000.BYTE029  $  if(x1&0x20)y=@001b;else y=@001c;
  $  101.空调系统-空调开启                           $    $               $    $  ANS000.BYTE031  $  if(x1&0x01)y=@001b;else y=@001c;
  $  102.空调系统-空调请求激活                       $    $               $    $  ANS000.BYTE031  $  if(x1&0x02)y=@000e;else y=@000f;
  $  103.空调系统-空调压缩机开                       $    $               $    $  ANS000.BYTE031  $  if(x1&0x04)y=@001b;else y=@001c;
  $  104.空调系统-空调断开或无空调                   $    $               $    $  ANS000.BYTE031  $  if(x1&0x08)y=@001b;else y=@001c;
  $  105.空调系统-空调因温度断开                     $    $               $    $  ANS000.BYTE031  $  if(x1&0x10)y=@001b;else y=@001c;
  $  106.空调系统-怠速转速因空调而增加               $    $               $    $  ANS000.BYTE031  $  if(x1&0x20)y=@001b;else y=@001c;
  $  107.空调系统-全负荷时关闭空调压缩机             $    $               $    $  ANS000.BYTE031  $  if(x1&0x40)y=@001b;else y=@001c;
  $  108.空调系统-空调中压开关开                     $    $               $    $  ANS000.BYTE031  $  if(x1&0x80)y=@001b;else y=@001c;
  $  109.AT/扭矩请求-AT转换离合器激活                $    $               $    $  ANS000.BYTE032  $  if(x1&0x08)y=@000e;else y=@000f;
  $  110.巡航控制-巡航功能                           $    $               $    $  ANS000.BYTE033  $  if(x1&0x01) y=@0001;else y=@0000;
  $  111.巡航控制-巡航状态                           $    $               $    $  ANS000.BYTE033  $  if(x1&0x02)y=@0093;else y=@003f;
  $  112.巡航控制-按键状态                           $    $               $    $  ANS000.BYTE033  $  if((x1&0x1F)<0x04)y=@00b5;else if((x1&0x1F)<0x08)y=@00b6;else if((x1&0x1F)<0x0C)y=@00b7;else if((x1&0x1F)<0x10)y=@00b8;else if((x1&0x1F)<0x14)y=@00b9;else if((x1&0x1F)<0x18)y=@00ba;else y=@0002;
  $  113.发动机状态-刹车开关激活                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x01)y=@000e;else y=@000f;
  $  114.发动机状态-刹车灯激活                       $    $               $    $  ANS000.BYTE034  $  if(x1&0x02)y=@000e;else y=@000f;
  $  115.发动机状态-涡轮增压旁通阀                   $    $               $    $  ANS000.BYTE034  $  if(x1&0x10)y=@0001;else y=@0000;
  $  116.发动机状态-防盗锁定状态                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x20)y=@0067;else y=@00bd;
  $  117.发动机状态-燃油反馈状态                     $    $               $    $  ANS000.BYTE034  $  if(x1&0x40)y=@00bb;else y=@00bc;
  $  118.发动机状态-可变气门升程阀状态(VVL阀)        $    $               $    $  ANS000.BYTE034  $  if(x1&0x80)y=@0001;else y=@0000;
...
$^ 01.碳罐控制阀控制 
 $^TYPE:2
$^BUTTON:输入
$^REQ00:7E0 05 2F 01 11 XX XX 00 00     $^
...
$^ 07.怠速转速控制-短期调整 
 $^TYPE:2
$^BUTTON:输入
$^REQ00:7E0 05 2F 01 24 XX XX 00 00     $^
...
$^ 12.增压压力限制阀控制 
 $^TYPE:2
$^BUTTON:输入
$^REQ00:7E0 05 2F 02 00 XX XX 00 00     $^
...
$^ 13.节气门开度控制 
 $^TYPE:2
$^BUTTON:输入
$^REQ00:7E0 05 2F 02 02 XX XX 00 00     $^
...
$^ 20.低压油泵占空比控制 
 $^TYPE:2
$^BUTTON:输入
$^REQ00:7E0 05 2F 02 0F XX XX 00 00     $^
...
$^ 21.排气凸轮轴控制 
 $^TYPE:2
$^BUTTON:输入
$^REQ00:7E0 05 2F 02 10 XX XX 00 00     $^
