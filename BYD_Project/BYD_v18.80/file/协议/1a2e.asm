...
读数据流: 
  ...
  $  001.冷凝风扇工作状态                    $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@02e0;else if(x1==0x02)y=@02e1;else if(x1==0x03)y=@02e2;else  y=@0002;
  $  002.冷却风扇工作状态                    $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@02e0;else if(x1==0x02)y=@02e1;else if(x1==0x03)y=@02e2;else  y=@0002;
  $  003.电源电压                            $    $  V            $    $  ANS003.BYTE004  $  if(x1<=0xFA) y=x1*0.125;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  004.冷凝风扇实际工作的占空比            $    $  %            $    $  ANS004.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  005.冷却风扇实际工作的占空比            $    $  %            $    $  ANS005.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  006.冷凝/冷却风扇预置工作的占空比       $    $  %            $    $  ANS006.BYTE004  $  if(x1<=0x64) y=x1;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  007.模块温度                            $    $  degree C     $    $  ANS007.BYTE004  $  if(x1<=0xD2) y=x1-40;else if(x1 == 0xFF) y=@027c;else y=@0002;
  $  008.电源档位                            $    $               $    $  ANS008.BYTE004  $  if(x1==0x00)y=@010e;else if(x1==0x01)y=@014f;else if(x1==0x02)y=@014e;else if(x1==0x03)y=@014d;else  y=@0002;
