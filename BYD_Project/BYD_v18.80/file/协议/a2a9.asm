...
版本信息:
  ...
  $%  000:软件号:              $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%02X.%02X.%02X %dY%dM%dD],x1,x2,x3,x4,x5,x6);
  $%  001:硬件号:              $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%02X.%02X.%02X %dY%dM%dD],x1,x2,x3,x4,x5,x6);
...
读数据流: 
  ...
  $  001.已匹配钥匙数             $    $       $    $  ANS001.BYTE004  $  if(x1==0x00)y=@00a7;else if(x1==0x01)y=@00a8;else if(x1==0x02)y=@00a9;else if(x1==0x03)y=@00aa;else if(x1==0x04)y=@00ab;else y=@0002;
  $  002.内部供电状况             $    $       $    $  ANS002.BYTE004  $  if(x1==0x00)y=@00ae;else if(x1==0xFF)y=@00af;else y=@0002;
  $  003.读卡器是否失去通信       $    $       $    $  ANS002.BYTE005  $  if(x1==0x00)y=@0364;else if(x1==0xFF)y=@0365;else y=@0002;
  $  004.内部天线状态             $    $       $    $  ANS002.BYTE006  $  if(x1==0x00)y=@0045;else if(x1==0xFF)y=@00b4;else y=@0002;
  $  005.钥匙状态                 $    $       $    $  ANS002.BYTE007  $  switxh(x1)2:y=@00b0;3:y=@00b1;4:y=@00b2;6:y=@00b3;default: y=@0002;
