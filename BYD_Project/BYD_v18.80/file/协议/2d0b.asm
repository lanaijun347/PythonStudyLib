...
读数据流: 
  ...
  $  000.后驱动电机状态       $    $           $    $  ANS000.BYTE004  $  switxh((x2*256+x1))0x00: y=@00dd;0x01: y=@00de;0x02: y=@0000;default: y=@0002;
  $  001.启动允许             $    $           $    $  ANS001.BYTE004  $  switxh((x2*256+x1))0x00: y=@00e4;0x01: y=@04ee;default: y=@0002;
  $  002.防盗解除状态         $    $           $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@00e1;0x01: y=@00e2;0x02: y=@04be;default: y=@0002;
  $  003.主动泄放状态         $    $           $    $  ANS003.BYTE004  $  switxh((x2*256+x1))0x00: y=@00e6;0x01: y=@0324;0x02: y=@00e8;0x03: y=@00e9;default: y=@0002;
  $  004.盖子状态             $    $           $    $  ANS004.BYTE004  $  switxh((x2*256+x1))0x00: y=@0001;0x01: y=@0000;default: y=@0002;
  $  005.动力系统状态         $    $           $    $  ANS005.BYTE004  $  switxh((x2*256+x1))0x00: y=@0045;0x01: y=@0046;default: y=@0002;
  ...
  $  011.IPM散热器温度        $    $  ℃       $    $  ANS011.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  012.电机温度             $    $  ℃       $    $  ANS012.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)-40);
  $  013.IGBT温度             $    $  ℃       $    $  ANS013.BYTE004  $  y=SPRINTF([%d],(x2*256+x1)-40);
  ...
  $  018.旋变状态             $    $           $    $  ANS018.BYTE004  $  switxh((x2*256+x1))0x00: y=@0045;0x01: y=@0046;default: y=@0002;
  $  019.过流状态             $    $           $    $  ANS019.BYTE004  $  switxh((x2*256+x1))0x00: y=@0045;0x01: y=@0046;default: y=@0002;
  $  020.IPM状态              $    $           $    $  ANS020.BYTE004  $  switxh((x2*256+x1))0x00: y=@0045;0x01: y=@0046;default: y=@0002;
