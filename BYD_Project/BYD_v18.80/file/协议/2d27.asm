...
读数据流: 
  ...
  $  000.生产日期            $    $         $    $  ANS000.BYTE004  $  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
  $  001.PTC预置档位         $    $         $    $  ANS001.BYTE004  $  y=x1;
  $  002.PTC实际档位         $    $         $    $  ANS002.BYTE004  $  y=x1;
  $  003.冷却液温度          $    $  ℃     $    $  ANS003.BYTE004  $  if((x1>=0)&&(x1<=170)) y=x1;else if(x1==208) y=@01d0;else if(x1==216) y=@01d1;else y=@0002;
  $  004.12V低压电源值       $    $  V      $    $  ANS004.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.1);
  $  005.负载高压电源        $    $  V      $    $  ANS005.BYTE004  $  y=(x1*256+x2);
  $  006.PTC产品序列号       $    $         $    $  ANS006.BYTE004  $  HEX(x1,x2,x3);
  $  007.生产日期            $    $         $    $  ANS006.BYTE007  $  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
