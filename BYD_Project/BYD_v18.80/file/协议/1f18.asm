...
读数据流: 
  ...
  $  001.是否加密       $    $       $    $  ANS001.BYTE004  $  if(x1==0x00)y=@0052;else if(x1==0x01)y=@0053;else y=@02dc;
  $  002.加密方式       $    $       $    $  ANS001.BYTE005  $  if(x1==0x00)y=@0052;else if(x1==0x01)y=@0188;else if(x1==0x02)y=@0189;else if(x1==0x03)y=@018a;else y=@02dc;
