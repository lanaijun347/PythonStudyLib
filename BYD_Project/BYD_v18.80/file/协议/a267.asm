...
版本信息:
  ...
  $%  001:软件号(年/月/日):        $%    $%  ANS000.BYTE007  $%  if(x1<27) y=SPRINTF([%02d/%02d/%02d],x1,x2,x3);else y=@002e;
  $%  002:硬件号:                  $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%d.%d.%d],x1,x2,x3);
  $%  003:硬件号(年/月/日):        $%    $%  ANS001.BYTE007  $%  if(x1<27) y=SPRINTF([%02d/%02d/%02d],x1,x2,x3);else y=@002e;
