...
读数据流: 
  ...
  $  021.车辆前行方向                                $    $               $    $  ANS012.BYTE006  $  if(x1==0) y=@0181; else if(x1==1) y=@0182; else y=@0002;
  $  022.换挡手柄                                    $    $               $    $  ANS013.BYTE004  $  if(x1==0) y=@0069;else if(x1==1) y=@0073; else if(x1==2) y=@0074;else if(x1==3) y=@0075; else if(x1==4) y=@0076;else if(x1==5) y=@0077;else if(x1==6) y=@0078; else if(x1==7) y=@0079;else if(x1==8) y=@007a; else y=@0002;
  $  023.换杆挡状态                                  $    $               $    $  ANS013.BYTE005  $  if(x1==0) y=@0045; else if(x1==1) y=@00c7; else y=@0002;
  $  024.当前档位                                    $    $               $    $  ANS013.BYTE006  $  if(x1==0) y=@0069;else if(x1==1) y=@006a; else if(x1==2) y=@006b;else if(x1==3) y=@006c; else if(x1==4) y=@006d;else if(x1==5) y=@006e;else if(x1==6) y=@006f; else if(x1==7) y=@0070; else if(x1==8) y=@0071;else if(x1==9) y=@0072;else y=@0002;
  ...
  $  033.EPB(电子驻车)状态                           $    $               $    $  ANS018.BYTE004  $  if(x1==0) y=@0009; else if(x1==1) y=@012b; else if(x1==2) y=@0183;else if(x1==3) y=@0183;else if(x1==4) y=@0046;else y=@0002;
  ...
  $  040.读取遥控驾驶状态                            $    $               $    $  ANS022.BYTE004  $  if(x1==0) y=@0045; else if(x1==1)y=@017b; else y=@0002;
  $  041.促动阀1位置传感器                           $    $  mm           $    $  ANS023.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  042.促动阀3位置传感器                           $    $  mm           $    $  ANS024.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  043.促动器阀1开关状态                           $    $               $    $  ANS025.BYTE004  $  if(x1==0) y=@00c4; else if(x1==1) y=@00c3; else y=@0002;
  $  044.促动器阀2开关状态                           $    $               $    $  ANS026.BYTE004  $  if(x1==0) y=@00c4; else if(x1==1) y=@00c3; else y=@0002;
  $  045.促动器1中位位置                             $    $               $    $  ANS027.BYTE004  $  y=x1*256+x2;
  $  046.促动器3中位位置                             $    $               $    $  ANS028.BYTE004  $  y=x1*256+x2;
  $  047.多路阀开关状态                              $    $               $    $  ANS029.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@00c4; else if((x1==0x00)&&(x2==0x01)) y=@00c3; else y=@0002;
  $  048.促动器2位置传感器                           $    $  mm           $    $  ANS030.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  049.促动器4位置传感器                           $    $  mm           $    $  ANS031.BYTE004  $  y=x1*2.56 + x2*0.01 - 15;
  $  050.促动器阀3开关状态                           $    $               $    $  ANS032.BYTE004  $  if(x1==0) y=@00c4; else if(x1==1) y=@00c3; else y=@0002;
  $  051.促动器阀4开关状态                           $    $               $    $  ANS033.BYTE004  $  if(x1==0) y=@00c4; else if(x1==1) y=@00c3; else y=@0002;
  ...
  $  075.整车工作模式                                $    $               $    $  ANS050.BYTE004  $  if(x1==0x00) y=@003e; else if(x1==0x01) y=@030d; else if(x1==0x02) y=@030e; else if(x1==0x03) y=@030f; else if(x1==0x04) y=@0310;else if(x1==0x05) y=@0311;else if(x1==0x06) y=@0312;else if(x1==0x07) y=@0313;else y=@0002;
  $  076.离合器强制脱开                              $    $               $    $  ANS050.BYTE005  $  if(x1==0) y=@02f7; else if(x1==1) y=@02f8; else y=@0002;
  $  077.离合器强制脱开命令有效标识位                $    $               $    $  ANS050.BYTE006  $  if(x1==0) y=@003f; else if(x1==1) y=@0093; else y=@0002;
