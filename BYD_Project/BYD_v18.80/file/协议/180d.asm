...
读数据流: 
  ...
  $  028.交流充电继电器动作请求命令                $    $               $    $  ANS028.BYTE004  $  if(x1==0x00)y=@0207;else if(x1==0x01)y=@0219;else y=@0002;
  $  029.SCI通讯状态                               $    $               $    $  ANS029.BYTE004  $  if(x1==0x00)y=@0228;else if(x1==0x01)y=@0046;else y=@0002;
  $  030.充放电系统故障状态                        $    $               $    $  ANS030.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@021d;else if(x1==0x02)y=@021e;else if(x1==0x03)y=@021f;else if(x1==0x04)y=@0220;else if(x1==0x05)y=@0368;else if(x1==0x06)y=@0222;else if(x1==0x07)y=@0223;else if(x1==0x08)y=@0224;else y=@0002;
  ...
  $  072.升降压DC模块故障                          $    $               $    $  ANS072.BYTE004  $  if(x1==0x00)y=@0046;else if(x1==0x01)y=@0045;else y=@0002;
