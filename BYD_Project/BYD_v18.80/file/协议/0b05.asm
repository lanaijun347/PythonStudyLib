...
读数据流: 
  ...
  $  001.放电是否允许         $    $               $    $  ANS001.BYTE004  $  if(x1==0x00)y=@004e;else if(x1==0x01)y=@004d;else if(x1==0x02)y=@00fe;else if(x1==0x03)y=@00ff;else y=@0002;
  $  002.DC系统故障状态       $    $               $    $  ANS002.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@0002;
  $  003.DC工作模式           $    $               $    $  ANS003.BYTE004  $  if(x1==0x00)y=@0100;else if(x1==0x01)y=@0101;else if(x1==0x02)y=@0102;else y=@0002;
