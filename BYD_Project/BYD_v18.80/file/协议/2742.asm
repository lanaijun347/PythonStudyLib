...
读数据流: 
  ...
  $  002.接地状态                             $    $               $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;0x02: y=@010e;0x03: y=@010e;default: y=@00d6;
  ...
  $  011.车内插座放电状态                     $    $               $    $  ANS011.BYTE004  $  switxh(x1)0x00: y=@0207;0x01: y=@0208;0x02: y=@0209;0x03: y=@020a;0x04: y=@020b;0x05: y=@010e;0x06: y=@010e;0x07: y=@010e;default: y=@00d6;
  $  012.VTOL(车辆对用电设备)放电状态         $    $               $    $  ANS012.BYTE004  $  switxh(x1)0x00: y=@0207;0x01: y=@0208;0x02: y=@0209;0x03: y=@020a;0x04: y=@020b;0x05: y=@010e;0x06: y=@010e;0x07: y=@010e;default: y=@00d6;
  $  013.充电口电锁状态                       $    $               $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@03eb;0x01: y=@072e;0x02: y=@03ed;0x03: y=@072f;default: y=@00d6;
  $  014.车载充电功率状态                     $    $               $    $  ANS014.BYTE004  $  switxh(x1)0x00: y=@020c;0x01: y=@020d;0x02: y=@020e;0x03: y=@010e;default: y=@00d6;
  $  015.充电口电锁工作模式                   $    $               $    $  ANS015.BYTE004  $  switxh(x1)0x00: y=@0730;0x01: y=@0731;0x02: y=@0732;0x03: y=@010e;default: y=@00d6;
  $  016.交流外充设备故障状态                 $    $               $    $  ANS016.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;default: y=@00d6;
  $  017.交流外充接地状态                     $    $               $    $  ANS017.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;0x02: y=@010e;0x03: y=@010e;default: y=@00d6;
  $  018.充电枪连接状态                       $    $               $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;0x02: y=@0047;default: y=@00d6;
  $  019.限功率放电状态                       $    $               $    $  ANS019.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0200;default: y=@00d6;
  $  020.应急充电是否允许                     $    $               $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@004d;0x01: y=@004e;default: y=@00d6;
  $  021.交流互锁故障                         $    $               $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;default: y=@00d6;
