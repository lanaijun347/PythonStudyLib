...
读数据流: 
  ...
  $  011.驻车制动开关状态                           $    $               $    $  ANS006.BYTE004  $  if(x1==0x00)y=@012a;else if(x1==0x01)y=@012b;else if(x1==0x02)y=@012c;else if(x1==0x03)y=@003f;else y=@0002;
  $  012.霍尔传感器计数                             $    $  Pulse        $    $  ANS007.BYTE004  $  y=(x2*256+x1);
  $  013.目标拉力                                   $    $  N            $    $  ANS008.BYTE004  $  y=x1*10;
  $  014.EPB(电子驻车)状态                          $    $               $    $  ANS009.BYTE004  $  if(x1==0x00)y=@012f;else if(x1==0x01)y=@0130;else if(x1==0x02)y=@0131;else if(x1==0x03)y=@0132;else if(x1==0x04)y=@0046;else y=@0002;
  $  015.EPB(电子驻车)校准检测状态                  $    $               $    $  ANS010.BYTE004  $  if(x1==0x00)y=@012d;else if(x1==0x01)y=@012e;else y=@0002;
  $  016.IGN状态                                    $    $               $    $  ANS011.BYTE004  $  if(x1==0x00)y=@0135;else if(x1==0x01)y=@0136;else if(x1==0x02)y=@0137;else if(x1==0x03)y=@0138;else y=@0002;
  ...
  $  019.维修模式                                   $    $               $    $  ANS014.BYTE004  $  if(x1==0x00)y=@003b;else if(x1==0x01)y=@0133;else if(x1==0x02)y=@0134;else y=@0002;
  $  020.EPB(电子驻车)电机操作有效                  $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@013c;else if(x1==0x01)y=@013d;else y=@0002;
  $  021.动态拉起状态                               $    $               $    $  ANS016.BYTE004  $  if(x1==0x00)y=@012c;else if(x1==0x01)y=@0139;else if(x1==0x02)y=@013a;else if(x1==0x03)y=@013b;else y=@0002;
  $  022.EPB(电子驻车)操作模式                      $    $               $    $  ANS017.BYTE004  $  if(x1==0x00)y=@0140;else if(x1==0x01)y=@0141;else y=@0002;
