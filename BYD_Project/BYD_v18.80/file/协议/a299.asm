...
版本信息:
  ...
  $%  001:硬件号:              $%    $%  ANS001.BYTE004  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
...
读数据流: 
  ...
  $  003.钥匙状态                 $    $       $    $  ANS000.BYTE007  $  switxh(x1) 0x03: y=@00b1; 0x04: y=@00b2; 0x06: y=@00b3;default: y=@00b0;
  $  004.钥匙ID                   $    $       $    $  ANS000.BYTE007  $  if(x1==0x04) y=@00b2;else if(x1==0x06) y=@00b3;else y=x2*16777216+x3*65536+x4*256+x5;
  $  005.钥匙序号                 $    $       $    $  ANS000.BYTE007  $  if(x1==0x04) y=@00b2;else if(x1==0x06) y=@00b3;else if(x1==0x03) y=@00b1;else y=x;
