...
版本信息:
  ...
  $%  004:车型:                    $%    $%  ANS002.BYTE004  $%  switxh(x1)0x81:y=@00f7;0x82:y=@00f8;0x83:y=@00f9;0x84:y=@00fa;0x85:y=@00fb;default: y=@0063;
  $%  005:MCU:                     $%    $%  ANS003.BYTE004  $%  switxh(x1)0x81:y=@00f6;default: y=@0063;
