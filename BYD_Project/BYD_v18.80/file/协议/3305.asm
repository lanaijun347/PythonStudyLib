...
读数据流: 
  ...
  $  000.放电是否允许         $    $         $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@004e;0x01: y=@004d;0x02: y=@02fd;0x03: y=@003b;default: y=@0002;
  $  001.DC系统故障状态       $    $         $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;default: y=@0002;
  ...
  $  007.MOS管温度            $    $  ℃     $    $  ANS007.BYTE004  $  y=SPRINTF([%d],x1-40);
