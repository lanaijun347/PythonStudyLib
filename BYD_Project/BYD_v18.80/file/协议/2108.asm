...
读数据流: 
  ...
  $  018.IPM温度                            $    $  degree C     $    $  ANS018.BYTE004  $  y=((x2<<8)+x1)-40;
  $  019.发动机目标扭矩                     $    $  牛顿米       $    $  ANS019.BYTE004  $  y=((x2<<8)+x1)*0.1-500;
  $  020.OK灯信息                           $    $               $    $  ANS020.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@02bf;else if((x1==0x01)&&(x2==0x00)) y=@02c0;else if((x1==0x02)&&(x2==0x00)) y=@02c1;else y=@02ae;
  $  021.电里程                             $    $  km           $    $  ANS021.BYTE004  $  y=(x3<<16)+(x2<<8)+x1;
  $  022.总里程                             $    $  km           $    $  ANS022.BYTE004  $  y=(x3<<16)+(x2<<8)+x1;
  $  023.整车驱动电机系统配置类型           $    $               $    $  ANS023.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@02ac;else if((x1==0x01)&&(x2==0x00)) y=@02ad;else if((x1==0x02)&&(x2==0x00)) y=@0013;else y=@02ae;
  ...
  $  026.坡道坡度                           $    $  °           $    $  ANS024.BYTE006  $  if((((x2<<8)+x1)>=0)&&(((x2<<8)+x1)<=300))y=(((x2<<8)+x1))*0.1;else if((((x2<<8)+x1)>=65236)&&(((x2<<8)+x1)<=65535))y=((((x2<<8)+x1))-65536)*0.1;else if((((x2<<8)+x1)==32767)) y=@04c3;else y=@02ae;
  $  027.前电机目标档位                     $    $               $    $  ANS025.BYTE004  $  if((x1==0x00)&&(x2==0x00)) y=@0591;else if((x1==0x01)&&(x2==0x00)) y=@00ef;else if((x1==0x02)&&(x2==0x00)) y=@00f0;else if((x1==0x03)&&(x2==0x00)) y=@00f1;else if((x1==0x04)&&(x2==0x00)) y=@00f2;else y=@02ae;
  $  028.BSG目标扭矩                        $    $  牛顿米       $    $  ANS026.BYTE004  $  y=((x2<<8)+x1)*1.0/10-500;
  $  029.BSG目标转速                        $    $  rpm          $    $  ANS027.BYTE004  $  y=((x2<<8)+x1)-3000;
  $  030.BSG目标电压                        $    $  V            $    $  ANS028.BYTE004  $  y=((x2<<8)+x1)*4;
  $  031.电池配置                           $    $               $    $  ANS029.BYTE004  $  if((((x2<<8)+x1)==0)) y=@007f;else if((((x2<<8)+x1)==1)) y=@007f;else if((((x2<<8)+x1)==2)) y=@007f;else y=@02ae;
