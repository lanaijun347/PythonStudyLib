...
读数据流: 
  ...
  $  000.P锁定状态                             $    $        $    $  ANS000.BYTE004  $  if(x1==0x00) y=@003f; else if(x1==0x01) y=@017c; else if(x1==0x02) y=@017d; else if(x1==0x03) y=@017e;else if(x1==0x04) y=@017f;else y=@0108;
  ...
  $  004.EEPROM存储故障                        $    $        $    $  ANS004.BYTE004  $  if(x1==0x00) y=@0045; else if(x1==0x01) y=@00b4;else y=@0108;
  $  005.缺相故障                              $    $        $    $  ANS005.BYTE004  $  if(x1==0x00) y=@0045; else if(x1==0x01) y=@036b;else if(x1==0x02) y=@036c;else if(x1==0x03) y=@036d;else if(x1==0x04) y=@036e;else if(x1==0x05) y=@036f;else if(x1==0x06) y=@0370;else if(x1==0x07) y=@0371;else y=@0108;
  $  006.与ABS(防抱死刹车系统)通讯故障         $    $        $    $  ANS006.BYTE004  $  if(x1==0x00) y=@0045; else if(x1==0x01) y=@00b4;else y=@0108;
  $  007.与TCU(自动变速箱控制器)通讯故障       $    $        $    $  ANS007.BYTE004  $  if(x1==0x00) y=@0045; else if(x1==0x01) y=@00b4;else y=@0108;
  $  008.驱动电压                              $    $  V     $    $  ANS008.BYTE004  $  if(x1<0x11) y=x1;else y=@0108;
  $  009.控制器电流                            $    $  A     $    $  ANS009.BYTE004  $  if(x1<0xFB) y=x1*0.1;else y=@0108;
  $  010.霍尔脉冲个数                          $    $        $    $  ANS010.BYTE004  $  if(x1<0x5B) y=x1;else y=@0108;
  $  011.反弹霍尔脉冲个数                      $    $        $    $  ANS011.BYTE004  $  if(x1<0x5B) y=x1;else y=@0108;
  $  012.控制状态                              $    $        $    $  ANS012.BYTE004  $  if(x1==0x00) y=@0045; else if(x1==0x01) y=@0372;else if(x1==0x02) y=@0373;else y=@0108;
