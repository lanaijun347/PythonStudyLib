...
读数据流: 
  ...
  $  024.速度限制监视器         $    $                $    $  ANS005.BYTE004  $  if(x1==0x00)y=@0357;else if(x1==0x01)y=@0358;else y=@0002;
  $  025.主动诊断               $    $                $    $  ANS006.BYTE004  $  if(x1 == 0x01) y=@0359;else if(x1 == 0x03) y=@035a;else y=@018c;
