...
读数据流: 
  ...
  $  037.机油液位                                    $    $               $    $  ANS000.BYTE153  $  switxh(x1)0x00: y=@029e;0x01: y=@029f;0x02: y=@02a0;0x03: y=@02a1;0x04: y=@02a2;0x05: y=@02a3;0x06: y=@02a4;0x07: y=@02a5;0x08: y=@02a6;0x09: y=@02a7;0x0A: y=@02a8;0x0B: y=@02a9;0x0C: y=@02aa;0x0D: y=@00c7;default: y=@0002;
  ...
  $  062.发动机启动命令                              $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x06)0x00: y=@003f;0x02: y=@0066;0x04: y=@0107;0x06: y=@003f;default: y=@0002;
  $  063.低压启动电池状态                            $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x18)0x00: y=@0047;0x08: y=@0048;0x10: y=@0047;0x18: y=@003f;default: y=@0002;
  $  064.发动机启动超时次数                          $    $               $    $  ANS000.BYTE018  $  switxh(x1&0x60)0x00: y=@0045;0x20: y=@00cc;0x40: y=@00cd;0x60: y=@003f;default: y=@0002;
  $  065.真空泵控制回路#1                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x06)0x00: y=@00ce;0x02: y=@00cf;0x04: y=@0045;0x06: y=@003f;default: y=@0002;
  $  066.真空泵控制回路#2                            $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x18)0x00: y=@00ce;0x08: y=@00cf;0x10: y=@0045;0x18: y=@003f;default: y=@0002;
  $  067.真空泵泄露状态                              $    $               $    $  ANS000.BYTE020  $  switxh(x1&0x60)0x00: y=@00ce;0x20: y=@00d0;0x40: y=@00d1;0x60: y=@0045;default: y=@0002;
  $  068.低速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x01) y=@001b;else y=@001c;
  $  069.高速风扇是否开启                            $    $               $    $  ANS000.BYTE023  $  if(x1&0x02) y=@001b;else y=@001c;
  $  070.风扇类型                                    $    $               $    $  ANS000.BYTE023  $  switxh(x1&0x0C)0x00: y=@0023;0x04: y=@0024;default: y=@010e;
