...
读数据流: 
  ...
  $  012.与ESP(电子车身稳定系统)通讯状态           $    $               $    $  ANS012.BYTE004  $  if(x1==0x00)y=@00ac;else if(x1==0x01)y=@037a;else y=@0002;
  $  013.与ABS(防抱死刹车系统)通讯状态             $    $               $    $  ANS013.BYTE004  $  if(x1==0x00)y=@00ac;else if(x1==0x02)y=@037a;else y=@0002;
  $  014.与电池管理器通讯状态                      $    $               $    $  ANS014.BYTE004  $  if(x1==0x00)y=@00ac;else if(x1==0x01)y=@037a;else y=@0002;
  $  015.与主控通讯状态                            $    $               $    $  ANS015.BYTE004  $  if(x1==0x00)y=@00ac;else if(x1==0x01)y=@037a;else y=@0002;
  ...
  $  072.升降压DC模块故障                          $    $               $    $  ANS072.BYTE004  $  if(x1==0x00)y=@0045;else if(x1==0x01)y=@0046;else y=@0002;
  ...
  $  000.充放电状态             $    $         $    $  ANS000.BYTE004  $  if(x1==0x00)y=@0240;else if(x1==0x01)y=@0241;else if(x1==0x02)y=@03fa;else if(x1==0x03)y=@0243;else if(x1==0x04)y=@0244;else if(x1==0x05)y=@0245;else y=@0002;
  $  001.当前电制频率           $    $  Hz     $    $  ANS001.BYTE004  $  if(x1==0x00) y=@037e;else if(x1==0x01) y=@037f;else y=@0002;
  $  002.当前电制三相电压       $    $  V      $    $  ANS002.BYTE004  $  if(x1==0x00) y=@0385;else if(x1==0x01) y=@0381;else if(x1==0x02) y=@0386;else if(x1==0x03) y=@0387;else if(x1==0x04) y=@0388;else if(x1 ==0x05) y=@0389;else y=@0002;
  $  003.当前电制单相电压       $    $  V      $    $  ANS003.BYTE004  $  if(x1==0x00) y=@0380;else if(x1==0x01) y=@0381;else if(x1==0x02) y=@0382;else if(x1==0x03) y=@0383;else if(x1==0x04) y=@0384;else y=@0002;
...
$^BUTTON:退出 
$^REQ00:780 02 10 03 00 00 00 00 00     $^
$^REQ01:780 04 2F FF 00 00 00 00 00     $^
...
$^REQ02:780 04 2F FF 00 00 00 00 00     $^
