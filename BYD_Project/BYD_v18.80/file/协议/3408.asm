...
读数据流: 
  ...
  $  011.TCU计算车速                        $    $  KM/H      $    $  ANS006.BYTE004  $  y=SPRINTF([%.4f],(x1*256+x2)*0.06875);
  $  012.TCU计算车速状态                    $    $            $    $  ANS006.BYTE006  $  switxh(x1)0x00: y=@0045;0x01: y=@00c7;default: y=@0002;
  ...
  $  015.TCU测量的发动机转速                $    $  rpm       $    $  ANS008.BYTE004  $  y=SPRINTF([%.2f],(x1*256+x2)*0.25);
  ...
  $  018.输入轴1转速                        $    $  rpm       $    $  ANS010.BYTE004  $  y=SPRINTF([%.2f],x1*0.25);
  $  019.输入轴2转速                        $    $  rpm       $    $  ANS011.BYTE004  $  y=SPRINTF([%.2f],(x1*256+x2)*0.25);
  $  020.输出轴转速                         $    $  rpm       $    $  ANS012.BYTE004  $  y=SPRINTF([%.2f],(x1*256+x2)*0.25);
  $  021.车辆前行方向                       $    $            $    $  ANS012.BYTE006  $  switxh(x1)0x00: y=@0181;0x01: y=@0182;default: y=@0002;
  $  022.换挡手柄                           $    $            $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@0069;0x01: y=@0073;0x02: y=@0074;0x03: y=@0075;0x04: y=@0076;0x05: y=@0077;0x06: y=@0078;0x07: y=@0079;0x08: y=@007a;default: y=@0002;
  $  023.换杆档状态                         $    $            $    $  ANS013.BYTE005  $  switxh(x1)0x00: y=@0045;0x01: y=@00c7;default: y=@0002;
  ...
  $  026.主压力阀实际电流                   $    $  mA        $    $  ANS014.BYTE006  $  y=SPRINTF([%.2f],x1*0.75);
  ...
  $  032.离合器1滑磨点                      $    $            $    $  ANS017.BYTE006  $  y=x1;
  $  033.EPB板状态                          $    $            $    $  ANS018.BYTE004  $  switxh(x1)0x00: y=@0009;0x01: y=@012b;0x02: y=@0183;0x03: y=@0183;0x04: y=@0046;default: y=@0002;
  ...
  $  039.离合器2滑磨点                      $    $            $    $  ANS021.BYTE006  $  y=x1;
  $  040.读取遥控驾驶状态                   $    $            $    $  ANS022.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@017b;default: y=@0002;
  ...
  $  043.促动器阀1开关状态                  $    $            $    $  ANS025.BYTE004  $  switxh(x1)0x00: y=@00c4;0x01: y=@00c3;default: y=@0002;
  $  044.促动器阀2开关状态                  $    $            $    $  ANS026.BYTE004  $  switxh(x1)0x00: y=@00c4;0x01: y=@00c3;default: y=@0002;
  $  045.促动器1中位位置                    $    $            $    $  ANS027.BYTE004  $  y=(x1*256+x2);
  $  046.促动器3中位位置                    $    $            $    $  ANS028.BYTE004  $  y=(x1*256+x2);
  $  047.多路阀开关状态                     $    $            $    $  ANS029.BYTE004  $  switxh((x1*256+x2))0x00: y=@00c4;0x01: y=@00c3;default: y=@0002;
  ...
  $  050.促动器阀3开关状态                  $    $            $    $  ANS032.BYTE004  $  switxh(x1)0x00: y=@00c4;0x01: y=@00c3;default: y=@0002;
  $  051.促动器阀4开关状态                  $    $            $    $  ANS033.BYTE004  $  switxh(x1)0x00: y=@00c4;0x01: y=@00c3;default: y=@0002;
  ...
  $  056.变速器油温                         $    $  ℃        $    $  ANS037.BYTE004  $  y=x1;
  $  057.离合器油温                         $    $  ℃        $    $  ANS038.BYTE004  $  y=x1;
  $  058.控制单元温度                       $    $  ℃        $    $  ANS039.BYTE004  $  y=x1;
  $  059.传感器电压                         $    $  V         $    $  ANS040.BYTE004  $  y=SPRINTF([%.4f],(x1*256+x2)*0.0024);
  ...
  $  063.P档系统状态                        $    $            $    $  ANS042.BYTE005  $  switxh(x1)0x00: y=@0045;0x01: y=@0046;default: y=@0002;
  ...
  $  075.整车工作模式                       $    $            $    $  ANS050.BYTE004  $  switxh(x1)0x00: y=@003e;0x01: y=@030d;0x02: y=@030e;0x03: y=@030f;0x04: y=@0310;0x05: y=@0311;0x06: y=@0312;0x07: y=@0313;default: y=@0002;
  $  076.离合器强制脱开                     $    $            $    $  ANS050.BYTE005  $  switxh(x1)0x00: y=@02f7;0x01: y=@02f8;default: y=@0002;
  $  077.离合器强制脱开命令有效标识位       $    $            $    $  ANS050.BYTE006  $  switxh(x1)0x00: y=@003f;0x01: y=@0093;default: y=@0002;
  $  078.促动器5位置传感器                  $    $  mm        $    $  ANS051.BYTE004  $  y=SPRINTF([%.2f],(x1*256+x2)*0.01-15);
  $  079.促动器5中位位置                    $    $            $    $  ANS051.BYTE006  $  y=(x1*256+x2);
  $  080.促动器5设置电流                    $    $  mA        $    $  ANS052.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.78125);
  $  081.促动器5实际电流                    $    $  mA        $    $  ANS052.BYTE006  $  y=SPRINTF([%.1f],(x1*256+x2)*0.78125);
  $  082.主压力阀-1设置电流                 $    $  mA        $    $  ANS053.BYTE004  $  y=SPRINTF([%.2f],(x1*256+x2)*0.73);
  $  083.主压力阀-1实际电流                 $    $  mA        $    $  ANS053.BYTE006  $  y=SPRINTF([%.2f],x1*0.75);
  $  084.油泵压力                           $    $  bar       $    $  ANS054.BYTE004  $  y=SPRINTF([%.2f],((x1*256+x2)*24.42-5676)/4324);
...
$^REQ01:7E1 04 2F 20 02 06 00 00 00     $^

$^DSP:离合器1压力测试
$^TIP:执行条件要求(为了安全请将刹车踏板踩到底) (1)整车N档位 (2)发动机启动中 (3)必须踩住刹车踏板 (4)查看压力信息请点击查询中的执行按钮 
...
$^REQ01:7E1 04 2F 20 03 06 00 00 00     $^
