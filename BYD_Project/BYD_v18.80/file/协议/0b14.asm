...
版本信息:
  ...
  $%  002:硬件日期:                         $%    $%  ANS001.BYTE005  $%  y=SPRINTF([%d%s%d%s%d%s],x1,@0038,x2,@0039,x3,@003a);
  ...
  $%  005:软件日期:                         $%    $%  ANS003.BYTE006  $%  y=SPRINTF([%d%s%d%s%d%s],x1,@0038,x2,@0039,x3,@003a);
...
读数据流: 
  ...
  $  007.制动踏板状态                $    $           $    $  ANS002.BYTE004  $  if(x1&0x01)y=@0367;else y=@0004;
  ...
  $  024.EPB(电子驻车)变量配置       $    $           $    $  ANS005.BYTE004  $  if(x1==0xBB)y=@00ca;else if(x1==0xAA)y=@00cb;else y=@0002;
