...
读数据流: 
  ...
  $  048.十五工况标志位                            $    $               $    $  ANS048.BYTE004  $  if(x1==0x00)y=@0250;else if(x1==0x01)y=@0251;else y=@0002;
  ...
  $  062.充电S2开关吸合标志                        $    $               $    $  ANS062.BYTE004  $  if(x1==0x00)y=@0047;else if(x1==0x01)y=@0048;else y=@0002;
  $  063.发送CP标志位                              $    $               $    $  ANS063.BYTE004  $  if(x1==0x00)y=@0257;else if(x1==0x01)y=@0258;else y=@0002;
  $  064.驱动电机系统配置类型                      $    $               $    $  ANS064.BYTE004  $  if(x1==0x00)y=@0255;else if(x1==0x01)y=@0256;else y=@0002;
  $  065.倾角传感器是否校准                        $    $               $    $  ANS065.BYTE004  $  if(x1==0x00)y=@00ed;else if(x1==0x01)y=@0259;else y=@0002;
  $  066.倾角传感器信息状态                        $    $               $    $  ANS066.BYTE004  $  if(x1==0x00)y=@0046;else if(x1==0x01)y=@0045;else y=@0002;
  ...
  $  071.降压模块状态                              $    $               $    $  ANS071.BYTE004  $  if(x1==0x00)y=@025a;else if(x1==0x01)y=@025b;else if(x1==0x02)y=@025c;else if(x1==0x03)y=@025d;else y=@0002;
  $  072.升降压DC模块故障                          $    $               $    $  ANS072.BYTE004  $  if(x1==0x01)y=@0045;else if(x1==0x00)y=@0046;else y=@0002;
