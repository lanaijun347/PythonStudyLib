...
读数据流: 
  ...
  $  000.前制动回路气压信号       $    $  Mpa     $    $  ANS000.BYTE004  $  if((x>0x96)||(x==0x00))y=@0108;else y=0.01*x;
  $  001.前制动回路气压状态       $    $          $    $  ANS001.BYTE004  $  if(x==0x00)y=@0045;else if(x==0x01)y=@06c9;else if(x==0x02)y=@067b;else y=@0108;
  $  002.后制动回路气压信号       $    $  Mpa     $    $  ANS002.BYTE004  $  if((x>0x96)||(x==0x00))y=@0108;else y=0.01*x;
  $  003.后制动回路气压状态       $    $          $    $  ANS003.BYTE004  $  if(x==0x00)y=@0045;else if(x==0x01)y=@06c9;else if(x==0x02)y=@067b;else y=@0108;
  $  004.制动踏板状态             $    $          $    $  ANS004.BYTE004  $  if(x==0x00)y=@0667;else if(x==0x01)y=@0004;else y=@0108;
  $  005.驻车状态                 $    $          $    $  ANS005.BYTE004  $  if(x==0x00)y=@0004;else if(x==0x01)y=@0187;else y=@0108;
  $  006.故障检测标志位           $    $          $    $  ANS006.BYTE004  $  if(x==0x00)y=@0108;else if(x==0x01)y=@06ca;else if(x==0x02)y=@06cb;else if(x==0x03)y=@06cc;else if(x==0x04)y=@06db;else y=@0108;
  $  007.请求档位                 $    $          $    $  ANS007.BYTE004  $  if(x==0x00)y=@0108;else if(x==0x01)y=@0073;else if(x==0x02)y=@0074;else if(x==0x03)y=@0075;else if(x==0x04)y=@0076;else if(x==0x05)y=@04eb;else y=@0108;
  $  008.驻车回路气压             $    $  Mpa     $    $  ANS008.BYTE004  $  if((x>0x96)||(x==0x00))y=@0108;else y=0.01*x;
  $  009.油门深度                 $    $  %       $    $  ANS009.BYTE004  $  if(x>0x64)y=@0108;else y=x;
  $  010.脚刹深度                 $    $  %       $    $  ANS010.BYTE004  $  if(x>0x64)y=@0108;else y=x;
