...
版本信息:
  ...
  $%  000:硬件日期:        $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
  $%  001:硬件版本:        $%    $%  ANS000.BYTE007  $%  y=SPRINTF([%d.%d.%d],x3,x2,x1);
  $%  002:软件日期:        $%    $%  ANS001.BYTE004  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
...
读数据流: 
  ...
  $  000.P档电机状态                                              $    $        $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@003f;0x01: y=@017c;0x02: y=@017d;0x03: y=@017e;0x04: y=@017f;default: y=@0002;
  $  001.驱动管或电机状态                                         $    $        $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@011d;default: y=@0002;
  $  002.备用霍尔信号状态                                         $    $        $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@00cf;default: y=@0002;
  $  003.位置霍尔状态                                             $    $        $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0369;0x02: y=@036a;default: y=@0002;
  $  004.电机缺相                                                 $    $        $    $  ANS004.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@036b;0x02: y=@036c;0x03: y=@036d;0x04: y=@036e;0x05: y=@036f;0x06: y=@0370;0x07: y=@0798;default: y=@0002;
  $  005.与ABS/ESP(防抱死刹车系统/电子车身稳定系统)通讯状态       $    $        $    $  ANS005.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@00b4;default: y=@0002;
  ...
  $  010.控制状态                                                 $    $        $    $  ANS010.BYTE004  $  switxh(x1)0x00: y=@0045;0x01: y=@0372;0x02: y=@0373;default: y=@0002;
