...
读数据流: 
  ...
  $  000.档位故障状态                    $    $           $    $  ANS000.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@04bb;default: y=@02ae;
  $  001.过载告警                        $    $           $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@04bb;default: y=@02ae;
  $  002.堵转告警                        $    $           $    $  ANS002.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@04bb;default: y=@02ae;
  $  003.油门错误                        $    $           $    $  ANS003.BYTE004  $  switxh(x1)0x00: y=@0228;0x01: y=@04bb;default: y=@02ae;
  ...
  $  009.整车工作模式                    $    $           $    $  ANS009.BYTE004  $  if((x3*256*256+x2*256+x1)==0) y=@02b1;else if((x3*256*256+x2*256+x1)==1) y=@030d;else if((x3*256*256+x2*256+x1)==2) y=@0312;else if((x3*256*256+x2*256+x1)==3) y=@0313;else if((x3*256*256+x2*256+x1)==4) y=@04b9;else y=@02ae;
  ...
  $  016.巡航目标车速                    $    $  km/h     $    $  ANS016.BYTE004  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=3000)) y=SPRINTF([%.1f],(x2*256+x1)/10);else if((x2*256+x1)==65535) y=@04ba;else y=@0002;
  $  017.OK灯状态                        $    $           $    $  ANS017.BYTE004  $  if(x1==0) y=@02bf;else if(x1==1) y=@02c0;else y=@0002;
  $  018.无极风扇请求状态                $    $  %        $    $  ANS018.BYTE004  $  if((x1>=0)&&(x1<=100)) y=x1;else if(x1==255) y=@04c2;else y=@0002;
  $  019.真空泵状态                      $    $           $    $  ANS019.BYTE004  $  if(x1==0) y=@04c0;else if(x1==1) y=@04c1;else y=@0002;
  ...
  $  023.水温值                          $    $  ℃       $    $  ANS023.BYTE004  $  if((x1>=0)&&(x1<=200)) y=x1-40;else if(x1==255) y=@04c2;else y=@0002;
  ...
  $  029.整车车速                        $    $  km/h     $    $  ANS029.BYTE004  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=3000)) y=SPRINTF([%.1f],(x2*256+x1)*0.1);else if((x2*256+x1)==65535) y=@00c7;else y=@0002;
  ...
  $  038.VIN是否写入                     $    $           $    $  ANS038.BYTE004  $  if((x2*256+x1)==0) y=@0265;else if((x2*256+x1)==1) y=@04bf;else y=@02ae;
