...
版本信息:
  ...
  $%  000:引导程序软件版本号/日期（年）:        $%    $%  ANS000.BYTE004  $%  y=SPRINTF([%02d%s%02d%s%d%s],x1+2000,@0038,x2,@0521,x3,@0522);
...
读数据流: 
  ...
  $  002.BSG电机实际转速                 $    $  rpm     $    $  ANS002.BYTE004  $  y=SPRINTF([%d],(x1*256+x2)-30000);
  $  003.BSG输出扭矩（发电、电动）       $    $  NM      $    $  ANS003.BYTE004  $  y=SPRINTF([%.1f],(x1*256+x2)*0.1-500);
  $  004.BSG母线电压                     $    $  V       $    $  ANS004.BYTE004  $  y=(x1*256+x2);
  ...
  $  008.BSG电机温度                     $    $  ℃      $    $  ANS008.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  009.BSG稳压状态                     $    $          $    $  ANS009.BYTE004  $  switxh(x1)0x00: y=@0000;0x01: y=@002d;default: y=@0002;
  $  010.IPM温度                         $    $  ℃      $    $  ANS010.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  011.BSG箱体温度                     $    $  ℃      $    $  ANS011.BYTE004  $  y=SPRINTF([%d],x1-40);
  $  012.电源电压                        $    $  V       $    $  ANS012.BYTE004  $  y=SPRINTF([%.1f],x1*0.1);
  $  013.三相继电器总状态                $    $          $    $  ANS013.BYTE004  $  switxh(x1)0x00: y=@0048;0x01: y=@0047;default: y=@0002;
