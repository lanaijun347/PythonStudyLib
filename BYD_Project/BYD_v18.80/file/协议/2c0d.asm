...
读数据流: 
  ...
  $  011.水泵状态                        $    $           $    $  ANS011.BYTE004  $  switxh((x2*256+x1))0x00: y=@002d;0x01: y=@0000;0x02: y=@010e;default: y=@02ae;
  $  012.巡航状态                        $    $           $    $  ANS012.BYTE004  $  switxh(x1)0x00: y=@02bd;0x01: y=@02be;default: y=@02ae;
  ...
  $  020.风扇高速状态                    $    $  %        $    $  ANS020.BYTE004  $  switxh(x1)0x00: y=@05b0;0x01: y=@05b1;default: y=@0002;
  $  021.风扇低速状态                    $    $  %        $    $  ANS021.BYTE004  $  switxh(x1)0x00: y=@05ae;0x01: y=@05af;default: y=@0002;
  $  022.EPB(电子驻车系统)状态           $    $           $    $  ANS022.BYTE004  $  switxh(x1)0x00: y=@0009;0x01: y=@0004;0x02: y=@00ea;0x03: y=@00eb;0x04: y=@0046;default: y=@0002;
  ...
  $  026.整车车速                        $    $  km/h     $    $  ANS026.BYTE004  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=3000)) y=SPRINTF([%.1f],(x2*256+x1)*0.1);else if((x2*256+x1)==65535) y=@00c7;else y=@0002;
  ...
  $  030.坡道坡度                        $    $           $    $  ANS030.BYTE004  $  if(((x2*256+x1)>=0)&&((x2*256+x1)<=200)) y=(x2*256+x1)-100;else if((x2*256+x1)==32767) y=@04c3;else y=@02ae;
  $  031.售后软件版本号                  $    $           $    $  ANS031.BYTE004  $  y=SPRINTF([%d.%d.%d],x1,x2,x3);
  $  032.巡航配置状态                    $    $           $    $  ANS032.BYTE004  $  switxh((x2*256+x1))0x00: y=@0013;0x01: y=@034e;0x02: y=@034f;default: y=@0002;
  ...
  $  036.倾角标定工作信息/是否校准       $    $           $    $  ANS036.BYTE004  $  if((x2*256+x1)==0) y=@00ec;else if((x2*256+x1)==1) y=@00ed;else y=@02ae;
