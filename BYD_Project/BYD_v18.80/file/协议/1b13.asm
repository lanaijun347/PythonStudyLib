...
版本信息:
  ...
  $%  004:车型:                    $%    $%  ANS002.BYTE004  $%  switxh(x1)0x51:y=@00f7;0x52:y=@00f8;0x53:y=@00f9;0x54:y=@00fa;0x55:y=@00fb;default: y=@0063;
  $%  005:MCU:                     $%    $%  ANS003.BYTE004  $%  switxh(x1)0x51:y=@00f6;default: y=@0063;
  $%  006:压缩机产品序列号:        $%    $%  ANS004.BYTE004  $%  y=SPRINTF([%02X %02X %02X],x1,x2,x3);
  $%  007:PTC生产日期:             $%    $%  ANS004.BYTE007  $%  y=SPRINTF([20%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
