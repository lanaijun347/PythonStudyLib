...
读数据流: 
  ...
  $  000.静态标定状态         $    $       $    $  ANS000.BYTE004  $  switxh(x1)0x01: y=@0350;0x02: y=@0351;0x03: y=@0352;default: y=@0002;
  $  001.静态标定角度值       $    $       $    $  ANS000.BYTE005  $  y=SPRINTF([%.2f],(x1*256+x2)/100);
  $  002.动态标定状态         $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x01: y=@0353;0x02: y=@0354;0x03: y=@0355;0x04: y=@0356;default: y=@0002;
