...
版本信息:
  ...
  $%  004:生产日期:           $%    $%  ANS000.BYTE009  $%  y=SPRINTF([20%02X%s%02X%s%02X%s],x1,@0038,x2,@0039,x3,@003a);
  $%  005:车速信息:           $%    $%  ANS001.BYTE027  $%  y=x1;
  $%  006:ECU加密信息:        $%    $%  ANS002.BYTE004  $%  if(x1==0x00)y=@0052;else if(x1==0x01)y=@0053;else y=@007f;
