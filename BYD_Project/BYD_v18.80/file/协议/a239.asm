...
版本信息:
  ...
  $%  005:已匹配钥匙数:        $%    $%  ANS003.BYTE004  $%  if(x1==0x00) y=@084c;else if(x1==0x01)y=@00a8;else if(x1==0x02)y=@00a9;else if(x1==0x03)y=@00aa;else if(x1==0x04)y=@00ab;else y=@007f;
...
读数据流: 
  ...
  $  000.内部供电状况             $    $       $    $  ANS000.BYTE004  $  if(x1==0x00) y=@00ae;else if(x1==0xFF)y=@00af;else y=@007f;
  $  001.读卡器是否失去通信       $    $       $    $  ANS000.BYTE005  $  if(x1==0x00) y=@0364;else if(x1==0xFF)y=@0365;else y=@007f;
  $  002.读卡器内部天线故障       $    $       $    $  ANS000.BYTE006  $  if(x1==0x00) y=@0045;else if(x1==0xFF)y=@00b4;else y=@007f;
  $  003.钥匙状态                 $    $       $    $  ANS000.BYTE007  $  if(x1==0x03) y=@00b1; else if(x1==0x04) y=@00b2; else if(x1==0x06) y=@00b3; else y=@00b0;
  $  004.钥匙ID                   $    $       $    $  ANS000.BYTE007  $  if(x1==0x04) y=@00b2; else if(x1==0x06) y=@00b3; else y=(x2<<24)+(x3<<16)+(x4<<8)+x5;
  $  005.钥匙序号                 $    $       $    $  ANS000.BYTE007  $  if(x1==0x03) y=@00b1;else if(x1==0x04) y=@00b2; else if(x1==0x06) y=@00b3; else y=x;
