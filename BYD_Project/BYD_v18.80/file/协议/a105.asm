...
读数据流: 
  ...
  $  006.缺相错误0(速度判断)                $    $          $    $  ANS006.BYTE004  $  if(x1==0x00) y=@0045;else if(x1==0x01) y=@0046;else y=@0108;
  $  007.缺相错误1(电流判断)                $    $          $    $  ANS007.BYTE004  $  if(x1==0x00) y=@0045;else if(x1==0x01) y=@0046;else y=@0108;
  $  008.参数设定错误                       $    $          $    $  ANS008.BYTE004  $  if(x1==0x00) y=@0045;else if(x1==0x01) y=@0046;else y=@0108;
