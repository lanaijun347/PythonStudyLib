...
版本信息:
  ...
  $%  007:生产日期:              $%    $%  ANS003.BYTE007  $%  y=SPRINTF([%02d%s%02d%s%02d%s],x1,@0038,x2,@0039,x3,@003a);
...
读数据流: 
  ...
  $  000.前摄像头配置信息             $    $       $    $  ANS000.BYTE004  $  if((x1==0)) y=@005c;else if((x1==1)) y=@005d;else if((x1>=2)&&(x1<=255)) y=x1;else y=@0002;
  $  001.后摄像头配置信息             $    $       $    $  ANS000.BYTE005  $  if((x1==0)) y=@005c;else if((x1==1)) y=@005d;else if((x1>=2)&&(x1<=255)) y=x1;else y=@0002;
  $  002.左摄像头配置信息             $    $       $    $  ANS000.BYTE006  $  if((x1==0)) y=@005c;else if((x1==1)) y=@005d;else if((x1>=2)&&(x1<=255)) y=x1;else y=@0002;
  $  003.右摄像头配置信息             $    $       $    $  ANS000.BYTE007  $  if((x1==0)) y=@005c;else if((x1==1)) y=@005d;else if((x1>=2)&&(x1<=255)) y=x1;else y=@0002;
  $  004.倒车雷达使能状态(预留)       $    $       $    $  ANS000.BYTE008  $  switxh(x1)0x00: y=@005a;0x01: y=@005b;default: y=@0002;
  $  005.全景匹配状态                 $    $       $    $  ANS001.BYTE004  $  switxh(x1)0x00: y=@0020;0x01: y=@001f;default: y=@0002;
