...
读取故障码:
  ...
  $#  REQ000:754 03 19 02 08 00 00 00 00       $#  ANS000:75C 03 19 02 08 00 00 00 00
...
版本信息:
  ...
  $%  REQ007:754 03 22 F1 9D 00 00 00 00       $%  ANS007:75C 03 22 F1 9D 00 00 00 00
  $%  REQ008:754 03 22 F1 A1 00 00 00 00       $%  ANS008:75C 03 22 F1 A1 00 00 00 00
...
读数据流: 
  ...
  $  REQ000:754 03 22 3C E2 00 00 00 00       $  ANS000:75C 03 22 3C E2 00 00 00 00
