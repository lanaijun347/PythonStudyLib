...
读数据流: 
  ...
  $  REQ003:726 03 22 2B 00 00 00 00 00       $  ANS003:72E 03 22 2B 00 00 00 00 00
  ...
  $  025.AVS(全息影像控制单元)标定状态       $    $            $    $  ANS003.BYTE004  $  if(X1==0) y=@0451;else if(X1==1) y=@099f;else Y=@0006;
