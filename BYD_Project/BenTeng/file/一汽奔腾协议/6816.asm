...
版本信息:
  ...
  $%  REQ006:7A4 03 22 FD 03 00 00 00 00       $%  ANS006:7C4 03 22 FD 03 00 00 00 00
  $%  REQ007:7A4 03 22 FD 04 00 00 00 00       $%  ANS007:7C4 03 22 FD 04 00 00 00 00
  $%  REQ008:7A4 03 22 FD 06 00 00 00 00       $%  ANS008:7C4 03 22 FD 06 00 00 00 00
  $%  REQ009:7A4 03 22 01 00 00 00 00 00       $%  ANS009:7C4 03 22 01 00 00 00 00 00
  $%  REQ010:7A4 03 22 F1 96 00 00 00 00       $%  ANS010:7C4 03 22 F1 96 00 00 00 00
  $%  REQ011:7A4 03 00 00 06 00 00 00 00       $%  ANS011:7C4 03 00 00 06 00 00 00 00
  ...
  $%  006:加注状态:                $%    $%  ANS006.BYTE004  $%  if(X1==0) y=@03ca;else if(X1==170) y=@03cb;else if(X1==238) y=@03cc;else y=@0004;
  $%  007:下线检测状态:            $%    $%  ANS007.BYTE004  $%  if(X1==0) y=@05de;else if(X1==170) y=@05df;else if(X1==238) y=@05e0;else y=@0004;
  $%  008:激活诊断模式:            $%    $%  ANS008.BYTE004  $%  if(X1==1) y=@03cd;else if(X1==2) y=@05d9;else if(X1==3) y=@03ce;else if(X1==5) y=@05da;else if(X1==129) y=@05db;else if(X1==130) y=@05dc;else if(X1==131) y=@05dd;else y=@0004;
  $%  009:配置信息:                $%    $%  ANS009.BYTE004  $%  Y=HEX(X1,X2);
  $%  010:刷新软件版本号:          $%    $%  ANS010.BYTE004  $%  Y=ASCII(X1,X2,X3);
  $%  011:刷新软件号:              $%    $%  ANS011.BYTE004  $%  Y=ASCII(X1,X2,X3);
...
读数据流: 
  ...
  $  009.左前进气阀驱动状态       $    $           $    $  ANS002.BYTE006  $  if(((X1>>0)&1)) y=@0015;else y=@0014;
  $  010.左前排气阀驱动状态       $    $           $    $  ANS002.BYTE006  $  if(((X1>>1)&1)==0) y=@0014;else if(((X1>>1)&1)==1) y=@0015;
  $  011.右前进气阀驱动状态       $    $           $    $  ANS002.BYTE006  $  if(((X1>>2)&1)==0) y=@0014;else if(((X1>>2)&1)==1) y=@0015;
  $  012.右前排气阀驱动状态       $    $           $    $  ANS002.BYTE006  $  if(((X1>>3)&1)==0) y=@0014;else if(((X1>>3)&1)==1) y=@0015;
  $  013.左后进气阀驱动状态       $    $           $    $  ANS002.BYTE006  $  if(((X1>>4)&1)==0) y=@0014;else if(((X1>>4)&1)==1) y=@0015;
  $  014.左后排气阀驱动状态       $    $           $    $  ANS002.BYTE006  $  if(((X1>>5)&1)==0) y=@0014;else if(((X1>>5)&1)==1) y=@0015;
  $  015.右后进气阀驱动状态       $    $           $    $  ANS002.BYTE006  $  if(((X1>>6)&1)==0) y=@0014;else if(((X1>>6)&1)==1) y=@0015;
  $  016.右后排气阀驱动状态       $    $           $    $  ANS002.BYTE006  $  if(((X1>>7)&1)==0) y=@0014;else if(((X1>>7)&1)==1) y=@0015;
