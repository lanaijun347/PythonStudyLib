...
版本信息:
  ...
  $%  018:AFS(随动转向大灯):                          $%    $%  ANS015.BYTE004  $%  if(((X1>>3)&1)) Y=@0e95;else Y=@0e96;
  $%  019:SAS(转角传感器):                            $%    $%  ANS015.BYTE004  $%  if(((X1>>4)&1)) Y=@0e95;else Y=@0e96;
  $%  020:EPB(电子驻车制动):                          $%    $%  ANS015.BYTE004  $%  if(((X1>>5)&1)) Y=@0e95;else Y=@0e96;
  $%  021:ACU(安全气囊控制单元):                      $%    $%  ANS015.BYTE004  $%  if(((X1>>6)&1)) Y=@0e95;else Y=@0e96;
  $%  022:ABS(防抱死制动系统):                        $%    $%  ANS015.BYTE004  $%  if(((X1>>7)&1)) Y=@0e95;else Y=@0e96;
  $%  023:ACC（自适应巡航控制）:                      $%    $%  ANS015.BYTE005  $%  if(((X1>>0)&1)) Y=@0e95;else Y=@0e96;
  $%  024:EPS(电动助力转向):                          $%    $%  ANS015.BYTE005  $%  if(((X1>>1)&1)) Y=@0e95;else Y=@0e96;
  $%  025:PKE(被动无匙进入):                          $%    $%  ANS015.BYTE006  $%  if(((X1>>0)&1)) Y=@0e95;else Y=@0e96;
  $%  026:DWCU（电动车窗）:                           $%    $%  ANS015.BYTE006  $%  if(((X1>>1)&1)) Y=@0e95;else Y=@0e96;
  $%  027:TPMS(轮胎气压报警监测系统):                 $%    $%  ANS015.BYTE006  $%  if(((X1>>2)&1)) Y=@0e95;else Y=@0e96;
  $%  028:DATC(空调控制器):                           $%    $%  ANS015.BYTE006  $%  if(((X1>>3)&1)) Y=@0e95;else Y=@0e96;
  $%  029:BCM(车身控制单元):                          $%    $%  ANS015.BYTE006  $%  if(((X1>>4)&1)) Y=@0e95;else Y=@0e96;
  $%  030:DSCU（座椅记忆控制单元）:                   $%    $%  ANS015.BYTE006  $%  if(((X1>>5)&1)) Y=@0e95;else Y=@0e96;
  $%  031:PDC(倒车雷达):                              $%    $%  ANS015.BYTE006  $%  if(((X1>>6)&1)) Y=@0e95;else Y=@0e96;
  $%  032:IC(组合仪表):                               $%    $%  ANS015.BYTE007  $%  if(((X1>>0)&1)) Y=@0e95;else Y=@0e96;
  $%  033:MMI（音响系统）:                            $%    $%  ANS015.BYTE007  $%  if(((X1>>1)&1)) Y=@0e95;else Y=@0e96;
