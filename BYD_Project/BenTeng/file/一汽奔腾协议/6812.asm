...
版本信息:
  ...
  $%  REQ007:75E 03 22 F1 00 00 00 00 00       $%  ANS007:77E 03 22 F1 00 00 00 00 00
  $%  REQ008:75E 03 22 F1 89 00 00 00 00       $%  ANS008:77E 03 22 F1 89 00 00 00 00
  $%  REQ009:75E 03 22 F1 8C 00 00 00 00       $%  ANS009:77E 03 22 F1 8C 00 00 00 00
  $%  REQ010:75E 03 22 F1 91 00 00 00 00       $%  ANS010:77E 03 22 F1 91 00 00 00 00
  $%  REQ011:75E 03 22 F1 92 00 00 00 00       $%  ANS011:77E 03 22 F1 92 00 00 00 00
  $%  REQ012:75E 03 22 F1 94 00 00 00 00       $%  ANS012:77E 03 22 F1 94 00 00 00 00
  $%  REQ013:75E 03 22 F1 98 00 00 00 00       $%  ANS013:77E 03 22 F1 98 00 00 00 00
  $%  REQ014:75E 03 22 F1 A2 00 00 00 00       $%  ANS014:77E 03 22 F1 A2 00 00 00 00
  $%  REQ015:75E 03 22 F1 A6 00 00 00 00       $%  ANS015:77E 03 22 F1 A6 00 00 00 00
  ...
  $%  003:供应商ECU软件版本号:             $%    $%  ANS003.BYTE004  $%  Y=ASCII(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15,X16);
  $%  004:编程日期:                        $%    $%  ANS004.BYTE004  $%  Y=HEX(X1,X2,X3,X4);
  $%  005:ECU安装日期:                     $%    $%  ANS005.BYTE004  $%  Y=HEX(X1,X2,X3,X4);
  $%  006:碰撞信息:                        $%    $%  ANS006.BYTE004  $%  Y=HEX(X1);
  $%  007:车辆模式配置:                    $%    $%  ANS007.BYTE004  $%  if(X1==1) y=@006a;else if(X1==2) y=@05f3;else y=@0004;
  $%  008:ECU软件版本号:                   $%    $%  ANS008.BYTE004  $%  Y=ASCII(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15);
  $%  009:ECU序列号:                       $%    $%  ANS009.BYTE004  $%  Y=ASCII(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15);
  $%  010:ECU硬件版本号:                   $%    $%  ANS010.BYTE004  $%  Y=ASCII(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15);
  $%  011:供应商ECU硬件号:                 $%    $%  ANS011.BYTE004  $%  Y=ASCII(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15,X16);
  ...
  $%  014:配置参数:                        $%    $%  ANS006.BYTE004  $%  Y=HEX(X1,X2,X3,X4,X5);
  $%  015:售后配置参数:                    $%    $%  ANS014.BYTE004  $%  Y=HEX(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15,X16);
  $%  016:车辆在生产线上的生产日期:        $%    $%  ANS015.BYTE004  $%  Y=HEX(X1,X2,X3,X4);
...
读数据流: 
  ...
  $  REQ022:75E 03 22 01 03 00 00 00 00       $  ANS022:77E 03 22 01 03 00 00 00 00
  $  REQ023:75E 03 22 01 34 00 00 00 00       $  ANS023:77E 03 22 01 34 00 00 00 00
  $  REQ024:75E 03 22 01 10 00 00 00 00       $  ANS024:77E 03 22 01 10 00 00 00 00
  $  REQ025:75E 03 22 01 1F 00 00 00 00       $  ANS025:77E 03 22 01 1F 00 00 00 00
  $  REQ026:75E 03 22 01 20 00 00 00 00       $  ANS026:77E 03 22 01 20 00 00 00 00
  ...
  $  025.后视镜折叠状态               $    $        $    $  ANS022.BYTE004  $  if(X1==0) y=@0014;else if(X1==1) y=@0015;else y=@0004;
  $  026.后视镜展开状态               $    $        $    $  ANS023.BYTE004  $  if(X1==0) y=@0014;else if(X1==1) y=@0015;else y=@0004;
  $  027.后雨刮状态                   $    $        $    $  ANS024.BYTE004  $  if(X1==0) y=@0014;else if(X1==1) y=@0015;else y=@0004;
  $  028.遥控器1 ID                   $    $        $    $  ANS025.BYTE004  $  Y=HEX(X1,X2,X3,X4);
  $  029.遥控器2 ID                   $    $        $    $  ANS026.BYTE004  $  Y=HEX(X1,X2,X3,X4);
