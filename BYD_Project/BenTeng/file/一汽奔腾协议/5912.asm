...
读数据流: 
  ...
  $  REQ004:7A4 03 22 FD 04 00 00 00 00       $  ANS004:7C4 03 22 FD 04 00 00 00 00
  $  REQ005:7A4 03 22 FD 05 00 00 00 00       $  ANS005:7C4 03 22 FD 05 00 00 00 00
  $  REQ006:7A4 03 22 FD 06 00 00 00 00       $  ANS006:7C4 03 22 FD 06 00 00 00 00

  $  000.轮速信息           $    $  km/h     $    $  ANS000.BYTE004  $  Y=(X1*256+X2)*0.05625;
  $  001.电池电压           $    $  V        $    $  ANS001.BYTE004  $  Y=X1*0.08;
  $  002.驱动状态           $    $           $    $  ANS002.BYTE004  $  if(X1==0) y=@0014;else if(X1==1) y=@0015;else y=@0004;
  $  003.加注状态           $    $           $    $  ANS003.BYTE004  $  if(X1==0) y=@03ca;else if(X1==170) y=@03cb;else if(X1==238) y=@03cc;else y=@0004;
  $  004.下线检测状态       $    $           $    $  ANS004.BYTE004  $  if(X1==0) y=@05de;else if(X1==170) y=@05df;else if(X1==238) y=@05e0;else y=@0004;
  $  005.系统传感器         $    $           $    $  ANS005.BYTE004  $  Y=(X1*256+X2)*0.0153;
