...
读数据流: 
  ...
  $  REQ004:7A2 03 22 18 86 00 00 00 00       $  ANS004:7AA 03 22 18 86 00 00 00 00
  $  REQ005:7A2 03 22 18 90 00 00 00 00       $  ANS005:7AA 03 22 18 90 00 00 00 00
  ...
  $  004.SAS(转角传感器)角速度         $    $  deg/s     $    $  ANS004.BYTE004  $  Y=(X1*256+X2)*0.04375;
  $  005.SAS(转角传感器)标定状态       $    $            $    $  ANS005.BYTE004  $  if(X1==0) Y=@03c6;else if(X1==1) Y=@03c7;else y=@0004;
