...
读数据流: 
  ...
  $  019.后与左右棋盘格之间的距离       $    $            $    $  ANS002.BYTE010  $  Y=(X1*256+X2);
  $  020.前棋盘格与车之间的距离         $    $            $    $  ANS002.BYTE012  $  Y=(X1*256+X2);
  $  021.后棋盘格与车之间的距离         $    $            $    $  ANS002.BYTE014  $  Y=(X1*256+X2);
  $  022.左棋盘格与车之间的距离         $    $            $    $  ANS002.BYTE016  $  Y=(X1*256+X2);
  $  023.右棋盘格与车之间的距离         $    $            $    $  ANS002.BYTE018  $  Y=(X1*256+X2);
