...
版本信息:
  ...
  $%  004:供应商ECU硬件版本号:        $%    $%  ANS004.BYTE004  $%  Y=ASCII(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15);
  $%  005:供应商ECU软件版本号:        $%    $%  ANS005.BYTE004  $%  Y=ASCII(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15);
...
读数据流: 
  ...
  $  002.Y轴的安装位置                              $    $  m          $    $  ANS000.BYTE006  $  Y=X1*256+X2;
  $  003.校准后的XY平面的安装角度（水平方向）       $    $  degree     $    $  ANS000.BYTE010  $  Y=(X1*256+X2)*0.01;
