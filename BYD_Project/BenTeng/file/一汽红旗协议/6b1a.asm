...
读数据流: 
  ...
  $  000.SRU_左前距离                            $    $  cm     $    $  ANS000.BYTE004  $  if(X1>=0&&X1<=253)Y=X1;else if(X1==254)Y=@0000;else if(X1==255)Y=@0001;
  $  001.SRU_FML距离                             $    $  cm     $    $  ANS001.BYTE004  $  if(X1>=0&&X1<=253)Y=X1;else if(X1==254)Y=@0000;else if(X1==255)Y=@0001;
  $  002.SRU_FMR距离                             $    $  cm     $    $  ANS002.BYTE004  $  if(X1>=0&&X1<=253)Y=X1;else if(X1==254)Y=@0000;else if(X1==255)Y=@0001;
  $  003.SRU_右前距离                            $    $  cm     $    $  ANS003.BYTE004  $  if(X1>=0&&X1<=253)Y=X1;else if(X1==254)Y=@0000;else if(X1==255)Y=@0001;
  $  004.SRU_左后距离                            $    $  cm     $    $  ANS004.BYTE004  $  if(X1>=0&&X1<=253)Y=X1;else if(X1==254)Y=@0000;else if(X1==255)Y=@0001;
  $  005.SRU_RML(左约束模块)距离                 $    $  cm     $    $  ANS005.BYTE004  $  if(X1>=0&&X1<=253)Y=X1;else if(X1==254)Y=@0000;else if(X1==255)Y=@0001;
  $  006.SRU_RMR距离                             $    $  cm     $    $  ANS006.BYTE004  $  if(X1>=0&&X1<=253)Y=X1;else if(X1==254)Y=@0000;else if(X1==255)Y=@0001;
  $  007.SRU_右后距离                            $    $  cm     $    $  ANS007.BYTE004  $  if(X1>=0&&X1<=253)Y=X1;else if(X1==254)Y=@0000;else if(X1==255)Y=@0001;
  $  008.LRU_左侧距离                            $    $  cm     $    $  ANS008.BYTE004  $  if((X1*256+X2)>=0&&(X1*256+X2)<=1021)Y=X1*256+X2;else if((X1*256+X2)==1022)Y=@0000;else if((X1*256+X2)==1023)Y=@0001;else y=@0004;
  $  009.LRU_右侧距离                            $    $  cm     $    $  ANS009.BYTE004  $  if((X1*256+X2)>=0&&(X1*256+X2)<=1021)Y=X1*256+X2;else if((X1*256+X2)==1022)Y=@0000;else if((X1*256+X2)==1023)Y=@0001;else y=@0004;
  $  010.AVM（全景式监控系统）视野变化状态       $    $         $    $  ANS010.BYTE004  $  if(X1==0) y=@0005;else if(X1==1) y=@0053;else if(X1==2) y=@0296;else if(X1==3) y=@0297;else if(X1==4) y=@0056;else if(X1==5) y=@0057;else if(X1==6) y=@0472;else if(X1==7) y=@0473;else y=@0004;
  $  011.AVM（全景式监控系统）标定状态           $    $         $    $  ANS011.BYTE004  $  if(X1==0) y=@0002;else if(X1==1) y=@0003;else y=@0004;
