...
读数据流: 
  ...
  $  REQ008:726 03 22 2A D1 00 00 00 00       $  ANS008:72E 03 22 2A D1 00 00 00 00
  $  REQ009:726 03 22 2A D2 00 00 00 00       $  ANS009:72E 03 22 2A D2 00 00 00 00
  $  REQ010:726 03 22 2B 10 00 00 00 00       $  ANS010:72E 03 22 2B 10 00 00 00 00
  $  REQ011:726 03 22 2B 00 00 00 00 00       $  ANS011:72E 03 22 2B 00 00 00 00 00

  $  000.SRU左前距离                                 $    $  cm     $    $  ANS000.BYTE004  $  if(X1>=0&&X1<=253)Y=X1*1;else if(X1==254)Y=-1;else if(X1==255)Y=-2;else y=@0004;
  $  001.SRU左前中距离                               $    $  cm     $    $  ANS001.BYTE004  $  if(X1>=0&&X1<=253)Y=X1*1;else if(X1==254)Y=-1;else if(X1==255)Y=-2;else y=@0004;
  $  002.SRU右前中距离                               $    $  cm     $    $  ANS002.BYTE004  $  if(X1>=0&&X1<=253)Y=X1*1;else if(X1==254)Y=-1;else if(X1==255)Y=-2;else y=@0004;
  $  003.SRU右前距离                                 $    $  cm     $    $  ANS003.BYTE004  $  if(X1>=0&&X1<=253)Y=X1*1;else if(X1==254)Y=-1;else if(X1==255)Y=-2;else y=@0004;
  $  004.SRU左后距离                                 $    $  cm     $    $  ANS004.BYTE004  $  if(X1>=0&&X1<=253)Y=X1*1;else if(X1==254)Y=-1;else if(X1==255)Y=-2;else y=@0004;
  $  005.SRU左后中距离                               $    $  cm     $    $  ANS005.BYTE004  $  if(X1>=0&&X1<=253)Y=X1*1;else if(X1==254)Y=-1;else if(X1==255)Y=-2;else y=@0004;
  $  006.SRU右后中距离                               $    $  cm     $    $  ANS006.BYTE004  $  if(X1>=0&&X1<=253)Y=X1*1;else if(X1==254)Y=-1;else if(X1==255)Y=-2;else y=@0004;
  $  007.SRU右后距离                                 $    $  cm     $    $  ANS007.BYTE004  $  if(X1>=0&&X1<=253)Y=X1*1;else if(X1==254)Y=-1;else if(X1==255)Y=-2;else y=@0004;
  $  008.LRU左侧距离                                 $    $  cm     $    $  ANS008.BYTE004  $  if((X1*256+X2)>=0&&(X1*256+X2)<=1021)Y=(X1*256+X2)*1;else if((X1*256+X2)==1022)Y=-1;else if((X1*256+X2)==1023)Y=-2;else y=@0004;
  $  009.LRU右侧距离                                 $    $  cm     $    $  ANS009.BYTE004  $  if((X1*256+X2)>=0&&(X1*256+X2)<=1021)Y=(X1*256+X2)*1;else if((X1*256+X2)==1022)Y=-1;else if((X1*256+X2)==1023)Y=-2;else y=@0004;
  $  010.AVM(全景环视影像控制模块)视图更改状态       $    $         $    $  ANS010.BYTE004  $  if(X1==0) y=@0005;else if(X1==1) y=@0053;else if(X1==2) y=@0296;else if(X1==3) y=@0297;else if(X1==4) y=@0056;else if(X1==5) y=@0057;else if(X1==6) y=@0058;else if(X1==7) y=@0059;else y=@0004;
  $  011.AVM(全景环视影像控制模块)标定状态           $    $         $    $  ANS011.BYTE004  $  if(X1==0) y=@0294;else if(X1==1) y=@0295;else y=@0004;
