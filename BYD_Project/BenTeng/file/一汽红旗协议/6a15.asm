...
读数据流: 
  ...
  $  002.前右中雷达距离         $    $  cm     $    $  ANS002.BYTE004  $  if(X1<=253) Y=X1*1;else Y=@0004;
  $  003.前右雷达距离           $    $  cm     $    $  ANS003.BYTE004  $  if(X1<=253) Y=X1*1;else Y=@0004;
