...
版本信息:
  ...
  $%  REQ013:760 03 22 F1 83 00 00 00 00            $%  
  $%  REQ014:760 03 22 F1 8A 00 00 00 00            $%  
  $%  REQ015:760 03 22 F1 92 00 00 00 00            $%  
  $%  REQ016:760 03 22 F1 94 00 00 00 00            $%  
  $%  REQ017:760 03 22 F1 98 00 00 00 00            $%  
  $%  REQ018:760 03 22 B1 13 00 00 00 00            $%  
  $%  REQ019:760 03 22 B1 14 00 00 00 00            $%  
  $%  REQ020:760 03 22 B1 15 00 00 00 00            $%  
  $%  REQ021:760 03 22 B1 16 00 00 00 00            $%  
  ...
  $%  018:泊车辅助控制模块零件号（挂入倒档）            $%    $%  ANS018.BYTE003  $%  HEX(x1,x2,x3,x4,x5); 
  $%  019:泊车辅助控制模块硬件号（挂入倒档）            $%    $%  ANS019.BYTE003  $%  HEX(x1,x2,x3,x4,x5); 
  $%  020:泊车辅助控制模块应用软件号（挂入倒档）        $%    $%  ANS020.BYTE003  $%  HEX(x1,x2,x3,x4,x5); 
  $%  021:泊车辅助控制模块标定软件号（挂入倒档）        $%    $%  ANS021.BYTE003  $%  HEX(x1,x2,x3,x4,x5); 
