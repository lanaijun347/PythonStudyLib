...
<VCI>
	...
	<VERSION num="0">
		...
		<param type="string" value="{&quot;10749153&quot;: &quot;0000449B&quot;, &quot;10475378&quot;: &quot;0000449C&quot;}"/>
		</call_protocol>
	</VERSION>
	<VERSION num="1">
		<call_protocol label="reload_path" function="get_info_scanf_version">
...
版本信息:
  ...
  $%  REQ008:730 03 22 F1 A9 00 00 00 00            $%  
  $%  REQ009:730 03 22 F1 AA 00 00 00 00            $%  
...
数据流:
  ...
  $  001.乘客侧气囊禁用开关状态                   $    $           $    $  ANS000.BYTE004  $  switxh(x&0x0F)0x00:@0d63;0x02:@0d64;0x03:@01b1;0x04:@096d;0x07:@096e; 
  $  002.前排副驾驶安全带插锁状态                 $    $           $    $  ANS000.BYTE005  $  switxh(x&0xC0)0x00:@03e3;0x40:@03e4;0x80:@096d;0xC0:@096e; 
  $  003.前排驾驶员安全带插锁状态                 $    $           $    $  ANS000.BYTE005  $  switxh(x&0x30)0x00:@03e3;0x10:@03e4;0x20:@096d;0x30:@096e; 
  $  004.第二排座椅左侧安全带插锁状态             $    $           $    $  ANS000.BYTE005  $  switxh(x&0x0C)0x00:@03e3;0x04:@03e4;0x08:@096d;0x0C:@096e; 
  $  005.第二排座椅中间安全带插锁状态             $    $           $    $  ANS000.BYTE005  $  switxh(x&0x03)0x00:@03e3;0x01:@03e4;0x02:@096d;0x03:@096e; 
  $  006.第二排座椅右侧安全带插锁状态             $    $           $    $  ANS000.BYTE006  $  switxh(x&0xC0)0x00:@03e3;0x40:@03e4;0x80:@096d;0xC0:@096e; 
  $  007.气囊警告灯状态                           $    $           $    $  ANS000.BYTE006  $  switxh(x&0x03)0x00:@002e;0x01:@0037;0x02:@0038; 
  $  008.VIN锁定状态                              $    $           $    $  ANS000.BYTE006  $  switxh(x&0x08)0x00:@02fa;0x08:@02f9; 
  $  009.气囊控制模块激活状态                     $    $           $    $  ANS000.BYTE006  $  switxh(x&0x10)0x00:@00e7;0x10:@00e6; 
  $  010.碰撞是否发生                             $    $           $    $  ANS000.BYTE006  $  switxh(x&0x04)0x00:@071b;0x04:@071c; 
  $  011.驾驶员安全带提醒输出状态                 $    $           $    $  ANS000.BYTE007  $  switxh(x&0x30)0x00:@002e;0x10:@0037;0x20:@0038;0x30:@06ec; 
  $  012.乘客安全带提醒输出状态                   $    $           $    $  ANS000.BYTE007  $  switxh(x&0xC0)0x00:@002e;0x40:@0037;0x80:@0038;0xC0:@06ec; 
  $  013.气囊控制模块使用时间                     $    $  小时     $    $  ANS001.BYTE003  $  y=(x1*16777216+x2*65536+x3*256+x4)*0.00027; 
  $  014.点火钥匙打开后气囊控制模块运作时间       $    $  秒       $    $  ANS002.BYTE003  $  y=(x1*256+x2)*1; 
  $  015.驾驶员气囊（DAB）点火回路电阻值          $    $  欧姆     $    $  ANS003.BYTE003  $  y=(x)*0.1; 
  $  016.乘客气囊（PAB）点火回路电阻值            $    $  欧姆     $    $  ANS003.BYTE005  $  y=(x)*0.1; 
  $  017.左侧侧气帘点火回路电阻值                 $    $  欧姆     $    $  ANS003.BYTE009  $  y=(x)*0.1; 
  $  018.右侧侧气帘点火回路电阻值                 $    $  欧姆     $    $  ANS003.BYTE010  $  y=(x)*0.1; 
  $  019.驾驶员预拉紧安全带点火回路电阻值         $    $  欧姆     $    $  ANS003.BYTE011  $  y=(x)*0.1; 
  $  020.乘客预拉紧安全带点火回路电阻值           $    $  欧姆     $    $  ANS003.BYTE012  $  y=(x)*0.1; 
  $  021.右侧侧气囊点火回路电阻值                 $    $  欧姆     $    $  ANS003.BYTE013  $  y=(x)*0.1; 
  $  022.左侧侧气囊点火回路电阻值                 $    $  欧姆     $    $  ANS003.BYTE014  $  y=(x)*0.1; 
