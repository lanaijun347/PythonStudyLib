...
<VCI>
	...
	<VERSION num="0">
		...
		<param type="string" value="{&quot;10833386&quot;: &quot;000044A5&quot;, &quot;10848112&quot;: &quot;000044A5&quot;, &quot;10961371&quot;: &quot;000044A5&quot;, &quot;10838846&quot;: &quot;000044A6&quot;}"/>
		</call_protocol>
	</VERSION>
	<VERSION num="1">
		<call_protocol label="reload_path" function="get_info_scanf_version">
...
版本信息:
  ...
  $%  REQ007:761 03 22 F1 A2 00 00 00 00            $%  
  $%  REQ008:761 03 22 F1 A5 00 00 00 00            $%  
  $%  REQ009:761 03 22 F1 A8 00 00 00 00            $%  
  $%  REQ010:761 03 22 F1 A9 00 00 00 00            $%  
  $%  REQ011:761 03 22 F1 8A 00 00 00 00            $%  
  $%  REQ012:761 03 22 F1 92 00 00 00 00            $%  
  $%  REQ013:761 03 22 F1 94 00 00 00 00            $%  
  $%  REQ014:761 03 22 F1 98 00 00 00 00            $%  
  ...
  $%  009:车辆特征信息(FK)                           $%    $%  ANS009.BYTE003  $%  HEX(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20); 
  $%  010:电控单元配置文件号                         $%    $%  ANS010.BYTE003  $%  HEX(x1,x2,x3,x4,x5); 
...
数据流:
  ...
  $  REQ000:761 03 22 B0 01 00 00 00 00            $  

  $  000.电池电压                         $    $  伏特     $    $  ANS000.BYTE003  $  y=(x)*0.1; 
  $  001.当前收音机天线电压               $    $  伏       $    $  ANS000.BYTE004  $  y=(x)*0.1; 
  $  002.当前左侧方向盘控制电路电压       $    $  伏       $    $  ANS000.BYTE005  $  y=(x)*0.1; 
  $  003.当前右侧方向盘控制电路电压       $    $  伏       $    $  ANS000.BYTE006  $  y=(x)*0.1; 
