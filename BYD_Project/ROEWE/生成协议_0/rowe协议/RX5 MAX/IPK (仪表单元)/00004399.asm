...
<VCI>
	...
	<VERSION num="0">
		...
		<param type="string" value="{&quot;10811558&quot;: &quot;00004398&quot;, &quot;10183354&quot;: &quot;00004399&quot;}"/>
		</call_protocol>
	</VERSION>
	<VERSION num="1">
		<call_protocol label="reload_path" function="get_info_scanf_version">
...
版本信息:
  ...
  $%  REQ008:760 03 22 F1 A9 00 00 00 00            $%  
  $%  REQ009:760 03 22 F1 B5 00 00 00 00            $%  
  $%  REQ010:760 03 22 F1 83 00 00 00 00            $%  
  $%  REQ011:760 03 22 F1 8A 00 00 00 00            $%  
  ...
  $%  009:电控单元第二应用软件号        $%    $%  ANS009.BYTE003  $%  HEX(x1,x2,x3,x4,x5); 
...
数据流:
  ...
  $  REQ002:760 03 22 B1 15 00 00 00 00            $  
