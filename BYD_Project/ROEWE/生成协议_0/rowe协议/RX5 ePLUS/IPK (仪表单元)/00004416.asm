...
版本信息:
  ...
  $%  REQ009:760 03 22 F1 A8 00 00 00 00            $%  
  $%  REQ010:760 03 22 F1 A9 00 00 00 00            $%  
  $%  REQ011:760 03 22 F1 AA 00 00 00 00            $%  
  $%  REQ012:760 03 22 F1 8A 00 00 00 00            $%  
  $%  REQ013:760 03 22 F1 92 00 00 00 00            $%  
  $%  REQ014:760 03 22 F1 94 00 00 00 00            $%  
  $%  REQ015:760 03 22 F1 98 00 00 00 00            $%  
  ...
  $%  011:电控单元刷新过程文件号          $%    $%  ANS011.BYTE003  $%  HEX(x1,x2,x3,x4,x5); 
