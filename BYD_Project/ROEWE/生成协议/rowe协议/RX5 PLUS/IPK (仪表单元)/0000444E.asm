...
<VCI>
	...
	<VERSION num="0">
		...
		<param type="string" value="{&quot;10855604&quot;: &quot;0000444D&quot;, &quot;10738393&quot;: &quot;0000444E&quot;}"/>
		</call_protocol>
	</VERSION>
	<VERSION num="1">
		<call_protocol label="reload_path" function="get_info_scanf_version">
...
版本信息:
  ...
  $%  REQ007:760 03 22 F1 A9 00 00 00 00            $%  
  $%  REQ008:760 03 22 F1 83 00 00 00 00            $%  
  $%  REQ009:760 03 22 F1 8A 00 00 00 00            $%  
  $%  REQ010:760 03 22 F1 92 00 00 00 00            $%  
  $%  REQ011:760 03 22 F1 94 00 00 00 00            $%  
  ...
  $%  009:系统供应商标识号                $%    $%  ANS009.BYTE003  $%  HEX(x1,x2,x3,x4,x5); 
  $%  010:供应商电控单元硬件参考号        $%    $%  ANS010.BYTE003  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10); 
  $%  011:电控单元软件参考号              $%    $%  ANS011.BYTE003  $%  ASCII(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10); 
...
数据流:
  ...
  $  REQ003:760 03 22 E1 02 00 00 00 00            $  
  ...
  $  003.原始燃油量               $    $  升       $    $  ANS003.BYTE003  $  y=(x1*256+x2)*0.001; 
